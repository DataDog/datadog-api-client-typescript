...
export function createConfiguration(
  ...
  const configuration = new Configuration(
    ...
    conf.backoffMultiplier || 2,
    {
      ...
      "v2.createScorecardCampaign": false,
      "v2.createScorecardOutcomesBatch": false,
      "v2.createScorecardRule": false,
      "v2.deleteScorecardCampaign": false,
      "v2.deleteScorecardRule": false,
      "v2.deleteScorecardRuleWorkflow": false,
      "v2.generateScorecardCampaignReport": false,
      "v2.generateScorecardCampaignTeamReports": false,
      "v2.getScorecardCampaign": false,
      "v2.listScorecardCampaigns": false,
      "v2.listScorecardDefaultRules": false,
      "v2.listScorecardFacets": false,
      "v2.listScorecardOutcomes": false,
      "v2.listScorecardRules": false,
      "v2.listScorecards": false,
      "v2.listScorecardScores": false,
      "v2.setupScorecardRules": false,
      "v2.updateScorecardCampaign": false,
      "v2.updateScorecardOutcomesAsync": false,
      "v2.updateScorecardRule": false,
      "v2.updateScorecardRuleWorkflow": false,
