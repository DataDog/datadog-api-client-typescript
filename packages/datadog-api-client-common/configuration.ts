...
export function createConfiguration(
  ...
  const configuration = new Configuration(
    ...
    conf.backoffMultiplier || 2,
    {
      ...
      "v2.createElasticCloudCcmAccount": false,
      "v2.deleteElasticCloudCcmAccount": false,
      "v2.getElasticCloudCcmAccount": false,
      "v2.listElasticCloudCcmAccounts": false,
      "v2.updateElasticCloudCcmAccount": false,
      "v2.createElasticCloudMonitoringAccount": false,
      "v2.deleteElasticCloudMonitoringAccount": false,
      "v2.getElasticCloudMonitoringAccount": false,
      "v2.listElasticCloudMonitoringAccounts": false,
      "v2.updateElasticCloudMonitoringAccount": false,
      "v2.createTwilioAccount": false,
      "v2.deleteTwilioAccount": false,
      "v2.getTwilioAccount": false,
      "v2.listTwilioAccounts": false,
      "v2.updateTwilioAccount": false,
