...
export function createConfiguration(
  ...
  const configuration = new Configuration(
    ...
    conf.backoffMultiplier || 2,
    {
      ...
      "v2.acceptRecommendedEntities": false,
      "v2.convertCatalogEntities": false,
      "v2.declineRecommendedEntities": false,
      "v2.getIDPConfigValue": false,
      "v2.triggerRecommendedEntities": false,
      "v2.upsertIDPConfigValue": false,
