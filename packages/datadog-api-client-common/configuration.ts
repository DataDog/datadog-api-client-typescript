...
export function createConfiguration(
  ...
  const configuration = new Configuration(
    ...
    conf.backoffMultiplier || 2,
    {
      ...
      "v2.createCSMThreatsAgentRule": false,
      "v2.deleteCSMThreatsAgentRule": false,
      "v2.downloadCSMThreatsPolicy": false,
      "v2.getCSMThreatsAgentRule": false,
      "v2.listCSMThreatsAgentRules": false,
      "v2.updateCSMThreatsAgentRule": false,
