...
export function createConfiguration(
  ...
  const configuration = new Configuration(
    ...
    conf.backoffMultiplier || 2,
    {
      ...
      "v2.createLogsCustomDestination": false,
      "v2.deleteLogsCustomDestination": false,
      "v2.getLogsCustomDestination": false,
      "v2.listLogsCustomDestinations": false,
      "v2.updateLogsCustomDestination": false,
