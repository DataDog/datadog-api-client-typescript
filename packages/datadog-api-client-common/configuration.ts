...
export function createConfiguration(
  ...
  const configuration = new Configuration(
    ...
    conf.backoffMultiplier || 2,
    {
      ...
      "v2.createIncidentConfigRule": false,
      ...
      "v2.deleteIncidentConfigRule": false,
      ...
      "v2.getIncidentConfigRule": false,
      ...
      "v2.listIncidentConfigRules": false,
      ...
      "v2.updateIncidentConfigRule": false,
