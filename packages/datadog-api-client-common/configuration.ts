...
export function createConfiguration(
  ...
  const configuration = new Configuration(
    ...
    conf.backoffMultiplier || 2,
    {
      ...
      "v2.createIntegrationAccount": false,
      "v2.deleteIntegrationAccount": false,
      "v2.getIntegrationAccount": false,
      "v2.listIntegrationAccounts": false,
      "v2.updateIntegrationAccount": false,
