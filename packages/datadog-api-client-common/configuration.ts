...
export function createConfiguration(
  ...
  const configuration = new Configuration(
    ...
    conf.backoffMultiplier || 2,
    {
      ...
      "v2.listGovernanceLimits": false,
      "v2.listGovernanceResourceLimits": false,
      "v2.updateGovernanceNotificationSettings": false,
      "v2.createGovernanceMitigation": false,
      "v2.getGovernanceControl": false,
      "v2.getGovernanceControlDetection": false,
      ...
      "v2.updateGovernanceControlDetection": false,
