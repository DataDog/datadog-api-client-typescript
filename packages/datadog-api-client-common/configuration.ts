...
export function createConfiguration(
  ...
  const configuration = new Configuration(
    ...
    conf.backoffMultiplier || 2,
    {
      ...
      "v2.createEventEmailAddress": false,
      "v2.createOnCallEventEmailAddress": false,
      "v2.deleteEventEmailAddress": false,
      "v2.deleteOnCallEventEmailAddress": false,
      "v2.getEventEmailAddress": false,
      "v2.listEventEmailAddresses": false,
      "v2.listOnCallEventEmailAddresses": false,
      "v2.updateEventEmailAddress": false,
