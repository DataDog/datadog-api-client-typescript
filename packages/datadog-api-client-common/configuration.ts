...
export function createConfiguration(
  ...
  const configuration = new Configuration(
    ...
    conf.backoffMultiplier || 2,
    {
      ...
      "v2.getCostAIPreferredTags": false,
      "v2.getCostSetting": false,
      "v2.listCostTagPipelineActiveKeys": false,
      "v2.listCustomAllocationRulesStatus": false,
      "v2.listTagPipelinesRulesetsStatus": false,
