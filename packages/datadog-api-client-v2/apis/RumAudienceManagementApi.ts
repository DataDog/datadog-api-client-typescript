...
export class RumAudienceManagementApiRequestFactory extends BaseAPIRequestFactory {
  ...
  public async createConnection(entity: string,body: CreateConnectionRequest,_options?: Configuration): Promise<RequestContext> {
    ...
    // Path Params
    const localVarPath = '/api/v2/product-analytics/{entity}/mapping/connection'
      .replace('{entity}', encodeURIComponent(String(entity)));

    // Make Request Context
    const requestContext = _config.getServer('v2.RumAudienceManagementApi.createConnection').makeRequestContext(localVarPath, HttpMethod.POST);
  ...
  public async deleteConnection(id: string,entity: string,_options?: Configuration): Promise<RequestContext> {
    const _config = _options || this.configuration;
    ...
    // Make Request Context
    const requestContext = _config.getServer('v2.RumAudienceManagementApi.deleteConnection').makeRequestContext(localVarPath, HttpMethod.DELETE);
    requestContext.setHeaderParam("Accept", "*/*");
    requestContext.setHttpConfig(_config.httpConfig);
  ...
  public async getAccountFacetInfo(body: FacetInfoRequest,_options?: Configuration): Promise<RequestContext> {
    const _config = _options || this.configuration;
    ...
    // Make Request Context
    const requestContext = _config.getServer('v2.RumAudienceManagementApi.getAccountFacetInfo').makeRequestContext(localVarPath, HttpMethod.POST);
  ...
  public async getMapping(entity: string,_options?: Configuration): Promise<RequestContext> {
    const _config = _options || this.configuration;
    ...
    // Path Params
    const localVarPath = '/api/v2/product-analytics/{entity}/mapping'
      .replace('{entity}', encodeURIComponent(String(entity)));

    // Make Request Context
    const requestContext = _config.getServer('v2.RumAudienceManagementApi.getMapping').makeRequestContext(localVarPath, HttpMethod.GET);
    requestContext.setHeaderParam("Accept", "application/json");
    requestContext.setHttpConfig(_config.httpConfig);
  ...
  public async getUserFacetInfo(body: FacetInfoRequest,_options?: Configuration): Promise<RequestContext> {
    const _config = _options || this.configuration;
    ...
    // Make Request Context
    const requestContext = _config.getServer('v2.RumAudienceManagementApi.getUserFacetInfo').makeRequestContext(localVarPath, HttpMethod.POST);
    requestContext.setHeaderParam("Accept", "application/json");
    requestContext.setHttpConfig(_config.httpConfig);
  ...
  public async listConnections(entity: string,_options?: Configuration): Promise<RequestContext> {
    const _config = _options || this.configuration;
    ...
    // Path Params
    const localVarPath = '/api/v2/product-analytics/{entity}/mapping/connections'
      .replace('{entity}', encodeURIComponent(String(entity)));

    // Make Request Context
    const requestContext = _config.getServer('v2.RumAudienceManagementApi.listConnections').makeRequestContext(localVarPath, HttpMethod.GET);
    requestContext.setHeaderParam("Accept", "application/json");
    requestContext.setHttpConfig(_config.httpConfig);
  ...
  public async queryAccounts(body: QueryAccountRequest,_options?: Configuration): Promise<RequestContext> {
    const _config = _options || this.configuration;
    ...
    // Make Request Context
    const requestContext = _config.getServer('v2.RumAudienceManagementApi.queryAccounts').makeRequestContext(localVarPath, HttpMethod.POST);
    requestContext.setHeaderParam("Accept", "application/json");
    requestContext.setHttpConfig(_config.httpConfig);
  ...
  public async queryEventFilteredUsers(body: QueryEventFilteredUsersRequest,_options?: Configuration): Promise<RequestContext> {
    const _config = _options || this.configuration;
    ...
    // Make Request Context
    const requestContext = _config.getServer('v2.RumAudienceManagementApi.queryEventFilteredUsers').makeRequestContext(localVarPath, HttpMethod.POST);
    requestContext.setHeaderParam("Accept", "application/json");
    requestContext.setHttpConfig(_config.httpConfig);
  ...
  public async queryUsers(body: QueryUsersRequest,_options?: Configuration): Promise<RequestContext> {
    const _config = _options || this.configuration;
    ...
    // Make Request Context
    const requestContext = _config.getServer('v2.RumAudienceManagementApi.queryUsers').makeRequestContext(localVarPath, HttpMethod.POST);
    requestContext.setHeaderParam("Accept", "application/json");
    requestContext.setHttpConfig(_config.httpConfig);
  ...
  public async updateConnection(entity: string,body: UpdateConnectionRequest,_options?: Configuration): Promise<RequestContext> {
    const _config = _options || this.configuration;
    ...
    // Make Request Context
    const requestContext = _config.getServer('v2.RumAudienceManagementApi.updateConnection').makeRequestContext(localVarPath, HttpMethod.PUT);
    requestContext.setHeaderParam("Accept", "*/*");
    requestContext.setHttpConfig(_config.httpConfig);
...
export class RumAudienceManagementApiResponseProcessor {
   ...
   * @throws ApiException if the response code was not in [200, 299]
   */
   public async getAccountFacetInfo(response: ResponseContext): Promise<FacetInfoResponse> {
    const contentType = ObjectSerializer.normalizeMediaType(response.headers["content-type"]);
   ...
   * @throws ApiException if the response code was not in [200, 299]
   */
   public async getMapping(response: ResponseContext): Promise<GetMappingResponse> {
    const contentType = ObjectSerializer.normalizeMediaType(response.headers["content-type"]);
    if (response.httpStatusCode === 200) {
   ...
   * @throws ApiException if the response code was not in [200, 299]
   */
   public async getUserFacetInfo(response: ResponseContext): Promise<FacetInfoResponse> {
    const contentType = ObjectSerializer.normalizeMediaType(response.headers["content-type"]);
    if (response.httpStatusCode === 200) {
      const body: FacetInfoResponse = ObjectSerializer.deserialize(
        ObjectSerializer.parse(await response.body.text(), contentType),
   ...
   * @throws ApiException if the response code was not in [200, 299]
   */
   public async queryAccounts(response: ResponseContext): Promise<QueryResponse> {
    const contentType = ObjectSerializer.normalizeMediaType(response.headers["content-type"]);
    if (response.httpStatusCode === 200) {
   ...
   * @throws ApiException if the response code was not in [200, 299]
   */
   public async queryEventFilteredUsers(response: ResponseContext): Promise<QueryResponse> {
    const contentType = ObjectSerializer.normalizeMediaType(response.headers["content-type"]);
    if (response.httpStatusCode === 200) {
      const body: QueryResponse = ObjectSerializer.deserialize(
        ObjectSerializer.parse(await response.body.text(), contentType),
...
export class RumAudienceManagementApi {
  ...
  public constructor(configuration: Configuration, requestFactory?: RumAudienceManagementApiRequestFactory, responseProcessor?: RumAudienceManagementApiResponseProcessor) {
    this.configuration = configuration;
    this.requestFactory = requestFactory || new RumAudienceManagementApiRequestFactory(configuration);
    this.responseProcessor = responseProcessor || new RumAudienceManagementApiResponseProcessor();
  }
   ...
   */
  public createConnection(param: RumAudienceManagementApiCreateConnectionRequest, options?: Configuration): Promise<void> {
   ...
   * @param param The request object
   */
  public deleteConnection(param: RumAudienceManagementApiDeleteConnectionRequest, options?: Configuration): Promise<void> {
   ...
   * @param param The request object
   */
  public getAccountFacetInfo(param: RumAudienceManagementApiGetAccountFacetInfoRequest, options?: Configuration): Promise<FacetInfoResponse> {
   ...
   * @param param The request object
   */
  public getMapping(param: RumAudienceManagementApiGetMappingRequest, options?: Configuration): Promise<GetMappingResponse> {
   ...
   * @param param The request object
   */
  public getUserFacetInfo(param: RumAudienceManagementApiGetUserFacetInfoRequest, options?: Configuration): Promise<FacetInfoResponse> {
   ...
   * @param param The request object
   */
  public listConnections(param: RumAudienceManagementApiListConnectionsRequest, options?: Configuration): Promise<ListConnectionsResponse> {
   ...
   * @param param The request object
   */
  public queryAccounts(param: RumAudienceManagementApiQueryAccountsRequest, options?: Configuration): Promise<QueryResponse> {
   ...
   * @param param The request object
   */
  public queryEventFilteredUsers(param: RumAudienceManagementApiQueryEventFilteredUsersRequest, options?: Configuration): Promise<QueryResponse> {
   ...
   * @param param The request object
   */
  public queryUsers(param: RumAudienceManagementApiQueryUsersRequest, options?: Configuration): Promise<QueryResponse> {
   ...
   * @param param The request object
   */
  public updateConnection(param: RumAudienceManagementApiUpdateConnectionRequest, options?: Configuration): Promise<void> {
