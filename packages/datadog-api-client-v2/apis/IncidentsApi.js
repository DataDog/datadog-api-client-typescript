...
exports.IncidentsApiResponseProcessor = exports.IncidentsApiRequestFactory = void 0;
...
var IncidentsApiRequestFactory = /** @class */ (function (_super) {
     ...
     */
    IncidentsApiRequestFactory.prototype.createIncident = function (body, options) {
            ...
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0:
                        ...
                        requestContext = configuration_1.getServer(config, 'IncidentsApi.createIncident').makeRequestContext(localVarPath, http_1.HttpMethod.POST);
     ...
     */
    IncidentsApiRequestFactory.prototype.deleteIncident = function (incidentId, options) {
        return __awaiter(this, void 0, void 0, function () {
            ...
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0:
                        ...
                        localVarPath = '/api/v2/incidents/{incident_id}'
                            .replace('{' + 'incident_id' + '}', encodeURIComponent(String(incidentId)));
                        requestContext = configuration_1.getServer(config, 'IncidentsApi.deleteIncident').makeRequestContext(localVarPath, http_1.HttpMethod.DELETE);
                        requestContext.setHeaderParam("Accept", "application/json, */*;q=0.8");
                        requestContext.setHttpConfig(config.httpConfig);
                        authMethod = null;
                        // Apply auth methods
     ...
     */
    IncidentsApiRequestFactory.prototype.getIncident = function (incidentId, include, options) {
        return __awaiter(this, void 0, void 0, function () {
            var config, localVarPath, requestContext, authMethod;
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0:
                        ...
                        localVarPath = '/api/v2/incidents/{incident_id}'
                            .replace('{' + 'incident_id' + '}', encodeURIComponent(String(incidentId)));
                        requestContext = configuration_1.getServer(config, 'IncidentsApi.getIncident').makeRequestContext(localVarPath, http_1.HttpMethod.GET);
                        requestContext.setHeaderParam("Accept", "application/json, */*;q=0.8");
                        requestContext.setHttpConfig(config.httpConfig);
                        // Query Params
     ...
     */
    IncidentsApiRequestFactory.prototype.listIncidents = function (include, pageSize, pageOffset, options) {
        return __awaiter(this, void 0, void 0, function () {
            var config, localVarPath, requestContext, authMethod;
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0:
                        config = options || this.configuration;
                        localVarPath = '/api/v2/incidents';
                        requestContext = configuration_1.getServer(config, 'IncidentsApi.listIncidents').makeRequestContext(localVarPath, http_1.HttpMethod.GET);
                        requestContext.setHeaderParam("Accept", "application/json, */*;q=0.8");
                        requestContext.setHttpConfig(config.httpConfig);
                        // Query Params
                        if (include !== undefined) {
     ...
     * @param body Incident Payload.
     */
    IncidentsApiRequestFactory.prototype.updateIncident = function (incidentId, body, options) {
        return __awaiter(this, void 0, void 0, function () {
            var config, localVarPath, requestContext, contentType, serializedBody, authMethod;
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0:
                        ...
                        localVarPath = '/api/v2/incidents/{incident_id}'
                            .replace('{' + 'incident_id' + '}', encodeURIComponent(String(incidentId)));
                        requestContext = configuration_1.getServer(config, 'IncidentsApi.updateIncident').makeRequestContext(localVarPath, http_1.HttpMethod.PATCH);
                        requestContext.setHeaderParam("Accept", "application/json, */*;q=0.8");
                        requestContext.setHttpConfig(config.httpConfig);
                        contentType = ObjectSerializer_1.ObjectSerializer.getPreferredMediaType([
                            "application/json"
        ...
        return __awaiter(this, void 0, void 0, function () {
            ...
            return __generator(this, function (_0) {
                switch (_0.label) {
                    ...
                    case 1:
                        body_1 = _b.apply(_a, [_d.apply(_c, [_0.sent(), contentType]), "IncidentResponse", ""]);
                    ...
                    case 10:
                        ...
                        return [4 /*yield*/, response.body.text()];
                    case 11:
                        body_6 = _x.apply(_w, [_z.apply(_y, [_0.sent(), contentType]), "IncidentResponse", ""]);
            ...
            return __generator(this, function (_0) {
                switch (_0.label) {
                    case 0:
                        ...
                        return [4 /*yield*/, response.body.text()];
                    case 1:
                        body_12 = _b.apply(_a, [_d.apply(_c, [_0.sent(), contentType]), "IncidentResponse", ""]);
                    ...
                    case 10:
                        ...
                        return [4 /*yield*/, response.body.text()];
                    case 11:
                        body_17 = _x.apply(_w, [_z.apply(_y, [_0.sent(), contentType]), "IncidentResponse", ""]);
            ...
            return __generator(this, function (_0) {
                switch (_0.label) {
                    case 0:
                        ...
                        return [4 /*yield*/, response.body.text()];
                    case 1:
                        body_18 = _b.apply(_a, [_d.apply(_c, [_0.sent(), contentType]), "IncidentsResponse", ""]);
                    ...
                    case 10:
                        ...
                        return [4 /*yield*/, response.body.text()];
                    case 11:
                        body_23 = _x.apply(_w, [_z.apply(_y, [_0.sent(), contentType]), "IncidentsResponse", ""]);
            ...
            return __generator(this, function (_0) {
                switch (_0.label) {
                    case 0:
                        ...
                        return [4 /*yield*/, response.body.text()];
                    case 1:
                        body_24 = _b.apply(_a, [_d.apply(_c, [_0.sent(), contentType]), "IncidentResponse", ""]);
                    ...
                    case 10:
                        ...
                        return [4 /*yield*/, response.body.text()];
                    case 11:
                        body_29 = _x.apply(_w, [_z.apply(_y, [_0.sent(), contentType]), "IncidentResponse", ""]);
