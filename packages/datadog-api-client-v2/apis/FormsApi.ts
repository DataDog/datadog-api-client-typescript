...
export class FormsApiRequestFactory extends BaseAPIRequestFactory {
  ...
  public async cloneForm(formId: string,body: CloneFormRequest,_options?: Configuration): Promise<RequestContext> {
    const _config = _options || this.configuration;

    logger.warn("Using unstable operation 'cloneForm'");
    if (!_config.unstableOperations['v2.cloneForm']) {
      throw new Error("Unstable operation 'cloneForm' is disabled");
    }
    ...
    // Path Params
    const localVarPath = '/api/v2/forms/{form_id}/clone'
      .replace('{form_id}', encodeURIComponent(String(formId)));

    // Make Request Context
    const requestContext = _config.getServer('v2.FormsApi.cloneForm').makeRequestContext(localVarPath, HttpMethod.POST);
    ...
    const serializedBody = ObjectSerializer.stringify(
      ObjectSerializer.serialize(body, "CloneFormRequest", ""),
      contentType
    );
  ...
  public async createAndPublishForm(body: CreateFormRequest,_options?: Configuration): Promise<RequestContext> {
    const _config = _options || this.configuration;
    ...
    // Make Request Context
    const requestContext = _config.getServer('v2.FormsApi.createAndPublishForm').makeRequestContext(localVarPath, HttpMethod.POST);
    requestContext.setHeaderParam("Accept", "application/json");
    requestContext.setHttpConfig(_config.httpConfig);
  ...
  public async createForm(body: CreateFormRequest,_options?: Configuration): Promise<RequestContext> {
    const _config = _options || this.configuration;
    ...
    // Make Request Context
    const requestContext = _config.getServer('v2.FormsApi.createForm').makeRequestContext(localVarPath, HttpMethod.POST);
    requestContext.setHeaderParam("Accept", "application/json");
    requestContext.setHttpConfig(_config.httpConfig);
  ...
  public async deleteForm(formId: string,_options?: Configuration): Promise<RequestContext> {
    const _config = _options || this.configuration;
    ...
    // Path Params
    const localVarPath = '/api/v2/forms/{form_id}'
      .replace('{form_id}', encodeURIComponent(String(formId)));

    // Make Request Context
    const requestContext = _config.getServer('v2.FormsApi.deleteForm').makeRequestContext(localVarPath, HttpMethod.DELETE);
    requestContext.setHeaderParam("Accept", "application/json");
    requestContext.setHttpConfig(_config.httpConfig);
  ...
  public async getForm(formId: string,version?: string,_options?: Configuration): Promise<RequestContext> {
    const _config = _options || this.configuration;
    ...
    // Make Request Context
    const requestContext = _config.getServer('v2.FormsApi.getForm').makeRequestContext(localVarPath, HttpMethod.GET);
    requestContext.setHeaderParam("Accept", "application/json");
    requestContext.setHttpConfig(_config.httpConfig);
  ...
  public async listForms(_options?: Configuration): Promise<RequestContext> {
    ...
    // Make Request Context
    const requestContext = _config.getServer('v2.FormsApi.listForms').makeRequestContext(localVarPath, HttpMethod.GET);
    requestContext.setHeaderParam("Accept", "application/json");
    requestContext.setHttpConfig(_config.httpConfig);
  ...
  public async publishForm(formId: string,body: PublishFormRequest,_options?: Configuration): Promise<RequestContext> {
    const _config = _options || this.configuration;

    logger.warn("Using unstable operation 'publishForm'");
    if (!_config.unstableOperations['v2.publishForm']) {
      throw new Error("Unstable operation 'publishForm' is disabled");
    }
    ...
    // Path Params
    const localVarPath = '/api/v2/forms/{form_id}/publish'
      .replace('{form_id}', encodeURIComponent(String(formId)));

    // Make Request Context
    const requestContext = _config.getServer('v2.FormsApi.publishForm').makeRequestContext(localVarPath, HttpMethod.POST);
    requestContext.setHeaderParam("Accept", "application/json");
    requestContext.setHttpConfig(_config.httpConfig);
    ...
    requestContext.setHeaderParam("Content-Type", contentType);
    const serializedBody = ObjectSerializer.stringify(
      ObjectSerializer.serialize(body, "PublishFormRequest", ""),
      contentType
    );
    requestContext.setBody(serializedBody);
  ...
  public async updateForm(formId: string,body: UpdateFormRequest,_options?: Configuration): Promise<RequestContext> {
    const _config = _options || this.configuration;

    logger.warn("Using unstable operation 'updateForm'");
    if (!_config.unstableOperations['v2.updateForm']) {
      throw new Error("Unstable operation 'updateForm' is disabled");
    }
    ...
    // Make Request Context
    const requestContext = _config.getServer('v2.FormsApi.updateForm').makeRequestContext(localVarPath, HttpMethod.PATCH);
    requestContext.setHeaderParam("Accept", "application/json");
    requestContext.setHttpConfig(_config.httpConfig);
    ...
    requestContext.setHeaderParam("Content-Type", contentType);
    const serializedBody = ObjectSerializer.stringify(
      ObjectSerializer.serialize(body, "UpdateFormRequest", ""),
      contentType
    );
    requestContext.setBody(serializedBody);
  ...
  public async upsertAndPublishFormVersion(formId: string,body: UpsertAndPublishFormVersionRequest,_options?: Configuration): Promise<RequestContext> {
    const _config = _options || this.configuration;

    logger.warn("Using unstable operation 'upsertAndPublishFormVersion'");
    if (!_config.unstableOperations['v2.upsertAndPublishFormVersion']) {
      throw new Error("Unstable operation 'upsertAndPublishFormVersion' is disabled");
    }
    ...
    // Path Params
    const localVarPath = '/api/v2/forms/{form_id}/versions/upsert_and_publish'
      .replace('{form_id}', encodeURIComponent(String(formId)));

    // Make Request Context
    const requestContext = _config.getServer('v2.FormsApi.upsertAndPublishFormVersion').makeRequestContext(localVarPath, HttpMethod.POST);
    requestContext.setHeaderParam("Accept", "application/json");
    requestContext.setHttpConfig(_config.httpConfig);
    ...
    requestContext.setHeaderParam("Content-Type", contentType);
    const serializedBody = ObjectSerializer.stringify(
      ObjectSerializer.serialize(body, "UpsertAndPublishFormVersionRequest", ""),
      contentType
    );
    requestContext.setBody(serializedBody);
  ...
  public async upsertFormVersion(formId: string,body: UpsertFormVersionRequest,_options?: Configuration): Promise<RequestContext> {
    const _config = _options || this.configuration;

    logger.warn("Using unstable operation 'upsertFormVersion'");
    if (!_config.unstableOperations['v2.upsertFormVersion']) {
      throw new Error("Unstable operation 'upsertFormVersion' is disabled");
    }
    ...
    // Path Params
    const localVarPath = '/api/v2/forms/{form_id}/versions'
      .replace('{form_id}', encodeURIComponent(String(formId)));

    // Make Request Context
    const requestContext = _config.getServer('v2.FormsApi.upsertFormVersion').makeRequestContext(localVarPath, HttpMethod.POST);
    requestContext.setHeaderParam("Accept", "application/json");
    requestContext.setHttpConfig(_config.httpConfig);
    ...
    requestContext.setHeaderParam("Content-Type", contentType);
    const serializedBody = ObjectSerializer.stringify(
      ObjectSerializer.serialize(body, "UpsertFormVersionRequest", ""),
      contentType
    );
    requestContext.setBody(serializedBody);
...
export class FormsApiResponseProcessor {
   ...
   * @throws ApiException if the response code was not in [200, 299]
   */
   public async createAndPublishForm(response: ResponseContext): Promise<FormResponse> {
    const contentType = ObjectSerializer.normalizeMediaType(response.headers["content-type"]);
    if (response.httpStatusCode === 200) {
      const body: FormResponse = ObjectSerializer.deserialize(
        ObjectSerializer.parse(await response.body.text(), contentType),
   ...
   * @throws ApiException if the response code was not in [200, 299]
   */
   public async deleteForm(response: ResponseContext): Promise<DeleteFormResponse> {
    const contentType = ObjectSerializer.normalizeMediaType(response.headers["content-type"]);
    if (response.httpStatusCode === 200) {
   ...
   * @throws ApiException if the response code was not in [200, 299]
   */
   public async publishForm(response: ResponseContext): Promise<FormPublicationResponse> {
    const contentType = ObjectSerializer.normalizeMediaType(response.headers["content-type"]);
    if (response.httpStatusCode === 200) {
      const body: FormPublicationResponse = ObjectSerializer.deserialize(
        ObjectSerializer.parse(await response.body.text(), contentType),
   ...
   * @throws ApiException if the response code was not in [200, 299]
   */
   public async upsertAndPublishFormVersion(response: ResponseContext): Promise<FormResponse> {
    const contentType = ObjectSerializer.normalizeMediaType(response.headers["content-type"]);
    if (response.httpStatusCode === 200) {
      const body: FormResponse = ObjectSerializer.deserialize(
        ObjectSerializer.parse(await response.body.text(), contentType),
   ...
   * @throws ApiException if the response code was not in [200, 299]
   */
   public async upsertFormVersion(response: ResponseContext): Promise<FormVersionResponse> {
    const contentType = ObjectSerializer.normalizeMediaType(response.headers["content-type"]);
    if (response.httpStatusCode === 200) {
...
export class FormsApi {
   ...
   */
  public cloneForm(param: FormsApiCloneFormRequest, options?: Configuration): Promise<FormResponse> {
    const requestContextPromise = this.requestFactory.cloneForm(param.formId,param.body,options);
   ...
   * @param param The request object
   */
  public createAndPublishForm(param: FormsApiCreateAndPublishFormRequest, options?: Configuration): Promise<FormResponse> {
    const requestContextPromise = this.requestFactory.createAndPublishForm(param.body,options);
    return requestContextPromise.then(requestContext => {
        return this.configuration.httpApi.send(requestContext).then(responseContext => {
   ...
   * @param param The request object
   */
  public createForm(param: FormsApiCreateFormRequest, options?: Configuration): Promise<FormResponse> {
    const requestContextPromise = this.requestFactory.createForm(param.body,options);
    return requestContextPromise.then(requestContext => {
        return this.configuration.httpApi.send(requestContext).then(responseContext => {
   ...
   * @param param The request object
   */
  public deleteForm(param: FormsApiDeleteFormRequest, options?: Configuration): Promise<DeleteFormResponse> {
    const requestContextPromise = this.requestFactory.deleteForm(param.formId,options);
    return requestContextPromise.then(requestContext => {
        return this.configuration.httpApi.send(requestContext).then(responseContext => {
   ...
   * @param param The request object
   */
  public getForm(param: FormsApiGetFormRequest, options?: Configuration): Promise<FormResponse> {
    const requestContextPromise = this.requestFactory.getForm(param.formId,param.version,options);
    return requestContextPromise.then(requestContext => {
        return this.configuration.httpApi.send(requestContext).then(responseContext => {
   ...
   * @param param The request object
   */
  public publishForm(param: FormsApiPublishFormRequest, options?: Configuration): Promise<FormPublicationResponse> {
    const requestContextPromise = this.requestFactory.publishForm(param.formId,param.body,options);
    return requestContextPromise.then(requestContext => {
        return this.configuration.httpApi.send(requestContext).then(responseContext => {
   ...
   * @param param The request object
   */
  public updateForm(param: FormsApiUpdateFormRequest, options?: Configuration): Promise<FormResponse> {
    const requestContextPromise = this.requestFactory.updateForm(param.formId,param.body,options);
    return requestContextPromise.then(requestContext => {
        return this.configuration.httpApi.send(requestContext).then(responseContext => {
   ...
   * @param param The request object
   */
  public upsertAndPublishFormVersion(param: FormsApiUpsertAndPublishFormVersionRequest, options?: Configuration): Promise<FormResponse> {
    const requestContextPromise = this.requestFactory.upsertAndPublishFormVersion(param.formId,param.body,options);
    return requestContextPromise.then(requestContext => {
        return this.configuration.httpApi.send(requestContext).then(responseContext => {
   ...
   * @param param The request object
   */
  public upsertFormVersion(param: FormsApiUpsertFormVersionRequest, options?: Configuration): Promise<FormVersionResponse> {
    const requestContextPromise = this.requestFactory.upsertFormVersion(param.formId,param.body,options);
    return requestContextPromise.then(requestContext => {
        return this.configuration.httpApi.send(requestContext).then(responseContext => {
