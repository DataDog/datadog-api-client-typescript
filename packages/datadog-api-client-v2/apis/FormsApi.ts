...
export class FormsApiRequestFactory extends BaseAPIRequestFactory {
  public async cloneForm(
    ...
    const requestContext = _config
      .getServer("v2.FormsApi.cloneForm")
  ...
  public async publishForm(
    ...
    // Make Request Context
    const requestContext = _config
      .getServer("v2.FormsApi.publishForm")
      .makeRequestContext(localVarPath, HttpMethod.POST);
    requestContext.setHeaderParam("Accept", "application/json");
    requestContext.setHttpConfig(_config.httpConfig);
  ...
  public async updateForm(
    ...
    // Make Request Context
    const requestContext = _config
      .getServer("v2.FormsApi.updateForm")
  ...
  public async upsertAndPublishFormVersion(
    ...
    if (!_config.unstableOperations["v2.upsertAndPublishFormVersion"]) {
      throw new Error(
        "Unstable operation 'upsertAndPublishFormVersion' is disabled"
      );
    }
    ...
    // Make Request Context
    const requestContext = _config
      .getServer("v2.FormsApi.upsertAndPublishFormVersion")
      .makeRequestContext(localVarPath, HttpMethod.POST);
    requestContext.setHeaderParam("Accept", "application/json");
    requestContext.setHttpConfig(_config.httpConfig);
  ...
  public async upsertFormVersion(
    ...
    // Make Request Context
    const requestContext = _config
      .getServer("v2.FormsApi.upsertFormVersion")
      .makeRequestContext(localVarPath, HttpMethod.POST);
    requestContext.setHeaderParam("Accept", "application/json");
    requestContext.setHttpConfig(_config.httpConfig);
