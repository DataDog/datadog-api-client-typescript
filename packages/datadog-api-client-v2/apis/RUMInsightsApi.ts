...
export class RUMInsightsApiRequestFactory extends BaseAPIRequestFactory {
  ...
  public async queryAggregatedLongTasks(body: AggregatedLongTasksRequest,_options?: Configuration): Promise<RequestContext> {
    ...
    if (!_config.unstableOperations['v2.queryAggregatedLongTasks']) {
      throw new Error("Unstable operation 'queryAggregatedLongTasks' is disabled");
    }
    ...
    const requestContext = _config.getServer('v2.RUMInsightsApi.queryAggregatedLongTasks').makeRequestContext(localVarPath, HttpMethod.POST);
  ...
  public async queryAggregatedSignalsProblems(body: AggregatedSignalsProblemsRequest,_options?: Configuration): Promise<RequestContext> {
    const _config = _options || this.configuration;
    ...
    if (!_config.unstableOperations['v2.queryAggregatedSignalsProblems']) {
      throw new Error("Unstable operation 'queryAggregatedSignalsProblems' is disabled");
    }
    ...
    // Make Request Context
    const requestContext = _config.getServer('v2.RUMInsightsApi.queryAggregatedSignalsProblems').makeRequestContext(localVarPath, HttpMethod.POST);
    requestContext.setHeaderParam("Accept", "application/json");
    requestContext.setHttpConfig(_config.httpConfig);
  ...
  public async queryAggregatedWaterfall(body: AggregatedWaterfallRequest,_options?: Configuration): Promise<RequestContext> {
    const _config = _options || this.configuration;

    logger.warn("Using unstable operation 'queryAggregatedWaterfall'");
    if (!_config.unstableOperations['v2.queryAggregatedWaterfall']) {
      throw new Error("Unstable operation 'queryAggregatedWaterfall' is disabled");
    }
    ...
    // Make Request Context
    const requestContext = _config.getServer('v2.RUMInsightsApi.queryAggregatedWaterfall').makeRequestContext(localVarPath, HttpMethod.POST);
    requestContext.setHeaderParam("Accept", "application/json");
    requestContext.setHttpConfig(_config.httpConfig);
...
export class RUMInsightsApiResponseProcessor {
   ...
   */
   public async queryAggregatedLongTasks(response: ResponseContext): Promise<AggregatedLongTasksResponse> {
   ...
   * @throws ApiException if the response code was not in [200, 299]
   */
   public async queryAggregatedSignalsProblems(response: ResponseContext): Promise<AggregatedSignalsProblemsResponse> {
    const contentType = ObjectSerializer.normalizeMediaType(response.headers["content-type"]);
    if (response.httpStatusCode === 201) {
      const body: AggregatedSignalsProblemsResponse = ObjectSerializer.deserialize(
        ObjectSerializer.parse(await response.body.text(), contentType),
   ...
   * @throws ApiException if the response code was not in [200, 299]
   */
   public async queryAggregatedWaterfall(response: ResponseContext): Promise<AggregatedWaterfallResponse> {
    const contentType = ObjectSerializer.normalizeMediaType(response.headers["content-type"]);
    if (response.httpStatusCode === 201) {
...
export class RUMInsightsApi {
  ...
  public constructor(configuration: Configuration, requestFactory?: RUMInsightsApiRequestFactory, responseProcessor?: RUMInsightsApiResponseProcessor) {
    this.configuration = configuration;
    this.requestFactory = requestFactory || new RUMInsightsApiRequestFactory(configuration);
    this.responseProcessor = responseProcessor || new RUMInsightsApiResponseProcessor();
  }
   ...
   */
  public queryAggregatedLongTasks(param: RUMInsightsApiQueryAggregatedLongTasksRequest, options?: Configuration): Promise<AggregatedLongTasksResponse> {
    const requestContextPromise = this.requestFactory.queryAggregatedLongTasks(param.body,options);
   ...
   * @param param The request object
   */
  public queryAggregatedSignalsProblems(param: RUMInsightsApiQueryAggregatedSignalsProblemsRequest, options?: Configuration): Promise<AggregatedSignalsProblemsResponse> {
    const requestContextPromise = this.requestFactory.queryAggregatedSignalsProblems(param.body,options);
    return requestContextPromise.then(requestContext => {
        return this.configuration.httpApi.send(requestContext).then(responseContext => {
   ...
   * @param param The request object
   */
  public queryAggregatedWaterfall(param: RUMInsightsApiQueryAggregatedWaterfallRequest, options?: Configuration): Promise<AggregatedWaterfallResponse> {
    const requestContextPromise = this.requestFactory.queryAggregatedWaterfall(param.body,options);
    return requestContextPromise.then(requestContext => {
        return this.configuration.httpApi.send(requestContext).then(responseContext => {
