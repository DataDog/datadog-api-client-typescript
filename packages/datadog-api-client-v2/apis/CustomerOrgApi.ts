...
export class CustomerOrgApiRequestFactory extends BaseAPIRequestFactory {
  ...
  public async disableCustomerOrg(body: CustomerOrgDisableRequest,_options?: Configuration): Promise<RequestContext> {
    ...
    const requestContext = _config.getServer('v2.CustomerOrgApi.disableCustomerOrg').makeRequestContext(localVarPath, HttpMethod.POST);
...
export class CustomerOrgApiResponseProcessor {
   ...
   */
   public async disableCustomerOrg(response: ResponseContext): Promise<CustomerOrgDisableResponse> {
...
export class CustomerOrgApi {
  ...
  public constructor(configuration: Configuration, requestFactory?: CustomerOrgApiRequestFactory, responseProcessor?: CustomerOrgApiResponseProcessor) {
    this.configuration = configuration;
    this.requestFactory = requestFactory || new CustomerOrgApiRequestFactory(configuration);
    this.responseProcessor = responseProcessor || new CustomerOrgApiResponseProcessor();
  }
   ...
   */
  public disableCustomerOrg(param: CustomerOrgApiDisableCustomerOrgRequest, options?: Configuration): Promise<CustomerOrgDisableResponse> {
    const requestContextPromise = this.requestFactory.disableCustomerOrg(param.body,options);
