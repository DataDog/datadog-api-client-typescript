...
export class StatuspageIntegrationApiRequestFactory extends BaseAPIRequestFactory {
  ...
  public async createStatuspageAccount(body: StatuspageAccountCreateRequest,_options?: Configuration): Promise<RequestContext> {
    ...
    const requestContext = _config.getServer('v2.StatuspageIntegrationApi.createStatuspageAccount').makeRequestContext(localVarPath, HttpMethod.POST);
  ...
  public async createStatuspageUrlSetting(body: StatuspageUrlSettingCreateRequest,_options?: Configuration): Promise<RequestContext> {
    const _config = _options || this.configuration;
    ...
    // Make Request Context
    const requestContext = _config.getServer('v2.StatuspageIntegrationApi.createStatuspageUrlSetting').makeRequestContext(localVarPath, HttpMethod.POST);
    requestContext.setHeaderParam("Accept", "application/json");
    requestContext.setHttpConfig(_config.httpConfig);
  ...
  public async deleteStatuspageAccount(_options?: Configuration): Promise<RequestContext> {
    const _config = _options || this.configuration;
    ...
    // Make Request Context
    const requestContext = _config.getServer('v2.StatuspageIntegrationApi.deleteStatuspageAccount').makeRequestContext(localVarPath, HttpMethod.DELETE);
  ...
  public async deleteStatuspageUrlSetting(statuspageUrlSettingId: string,_options?: Configuration): Promise<RequestContext> {
    const _config = _options || this.configuration;
    ...
    // Path Params
    const localVarPath = '/api/v2/integration/statuspage/url_settings/{statuspage_url_setting_id}'
      .replace('{statuspage_url_setting_id}', encodeURIComponent(String(statuspageUrlSettingId)));

    // Make Request Context
    const requestContext = _config.getServer('v2.StatuspageIntegrationApi.deleteStatuspageUrlSetting').makeRequestContext(localVarPath, HttpMethod.DELETE);
    requestContext.setHeaderParam("Accept", "*/*");
    requestContext.setHttpConfig(_config.httpConfig);
  ...
  public async getStatuspageAccount(_options?: Configuration): Promise<RequestContext> {
    const _config = _options || this.configuration;
    ...
    // Make Request Context
    const requestContext = _config.getServer('v2.StatuspageIntegrationApi.getStatuspageAccount').makeRequestContext(localVarPath, HttpMethod.GET);
    requestContext.setHeaderParam("Accept", "application/json");
    requestContext.setHttpConfig(_config.httpConfig);
  ...
  public async listStatuspageUrlSettings(_options?: Configuration): Promise<RequestContext> {
    const _config = _options || this.configuration;
    ...
    // Make Request Context
    const requestContext = _config.getServer('v2.StatuspageIntegrationApi.listStatuspageUrlSettings').makeRequestContext(localVarPath, HttpMethod.GET);
    requestContext.setHeaderParam("Accept", "application/json");
    requestContext.setHttpConfig(_config.httpConfig);
  ...
  public async updateStatuspageAccount(body: StatuspageAccountUpdateRequest,_options?: Configuration): Promise<RequestContext> {
    const _config = _options || this.configuration;
    ...
    // Make Request Context
    const requestContext = _config.getServer('v2.StatuspageIntegrationApi.updateStatuspageAccount').makeRequestContext(localVarPath, HttpMethod.PATCH);
    requestContext.setHeaderParam("Accept", "application/json");
    requestContext.setHttpConfig(_config.httpConfig);
  ...
  public async updateStatuspageUrlSetting(statuspageUrlSettingId: string,body: StatuspageUrlSettingUpdateRequest,_options?: Configuration): Promise<RequestContext> {
    const _config = _options || this.configuration;
    ...
    // Make Request Context
    const requestContext = _config.getServer('v2.StatuspageIntegrationApi.updateStatuspageUrlSetting').makeRequestContext(localVarPath, HttpMethod.PATCH);
    requestContext.setHeaderParam("Accept", "application/json");
    requestContext.setHttpConfig(_config.httpConfig);
...
export class StatuspageIntegrationApiResponseProcessor {
   ...
   */
   public async createStatuspageAccount(response: ResponseContext): Promise<StatuspageAccountResponse> {
   ...
   * @throws ApiException if the response code was not in [200, 299]
   */
   public async createStatuspageUrlSetting(response: ResponseContext): Promise<StatuspageUrlSettingResponse> {
    const contentType = ObjectSerializer.normalizeMediaType(response.headers["content-type"]);
    if (response.httpStatusCode === 201) {
   ...
   * @throws ApiException if the response code was not in [200, 299]
   */
   public async deleteStatuspageAccount(response: ResponseContext): Promise<void> {
    const contentType = ObjectSerializer.normalizeMediaType(response.headers["content-type"]);
   ...
   * @throws ApiException if the response code was not in [200, 299]
   */
   public async deleteStatuspageUrlSetting(response: ResponseContext): Promise<void> {
    const contentType = ObjectSerializer.normalizeMediaType(response.headers["content-type"]);
    if (response.httpStatusCode === 204) {
      return;
    }
   ...
   * @throws ApiException if the response code was not in [200, 299]
   */
   public async getStatuspageAccount(response: ResponseContext): Promise<StatuspageAccountResponse> {
    const contentType = ObjectSerializer.normalizeMediaType(response.headers["content-type"]);
   ...
   * @throws ApiException if the response code was not in [200, 299]
   */
   public async listStatuspageUrlSettings(response: ResponseContext): Promise<StatuspageUrlSettingsResponse> {
    const contentType = ObjectSerializer.normalizeMediaType(response.headers["content-type"]);
    if (response.httpStatusCode === 200) {
   ...
   * @throws ApiException if the response code was not in [200, 299]
   */
   public async updateStatuspageAccount(response: ResponseContext): Promise<StatuspageAccountResponse> {
    const contentType = ObjectSerializer.normalizeMediaType(response.headers["content-type"]);
    if (response.httpStatusCode === 200) {
      const body: StatuspageAccountResponse = ObjectSerializer.deserialize(
        ObjectSerializer.parse(await response.body.text(), contentType),
   ...
   * @throws ApiException if the response code was not in [200, 299]
   */
   public async updateStatuspageUrlSetting(response: ResponseContext): Promise<StatuspageUrlSettingResponse> {
    const contentType = ObjectSerializer.normalizeMediaType(response.headers["content-type"]);
    if (response.httpStatusCode === 200) {
      const body: StatuspageUrlSettingResponse = ObjectSerializer.deserialize(
        ObjectSerializer.parse(await response.body.text(), contentType),
...
export class StatuspageIntegrationApi {
  ...
  public constructor(configuration: Configuration, requestFactory?: StatuspageIntegrationApiRequestFactory, responseProcessor?: StatuspageIntegrationApiResponseProcessor) {
    this.configuration = configuration;
    this.requestFactory = requestFactory || new StatuspageIntegrationApiRequestFactory(configuration);
    this.responseProcessor = responseProcessor || new StatuspageIntegrationApiResponseProcessor();
  }
   ...
   */
  public createStatuspageAccount(param: StatuspageIntegrationApiCreateStatuspageAccountRequest, options?: Configuration): Promise<StatuspageAccountResponse> {
    const requestContextPromise = this.requestFactory.createStatuspageAccount(param.body,options);
   ...
   * @param param The request object
   */
  public createStatuspageUrlSetting(param: StatuspageIntegrationApiCreateStatuspageUrlSettingRequest, options?: Configuration): Promise<StatuspageUrlSettingResponse> {
    const requestContextPromise = this.requestFactory.createStatuspageUrlSetting(param.body,options);
    return requestContextPromise.then(requestContext => {
        return this.configuration.httpApi.send(requestContext).then(responseContext => {
  ...
  public deleteStatuspageAccount( options?: Configuration): Promise<void> {
    const requestContextPromise = this.requestFactory.deleteStatuspageAccount(options);
    return requestContextPromise.then(requestContext => {
        return this.configuration.httpApi.send(requestContext).then(responseContext => {
   ...
   * @param param The request object
   */
  public deleteStatuspageUrlSetting(param: StatuspageIntegrationApiDeleteStatuspageUrlSettingRequest, options?: Configuration): Promise<void> {
    const requestContextPromise = this.requestFactory.deleteStatuspageUrlSetting(param.statuspageUrlSettingId,options);
    return requestContextPromise.then(requestContext => {
        return this.configuration.httpApi.send(requestContext).then(responseContext => {
   ...
   * @param param The request object
   */
  public getStatuspageAccount( options?: Configuration): Promise<StatuspageAccountResponse> {
    const requestContextPromise = this.requestFactory.getStatuspageAccount(options);
    return requestContextPromise.then(requestContext => {
        return this.configuration.httpApi.send(requestContext).then(responseContext => {
   ...
   * @param param The request object
   */
  public listStatuspageUrlSettings( options?: Configuration): Promise<StatuspageUrlSettingsResponse> {
    const requestContextPromise = this.requestFactory.listStatuspageUrlSettings(options);
    return requestContextPromise.then(requestContext => {
        return this.configuration.httpApi.send(requestContext).then(responseContext => {
   ...
   * @param param The request object
   */
  public updateStatuspageAccount(param: StatuspageIntegrationApiUpdateStatuspageAccountRequest, options?: Configuration): Promise<StatuspageAccountResponse> {
    const requestContextPromise = this.requestFactory.updateStatuspageAccount(param.body,options);
    return requestContextPromise.then(requestContext => {
        return this.configuration.httpApi.send(requestContext).then(responseContext => {
   ...
   * @param param The request object
   */
  public updateStatuspageUrlSetting(param: StatuspageIntegrationApiUpdateStatuspageUrlSettingRequest, options?: Configuration): Promise<StatuspageUrlSettingResponse> {
    const requestContextPromise = this.requestFactory.updateStatuspageUrlSetting(param.statuspageUrlSettingId,param.body,options);
    return requestContextPromise.then(requestContext => {
        return this.configuration.httpApi.send(requestContext).then(responseContext => {
