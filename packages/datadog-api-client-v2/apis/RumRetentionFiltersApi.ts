...
export class RumRetentionFiltersApiRequestFactory extends BaseAPIRequestFactory {
  ...
  public async getPermanentRetentionFilter(appId: string,permanentRfId: RumPermanentRetentionFilterID,_options?: Configuration): Promise<RequestContext> {
    const _config = _options || this.configuration;
    ...
    // Path Params
    const localVarPath = '/api/v2/rum/applications/{app_id}/retention_filters/permanent/{permanent_rf_id}'
      .replace('{app_id}', encodeURIComponent(String(appId)))
      .replace('{permanent_rf_id}', encodeURIComponent(String(permanentRfId)));

    // Make Request Context
    const requestContext = _config.getServer('v2.RumRetentionFiltersApi.getPermanentRetentionFilter').makeRequestContext(localVarPath, HttpMethod.GET);
    requestContext.setHeaderParam("Accept", "application/json");
    requestContext.setHttpConfig(_config.httpConfig);
  ...
  public async listPermanentRetentionFilters(appId: string,_options?: Configuration): Promise<RequestContext> {
    const _config = _options || this.configuration;
    ...
    // Path Params
    const localVarPath = '/api/v2/rum/applications/{app_id}/retention_filters/permanent'
      .replace('{app_id}', encodeURIComponent(String(appId)));

    // Make Request Context
    const requestContext = _config.getServer('v2.RumRetentionFiltersApi.listPermanentRetentionFilters').makeRequestContext(localVarPath, HttpMethod.GET);
    requestContext.setHeaderParam("Accept", "application/json");
    requestContext.setHttpConfig(_config.httpConfig);
  ...
  public async updatePermanentRetentionFilter(appId: string,permanentRfId: RumPermanentRetentionFilterID,body: RumPermanentRetentionFilterUpdateRequest,_options?: Configuration): Promise<RequestContext> {
    const _config = _options || this.configuration;
    ...
    // Make Request Context
    const requestContext = _config.getServer('v2.RumRetentionFiltersApi.updatePermanentRetentionFilter').makeRequestContext(localVarPath, HttpMethod.PATCH);
    requestContext.setHeaderParam("Accept", "application/json");
    requestContext.setHttpConfig(_config.httpConfig);
    ...
    requestContext.setHeaderParam("Content-Type", contentType);
    const serializedBody = ObjectSerializer.stringify(
      ObjectSerializer.serialize(body, "RumPermanentRetentionFilterUpdateRequest", ""),
      contentType
    );
    requestContext.setBody(serializedBody);
...
export class RumRetentionFiltersApiResponseProcessor {
   ...
   * @throws ApiException if the response code was not in [200, 299]
   */
   public async getPermanentRetentionFilter(response: ResponseContext): Promise<RumPermanentRetentionFilterResponse> {
    const contentType = ObjectSerializer.normalizeMediaType(response.headers["content-type"]);
    if (response.httpStatusCode === 200) {
      const body: RumPermanentRetentionFilterResponse = ObjectSerializer.deserialize(
        ObjectSerializer.parse(await response.body.text(), contentType),
   ...
   * @throws ApiException if the response code was not in [200, 299]
   */
   public async listPermanentRetentionFilters(response: ResponseContext): Promise<RumPermanentRetentionFiltersResponse> {
    const contentType = ObjectSerializer.normalizeMediaType(response.headers["content-type"]);
    if (response.httpStatusCode === 200) {
      const body: RumPermanentRetentionFiltersResponse = ObjectSerializer.deserialize(
        ObjectSerializer.parse(await response.body.text(), contentType),
   ...
   * @throws ApiException if the response code was not in [200, 299]
   */
   public async updatePermanentRetentionFilter(response: ResponseContext): Promise<RumPermanentRetentionFilterResponse> {
    const contentType = ObjectSerializer.normalizeMediaType(response.headers["content-type"]);
    if (response.httpStatusCode === 200) {
      const body: RumPermanentRetentionFilterResponse = ObjectSerializer.deserialize(
        ObjectSerializer.parse(await response.body.text(), contentType),
...
export class RumRetentionFiltersApi {
   ...
   * @param param The request object
   */
  public getPermanentRetentionFilter(param: RumRetentionFiltersApiGetPermanentRetentionFilterRequest, options?: Configuration): Promise<RumPermanentRetentionFilterResponse> {
    const requestContextPromise = this.requestFactory.getPermanentRetentionFilter(param.appId,param.permanentRfId,options);
    return requestContextPromise.then(requestContext => {
        return this.configuration.httpApi.send(requestContext).then(responseContext => {
   ...
   * @param param The request object
   */
  public listPermanentRetentionFilters(param: RumRetentionFiltersApiListPermanentRetentionFiltersRequest, options?: Configuration): Promise<RumPermanentRetentionFiltersResponse> {
    const requestContextPromise = this.requestFactory.listPermanentRetentionFilters(param.appId,options);
    return requestContextPromise.then(requestContext => {
        return this.configuration.httpApi.send(requestContext).then(responseContext => {
   ...
   * @param param The request object
   */
  public updatePermanentRetentionFilter(param: RumRetentionFiltersApiUpdatePermanentRetentionFilterRequest, options?: Configuration): Promise<RumPermanentRetentionFilterResponse> {
    const requestContextPromise = this.requestFactory.updatePermanentRetentionFilter(param.appId,param.permanentRfId,param.body,options);
    return requestContextPromise.then(requestContext => {
        return this.configuration.httpApi.send(requestContext).then(responseContext => {
