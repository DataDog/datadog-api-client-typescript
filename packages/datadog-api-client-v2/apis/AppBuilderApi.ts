...
export class AppBuilderApi {
  ...
  /**
   * Publish an app for use by other users. You will also need to set a [Restriction Policy](https://docs.datadoghq.com/api/latest/restriction-policies/) on the app if a policy does not yet exist to ensure the app is accessible to the correct users.
   * @param param The request object
   */
  public publishApp(
  ...
  /**
   * Unpublish an app, removing the live version of the app. Unpublishing creates a new instance of a `deployment` object on the app, with a nil `app_version_id` i.e. `00000000-0000-0000-0000-000000000000`. The app can still be updated and published again in the future.
   * @param param The request object
   */
  public unpublishApp(
