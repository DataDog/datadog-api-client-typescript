...
export class BitsAIApiRequestFactory extends BaseAPIRequestFactory {
  ...
  public async getInvestigation(id: string,_options?: Configuration): Promise<RequestContext> {
    ...
    // Path Params
    const localVarPath = '/api/v2/bits-ai/investigations/{id}'
      .replace('{id}', encodeURIComponent(String(id)));

    // Make Request Context
    const requestContext = _config.getServer('v2.BitsAIApi.getInvestigation').makeRequestContext(localVarPath, HttpMethod.GET);
  ...
  public async listInvestigations(pageOffset?: number,pageLimit?: number,filterMonitorId?: number,_options?: Configuration): Promise<RequestContext> {
    const _config = _options || this.configuration;
    ...
    // Make Request Context
    const requestContext = _config.getServer('v2.BitsAIApi.listInvestigations').makeRequestContext(localVarPath, HttpMethod.GET);
    requestContext.setHeaderParam("Accept", "application/json");
    requestContext.setHttpConfig(_config.httpConfig);
  ...
  if (filterMonitorId !== undefined) {
      requestContext.setQueryParam("filter[monitor_id]", ObjectSerializer.serialize(filterMonitorId, "number", "int64"
), "");
    }
  ...
  public async triggerInvestigation(body: TriggerInvestigationRequest,_options?: Configuration): Promise<RequestContext> {
    const _config = _options || this.configuration;
    ...
    // Make Request Context
    const requestContext = _config.getServer('v2.BitsAIApi.triggerInvestigation').makeRequestContext(localVarPath, HttpMethod.POST);
    requestContext.setHeaderParam("Accept", "application/json");
    requestContext.setHttpConfig(_config.httpConfig);
...
export class BitsAIApiResponseProcessor {
   ...
   */
   public async getInvestigation(response: ResponseContext): Promise<GetInvestigationResponse> {
   ...
   * @throws ApiException if the response code was not in [200, 299]
   */
   public async listInvestigations(response: ResponseContext): Promise<ListInvestigationsResponse> {
    const contentType = ObjectSerializer.normalizeMediaType(response.headers["content-type"]);
    if (response.httpStatusCode === 200) {
   ...
   * @throws ApiException if the response code was not in [200, 299]
   */
   public async triggerInvestigation(response: ResponseContext): Promise<TriggerInvestigationResponse> {
    const contentType = ObjectSerializer.normalizeMediaType(response.headers["content-type"]);
    if (response.httpStatusCode === 200) {
...
export class BitsAIApi {
  ...
  public constructor(configuration: Configuration, requestFactory?: BitsAIApiRequestFactory, responseProcessor?: BitsAIApiResponseProcessor) {
    this.configuration = configuration;
    this.requestFactory = requestFactory || new BitsAIApiRequestFactory(configuration);
    this.responseProcessor = responseProcessor || new BitsAIApiResponseProcessor();
  }
   ...
   */
  public getInvestigation(param: BitsAIApiGetInvestigationRequest, options?: Configuration): Promise<GetInvestigationResponse> {
   ...
   * @param param The request object
   */
  public listInvestigations(param: BitsAIApiListInvestigationsRequest = {}, options?: Configuration): Promise<ListInvestigationsResponse> {
...
/**
   ...
   * @param param The request object
   */
  public triggerInvestigation(param: BitsAIApiTriggerInvestigationRequest, options?: Configuration): Promise<TriggerInvestigationResponse> {
