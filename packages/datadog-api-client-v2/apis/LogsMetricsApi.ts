...
export class LogsMetricsApiRequestFactory extends BaseAPIRequestFactory {
  ...
  public async createLogsMetric(body: LogsMetricCreateRequest,_options?: Configuration): Promise<RequestContext> {
    ...
    const requestContext = getServer(_config, 'LogsMetricsApi.createLogsMetric').makeRequestContext(localVarPath, HttpMethod.POST);
  ...
  public async deleteLogsMetric(metricId: string,_options?: Configuration): Promise<RequestContext> {
    ...
    // Make Request Context
    const requestContext = getServer(_config, 'LogsMetricsApi.deleteLogsMetric').makeRequestContext(localVarPath, HttpMethod.DELETE);
  ...
  public async getLogsMetric(metricId: string,_options?: Configuration): Promise<RequestContext> {
    ...
    // Make Request Context
    const requestContext = getServer(_config, 'LogsMetricsApi.getLogsMetric').makeRequestContext(localVarPath, HttpMethod.GET);
    requestContext.setHeaderParam("Accept", "application/json");
    requestContext.setHttpConfig(_config.httpConfig);
  ...
  public async listLogsMetrics(_options?: Configuration): Promise<RequestContext> {
    ...
    // Make Request Context
    const requestContext = getServer(_config, 'LogsMetricsApi.listLogsMetrics').makeRequestContext(localVarPath, HttpMethod.GET);
    requestContext.setHeaderParam("Accept", "application/json");
    requestContext.setHttpConfig(_config.httpConfig);
  ...
  public async updateLogsMetric(metricId: string,body: LogsMetricUpdateRequest,_options?: Configuration): Promise<RequestContext> {
    ...
    // Make Request Context
    const requestContext = getServer(_config, 'LogsMetricsApi.updateLogsMetric').makeRequestContext(localVarPath, HttpMethod.PATCH);
    requestContext.setHeaderParam("Accept", "application/json");
    requestContext.setHttpConfig(_config.httpConfig);
