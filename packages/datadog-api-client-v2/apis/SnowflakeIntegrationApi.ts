...
export class SnowflakeIntegrationApiRequestFactory extends BaseAPIRequestFactory {
  public async createSnowflakeIntegrationAccount(
    ...
    logger.warn("Using unstable operation 'createSnowflakeIntegrationAccount'");
    if (!_config.unstableOperations["v2.createSnowflakeIntegrationAccount"]) {
      throw new Error(
        "Unstable operation 'createSnowflakeIntegrationAccount' is disabled"
      );
    }
    ...
    const requestContext = _config
      .getServer("v2.SnowflakeIntegrationApi.createSnowflakeIntegrationAccount")
  ...
  public async deleteSnowflakeIntegrationAccount(
    ...
    logger.warn("Using unstable operation 'deleteSnowflakeIntegrationAccount'");
    if (!_config.unstableOperations["v2.deleteSnowflakeIntegrationAccount"]) {
      throw new Error(
        "Unstable operation 'deleteSnowflakeIntegrationAccount' is disabled"
      );
    }
    ...
    // Make Request Context
    const requestContext = _config
      .getServer("v2.SnowflakeIntegrationApi.deleteSnowflakeIntegrationAccount")
  ...
  public async getSnowflakeIntegrationAccount(
    ...
    logger.warn("Using unstable operation 'getSnowflakeIntegrationAccount'");
    if (!_config.unstableOperations["v2.getSnowflakeIntegrationAccount"]) {
      throw new Error(
        "Unstable operation 'getSnowflakeIntegrationAccount' is disabled"
      );
    }
    ...
    // Make Request Context
    const requestContext = _config
      .getServer("v2.SnowflakeIntegrationApi.getSnowflakeIntegrationAccount")
  ...
  public async listSnowflakeIntegrationAccounts(
    ...
    logger.warn("Using unstable operation 'listSnowflakeIntegrationAccounts'");
    if (!_config.unstableOperations["v2.listSnowflakeIntegrationAccounts"]) {
      throw new Error(
        "Unstable operation 'listSnowflakeIntegrationAccounts' is disabled"
      );
    }
    ...
    // Make Request Context
    const requestContext = _config
      .getServer("v2.SnowflakeIntegrationApi.listSnowflakeIntegrationAccounts")
      .makeRequestContext(localVarPath, HttpMethod.GET);
    requestContext.setHeaderParam("Accept", "application/json");
    requestContext.setHttpConfig(_config.httpConfig);
  ...
  public async updateSnowflakeIntegrationAccount(
    ...
    logger.warn("Using unstable operation 'updateSnowflakeIntegrationAccount'");
    if (!_config.unstableOperations["v2.updateSnowflakeIntegrationAccount"]) {
      throw new Error(
        "Unstable operation 'updateSnowflakeIntegrationAccount' is disabled"
      );
    }
    ...
    // Make Request Context
    const requestContext = _config
      .getServer("v2.SnowflakeIntegrationApi.updateSnowflakeIntegrationAccount")
...
export class SnowflakeIntegrationApiResponseProcessor {
  ...
  public async createSnowflakeIntegrationAccount(
    ...
    if (response.httpStatusCode === 201) {
      const body: SnowflakeIntegrationAccountResponse =
  ...
  public async listSnowflakeIntegrationAccounts(
    ...
    if (response.httpStatusCode === 200) {
      const body: SnowflakeIntegrationAccountsResponse =
        ObjectSerializer.deserialize(
          ObjectSerializer.parse(await response.body.text(), contentType),
...
export class SnowflakeIntegrationApi {
  ...
  public constructor(
    ...
    this.requestFactory =
      requestFactory ||
      new SnowflakeIntegrationApiRequestFactory(configuration);
