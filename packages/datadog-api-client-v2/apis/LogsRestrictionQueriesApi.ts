...
export class LogsRestrictionQueriesApiRequestFactory extends BaseAPIRequestFactory {
  ...
  public async addRoleToRestrictionQuery(restrictionQueryId: string,body: RelationshipToRole,_options?: Configuration): Promise<RequestContext> {
    ...
    // Path Params
    const localVarPath = '/api/v2/logs/config/restriction_queries/{restriction_query_id}/roles'
      .replace('{restriction_query_id}', encodeURIComponent(String(restrictionQueryId)));

    // Make Request Context
    const requestContext = _config.getServer('v2.LogsRestrictionQueriesApi.addRoleToRestrictionQuery').makeRequestContext(localVarPath, HttpMethod.POST);
  ...
  public async createRestrictionQuery(body: RestrictionQueryCreatePayload,_options?: Configuration): Promise<RequestContext> {
    const _config = _options || this.configuration;
    ...
    // Make Request Context
    const requestContext = _config.getServer('v2.LogsRestrictionQueriesApi.createRestrictionQuery').makeRequestContext(localVarPath, HttpMethod.POST);
  ...
  public async deleteRestrictionQuery(restrictionQueryId: string,_options?: Configuration): Promise<RequestContext> {
    const _config = _options || this.configuration;
    ...
    // Path Params
    const localVarPath = '/api/v2/logs/config/restriction_queries/{restriction_query_id}'
      .replace('{restriction_query_id}', encodeURIComponent(String(restrictionQueryId)));

    // Make Request Context
    const requestContext = _config.getServer('v2.LogsRestrictionQueriesApi.deleteRestrictionQuery').makeRequestContext(localVarPath, HttpMethod.DELETE);
    requestContext.setHeaderParam("Accept", "*/*");
    requestContext.setHttpConfig(_config.httpConfig);
  ...
  public async getRestrictionQuery(restrictionQueryId: string,_options?: Configuration): Promise<RequestContext> {
    const _config = _options || this.configuration;
    ...
    // Make Request Context
    const requestContext = _config.getServer('v2.LogsRestrictionQueriesApi.getRestrictionQuery').makeRequestContext(localVarPath, HttpMethod.GET);
    requestContext.setHeaderParam("Accept", "application/json");
    requestContext.setHttpConfig(_config.httpConfig);
  ...
  public async getRoleRestrictionQuery(roleId: string,_options?: Configuration): Promise<RequestContext> {
    const _config = _options || this.configuration;
    ...
    // Path Params
    const localVarPath = '/api/v2/logs/config/restriction_queries/role/{role_id}'
      .replace('{role_id}', encodeURIComponent(String(roleId)));

    // Make Request Context
    const requestContext = _config.getServer('v2.LogsRestrictionQueriesApi.getRoleRestrictionQuery').makeRequestContext(localVarPath, HttpMethod.GET);
    requestContext.setHeaderParam("Accept", "application/json");
    requestContext.setHttpConfig(_config.httpConfig);
  ...
  public async listRestrictionQueries(pageSize?: number,pageNumber?: number,_options?: Configuration): Promise<RequestContext> {
    const _config = _options || this.configuration;
    ...
    // Make Request Context
    const requestContext = _config.getServer('v2.LogsRestrictionQueriesApi.listRestrictionQueries').makeRequestContext(localVarPath, HttpMethod.GET);
    requestContext.setHeaderParam("Accept", "application/json");
    requestContext.setHttpConfig(_config.httpConfig);
  ...
  public async listRestrictionQueryRoles(restrictionQueryId: string,pageSize?: number,pageNumber?: number,_options?: Configuration): Promise<RequestContext> {
    const _config = _options || this.configuration;
    ...
    // Make Request Context
    const requestContext = _config.getServer('v2.LogsRestrictionQueriesApi.listRestrictionQueryRoles').makeRequestContext(localVarPath, HttpMethod.GET);
    requestContext.setHeaderParam("Accept", "application/json");
    requestContext.setHttpConfig(_config.httpConfig);
  ...
  public async listUserRestrictionQueries(userId: string,_options?: Configuration): Promise<RequestContext> {
    const _config = _options || this.configuration;
    ...
    // Path Params
    const localVarPath = '/api/v2/logs/config/restriction_queries/user/{user_id}'
      .replace('{user_id}', encodeURIComponent(String(userId)));

    // Make Request Context
    const requestContext = _config.getServer('v2.LogsRestrictionQueriesApi.listUserRestrictionQueries').makeRequestContext(localVarPath, HttpMethod.GET);
    requestContext.setHeaderParam("Accept", "application/json");
    requestContext.setHttpConfig(_config.httpConfig);
  ...
  public async removeRoleFromRestrictionQuery(restrictionQueryId: string,body: RelationshipToRole,_options?: Configuration): Promise<RequestContext> {
    const _config = _options || this.configuration;
    ...
    // Make Request Context
    const requestContext = _config.getServer('v2.LogsRestrictionQueriesApi.removeRoleFromRestrictionQuery').makeRequestContext(localVarPath, HttpMethod.DELETE);
    requestContext.setHeaderParam("Accept", "*/*");
    requestContext.setHttpConfig(_config.httpConfig);
  ...
  public async replaceRestrictionQuery(restrictionQueryId: string,body: RestrictionQueryUpdatePayload,_options?: Configuration): Promise<RequestContext> {
    const _config = _options || this.configuration;
    ...
    // Make Request Context
    const requestContext = _config.getServer('v2.LogsRestrictionQueriesApi.replaceRestrictionQuery').makeRequestContext(localVarPath, HttpMethod.PUT);
    requestContext.setHeaderParam("Accept", "application/json");
    requestContext.setHttpConfig(_config.httpConfig);
  ...
  public async updateRestrictionQuery(restrictionQueryId: string,body: RestrictionQueryUpdatePayload,_options?: Configuration): Promise<RequestContext> {
    const _config = _options || this.configuration;
    ...
    // Make Request Context
    const requestContext = _config.getServer('v2.LogsRestrictionQueriesApi.updateRestrictionQuery').makeRequestContext(localVarPath, HttpMethod.PATCH);
    requestContext.setHeaderParam("Accept", "application/json");
    requestContext.setHttpConfig(_config.httpConfig);
...
export class LogsRestrictionQueriesApiResponseProcessor {
   ...
   */
   public async addRoleToRestrictionQuery(response: ResponseContext): Promise<void> {
   ...
   * @throws ApiException if the response code was not in [200, 299]
   */
   public async createRestrictionQuery(response: ResponseContext): Promise<RestrictionQueryWithoutRelationshipsResponse> {
    const contentType = ObjectSerializer.normalizeMediaType(response.headers["content-type"]);
    if (response.httpStatusCode === 200) {
      const body: RestrictionQueryWithoutRelationshipsResponse = ObjectSerializer.deserialize(
   ...
   * @throws ApiException if the response code was not in [200, 299]
   */
   public async deleteRestrictionQuery(response: ResponseContext): Promise<void> {
    const contentType = ObjectSerializer.normalizeMediaType(response.headers["content-type"]);
    if (response.httpStatusCode === 204) {
      return;
    }
   ...
   * @throws ApiException if the response code was not in [200, 299]
   */
   public async getRestrictionQuery(response: ResponseContext): Promise<RestrictionQueryWithRelationshipsResponse> {
    const contentType = ObjectSerializer.normalizeMediaType(response.headers["content-type"]);
    if (response.httpStatusCode === 200) {
      const body: RestrictionQueryWithRelationshipsResponse = ObjectSerializer.deserialize(
        ObjectSerializer.parse(await response.body.text(), contentType),
   ...
   * @throws ApiException if the response code was not in [200, 299]
   */
   public async getRoleRestrictionQuery(response: ResponseContext): Promise<RestrictionQueryListResponse> {
    const contentType = ObjectSerializer.normalizeMediaType(response.headers["content-type"]);
    if (response.httpStatusCode === 200) {
   ...
   * @throws ApiException if the response code was not in [200, 299]
   */
   public async listRestrictionQueries(response: ResponseContext): Promise<RestrictionQueryListResponse> {
    const contentType = ObjectSerializer.normalizeMediaType(response.headers["content-type"]);
    if (response.httpStatusCode === 200) {
      const body: RestrictionQueryListResponse = ObjectSerializer.deserialize(
        ObjectSerializer.parse(await response.body.text(), contentType),
   ...
   * @throws ApiException if the response code was not in [200, 299]
   */
   public async listRestrictionQueryRoles(response: ResponseContext): Promise<RestrictionQueryRolesResponse> {
    const contentType = ObjectSerializer.normalizeMediaType(response.headers["content-type"]);
    if (response.httpStatusCode === 200) {
   ...
   * @throws ApiException if the response code was not in [200, 299]
   */
   public async listUserRestrictionQueries(response: ResponseContext): Promise<RestrictionQueryListResponse> {
    const contentType = ObjectSerializer.normalizeMediaType(response.headers["content-type"]);
    if (response.httpStatusCode === 200) {
      const body: RestrictionQueryListResponse = ObjectSerializer.deserialize(
        ObjectSerializer.parse(await response.body.text(), contentType),
   ...
   * @throws ApiException if the response code was not in [200, 299]
   */
   public async removeRoleFromRestrictionQuery(response: ResponseContext): Promise<void> {
    const contentType = ObjectSerializer.normalizeMediaType(response.headers["content-type"]);
    if (response.httpStatusCode === 204) {
      return;
    }
   ...
   * @throws ApiException if the response code was not in [200, 299]
   */
   public async replaceRestrictionQuery(response: ResponseContext): Promise<RestrictionQueryWithoutRelationshipsResponse> {
    const contentType = ObjectSerializer.normalizeMediaType(response.headers["content-type"]);
    if (response.httpStatusCode === 200) {
      const body: RestrictionQueryWithoutRelationshipsResponse = ObjectSerializer.deserialize(
        ObjectSerializer.parse(await response.body.text(), contentType),
   ...
   * @throws ApiException if the response code was not in [200, 299]
   */
   public async updateRestrictionQuery(response: ResponseContext): Promise<RestrictionQueryWithoutRelationshipsResponse> {
    const contentType = ObjectSerializer.normalizeMediaType(response.headers["content-type"]);
    if (response.httpStatusCode === 200) {
      const body: RestrictionQueryWithoutRelationshipsResponse = ObjectSerializer.deserialize(
        ObjectSerializer.parse(await response.body.text(), contentType),
...
export class LogsRestrictionQueriesApi {
  ...
  public constructor(configuration: Configuration, requestFactory?: LogsRestrictionQueriesApiRequestFactory, responseProcessor?: LogsRestrictionQueriesApiResponseProcessor) {
    this.configuration = configuration;
    this.requestFactory = requestFactory || new LogsRestrictionQueriesApiRequestFactory(configuration);
    this.responseProcessor = responseProcessor || new LogsRestrictionQueriesApiResponseProcessor();
  }
   ...
   */
  public addRoleToRestrictionQuery(param: LogsRestrictionQueriesApiAddRoleToRestrictionQueryRequest, options?: Configuration): Promise<void> {
   ...
   * @param param The request object
   */
  public createRestrictionQuery(param: LogsRestrictionQueriesApiCreateRestrictionQueryRequest, options?: Configuration): Promise<RestrictionQueryWithoutRelationshipsResponse> {
   ...
   * @param param The request object
   */
  public deleteRestrictionQuery(param: LogsRestrictionQueriesApiDeleteRestrictionQueryRequest, options?: Configuration): Promise<void> {
   ...
   * @param param The request object
   */
  public getRestrictionQuery(param: LogsRestrictionQueriesApiGetRestrictionQueryRequest, options?: Configuration): Promise<RestrictionQueryWithRelationshipsResponse> {
   ...
   * @param param The request object
   */
  public getRoleRestrictionQuery(param: LogsRestrictionQueriesApiGetRoleRestrictionQueryRequest, options?: Configuration): Promise<RestrictionQueryListResponse> {
   ...
   * @param param The request object
   */
  public listRestrictionQueries(param: LogsRestrictionQueriesApiListRestrictionQueriesRequest = {}, options?: Configuration): Promise<RestrictionQueryListResponse> {
   ...
   * @param param The request object
   */
  public listRestrictionQueryRoles(param: LogsRestrictionQueriesApiListRestrictionQueryRolesRequest, options?: Configuration): Promise<RestrictionQueryRolesResponse> {
   ...
   * @param param The request object
   */
  public listUserRestrictionQueries(param: LogsRestrictionQueriesApiListUserRestrictionQueriesRequest, options?: Configuration): Promise<RestrictionQueryListResponse> {
   ...
   * @param param The request object
   */
  public removeRoleFromRestrictionQuery(param: LogsRestrictionQueriesApiRemoveRoleFromRestrictionQueryRequest, options?: Configuration): Promise<void> {
   ...
   * @param param The request object
   */
  public replaceRestrictionQuery(param: LogsRestrictionQueriesApiReplaceRestrictionQueryRequest, options?: Configuration): Promise<RestrictionQueryWithoutRelationshipsResponse> {
   ...
   * @param param The request object
   */
  public updateRestrictionQuery(param: LogsRestrictionQueriesApiUpdateRestrictionQueryRequest, options?: Configuration): Promise<RestrictionQueryWithoutRelationshipsResponse> {
