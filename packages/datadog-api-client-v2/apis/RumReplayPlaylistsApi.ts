...
export class RumReplayPlaylistsApiRequestFactory extends BaseAPIRequestFactory {
  ...
  public async addRumReplaySessionToPlaylist(ts: number,playlistId: number,sessionId: string,dataSource?: string,_options?: Configuration): Promise<RequestContext> {
    ...
    const requestContext = _config.getServer('v2.RumReplayPlaylistsApi.addRumReplaySessionToPlaylist').makeRequestContext(localVarPath, HttpMethod.PUT);
    requestContext.setHeaderParam("Accept", "application/json");
    requestContext.setHttpConfig(_config.httpConfig);

    // Query Params
  if (dataSource !== undefined) {
      requestContext.setQueryParam("data_source", ObjectSerializer.serialize(dataSource, "string", ""
), "");
    }
  if (ts !== undefined) {
      requestContext.setQueryParam("ts", ObjectSerializer.serialize(ts, "number", "int64"
), "");
    }
  ...
  public async bulkRemoveRumReplayPlaylistSessions(playlistId: number,body: SessionIdArray,_options?: Configuration): Promise<RequestContext> {
    const _config = _options || this.configuration;
    ...
    // Path Params
    const localVarPath = '/api/v2/rum/replay/playlists/{playlist_id}/sessions'
      .replace('{playlist_id}', encodeURIComponent(String(playlistId)));

    // Make Request Context
    const requestContext = _config.getServer('v2.RumReplayPlaylistsApi.bulkRemoveRumReplayPlaylistSessions').makeRequestContext(localVarPath, HttpMethod.DELETE);
  ...
  public async createRumReplayPlaylist(body: Playlist,_options?: Configuration): Promise<RequestContext> {
    const _config = _options || this.configuration;
    ...
    // Make Request Context
    const requestContext = _config.getServer('v2.RumReplayPlaylistsApi.createRumReplayPlaylist').makeRequestContext(localVarPath, HttpMethod.POST);
    requestContext.setHeaderParam("Accept", "application/json");
    requestContext.setHttpConfig(_config.httpConfig);
  ...
  public async deleteRumReplayPlaylist(playlistId: number,_options?: Configuration): Promise<RequestContext> {
    const _config = _options || this.configuration;
    ...
    // Path Params
    const localVarPath = '/api/v2/rum/replay/playlists/{playlist_id}'
      .replace('{playlist_id}', encodeURIComponent(String(playlistId)));

    // Make Request Context
    const requestContext = _config.getServer('v2.RumReplayPlaylistsApi.deleteRumReplayPlaylist').makeRequestContext(localVarPath, HttpMethod.DELETE);
    requestContext.setHeaderParam("Accept", "*/*");
    requestContext.setHttpConfig(_config.httpConfig);
  ...
  public async getRumReplayPlaylist(playlistId: number,_options?: Configuration): Promise<RequestContext> {
    const _config = _options || this.configuration;
    ...
    // Make Request Context
    const requestContext = _config.getServer('v2.RumReplayPlaylistsApi.getRumReplayPlaylist').makeRequestContext(localVarPath, HttpMethod.GET);
    requestContext.setHeaderParam("Accept", "application/json");
    requestContext.setHttpConfig(_config.httpConfig);
  ...
  public async listRumReplayPlaylists(filterCreatedByUuid?: string,filterQuery?: string,pageNumber?: number,pageSize?: number,_options?: Configuration): Promise<RequestContext> {
    const _config = _options || this.configuration;
    ...
    // Make Request Context
    const requestContext = _config.getServer('v2.RumReplayPlaylistsApi.listRumReplayPlaylists').makeRequestContext(localVarPath, HttpMethod.GET);
    requestContext.setHeaderParam("Accept", "application/json");
    requestContext.setHttpConfig(_config.httpConfig);

    // Query Params
  if (filterCreatedByUuid !== undefined) {
      requestContext.setQueryParam("filter[created_by_uuid]", ObjectSerializer.serialize(filterCreatedByUuid, "string", ""
), "");
    }
  ...
  public async listRumReplayPlaylistSessions(playlistId: number,pageNumber?: number,pageSize?: number,_options?: Configuration): Promise<RequestContext> {
    const _config = _options || this.configuration;
    ...
    // Make Request Context
    const requestContext = _config.getServer('v2.RumReplayPlaylistsApi.listRumReplayPlaylistSessions').makeRequestContext(localVarPath, HttpMethod.GET);
    requestContext.setHeaderParam("Accept", "application/json");
    requestContext.setHttpConfig(_config.httpConfig);
  ...
  public async removeRumReplaySessionFromPlaylist(playlistId: number,sessionId: string,_options?: Configuration): Promise<RequestContext> {
    const _config = _options || this.configuration;
    ...
    // Make Request Context
    const requestContext = _config.getServer('v2.RumReplayPlaylistsApi.removeRumReplaySessionFromPlaylist').makeRequestContext(localVarPath, HttpMethod.DELETE);
    requestContext.setHeaderParam("Accept", "*/*");
    requestContext.setHttpConfig(_config.httpConfig);
  ...
  public async updateRumReplayPlaylist(playlistId: number,body: Playlist,_options?: Configuration): Promise<RequestContext> {
    const _config = _options || this.configuration;
    ...
    // Make Request Context
    const requestContext = _config.getServer('v2.RumReplayPlaylistsApi.updateRumReplayPlaylist').makeRequestContext(localVarPath, HttpMethod.PUT);
    requestContext.setHeaderParam("Accept", "application/json");
    requestContext.setHttpConfig(_config.httpConfig);
...
export class RumReplayPlaylistsApiResponseProcessor {
   ...
   */
   public async addRumReplaySessionToPlaylist(response: ResponseContext): Promise<PlaylistsSession> {
   ...
   * @throws ApiException if the response code was not in [200, 299]
   */
   public async bulkRemoveRumReplayPlaylistSessions(response: ResponseContext): Promise<void> {
    const contentType = ObjectSerializer.normalizeMediaType(response.headers["content-type"]);
   ...
   * @throws ApiException if the response code was not in [200, 299]
   */
   public async createRumReplayPlaylist(response: ResponseContext): Promise<Playlist> {
    const contentType = ObjectSerializer.normalizeMediaType(response.headers["content-type"]);
   ...
   * @throws ApiException if the response code was not in [200, 299]
   */
   public async deleteRumReplayPlaylist(response: ResponseContext): Promise<void> {
    const contentType = ObjectSerializer.normalizeMediaType(response.headers["content-type"]);
    if (response.httpStatusCode === 204) {
      return;
    }
   ...
   * @throws ApiException if the response code was not in [200, 299]
   */
   public async getRumReplayPlaylist(response: ResponseContext): Promise<Playlist> {
    const contentType = ObjectSerializer.normalizeMediaType(response.headers["content-type"]);
   ...
   * @throws ApiException if the response code was not in [200, 299]
   */
   public async listRumReplayPlaylists(response: ResponseContext): Promise<PlaylistArray> {
    const contentType = ObjectSerializer.normalizeMediaType(response.headers["content-type"]);
    if (response.httpStatusCode === 200) {
   ...
   * @throws ApiException if the response code was not in [200, 299]
   */
   public async listRumReplayPlaylistSessions(response: ResponseContext): Promise<PlaylistsSessionArray> {
    const contentType = ObjectSerializer.normalizeMediaType(response.headers["content-type"]);
    if (response.httpStatusCode === 200) {
   ...
   * @throws ApiException if the response code was not in [200, 299]
   */
   public async removeRumReplaySessionFromPlaylist(response: ResponseContext): Promise<void> {
    const contentType = ObjectSerializer.normalizeMediaType(response.headers["content-type"]);
    if (response.httpStatusCode === 204) {
      return;
    }
   ...
   * @throws ApiException if the response code was not in [200, 299]
   */
   public async updateRumReplayPlaylist(response: ResponseContext): Promise<Playlist> {
    const contentType = ObjectSerializer.normalizeMediaType(response.headers["content-type"]);
    if (response.httpStatusCode === 200) {
      const body: Playlist = ObjectSerializer.deserialize(
        ObjectSerializer.parse(await response.body.text(), contentType),
...
export class RumReplayPlaylistsApi {
  ...
  public constructor(configuration: Configuration, requestFactory?: RumReplayPlaylistsApiRequestFactory, responseProcessor?: RumReplayPlaylistsApiResponseProcessor) {
    this.configuration = configuration;
    this.requestFactory = requestFactory || new RumReplayPlaylistsApiRequestFactory(configuration);
    this.responseProcessor = responseProcessor || new RumReplayPlaylistsApiResponseProcessor();
  }
   ...
   */
  public addRumReplaySessionToPlaylist(param: RumReplayPlaylistsApiAddRumReplaySessionToPlaylistRequest, options?: Configuration): Promise<PlaylistsSession> {
   ...
   * @param param The request object
   */
  public bulkRemoveRumReplayPlaylistSessions(param: RumReplayPlaylistsApiBulkRemoveRumReplayPlaylistSessionsRequest, options?: Configuration): Promise<void> {
   ...
   * @param param The request object
   */
  public createRumReplayPlaylist(param: RumReplayPlaylistsApiCreateRumReplayPlaylistRequest, options?: Configuration): Promise<Playlist> {
   ...
   * @param param The request object
   */
  public deleteRumReplayPlaylist(param: RumReplayPlaylistsApiDeleteRumReplayPlaylistRequest, options?: Configuration): Promise<void> {
   ...
   * @param param The request object
   */
  public getRumReplayPlaylist(param: RumReplayPlaylistsApiGetRumReplayPlaylistRequest, options?: Configuration): Promise<Playlist> {
   ...
   * @param param The request object
   */
  public listRumReplayPlaylists(param: RumReplayPlaylistsApiListRumReplayPlaylistsRequest = {}, options?: Configuration): Promise<PlaylistArray> {
   ...
   * @param param The request object
   */
  public listRumReplayPlaylistSessions(param: RumReplayPlaylistsApiListRumReplayPlaylistSessionsRequest, options?: Configuration): Promise<PlaylistsSessionArray> {
   ...
   * @param param The request object
   */
  public removeRumReplaySessionFromPlaylist(param: RumReplayPlaylistsApiRemoveRumReplaySessionFromPlaylistRequest, options?: Configuration): Promise<void> {
   ...
   * @param param The request object
   */
  public updateRumReplayPlaylist(param: RumReplayPlaylistsApiUpdateRumReplayPlaylistRequest, options?: Configuration): Promise<Playlist> {
