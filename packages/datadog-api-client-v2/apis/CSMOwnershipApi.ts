...
export class CSMOwnershipApiRequestFactory extends BaseAPIRequestFactory {
  public async createOwnershipFeedback(
    ...
    if (!_config.unstableOperations["v2.createOwnershipFeedback"]) {
      throw new Error(
        "Unstable operation 'createOwnershipFeedback' is disabled"
      );
    }
  ...
  public async getOwnershipEvidence(
    ...
    if (ifNoneMatch !== undefined) {
      requestContext.setHeaderParam(
        "If-None-Match",
        ObjectSerializer.serialize(ifNoneMatch, "string", "")
      );
    }
  ...
  public async listOwnershipHistoryByOwnerType(
    ...
    if (!_config.unstableOperations["v2.listOwnershipHistoryByOwnerType"]) {
      throw new Error(
        "Unstable operation 'listOwnershipHistoryByOwnerType' is disabled"
      );
    }
  ...
  public async listOwnershipInferences(
    ...
    if (!_config.unstableOperations["v2.listOwnershipInferences"]) {
      throw new Error(
        "Unstable operation 'listOwnershipInferences' is disabled"
      );
    }
