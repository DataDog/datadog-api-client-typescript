...
export class CSMOwnershipApiRequestFactory extends BaseAPIRequestFactory {
  ...
  public async createOwnershipFeedback(resourceId: string,ownerType: OwnershipOwnerType,body: OwnershipFeedbackRequest,_options?: Configuration): Promise<RequestContext> {
    const _config = _options || this.configuration;

    logger.warn("Using unstable operation 'createOwnershipFeedback'");
    ...
    const requestContext = _config.getServer('v2.CSMOwnershipApi.createOwnershipFeedback').makeRequestContext(localVarPath, HttpMethod.POST);
    ...
    const serializedBody = ObjectSerializer.stringify(
      ObjectSerializer.serialize(body, "OwnershipFeedbackRequest", ""),
      contentType
    );
  ...
  public async getOwnershipEvidence(resourceId: string,ownerType: OwnershipOwnerType,ifNoneMatch?: string,_options?: Configuration): Promise<RequestContext> {
    const _config = _options || this.configuration;

    logger.warn("Using unstable operation 'getOwnershipEvidence'");
    ...
    // Make Request Context
    const requestContext = _config.getServer('v2.CSMOwnershipApi.getOwnershipEvidence').makeRequestContext(localVarPath, HttpMethod.GET);
    requestContext.setHeaderParam("Accept", "application/json");
    requestContext.setHttpConfig(_config.httpConfig);
  ...
  public async getOwnershipInference(resourceId: string,ownerType: OwnershipOwnerType,ifNoneMatch?: string,_options?: Configuration): Promise<RequestContext> {
    const _config = _options || this.configuration;

    logger.warn("Using unstable operation 'getOwnershipInference'");
    ...
    // Make Request Context
    const requestContext = _config.getServer('v2.CSMOwnershipApi.getOwnershipInference').makeRequestContext(localVarPath, HttpMethod.GET);
    requestContext.setHeaderParam("Accept", "application/json");
    requestContext.setHttpConfig(_config.httpConfig);
  ...
  public async listOwnershipHistory(resourceId: string,cursor?: string,limit?: number,_options?: Configuration): Promise<RequestContext> {
    const _config = _options || this.configuration;

    logger.warn("Using unstable operation 'listOwnershipHistory'");
    ...
    // Path Params
    const localVarPath = '/api/v2/csm/ownership/{resource_id}/history'
      .replace('{resource_id}', encodeURIComponent(String(resourceId)));

    // Make Request Context
    const requestContext = _config.getServer('v2.CSMOwnershipApi.listOwnershipHistory').makeRequestContext(localVarPath, HttpMethod.GET);
    requestContext.setHeaderParam("Accept", "application/json");
    requestContext.setHttpConfig(_config.httpConfig);
  ...
  public async listOwnershipHistoryByOwnerType(resourceId: string,ownerType: OwnershipOwnerType,cursor?: string,limit?: number,_options?: Configuration): Promise<RequestContext> {
    const _config = _options || this.configuration;

    logger.warn("Using unstable operation 'listOwnershipHistoryByOwnerType'");
    ...
    // Make Request Context
    const requestContext = _config.getServer('v2.CSMOwnershipApi.listOwnershipHistoryByOwnerType').makeRequestContext(localVarPath, HttpMethod.GET);
    requestContext.setHeaderParam("Accept", "application/json");
    requestContext.setHttpConfig(_config.httpConfig);
  ...
  public async listOwnershipInferences(resourceId: string,_options?: Configuration): Promise<RequestContext> {
    const _config = _options || this.configuration;

    logger.warn("Using unstable operation 'listOwnershipInferences'");
    ...
    // Path Params
    const localVarPath = '/api/v2/csm/ownership/{resource_id}'
      .replace('{resource_id}', encodeURIComponent(String(resourceId)));

    // Make Request Context
    const requestContext = _config.getServer('v2.CSMOwnershipApi.listOwnershipInferences').makeRequestContext(localVarPath, HttpMethod.GET);
    requestContext.setHeaderParam("Accept", "application/json");
    requestContext.setHttpConfig(_config.httpConfig);
...
export class CSMOwnershipApiResponseProcessor {
   ...
   */
   public async createOwnershipFeedback(response: ResponseContext): Promise<OwnershipFeedbackResponse> {
    const contentType = ObjectSerializer.normalizeMediaType(response.headers["content-type"]);
    if (response.httpStatusCode === 201) {
      const body: OwnershipFeedbackResponse = ObjectSerializer.deserialize(
    ...
    if (response.httpStatusCode === 409) {
      ...
      try {
        ...
        logger.debug(`Got error deserializing error: ${error}`);
        throw new ApiException<OwnershipInferenceResponse>(response.httpStatusCode, bodyText);
      } 
      throw new ApiException<OwnershipInferenceResponse>(response.httpStatusCode, body);
    }
   ...
   * @throws ApiException if the response code was not in [200, 299]
   */
   public async getOwnershipEvidence(response: ResponseContext): Promise<OwnershipEvidenceResponse> {
    const contentType = ObjectSerializer.normalizeMediaType(response.headers["content-type"]);
    if (response.httpStatusCode === 200) {
      const body: OwnershipEvidenceResponse = ObjectSerializer.deserialize(
        ObjectSerializer.parse(await response.body.text(), contentType),
   ...
   * @throws ApiException if the response code was not in [200, 299]
   */
   public async getOwnershipInference(response: ResponseContext): Promise<OwnershipInferenceResponse> {
    const contentType = ObjectSerializer.normalizeMediaType(response.headers["content-type"]);
    if (response.httpStatusCode === 200) {
      const body: OwnershipInferenceResponse = ObjectSerializer.deserialize(
        ObjectSerializer.parse(await response.body.text(), contentType),
        "OwnershipInferenceResponse"
      ) as OwnershipInferenceResponse;
      return body;
   ...
   * @throws ApiException if the response code was not in [200, 299]
   */
   public async listOwnershipHistory(response: ResponseContext): Promise<OwnershipHistoryResponse> {
    const contentType = ObjectSerializer.normalizeMediaType(response.headers["content-type"]);
    if (response.httpStatusCode === 200) {
      const body: OwnershipHistoryResponse = ObjectSerializer.deserialize(
        ObjectSerializer.parse(await response.body.text(), contentType),
   ...
   * @throws ApiException if the response code was not in [200, 299]
   */
   public async listOwnershipHistoryByOwnerType(response: ResponseContext): Promise<OwnershipHistoryResponse> {
    const contentType = ObjectSerializer.normalizeMediaType(response.headers["content-type"]);
    if (response.httpStatusCode === 200) {
      const body: OwnershipHistoryResponse = ObjectSerializer.deserialize(
        ObjectSerializer.parse(await response.body.text(), contentType),
   ...
   * @throws ApiException if the response code was not in [200, 299]
   */
   public async listOwnershipInferences(response: ResponseContext): Promise<OwnershipInferenceListResponse> {
    const contentType = ObjectSerializer.normalizeMediaType(response.headers["content-type"]);
    if (response.httpStatusCode === 200) {
      const body: OwnershipInferenceListResponse = ObjectSerializer.deserialize(
        ObjectSerializer.parse(await response.body.text(), contentType),
...
export class CSMOwnershipApi {
  ...
  public constructor(configuration: Configuration, requestFactory?: CSMOwnershipApiRequestFactory, responseProcessor?: CSMOwnershipApiResponseProcessor) {
    this.configuration = configuration;
    this.requestFactory = requestFactory || new CSMOwnershipApiRequestFactory(configuration);
    this.responseProcessor = responseProcessor || new CSMOwnershipApiResponseProcessor();
  }
   ...
   */
  public createOwnershipFeedback(param: CSMOwnershipApiCreateOwnershipFeedbackRequest, options?: Configuration): Promise<OwnershipFeedbackResponse> {
   ...
   * @param param The request object
   */
  public getOwnershipEvidence(param: CSMOwnershipApiGetOwnershipEvidenceRequest, options?: Configuration): Promise<OwnershipEvidenceResponse> {
   ...
   * @param param The request object
   */
  public getOwnershipInference(param: CSMOwnershipApiGetOwnershipInferenceRequest, options?: Configuration): Promise<OwnershipInferenceResponse> {
   ...
   * @param param The request object
   */
  public listOwnershipHistory(param: CSMOwnershipApiListOwnershipHistoryRequest, options?: Configuration): Promise<OwnershipHistoryResponse> {
   ...
   * @param param The request object
   */
  public listOwnershipHistoryByOwnerType(param: CSMOwnershipApiListOwnershipHistoryByOwnerTypeRequest, options?: Configuration): Promise<OwnershipHistoryResponse> {
   ...
   * @param param The request object
   */
  public listOwnershipInferences(param: CSMOwnershipApiListOwnershipInferencesRequest, options?: Configuration): Promise<OwnershipInferenceListResponse> {
