...
export class FleetAutomationApiRequestFactory extends BaseAPIRequestFactory {
  ...
  public async cancelFleetDeployment(deploymentId: string,_options?: Configuration): Promise<RequestContext> {
    ...
    // Path Params
    const localVarPath = '/api/unstable/fleet/deployments/{deployment_id}/cancel'
      .replace('{deployment_id}', encodeURIComponent(String(deploymentId)));

    // Make Request Context
    const requestContext = _config.getServer('v2.FleetAutomationApi.cancelFleetDeployment').makeRequestContext(localVarPath, HttpMethod.POST);
  ...
  public async createFleetDeploymentConfigure(body: FleetDeploymentConfigureCreateRequest,_options?: Configuration): Promise<RequestContext> {
    const _config = _options || this.configuration;
    ...
    // Make Request Context
    const requestContext = _config.getServer('v2.FleetAutomationApi.createFleetDeploymentConfigure').makeRequestContext(localVarPath, HttpMethod.POST);
    ...
    const serializedBody = ObjectSerializer.stringify(
      ObjectSerializer.serialize(body, "FleetDeploymentConfigureCreateRequest", ""),
      contentType
    );
  ...
  public async createFleetDeploymentUpgrade(body: FleetDeploymentPackageUpgradeCreateRequest,_options?: Configuration): Promise<RequestContext> {
    const _config = _options || this.configuration;
    ...
    // Make Request Context
    const requestContext = _config.getServer('v2.FleetAutomationApi.createFleetDeploymentUpgrade').makeRequestContext(localVarPath, HttpMethod.POST);
    requestContext.setHeaderParam("Accept", "application/json");
    requestContext.setHttpConfig(_config.httpConfig);
    ...
    requestContext.setHeaderParam("Content-Type", contentType);
    const serializedBody = ObjectSerializer.stringify(
      ObjectSerializer.serialize(body, "FleetDeploymentPackageUpgradeCreateRequest", ""),
      contentType
    );
    requestContext.setBody(serializedBody);
  ...
  public async createFleetSchedule(body: FleetScheduleCreateRequest,_options?: Configuration): Promise<RequestContext> {
    const _config = _options || this.configuration;
    ...
    // Make Request Context
    const requestContext = _config.getServer('v2.FleetAutomationApi.createFleetSchedule').makeRequestContext(localVarPath, HttpMethod.POST);
    requestContext.setHeaderParam("Accept", "application/json");
    requestContext.setHttpConfig(_config.httpConfig);
  ...
  public async deleteFleetSchedule(id: string,_options?: Configuration): Promise<RequestContext> {
    const _config = _options || this.configuration;
    ...
    // Path Params
    const localVarPath = '/api/unstable/fleet/schedules/{id}'
      .replace('{id}', encodeURIComponent(String(id)));

    // Make Request Context
    const requestContext = _config.getServer('v2.FleetAutomationApi.deleteFleetSchedule').makeRequestContext(localVarPath, HttpMethod.DELETE);
    requestContext.setHeaderParam("Accept", "*/*");
    requestContext.setHttpConfig(_config.httpConfig);
  ...
  public async getFleetAgentInfo(agentKey: string,_options?: Configuration): Promise<RequestContext> {
    const _config = _options || this.configuration;
    ...
    // Path Params
    const localVarPath = '/api/unstable/fleet/agents/{agent_key}'
      .replace('{agent_key}', encodeURIComponent(String(agentKey)));

    // Make Request Context
    const requestContext = _config.getServer('v2.FleetAutomationApi.getFleetAgentInfo').makeRequestContext(localVarPath, HttpMethod.GET);
    requestContext.setHeaderParam("Accept", "application/json");
    requestContext.setHttpConfig(_config.httpConfig);
  ...
  public async getFleetDeployment(deploymentId: string,limit?: number,page?: number,_options?: Configuration): Promise<RequestContext> {
    const _config = _options || this.configuration;
    ...
    // Path Params
    const localVarPath = '/api/unstable/fleet/deployments/{deployment_id}'
      .replace('{deployment_id}', encodeURIComponent(String(deploymentId)));

    // Make Request Context
    const requestContext = _config.getServer('v2.FleetAutomationApi.getFleetDeployment').makeRequestContext(localVarPath, HttpMethod.GET);
    requestContext.setHeaderParam("Accept", "application/json");
    requestContext.setHttpConfig(_config.httpConfig);
  ...
  public async getFleetSchedule(id: string,_options?: Configuration): Promise<RequestContext> {
    const _config = _options || this.configuration;
    ...
    // Make Request Context
    const requestContext = _config.getServer('v2.FleetAutomationApi.getFleetSchedule').makeRequestContext(localVarPath, HttpMethod.GET);
    requestContext.setHeaderParam("Accept", "application/json");
    requestContext.setHttpConfig(_config.httpConfig);
  ...
  public async listFleetAgents(pageNumber?: number,pageSize?: number,sortAttribute?: string,sortDescending?: boolean,tags?: string,filter?: string,_options?: Configuration): Promise<RequestContext> {
    const _config = _options || this.configuration;
    ...
    // Make Request Context
    const requestContext = _config.getServer('v2.FleetAutomationApi.listFleetAgents').makeRequestContext(localVarPath, HttpMethod.GET);
    requestContext.setHeaderParam("Accept", "application/json");
    requestContext.setHttpConfig(_config.httpConfig);
  ...
  if (sortAttribute !== undefined) {
      requestContext.setQueryParam("sort_attribute", ObjectSerializer.serialize(sortAttribute, "string", ""
), "");
    }
  if (sortDescending !== undefined) {
      requestContext.setQueryParam("sort_descending", ObjectSerializer.serialize(sortDescending, "boolean", ""
), "");
    }
  if (tags !== undefined) {
  ...
  public async listFleetAgentTracers(agentKey: string,pageNumber?: number,pageSize?: number,sortAttribute?: string,sortDescending?: boolean,_options?: Configuration): Promise<RequestContext> {
    const _config = _options || this.configuration;
    ...
    // Path Params
    const localVarPath = '/api/unstable/fleet/agents/{agent_key}/tracers'
      .replace('{agent_key}', encodeURIComponent(String(agentKey)));

    // Make Request Context
    const requestContext = _config.getServer('v2.FleetAutomationApi.listFleetAgentTracers').makeRequestContext(localVarPath, HttpMethod.GET);
    requestContext.setHeaderParam("Accept", "application/json");
    requestContext.setHttpConfig(_config.httpConfig);
  ...
  public async listFleetAgentVersions(_options?: Configuration): Promise<RequestContext> {
    const _config = _options || this.configuration;
    ...
    // Make Request Context
    const requestContext = _config.getServer('v2.FleetAutomationApi.listFleetAgentVersions').makeRequestContext(localVarPath, HttpMethod.GET);
    requestContext.setHeaderParam("Accept", "application/json");
    requestContext.setHttpConfig(_config.httpConfig);
  ...
  public async listFleetDeployments(pageSize?: number,pageOffset?: number,_options?: Configuration): Promise<RequestContext> {
    const _config = _options || this.configuration;
    ...
    // Make Request Context
    const requestContext = _config.getServer('v2.FleetAutomationApi.listFleetDeployments').makeRequestContext(localVarPath, HttpMethod.GET);
    requestContext.setHeaderParam("Accept", "application/json");
    requestContext.setHttpConfig(_config.httpConfig);
  ...
  if (pageOffset !== undefined) {
      requestContext.setQueryParam("page_offset", ObjectSerializer.serialize(pageOffset, "number", "int64"
), "");
    }
  ...
  public async listFleetSchedules(_options?: Configuration): Promise<RequestContext> {
    const _config = _options || this.configuration;
    ...
    // Make Request Context
    const requestContext = _config.getServer('v2.FleetAutomationApi.listFleetSchedules').makeRequestContext(localVarPath, HttpMethod.GET);
    requestContext.setHeaderParam("Accept", "application/json");
    requestContext.setHttpConfig(_config.httpConfig);
  ...
  public async listFleetTracers(pageNumber?: number,pageSize?: number,sortAttribute?: string,sortDescending?: boolean,filter?: string,_options?: Configuration): Promise<RequestContext> {
    const _config = _options || this.configuration;
    ...
    // Make Request Context
    const requestContext = _config.getServer('v2.FleetAutomationApi.listFleetTracers').makeRequestContext(localVarPath, HttpMethod.GET);
    requestContext.setHeaderParam("Accept", "application/json");
    requestContext.setHttpConfig(_config.httpConfig);
  ...
  public async triggerFleetSchedule(id: string,_options?: Configuration): Promise<RequestContext> {
    const _config = _options || this.configuration;
    ...
    // Path Params
    const localVarPath = '/api/unstable/fleet/schedules/{id}/trigger'
      .replace('{id}', encodeURIComponent(String(id)));

    // Make Request Context
    const requestContext = _config.getServer('v2.FleetAutomationApi.triggerFleetSchedule').makeRequestContext(localVarPath, HttpMethod.POST);
    requestContext.setHeaderParam("Accept", "application/json");
    requestContext.setHttpConfig(_config.httpConfig);
  ...
  public async updateFleetSchedule(id: string,body: FleetSchedulePatchRequest,_options?: Configuration): Promise<RequestContext> {
    const _config = _options || this.configuration;
    ...
    // Make Request Context
    const requestContext = _config.getServer('v2.FleetAutomationApi.updateFleetSchedule').makeRequestContext(localVarPath, HttpMethod.PATCH);
    requestContext.setHeaderParam("Accept", "application/json");
    requestContext.setHttpConfig(_config.httpConfig);
...
export class FleetAutomationApiResponseProcessor {
   ...
   * @throws ApiException if the response code was not in [200, 299]
   */
   public async createFleetDeploymentConfigure(response: ResponseContext): Promise<FleetDeploymentResponse> {
    const contentType = ObjectSerializer.normalizeMediaType(response.headers["content-type"]);
   ...
   * @throws ApiException if the response code was not in [200, 299]
   */
   public async createFleetDeploymentUpgrade(response: ResponseContext): Promise<FleetDeploymentResponse> {
    const contentType = ObjectSerializer.normalizeMediaType(response.headers["content-type"]);
    if (response.httpStatusCode === 201) {
      const body: FleetDeploymentResponse = ObjectSerializer.deserialize(
        ObjectSerializer.parse(await response.body.text(), contentType),
   ...
   * @throws ApiException if the response code was not in [200, 299]
   */
   public async createFleetSchedule(response: ResponseContext): Promise<FleetScheduleResponse> {
    const contentType = ObjectSerializer.normalizeMediaType(response.headers["content-type"]);
    if (response.httpStatusCode === 201) {
   ...
   * @throws ApiException if the response code was not in [200, 299]
   */
   public async getFleetAgentInfo(response: ResponseContext): Promise<FleetAgentInfoResponse> {
    const contentType = ObjectSerializer.normalizeMediaType(response.headers["content-type"]);
   ...
   * @throws ApiException if the response code was not in [200, 299]
   */
   public async getFleetDeployment(response: ResponseContext): Promise<FleetDeploymentResponse> {
    const contentType = ObjectSerializer.normalizeMediaType(response.headers["content-type"]);
    if (response.httpStatusCode === 200) {
      const body: FleetDeploymentResponse = ObjectSerializer.deserialize(
        ObjectSerializer.parse(await response.body.text(), contentType),
   ...
   * @throws ApiException if the response code was not in [200, 299]
   */
   public async getFleetSchedule(response: ResponseContext): Promise<FleetScheduleResponse> {
    const contentType = ObjectSerializer.normalizeMediaType(response.headers["content-type"]);
    if (response.httpStatusCode === 200) {
      const body: FleetScheduleResponse = ObjectSerializer.deserialize(
        ObjectSerializer.parse(await response.body.text(), contentType),
   ...
   * @throws ApiException if the response code was not in [200, 299]
   */
   public async listFleetAgents(response: ResponseContext): Promise<FleetAgentsResponse> {
    const contentType = ObjectSerializer.normalizeMediaType(response.headers["content-type"]);
    if (response.httpStatusCode === 200) {
   ...
   * @throws ApiException if the response code was not in [200, 299]
   */
   public async listFleetAgentTracers(response: ResponseContext): Promise<FleetTracersResponse> {
    const contentType = ObjectSerializer.normalizeMediaType(response.headers["content-type"]);
    if (response.httpStatusCode === 200) {
   ...
   * @throws ApiException if the response code was not in [200, 299]
   */
   public async listFleetAgentVersions(response: ResponseContext): Promise<FleetAgentVersionsResponse> {
    const contentType = ObjectSerializer.normalizeMediaType(response.headers["content-type"]);
    if (response.httpStatusCode === 200) {
   ...
   * @throws ApiException if the response code was not in [200, 299]
   */
   public async listFleetDeployments(response: ResponseContext): Promise<FleetDeploymentsResponse> {
    const contentType = ObjectSerializer.normalizeMediaType(response.headers["content-type"]);
    if (response.httpStatusCode === 200) {
   ...
   * @throws ApiException if the response code was not in [200, 299]
   */
   public async listFleetSchedules(response: ResponseContext): Promise<FleetSchedulesResponse> {
    const contentType = ObjectSerializer.normalizeMediaType(response.headers["content-type"]);
    if (response.httpStatusCode === 200) {
   ...
   * @throws ApiException if the response code was not in [200, 299]
   */
   public async listFleetTracers(response: ResponseContext): Promise<FleetTracersResponse> {
    const contentType = ObjectSerializer.normalizeMediaType(response.headers["content-type"]);
    if (response.httpStatusCode === 200) {
      const body: FleetTracersResponse = ObjectSerializer.deserialize(
        ObjectSerializer.parse(await response.body.text(), contentType),
   ...
   * @throws ApiException if the response code was not in [200, 299]
   */
   public async triggerFleetSchedule(response: ResponseContext): Promise<FleetDeploymentResponse> {
    const contentType = ObjectSerializer.normalizeMediaType(response.headers["content-type"]);
    if (response.httpStatusCode === 201) {
      const body: FleetDeploymentResponse = ObjectSerializer.deserialize(
        ObjectSerializer.parse(await response.body.text(), contentType),
   ...
   * @throws ApiException if the response code was not in [200, 299]
   */
   public async updateFleetSchedule(response: ResponseContext): Promise<FleetScheduleResponse> {
    const contentType = ObjectSerializer.normalizeMediaType(response.headers["content-type"]);
    if (response.httpStatusCode === 200) {
      const body: FleetScheduleResponse = ObjectSerializer.deserialize(
        ObjectSerializer.parse(await response.body.text(), contentType),
...
export class FleetAutomationApi {
  ...
  public constructor(configuration: Configuration, requestFactory?: FleetAutomationApiRequestFactory, responseProcessor?: FleetAutomationApiResponseProcessor) {
    this.configuration = configuration;
    this.requestFactory = requestFactory || new FleetAutomationApiRequestFactory(configuration);
    this.responseProcessor = responseProcessor || new FleetAutomationApiResponseProcessor();
  }
   ...
   */
  public cancelFleetDeployment(param: FleetAutomationApiCancelFleetDeploymentRequest, options?: Configuration): Promise<void> {
   ...
   * @param param The request object
   */
  public createFleetDeploymentConfigure(param: FleetAutomationApiCreateFleetDeploymentConfigureRequest, options?: Configuration): Promise<FleetDeploymentResponse> {
   ...
   * @param param The request object
   */
  public createFleetDeploymentUpgrade(param: FleetAutomationApiCreateFleetDeploymentUpgradeRequest, options?: Configuration): Promise<FleetDeploymentResponse> {
   ...
   * @param param The request object
   */
  public createFleetSchedule(param: FleetAutomationApiCreateFleetScheduleRequest, options?: Configuration): Promise<FleetScheduleResponse> {
   ...
   * @param param The request object
   */
  public deleteFleetSchedule(param: FleetAutomationApiDeleteFleetScheduleRequest, options?: Configuration): Promise<void> {
   ...
   * @param param The request object
   */
  public getFleetAgentInfo(param: FleetAutomationApiGetFleetAgentInfoRequest, options?: Configuration): Promise<FleetAgentInfoResponse> {
   ...
   * @param param The request object
   */
  public getFleetDeployment(param: FleetAutomationApiGetFleetDeploymentRequest, options?: Configuration): Promise<FleetDeploymentResponse> {
   ...
   * @param param The request object
   */
  public getFleetSchedule(param: FleetAutomationApiGetFleetScheduleRequest, options?: Configuration): Promise<FleetScheduleResponse> {
   ...
   * @param param The request object
   */
  public listFleetAgents(param: FleetAutomationApiListFleetAgentsRequest = {}, options?: Configuration): Promise<FleetAgentsResponse> {
   ...
   * @param param The request object
   */
  public listFleetAgentTracers(param: FleetAutomationApiListFleetAgentTracersRequest, options?: Configuration): Promise<FleetTracersResponse> {
   ...
   * @param param The request object
   */
  public listFleetAgentVersions( options?: Configuration): Promise<FleetAgentVersionsResponse> {
   ...
   * @param param The request object
   */
  public listFleetDeployments(param: FleetAutomationApiListFleetDeploymentsRequest = {}, options?: Configuration): Promise<FleetDeploymentsResponse> {
   ...
   * @param param The request object
   */
  public listFleetSchedules( options?: Configuration): Promise<FleetSchedulesResponse> {
   ...
   * @param param The request object
   */
  public listFleetTracers(param: FleetAutomationApiListFleetTracersRequest = {}, options?: Configuration): Promise<FleetTracersResponse> {
   ...
   * @param param The request object
   */
  public triggerFleetSchedule(param: FleetAutomationApiTriggerFleetScheduleRequest, options?: Configuration): Promise<FleetDeploymentResponse> {
   ...
   * @param param The request object
   */
  public updateFleetSchedule(param: FleetAutomationApiUpdateFleetScheduleRequest, options?: Configuration): Promise<FleetScheduleResponse> {
