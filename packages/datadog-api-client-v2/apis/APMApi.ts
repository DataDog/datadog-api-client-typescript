...
export class APMApiRequestFactory extends BaseAPIRequestFactory {
  ...
  public async getServiceList(filterEnv: string,_options?: Configuration): Promise<RequestContext> {
    ...
    const requestContext = _config.getServer('v2.APMApi.getServiceList').makeRequestContext(localVarPath, HttpMethod.GET);
    requestContext.setHeaderParam("Accept", "application/json");
    requestContext.setHttpConfig(_config.httpConfig);

    // Query Params
  if (filterEnv !== undefined) {
      requestContext.setQueryParam("filter[env]", ObjectSerializer.serialize(filterEnv, "string", ""
), "");
    }
...
export class APMApi {
  ...
  public constructor(configuration: Configuration, requestFactory?: APMApiRequestFactory, responseProcessor?: APMApiResponseProcessor) {
    this.configuration = configuration;
    this.requestFactory = requestFactory || new APMApiRequestFactory(configuration);
   ...
   */
  public getServiceList(param: APMApiGetServiceListRequest, options?: Configuration): Promise<ServiceList> {
