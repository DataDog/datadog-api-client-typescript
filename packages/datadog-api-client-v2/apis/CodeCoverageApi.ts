...
export class CodeCoverageApiRequestFactory extends BaseAPIRequestFactory {
  ...
  public async getCodeCoverageBranchSummary(body: BranchCoverageSummaryRequest,_options?: Configuration): Promise<RequestContext> {
    ...
    const requestContext = _config.getServer('v2.CodeCoverageApi.getCodeCoverageBranchSummary').makeRequestContext(localVarPath, HttpMethod.POST);
  ...
  public async getCodeCoverageCommitSummary(body: CommitCoverageSummaryRequest,_options?: Configuration): Promise<RequestContext> {
    const _config = _options || this.configuration;
    ...
    // Make Request Context
    const requestContext = _config.getServer('v2.CodeCoverageApi.getCodeCoverageCommitSummary').makeRequestContext(localVarPath, HttpMethod.POST);
    requestContext.setHeaderParam("Accept", "application/json");
    requestContext.setHttpConfig(_config.httpConfig);
...
export class CodeCoverageApiResponseProcessor {
   ...
   */
   public async getCodeCoverageBranchSummary(response: ResponseContext): Promise<CoverageSummaryResponse> {
   ...
   * @throws ApiException if the response code was not in [200, 299]
   */
   public async getCodeCoverageCommitSummary(response: ResponseContext): Promise<CoverageSummaryResponse> {
    const contentType = ObjectSerializer.normalizeMediaType(response.headers["content-type"]);
    if (response.httpStatusCode === 200) {
      const body: CoverageSummaryResponse = ObjectSerializer.deserialize(
        ObjectSerializer.parse(await response.body.text(), contentType),
...
export class CodeCoverageApi {
  ...
  public constructor(configuration: Configuration, requestFactory?: CodeCoverageApiRequestFactory, responseProcessor?: CodeCoverageApiResponseProcessor) {
    this.configuration = configuration;
    this.requestFactory = requestFactory || new CodeCoverageApiRequestFactory(configuration);
    this.responseProcessor = responseProcessor || new CodeCoverageApiResponseProcessor();
  }
   ...
   */
  public getCodeCoverageBranchSummary(param: CodeCoverageApiGetCodeCoverageBranchSummaryRequest, options?: Configuration): Promise<CoverageSummaryResponse> {
   ...
   * @param param The request object
   */
  public getCodeCoverageCommitSummary(param: CodeCoverageApiGetCodeCoverageCommitSummaryRequest, options?: Configuration): Promise<CoverageSummaryResponse> {
