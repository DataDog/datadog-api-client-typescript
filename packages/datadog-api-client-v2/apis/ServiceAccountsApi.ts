...
export class ServiceAccountsApiRequestFactory extends BaseAPIRequestFactory {
  ...
  public async createServiceAccountAccessToken(serviceAccountId: string,body: ServiceAccountAccessTokenCreateRequest,_options?: Configuration): Promise<RequestContext> {
    const _config = _options || this.configuration;

    // verify required parameter 'serviceAccountId' is not null or undefined
    if (serviceAccountId === null || serviceAccountId === undefined) {
      throw new RequiredError('serviceAccountId', 'createServiceAccountAccessToken');
    }

    // verify required parameter 'body' is not null or undefined
    if (body === null || body === undefined) {
      throw new RequiredError('body', 'createServiceAccountAccessToken');
    }

    // Path Params
    const localVarPath = '/api/v2/service_accounts/{service_account_id}/access_tokens'
      .replace('{service_account_id}', encodeURIComponent(String(serviceAccountId)));

    // Make Request Context
    const requestContext = _config.getServer('v2.ServiceAccountsApi.createServiceAccountAccessToken').makeRequestContext(localVarPath, HttpMethod.POST);
    requestContext.setHeaderParam("Accept", "application/json");
    requestContext.setHttpConfig(_config.httpConfig);
    ...
    requestContext.setHeaderParam("Content-Type", contentType);
    const serializedBody = ObjectSerializer.stringify(
      ObjectSerializer.serialize(body, "ServiceAccountAccessTokenCreateRequest", ""),
      contentType
    );
    requestContext.setBody(serializedBody);
  ...
  public async getServiceAccountAccessToken(serviceAccountId: string,tokenId: string,_options?: Configuration): Promise<RequestContext> {
    const _config = _options || this.configuration;

    // verify required parameter 'serviceAccountId' is not null or undefined
    if (serviceAccountId === null || serviceAccountId === undefined) {
      throw new RequiredError('serviceAccountId', 'getServiceAccountAccessToken');
    }
    ...
    // Make Request Context
    const requestContext = _config.getServer('v2.ServiceAccountsApi.getServiceAccountAccessToken').makeRequestContext(localVarPath, HttpMethod.GET);
    requestContext.setHeaderParam("Accept", "application/json");
    requestContext.setHttpConfig(_config.httpConfig);
  ...
  public async listServiceAccountAccessTokens(serviceAccountId: string,pageSize?: number,pageNumber?: number,sort?: PersonalAccessTokensSort,filter?: string,_options?: Configuration): Promise<RequestContext> {
    const _config = _options || this.configuration;

    // verify required parameter 'serviceAccountId' is not null or undefined
    if (serviceAccountId === null || serviceAccountId === undefined) {
      throw new RequiredError('serviceAccountId', 'listServiceAccountAccessTokens');
    }
    ...
    // Make Request Context
    const requestContext = _config.getServer('v2.ServiceAccountsApi.listServiceAccountAccessTokens').makeRequestContext(localVarPath, HttpMethod.GET);
    requestContext.setHeaderParam("Accept", "application/json");
    requestContext.setHttpConfig(_config.httpConfig);
  ...
  public async revokeServiceAccountAccessToken(serviceAccountId: string,tokenId: string,_options?: Configuration): Promise<RequestContext> {
    const _config = _options || this.configuration;

    // verify required parameter 'serviceAccountId' is not null or undefined
    if (serviceAccountId === null || serviceAccountId === undefined) {
      throw new RequiredError('serviceAccountId', 'revokeServiceAccountAccessToken');
    }
    ...
    // Make Request Context
    const requestContext = _config.getServer('v2.ServiceAccountsApi.revokeServiceAccountAccessToken').makeRequestContext(localVarPath, HttpMethod.DELETE);
    requestContext.setHeaderParam("Accept", "*/*");
    requestContext.setHttpConfig(_config.httpConfig);
  ...
  public async updateServiceAccountAccessToken(serviceAccountId: string,tokenId: string,body: ServiceAccountAccessTokenUpdateRequest,_options?: Configuration): Promise<RequestContext> {
    const _config = _options || this.configuration;

    // verify required parameter 'serviceAccountId' is not null or undefined
    if (serviceAccountId === null || serviceAccountId === undefined) {
      throw new RequiredError('serviceAccountId', 'updateServiceAccountAccessToken');
    }
    ...
    // verify required parameter 'body' is not null or undefined
    if (body === null || body === undefined) {
      throw new RequiredError('body', 'updateServiceAccountAccessToken');
    }
    ...
    // Make Request Context
    const requestContext = _config.getServer('v2.ServiceAccountsApi.updateServiceAccountAccessToken').makeRequestContext(localVarPath, HttpMethod.PATCH);
    requestContext.setHeaderParam("Accept", "application/json");
    requestContext.setHttpConfig(_config.httpConfig);
    ...
    requestContext.setHeaderParam("Content-Type", contentType);
    const serializedBody = ObjectSerializer.stringify(
      ObjectSerializer.serialize(body, "ServiceAccountAccessTokenUpdateRequest", ""),
      contentType
    );
    requestContext.setBody(serializedBody);
...
export class ServiceAccountsApiResponseProcessor {
   ...
   * @throws ApiException if the response code was not in [200, 299]
   */
   public async createServiceAccountAccessToken(response: ResponseContext): Promise<ServiceAccessTokenCreateResponse> {
    const contentType = ObjectSerializer.normalizeMediaType(response.headers["content-type"]);
    if (response.httpStatusCode === 201) {
      const body: ServiceAccessTokenCreateResponse = ObjectSerializer.deserialize(
        ObjectSerializer.parse(await response.body.text(), contentType),
   ...
   * @throws ApiException if the response code was not in [200, 299]
   */
   public async getServiceAccountAccessToken(response: ResponseContext): Promise<ServiceAccessTokenResponse> {
    const contentType = ObjectSerializer.normalizeMediaType(response.headers["content-type"]);
   ...
   * @throws ApiException if the response code was not in [200, 299]
   */
   public async listServiceAccountAccessTokens(response: ResponseContext): Promise<ListServiceAccessTokensResponse> {
    const contentType = ObjectSerializer.normalizeMediaType(response.headers["content-type"]);
    if (response.httpStatusCode === 200) {
      const body: ListServiceAccessTokensResponse = ObjectSerializer.deserialize(
        ObjectSerializer.parse(await response.body.text(), contentType),
   ...
   * @throws ApiException if the response code was not in [200, 299]
   */
   public async revokeServiceAccountAccessToken(response: ResponseContext): Promise<void> {
    const contentType = ObjectSerializer.normalizeMediaType(response.headers["content-type"]);
    if (response.httpStatusCode === 204) {
      return;
    }
   ...
   * @throws ApiException if the response code was not in [200, 299]
   */
   public async updateServiceAccountAccessToken(response: ResponseContext): Promise<ServiceAccessTokenResponse> {
    const contentType = ObjectSerializer.normalizeMediaType(response.headers["content-type"]);
    if (response.httpStatusCode === 200) {
      const body: ServiceAccessTokenResponse = ObjectSerializer.deserialize(
        ObjectSerializer.parse(await response.body.text(), contentType),
...
export class ServiceAccountsApi {
   ...
   * @param param The request object
   */
  public createServiceAccountAccessToken(param: ServiceAccountsApiCreateServiceAccountAccessTokenRequest, options?: Configuration): Promise<ServiceAccessTokenCreateResponse> {
   ...
   * @param param The request object
   */
  public getServiceAccountAccessToken(param: ServiceAccountsApiGetServiceAccountAccessTokenRequest, options?: Configuration): Promise<ServiceAccessTokenResponse> {
   ...
   * @param param The request object
   */
  public listServiceAccountAccessTokens(param: ServiceAccountsApiListServiceAccountAccessTokensRequest, options?: Configuration): Promise<ListServiceAccessTokensResponse> {
   ...
   * @param param The request object
   */
  public revokeServiceAccountAccessToken(param: ServiceAccountsApiRevokeServiceAccountAccessTokenRequest, options?: Configuration): Promise<void> {
   ...
   * @param param The request object
   */
  public updateServiceAccountAccessToken(param: ServiceAccountsApiUpdateServiceAccountAccessTokenRequest, options?: Configuration): Promise<ServiceAccessTokenResponse> {
