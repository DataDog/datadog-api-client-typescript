...
export class ServiceAccountsApiRequestFactory extends BaseAPIRequestFactory {
  ...
  public async createServiceAccountApplicationKey(serviceAccountId: string,body: ApplicationKeyCreateRequest,_options?: Configuration): Promise<RequestContext> {
    ...
    if (serviceAccountId === null || serviceAccountId === undefined) {
      throw new RequiredError('Required parameter serviceAccountId was null or undefined when calling createServiceAccountApplicationKey.');
    }

    // verify required parameter 'body' is not null or undefined
    if (body === null || body === undefined) {
      throw new RequiredError('Required parameter body was null or undefined when calling createServiceAccountApplicationKey.');
    }
    ...
    const requestContext = getServer(_config, 'ServiceAccountsApi.createServiceAccountApplicationKey').makeRequestContext(localVarPath, HttpMethod.POST);
  ...
  public async deleteServiceAccountApplicationKey(serviceAccountId: string,appKeyId: string,_options?: Configuration): Promise<RequestContext> {
    ...
    // verify required parameter 'serviceAccountId' is not null or undefined
    if (serviceAccountId === null || serviceAccountId === undefined) {
      throw new RequiredError('Required parameter serviceAccountId was null or undefined when calling deleteServiceAccountApplicationKey.');
    }

    // verify required parameter 'appKeyId' is not null or undefined
    if (appKeyId === null || appKeyId === undefined) {
      throw new RequiredError('Required parameter appKeyId was null or undefined when calling deleteServiceAccountApplicationKey.');
    }
    ...
    // Make Request Context
    const requestContext = getServer(_config, 'ServiceAccountsApi.deleteServiceAccountApplicationKey').makeRequestContext(localVarPath, HttpMethod.DELETE);
  ...
  public async getServiceAccountApplicationKey(serviceAccountId: string,appKeyId: string,_options?: Configuration): Promise<RequestContext> {
    ...
    // verify required parameter 'serviceAccountId' is not null or undefined
    if (serviceAccountId === null || serviceAccountId === undefined) {
      throw new RequiredError('Required parameter serviceAccountId was null or undefined when calling getServiceAccountApplicationKey.');
    }

    // verify required parameter 'appKeyId' is not null or undefined
    if (appKeyId === null || appKeyId === undefined) {
      throw new RequiredError('Required parameter appKeyId was null or undefined when calling getServiceAccountApplicationKey.');
    }
    ...
    // Make Request Context
    const requestContext = getServer(_config, 'ServiceAccountsApi.getServiceAccountApplicationKey').makeRequestContext(localVarPath, HttpMethod.GET);
    requestContext.setHeaderParam("Accept", "application/json");
    requestContext.setHttpConfig(_config.httpConfig);
  ...
  public async listServiceAccountApplicationKeys(serviceAccountId: string,pageSize?: number,pageNumber?: number,sort?: ApplicationKeysSort,filter?: string,filterCreatedAtStart?: string,filterCreatedAtEnd?: string,_options?: Configuration): Promise<RequestContext> {
    ...
    // verify required parameter 'serviceAccountId' is not null or undefined
    if (serviceAccountId === null || serviceAccountId === undefined) {
      throw new RequiredError('Required parameter serviceAccountId was null or undefined when calling listServiceAccountApplicationKeys.');
    }
    ...
    // Make Request Context
    const requestContext = getServer(_config, 'ServiceAccountsApi.listServiceAccountApplicationKeys').makeRequestContext(localVarPath, HttpMethod.GET);
    requestContext.setHeaderParam("Accept", "application/json");
    requestContext.setHttpConfig(_config.httpConfig);
  ...
  public async updateServiceAccountApplicationKey(serviceAccountId: string,appKeyId: string,body: ApplicationKeyUpdateRequest,_options?: Configuration): Promise<RequestContext> {
    ...
    // verify required parameter 'serviceAccountId' is not null or undefined
    if (serviceAccountId === null || serviceAccountId === undefined) {
      throw new RequiredError('Required parameter serviceAccountId was null or undefined when calling updateServiceAccountApplicationKey.');
    }

    // verify required parameter 'appKeyId' is not null or undefined
    if (appKeyId === null || appKeyId === undefined) {
      throw new RequiredError('Required parameter appKeyId was null or undefined when calling updateServiceAccountApplicationKey.');
    }

    // verify required parameter 'body' is not null or undefined
    if (body === null || body === undefined) {
      throw new RequiredError('Required parameter body was null or undefined when calling updateServiceAccountApplicationKey.');
    }
    ...
    // Make Request Context
    const requestContext = getServer(_config, 'ServiceAccountsApi.updateServiceAccountApplicationKey').makeRequestContext(localVarPath, HttpMethod.PATCH);
    requestContext.setHeaderParam("Accept", "application/json");
    requestContext.setHttpConfig(_config.httpConfig);
