...
export class NetworkHealthInsightsApiRequestFactory extends BaseAPIRequestFactory {
  ...
  public async listNetworkHealthInsights(from?: string,to?: string,_options?: Configuration): Promise<RequestContext> {
    ...
    if (!_config.unstableOperations['v2.listNetworkHealthInsights']) {
      throw new Error("Unstable operation 'listNetworkHealthInsights' is disabled");
    }
    ...
    const requestContext = _config.getServer('v2.NetworkHealthInsightsApi.listNetworkHealthInsights').makeRequestContext(localVarPath, HttpMethod.GET);
...
export class NetworkHealthInsightsApiResponseProcessor {
   ...
   */
   public async listNetworkHealthInsights(response: ResponseContext): Promise<NetworkHealthInsightsResponse> {
...
export class NetworkHealthInsightsApi {
  ...
  public constructor(configuration: Configuration, requestFactory?: NetworkHealthInsightsApiRequestFactory, responseProcessor?: NetworkHealthInsightsApiResponseProcessor) {
    this.configuration = configuration;
    this.requestFactory = requestFactory || new NetworkHealthInsightsApiRequestFactory(configuration);
    this.responseProcessor = responseProcessor || new NetworkHealthInsightsApiResponseProcessor();
  }
   ...
   */
  public listNetworkHealthInsights(param: NetworkHealthInsightsApiListNetworkHealthInsightsRequest = {}, options?: Configuration): Promise<NetworkHealthInsightsResponse> {
    const requestContextPromise = this.requestFactory.listNetworkHealthInsights(param.from,param.to,options);
