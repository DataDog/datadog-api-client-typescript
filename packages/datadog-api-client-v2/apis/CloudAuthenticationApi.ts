...
export class CloudAuthenticationApiRequestFactory extends BaseAPIRequestFactory {
  ...
  public async createAWSCloudAuthPersonaMapping(body: AWSCloudAuthPersonaMappingCreateRequest,_options?: Configuration): Promise<RequestContext> {
    ...
    const requestContext = _config.getServer('v2.CloudAuthenticationApi.createAWSCloudAuthPersonaMapping').makeRequestContext(localVarPath, HttpMethod.POST);
    ...
    const serializedBody = ObjectSerializer.stringify(
      ObjectSerializer.serialize(body, "AWSCloudAuthPersonaMappingCreateRequest", ""),
      contentType
    );
  ...
  public async deleteAWSCloudAuthPersonaMapping(personaMappingId: string,_options?: Configuration): Promise<RequestContext> {
    const _config = _options || this.configuration;
    ...
    // Path Params
    const localVarPath = '/api/v2/cloud_auth/aws/persona_mapping/{persona_mapping_id}'
      .replace('{persona_mapping_id}', encodeURIComponent(String(personaMappingId)));

    // Make Request Context
    const requestContext = _config.getServer('v2.CloudAuthenticationApi.deleteAWSCloudAuthPersonaMapping').makeRequestContext(localVarPath, HttpMethod.DELETE);
  ...
  public async getAWSCloudAuthPersonaMapping(personaMappingId: string,_options?: Configuration): Promise<RequestContext> {
    const _config = _options || this.configuration;
    ...
    // Make Request Context
    const requestContext = _config.getServer('v2.CloudAuthenticationApi.getAWSCloudAuthPersonaMapping').makeRequestContext(localVarPath, HttpMethod.GET);
    requestContext.setHeaderParam("Accept", "application/json");
    requestContext.setHttpConfig(_config.httpConfig);
  ...
  public async listAWSCloudAuthPersonaMappings(_options?: Configuration): Promise<RequestContext> {
    const _config = _options || this.configuration;
    ...
    // Make Request Context
    const requestContext = _config.getServer('v2.CloudAuthenticationApi.listAWSCloudAuthPersonaMappings').makeRequestContext(localVarPath, HttpMethod.GET);
    requestContext.setHeaderParam("Accept", "application/json");
    requestContext.setHttpConfig(_config.httpConfig);
...
export class CloudAuthenticationApiResponseProcessor {
   ...
   */
   public async createAWSCloudAuthPersonaMapping(response: ResponseContext): Promise<AWSCloudAuthPersonaMappingResponse> {
    const contentType = ObjectSerializer.normalizeMediaType(response.headers["content-type"]);
    if (response.httpStatusCode === 201) {
      const body: AWSCloudAuthPersonaMappingResponse = ObjectSerializer.deserialize(
   ...
   * @throws ApiException if the response code was not in [200, 299]
   */
   public async deleteAWSCloudAuthPersonaMapping(response: ResponseContext): Promise<void> {
    const contentType = ObjectSerializer.normalizeMediaType(response.headers["content-type"]);
   ...
   * @throws ApiException if the response code was not in [200, 299]
   */
   public async getAWSCloudAuthPersonaMapping(response: ResponseContext): Promise<AWSCloudAuthPersonaMappingResponse> {
    const contentType = ObjectSerializer.normalizeMediaType(response.headers["content-type"]);
   ...
   * @throws ApiException if the response code was not in [200, 299]
   */
   public async listAWSCloudAuthPersonaMappings(response: ResponseContext): Promise<AWSCloudAuthPersonaMappingsResponse> {
    const contentType = ObjectSerializer.normalizeMediaType(response.headers["content-type"]);
    if (response.httpStatusCode === 200) {
      const body: AWSCloudAuthPersonaMappingsResponse = ObjectSerializer.deserialize(
        ObjectSerializer.parse(await response.body.text(), contentType),
...
export class CloudAuthenticationApi {
  ...
  public constructor(configuration: Configuration, requestFactory?: CloudAuthenticationApiRequestFactory, responseProcessor?: CloudAuthenticationApiResponseProcessor) {
    this.configuration = configuration;
    this.requestFactory = requestFactory || new CloudAuthenticationApiRequestFactory(configuration);
    this.responseProcessor = responseProcessor || new CloudAuthenticationApiResponseProcessor();
  }
   ...
   */
  public createAWSCloudAuthPersonaMapping(param: CloudAuthenticationApiCreateAWSCloudAuthPersonaMappingRequest, options?: Configuration): Promise<AWSCloudAuthPersonaMappingResponse> {
   ...
   * @param param The request object
   */
  public deleteAWSCloudAuthPersonaMapping(param: CloudAuthenticationApiDeleteAWSCloudAuthPersonaMappingRequest, options?: Configuration): Promise<void> {
   ...
   * @param param The request object
   */
  public getAWSCloudAuthPersonaMapping(param: CloudAuthenticationApiGetAWSCloudAuthPersonaMappingRequest, options?: Configuration): Promise<AWSCloudAuthPersonaMappingResponse> {
   ...
   * @param param The request object
   */
  public listAWSCloudAuthPersonaMappings( options?: Configuration): Promise<AWSCloudAuthPersonaMappingsResponse> {
