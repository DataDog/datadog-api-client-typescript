...
export class RUMApiRequestFactory extends BaseAPIRequestFactory {
  ...
  public async aggregateRUMEvents(body: RUMAggregateRequest,_options?: Configuration): Promise<RequestContext> {
    ...
    if (body === null || body === undefined) {
      throw new RequiredError('Required parameter body was null or undefined when calling aggregateRUMEvents.');
    }
    ...
    const requestContext = getServer(_config, 'RUMApi.aggregateRUMEvents').makeRequestContext(localVarPath, HttpMethod.POST);
  ...
  public async listRUMEvents(filterQuery?: string,filterFrom?: Date,filterTo?: Date,sort?: RUMSort,pageCursor?: string,pageLimit?: number,_options?: Configuration): Promise<RequestContext> {
    ...
    // Make Request Context
    const requestContext = getServer(_config, 'RUMApi.listRUMEvents').makeRequestContext(localVarPath, HttpMethod.GET);
    requestContext.setHeaderParam("Accept", "application/json");
    requestContext.setHttpConfig(_config.httpConfig);
  ...
  public async searchRUMEvents(body: RUMSearchEventsRequest,_options?: Configuration): Promise<RequestContext> {
    ...
    // verify required parameter 'body' is not null or undefined
    if (body === null || body === undefined) {
      throw new RequiredError('Required parameter body was null or undefined when calling searchRUMEvents.');
    }
    ...
    // Make Request Context
    const requestContext = getServer(_config, 'RUMApi.searchRUMEvents').makeRequestContext(localVarPath, HttpMethod.POST);
    requestContext.setHeaderParam("Accept", "application/json");
    requestContext.setHttpConfig(_config.httpConfig);
