...
import { CloudWorkloadSecurityAgentPolicyBatchUpdateRequest } from "../models/CloudWorkloadSecurityAgentPolicyBatchUpdateRequest";
...
export class CSMThreatsApiRequestFactory extends BaseAPIRequestFactory {
  public async batchUpdateCSMThreatsAgentPolicy(
    ...
    if (body === null || body === undefined) {
      throw new RequiredError("body", "batchUpdateCSMThreatsAgentPolicy");
    }
    ...
    const requestContext = _config
      .getServer("v2.CSMThreatsApi.batchUpdateCSMThreatsAgentPolicy")
  ...
  public async deleteCSMThreatsAgentRule(
    ...
    if (policyId !== undefined) {
      requestContext.setQueryParam(
        "policy_id",
        ObjectSerializer.serialize(policyId, "string", ""),
        ""
      );
    }
...
export class CSMThreatsApiResponseProcessor {
   ...
   *
   * @params response Response returned by the server for a request to batchUpdateCSMThreatsAgentPolicy
  ...
  public async batchUpdateCSMThreatsAgentPolicy(
    ...
    if (response.httpStatusCode === 200) {
      const body: CloudWorkloadSecurityAgentPoliciesListResponse =
...
export interface CSMThreatsApiBatchUpdateCSMThreatsAgentPolicyRequest {
  /**
   * New definition of Agent policies
   * @type CloudWorkloadSecurityAgentPolicyBatchUpdateRequest
   */
  body: CloudWorkloadSecurityAgentPolicyBatchUpdateRequest;
}
...
export class CSMThreatsApi {
   ...
   */
  public batchUpdateCSMThreatsAgentPolicy(
    param: CSMThreatsApiBatchUpdateCSMThreatsAgentPolicyRequest,
    options?: Configuration
  ): Promise<CloudWorkloadSecurityAgentPoliciesListResponse> {
    const requestContextPromise =
      this.requestFactory.batchUpdateCSMThreatsAgentPolicy(param.body, options);
    return requestContextPromise.then((requestContext) => {
      return this.configuration.httpApi
        .send(requestContext)
        .then((responseContext) => {
          return this.responseProcessor.batchUpdateCSMThreatsAgentPolicy(
            responseContext
          );
        });
    });
