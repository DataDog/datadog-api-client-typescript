...
export class CloudCostManagementApiRequestFactory extends BaseAPIRequestFactory {
  ...
  public async createCostGCPUsageCostConfig(body: GCPUsageCostConfigPostRequest,_options?: Configuration): Promise<RequestContext> {
    const _config = _options || this.configuration;
    ...
    // Make Request Context
    const requestContext = _config.getServer('v2.CloudCostManagementApi.createCostGCPUsageCostConfig').makeRequestContext(localVarPath, HttpMethod.POST);
    requestContext.setHeaderParam("Accept", "application/json");
    requestContext.setHttpConfig(_config.httpConfig);
  ...
  public async createCustomAllocationRule(body: ArbitraryCostUpsertRequest,_options?: Configuration): Promise<RequestContext> {
    const _config = _options || this.configuration;
    ...
    // Make Request Context
    const requestContext = _config.getServer('v2.CloudCostManagementApi.createCustomAllocationRule').makeRequestContext(localVarPath, HttpMethod.POST);
    requestContext.setHeaderParam("Accept", "application/json");
    requestContext.setHttpConfig(_config.httpConfig);
  ...
  public async createTagPipelinesRuleset(body: CreateRulesetRequest,_options?: Configuration): Promise<RequestContext> {
    const _config = _options || this.configuration;
    ...
    // Make Request Context
    const requestContext = _config.getServer('v2.CloudCostManagementApi.createTagPipelinesRuleset').makeRequestContext(localVarPath, HttpMethod.POST);
    requestContext.setHeaderParam("Accept", "application/json");
    requestContext.setHttpConfig(_config.httpConfig);
  ...
  public async deleteCostAWSCURConfig(cloudAccountId: number,_options?: Configuration): Promise<RequestContext> {
    const _config = _options || this.configuration;
  ...
  public async deleteCostAzureUCConfig(cloudAccountId: number,_options?: Configuration): Promise<RequestContext> {
    const _config = _options || this.configuration;
  ...
  public async deleteCostGCPUsageCostConfig(cloudAccountId: number,_options?: Configuration): Promise<RequestContext> {
    const _config = _options || this.configuration;
    ...
    // Path Params
    const localVarPath = '/api/v2/cost/gcp_uc_config/{cloud_account_id}'
      .replace('{cloud_account_id}', encodeURIComponent(String(cloudAccountId)));

    // Make Request Context
    const requestContext = _config.getServer('v2.CloudCostManagementApi.deleteCostGCPUsageCostConfig').makeRequestContext(localVarPath, HttpMethod.DELETE);
    requestContext.setHeaderParam("Accept", "*/*");
    requestContext.setHttpConfig(_config.httpConfig);
  ...
  public async deleteCostTagDescriptionByKey(tagKey: string,cloud?: string,_options?: Configuration): Promise<RequestContext> {
    const _config = _options || this.configuration;
    ...
    // Path Params
    const localVarPath = '/api/v2/cost/tag_descriptions/{tag_key}'
      .replace('{tag_key}', encodeURIComponent(String(tagKey)));

    // Make Request Context
    const requestContext = _config.getServer('v2.CloudCostManagementApi.deleteCostTagDescriptionByKey').makeRequestContext(localVarPath, HttpMethod.DELETE);
    requestContext.setHeaderParam("Accept", "*/*");
    requestContext.setHttpConfig(_config.httpConfig);

    // Query Params
  if (cloud !== undefined) {
      requestContext.setQueryParam("cloud", ObjectSerializer.serialize(cloud, "string", ""
), "");
    }
  ...
  public async deleteCustomAllocationRule(ruleId: number,_options?: Configuration): Promise<RequestContext> {
    const _config = _options || this.configuration;
    ...
    // Path Params
    const localVarPath = '/api/v2/cost/arbitrary_rule/{rule_id}'
      .replace('{rule_id}', encodeURIComponent(String(ruleId)));

    // Make Request Context
    const requestContext = _config.getServer('v2.CloudCostManagementApi.deleteCustomAllocationRule').makeRequestContext(localVarPath, HttpMethod.DELETE);
    requestContext.setHeaderParam("Accept", "*/*");
    requestContext.setHttpConfig(_config.httpConfig);
  ...
  public async deleteCustomForecast(budgetId: string,_options?: Configuration): Promise<RequestContext> {
    const _config = _options || this.configuration;
    ...
    // Path Params
    const localVarPath = '/api/v2/cost/budget/{budget_id}/custom-forecast'
      .replace('{budget_id}', encodeURIComponent(String(budgetId)));

    // Make Request Context
    const requestContext = _config.getServer('v2.CloudCostManagementApi.deleteCustomForecast').makeRequestContext(localVarPath, HttpMethod.DELETE);
    requestContext.setHeaderParam("Accept", "*/*");
    requestContext.setHttpConfig(_config.httpConfig);
  ...
  public async deleteTagPipelinesRuleset(rulesetId: string,_options?: Configuration): Promise<RequestContext> {
    const _config = _options || this.configuration;
    ...
    // Path Params
    const localVarPath = '/api/v2/tags/enrichment/{ruleset_id}'
      .replace('{ruleset_id}', encodeURIComponent(String(rulesetId)));

    // Make Request Context
    const requestContext = _config.getServer('v2.CloudCostManagementApi.deleteTagPipelinesRuleset').makeRequestContext(localVarPath, HttpMethod.DELETE);
    requestContext.setHeaderParam("Accept", "*/*");
    requestContext.setHttpConfig(_config.httpConfig);
  ...
  public async generateCostTagDescriptionByKey(tagKey: string,_options?: Configuration): Promise<RequestContext> {
    const _config = _options || this.configuration;
    ...
    // Path Params
    const localVarPath = '/api/v2/cost/tag_descriptions/{tag_key}/generate'
      .replace('{tag_key}', encodeURIComponent(String(tagKey)));

    // Make Request Context
    const requestContext = _config.getServer('v2.CloudCostManagementApi.generateCostTagDescriptionByKey').makeRequestContext(localVarPath, HttpMethod.GET);
    requestContext.setHeaderParam("Accept", "application/json");
    requestContext.setHttpConfig(_config.httpConfig);
  ...
  public async getBudget(budgetId: string,actual?: boolean,forecast?: boolean,start?: number,end?: number,_options?: Configuration): Promise<RequestContext> {
    const _config = _options || this.configuration;
    ...
    // Query Params
  if (actual !== undefined) {
      requestContext.setQueryParam("actual", ObjectSerializer.serialize(actual, "boolean", ""
), "");
    }
  if (forecast !== undefined) {
      requestContext.setQueryParam("forecast", ObjectSerializer.serialize(forecast, "boolean", ""
), "");
    }
  if (start !== undefined) {
  ...
  public async getCommitmentsCommitmentList(provider: CommitmentsProvider,product: string,start: number,end: number,filterBy?: string,commitmentType?: CommitmentsCommitmentType,_options?: Configuration): Promise<RequestContext> {
    const _config = _options || this.configuration;
    ...
    // Make Request Context
    const requestContext = _config.getServer('v2.CloudCostManagementApi.getCommitmentsCommitmentList').makeRequestContext(localVarPath, HttpMethod.GET);
    requestContext.setHeaderParam("Accept", "application/json");
    requestContext.setHttpConfig(_config.httpConfig);

    // Query Params
  if (provider !== undefined) {
      requestContext.setQueryParam("provider", ObjectSerializer.serialize(provider, "CommitmentsProvider", ""
), "");
    }
  ...
  if (filterBy !== undefined) {
      requestContext.setQueryParam("filterBy", ObjectSerializer.serialize(filterBy, "string", ""
), "");
    }
  if (commitmentType !== undefined) {
      requestContext.setQueryParam("commitmentType", ObjectSerializer.serialize(commitmentType, "CommitmentsCommitmentType", ""
), "");
    }
  ...
  public async getCommitmentsCoverageScalar(provider: CommitmentsProvider,product: string,start: number,end: number,filterBy?: string,_options?: Configuration): Promise<RequestContext> {
    const _config = _options || this.configuration;
    ...
    // Make Request Context
    const requestContext = _config.getServer('v2.CloudCostManagementApi.getCommitmentsCoverageScalar').makeRequestContext(localVarPath, HttpMethod.GET);
    requestContext.setHeaderParam("Accept", "application/json");
    requestContext.setHttpConfig(_config.httpConfig);
  ...
  public async getCommitmentsCoverageTimeseries(provider: CommitmentsProvider,product: string,start: number,end: number,filterBy?: string,_options?: Configuration): Promise<RequestContext> {
    const _config = _options || this.configuration;
    ...
    // Make Request Context
    const requestContext = _config.getServer('v2.CloudCostManagementApi.getCommitmentsCoverageTimeseries').makeRequestContext(localVarPath, HttpMethod.GET);
    requestContext.setHeaderParam("Accept", "application/json");
    requestContext.setHttpConfig(_config.httpConfig);
  ...
  public async getCommitmentsOnDemandHotspotsScalar(provider: CommitmentsProvider,product: string,start: number,end: number,filterBy?: string,_options?: Configuration): Promise<RequestContext> {
    const _config = _options || this.configuration;

    logger.warn("Using unstable operation 'getCommitmentsOnDemandHotspotsScalar'");
    ...
    // Make Request Context
    const requestContext = _config.getServer('v2.CloudCostManagementApi.getCommitmentsOnDemandHotspotsScalar').makeRequestContext(localVarPath, HttpMethod.GET);
    requestContext.setHeaderParam("Accept", "application/json");
    requestContext.setHttpConfig(_config.httpConfig);
  ...
  public async getCommitmentsSavingsScalar(provider: CommitmentsProvider,product: string,start: number,end: number,filterBy?: string,_options?: Configuration): Promise<RequestContext> {
    const _config = _options || this.configuration;
    ...
    // Make Request Context
    const requestContext = _config.getServer('v2.CloudCostManagementApi.getCommitmentsSavingsScalar').makeRequestContext(localVarPath, HttpMethod.GET);
    requestContext.setHeaderParam("Accept", "application/json");
    requestContext.setHttpConfig(_config.httpConfig);
  ...
  public async getCommitmentsSavingsTimeseries(provider: CommitmentsProvider,product: string,start: number,end: number,filterBy?: string,_options?: Configuration): Promise<RequestContext> {
    const _config = _options || this.configuration;
    ...
    // Make Request Context
    const requestContext = _config.getServer('v2.CloudCostManagementApi.getCommitmentsSavingsTimeseries').makeRequestContext(localVarPath, HttpMethod.GET);
    requestContext.setHeaderParam("Accept", "application/json");
    requestContext.setHttpConfig(_config.httpConfig);
  ...
  public async getCommitmentsUtilizationScalar(provider: CommitmentsProvider,product: string,start: number,end: number,filterBy?: string,commitmentType?: CommitmentsCommitmentType,_options?: Configuration): Promise<RequestContext> {
    const _config = _options || this.configuration;
    ...
    // Make Request Context
    const requestContext = _config.getServer('v2.CloudCostManagementApi.getCommitmentsUtilizationScalar').makeRequestContext(localVarPath, HttpMethod.GET);
    requestContext.setHeaderParam("Accept", "application/json");
    requestContext.setHttpConfig(_config.httpConfig);
  ...
  public async getCommitmentsUtilizationTimeseries(provider: CommitmentsProvider,product: string,start: number,end: number,filterBy?: string,commitmentType?: CommitmentsCommitmentType,_options?: Configuration): Promise<RequestContext> {
    const _config = _options || this.configuration;

    logger.warn("Using unstable operation 'getCommitmentsUtilizationTimeseries'");
    ...
    // Make Request Context
    const requestContext = _config.getServer('v2.CloudCostManagementApi.getCommitmentsUtilizationTimeseries').makeRequestContext(localVarPath, HttpMethod.GET);
    requestContext.setHeaderParam("Accept", "application/json");
    requestContext.setHttpConfig(_config.httpConfig);
  ...
  public async getCostAccountFilters(cloudAccountId: number,_options?: Configuration): Promise<RequestContext> {
    const _config = _options || this.configuration;
    ...
    // Path Params
    const localVarPath = '/api/v2/cost/account_filters/{cloud_account_id}'
      .replace('{cloud_account_id}', encodeURIComponent(String(cloudAccountId)));

    // Make Request Context
    const requestContext = _config.getServer('v2.CloudCostManagementApi.getCostAccountFilters').makeRequestContext(localVarPath, HttpMethod.GET);
    requestContext.setHeaderParam("Accept", "application/json");
    requestContext.setHttpConfig(_config.httpConfig);
  ...
  public async getCostAnomaly(anomalyId: string,_options?: Configuration): Promise<RequestContext> {
    const _config = _options || this.configuration;
    ...
    // Path Params
    const localVarPath = '/api/v2/cost/anomalies/{anomaly_id}'
      .replace('{anomaly_id}', encodeURIComponent(String(anomalyId)));

    // Make Request Context
    const requestContext = _config.getServer('v2.CloudCostManagementApi.getCostAnomaly').makeRequestContext(localVarPath, HttpMethod.GET);
    requestContext.setHeaderParam("Accept", "application/json");
    requestContext.setHttpConfig(_config.httpConfig);
  ...
  public async getCostAWSCURConfig(cloudAccountId: number,_options?: Configuration): Promise<RequestContext> {
    const _config = _options || this.configuration;
    ...
    // Make Request Context
    const requestContext = _config.getServer('v2.CloudCostManagementApi.getCostAWSCURConfig').makeRequestContext(localVarPath, HttpMethod.GET);
    requestContext.setHeaderParam("Accept", "application/json");
    requestContext.setHttpConfig(_config.httpConfig);
  ...
  public async getCostAzureUCConfig(cloudAccountId: number,_options?: Configuration): Promise<RequestContext> {
    const _config = _options || this.configuration;
    ...
    // Make Request Context
    const requestContext = _config.getServer('v2.CloudCostManagementApi.getCostAzureUCConfig').makeRequestContext(localVarPath, HttpMethod.GET);
    requestContext.setHeaderParam("Accept", "application/json");
    requestContext.setHttpConfig(_config.httpConfig);
  ...
  public async getCostGCPUsageCostConfig(cloudAccountId: number,_options?: Configuration): Promise<RequestContext> {
    const _config = _options || this.configuration;
    ...
    // Make Request Context
    const requestContext = _config.getServer('v2.CloudCostManagementApi.getCostGCPUsageCostConfig').makeRequestContext(localVarPath, HttpMethod.GET);
    requestContext.setHeaderParam("Accept", "application/json");
    requestContext.setHttpConfig(_config.httpConfig);
  ...
  public async getCostTagDescriptionByKey(tagKey: string,filterCloud?: string,_options?: Configuration): Promise<RequestContext> {
    const _config = _options || this.configuration;
    ...
    // Make Request Context
    const requestContext = _config.getServer('v2.CloudCostManagementApi.getCostTagDescriptionByKey').makeRequestContext(localVarPath, HttpMethod.GET);
    requestContext.setHeaderParam("Accept", "application/json");
    requestContext.setHttpConfig(_config.httpConfig);

    // Query Params
  if (filterCloud !== undefined) {
      requestContext.setQueryParam("filter[cloud]", ObjectSerializer.serialize(filterCloud, "string", ""
), "");
    }
  ...
  public async getCostTagKey(tagKey: string,filterMetric?: string,pageSize?: number,_options?: Configuration): Promise<RequestContext> {
    const _config = _options || this.configuration;
    ...
    // Path Params
    const localVarPath = '/api/v2/cost/tag_keys/{tag_key}'
      .replace('{tag_key}', encodeURIComponent(String(tagKey)));

    // Make Request Context
    const requestContext = _config.getServer('v2.CloudCostManagementApi.getCostTagKey').makeRequestContext(localVarPath, HttpMethod.GET);
    requestContext.setHeaderParam("Accept", "application/json");
    requestContext.setHttpConfig(_config.httpConfig);

    // Query Params
  if (filterMetric !== undefined) {
      requestContext.setQueryParam("filter[metric]", ObjectSerializer.serialize(filterMetric, "string", ""
), "");
    }
  ...
  public async getCostTagMetadataCurrency(filterMonth: string,filterProvider?: string,_options?: Configuration): Promise<RequestContext> {
    const _config = _options || this.configuration;
    ...
    if (!_config.unstableOperations['v2.getCostTagMetadataCurrency']) {
      throw new Error("Unstable operation 'getCostTagMetadataCurrency' is disabled");
    }
    ...
    // Make Request Context
    const requestContext = _config.getServer('v2.CloudCostManagementApi.getCostTagMetadataCurrency').makeRequestContext(localVarPath, HttpMethod.GET);
    requestContext.setHeaderParam("Accept", "application/json");
    requestContext.setHttpConfig(_config.httpConfig);

    // Query Params
  if (filterMonth !== undefined) {
      requestContext.setQueryParam("filter[month]", ObjectSerializer.serialize(filterMonth, "string", ""
), "");
    }
  if (filterProvider !== undefined) {
      requestContext.setQueryParam("filter[provider]", ObjectSerializer.serialize(filterProvider, "string", ""
), "");
    }
  ...
  public async getCustomAllocationRule(ruleId: number,_options?: Configuration): Promise<RequestContext> {
    const _config = _options || this.configuration;
    ...
    // Make Request Context
    const requestContext = _config.getServer('v2.CloudCostManagementApi.getCustomAllocationRule').makeRequestContext(localVarPath, HttpMethod.GET);
    requestContext.setHeaderParam("Accept", "application/json");
    requestContext.setHttpConfig(_config.httpConfig);
  ...
  public async getCustomForecast(budgetId: string,_options?: Configuration): Promise<RequestContext> {
    const _config = _options || this.configuration;
    ...
    // Make Request Context
    const requestContext = _config.getServer('v2.CloudCostManagementApi.getCustomForecast').makeRequestContext(localVarPath, HttpMethod.GET);
    requestContext.setHeaderParam("Accept", "application/json");
    requestContext.setHttpConfig(_config.httpConfig);
  ...
  public async getTagPipelinesRuleset(rulesetId: string,_options?: Configuration): Promise<RequestContext> {
    const _config = _options || this.configuration;
    ...
    // Make Request Context
    const requestContext = _config.getServer('v2.CloudCostManagementApi.getTagPipelinesRuleset').makeRequestContext(localVarPath, HttpMethod.GET);
    requestContext.setHeaderParam("Accept", "application/json");
    requestContext.setHttpConfig(_config.httpConfig);
  ...
  public async listCostAnomalies(start?: number,end?: number,filter?: string,minAnomalousThreshold?: string,minCostThreshold?: string,dismissalCause?: string,orderBy?: string,order?: string,limit?: number,offset?: number,providerIds?: Array<string>,_options?: Configuration): Promise<RequestContext> {
    const _config = _options || this.configuration;
    ...
    // Make Request Context
    const requestContext = _config.getServer('v2.CloudCostManagementApi.listCostAnomalies').makeRequestContext(localVarPath, HttpMethod.GET);
    requestContext.setHeaderParam("Accept", "application/json");
    requestContext.setHttpConfig(_config.httpConfig);
  ...
  if (minAnomalousThreshold !== undefined) {
      requestContext.setQueryParam("min_anomalous_threshold", ObjectSerializer.serialize(minAnomalousThreshold, "string", ""
), "");
    }
  if (minCostThreshold !== undefined) {
      requestContext.setQueryParam("min_cost_threshold", ObjectSerializer.serialize(minCostThreshold, "string", ""
), "");
    }
  if (dismissalCause !== undefined) {
      requestContext.setQueryParam("dismissal_cause", ObjectSerializer.serialize(dismissalCause, "string", ""
), "");
    }
  ...
  if (providerIds !== undefined) {
      requestContext.setQueryParam("provider_ids", ObjectSerializer.serialize(providerIds, "Array<string>", ""
), "multi");
    }
  ...
  public async listCostGCPUsageCostConfigs(_options?: Configuration): Promise<RequestContext> {
    const _config = _options || this.configuration;
    ...
    // Make Request Context
    const requestContext = _config.getServer('v2.CloudCostManagementApi.listCostGCPUsageCostConfigs').makeRequestContext(localVarPath, HttpMethod.GET);
    requestContext.setHeaderParam("Accept", "application/json");
    requestContext.setHttpConfig(_config.httpConfig);
  ...
  public async listCostOCIConfigs(_options?: Configuration): Promise<RequestContext> {
    const _config = _options || this.configuration;
    ...
    // Make Request Context
    const requestContext = _config.getServer('v2.CloudCostManagementApi.listCostOCIConfigs').makeRequestContext(localVarPath, HttpMethod.GET);
    requestContext.setHeaderParam("Accept", "application/json");
    requestContext.setHttpConfig(_config.httpConfig);
  ...
  public async listCostTagDescriptions(filterCloud?: string,_options?: Configuration): Promise<RequestContext> {
    const _config = _options || this.configuration;
    ...
    // Make Request Context
    const requestContext = _config.getServer('v2.CloudCostManagementApi.listCostTagDescriptions').makeRequestContext(localVarPath, HttpMethod.GET);
    requestContext.setHeaderParam("Accept", "application/json");
    requestContext.setHttpConfig(_config.httpConfig);
  ...
  public async listCostTagKeys(filterMetric?: string,filterTags?: Array<string>,_options?: Configuration): Promise<RequestContext> {
    const _config = _options || this.configuration;
    ...
    // Make Request Context
    const requestContext = _config.getServer('v2.CloudCostManagementApi.listCostTagKeys').makeRequestContext(localVarPath, HttpMethod.GET);
    requestContext.setHeaderParam("Accept", "application/json");
    requestContext.setHttpConfig(_config.httpConfig);
  ...
  public async listCostTagKeySources(filterMonth: string,filterProvider?: string,filterMetric?: string,_options?: Configuration): Promise<RequestContext> {
    const _config = _options || this.configuration;
    ...
    // Make Request Context
    const requestContext = _config.getServer('v2.CloudCostManagementApi.listCostTagKeySources').makeRequestContext(localVarPath, HttpMethod.GET);
    requestContext.setHeaderParam("Accept", "application/json");
    requestContext.setHttpConfig(_config.httpConfig);
  ...
  public async listCostTagMetadata(filterMonth: string,filterProvider?: string,filterMetric?: string,filterTagKey?: string,filterDaily?: CostTagMetadataDailyFilter,_options?: Configuration): Promise<RequestContext> {
    const _config = _options || this.configuration;
    ...
    // Make Request Context
    const requestContext = _config.getServer('v2.CloudCostManagementApi.listCostTagMetadata').makeRequestContext(localVarPath, HttpMethod.GET);
    requestContext.setHeaderParam("Accept", "application/json");
    requestContext.setHttpConfig(_config.httpConfig);
  ...
  if (filterTagKey !== undefined) {
      requestContext.setQueryParam("filter[tag_key]", ObjectSerializer.serialize(filterTagKey, "string", ""
), "");
    }
  if (filterDaily !== undefined) {
      requestContext.setQueryParam("filter[daily]", ObjectSerializer.serialize(filterDaily, "CostTagMetadataDailyFilter", ""
), "");
    }
  ...
  public async listCostTagMetadataMetrics(filterMonth: string,filterProvider?: string,_options?: Configuration): Promise<RequestContext> {
    const _config = _options || this.configuration;
    ...
    if (!_config.unstableOperations['v2.listCostTagMetadataMetrics']) {
      throw new Error("Unstable operation 'listCostTagMetadataMetrics' is disabled");
    }
    ...
    // Make Request Context
    const requestContext = _config.getServer('v2.CloudCostManagementApi.listCostTagMetadataMetrics').makeRequestContext(localVarPath, HttpMethod.GET);
    requestContext.setHeaderParam("Accept", "application/json");
    requestContext.setHttpConfig(_config.httpConfig);
  ...
  public async listCostTagMetadataMonths(filterProvider: string,_options?: Configuration): Promise<RequestContext> {
    const _config = _options || this.configuration;

    logger.warn("Using unstable operation 'listCostTagMetadataMonths'");
    if (!_config.unstableOperations['v2.listCostTagMetadataMonths']) {
      throw new Error("Unstable operation 'listCostTagMetadataMonths' is disabled");
    }
    ...
    // Make Request Context
    const requestContext = _config.getServer('v2.CloudCostManagementApi.listCostTagMetadataMonths').makeRequestContext(localVarPath, HttpMethod.GET);
    requestContext.setHeaderParam("Accept", "application/json");
    requestContext.setHttpConfig(_config.httpConfig);
  ...
  public async listCostTagMetadataOrchestrators(filterMonth: string,filterProvider?: string,_options?: Configuration): Promise<RequestContext> {
    const _config = _options || this.configuration;
    ...
    if (!_config.unstableOperations['v2.listCostTagMetadataOrchestrators']) {
      throw new Error("Unstable operation 'listCostTagMetadataOrchestrators' is disabled");
    }
    ...
    // Make Request Context
    const requestContext = _config.getServer('v2.CloudCostManagementApi.listCostTagMetadataOrchestrators').makeRequestContext(localVarPath, HttpMethod.GET);
    requestContext.setHeaderParam("Accept", "application/json");
    requestContext.setHttpConfig(_config.httpConfig);
  ...
  public async listCostTags(filterMetric?: string,filterMatch?: string,filterTags?: Array<string>,filterTagKeys?: Array<string>,pageSize?: number,_options?: Configuration): Promise<RequestContext> {
    const _config = _options || this.configuration;
    ...
    // Make Request Context
    const requestContext = _config.getServer('v2.CloudCostManagementApi.listCostTags').makeRequestContext(localVarPath, HttpMethod.GET);
    requestContext.setHeaderParam("Accept", "application/json");
    requestContext.setHttpConfig(_config.httpConfig);
  ...
  if (filterMatch !== undefined) {
      requestContext.setQueryParam("filter[match]", ObjectSerializer.serialize(filterMatch, "string", ""
), "");
    }
  if (filterTags !== undefined) {
      requestContext.setQueryParam("filter[tags]", ObjectSerializer.serialize(filterTags, "Array<string>", ""
  ...
  if (filterTagKeys !== undefined) {
      requestContext.setQueryParam("filter[tag_keys]", ObjectSerializer.serialize(filterTagKeys, "Array<string>", ""
), "multi");
    }
  if (pageSize !== undefined) {
      requestContext.setQueryParam("page[size]", ObjectSerializer.serialize(pageSize, "number", "int32"
  ...
  public async listCustomAllocationRules(_options?: Configuration): Promise<RequestContext> {
    const _config = _options || this.configuration;
    ...
    // Make Request Context
    const requestContext = _config.getServer('v2.CloudCostManagementApi.listCustomAllocationRules').makeRequestContext(localVarPath, HttpMethod.GET);
    requestContext.setHeaderParam("Accept", "application/json");
    requestContext.setHttpConfig(_config.httpConfig);
  ...
  public async listCustomAllocationRulesStatus(_options?: Configuration): Promise<RequestContext> {
    const _config = _options || this.configuration;
    ...
    // Make Request Context
    const requestContext = _config.getServer('v2.CloudCostManagementApi.listCustomAllocationRulesStatus').makeRequestContext(localVarPath, HttpMethod.GET);
    requestContext.setHeaderParam("Accept", "application/json");
    requestContext.setHttpConfig(_config.httpConfig);
  ...
  public async listCustomCostsFiles(pageNumber?: number,pageSize?: number,filterStatus?: string,filterName?: string,filterProvider?: Array<string>,sort?: string,_options?: Configuration): Promise<RequestContext> {
    const _config = _options || this.configuration;
  ...
  if (filterProvider !== undefined) {
      requestContext.setQueryParam("filter[provider]", ObjectSerializer.serialize(filterProvider, "Array<string>", ""
), "multi");
    }
  if (sort !== undefined) {
  ...
  public async listTagPipelinesRulesets(_options?: Configuration): Promise<RequestContext> {
    const _config = _options || this.configuration;
    ...
    // Make Request Context
    const requestContext = _config.getServer('v2.CloudCostManagementApi.listTagPipelinesRulesets').makeRequestContext(localVarPath, HttpMethod.GET);
    requestContext.setHeaderParam("Accept", "application/json");
    requestContext.setHttpConfig(_config.httpConfig);
  ...
  public async listTagPipelinesRulesetsStatus(_options?: Configuration): Promise<RequestContext> {
    const _config = _options || this.configuration;
    ...
    // Make Request Context
    const requestContext = _config.getServer('v2.CloudCostManagementApi.listTagPipelinesRulesetsStatus').makeRequestContext(localVarPath, HttpMethod.GET);
    requestContext.setHeaderParam("Accept", "application/json");
    requestContext.setHttpConfig(_config.httpConfig);
  ...
  public async reorderCustomAllocationRules(body: ReorderRuleResourceArray,_options?: Configuration): Promise<RequestContext> {
    const _config = _options || this.configuration;
    ...
    // Make Request Context
    const requestContext = _config.getServer('v2.CloudCostManagementApi.reorderCustomAllocationRules').makeRequestContext(localVarPath, HttpMethod.POST);
    requestContext.setHeaderParam("Accept", "*/*");
    requestContext.setHttpConfig(_config.httpConfig);
  ...
  public async reorderTagPipelinesRulesets(body: ReorderRulesetResourceArray,_options?: Configuration): Promise<RequestContext> {
    const _config = _options || this.configuration;
    ...
    // Make Request Context
    const requestContext = _config.getServer('v2.CloudCostManagementApi.reorderTagPipelinesRulesets').makeRequestContext(localVarPath, HttpMethod.POST);
    requestContext.setHeaderParam("Accept", "*/*");
    requestContext.setHttpConfig(_config.httpConfig);
  ...
  public async searchCostRecommendations(body: RecommendationsFilterRequest,pageSize?: string,pageToken?: string,_options?: Configuration): Promise<RequestContext> {
    const _config = _options || this.configuration;

    logger.warn("Using unstable operation 'searchCostRecommendations'");
    if (!_config.unstableOperations['v2.searchCostRecommendations']) {
      throw new Error("Unstable operation 'searchCostRecommendations' is disabled");
    }
    ...
    // Make Request Context
    const requestContext = _config.getServer('v2.CloudCostManagementApi.searchCostRecommendations').makeRequestContext(localVarPath, HttpMethod.POST);
    requestContext.setHeaderParam("Accept", "application/json");
    requestContext.setHttpConfig(_config.httpConfig);

    // Query Params
  if (pageSize !== undefined) {
      requestContext.setQueryParam("page[size]", ObjectSerializer.serialize(pageSize, "string", ""
), "");
    }
  if (pageToken !== undefined) {
      requestContext.setQueryParam("page[token]", ObjectSerializer.serialize(pageToken, "string", ""
), "");
    }
  ...
  public async updateCostAccountFilters(cloudAccountId: number,body: AccountFiltersPatchRequest,_options?: Configuration): Promise<RequestContext> {
    const _config = _options || this.configuration;
    ...
    // Make Request Context
    const requestContext = _config.getServer('v2.CloudCostManagementApi.updateCostAccountFilters').makeRequestContext(localVarPath, HttpMethod.PATCH);
    requestContext.setHeaderParam("Accept", "application/json");
    requestContext.setHttpConfig(_config.httpConfig);
  ...
  public async updateCostAWSCURConfig(cloudAccountId: number,body: AwsCURConfigPatchRequest,_options?: Configuration): Promise<RequestContext> {
    const _config = _options || this.configuration;
  ...
  public async updateCostAzureUCConfigs(cloudAccountId: number,body: AzureUCConfigPatchRequest,_options?: Configuration): Promise<RequestContext> {
    const _config = _options || this.configuration;
  ...
  public async updateCostGCPUsageCostConfig(cloudAccountId: number,body: GCPUsageCostConfigPatchRequest,_options?: Configuration): Promise<RequestContext> {
    const _config = _options || this.configuration;
    ...
    // Make Request Context
    const requestContext = _config.getServer('v2.CloudCostManagementApi.updateCostGCPUsageCostConfig').makeRequestContext(localVarPath, HttpMethod.PATCH);
    requestContext.setHeaderParam("Accept", "application/json");
    requestContext.setHttpConfig(_config.httpConfig);
  ...
  public async updateCustomAllocationRule(ruleId: number,body: ArbitraryCostUpsertRequest,_options?: Configuration): Promise<RequestContext> {
    const _config = _options || this.configuration;
    ...
    // Make Request Context
    const requestContext = _config.getServer('v2.CloudCostManagementApi.updateCustomAllocationRule').makeRequestContext(localVarPath, HttpMethod.PATCH);
    requestContext.setHeaderParam("Accept", "application/json");
    requestContext.setHttpConfig(_config.httpConfig);
  ...
  public async updateTagPipelinesRuleset(rulesetId: string,body: UpdateRulesetRequest,_options?: Configuration): Promise<RequestContext> {
    const _config = _options || this.configuration;
    ...
    // Make Request Context
    const requestContext = _config.getServer('v2.CloudCostManagementApi.updateTagPipelinesRuleset').makeRequestContext(localVarPath, HttpMethod.PATCH);
    requestContext.setHeaderParam("Accept", "application/json");
    requestContext.setHttpConfig(_config.httpConfig);
  ...
  public async upsertCostTagDescriptionByKey(tagKey: string,body: CostTagDescriptionUpsertRequest,_options?: Configuration): Promise<RequestContext> {
    const _config = _options || this.configuration;
    ...
    // Make Request Context
    const requestContext = _config.getServer('v2.CloudCostManagementApi.upsertCostTagDescriptionByKey').makeRequestContext(localVarPath, HttpMethod.PUT);
    requestContext.setHeaderParam("Accept", "*/*");
    requestContext.setHttpConfig(_config.httpConfig);
  ...
  public async upsertCustomForecast(body: CustomForecastUpsertRequest,_options?: Configuration): Promise<RequestContext> {
    const _config = _options || this.configuration;
    ...
    // Make Request Context
    const requestContext = _config.getServer('v2.CloudCostManagementApi.upsertCustomForecast').makeRequestContext(localVarPath, HttpMethod.PUT);
    requestContext.setHeaderParam("Accept", "application/json");
    requestContext.setHttpConfig(_config.httpConfig);
  ...
  public async validateBudget(body: BudgetValidationRequest,_options?: Configuration): Promise<RequestContext> {
    const _config = _options || this.configuration;
    ...
    // Make Request Context
    const requestContext = _config.getServer('v2.CloudCostManagementApi.validateBudget').makeRequestContext(localVarPath, HttpMethod.POST);
    requestContext.setHeaderParam("Accept", "application/json");
    requestContext.setHttpConfig(_config.httpConfig);
  ...
  public async validateCsvBudget(_options?: Configuration): Promise<RequestContext> {
    const _config = _options || this.configuration;
    ...
    // Make Request Context
    const requestContext = _config.getServer('v2.CloudCostManagementApi.validateCsvBudget').makeRequestContext(localVarPath, HttpMethod.POST);
    requestContext.setHeaderParam("Accept", "application/json");
    requestContext.setHttpConfig(_config.httpConfig);
  ...
  public async validateQuery(body: RulesValidateQueryRequest,_options?: Configuration): Promise<RequestContext> {
    const _config = _options || this.configuration;
    ...
    // Make Request Context
    const requestContext = _config.getServer('v2.CloudCostManagementApi.validateQuery').makeRequestContext(localVarPath, HttpMethod.POST);
    requestContext.setHeaderParam("Accept", "application/json");
    requestContext.setHttpConfig(_config.httpConfig);
...
export class CloudCostManagementApiResponseProcessor {
   ...
   * @throws ApiException if the response code was not in [200, 299]
   */
   public async createCostGCPUsageCostConfig(response: ResponseContext): Promise<GCPUsageCostConfigResponse> {
    const contentType = ObjectSerializer.normalizeMediaType(response.headers["content-type"]);
    if (response.httpStatusCode === 200) {
   ...
   * @throws ApiException if the response code was not in [200, 299]
   */
   public async createCustomAllocationRule(response: ResponseContext): Promise<ArbitraryRuleResponse> {
    const contentType = ObjectSerializer.normalizeMediaType(response.headers["content-type"]);
    if (response.httpStatusCode === 200) {
   ...
   * @throws ApiException if the response code was not in [200, 299]
   */
   public async createTagPipelinesRuleset(response: ResponseContext): Promise<RulesetResp> {
    const contentType = ObjectSerializer.normalizeMediaType(response.headers["content-type"]);
    if (response.httpStatusCode === 200) {
   ...
   * @throws ApiException if the response code was not in [200, 299]
   */
   public async deleteCostGCPUsageCostConfig(response: ResponseContext): Promise<void> {
    const contentType = ObjectSerializer.normalizeMediaType(response.headers["content-type"]);
    if (response.httpStatusCode === 204) {
      return;
    }
   ...
   * @throws ApiException if the response code was not in [200, 299]
   */
   public async deleteCostTagDescriptionByKey(response: ResponseContext): Promise<void> {
    const contentType = ObjectSerializer.normalizeMediaType(response.headers["content-type"]);
    if (response.httpStatusCode === 204) {
      return;
    }
   ...
   * @throws ApiException if the response code was not in [200, 299]
   */
   public async deleteCustomAllocationRule(response: ResponseContext): Promise<void> {
    const contentType = ObjectSerializer.normalizeMediaType(response.headers["content-type"]);
    if (response.httpStatusCode === 204) {
      return;
    }
   ...
   * @throws ApiException if the response code was not in [200, 299]
   */
   public async deleteTagPipelinesRuleset(response: ResponseContext): Promise<void> {
    const contentType = ObjectSerializer.normalizeMediaType(response.headers["content-type"]);
    if (response.httpStatusCode === 204) {
      return;
    }
   ...
   * @throws ApiException if the response code was not in [200, 299]
   */
   public async generateCostTagDescriptionByKey(response: ResponseContext): Promise<GenerateCostTagDescriptionResponse> {
    const contentType = ObjectSerializer.normalizeMediaType(response.headers["content-type"]);
    if (response.httpStatusCode === 200) {
      const body: GenerateCostTagDescriptionResponse = ObjectSerializer.deserialize(
        ObjectSerializer.parse(await response.body.text(), contentType),
   ...
   * @throws ApiException if the response code was not in [200, 299]
   */
   public async getCommitmentsCommitmentList(response: ResponseContext): Promise<CommitmentsListResponse> {
    const contentType = ObjectSerializer.normalizeMediaType(response.headers["content-type"]);
    if (response.httpStatusCode === 200) {
   ...
   * @throws ApiException if the response code was not in [200, 299]
   */
   public async getCommitmentsCoverageScalar(response: ResponseContext): Promise<CommitmentsCoverageScalarResponse> {
    const contentType = ObjectSerializer.normalizeMediaType(response.headers["content-type"]);
    if (response.httpStatusCode === 200) {
      const body: CommitmentsCoverageScalarResponse = ObjectSerializer.deserialize(
        ObjectSerializer.parse(await response.body.text(), contentType),
   ...
   * @throws ApiException if the response code was not in [200, 299]
   */
   public async getCommitmentsCoverageTimeseries(response: ResponseContext): Promise<CommitmentsCoverageTimeseriesResponse> {
    const contentType = ObjectSerializer.normalizeMediaType(response.headers["content-type"]);
    if (response.httpStatusCode === 200) {
      const body: CommitmentsCoverageTimeseriesResponse = ObjectSerializer.deserialize(
        ObjectSerializer.parse(await response.body.text(), contentType),
   ...
   * @throws ApiException if the response code was not in [200, 299]
   */
   public async getCommitmentsOnDemandHotspotsScalar(response: ResponseContext): Promise<CommitmentsOnDemandHotspotsScalarResponse> {
    const contentType = ObjectSerializer.normalizeMediaType(response.headers["content-type"]);
    if (response.httpStatusCode === 200) {
      const body: CommitmentsOnDemandHotspotsScalarResponse = ObjectSerializer.deserialize(
        ObjectSerializer.parse(await response.body.text(), contentType),
   ...
   * @throws ApiException if the response code was not in [200, 299]
   */
   public async getCommitmentsSavingsScalar(response: ResponseContext): Promise<CommitmentsSavingsScalarResponse> {
    const contentType = ObjectSerializer.normalizeMediaType(response.headers["content-type"]);
    if (response.httpStatusCode === 200) {
      const body: CommitmentsSavingsScalarResponse = ObjectSerializer.deserialize(
        ObjectSerializer.parse(await response.body.text(), contentType),
   ...
   * @throws ApiException if the response code was not in [200, 299]
   */
   public async getCommitmentsSavingsTimeseries(response: ResponseContext): Promise<CommitmentsSavingsTimeseriesResponse> {
    const contentType = ObjectSerializer.normalizeMediaType(response.headers["content-type"]);
    if (response.httpStatusCode === 200) {
      const body: CommitmentsSavingsTimeseriesResponse = ObjectSerializer.deserialize(
        ObjectSerializer.parse(await response.body.text(), contentType),
   ...
   * @throws ApiException if the response code was not in [200, 299]
   */
   public async getCommitmentsUtilizationScalar(response: ResponseContext): Promise<CommitmentsUtilizationScalarResponse> {
    const contentType = ObjectSerializer.normalizeMediaType(response.headers["content-type"]);
    if (response.httpStatusCode === 200) {
      const body: CommitmentsUtilizationScalarResponse = ObjectSerializer.deserialize(
        ObjectSerializer.parse(await response.body.text(), contentType),
   ...
   * @throws ApiException if the response code was not in [200, 299]
   */
   public async getCommitmentsUtilizationTimeseries(response: ResponseContext): Promise<CommitmentsUtilizationTimeseriesResponse> {
    const contentType = ObjectSerializer.normalizeMediaType(response.headers["content-type"]);
    if (response.httpStatusCode === 200) {
      const body: CommitmentsUtilizationTimeseriesResponse = ObjectSerializer.deserialize(
        ObjectSerializer.parse(await response.body.text(), contentType),
   ...
   * @throws ApiException if the response code was not in [200, 299]
   */
   public async getCostAccountFilters(response: ResponseContext): Promise<AccountFiltersResponse> {
    const contentType = ObjectSerializer.normalizeMediaType(response.headers["content-type"]);
    if (response.httpStatusCode === 200) {
   ...
   * @throws ApiException if the response code was not in [200, 299]
   */
   public async getCostAnomaly(response: ResponseContext): Promise<CostAnomalyResponse> {
    const contentType = ObjectSerializer.normalizeMediaType(response.headers["content-type"]);
    if (response.httpStatusCode === 200) {
   ...
   * @throws ApiException if the response code was not in [200, 299]
   */
   public async getCostAWSCURConfig(response: ResponseContext): Promise<AwsCurConfigResponse> {
    const contentType = ObjectSerializer.normalizeMediaType(response.headers["content-type"]);
    if (response.httpStatusCode === 200) {
      const body: AwsCurConfigResponse = ObjectSerializer.deserialize(
        ObjectSerializer.parse(await response.body.text(), contentType),
   ...
   * @throws ApiException if the response code was not in [200, 299]
   */
   public async getCostAzureUCConfig(response: ResponseContext): Promise<UCConfigPair> {
    const contentType = ObjectSerializer.normalizeMediaType(response.headers["content-type"]);
    if (response.httpStatusCode === 200) {
   ...
   * @throws ApiException if the response code was not in [200, 299]
   */
   public async getCostGCPUsageCostConfig(response: ResponseContext): Promise<GcpUcConfigResponse> {
    const contentType = ObjectSerializer.normalizeMediaType(response.headers["content-type"]);
    if (response.httpStatusCode === 200) {
   ...
   * @throws ApiException if the response code was not in [200, 299]
   */
   public async getCostTagDescriptionByKey(response: ResponseContext): Promise<CostTagDescriptionResponse> {
    const contentType = ObjectSerializer.normalizeMediaType(response.headers["content-type"]);
    if (response.httpStatusCode === 200) {
   ...
   * @throws ApiException if the response code was not in [200, 299]
   */
   public async getCostTagKey(response: ResponseContext): Promise<CostTagKeyResponse> {
    const contentType = ObjectSerializer.normalizeMediaType(response.headers["content-type"]);
    if (response.httpStatusCode === 200) {
   ...
   * @throws ApiException if the response code was not in [200, 299]
   */
   public async getCostTagMetadataCurrency(response: ResponseContext): Promise<CostCurrencyResponse> {
    const contentType = ObjectSerializer.normalizeMediaType(response.headers["content-type"]);
    if (response.httpStatusCode === 200) {
   ...
   * @throws ApiException if the response code was not in [200, 299]
   */
   public async getCustomAllocationRule(response: ResponseContext): Promise<ArbitraryRuleResponse> {
    const contentType = ObjectSerializer.normalizeMediaType(response.headers["content-type"]);
    if (response.httpStatusCode === 200) {
      const body: ArbitraryRuleResponse = ObjectSerializer.deserialize(
        ObjectSerializer.parse(await response.body.text(), contentType),
   ...
   * @throws ApiException if the response code was not in [200, 299]
   */
   public async getCustomForecast(response: ResponseContext): Promise<CustomForecastResponse> {
    const contentType = ObjectSerializer.normalizeMediaType(response.headers["content-type"]);
    if (response.httpStatusCode === 200) {
   ...
   * @throws ApiException if the response code was not in [200, 299]
   */
   public async getTagPipelinesRuleset(response: ResponseContext): Promise<RulesetResp> {
    const contentType = ObjectSerializer.normalizeMediaType(response.headers["content-type"]);
    if (response.httpStatusCode === 200) {
      const body: RulesetResp = ObjectSerializer.deserialize(
        ObjectSerializer.parse(await response.body.text(), contentType),
   ...
   * @throws ApiException if the response code was not in [200, 299]
   */
   public async listCostAnomalies(response: ResponseContext): Promise<CostAnomaliesResponse> {
    const contentType = ObjectSerializer.normalizeMediaType(response.headers["content-type"]);
    if (response.httpStatusCode === 200) {
   ...
   * @throws ApiException if the response code was not in [200, 299]
   */
   public async listCostGCPUsageCostConfigs(response: ResponseContext): Promise<GCPUsageCostConfigsResponse> {
    const contentType = ObjectSerializer.normalizeMediaType(response.headers["content-type"]);
    if (response.httpStatusCode === 200) {
   ...
   * @throws ApiException if the response code was not in [200, 299]
   */
   public async listCostOCIConfigs(response: ResponseContext): Promise<OCIConfigsResponse> {
    const contentType = ObjectSerializer.normalizeMediaType(response.headers["content-type"]);
    if (response.httpStatusCode === 200) {
   ...
   * @throws ApiException if the response code was not in [200, 299]
   */
   public async listCostTagDescriptions(response: ResponseContext): Promise<CostTagDescriptionsResponse> {
    const contentType = ObjectSerializer.normalizeMediaType(response.headers["content-type"]);
    if (response.httpStatusCode === 200) {
   ...
   * @throws ApiException if the response code was not in [200, 299]
   */
   public async listCostTagKeys(response: ResponseContext): Promise<CostTagKeysResponse> {
    const contentType = ObjectSerializer.normalizeMediaType(response.headers["content-type"]);
    if (response.httpStatusCode === 200) {
   ...
   * @throws ApiException if the response code was not in [200, 299]
   */
   public async listCostTagKeySources(response: ResponseContext): Promise<CostTagKeySourcesResponse> {
    const contentType = ObjectSerializer.normalizeMediaType(response.headers["content-type"]);
    if (response.httpStatusCode === 200) {
   ...
   * @throws ApiException if the response code was not in [200, 299]
   */
   public async listCostTagMetadata(response: ResponseContext): Promise<CostTagKeyMetadataResponse> {
    const contentType = ObjectSerializer.normalizeMediaType(response.headers["content-type"]);
    if (response.httpStatusCode === 200) {
   ...
   * @throws ApiException if the response code was not in [200, 299]
   */
   public async listCostTagMetadataMetrics(response: ResponseContext): Promise<CostMetricsResponse> {
    const contentType = ObjectSerializer.normalizeMediaType(response.headers["content-type"]);
    if (response.httpStatusCode === 200) {
   ...
   * @throws ApiException if the response code was not in [200, 299]
   */
   public async listCostTagMetadataMonths(response: ResponseContext): Promise<CostTagMetadataMonthsResponse> {
    const contentType = ObjectSerializer.normalizeMediaType(response.headers["content-type"]);
    if (response.httpStatusCode === 200) {
   ...
   * @throws ApiException if the response code was not in [200, 299]
   */
   public async listCostTagMetadataOrchestrators(response: ResponseContext): Promise<CostOrchestratorsResponse> {
    const contentType = ObjectSerializer.normalizeMediaType(response.headers["content-type"]);
    if (response.httpStatusCode === 200) {
   ...
   * @throws ApiException if the response code was not in [200, 299]
   */
   public async listCostTags(response: ResponseContext): Promise<CostTagsResponse> {
    const contentType = ObjectSerializer.normalizeMediaType(response.headers["content-type"]);
    if (response.httpStatusCode === 200) {
   ...
   * @throws ApiException if the response code was not in [200, 299]
   */
   public async listCustomAllocationRules(response: ResponseContext): Promise<ArbitraryRuleResponseArray> {
    const contentType = ObjectSerializer.normalizeMediaType(response.headers["content-type"]);
    if (response.httpStatusCode === 200) {
   ...
   * @throws ApiException if the response code was not in [200, 299]
   */
   public async listCustomAllocationRulesStatus(response: ResponseContext): Promise<ArbitraryRuleStatusResponseArray> {
    const contentType = ObjectSerializer.normalizeMediaType(response.headers["content-type"]);
    if (response.httpStatusCode === 200) {
      const body: ArbitraryRuleStatusResponseArray = ObjectSerializer.deserialize(
        ObjectSerializer.parse(await response.body.text(), contentType),
   ...
   * @throws ApiException if the response code was not in [200, 299]
   */
   public async listTagPipelinesRulesets(response: ResponseContext): Promise<RulesetRespArray> {
    const contentType = ObjectSerializer.normalizeMediaType(response.headers["content-type"]);
    if (response.httpStatusCode === 200) {
   ...
   * @throws ApiException if the response code was not in [200, 299]
   */
   public async listTagPipelinesRulesetsStatus(response: ResponseContext): Promise<RulesetStatusRespArray> {
    const contentType = ObjectSerializer.normalizeMediaType(response.headers["content-type"]);
    if (response.httpStatusCode === 200) {
   ...
   * @throws ApiException if the response code was not in [200, 299]
   */
   public async reorderCustomAllocationRules(response: ResponseContext): Promise<void> {
    const contentType = ObjectSerializer.normalizeMediaType(response.headers["content-type"]);
    if (response.httpStatusCode === 204) {
      return;
    }
   ...
   * @throws ApiException if the response code was not in [200, 299]
   */
   public async reorderTagPipelinesRulesets(response: ResponseContext): Promise<void> {
    const contentType = ObjectSerializer.normalizeMediaType(response.headers["content-type"]);
    if (response.httpStatusCode === 204) {
      return;
    }
   ...
   * @throws ApiException if the response code was not in [200, 299]
   */
   public async searchCostRecommendations(response: ResponseContext): Promise<CostRecommendationArray> {
    const contentType = ObjectSerializer.normalizeMediaType(response.headers["content-type"]);
    if (response.httpStatusCode === 200) {
   ...
   * @throws ApiException if the response code was not in [200, 299]
   */
   public async updateCostAccountFilters(response: ResponseContext): Promise<AccountFiltersResponse> {
    const contentType = ObjectSerializer.normalizeMediaType(response.headers["content-type"]);
    if (response.httpStatusCode === 200) {
      const body: AccountFiltersResponse = ObjectSerializer.deserialize(
        ObjectSerializer.parse(await response.body.text(), contentType),
   ...
   * @throws ApiException if the response code was not in [200, 299]
   */
   public async updateCostGCPUsageCostConfig(response: ResponseContext): Promise<GCPUsageCostConfigResponse> {
    const contentType = ObjectSerializer.normalizeMediaType(response.headers["content-type"]);
    if (response.httpStatusCode === 200) {
      const body: GCPUsageCostConfigResponse = ObjectSerializer.deserialize(
        ObjectSerializer.parse(await response.body.text(), contentType),
   ...
   * @throws ApiException if the response code was not in [200, 299]
   */
   public async updateCustomAllocationRule(response: ResponseContext): Promise<ArbitraryRuleResponse> {
    const contentType = ObjectSerializer.normalizeMediaType(response.headers["content-type"]);
    if (response.httpStatusCode === 200) {
      const body: ArbitraryRuleResponse = ObjectSerializer.deserialize(
        ObjectSerializer.parse(await response.body.text(), contentType),
   ...
   * @throws ApiException if the response code was not in [200, 299]
   */
   public async updateTagPipelinesRuleset(response: ResponseContext): Promise<RulesetResp> {
    const contentType = ObjectSerializer.normalizeMediaType(response.headers["content-type"]);
    if (response.httpStatusCode === 200) {
      const body: RulesetResp = ObjectSerializer.deserialize(
        ObjectSerializer.parse(await response.body.text(), contentType),
   ...
   * @throws ApiException if the response code was not in [200, 299]
   */
   public async upsertCostTagDescriptionByKey(response: ResponseContext): Promise<void> {
    const contentType = ObjectSerializer.normalizeMediaType(response.headers["content-type"]);
    if (response.httpStatusCode === 204) {
      return;
    }
   ...
   * @throws ApiException if the response code was not in [200, 299]
   */
   public async upsertCustomForecast(response: ResponseContext): Promise<CustomForecastResponse> {
    const contentType = ObjectSerializer.normalizeMediaType(response.headers["content-type"]);
    if (response.httpStatusCode === 200) {
      const body: CustomForecastResponse = ObjectSerializer.deserialize(
        ObjectSerializer.parse(await response.body.text(), contentType),
   ...
   * @throws ApiException if the response code was not in [200, 299]
   */
   public async validateBudget(response: ResponseContext): Promise<BudgetValidationResponse> {
    const contentType = ObjectSerializer.normalizeMediaType(response.headers["content-type"]);
    if (response.httpStatusCode === 200) {
   ...
   * @throws ApiException if the response code was not in [200, 299]
   */
   public async validateCsvBudget(response: ResponseContext): Promise<ValidationResponse> {
    const contentType = ObjectSerializer.normalizeMediaType(response.headers["content-type"]);
    if (response.httpStatusCode === 200) {
   ...
   * @throws ApiException if the response code was not in [200, 299]
   */
   public async validateQuery(response: ResponseContext): Promise<RulesValidateQueryResponse> {
    const contentType = ObjectSerializer.normalizeMediaType(response.headers["content-type"]);
    if (response.httpStatusCode === 200) {
...
export class CloudCostManagementApi {
   ...
   * @param param The request object
   */
  public createCostGCPUsageCostConfig(param: CloudCostManagementApiCreateCostGCPUsageCostConfigRequest, options?: Configuration): Promise<GCPUsageCostConfigResponse> {
   ...
   * @param param The request object
   */
  public createCustomAllocationRule(param: CloudCostManagementApiCreateCustomAllocationRuleRequest, options?: Configuration): Promise<ArbitraryRuleResponse> {
    const requestContextPromise = this.requestFactory.createCustomAllocationRule(param.body,options);
    return requestContextPromise.then(requestContext => {
        return this.configuration.httpApi.send(requestContext).then(responseContext => {
   ...
   * @param param The request object
   */
  public createTagPipelinesRuleset(param: CloudCostManagementApiCreateTagPipelinesRulesetRequest, options?: Configuration): Promise<RulesetResp> {
    const requestContextPromise = this.requestFactory.createTagPipelinesRuleset(param.body,options);
    return requestContextPromise.then(requestContext => {
        return this.configuration.httpApi.send(requestContext).then(responseContext => {
   ...
   * @param param The request object
   */
  public deleteCostGCPUsageCostConfig(param: CloudCostManagementApiDeleteCostGCPUsageCostConfigRequest, options?: Configuration): Promise<void> {
   ...
   * @param param The request object
   */
  public deleteCostTagDescriptionByKey(param: CloudCostManagementApiDeleteCostTagDescriptionByKeyRequest, options?: Configuration): Promise<void> {
    const requestContextPromise = this.requestFactory.deleteCostTagDescriptionByKey(param.tagKey,param.cloud,options);
    return requestContextPromise.then(requestContext => {
        return this.configuration.httpApi.send(requestContext).then(responseContext => {
   ...
   * @param param The request object
   */
  public deleteCustomAllocationRule(param: CloudCostManagementApiDeleteCustomAllocationRuleRequest, options?: Configuration): Promise<void> {
    const requestContextPromise = this.requestFactory.deleteCustomAllocationRule(param.ruleId,options);
    return requestContextPromise.then(requestContext => {
        return this.configuration.httpApi.send(requestContext).then(responseContext => {
   ...
   * @param param The request object
   */
  public deleteCustomForecast(param: CloudCostManagementApiDeleteCustomForecastRequest, options?: Configuration): Promise<void> {
    const requestContextPromise = this.requestFactory.deleteCustomForecast(param.budgetId,options);
    return requestContextPromise.then(requestContext => {
        return this.configuration.httpApi.send(requestContext).then(responseContext => {
   ...
   * @param param The request object
   */
  public deleteTagPipelinesRuleset(param: CloudCostManagementApiDeleteTagPipelinesRulesetRequest, options?: Configuration): Promise<void> {
    const requestContextPromise = this.requestFactory.deleteTagPipelinesRuleset(param.rulesetId,options);
    return requestContextPromise.then(requestContext => {
        return this.configuration.httpApi.send(requestContext).then(responseContext => {
   ...
   * @param param The request object
   */
  public generateCostTagDescriptionByKey(param: CloudCostManagementApiGenerateCostTagDescriptionByKeyRequest, options?: Configuration): Promise<GenerateCostTagDescriptionResponse> {
    const requestContextPromise = this.requestFactory.generateCostTagDescriptionByKey(param.tagKey,options);
    return requestContextPromise.then(requestContext => {
        return this.configuration.httpApi.send(requestContext).then(responseContext => {
  ...
  public getBudget(param: CloudCostManagementApiGetBudgetRequest, options?: Configuration): Promise<BudgetWithEntries> {
    const requestContextPromise = this.requestFactory.getBudget(param.budgetId,param.actual,param.forecast,param.start,param.end,options);
    return requestContextPromise.then(requestContext => {
        return this.configuration.httpApi.send(requestContext).then(responseContext => {
   ...
   * @param param The request object
   */
  public getCommitmentsCommitmentList(param: CloudCostManagementApiGetCommitmentsCommitmentListRequest, options?: Configuration): Promise<CommitmentsListResponse> {
   ...
   * @param param The request object
   */
  public getCommitmentsCoverageScalar(param: CloudCostManagementApiGetCommitmentsCoverageScalarRequest, options?: Configuration): Promise<CommitmentsCoverageScalarResponse> {
   ...
   * @param param The request object
   */
  public getCommitmentsCoverageTimeseries(param: CloudCostManagementApiGetCommitmentsCoverageTimeseriesRequest, options?: Configuration): Promise<CommitmentsCoverageTimeseriesResponse> {
   ...
   * @param param The request object
   */
  public getCommitmentsOnDemandHotspotsScalar(param: CloudCostManagementApiGetCommitmentsOnDemandHotspotsScalarRequest, options?: Configuration): Promise<CommitmentsOnDemandHotspotsScalarResponse> {
   ...
   * @param param The request object
   */
  public getCommitmentsSavingsScalar(param: CloudCostManagementApiGetCommitmentsSavingsScalarRequest, options?: Configuration): Promise<CommitmentsSavingsScalarResponse> {
   ...
   * @param param The request object
   */
  public getCommitmentsSavingsTimeseries(param: CloudCostManagementApiGetCommitmentsSavingsTimeseriesRequest, options?: Configuration): Promise<CommitmentsSavingsTimeseriesResponse> {
   ...
   * @param param The request object
   */
  public getCommitmentsUtilizationScalar(param: CloudCostManagementApiGetCommitmentsUtilizationScalarRequest, options?: Configuration): Promise<CommitmentsUtilizationScalarResponse> {
   ...
   * @param param The request object
   */
  public getCommitmentsUtilizationTimeseries(param: CloudCostManagementApiGetCommitmentsUtilizationTimeseriesRequest, options?: Configuration): Promise<CommitmentsUtilizationTimeseriesResponse> {
   ...
   * @param param The request object
   */
  public getCostAccountFilters(param: CloudCostManagementApiGetCostAccountFiltersRequest, options?: Configuration): Promise<AccountFiltersResponse> {
    const requestContextPromise = this.requestFactory.getCostAccountFilters(param.cloudAccountId,options);
    return requestContextPromise.then(requestContext => {
        return this.configuration.httpApi.send(requestContext).then(responseContext => {
   ...
   * @param param The request object
   */
  public getCostAnomaly(param: CloudCostManagementApiGetCostAnomalyRequest, options?: Configuration): Promise<CostAnomalyResponse> {
   ...
   * @param param The request object
   */
  public getCostAWSCURConfig(param: CloudCostManagementApiGetCostAWSCURConfigRequest, options?: Configuration): Promise<AwsCurConfigResponse> {
   ...
   * @param param The request object
   */
  public getCostAzureUCConfig(param: CloudCostManagementApiGetCostAzureUCConfigRequest, options?: Configuration): Promise<UCConfigPair> {
   ...
   * @param param The request object
   */
  public getCostGCPUsageCostConfig(param: CloudCostManagementApiGetCostGCPUsageCostConfigRequest, options?: Configuration): Promise<GcpUcConfigResponse> {
   ...
   * @param param The request object
   */
  public getCostTagDescriptionByKey(param: CloudCostManagementApiGetCostTagDescriptionByKeyRequest, options?: Configuration): Promise<CostTagDescriptionResponse> {
    const requestContextPromise = this.requestFactory.getCostTagDescriptionByKey(param.tagKey,param.filterCloud,options);
    return requestContextPromise.then(requestContext => {
        return this.configuration.httpApi.send(requestContext).then(responseContext => {
   ...
   * @param param The request object
   */
  public getCostTagKey(param: CloudCostManagementApiGetCostTagKeyRequest, options?: Configuration): Promise<CostTagKeyResponse> {
   ...
   * @param param The request object
   */
  public getCostTagMetadataCurrency(param: CloudCostManagementApiGetCostTagMetadataCurrencyRequest, options?: Configuration): Promise<CostCurrencyResponse> {
    const requestContextPromise = this.requestFactory.getCostTagMetadataCurrency(param.filterMonth,param.filterProvider,options);
    return requestContextPromise.then(requestContext => {
        return this.configuration.httpApi.send(requestContext).then(responseContext => {
   ...
   * @param param The request object
   */
  public getCustomAllocationRule(param: CloudCostManagementApiGetCustomAllocationRuleRequest, options?: Configuration): Promise<ArbitraryRuleResponse> {
    const requestContextPromise = this.requestFactory.getCustomAllocationRule(param.ruleId,options);
    return requestContextPromise.then(requestContext => {
        return this.configuration.httpApi.send(requestContext).then(responseContext => {
   ...
   * @param param The request object
   */
  public getCustomForecast(param: CloudCostManagementApiGetCustomForecastRequest, options?: Configuration): Promise<CustomForecastResponse> {
    const requestContextPromise = this.requestFactory.getCustomForecast(param.budgetId,options);
    return requestContextPromise.then(requestContext => {
        return this.configuration.httpApi.send(requestContext).then(responseContext => {
   ...
   * @param param The request object
   */
  public getTagPipelinesRuleset(param: CloudCostManagementApiGetTagPipelinesRulesetRequest, options?: Configuration): Promise<RulesetResp> {
    const requestContextPromise = this.requestFactory.getTagPipelinesRuleset(param.rulesetId,options);
    return requestContextPromise.then(requestContext => {
        return this.configuration.httpApi.send(requestContext).then(responseContext => {
   ...
   * @param param The request object
   */
  public listCostAnomalies(param: CloudCostManagementApiListCostAnomaliesRequest = {}, options?: Configuration): Promise<CostAnomaliesResponse> {
   ...
   * @param param The request object
   */
  public listCostGCPUsageCostConfigs( options?: Configuration): Promise<GCPUsageCostConfigsResponse> {
   ...
   * @param param The request object
   */
  public listCostOCIConfigs( options?: Configuration): Promise<OCIConfigsResponse> {
   ...
   * @param param The request object
   */
  public listCostTagDescriptions(param: CloudCostManagementApiListCostTagDescriptionsRequest = {}, options?: Configuration): Promise<CostTagDescriptionsResponse> {
   ...
   * @param param The request object
   */
  public listCostTagKeys(param: CloudCostManagementApiListCostTagKeysRequest = {}, options?: Configuration): Promise<CostTagKeysResponse> {
   ...
   * @param param The request object
   */
  public listCostTagKeySources(param: CloudCostManagementApiListCostTagKeySourcesRequest, options?: Configuration): Promise<CostTagKeySourcesResponse> {
    const requestContextPromise = this.requestFactory.listCostTagKeySources(param.filterMonth,param.filterProvider,param.filterMetric,options);
    return requestContextPromise.then(requestContext => {
        return this.configuration.httpApi.send(requestContext).then(responseContext => {
   ...
   * @param param The request object
   */
  public listCostTagMetadata(param: CloudCostManagementApiListCostTagMetadataRequest, options?: Configuration): Promise<CostTagKeyMetadataResponse> {
    const requestContextPromise = this.requestFactory.listCostTagMetadata(param.filterMonth,param.filterProvider,param.filterMetric,param.filterTagKey,param.filterDaily,options);
    return requestContextPromise.then(requestContext => {
        return this.configuration.httpApi.send(requestContext).then(responseContext => {
   ...
   * @param param The request object
   */
  public listCostTagMetadataMetrics(param: CloudCostManagementApiListCostTagMetadataMetricsRequest, options?: Configuration): Promise<CostMetricsResponse> {
    const requestContextPromise = this.requestFactory.listCostTagMetadataMetrics(param.filterMonth,param.filterProvider,options);
    return requestContextPromise.then(requestContext => {
        return this.configuration.httpApi.send(requestContext).then(responseContext => {
   ...
   * @param param The request object
   */
  public listCostTagMetadataMonths(param: CloudCostManagementApiListCostTagMetadataMonthsRequest, options?: Configuration): Promise<CostTagMetadataMonthsResponse> {
    const requestContextPromise = this.requestFactory.listCostTagMetadataMonths(param.filterProvider,options);
    return requestContextPromise.then(requestContext => {
        return this.configuration.httpApi.send(requestContext).then(responseContext => {
   ...
   * @param param The request object
   */
  public listCostTagMetadataOrchestrators(param: CloudCostManagementApiListCostTagMetadataOrchestratorsRequest, options?: Configuration): Promise<CostOrchestratorsResponse> {
    const requestContextPromise = this.requestFactory.listCostTagMetadataOrchestrators(param.filterMonth,param.filterProvider,options);
    return requestContextPromise.then(requestContext => {
        return this.configuration.httpApi.send(requestContext).then(responseContext => {
   ...
   * @param param The request object
   */
  public listCostTags(param: CloudCostManagementApiListCostTagsRequest = {}, options?: Configuration): Promise<CostTagsResponse> {
   ...
   * @param param The request object
   */
  public listCustomAllocationRules( options?: Configuration): Promise<ArbitraryRuleResponseArray> {
    const requestContextPromise = this.requestFactory.listCustomAllocationRules(options);
    return requestContextPromise.then(requestContext => {
        return this.configuration.httpApi.send(requestContext).then(responseContext => {
   ...
   * @param param The request object
   */
  public listCustomAllocationRulesStatus( options?: Configuration): Promise<ArbitraryRuleStatusResponseArray> {
   ...
   * @param param The request object
   */
  public listCustomCostsFiles(param: CloudCostManagementApiListCustomCostsFilesRequest = {}, options?: Configuration): Promise<CustomCostsFileListResponse> {
   ...
   * @param param The request object
   */
  public listTagPipelinesRulesets( options?: Configuration): Promise<RulesetRespArray> {
    const requestContextPromise = this.requestFactory.listTagPipelinesRulesets(options);
    return requestContextPromise.then(requestContext => {
        return this.configuration.httpApi.send(requestContext).then(responseContext => {
   ...
   * @param param The request object
   */
  public listTagPipelinesRulesetsStatus( options?: Configuration): Promise<RulesetStatusRespArray> {
   ...
   * @param param The request object
   */
  public reorderCustomAllocationRules(param: CloudCostManagementApiReorderCustomAllocationRulesRequest, options?: Configuration): Promise<void> {
    const requestContextPromise = this.requestFactory.reorderCustomAllocationRules(param.body,options);
    return requestContextPromise.then(requestContext => {
        return this.configuration.httpApi.send(requestContext).then(responseContext => {
   ...
   * @param param The request object
   */
  public reorderTagPipelinesRulesets(param: CloudCostManagementApiReorderTagPipelinesRulesetsRequest, options?: Configuration): Promise<void> {
    const requestContextPromise = this.requestFactory.reorderTagPipelinesRulesets(param.body,options);
    return requestContextPromise.then(requestContext => {
        return this.configuration.httpApi.send(requestContext).then(responseContext => {
   ...
   * @param param The request object
   */
  public searchCostRecommendations(param: CloudCostManagementApiSearchCostRecommendationsRequest, options?: Configuration): Promise<CostRecommendationArray> {
    const requestContextPromise = this.requestFactory.searchCostRecommendations(param.body,param.pageSize,param.pageToken,options);
    return requestContextPromise.then(requestContext => {
        return this.configuration.httpApi.send(requestContext).then(responseContext => {
   ...
   * @param param The request object
   */
  public updateCostAccountFilters(param: CloudCostManagementApiUpdateCostAccountFiltersRequest, options?: Configuration): Promise<AccountFiltersResponse> {
    const requestContextPromise = this.requestFactory.updateCostAccountFilters(param.cloudAccountId,param.body,options);
    return requestContextPromise.then(requestContext => {
        return this.configuration.httpApi.send(requestContext).then(responseContext => {
   ...
   * @param param The request object
   */
  public updateCostGCPUsageCostConfig(param: CloudCostManagementApiUpdateCostGCPUsageCostConfigRequest, options?: Configuration): Promise<GCPUsageCostConfigResponse> {
   ...
   * @param param The request object
   */
  public updateCustomAllocationRule(param: CloudCostManagementApiUpdateCustomAllocationRuleRequest, options?: Configuration): Promise<ArbitraryRuleResponse> {
    const requestContextPromise = this.requestFactory.updateCustomAllocationRule(param.ruleId,param.body,options);
    return requestContextPromise.then(requestContext => {
        return this.configuration.httpApi.send(requestContext).then(responseContext => {
   ...
   * @param param The request object
   */
  public updateTagPipelinesRuleset(param: CloudCostManagementApiUpdateTagPipelinesRulesetRequest, options?: Configuration): Promise<RulesetResp> {
    const requestContextPromise = this.requestFactory.updateTagPipelinesRuleset(param.rulesetId,param.body,options);
    return requestContextPromise.then(requestContext => {
        return this.configuration.httpApi.send(requestContext).then(responseContext => {
   ...
   * @param param The request object
   */
  public upsertCostTagDescriptionByKey(param: CloudCostManagementApiUpsertCostTagDescriptionByKeyRequest, options?: Configuration): Promise<void> {
    const requestContextPromise = this.requestFactory.upsertCostTagDescriptionByKey(param.tagKey,param.body,options);
    return requestContextPromise.then(requestContext => {
        return this.configuration.httpApi.send(requestContext).then(responseContext => {
   ...
   * @param param The request object
   */
  public upsertCustomForecast(param: CloudCostManagementApiUpsertCustomForecastRequest, options?: Configuration): Promise<CustomForecastResponse> {
    const requestContextPromise = this.requestFactory.upsertCustomForecast(param.body,options);
    return requestContextPromise.then(requestContext => {
        return this.configuration.httpApi.send(requestContext).then(responseContext => {
   ...
   * @param param The request object
   */
  public validateBudget(param: CloudCostManagementApiValidateBudgetRequest, options?: Configuration): Promise<BudgetValidationResponse> {
    const requestContextPromise = this.requestFactory.validateBudget(param.body,options);
    return requestContextPromise.then(requestContext => {
        return this.configuration.httpApi.send(requestContext).then(responseContext => {
   ...
   * @param param The request object
   */
  public validateCsvBudget( options?: Configuration): Promise<ValidationResponse> {
    const requestContextPromise = this.requestFactory.validateCsvBudget(options);
    return requestContextPromise.then(requestContext => {
        return this.configuration.httpApi.send(requestContext).then(responseContext => {
   ...
   * @param param The request object
   */
  public validateQuery(param: CloudCostManagementApiValidateQueryRequest, options?: Configuration): Promise<RulesValidateQueryResponse> {
