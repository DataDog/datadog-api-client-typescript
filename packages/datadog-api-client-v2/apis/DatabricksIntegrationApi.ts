...
export class DatabricksIntegrationApiRequestFactory extends BaseAPIRequestFactory {
  public async createDatabricksIntegrationAccount(
    ...
    const requestContext = _config
      .getServer(
        "v2.DatabricksIntegrationApi.createDatabricksIntegrationAccount"
      )
  ...
  public async deleteDatabricksIntegrationAccount(
    ...
    const requestContext = _config
      .getServer(
        "v2.DatabricksIntegrationApi.deleteDatabricksIntegrationAccount"
      )
  ...
  public async getDatabricksIntegrationAccount(
    ...
    // Make Request Context
    const requestContext = _config
      .getServer("v2.DatabricksIntegrationApi.getDatabricksIntegrationAccount")
  ...
  public async listDatabricksIntegrationAccounts(
    ...
    const requestContext = _config
      .getServer(
        "v2.DatabricksIntegrationApi.listDatabricksIntegrationAccounts"
      )
      .makeRequestContext(localVarPath, HttpMethod.GET);
    requestContext.setHeaderParam("Accept", "application/json");
    requestContext.setHttpConfig(_config.httpConfig);
  ...
  public async updateDatabricksIntegrationAccount(
    ...
    const requestContext = _config
      .getServer(
        "v2.DatabricksIntegrationApi.updateDatabricksIntegrationAccount"
      )
...
export class DatabricksIntegrationApi {
  ...
  public constructor(
    ...
    this.requestFactory =
      requestFactory ||
      new DatabricksIntegrationApiRequestFactory(configuration);
