...
export class OnCallApiRequestFactory extends BaseAPIRequestFactory {
  ...
  public async createUserNotificationChannel(userId: string,body: CreateUserNotificationChannelRequest,_options?: Configuration): Promise<RequestContext> {
    const _config = _options || this.configuration;
    ...
    // Path Params
    const localVarPath = '/api/v2/on-call/users/{user_id}/notification-channels'
      .replace('{user_id}', encodeURIComponent(String(userId)));

    // Make Request Context
    const requestContext = _config.getServer('v2.OnCallApi.createUserNotificationChannel').makeRequestContext(localVarPath, HttpMethod.POST);
    requestContext.setHeaderParam("Accept", "application/json");
    requestContext.setHttpConfig(_config.httpConfig);
    ...
    requestContext.setHeaderParam("Content-Type", contentType);
    const serializedBody = ObjectSerializer.stringify(
      ObjectSerializer.serialize(body, "CreateUserNotificationChannelRequest", ""),
      contentType
    );
    requestContext.setBody(serializedBody);
  ...
  public async createUserNotificationRule(userId: string,body: CreateOnCallNotificationRuleRequest,_options?: Configuration): Promise<RequestContext> {
    const _config = _options || this.configuration;
    ...
    // Path Params
    const localVarPath = '/api/v2/on-call/users/{user_id}/notification-rules'
      .replace('{user_id}', encodeURIComponent(String(userId)));

    // Make Request Context
    const requestContext = _config.getServer('v2.OnCallApi.createUserNotificationRule').makeRequestContext(localVarPath, HttpMethod.POST);
    requestContext.setHeaderParam("Accept", "application/json");
    requestContext.setHttpConfig(_config.httpConfig);
    ...
    requestContext.setHeaderParam("Content-Type", contentType);
    const serializedBody = ObjectSerializer.stringify(
      ObjectSerializer.serialize(body, "CreateOnCallNotificationRuleRequest", ""),
      contentType
    );
    requestContext.setBody(serializedBody);
  ...
  public async deleteUserNotificationChannel(userId: string,channelId: string,_options?: Configuration): Promise<RequestContext> {
    const _config = _options || this.configuration;
    ...
    // Make Request Context
    const requestContext = _config.getServer('v2.OnCallApi.deleteUserNotificationChannel').makeRequestContext(localVarPath, HttpMethod.DELETE);
    requestContext.setHeaderParam("Accept", "*/*");
    requestContext.setHttpConfig(_config.httpConfig);
  ...
  public async deleteUserNotificationRule(userId: string,ruleId: string,_options?: Configuration): Promise<RequestContext> {
    const _config = _options || this.configuration;
    ...
    // Make Request Context
    const requestContext = _config.getServer('v2.OnCallApi.deleteUserNotificationRule').makeRequestContext(localVarPath, HttpMethod.DELETE);
    requestContext.setHeaderParam("Accept", "*/*");
    requestContext.setHttpConfig(_config.httpConfig);
  ...
  public async getScheduleOnCallResponders(scheduleId: string,include?: string,filterPosition?: string,filterAtTs?: string,_options?: Configuration): Promise<RequestContext> {
    const _config = _options || this.configuration;
    ...
    // Path Params
    const localVarPath = '/api/v2/on-call/schedules/{schedule_id}/responders'
      .replace('{schedule_id}', encodeURIComponent(String(scheduleId)));

    // Make Request Context
    const requestContext = _config.getServer('v2.OnCallApi.getScheduleOnCallResponders').makeRequestContext(localVarPath, HttpMethod.GET);
    requestContext.setHeaderParam("Accept", "application/json");
    requestContext.setHttpConfig(_config.httpConfig);
  ...
  if (filterPosition !== undefined) {
      requestContext.setQueryParam("filter[position]", ObjectSerializer.serialize(filterPosition, "string", ""
), "");
    }
  ...
  public async getUserNotificationChannel(userId: string,channelId: string,_options?: Configuration): Promise<RequestContext> {
    const _config = _options || this.configuration;
    ...
    // Make Request Context
    const requestContext = _config.getServer('v2.OnCallApi.getUserNotificationChannel').makeRequestContext(localVarPath, HttpMethod.GET);
    requestContext.setHeaderParam("Accept", "application/json");
    requestContext.setHttpConfig(_config.httpConfig);
  ...
  public async getUserNotificationRule(userId: string,ruleId: string,include?: string,_options?: Configuration): Promise<RequestContext> {
    const _config = _options || this.configuration;
    ...
    // Make Request Context
    const requestContext = _config.getServer('v2.OnCallApi.getUserNotificationRule').makeRequestContext(localVarPath, HttpMethod.GET);
    requestContext.setHeaderParam("Accept", "application/json");
    requestContext.setHttpConfig(_config.httpConfig);
  ...
  public async listUserNotificationChannels(userId: string,_options?: Configuration): Promise<RequestContext> {
    const _config = _options || this.configuration;
    ...
    // Make Request Context
    const requestContext = _config.getServer('v2.OnCallApi.listUserNotificationChannels').makeRequestContext(localVarPath, HttpMethod.GET);
    requestContext.setHeaderParam("Accept", "application/json");
    requestContext.setHttpConfig(_config.httpConfig);
  ...
  public async listUserNotificationRules(userId: string,include?: string,_options?: Configuration): Promise<RequestContext> {
    const _config = _options || this.configuration;
    ...
    // Make Request Context
    const requestContext = _config.getServer('v2.OnCallApi.listUserNotificationRules').makeRequestContext(localVarPath, HttpMethod.GET);
    requestContext.setHeaderParam("Accept", "application/json");
    requestContext.setHttpConfig(_config.httpConfig);
  ...
  public async updateUserNotificationRule(userId: string,ruleId: string,body: UpdateOnCallNotificationRuleRequest,include?: string,_options?: Configuration): Promise<RequestContext> {
    const _config = _options || this.configuration;
    ...
    // Make Request Context
    const requestContext = _config.getServer('v2.OnCallApi.updateUserNotificationRule').makeRequestContext(localVarPath, HttpMethod.PUT);
    requestContext.setHeaderParam("Accept", "application/json");
    requestContext.setHttpConfig(_config.httpConfig);
  ...
  if (include !== undefined) {
    ...
    requestContext.setHeaderParam("Content-Type", contentType);
    const serializedBody = ObjectSerializer.stringify(
      ObjectSerializer.serialize(body, "UpdateOnCallNotificationRuleRequest", ""),
      contentType
    );
    requestContext.setBody(serializedBody);
...
export class OnCallApiResponseProcessor {
   ...
   * @throws ApiException if the response code was not in [200, 299]
   */
   public async createUserNotificationChannel(response: ResponseContext): Promise<NotificationChannel> {
    const contentType = ObjectSerializer.normalizeMediaType(response.headers["content-type"]);
    if (response.httpStatusCode === 201) {
   ...
   * @throws ApiException if the response code was not in [200, 299]
   */
   public async createUserNotificationRule(response: ResponseContext): Promise<OnCallNotificationRule> {
    const contentType = ObjectSerializer.normalizeMediaType(response.headers["content-type"]);
    if (response.httpStatusCode === 201) {
   ...
   * @throws ApiException if the response code was not in [200, 299]
   */
   public async deleteUserNotificationChannel(response: ResponseContext): Promise<void> {
    const contentType = ObjectSerializer.normalizeMediaType(response.headers["content-type"]);
    if (response.httpStatusCode === 204) {
      return;
    }
   ...
   * @throws ApiException if the response code was not in [200, 299]
   */
   public async deleteUserNotificationRule(response: ResponseContext): Promise<void> {
    const contentType = ObjectSerializer.normalizeMediaType(response.headers["content-type"]);
    if (response.httpStatusCode === 204) {
      return;
    }
   ...
   * @throws ApiException if the response code was not in [200, 299]
   */
   public async getScheduleOnCallResponders(response: ResponseContext): Promise<ScheduleOnCallResponders> {
    const contentType = ObjectSerializer.normalizeMediaType(response.headers["content-type"]);
    if (response.httpStatusCode === 200) {
   ...
   * @throws ApiException if the response code was not in [200, 299]
   */
   public async getUserNotificationChannel(response: ResponseContext): Promise<NotificationChannel> {
    const contentType = ObjectSerializer.normalizeMediaType(response.headers["content-type"]);
    if (response.httpStatusCode === 200) {
      const body: NotificationChannel = ObjectSerializer.deserialize(
        ObjectSerializer.parse(await response.body.text(), contentType),
   ...
   * @throws ApiException if the response code was not in [200, 299]
   */
   public async getUserNotificationRule(response: ResponseContext): Promise<OnCallNotificationRule> {
    const contentType = ObjectSerializer.normalizeMediaType(response.headers["content-type"]);
    if (response.httpStatusCode === 200) {
      const body: OnCallNotificationRule = ObjectSerializer.deserialize(
        ObjectSerializer.parse(await response.body.text(), contentType),
   ...
   * @throws ApiException if the response code was not in [200, 299]
   */
   public async listUserNotificationChannels(response: ResponseContext): Promise<ListNotificationChannelsResponse> {
    const contentType = ObjectSerializer.normalizeMediaType(response.headers["content-type"]);
    if (response.httpStatusCode === 200) {
      const body: ListNotificationChannelsResponse = ObjectSerializer.deserialize(
        ObjectSerializer.parse(await response.body.text(), contentType),
   ...
   * @throws ApiException if the response code was not in [200, 299]
   */
   public async listUserNotificationRules(response: ResponseContext): Promise<ListOnCallNotificationRulesResponse> {
    const contentType = ObjectSerializer.normalizeMediaType(response.headers["content-type"]);
    if (response.httpStatusCode === 200) {
      const body: ListOnCallNotificationRulesResponse = ObjectSerializer.deserialize(
        ObjectSerializer.parse(await response.body.text(), contentType),
   ...
   * @throws ApiException if the response code was not in [200, 299]
   */
   public async updateUserNotificationRule(response: ResponseContext): Promise<OnCallNotificationRule> {
    const contentType = ObjectSerializer.normalizeMediaType(response.headers["content-type"]);
    if (response.httpStatusCode === 200) {
      const body: OnCallNotificationRule = ObjectSerializer.deserialize(
        ObjectSerializer.parse(await response.body.text(), contentType),
...
export class OnCallApi {
   ...
   * @param param The request object
   */
  public createUserNotificationChannel(param: OnCallApiCreateUserNotificationChannelRequest, options?: Configuration): Promise<NotificationChannel> {
   ...
   * @param param The request object
   */
  public createUserNotificationRule(param: OnCallApiCreateUserNotificationRuleRequest, options?: Configuration): Promise<OnCallNotificationRule> {
   ...
   * @param param The request object
   */
  public deleteUserNotificationChannel(param: OnCallApiDeleteUserNotificationChannelRequest, options?: Configuration): Promise<void> {
   ...
   * @param param The request object
   */
  public deleteUserNotificationRule(param: OnCallApiDeleteUserNotificationRuleRequest, options?: Configuration): Promise<void> {
   ...
   * @param param The request object
   */
  public getScheduleOnCallResponders(param: OnCallApiGetScheduleOnCallRespondersRequest, options?: Configuration): Promise<ScheduleOnCallResponders> {
   ...
   * @param param The request object
   */
  public getUserNotificationChannel(param: OnCallApiGetUserNotificationChannelRequest, options?: Configuration): Promise<NotificationChannel> {
   ...
   * @param param The request object
   */
  public getUserNotificationRule(param: OnCallApiGetUserNotificationRuleRequest, options?: Configuration): Promise<OnCallNotificationRule> {
   ...
   * @param param The request object
   */
  public listUserNotificationChannels(param: OnCallApiListUserNotificationChannelsRequest, options?: Configuration): Promise<ListNotificationChannelsResponse> {
   ...
   * @param param The request object
   */
  public listUserNotificationRules(param: OnCallApiListUserNotificationRulesRequest, options?: Configuration): Promise<ListOnCallNotificationRulesResponse> {
   ...
   * @param param The request object
   */
  public updateUserNotificationRule(param: OnCallApiUpdateUserNotificationRuleRequest, options?: Configuration): Promise<OnCallNotificationRule> {
