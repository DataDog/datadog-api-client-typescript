...
export class OnCallApiRequestFactory extends BaseAPIRequestFactory {
  ...
  public async deleteOnCallSchedule(
    ...
    if (scheduleUuid === null || scheduleUuid === undefined) {
      throw new RequiredError("scheduleUuid", "deleteOnCallSchedule");
    }

    // Path Params
    const localVarPath = "/api/v2/on-call/schedules/{schedule_uuid}".replace(
      "{schedule_uuid}",
  ...
  public async getOnCallSchedule(
    ...
    // verify required parameter 'scheduleUuid' is not null or undefined
    if (scheduleUuid === null || scheduleUuid === undefined) {
      throw new RequiredError("scheduleUuid", "getOnCallSchedule");
    }
  ...
  public async updateOnCallSchedule(
    ...
    // verify required parameter 'scheduleUuid' is not null or undefined
    if (scheduleUuid === null || scheduleUuid === undefined) {
      throw new RequiredError("scheduleUuid", "updateOnCallSchedule");
    }
