...
import { ElasticCloudIntegrationAccountRequest } from "../models/ElasticCloudIntegrationAccountRequest";
...
import { ElasticCloudInterfaceId } from "../models/ElasticCloudInterfaceId";
...
export class ElasticCloudIntegrationAccountsApiRequestFactory extends BaseAPIRequestFactory {
  public async createElasticCloudIntegrationAccount(
    interfaceId: ElasticCloudInterfaceId,
    ...
    // Path Params
    const localVarPath =
      "/api/v2/integrations/elastic-cloud/interfaces/{interface_id}/accounts".replace(
        "{interface_id}",
...
export interface ElasticCloudIntegrationAccountsApiCreateElasticCloudIntegrationAccountRequest {
  /**
   * Selects the Elastic Cloud interface (source-type). Supported values: `elastic-cloud`, `elastic-cloud-ccm`.
...
export interface ElasticCloudIntegrationAccountsApiListElasticCloudIntegrationAccountsRequest {
  /**
   * Selects the Elastic Cloud interface (source-type). Supported values: `elastic-cloud`, `elastic-cloud-ccm`.
   * @type ElasticCloudInterfaceId
   */
...
export class ElasticCloudIntegrationAccountsApi {
  ...
  public listElasticCloudIntegrationAccounts(
    param: ElasticCloudIntegrationAccountsApiListElasticCloudIntegrationAccountsRequest,
    options?: Configuration
  ): Promise<ElasticCloudIntegrationAccountsResponse> {
    const requestContextPromise =
      this.requestFactory.listElasticCloudIntegrationAccounts(
        param.interfaceId,
        options
      );
    return requestContextPromise.then((requestContext) => {
