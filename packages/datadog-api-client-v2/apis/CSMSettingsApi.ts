...
export class CSMSettingsApiRequestFactory extends BaseAPIRequestFactory {
  ...
  public async getCSMAgentlessHostFacetInfo(facet: string,search?: string,query?: string,_options?: Configuration): Promise<RequestContext> {
    const _config = _options || this.configuration;

    logger.warn("Using unstable operation 'getCSMAgentlessHostFacetInfo'");
    ...
    const requestContext = _config.getServer('v2.CSMSettingsApi.getCSMAgentlessHostFacetInfo').makeRequestContext(localVarPath, HttpMethod.GET);
    requestContext.setHeaderParam("Accept", "application/json");
    requestContext.setHttpConfig(_config.httpConfig);

    // Query Params
  if (facet !== undefined) {
      requestContext.setQueryParam("facet", ObjectSerializer.serialize(facet, "string", ""
), "");
    }
  if (search !== undefined) {
  ...
  public async getCSMUnifiedHostFacetInfo(facet: string,search?: string,query?: string,_options?: Configuration): Promise<RequestContext> {
    const _config = _options || this.configuration;

    logger.warn("Using unstable operation 'getCSMUnifiedHostFacetInfo'");
    ...
    // Make Request Context
    const requestContext = _config.getServer('v2.CSMSettingsApi.getCSMUnifiedHostFacetInfo').makeRequestContext(localVarPath, HttpMethod.GET);
    requestContext.setHeaderParam("Accept", "application/json");
    requestContext.setHttpConfig(_config.httpConfig);
  ...
  public async listCSMAgentlessHostFacets(_options?: Configuration): Promise<RequestContext> {
    const _config = _options || this.configuration;

    logger.warn("Using unstable operation 'listCSMAgentlessHostFacets'");
    ...
    // Make Request Context
    const requestContext = _config.getServer('v2.CSMSettingsApi.listCSMAgentlessHostFacets').makeRequestContext(localVarPath, HttpMethod.GET);
    requestContext.setHeaderParam("Accept", "application/json");
    requestContext.setHttpConfig(_config.httpConfig);
  ...
  public async listCSMAgentlessHosts(page?: number,size?: number,query?: string,_options?: Configuration): Promise<RequestContext> {
    const _config = _options || this.configuration;

    logger.warn("Using unstable operation 'listCSMAgentlessHosts'");
    ...
    // Make Request Context
    const requestContext = _config.getServer('v2.CSMSettingsApi.listCSMAgentlessHosts').makeRequestContext(localVarPath, HttpMethod.GET);
    requestContext.setHeaderParam("Accept", "application/json");
    requestContext.setHttpConfig(_config.httpConfig);
  ...
  public async listCSMUnifiedHostFacets(_options?: Configuration): Promise<RequestContext> {
    const _config = _options || this.configuration;

    logger.warn("Using unstable operation 'listCSMUnifiedHostFacets'");
    ...
    // Make Request Context
    const requestContext = _config.getServer('v2.CSMSettingsApi.listCSMUnifiedHostFacets').makeRequestContext(localVarPath, HttpMethod.GET);
    requestContext.setHeaderParam("Accept", "application/json");
    requestContext.setHttpConfig(_config.httpConfig);
  ...
  public async listCSMUnifiedHosts(page?: number,size?: number,query?: string,_options?: Configuration): Promise<RequestContext> {
    const _config = _options || this.configuration;

    logger.warn("Using unstable operation 'listCSMUnifiedHosts'");
    ...
    // Make Request Context
    const requestContext = _config.getServer('v2.CSMSettingsApi.listCSMUnifiedHosts').makeRequestContext(localVarPath, HttpMethod.GET);
    requestContext.setHeaderParam("Accept", "application/json");
    requestContext.setHttpConfig(_config.httpConfig);
...
export class CSMSettingsApiResponseProcessor {
   ...
   */
   public async getCSMAgentlessHostFacetInfo(response: ResponseContext): Promise<CsmHostFacetInfoResponse> {
    const contentType = ObjectSerializer.normalizeMediaType(response.headers["content-type"]);
    if (response.httpStatusCode === 200) {
      const body: CsmHostFacetInfoResponse = ObjectSerializer.deserialize(
   ...
   * @throws ApiException if the response code was not in [200, 299]
   */
   public async getCSMUnifiedHostFacetInfo(response: ResponseContext): Promise<CsmHostFacetInfoResponse> {
    const contentType = ObjectSerializer.normalizeMediaType(response.headers["content-type"]);
    if (response.httpStatusCode === 200) {
      const body: CsmHostFacetInfoResponse = ObjectSerializer.deserialize(
        ObjectSerializer.parse(await response.body.text(), contentType),
   ...
   * @throws ApiException if the response code was not in [200, 299]
   */
   public async listCSMAgentlessHostFacets(response: ResponseContext): Promise<CsmAgentlessHostFacetsResponse> {
    const contentType = ObjectSerializer.normalizeMediaType(response.headers["content-type"]);
    if (response.httpStatusCode === 200) {
      const body: CsmAgentlessHostFacetsResponse = ObjectSerializer.deserialize(
        ObjectSerializer.parse(await response.body.text(), contentType),
   ...
   * @throws ApiException if the response code was not in [200, 299]
   */
   public async listCSMAgentlessHosts(response: ResponseContext): Promise<CsmAgentlessHostsResponse> {
    const contentType = ObjectSerializer.normalizeMediaType(response.headers["content-type"]);
    if (response.httpStatusCode === 200) {
      const body: CsmAgentlessHostsResponse = ObjectSerializer.deserialize(
        ObjectSerializer.parse(await response.body.text(), contentType),
   ...
   * @throws ApiException if the response code was not in [200, 299]
   */
   public async listCSMUnifiedHostFacets(response: ResponseContext): Promise<CsmUnifiedHostFacetsResponse> {
    const contentType = ObjectSerializer.normalizeMediaType(response.headers["content-type"]);
    if (response.httpStatusCode === 200) {
      const body: CsmUnifiedHostFacetsResponse = ObjectSerializer.deserialize(
        ObjectSerializer.parse(await response.body.text(), contentType),
   ...
   * @throws ApiException if the response code was not in [200, 299]
   */
   public async listCSMUnifiedHosts(response: ResponseContext): Promise<CsmUnifiedHostsResponse> {
    const contentType = ObjectSerializer.normalizeMediaType(response.headers["content-type"]);
    if (response.httpStatusCode === 200) {
      const body: CsmUnifiedHostsResponse = ObjectSerializer.deserialize(
        ObjectSerializer.parse(await response.body.text(), contentType),
...
export class CSMSettingsApi {
  ...
  public constructor(configuration: Configuration, requestFactory?: CSMSettingsApiRequestFactory, responseProcessor?: CSMSettingsApiResponseProcessor) {
    this.configuration = configuration;
    this.requestFactory = requestFactory || new CSMSettingsApiRequestFactory(configuration);
    this.responseProcessor = responseProcessor || new CSMSettingsApiResponseProcessor();
  }
   ...
   */
  public getCSMAgentlessHostFacetInfo(param: CSMSettingsApiGetCSMAgentlessHostFacetInfoRequest, options?: Configuration): Promise<CsmHostFacetInfoResponse> {
   ...
   * @param param The request object
   */
  public getCSMUnifiedHostFacetInfo(param: CSMSettingsApiGetCSMUnifiedHostFacetInfoRequest, options?: Configuration): Promise<CsmHostFacetInfoResponse> {
   ...
   * @param param The request object
   */
  public listCSMAgentlessHostFacets( options?: Configuration): Promise<CsmAgentlessHostFacetsResponse> {
   ...
   * @param param The request object
   */
  public listCSMAgentlessHosts(param: CSMSettingsApiListCSMAgentlessHostsRequest = {}, options?: Configuration): Promise<CsmAgentlessHostsResponse> {
   ...
   * @param param The request object
   */
  public listCSMUnifiedHostFacets( options?: Configuration): Promise<CsmUnifiedHostFacetsResponse> {
   ...
   * @param param The request object
   */
  public listCSMUnifiedHosts(param: CSMSettingsApiListCSMUnifiedHostsRequest = {}, options?: Configuration): Promise<CsmUnifiedHostsResponse> {
