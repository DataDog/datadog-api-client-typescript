...
export class OrganizationsApiRequestFactory extends BaseAPIRequestFactory {
  ...
  public async getOrgConfig(orgConfigName: string,_options?: Configuration): Promise<RequestContext> {
    ...
    // Path Params
    const localVarPath = '/api/v2/org_configs/{org_config_name}'
      .replace('{org_config_name}', encodeURIComponent(String(orgConfigName)));

    // Make Request Context
    const requestContext = _config.getServer('v2.OrganizationsApi.getOrgConfig').makeRequestContext(localVarPath, HttpMethod.GET);
  ...
  public async getSAMLConfiguration(samlConfigUuid: string,_options?: Configuration): Promise<RequestContext> {
    const _config = _options || this.configuration;
    ...
    // Path Params
    const localVarPath = '/api/v2/saml_configurations/{saml_config_uuid}'
      .replace('{saml_config_uuid}', encodeURIComponent(String(samlConfigUuid)));

    // Make Request Context
    const requestContext = _config.getServer('v2.OrganizationsApi.getSAMLConfiguration').makeRequestContext(localVarPath, HttpMethod.GET);
    requestContext.setHeaderParam("Accept", "application/json");
    requestContext.setHttpConfig(_config.httpConfig);
  ...
  public async listGlobalOrgs(userHandle: string,pageLimit?: number,pageCursor?: string,_options?: Configuration): Promise<RequestContext> {
    const _config = _options || this.configuration;
    ...
    // Make Request Context
    const requestContext = _config.getServer('v2.OrganizationsApi.listGlobalOrgs').makeRequestContext(localVarPath, HttpMethod.GET);
    requestContext.setHeaderParam("Accept", "application/json");
    requestContext.setHttpConfig(_config.httpConfig);

    // Query Params
  if (userHandle !== undefined) {
      requestContext.setQueryParam("user_handle", ObjectSerializer.serialize(userHandle, "string", ""
), "");
    }
  ...
  public async listOrgConfigs(_options?: Configuration): Promise<RequestContext> {
    const _config = _options || this.configuration;
    ...
    // Make Request Context
    const requestContext = _config.getServer('v2.OrganizationsApi.listOrgConfigs').makeRequestContext(localVarPath, HttpMethod.GET);
    requestContext.setHeaderParam("Accept", "application/json");
    requestContext.setHttpConfig(_config.httpConfig);
  ...
  public async listOrgs(filterName?: string,_options?: Configuration): Promise<RequestContext> {
    const _config = _options || this.configuration;
    ...
    // Make Request Context
    const requestContext = _config.getServer('v2.OrganizationsApi.listOrgs').makeRequestContext(localVarPath, HttpMethod.GET);
    requestContext.setHeaderParam("Accept", "application/json");
    requestContext.setHttpConfig(_config.httpConfig);
  ...
  public async listSAMLConfigurations(_options?: Configuration): Promise<RequestContext> {
    const _config = _options || this.configuration;
    ...
    // Make Request Context
    const requestContext = _config.getServer('v2.OrganizationsApi.listSAMLConfigurations').makeRequestContext(localVarPath, HttpMethod.GET);
    requestContext.setHeaderParam("Accept", "application/json");
    requestContext.setHttpConfig(_config.httpConfig);
  ...
  public async updateLoginOrgConfigsMaxSessionDuration(body: MaxSessionDurationUpdateRequest,_options?: Configuration): Promise<RequestContext> {
    const _config = _options || this.configuration;
    ...
    // Make Request Context
    const requestContext = _config.getServer('v2.OrganizationsApi.updateLoginOrgConfigsMaxSessionDuration').makeRequestContext(localVarPath, HttpMethod.PUT);
  ...
  public async updateOrgConfig(orgConfigName: string,body: OrgConfigWriteRequest,_options?: Configuration): Promise<RequestContext> {
    const _config = _options || this.configuration;
    ...
    // Make Request Context
    const requestContext = _config.getServer('v2.OrganizationsApi.updateOrgConfig').makeRequestContext(localVarPath, HttpMethod.PATCH);
    requestContext.setHeaderParam("Accept", "application/json");
    requestContext.setHttpConfig(_config.httpConfig);
  ...
  public async updateOrgSamlConfigurations(body: OrgSAMLPreferencesUpdateRequest,_options?: Configuration): Promise<RequestContext> {
    const _config = _options || this.configuration;
    ...
    if (!_config.unstableOperations['v2.updateOrgSamlConfigurations']) {
      throw new Error("Unstable operation 'updateOrgSamlConfigurations' is disabled");
    }
    ...
    // Make Request Context
    const requestContext = _config.getServer('v2.OrganizationsApi.updateOrgSamlConfigurations').makeRequestContext(localVarPath, HttpMethod.PATCH);
    requestContext.setHeaderParam("Accept", "*/*");
    requestContext.setHttpConfig(_config.httpConfig);
  ...
  public async updateSAMLConfiguration(samlConfigUuid: string,body: SAMLConfigurationUpdateRequest,_options?: Configuration): Promise<RequestContext> {
    const _config = _options || this.configuration;
    ...
    // Make Request Context
    const requestContext = _config.getServer('v2.OrganizationsApi.updateSAMLConfiguration').makeRequestContext(localVarPath, HttpMethod.PATCH);
    requestContext.setHeaderParam("Accept", "application/json");
    requestContext.setHttpConfig(_config.httpConfig);
  ...
  public async uploadIdPMetadata(idpFile?: HttpFile,_options?: Configuration): Promise<RequestContext> {
    const _config = _options || this.configuration;
    ...
    // Make Request Context
    const requestContext = _config.getServer('v2.OrganizationsApi.uploadIdPMetadata').makeRequestContext(localVarPath, HttpMethod.POST);
    requestContext.setHeaderParam("Accept", "*/*");
    requestContext.setHttpConfig(_config.httpConfig);
...
export class OrganizationsApiResponseProcessor {
   ...
   */
   public async getOrgConfig(response: ResponseContext): Promise<OrgConfigGetResponse> {
   ...
   * @throws ApiException if the response code was not in [200, 299]
   */
   public async getSAMLConfiguration(response: ResponseContext): Promise<SAMLConfigurationResponse> {
    const contentType = ObjectSerializer.normalizeMediaType(response.headers["content-type"]);
    if (response.httpStatusCode === 200) {
   ...
   * @throws ApiException if the response code was not in [200, 299]
   */
   public async listGlobalOrgs(response: ResponseContext): Promise<GlobalOrgsResponse> {
    const contentType = ObjectSerializer.normalizeMediaType(response.headers["content-type"]);
    if (response.httpStatusCode === 200) {
   ...
   * @throws ApiException if the response code was not in [200, 299]
   */
   public async listOrgConfigs(response: ResponseContext): Promise<OrgConfigListResponse> {
    const contentType = ObjectSerializer.normalizeMediaType(response.headers["content-type"]);
    if (response.httpStatusCode === 200) {
   ...
   * @throws ApiException if the response code was not in [200, 299]
   */
   public async listOrgs(response: ResponseContext): Promise<ManagedOrgsResponse> {
    const contentType = ObjectSerializer.normalizeMediaType(response.headers["content-type"]);
    if (response.httpStatusCode === 200) {
   ...
   * @throws ApiException if the response code was not in [200, 299]
   */
   public async listSAMLConfigurations(response: ResponseContext): Promise<SAMLConfigurationsResponse> {
    const contentType = ObjectSerializer.normalizeMediaType(response.headers["content-type"]);
    if (response.httpStatusCode === 200) {
   ...
   * @throws ApiException if the response code was not in [200, 299]
   */
   public async updateLoginOrgConfigsMaxSessionDuration(response: ResponseContext): Promise<void> {
    const contentType = ObjectSerializer.normalizeMediaType(response.headers["content-type"]);
   ...
   * @throws ApiException if the response code was not in [200, 299]
   */
   public async updateOrgConfig(response: ResponseContext): Promise<OrgConfigGetResponse> {
    const contentType = ObjectSerializer.normalizeMediaType(response.headers["content-type"]);
    if (response.httpStatusCode === 200) {
      const body: OrgConfigGetResponse = ObjectSerializer.deserialize(
        ObjectSerializer.parse(await response.body.text(), contentType),
   ...
   * @throws ApiException if the response code was not in [200, 299]
   */
   public async updateOrgSamlConfigurations(response: ResponseContext): Promise<void> {
    const contentType = ObjectSerializer.normalizeMediaType(response.headers["content-type"]);
    if (response.httpStatusCode === 204) {
      return;
    }
   ...
   * @throws ApiException if the response code was not in [200, 299]
   */
   public async updateSAMLConfiguration(response: ResponseContext): Promise<SAMLConfigurationResponse> {
    const contentType = ObjectSerializer.normalizeMediaType(response.headers["content-type"]);
    if (response.httpStatusCode === 200) {
      const body: SAMLConfigurationResponse = ObjectSerializer.deserialize(
        ObjectSerializer.parse(await response.body.text(), contentType),
...
export class OrganizationsApi {
   ...
   */
  public getOrgConfig(param: OrganizationsApiGetOrgConfigRequest, options?: Configuration): Promise<OrgConfigGetResponse> {
   ...
   * @param param The request object
   */
  public getSAMLConfiguration(param: OrganizationsApiGetSAMLConfigurationRequest, options?: Configuration): Promise<SAMLConfigurationResponse> {
    const requestContextPromise = this.requestFactory.getSAMLConfiguration(param.samlConfigUuid,options);
    return requestContextPromise.then(requestContext => {
        return this.configuration.httpApi.send(requestContext).then(responseContext => {
   ...
   * @param param The request object
   */
  public listGlobalOrgs(param: OrganizationsApiListGlobalOrgsRequest, options?: Configuration): Promise<GlobalOrgsResponse> {
    const requestContextPromise = this.requestFactory.listGlobalOrgs(param.userHandle,param.pageLimit,param.pageCursor,options);
    return requestContextPromise.then(requestContext => {
        return this.configuration.httpApi.send(requestContext).then(responseContext => {
...
/**
   ...
   * @param param The request object
   */
  public listOrgConfigs( options?: Configuration): Promise<OrgConfigListResponse> {
   ...
   * @param param The request object
   */
  public listOrgs(param: OrganizationsApiListOrgsRequest = {}, options?: Configuration): Promise<ManagedOrgsResponse> {
    const requestContextPromise = this.requestFactory.listOrgs(param.filterName,options);
    return requestContextPromise.then(requestContext => {
        return this.configuration.httpApi.send(requestContext).then(responseContext => {
   ...
   * @param param The request object
   */
  public listSAMLConfigurations( options?: Configuration): Promise<SAMLConfigurationsResponse> {
    const requestContextPromise = this.requestFactory.listSAMLConfigurations(options);
    return requestContextPromise.then(requestContext => {
        return this.configuration.httpApi.send(requestContext).then(responseContext => {
   ...
   * @param param The request object
   */
  public updateLoginOrgConfigsMaxSessionDuration(param: OrganizationsApiUpdateLoginOrgConfigsMaxSessionDurationRequest, options?: Configuration): Promise<void> {
    const requestContextPromise = this.requestFactory.updateLoginOrgConfigsMaxSessionDuration(param.body,options);
    return requestContextPromise.then(requestContext => {
        return this.configuration.httpApi.send(requestContext).then(responseContext => {
   ...
   * @param param The request object
   */
  public updateOrgConfig(param: OrganizationsApiUpdateOrgConfigRequest, options?: Configuration): Promise<OrgConfigGetResponse> {
   ...
   * @param param The request object
   */
  public updateOrgSamlConfigurations(param: OrganizationsApiUpdateOrgSamlConfigurationsRequest, options?: Configuration): Promise<void> {
    const requestContextPromise = this.requestFactory.updateOrgSamlConfigurations(param.body,options);
    return requestContextPromise.then(requestContext => {
        return this.configuration.httpApi.send(requestContext).then(responseContext => {
   ...
   * @param param The request object
   */
  public updateSAMLConfiguration(param: OrganizationsApiUpdateSAMLConfigurationRequest, options?: Configuration): Promise<SAMLConfigurationResponse> {
    const requestContextPromise = this.requestFactory.updateSAMLConfiguration(param.samlConfigUuid,param.body,options);
    return requestContextPromise.then(requestContext => {
        return this.configuration.httpApi.send(requestContext).then(responseContext => {
   ...
   * @param param The request object
   */
  public uploadIdPMetadata(param: OrganizationsApiUploadIdPMetadataRequest = {}, options?: Configuration): Promise<void> {
