...
export class ComplianceApiRequestFactory extends BaseAPIRequestFactory {
  ...
  public async getRuleBasedView(to: number,framework?: string,version?: string,queryFindingsWithoutFrameworkVersion?: boolean,includeRulesWithoutFindings?: boolean,isCustom?: boolean,query?: string,_options?: Configuration): Promise<RequestContext> {
    ...
    const requestContext = _config.getServer('v2.ComplianceApi.getRuleBasedView').makeRequestContext(localVarPath, HttpMethod.GET);
  ...
  if (framework !== undefined) {
      requestContext.setQueryParam("framework", ObjectSerializer.serialize(framework, "string", ""
), "");
    }
  ...
  if (queryFindingsWithoutFrameworkVersion !== undefined) {
      requestContext.setQueryParam("query_findings_without_framework_version", ObjectSerializer.serialize(queryFindingsWithoutFrameworkVersion, "boolean", ""
), "");
    }
  if (includeRulesWithoutFindings !== undefined) {
      requestContext.setQueryParam("include_rules_without_findings", ObjectSerializer.serialize(includeRulesWithoutFindings, "boolean", ""
), "");
    }
  if (isCustom !== undefined) {
      requestContext.setQueryParam("is_custom", ObjectSerializer.serialize(isCustom, "boolean", ""
), "");
    }
  if (query !== undefined) {
...
export class ComplianceApiResponseProcessor {
   ...
   */
   public async getRuleBasedView(response: ResponseContext): Promise<RuleBasedViewResponse> {
...
export class ComplianceApi {
  ...
  public constructor(configuration: Configuration, requestFactory?: ComplianceApiRequestFactory, responseProcessor?: ComplianceApiResponseProcessor) {
    this.configuration = configuration;
    this.requestFactory = requestFactory || new ComplianceApiRequestFactory(configuration);
    this.responseProcessor = responseProcessor || new ComplianceApiResponseProcessor();
  }
   ...
   */
  public getRuleBasedView(param: ComplianceApiGetRuleBasedViewRequest, options?: Configuration): Promise<RuleBasedViewResponse> {
