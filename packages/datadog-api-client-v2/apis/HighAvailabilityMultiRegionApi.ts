...
export class HighAvailabilityMultiRegionApiRequestFactory extends BaseAPIRequestFactory {
  ...
  public async createHamrOrgConnection(body: HamrOrgConnectionRequest,_options?: Configuration): Promise<RequestContext> {
    ...
    const requestContext = _config.getServer('v2.HighAvailabilityMultiRegionApi.createHamrOrgConnection').makeRequestContext(localVarPath, HttpMethod.POST);
  ...
  public async getHamrOrgConnection(_options?: Configuration): Promise<RequestContext> {
    const _config = _options || this.configuration;
    ...
    // Make Request Context
    const requestContext = _config.getServer('v2.HighAvailabilityMultiRegionApi.getHamrOrgConnection').makeRequestContext(localVarPath, HttpMethod.GET);
    requestContext.setHeaderParam("Accept", "application/json");
    requestContext.setHttpConfig(_config.httpConfig);
...
export class HighAvailabilityMultiRegionApiResponseProcessor {
   ...
   */
   public async createHamrOrgConnection(response: ResponseContext): Promise<HamrOrgConnectionResponse> {
   ...
   * @throws ApiException if the response code was not in [200, 299]
   */
   public async getHamrOrgConnection(response: ResponseContext): Promise<HamrOrgConnectionResponse> {
    const contentType = ObjectSerializer.normalizeMediaType(response.headers["content-type"]);
    if (response.httpStatusCode === 200) {
      const body: HamrOrgConnectionResponse = ObjectSerializer.deserialize(
        ObjectSerializer.parse(await response.body.text(), contentType),
...
export class HighAvailabilityMultiRegionApi {
  ...
  public constructor(configuration: Configuration, requestFactory?: HighAvailabilityMultiRegionApiRequestFactory, responseProcessor?: HighAvailabilityMultiRegionApiResponseProcessor) {
    this.configuration = configuration;
    this.requestFactory = requestFactory || new HighAvailabilityMultiRegionApiRequestFactory(configuration);
    this.responseProcessor = responseProcessor || new HighAvailabilityMultiRegionApiResponseProcessor();
  }
   ...
   */
  public createHamrOrgConnection(param: HighAvailabilityMultiRegionApiCreateHamrOrgConnectionRequest, options?: Configuration): Promise<HamrOrgConnectionResponse> {
   ...
   * @param param The request object
   */
  public getHamrOrgConnection( options?: Configuration): Promise<HamrOrgConnectionResponse> {
