...
export class ErrorTrackingApiRequestFactory extends BaseAPIRequestFactory {
  ...
  public async deleteIssueAssignee(issueId: string,_options?: Configuration): Promise<RequestContext> {
    ...
    // Path Params
    const localVarPath = '/api/v2/error-tracking/issues/{issue_id}/assignee'
      .replace('{issue_id}', encodeURIComponent(String(issueId)));

    // Make Request Context
    const requestContext = _config.getServer('v2.ErrorTrackingApi.deleteIssueAssignee').makeRequestContext(localVarPath, HttpMethod.DELETE);
  ...
  public async getIssue(issueId: string,include?: Array<GetIssueIncludeQueryParameterItem>,_options?: Configuration): Promise<RequestContext> {
    const _config = _options || this.configuration;
    ...
    // Path Params
    const localVarPath = '/api/v2/error-tracking/issues/{issue_id}'
      .replace('{issue_id}', encodeURIComponent(String(issueId)));

    // Make Request Context
    const requestContext = _config.getServer('v2.ErrorTrackingApi.getIssue').makeRequestContext(localVarPath, HttpMethod.GET);
    requestContext.setHeaderParam("Accept", "application/json");
    requestContext.setHttpConfig(_config.httpConfig);

    // Query Params
  if (include !== undefined) {
      requestContext.setQueryParam("include", ObjectSerializer.serialize(include, "Array<GetIssueIncludeQueryParameterItem>", ""
), "csv");
    }
  ...
  public async searchIssues(body: IssuesSearchRequest,include?: Array<SearchIssuesIncludeQueryParameterItem>,_options?: Configuration): Promise<RequestContext> {
    const _config = _options || this.configuration;
    ...
    // Make Request Context
    const requestContext = _config.getServer('v2.ErrorTrackingApi.searchIssues').makeRequestContext(localVarPath, HttpMethod.POST);
    requestContext.setHeaderParam("Accept", "application/json");
    requestContext.setHttpConfig(_config.httpConfig);

    // Query Params
  if (include !== undefined) {
      requestContext.setQueryParam("include", ObjectSerializer.serialize(include, "Array<SearchIssuesIncludeQueryParameterItem>", ""
), "csv");
    }
  ...
  public async updateIssueAssignee(issueId: string,body: IssueUpdateAssigneeRequest,_options?: Configuration): Promise<RequestContext> {
    const _config = _options || this.configuration;
    ...
    // Make Request Context
    const requestContext = _config.getServer('v2.ErrorTrackingApi.updateIssueAssignee').makeRequestContext(localVarPath, HttpMethod.PUT);
    requestContext.setHeaderParam("Accept", "application/json");
    requestContext.setHttpConfig(_config.httpConfig);
  ...
  public async updateIssueState(issueId: string,body: IssueUpdateStateRequest,_options?: Configuration): Promise<RequestContext> {
    const _config = _options || this.configuration;
    ...
    // Path Params
    const localVarPath = '/api/v2/error-tracking/issues/{issue_id}/state'
      .replace('{issue_id}', encodeURIComponent(String(issueId)));

    // Make Request Context
    const requestContext = _config.getServer('v2.ErrorTrackingApi.updateIssueState').makeRequestContext(localVarPath, HttpMethod.PUT);
    requestContext.setHeaderParam("Accept", "application/json");
    requestContext.setHttpConfig(_config.httpConfig);
...
export class ErrorTrackingApiResponseProcessor {
   ...
   * @throws ApiException if the response code was not in [200, 299]
   */
   public async searchIssues(response: ResponseContext): Promise<IssuesSearchResponse> {
    const contentType = ObjectSerializer.normalizeMediaType(response.headers["content-type"]);
    if (response.httpStatusCode === 200) {
   ...
   * @throws ApiException if the response code was not in [200, 299]
   */
   public async updateIssueAssignee(response: ResponseContext): Promise<IssueResponse> {
    const contentType = ObjectSerializer.normalizeMediaType(response.headers["content-type"]);
    if (response.httpStatusCode === 200) {
      const body: IssueResponse = ObjectSerializer.deserialize(
        ObjectSerializer.parse(await response.body.text(), contentType),
   ...
   * @throws ApiException if the response code was not in [200, 299]
   */
   public async updateIssueState(response: ResponseContext): Promise<IssueResponse> {
    const contentType = ObjectSerializer.normalizeMediaType(response.headers["content-type"]);
    if (response.httpStatusCode === 200) {
      const body: IssueResponse = ObjectSerializer.deserialize(
        ObjectSerializer.parse(await response.body.text(), contentType),
...
export class ErrorTrackingApi {
  ...
  public constructor(configuration: Configuration, requestFactory?: ErrorTrackingApiRequestFactory, responseProcessor?: ErrorTrackingApiResponseProcessor) {
    this.configuration = configuration;
    this.requestFactory = requestFactory || new ErrorTrackingApiRequestFactory(configuration);
    this.responseProcessor = responseProcessor || new ErrorTrackingApiResponseProcessor();
  }
   ...
   */
  public deleteIssueAssignee(param: ErrorTrackingApiDeleteIssueAssigneeRequest, options?: Configuration): Promise<void> {
   ...
   * @param param The request object
   */
  public getIssue(param: ErrorTrackingApiGetIssueRequest, options?: Configuration): Promise<IssueResponse> {
   ...
   * @param param The request object
   */
  public searchIssues(param: ErrorTrackingApiSearchIssuesRequest, options?: Configuration): Promise<IssuesSearchResponse> {
   ...
   * @param param The request object
   */
  public updateIssueAssignee(param: ErrorTrackingApiUpdateIssueAssigneeRequest, options?: Configuration): Promise<IssueResponse> {
   ...
   * @param param The request object
   */
  public updateIssueState(param: ErrorTrackingApiUpdateIssueStateRequest, options?: Configuration): Promise<IssueResponse> {
