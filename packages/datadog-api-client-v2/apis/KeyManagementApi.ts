...
export class KeyManagementApiRequestFactory extends BaseAPIRequestFactory {
  ...
  public async createPersonalAccessToken(
    ...
    logger.warn("Using unstable operation 'createPersonalAccessToken'");
    if (!_config.unstableOperations["v2.createPersonalAccessToken"]) {
      throw new Error(
        "Unstable operation 'createPersonalAccessToken' is disabled"
      );
    }
  ...
  public async getPersonalAccessToken(
    ...
    logger.warn("Using unstable operation 'getPersonalAccessToken'");
    if (!_config.unstableOperations["v2.getPersonalAccessToken"]) {
      throw new Error(
        "Unstable operation 'getPersonalAccessToken' is disabled"
      );
    }
  ...
  public async listPersonalAccessTokens(
    ...
    logger.warn("Using unstable operation 'listPersonalAccessTokens'");
    if (!_config.unstableOperations["v2.listPersonalAccessTokens"]) {
      throw new Error(
        "Unstable operation 'listPersonalAccessTokens' is disabled"
      );
    }
    ...
    if (filterOwnerUuid !== undefined) {
      requestContext.setQueryParam(
        "filter[owner_uuid]",
        ObjectSerializer.serialize(filterOwnerUuid, "Array<string>", "uuid"),
        "multi"
      );
    }
  ...
  public async revokePersonalAccessToken(
    ...
    logger.warn("Using unstable operation 'revokePersonalAccessToken'");
    if (!_config.unstableOperations["v2.revokePersonalAccessToken"]) {
      throw new Error(
        "Unstable operation 'revokePersonalAccessToken' is disabled"
      );
    }
  ...
  public async updatePersonalAccessToken(
    ...
    logger.warn("Using unstable operation 'updatePersonalAccessToken'");
    if (!_config.unstableOperations["v2.updatePersonalAccessToken"]) {
      throw new Error(
        "Unstable operation 'updatePersonalAccessToken' is disabled"
      );
    }
...
export class KeyManagementApiResponseProcessor {
  ...
  public async getPersonalAccessToken(
    ...
    if (response.httpStatusCode === 200) {
      const body: PersonalAccessTokenGetResponse = ObjectSerializer.deserialize(
        ObjectSerializer.parse(await response.body.text(), contentType),
  ...
  public async listPersonalAccessTokens(
    ...
    if (response.httpStatusCode === 200) {
      const body: PersonalAccessTokensListResponse =
