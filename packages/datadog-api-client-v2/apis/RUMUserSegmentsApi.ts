...
export class RUMUserSegmentsApiRequestFactory extends BaseAPIRequestFactory {
  public async createRumSegment(
    ...
    const requestContext = _config
      .getServer("v2.RUMUserSegmentsApi.createRumSegment")
    ...
    const serializedBody = ObjectSerializer.stringify(
      ObjectSerializer.serialize(body, "RumSegmentCreateRequest", ""),
      contentType
    );
  ...
  public async createRumStaticSegment(
    ...
    logger.warn("Using unstable operation 'createRumStaticSegment'");
    if (!_config.unstableOperations["v2.createRumStaticSegment"]) {
      throw new Error(
        "Unstable operation 'createRumStaticSegment' is disabled"
      );
    }
    ...
    // Make Request Context
    const requestContext = _config
      .getServer("v2.RUMUserSegmentsApi.createRumStaticSegment")
      .makeRequestContext(localVarPath, HttpMethod.POST);
    requestContext.setHeaderParam("Accept", "application/json");
    requestContext.setHttpConfig(_config.httpConfig);
    ...
    requestContext.setHeaderParam("Content-Type", contentType);
    const serializedBody = ObjectSerializer.stringify(
      ObjectSerializer.serialize(body, "RumStaticSegmentCreateRequest", ""),
      contentType
    );
    requestContext.setBody(serializedBody);
  ...
  public async deleteRumSegment(
    ...
    logger.warn("Using unstable operation 'deleteRumSegment'");
    if (!_config.unstableOperations["v2.deleteRumSegment"]) {
      throw new Error("Unstable operation 'deleteRumSegment' is disabled");
    }
    ...
    // Make Request Context
    const requestContext = _config
      .getServer("v2.RUMUserSegmentsApi.deleteRumSegment")
  ...
  public async getRumSegment(
    ...
    logger.warn("Using unstable operation 'getRumSegment'");
    if (!_config.unstableOperations["v2.getRumSegment"]) {
      throw new Error("Unstable operation 'getRumSegment' is disabled");
    }
    ...
    // Make Request Context
    const requestContext = _config
      .getServer("v2.RUMUserSegmentsApi.getRumSegment")
  ...
  public async initializeRumSegments(
    ...
    // Make Request Context
    const requestContext = _config
      .getServer("v2.RUMUserSegmentsApi.initializeRumSegments")
      .makeRequestContext(localVarPath, HttpMethod.POST);
  ...
  public async listRumSegments(
    ...
    // Make Request Context
    const requestContext = _config
      .getServer("v2.RUMUserSegmentsApi.listRumSegments")
      .makeRequestContext(localVarPath, HttpMethod.GET);
    requestContext.setHeaderParam("Accept", "application/json");
    requestContext.setHttpConfig(_config.httpConfig);
  ...
  public async listRumSegmentTemplates(
    ...
    logger.warn("Using unstable operation 'listRumSegmentTemplates'");
    if (!_config.unstableOperations["v2.listRumSegmentTemplates"]) {
      throw new Error(
        "Unstable operation 'listRumSegmentTemplates' is disabled"
      );
    }
    ...
    // Make Request Context
    const requestContext = _config
      .getServer("v2.RUMUserSegmentsApi.listRumSegmentTemplates")
      .makeRequestContext(localVarPath, HttpMethod.GET);
    requestContext.setHeaderParam("Accept", "application/json");
    requestContext.setHttpConfig(_config.httpConfig);
  ...
  public async updateRumSegment(
    ...
    logger.warn("Using unstable operation 'updateRumSegment'");
    if (!_config.unstableOperations["v2.updateRumSegment"]) {
      throw new Error("Unstable operation 'updateRumSegment' is disabled");
    }
    ...
    // Make Request Context
    const requestContext = _config
      .getServer("v2.RUMUserSegmentsApi.updateRumSegment")
    ...
    requestContext.setHeaderParam("Content-Type", contentType);
    const serializedBody = ObjectSerializer.stringify(
      ObjectSerializer.serialize(body, "RumSegmentUpdateRequest", ""),
      contentType
    );
    requestContext.setBody(serializedBody);
...
export class RUMUserSegmentsApiResponseProcessor {
  ...
  public async createRumSegment(
    ...
    if (response.httpStatusCode === 201) {
      const body: RumSegmentResponse = ObjectSerializer.deserialize(
  ...
  public async deleteRumSegment(
    ...
    if (response.httpStatusCode === 200) {
      const body: RumSegmentDeleteResponse = ObjectSerializer.deserialize(
        ObjectSerializer.parse(await response.body.text(), contentType),
  ...
  public async listRumSegments(
    ...
    if (response.httpStatusCode === 200) {
      const body: RumSegmentListResponse = ObjectSerializer.deserialize(
        ObjectSerializer.parse(await response.body.text(), contentType),
  ...
  public async listRumSegmentTemplates(
    ...
    if (response.httpStatusCode === 200) {
      const body: RumSegmentTemplateListResponse = ObjectSerializer.deserialize(
        ObjectSerializer.parse(await response.body.text(), contentType),
...
export class RUMUserSegmentsApi {
  ...
  public constructor(
    ...
    this.requestFactory =
      requestFactory || new RUMUserSegmentsApiRequestFactory(configuration);
