...
export class WebhooksIntegrationApiRequestFactory extends BaseAPIRequestFactory {
  ...
  public async createOAuth2ClientCredentials(body: WebhooksOAuth2ClientCredentialsCreateRequest,_options?: Configuration): Promise<RequestContext> {
    ...
    const requestContext = _config.getServer('v2.WebhooksIntegrationApi.createOAuth2ClientCredentials').makeRequestContext(localVarPath, HttpMethod.POST);
    ...
    const serializedBody = ObjectSerializer.stringify(
      ObjectSerializer.serialize(body, "WebhooksOAuth2ClientCredentialsCreateRequest", ""),
      contentType
    );
  ...
  public async deleteOAuth2ClientCredentials(authMethodId: string,_options?: Configuration): Promise<RequestContext> {
    const _config = _options || this.configuration;
    ...
    // Path Params
    const localVarPath = '/api/v2/integration/webhooks/configuration/auth-method/oauth2-client-credentials/{auth_method_id}'
      .replace('{auth_method_id}', encodeURIComponent(String(authMethodId)));

    // Make Request Context
    const requestContext = _config.getServer('v2.WebhooksIntegrationApi.deleteOAuth2ClientCredentials').makeRequestContext(localVarPath, HttpMethod.DELETE);
  ...
  public async getAllAuthMethods(include?: WebhooksAuthMethodProtocol,_options?: Configuration): Promise<RequestContext> {
    const _config = _options || this.configuration;
    ...
    // Make Request Context
    const requestContext = _config.getServer('v2.WebhooksIntegrationApi.getAllAuthMethods').makeRequestContext(localVarPath, HttpMethod.GET);
    requestContext.setHeaderParam("Accept", "application/json");
    requestContext.setHttpConfig(_config.httpConfig);

    // Query Params
  if (include !== undefined) {
      requestContext.setQueryParam("include", ObjectSerializer.serialize(include, "WebhooksAuthMethodProtocol", ""
), "");
    }
  ...
  public async getOAuth2ClientCredentials(authMethodId: string,_options?: Configuration): Promise<RequestContext> {
    const _config = _options || this.configuration;
    ...
    // Make Request Context
    const requestContext = _config.getServer('v2.WebhooksIntegrationApi.getOAuth2ClientCredentials').makeRequestContext(localVarPath, HttpMethod.GET);
    requestContext.setHeaderParam("Accept", "application/json");
    requestContext.setHttpConfig(_config.httpConfig);
  ...
  public async updateOAuth2ClientCredentials(authMethodId: string,body: WebhooksOAuth2ClientCredentialsUpdateRequest,_options?: Configuration): Promise<RequestContext> {
    const _config = _options || this.configuration;
    ...
    // Make Request Context
    const requestContext = _config.getServer('v2.WebhooksIntegrationApi.updateOAuth2ClientCredentials').makeRequestContext(localVarPath, HttpMethod.PATCH);
    requestContext.setHeaderParam("Accept", "application/json");
    requestContext.setHttpConfig(_config.httpConfig);
    ...
    requestContext.setHeaderParam("Content-Type", contentType);
    const serializedBody = ObjectSerializer.stringify(
      ObjectSerializer.serialize(body, "WebhooksOAuth2ClientCredentialsUpdateRequest", ""),
      contentType
    );
    requestContext.setBody(serializedBody);
...
export class WebhooksIntegrationApiResponseProcessor {
   ...
   */
   public async createOAuth2ClientCredentials(response: ResponseContext): Promise<WebhooksOAuth2ClientCredentialsResponse> {
    const contentType = ObjectSerializer.normalizeMediaType(response.headers["content-type"]);
    if (response.httpStatusCode === 201) {
      const body: WebhooksOAuth2ClientCredentialsResponse = ObjectSerializer.deserialize(
   ...
   * @throws ApiException if the response code was not in [200, 299]
   */
   public async deleteOAuth2ClientCredentials(response: ResponseContext): Promise<void> {
    const contentType = ObjectSerializer.normalizeMediaType(response.headers["content-type"]);
   ...
   * @throws ApiException if the response code was not in [200, 299]
   */
   public async getAllAuthMethods(response: ResponseContext): Promise<WebhooksAuthMethodsResponse> {
    const contentType = ObjectSerializer.normalizeMediaType(response.headers["content-type"]);
   ...
   * @throws ApiException if the response code was not in [200, 299]
   */
   public async getOAuth2ClientCredentials(response: ResponseContext): Promise<WebhooksOAuth2ClientCredentialsResponse> {
    const contentType = ObjectSerializer.normalizeMediaType(response.headers["content-type"]);
    if (response.httpStatusCode === 200) {
      const body: WebhooksOAuth2ClientCredentialsResponse = ObjectSerializer.deserialize(
        ObjectSerializer.parse(await response.body.text(), contentType),
   ...
   * @throws ApiException if the response code was not in [200, 299]
   */
   public async updateOAuth2ClientCredentials(response: ResponseContext): Promise<WebhooksOAuth2ClientCredentialsResponse> {
    const contentType = ObjectSerializer.normalizeMediaType(response.headers["content-type"]);
    if (response.httpStatusCode === 200) {
      const body: WebhooksOAuth2ClientCredentialsResponse = ObjectSerializer.deserialize(
        ObjectSerializer.parse(await response.body.text(), contentType),
...
export class WebhooksIntegrationApi {
   ...
   */
  public createOAuth2ClientCredentials(param: WebhooksIntegrationApiCreateOAuth2ClientCredentialsRequest, options?: Configuration): Promise<WebhooksOAuth2ClientCredentialsResponse> {
    const requestContextPromise = this.requestFactory.createOAuth2ClientCredentials(param.body,options);
   ...
   * @param param The request object
   */
  public deleteOAuth2ClientCredentials(param: WebhooksIntegrationApiDeleteOAuth2ClientCredentialsRequest, options?: Configuration): Promise<void> {
    const requestContextPromise = this.requestFactory.deleteOAuth2ClientCredentials(param.authMethodId,options);
    return requestContextPromise.then(requestContext => {
        return this.configuration.httpApi.send(requestContext).then(responseContext => {
   ...
   * @param param The request object
   */
  public getAllAuthMethods(param: WebhooksIntegrationApiGetAllAuthMethodsRequest = {}, options?: Configuration): Promise<WebhooksAuthMethodsResponse> {
    const requestContextPromise = this.requestFactory.getAllAuthMethods(param.include,options);
    return requestContextPromise.then(requestContext => {
        return this.configuration.httpApi.send(requestContext).then(responseContext => {
   ...
   * @param param The request object
   */
  public getOAuth2ClientCredentials(param: WebhooksIntegrationApiGetOAuth2ClientCredentialsRequest, options?: Configuration): Promise<WebhooksOAuth2ClientCredentialsResponse> {
    const requestContextPromise = this.requestFactory.getOAuth2ClientCredentials(param.authMethodId,options);
    return requestContextPromise.then(requestContext => {
        return this.configuration.httpApi.send(requestContext).then(responseContext => {
   ...
   * @param param The request object
   */
  public updateOAuth2ClientCredentials(param: WebhooksIntegrationApiUpdateOAuth2ClientCredentialsRequest, options?: Configuration): Promise<WebhooksOAuth2ClientCredentialsResponse> {
    const requestContextPromise = this.requestFactory.updateOAuth2ClientCredentials(param.authMethodId,param.body,options);
    return requestContextPromise.then(requestContext => {
        return this.configuration.httpApi.send(requestContext).then(responseContext => {
