...
export class OktaIntegrationApiRequestFactory extends BaseAPIRequestFactory {
  ...
  public async createOktaAccount(body: OktaAccountRequest,_options?: Configuration): Promise<RequestContext> {
    ...
    const requestContext = _config.getServer('v2.OktaIntegrationApi.createOktaAccount').makeRequestContext(localVarPath, HttpMethod.POST);
  ...
  public async deleteOktaAccount(accountId: string,_options?: Configuration): Promise<RequestContext> {
    const _config = _options || this.configuration;
    ...
    // Path Params
    const localVarPath = '/api/v2/integrations/okta/accounts/{account_id}'
      .replace('{account_id}', encodeURIComponent(String(accountId)));

    // Make Request Context
    const requestContext = _config.getServer('v2.OktaIntegrationApi.deleteOktaAccount').makeRequestContext(localVarPath, HttpMethod.DELETE);
  ...
  public async getOktaAccount(accountId: string,_options?: Configuration): Promise<RequestContext> {
    const _config = _options || this.configuration;
    ...
    // Make Request Context
    const requestContext = _config.getServer('v2.OktaIntegrationApi.getOktaAccount').makeRequestContext(localVarPath, HttpMethod.GET);
    requestContext.setHeaderParam("Accept", "application/json");
    requestContext.setHttpConfig(_config.httpConfig);
  ...
  public async listOktaAccounts(_options?: Configuration): Promise<RequestContext> {
    const _config = _options || this.configuration;
    ...
    // Make Request Context
    const requestContext = _config.getServer('v2.OktaIntegrationApi.listOktaAccounts').makeRequestContext(localVarPath, HttpMethod.GET);
    requestContext.setHeaderParam("Accept", "application/json");
    requestContext.setHttpConfig(_config.httpConfig);
  ...
  public async updateOktaAccount(accountId: string,body: OktaAccountUpdateRequest,_options?: Configuration): Promise<RequestContext> {
    const _config = _options || this.configuration;
    ...
    // Make Request Context
    const requestContext = _config.getServer('v2.OktaIntegrationApi.updateOktaAccount').makeRequestContext(localVarPath, HttpMethod.PATCH);
    requestContext.setHeaderParam("Accept", "application/json");
    requestContext.setHttpConfig(_config.httpConfig);
...
export class OktaIntegrationApiResponseProcessor {
   ...
   */
   public async createOktaAccount(response: ResponseContext): Promise<OktaAccountResponse> {
   ...
   * @throws ApiException if the response code was not in [200, 299]
   */
   public async getOktaAccount(response: ResponseContext): Promise<OktaAccountResponse> {
    const contentType = ObjectSerializer.normalizeMediaType(response.headers["content-type"]);
   ...
   * @throws ApiException if the response code was not in [200, 299]
   */
   public async listOktaAccounts(response: ResponseContext): Promise<OktaAccountsResponse> {
    const contentType = ObjectSerializer.normalizeMediaType(response.headers["content-type"]);
    if (response.httpStatusCode === 200) {
   ...
   * @throws ApiException if the response code was not in [200, 299]
   */
   public async updateOktaAccount(response: ResponseContext): Promise<OktaAccountResponse> {
    const contentType = ObjectSerializer.normalizeMediaType(response.headers["content-type"]);
    if (response.httpStatusCode === 200) {
      const body: OktaAccountResponse = ObjectSerializer.deserialize(
        ObjectSerializer.parse(await response.body.text(), contentType),
...
export class OktaIntegrationApi {
  ...
  public constructor(configuration: Configuration, requestFactory?: OktaIntegrationApiRequestFactory, responseProcessor?: OktaIntegrationApiResponseProcessor) {
    this.configuration = configuration;
    this.requestFactory = requestFactory || new OktaIntegrationApiRequestFactory(configuration);
    this.responseProcessor = responseProcessor || new OktaIntegrationApiResponseProcessor();
  }
   ...
   */
  public createOktaAccount(param: OktaIntegrationApiCreateOktaAccountRequest, options?: Configuration): Promise<OktaAccountResponse> {
   ...
   * @param param The request object
   */
  public deleteOktaAccount(param: OktaIntegrationApiDeleteOktaAccountRequest, options?: Configuration): Promise<void> {
   ...
   * @param param The request object
   */
  public getOktaAccount(param: OktaIntegrationApiGetOktaAccountRequest, options?: Configuration): Promise<OktaAccountResponse> {
   ...
   * @param param The request object
   */
  public listOktaAccounts( options?: Configuration): Promise<OktaAccountsResponse> {
   ...
   * @param param The request object
   */
  public updateOktaAccount(param: OktaIntegrationApiUpdateOktaAccountRequest, options?: Configuration): Promise<OktaAccountResponse> {
