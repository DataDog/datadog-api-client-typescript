...
export class AuthNMappingsApiRequestFactory extends BaseAPIRequestFactory {
  ...
  public async createAuthNMapping(body: AuthNMappingCreateRequest,_options?: Configuration): Promise<RequestContext> {
    ...
    if (body === null || body === undefined) {
      throw new RequiredError('Required parameter body was null or undefined when calling createAuthNMapping.');
    }
    ...
    const requestContext = getServer(_config, 'AuthNMappingsApi.createAuthNMapping').makeRequestContext(localVarPath, HttpMethod.POST);
  ...
  public async deleteAuthNMapping(authnMappingId: string,_options?: Configuration): Promise<RequestContext> {
    ...
    if (authnMappingId === null || authnMappingId === undefined) {
      throw new RequiredError('Required parameter authnMappingId was null or undefined when calling deleteAuthNMapping.');
    }
    ...
    // Make Request Context
    const requestContext = getServer(_config, 'AuthNMappingsApi.deleteAuthNMapping').makeRequestContext(localVarPath, HttpMethod.DELETE);
  ...
  public async getAuthNMapping(authnMappingId: string,_options?: Configuration): Promise<RequestContext> {
    ...
    // verify required parameter 'authnMappingId' is not null or undefined
    if (authnMappingId === null || authnMappingId === undefined) {
      throw new RequiredError('Required parameter authnMappingId was null or undefined when calling getAuthNMapping.');
    }
    ...
    // Make Request Context
    const requestContext = getServer(_config, 'AuthNMappingsApi.getAuthNMapping').makeRequestContext(localVarPath, HttpMethod.GET);
    requestContext.setHeaderParam("Accept", "application/json");
    requestContext.setHttpConfig(_config.httpConfig);
  ...
  public async listAuthNMappings(pageSize?: number,pageNumber?: number,sort?: AuthNMappingsSort,include?: Array<string>,filter?: string,_options?: Configuration): Promise<RequestContext> {
    const _config = _options || this.configuration;
    ...
    // Make Request Context
    const requestContext = getServer(_config, 'AuthNMappingsApi.listAuthNMappings').makeRequestContext(localVarPath, HttpMethod.GET);
    requestContext.setHeaderParam("Accept", "application/json");
    requestContext.setHttpConfig(_config.httpConfig);
  ...
  public async updateAuthNMapping(authnMappingId: string,body: AuthNMappingUpdateRequest,_options?: Configuration): Promise<RequestContext> {
    ...
    // verify required parameter 'authnMappingId' is not null or undefined
    if (authnMappingId === null || authnMappingId === undefined) {
      throw new RequiredError('Required parameter authnMappingId was null or undefined when calling updateAuthNMapping.');
    }

    // verify required parameter 'body' is not null or undefined
    if (body === null || body === undefined) {
      throw new RequiredError('Required parameter body was null or undefined when calling updateAuthNMapping.');
    }
    ...
    // Make Request Context
    const requestContext = getServer(_config, 'AuthNMappingsApi.updateAuthNMapping').makeRequestContext(localVarPath, HttpMethod.PATCH);
    requestContext.setHeaderParam("Accept", "application/json");
    requestContext.setHttpConfig(_config.httpConfig);
...
export class AuthNMappingsApi {
  ...
  public listAuthNMappings(param: AuthNMappingsApiListAuthNMappingsRequest = {}, options?: Configuration): Promise<AuthNMappingsResponse> {
    const requestContextPromise = this.requestFactory.listAuthNMappings(param.pageSize,param.pageNumber,param.sort,param.include,param.filter,options);
    return requestContextPromise.then(requestContext => {
        return this.configuration.httpApi.send(requestContext).then(responseContext => {
