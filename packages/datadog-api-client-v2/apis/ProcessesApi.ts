...
export class ProcessesApiRequestFactory extends BaseAPIRequestFactory {
  ...
  public async listProcesses(search?: string,tags?: string,from?: number,to?: number,pageLimit?: number,pageCursor?: string,_options?: Configuration): Promise<RequestContext> {
    ...
    const requestContext = _config.getServer('v2.ProcessesApi.listProcesses').makeRequestContext(localVarPath, HttpMethod.GET);
...
export class ProcessesApi {
   ...
   */
  public async *listProcessesWithPagination(param: ProcessesApiListProcessesRequest = {}, options?: Configuration): AsyncGenerator<ProcessSummary> {
