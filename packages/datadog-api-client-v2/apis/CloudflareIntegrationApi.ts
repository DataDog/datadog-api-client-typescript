...
export class CloudflareIntegrationApiRequestFactory extends BaseAPIRequestFactory {
  ...
  public async createCloudflareAccount(body: CloudflareAccountCreateRequest,_options?: Configuration): Promise<RequestContext> {
    ...
    const requestContext = _config.getServer('v2.CloudflareIntegrationApi.createCloudflareAccount').makeRequestContext(localVarPath, HttpMethod.POST);
  ...
  public async deleteCloudflareAccount(accountId: string,_options?: Configuration): Promise<RequestContext> {
    const _config = _options || this.configuration;
    ...
    // Path Params
    const localVarPath = '/api/v2/integrations/cloudflare/accounts/{account_id}'
      .replace('{account_id}', encodeURIComponent(String(accountId)));

    // Make Request Context
    const requestContext = _config.getServer('v2.CloudflareIntegrationApi.deleteCloudflareAccount').makeRequestContext(localVarPath, HttpMethod.DELETE);
  ...
  public async getCloudflareAccount(accountId: string,_options?: Configuration): Promise<RequestContext> {
    const _config = _options || this.configuration;
    ...
    // Make Request Context
    const requestContext = _config.getServer('v2.CloudflareIntegrationApi.getCloudflareAccount').makeRequestContext(localVarPath, HttpMethod.GET);
    requestContext.setHeaderParam("Accept", "application/json");
    requestContext.setHttpConfig(_config.httpConfig);
  ...
  public async listCloudflareAccounts(_options?: Configuration): Promise<RequestContext> {
    const _config = _options || this.configuration;
    ...
    // Make Request Context
    const requestContext = _config.getServer('v2.CloudflareIntegrationApi.listCloudflareAccounts').makeRequestContext(localVarPath, HttpMethod.GET);
    requestContext.setHeaderParam("Accept", "application/json");
    requestContext.setHttpConfig(_config.httpConfig);
  ...
  public async updateCloudflareAccount(accountId: string,body: CloudflareAccountUpdateRequest,_options?: Configuration): Promise<RequestContext> {
    const _config = _options || this.configuration;
    ...
    // Make Request Context
    const requestContext = _config.getServer('v2.CloudflareIntegrationApi.updateCloudflareAccount').makeRequestContext(localVarPath, HttpMethod.PATCH);
    requestContext.setHeaderParam("Accept", "application/json");
    requestContext.setHttpConfig(_config.httpConfig);
...
export class CloudflareIntegrationApiResponseProcessor {
   ...
   */
   public async createCloudflareAccount(response: ResponseContext): Promise<CloudflareAccountResponse> {
   ...
   * @throws ApiException if the response code was not in [200, 299]
   */
   public async deleteCloudflareAccount(response: ResponseContext): Promise<void> {
    const contentType = ObjectSerializer.normalizeMediaType(response.headers["content-type"]);
   ...
   * @throws ApiException if the response code was not in [200, 299]
   */
   public async getCloudflareAccount(response: ResponseContext): Promise<CloudflareAccountResponse> {
    const contentType = ObjectSerializer.normalizeMediaType(response.headers["content-type"]);
   ...
   * @throws ApiException if the response code was not in [200, 299]
   */
   public async listCloudflareAccounts(response: ResponseContext): Promise<CloudflareAccountsResponse> {
    const contentType = ObjectSerializer.normalizeMediaType(response.headers["content-type"]);
    if (response.httpStatusCode === 200) {
   ...
   * @throws ApiException if the response code was not in [200, 299]
   */
   public async updateCloudflareAccount(response: ResponseContext): Promise<CloudflareAccountResponse> {
    const contentType = ObjectSerializer.normalizeMediaType(response.headers["content-type"]);
    if (response.httpStatusCode === 200) {
      const body: CloudflareAccountResponse = ObjectSerializer.deserialize(
        ObjectSerializer.parse(await response.body.text(), contentType),
...
export class CloudflareIntegrationApi {
  ...
  public constructor(configuration: Configuration, requestFactory?: CloudflareIntegrationApiRequestFactory, responseProcessor?: CloudflareIntegrationApiResponseProcessor) {
    this.configuration = configuration;
    this.requestFactory = requestFactory || new CloudflareIntegrationApiRequestFactory(configuration);
    this.responseProcessor = responseProcessor || new CloudflareIntegrationApiResponseProcessor();
  }
   ...
   */
  public createCloudflareAccount(param: CloudflareIntegrationApiCreateCloudflareAccountRequest, options?: Configuration): Promise<CloudflareAccountResponse> {
   ...
   * @param param The request object
   */
  public deleteCloudflareAccount(param: CloudflareIntegrationApiDeleteCloudflareAccountRequest, options?: Configuration): Promise<void> {
   ...
   * @param param The request object
   */
  public getCloudflareAccount(param: CloudflareIntegrationApiGetCloudflareAccountRequest, options?: Configuration): Promise<CloudflareAccountResponse> {
   ...
   * @param param The request object
   */
  public listCloudflareAccounts( options?: Configuration): Promise<CloudflareAccountsResponse> {
   ...
   * @param param The request object
   */
  public updateCloudflareAccount(param: CloudflareIntegrationApiUpdateCloudflareAccountRequest, options?: Configuration): Promise<CloudflareAccountResponse> {
