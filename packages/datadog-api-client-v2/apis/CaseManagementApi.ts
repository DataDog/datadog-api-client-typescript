...
export class CaseManagementApiRequestFactory extends BaseAPIRequestFactory {
  ...
  public async favoriteProject(
    ...
    logger.warn("Using unstable operation 'favoriteProject'");
    if (!_config.unstableOperations["v2.favoriteProject"]) {
      throw new Error("Unstable operation 'favoriteProject' is disabled");
    }
    ...
    // Make Request Context
    const requestContext = _config
      .getServer("v2.CaseManagementApi.favoriteProject")
      .makeRequestContext(localVarPath, HttpMethod.POST);
    requestContext.setHeaderParam("Accept", "*/*");
    requestContext.setHttpConfig(_config.httpConfig);
  ...
  public async listUserProjectFavorites(
    ...
    logger.warn("Using unstable operation 'listUserProjectFavorites'");
    if (!_config.unstableOperations["v2.listUserProjectFavorites"]) {
      throw new Error(
        "Unstable operation 'listUserProjectFavorites' is disabled"
      );
    }
    ...
    // Make Request Context
    const requestContext = _config
      .getServer("v2.CaseManagementApi.listUserProjectFavorites")
      .makeRequestContext(localVarPath, HttpMethod.GET);
    requestContext.setHeaderParam("Accept", "application/json");
    requestContext.setHttpConfig(_config.httpConfig);
  ...
  public async unfavoriteProject(
    ...
    logger.warn("Using unstable operation 'unfavoriteProject'");
    if (!_config.unstableOperations["v2.unfavoriteProject"]) {
      throw new Error("Unstable operation 'unfavoriteProject' is disabled");
    }
    ...
    // Make Request Context
    const requestContext = _config
      .getServer("v2.CaseManagementApi.unfavoriteProject")
      .makeRequestContext(localVarPath, HttpMethod.DELETE);
    requestContext.setHeaderParam("Accept", "*/*");
    requestContext.setHttpConfig(_config.httpConfig);
