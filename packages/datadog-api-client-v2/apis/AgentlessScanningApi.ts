...
export class AgentlessScanningApiRequestFactory extends BaseAPIRequestFactory {
  ...
  public async createAwsOnDemandTask(body: AwsOnDemandCreateRequest,_options?: Configuration): Promise<RequestContext> {
    ...
    const requestContext = _config.getServer('v2.AgentlessScanningApi.createAwsOnDemandTask').makeRequestContext(localVarPath, HttpMethod.POST);
  ...
  public async createAwsScanOptions(body: AwsScanOptionsCreateRequest,_options?: Configuration): Promise<RequestContext> {
    const _config = _options || this.configuration;
    ...
    // Make Request Context
    const requestContext = _config.getServer('v2.AgentlessScanningApi.createAwsScanOptions').makeRequestContext(localVarPath, HttpMethod.POST);
    requestContext.setHeaderParam("Accept", "application/json");
    requestContext.setHttpConfig(_config.httpConfig);
  ...
  public async createAzureScanOptions(body: AzureScanOptions,_options?: Configuration): Promise<RequestContext> {
    const _config = _options || this.configuration;
    ...
    // Make Request Context
    const requestContext = _config.getServer('v2.AgentlessScanningApi.createAzureScanOptions').makeRequestContext(localVarPath, HttpMethod.POST);
    requestContext.setHeaderParam("Accept", "application/json");
    requestContext.setHttpConfig(_config.httpConfig);
  ...
  public async createGcpScanOptions(body: GcpScanOptions,_options?: Configuration): Promise<RequestContext> {
    const _config = _options || this.configuration;
    ...
    // Make Request Context
    const requestContext = _config.getServer('v2.AgentlessScanningApi.createGcpScanOptions').makeRequestContext(localVarPath, HttpMethod.POST);
    requestContext.setHeaderParam("Accept", "application/json");
    requestContext.setHttpConfig(_config.httpConfig);
  ...
  public async deleteAwsScanOptions(accountId: string,_options?: Configuration): Promise<RequestContext> {
    const _config = _options || this.configuration;
    ...
    // Path Params
    const localVarPath = '/api/v2/agentless_scanning/accounts/aws/{account_id}'
      .replace('{account_id}', encodeURIComponent(String(accountId)));

    // Make Request Context
    const requestContext = _config.getServer('v2.AgentlessScanningApi.deleteAwsScanOptions').makeRequestContext(localVarPath, HttpMethod.DELETE);
  ...
  public async deleteAzureScanOptions(subscriptionId: string,_options?: Configuration): Promise<RequestContext> {
    const _config = _options || this.configuration;
    ...
    // Path Params
    const localVarPath = '/api/v2/agentless_scanning/accounts/azure/{subscription_id}'
      .replace('{subscription_id}', encodeURIComponent(String(subscriptionId)));

    // Make Request Context
    const requestContext = _config.getServer('v2.AgentlessScanningApi.deleteAzureScanOptions').makeRequestContext(localVarPath, HttpMethod.DELETE);
    requestContext.setHeaderParam("Accept", "*/*");
    requestContext.setHttpConfig(_config.httpConfig);
  ...
  public async deleteGcpScanOptions(projectId: string,_options?: Configuration): Promise<RequestContext> {
    const _config = _options || this.configuration;
    ...
    // Path Params
    const localVarPath = '/api/v2/agentless_scanning/accounts/gcp/{project_id}'
      .replace('{project_id}', encodeURIComponent(String(projectId)));

    // Make Request Context
    const requestContext = _config.getServer('v2.AgentlessScanningApi.deleteGcpScanOptions').makeRequestContext(localVarPath, HttpMethod.DELETE);
    requestContext.setHeaderParam("Accept", "*/*");
    requestContext.setHttpConfig(_config.httpConfig);
  ...
  public async getAwsOnDemandTask(taskId: string,_options?: Configuration): Promise<RequestContext> {
    const _config = _options || this.configuration;
    ...
    // Path Params
    const localVarPath = '/api/v2/agentless_scanning/ondemand/aws/{task_id}'
      .replace('{task_id}', encodeURIComponent(String(taskId)));

    // Make Request Context
    const requestContext = _config.getServer('v2.AgentlessScanningApi.getAwsOnDemandTask').makeRequestContext(localVarPath, HttpMethod.GET);
    requestContext.setHeaderParam("Accept", "application/json");
    requestContext.setHttpConfig(_config.httpConfig);
  ...
  public async getAwsScanOptions(accountId: string,_options?: Configuration): Promise<RequestContext> {
    const _config = _options || this.configuration;
    ...
    // Make Request Context
    const requestContext = _config.getServer('v2.AgentlessScanningApi.getAwsScanOptions').makeRequestContext(localVarPath, HttpMethod.GET);
    requestContext.setHeaderParam("Accept", "application/json");
    requestContext.setHttpConfig(_config.httpConfig);
  ...
  public async getAzureScanOptions(subscriptionId: string,_options?: Configuration): Promise<RequestContext> {
    const _config = _options || this.configuration;
    ...
    // Make Request Context
    const requestContext = _config.getServer('v2.AgentlessScanningApi.getAzureScanOptions').makeRequestContext(localVarPath, HttpMethod.GET);
    requestContext.setHeaderParam("Accept", "application/json");
    requestContext.setHttpConfig(_config.httpConfig);
  ...
  public async getGcpScanOptions(projectId: string,_options?: Configuration): Promise<RequestContext> {
    const _config = _options || this.configuration;
    ...
    // Make Request Context
    const requestContext = _config.getServer('v2.AgentlessScanningApi.getGcpScanOptions').makeRequestContext(localVarPath, HttpMethod.GET);
    requestContext.setHeaderParam("Accept", "application/json");
    requestContext.setHttpConfig(_config.httpConfig);
  ...
  public async listAwsOnDemandTasks(_options?: Configuration): Promise<RequestContext> {
    const _config = _options || this.configuration;
    ...
    // Make Request Context
    const requestContext = _config.getServer('v2.AgentlessScanningApi.listAwsOnDemandTasks').makeRequestContext(localVarPath, HttpMethod.GET);
    requestContext.setHeaderParam("Accept", "application/json");
    requestContext.setHttpConfig(_config.httpConfig);
  ...
  public async listAwsScanOptions(_options?: Configuration): Promise<RequestContext> {
    const _config = _options || this.configuration;
    ...
    // Make Request Context
    const requestContext = _config.getServer('v2.AgentlessScanningApi.listAwsScanOptions').makeRequestContext(localVarPath, HttpMethod.GET);
    requestContext.setHeaderParam("Accept", "application/json");
    requestContext.setHttpConfig(_config.httpConfig);
  ...
  public async listAzureScanOptions(_options?: Configuration): Promise<RequestContext> {
    const _config = _options || this.configuration;
    ...
    // Make Request Context
    const requestContext = _config.getServer('v2.AgentlessScanningApi.listAzureScanOptions').makeRequestContext(localVarPath, HttpMethod.GET);
    requestContext.setHeaderParam("Accept", "application/json");
    requestContext.setHttpConfig(_config.httpConfig);
  ...
  public async listGcpScanOptions(_options?: Configuration): Promise<RequestContext> {
    const _config = _options || this.configuration;
    ...
    // Make Request Context
    const requestContext = _config.getServer('v2.AgentlessScanningApi.listGcpScanOptions').makeRequestContext(localVarPath, HttpMethod.GET);
    requestContext.setHeaderParam("Accept", "application/json");
    requestContext.setHttpConfig(_config.httpConfig);
  ...
  public async updateAwsScanOptions(accountId: string,body: AwsScanOptionsUpdateRequest,_options?: Configuration): Promise<RequestContext> {
    const _config = _options || this.configuration;
    ...
    // Make Request Context
    const requestContext = _config.getServer('v2.AgentlessScanningApi.updateAwsScanOptions').makeRequestContext(localVarPath, HttpMethod.PATCH);
    requestContext.setHeaderParam("Accept", "*/*");
    requestContext.setHttpConfig(_config.httpConfig);
  ...
  public async updateAzureScanOptions(subscriptionId: string,body: AzureScanOptionsInputUpdate,_options?: Configuration): Promise<RequestContext> {
    const _config = _options || this.configuration;
    ...
    // Make Request Context
    const requestContext = _config.getServer('v2.AgentlessScanningApi.updateAzureScanOptions').makeRequestContext(localVarPath, HttpMethod.PATCH);
    requestContext.setHeaderParam("Accept", "application/json");
    requestContext.setHttpConfig(_config.httpConfig);
  ...
  public async updateGcpScanOptions(projectId: string,body: GcpScanOptionsInputUpdate,_options?: Configuration): Promise<RequestContext> {
    const _config = _options || this.configuration;
    ...
    // Make Request Context
    const requestContext = _config.getServer('v2.AgentlessScanningApi.updateGcpScanOptions').makeRequestContext(localVarPath, HttpMethod.PATCH);
    requestContext.setHeaderParam("Accept", "application/json");
    requestContext.setHttpConfig(_config.httpConfig);
...
export class AgentlessScanningApiResponseProcessor {
   ...
   */
   public async createAwsOnDemandTask(response: ResponseContext): Promise<AwsOnDemandResponse> {
   ...
   * @throws ApiException if the response code was not in [200, 299]
   */
   public async createAwsScanOptions(response: ResponseContext): Promise<AwsScanOptionsResponse> {
    const contentType = ObjectSerializer.normalizeMediaType(response.headers["content-type"]);
    if (response.httpStatusCode === 201) {
   ...
   * @throws ApiException if the response code was not in [200, 299]
   */
   public async createAzureScanOptions(response: ResponseContext): Promise<AzureScanOptions> {
    const contentType = ObjectSerializer.normalizeMediaType(response.headers["content-type"]);
    if (response.httpStatusCode === 201) {
   ...
   * @throws ApiException if the response code was not in [200, 299]
   */
   public async createGcpScanOptions(response: ResponseContext): Promise<GcpScanOptions> {
    const contentType = ObjectSerializer.normalizeMediaType(response.headers["content-type"]);
    if (response.httpStatusCode === 201) {
   ...
   * @throws ApiException if the response code was not in [200, 299]
   */
   public async deleteAzureScanOptions(response: ResponseContext): Promise<void> {
    const contentType = ObjectSerializer.normalizeMediaType(response.headers["content-type"]);
    if (response.httpStatusCode === 204) {
      return;
    }
   ...
   * @throws ApiException if the response code was not in [200, 299]
   */
   public async getAwsOnDemandTask(response: ResponseContext): Promise<AwsOnDemandResponse> {
    const contentType = ObjectSerializer.normalizeMediaType(response.headers["content-type"]);
   ...
   * @throws ApiException if the response code was not in [200, 299]
   */
   public async getAwsScanOptions(response: ResponseContext): Promise<AwsScanOptionsResponse> {
    const contentType = ObjectSerializer.normalizeMediaType(response.headers["content-type"]);
    if (response.httpStatusCode === 200) {
      const body: AwsScanOptionsResponse = ObjectSerializer.deserialize(
        ObjectSerializer.parse(await response.body.text(), contentType),
   ...
   * @throws ApiException if the response code was not in [200, 299]
   */
   public async getAzureScanOptions(response: ResponseContext): Promise<AzureScanOptions> {
    const contentType = ObjectSerializer.normalizeMediaType(response.headers["content-type"]);
    if (response.httpStatusCode === 200) {
      const body: AzureScanOptions = ObjectSerializer.deserialize(
        ObjectSerializer.parse(await response.body.text(), contentType),
   ...
   * @throws ApiException if the response code was not in [200, 299]
   */
   public async getGcpScanOptions(response: ResponseContext): Promise<GcpScanOptions> {
    const contentType = ObjectSerializer.normalizeMediaType(response.headers["content-type"]);
    if (response.httpStatusCode === 200) {
      const body: GcpScanOptions = ObjectSerializer.deserialize(
        ObjectSerializer.parse(await response.body.text(), contentType),
   ...
   * @throws ApiException if the response code was not in [200, 299]
   */
   public async listAwsOnDemandTasks(response: ResponseContext): Promise<AwsOnDemandListResponse> {
    const contentType = ObjectSerializer.normalizeMediaType(response.headers["content-type"]);
    if (response.httpStatusCode === 200) {
   ...
   * @throws ApiException if the response code was not in [200, 299]
   */
   public async listAwsScanOptions(response: ResponseContext): Promise<AwsScanOptionsListResponse> {
    const contentType = ObjectSerializer.normalizeMediaType(response.headers["content-type"]);
    if (response.httpStatusCode === 200) {
   ...
   * @throws ApiException if the response code was not in [200, 299]
   */
   public async listAzureScanOptions(response: ResponseContext): Promise<AzureScanOptionsArray> {
    const contentType = ObjectSerializer.normalizeMediaType(response.headers["content-type"]);
    if (response.httpStatusCode === 200) {
   ...
   * @throws ApiException if the response code was not in [200, 299]
   */
   public async listGcpScanOptions(response: ResponseContext): Promise<GcpScanOptionsArray> {
    const contentType = ObjectSerializer.normalizeMediaType(response.headers["content-type"]);
    if (response.httpStatusCode === 200) {
   ...
   * @throws ApiException if the response code was not in [200, 299]
   */
   public async updateAzureScanOptions(response: ResponseContext): Promise<AzureScanOptions> {
    const contentType = ObjectSerializer.normalizeMediaType(response.headers["content-type"]);
    if (response.httpStatusCode === 200) {
      const body: AzureScanOptions = ObjectSerializer.deserialize(
        ObjectSerializer.parse(await response.body.text(), contentType),
   ...
   * @throws ApiException if the response code was not in [200, 299]
   */
   public async updateGcpScanOptions(response: ResponseContext): Promise<GcpScanOptions> {
    const contentType = ObjectSerializer.normalizeMediaType(response.headers["content-type"]);
    if (response.httpStatusCode === 200) {
      const body: GcpScanOptions = ObjectSerializer.deserialize(
        ObjectSerializer.parse(await response.body.text(), contentType),
...
export class AgentlessScanningApi {
  ...
  public constructor(configuration: Configuration, requestFactory?: AgentlessScanningApiRequestFactory, responseProcessor?: AgentlessScanningApiResponseProcessor) {
    this.configuration = configuration;
    this.requestFactory = requestFactory || new AgentlessScanningApiRequestFactory(configuration);
    this.responseProcessor = responseProcessor || new AgentlessScanningApiResponseProcessor();
  }
   ...
   */
  public createAwsOnDemandTask(param: AgentlessScanningApiCreateAwsOnDemandTaskRequest, options?: Configuration): Promise<AwsOnDemandResponse> {
   ...
   * @param param The request object
   */
  public createAwsScanOptions(param: AgentlessScanningApiCreateAwsScanOptionsRequest, options?: Configuration): Promise<AwsScanOptionsResponse> {
   ...
   * @param param The request object
   */
  public createAzureScanOptions(param: AgentlessScanningApiCreateAzureScanOptionsRequest, options?: Configuration): Promise<AzureScanOptions> {
   ...
   * @param param The request object
   */
  public createGcpScanOptions(param: AgentlessScanningApiCreateGcpScanOptionsRequest, options?: Configuration): Promise<GcpScanOptions> {
   ...
   * @param param The request object
   */
  public deleteAwsScanOptions(param: AgentlessScanningApiDeleteAwsScanOptionsRequest, options?: Configuration): Promise<void> {
   ...
   * @param param The request object
   */
  public deleteAzureScanOptions(param: AgentlessScanningApiDeleteAzureScanOptionsRequest, options?: Configuration): Promise<void> {
   ...
   * @param param The request object
   */
  public deleteGcpScanOptions(param: AgentlessScanningApiDeleteGcpScanOptionsRequest, options?: Configuration): Promise<void> {
   ...
   * @param param The request object
   */
  public getAwsOnDemandTask(param: AgentlessScanningApiGetAwsOnDemandTaskRequest, options?: Configuration): Promise<AwsOnDemandResponse> {
   ...
   * @param param The request object
   */
  public getAwsScanOptions(param: AgentlessScanningApiGetAwsScanOptionsRequest, options?: Configuration): Promise<AwsScanOptionsResponse> {
   ...
   * @param param The request object
   */
  public getAzureScanOptions(param: AgentlessScanningApiGetAzureScanOptionsRequest, options?: Configuration): Promise<AzureScanOptions> {
   ...
   * @param param The request object
   */
  public getGcpScanOptions(param: AgentlessScanningApiGetGcpScanOptionsRequest, options?: Configuration): Promise<GcpScanOptions> {
   ...
   * @param param The request object
   */
  public listAwsOnDemandTasks( options?: Configuration): Promise<AwsOnDemandListResponse> {
   ...
   * @param param The request object
   */
  public listAwsScanOptions( options?: Configuration): Promise<AwsScanOptionsListResponse> {
   ...
   * @param param The request object
   */
  public listAzureScanOptions( options?: Configuration): Promise<AzureScanOptionsArray> {
   ...
   * @param param The request object
   */
  public listGcpScanOptions( options?: Configuration): Promise<GcpScanOptionsArray> {
   ...
   * @param param The request object
   */
  public updateAwsScanOptions(param: AgentlessScanningApiUpdateAwsScanOptionsRequest, options?: Configuration): Promise<void> {
   ...
   * @param param The request object
   */
  public updateAzureScanOptions(param: AgentlessScanningApiUpdateAzureScanOptionsRequest, options?: Configuration): Promise<AzureScanOptions> {
   ...
   * @param param The request object
   */
  public updateGcpScanOptions(param: AgentlessScanningApiUpdateGcpScanOptionsRequest, options?: Configuration): Promise<GcpScanOptions> {
