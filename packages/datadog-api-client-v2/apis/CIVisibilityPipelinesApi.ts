...
export class CIVisibilityPipelinesApiRequestFactory extends BaseAPIRequestFactory {
  ...
  public async aggregateCIAppPipelineEvents(body: CIAppPipelinesAggregateRequest,_options?: Configuration): Promise<RequestContext> {
    ...
    const requestContext = _config.getServer('v2.CIVisibilityPipelinesApi.aggregateCIAppPipelineEvents').makeRequestContext(localVarPath, HttpMethod.POST);
  ...
  public async createCIAppPipelineEvent(body: CIAppCreatePipelineEventRequest,_options?: Configuration): Promise<RequestContext> {
    const _config = _options || this.configuration;
    ...
    // Make Request Context
    const requestContext = _config.getServer('v2.CIVisibilityPipelinesApi.createCIAppPipelineEvent').makeRequestContext(localVarPath, HttpMethod.POST);
    requestContext.setHeaderParam("Accept", "application/json");
    requestContext.setHttpConfig(_config.httpConfig);
  ...
  public async listCIAppPipelineEvents(filterQuery?: string,filterFrom?: Date,filterTo?: Date,sort?: CIAppSort,pageCursor?: string,pageLimit?: number,_options?: Configuration): Promise<RequestContext> {
    const _config = _options || this.configuration;
    ...
    // Make Request Context
    const requestContext = _config.getServer('v2.CIVisibilityPipelinesApi.listCIAppPipelineEvents').makeRequestContext(localVarPath, HttpMethod.GET);
    requestContext.setHeaderParam("Accept", "application/json");
    requestContext.setHttpConfig(_config.httpConfig);
    ...
    if (sort !== undefined) {
      requestContext.setQueryParam("sort", ObjectSerializer.serialize(sort, "CIAppSort", ""), "");
    }
  ...
  public async searchCIAppPipelineEvents(body?: CIAppPipelineEventsRequest,_options?: Configuration): Promise<RequestContext> {
    const _config = _options || this.configuration;
    ...
    // Make Request Context
    const requestContext = _config.getServer('v2.CIVisibilityPipelinesApi.searchCIAppPipelineEvents').makeRequestContext(localVarPath, HttpMethod.POST);
    requestContext.setHeaderParam("Accept", "application/json");
    requestContext.setHttpConfig(_config.httpConfig);
...
export class CIVisibilityPipelinesApiResponseProcessor {
   ...
   */
   public async aggregateCIAppPipelineEvents(response: ResponseContext): Promise<CIAppPipelinesAnalyticsAggregateResponse> {
   ...
   * @throws ApiException if the response code was not in [200, 299]
   */
   public async createCIAppPipelineEvent(response: ResponseContext): Promise<any> {
    const contentType = ObjectSerializer.normalizeMediaType(response.headers["content-type"]);
    ...
    if (response.httpStatusCode === 400||response.httpStatusCode === 401||response.httpStatusCode === 403||response.httpStatusCode === 408||response.httpStatusCode === 413||response.httpStatusCode === 429||response.httpStatusCode === 500||response.httpStatusCode === 503) {
      const bodyText = ObjectSerializer.parse(await response.body.text(), contentType);
   ...
   * @throws ApiException if the response code was not in [200, 299]
   */
   public async listCIAppPipelineEvents(response: ResponseContext): Promise<CIAppPipelineEventsResponse> {
    const contentType = ObjectSerializer.normalizeMediaType(response.headers["content-type"]);
    if (response.httpStatusCode === 200) {
   ...
   * @throws ApiException if the response code was not in [200, 299]
   */
   public async searchCIAppPipelineEvents(response: ResponseContext): Promise<CIAppPipelineEventsResponse> {
    const contentType = ObjectSerializer.normalizeMediaType(response.headers["content-type"]);
    if (response.httpStatusCode === 200) {
      const body: CIAppPipelineEventsResponse = ObjectSerializer.deserialize(
        ObjectSerializer.parse(await response.body.text(), contentType),
...
export class CIVisibilityPipelinesApi {
  ...
  public constructor(configuration: Configuration, requestFactory?: CIVisibilityPipelinesApiRequestFactory, responseProcessor?: CIVisibilityPipelinesApiResponseProcessor) {
    this.configuration = configuration;
    this.requestFactory = requestFactory || new CIVisibilityPipelinesApiRequestFactory(configuration);
    this.responseProcessor = responseProcessor || new CIVisibilityPipelinesApiResponseProcessor();
  }
   ...
   */
  public aggregateCIAppPipelineEvents(param: CIVisibilityPipelinesApiAggregateCIAppPipelineEventsRequest, options?: Configuration): Promise<CIAppPipelinesAnalyticsAggregateResponse> {
   ...
   * @param param The request object
   */
  public createCIAppPipelineEvent(param: CIVisibilityPipelinesApiCreateCIAppPipelineEventRequest, options?: Configuration): Promise<any> {
   ...
   * @param param The request object
   */
  public listCIAppPipelineEvents(param: CIVisibilityPipelinesApiListCIAppPipelineEventsRequest = {}, options?: Configuration): Promise<CIAppPipelineEventsResponse> {
   ...
   */
  public async *listCIAppPipelineEventsWithPagination(param: CIVisibilityPipelinesApiListCIAppPipelineEventsRequest = {}, options?: Configuration): AsyncGenerator<CIAppPipelineEvent> {
   ...
   * @param param The request object
   */
  public searchCIAppPipelineEvents(param: CIVisibilityPipelinesApiSearchCIAppPipelineEventsRequest = {}, options?: Configuration): Promise<CIAppPipelineEventsResponse> {
   ...
   */
  public async *searchCIAppPipelineEventsWithPagination(param: CIVisibilityPipelinesApiSearchCIAppPipelineEventsRequest = {}, options?: Configuration): AsyncGenerator<CIAppPipelineEvent> {
