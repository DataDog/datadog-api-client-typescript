...
export class OrgAuthorizedClientsApiRequestFactory extends BaseAPIRequestFactory {
  ...
  public async listOrgAuthorizedClients(
    ...
    if (filterOauth2ClientName !== undefined) {
      requestContext.setQueryParam(
        ...
        ObjectSerializer.serialize(filterOauth2ClientName, "string", ""),
        ""
      );
    }
  ...
  public async listOrgAuthorizedClientUserAuthorizations(
    ...
    if (filterUserEmail !== undefined) {
      requestContext.setQueryParam(
        "filter[user][email]",
        ObjectSerializer.serialize(filterUserEmail, "string", ""),
        ""
      );
    }
    if (filterUserDisabled !== undefined) {
      requestContext.setQueryParam(
        "filter[user][disabled]",
        ObjectSerializer.serialize(filterUserDisabled, "string", ""),
        ""
      );
    }
...
export class OrgAuthorizedClientsApi {
  ...
  public constructor(
    ...
    requestFactory?: OrgAuthorizedClientsApiRequestFactory,
    responseProcessor?: OrgAuthorizedClientsApiResponseProcessor
  ) {
   ...
   */
  public deleteOrgAuthorizedClient(
    param: OrgAuthorizedClientsApiDeleteOrgAuthorizedClientRequest,
    options?: Configuration
  ): Promise<void> {
    const requestContextPromise = this.requestFactory.deleteOrgAuthorizedClient(
   ...
   * @param param The request object
   */
  public deleteOrgAuthorizedClientAllUserAuthorizations(
   ...
   * @param param The request object
   */
  public deleteOrgAuthorizedClientUserAuthorization(
   ...
   * @param param The request object
   */
  public getOrgAuthorizedClient(
    param: OrgAuthorizedClientsApiGetOrgAuthorizedClientRequest,
    options?: Configuration
  ): Promise<OrgAuthorizedClientResponse> {
    const requestContextPromise = this.requestFactory.getOrgAuthorizedClient(
      param.orgAuthorizedClientId,
      param.include,
      param.filterUserAuthorizedClientsDisabled,
      param.filterUserAuthorizedClientsUserDisabled,
      options
    );
    return requestContextPromise.then((requestContext) => {
      return this.configuration.httpApi
   ...
   * @param param The request object
   */
  public listOrgAuthorizedClients(
    param: OrgAuthorizedClientsApiListOrgAuthorizedClientsRequest = {},
    options?: Configuration
  ): Promise<OrgAuthorizedClientsResponse> {
    const requestContextPromise = this.requestFactory.listOrgAuthorizedClients(
      param.pageSize,
      param.pageNumber,
      param.sort,
      param.filter,
  ...
  public async *listOrgAuthorizedClientsWithPagination(
    ...
    while (true) {
      ...
      const response = await this.responseProcessor.listOrgAuthorizedClients(
        responseContext
      );
   ...
   * @param param The request object
   */
  public listOrgAuthorizedClientUserAuthorizations(
   ...
   * @param param The request object
   */
  public updateOrgAuthorizedClient(
    param: OrgAuthorizedClientsApiUpdateOrgAuthorizedClientRequest,
    options?: Configuration
  ): Promise<OrgAuthorizedClientResponse> {
    const requestContextPromise = this.requestFactory.updateOrgAuthorizedClient(
      param.orgAuthorizedClientId,
      param.body,
      options
    );
