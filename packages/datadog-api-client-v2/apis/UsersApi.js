...
var UsersApiRequestFactory = /** @class */ (function (_super) {
     ...
     * @param body
     */
    UsersApiRequestFactory.prototype.createUser = function (body, options) {
            ...
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0:
                        ...
                        requestContext = configuration_1.getServer(config, 'UsersApi.createUser').makeRequestContext(localVarPath, http_1.HttpMethod.POST);
     ...
     */
    UsersApiRequestFactory.prototype.disableUser = function (userId, options) {
        return __awaiter(this, void 0, void 0, function () {
            ...
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0:
                        ...
                        localVarPath = '/api/v2/users/{user_id}'
                            .replace('{' + 'user_id' + '}', encodeURIComponent(String(userId)));
                        requestContext = configuration_1.getServer(config, 'UsersApi.disableUser').makeRequestContext(localVarPath, http_1.HttpMethod.DELETE);
                        requestContext.setHeaderParam("Accept", "application/json, */*;q=0.8");
                        requestContext.setHttpConfig(config.httpConfig);
                        authMethod = null;
                        // Apply auth methods
     ...
     */
    UsersApiRequestFactory.prototype.getInvitation = function (userInvitationUuid, options) {
        return __awaiter(this, void 0, void 0, function () {
            var config, localVarPath, requestContext, authMethod;
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0:
                        ...
                        localVarPath = '/api/v2/user_invitations/{user_invitation_uuid}'
                            .replace('{' + 'user_invitation_uuid' + '}', encodeURIComponent(String(userInvitationUuid)));
                        requestContext = configuration_1.getServer(config, 'UsersApi.getInvitation').makeRequestContext(localVarPath, http_1.HttpMethod.GET);
                        requestContext.setHeaderParam("Accept", "application/json, */*;q=0.8");
                        requestContext.setHttpConfig(config.httpConfig);
                        authMethod = null;
                        // Apply auth methods
     ...
     * @param userId The ID of the user.
     */
    UsersApiRequestFactory.prototype.getUser = function (userId, options) {
        return __awaiter(this, void 0, void 0, function () {
            var config, localVarPath, requestContext, authMethod;
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0:
                        ...
                        localVarPath = '/api/v2/users/{user_id}'
                            .replace('{' + 'user_id' + '}', encodeURIComponent(String(userId)));
                        requestContext = configuration_1.getServer(config, 'UsersApi.getUser').makeRequestContext(localVarPath, http_1.HttpMethod.GET);
                        requestContext.setHeaderParam("Accept", "application/json, */*;q=0.8");
                        requestContext.setHttpConfig(config.httpConfig);
                        authMethod = null;
                        // Apply auth methods
     ...
     * @param userId The ID of the user.
     */
    UsersApiRequestFactory.prototype.listUserOrganizations = function (userId, options) {
        return __awaiter(this, void 0, void 0, function () {
            var config, localVarPath, requestContext, authMethod;
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0:
                        ...
                        localVarPath = '/api/v2/users/{user_id}/orgs'
                            .replace('{' + 'user_id' + '}', encodeURIComponent(String(userId)));
                        requestContext = configuration_1.getServer(config, 'UsersApi.listUserOrganizations').makeRequestContext(localVarPath, http_1.HttpMethod.GET);
                        requestContext.setHeaderParam("Accept", "application/json, */*;q=0.8");
                        requestContext.setHttpConfig(config.httpConfig);
                        authMethod = null;
                        // Apply auth methods
     ...
     * @param userId The ID of the user.
     */
    UsersApiRequestFactory.prototype.listUserPermissions = function (userId, options) {
        return __awaiter(this, void 0, void 0, function () {
            var config, localVarPath, requestContext, authMethod;
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0:
                        ...
                        localVarPath = '/api/v2/users/{user_id}/permissions'
                            .replace('{' + 'user_id' + '}', encodeURIComponent(String(userId)));
                        requestContext = configuration_1.getServer(config, 'UsersApi.listUserPermissions').makeRequestContext(localVarPath, http_1.HttpMethod.GET);
                        requestContext.setHeaderParam("Accept", "application/json, */*;q=0.8");
                        requestContext.setHttpConfig(config.httpConfig);
                        authMethod = null;
                        // Apply auth methods
     ...
     */
    UsersApiRequestFactory.prototype.listUsers = function (pageSize, pageNumber, sort, sortDir, filter, filterStatus, options) {
        return __awaiter(this, void 0, void 0, function () {
            var config, localVarPath, requestContext, authMethod;
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0:
                        config = options || this.configuration;
                        localVarPath = '/api/v2/users';
                        requestContext = configuration_1.getServer(config, 'UsersApi.listUsers').makeRequestContext(localVarPath, http_1.HttpMethod.GET);
                        requestContext.setHeaderParam("Accept", "application/json, */*;q=0.8");
                        requestContext.setHttpConfig(config.httpConfig);
                        // Query Params
     ...
     * @param body
     */
    UsersApiRequestFactory.prototype.sendInvitations = function (body, options) {
        return __awaiter(this, void 0, void 0, function () {
            var config, localVarPath, requestContext, contentType, serializedBody, authMethod;
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0:
                        ...
                        requestContext = configuration_1.getServer(config, 'UsersApi.sendInvitations').makeRequestContext(localVarPath, http_1.HttpMethod.POST);
                        requestContext.setHeaderParam("Accept", "application/json, */*;q=0.8");
                        requestContext.setHttpConfig(config.httpConfig);
                        contentType = ObjectSerializer_1.ObjectSerializer.getPreferredMediaType([
                            "application/json"
     ...
     * @param body
     */
    UsersApiRequestFactory.prototype.updateUser = function (userId, body, options) {
        return __awaiter(this, void 0, void 0, function () {
            var config, localVarPath, requestContext, contentType, serializedBody, authMethod;
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0:
                        ...
                        localVarPath = '/api/v2/users/{user_id}'
                            .replace('{' + 'user_id' + '}', encodeURIComponent(String(userId)));
                        requestContext = configuration_1.getServer(config, 'UsersApi.updateUser').makeRequestContext(localVarPath, http_1.HttpMethod.PATCH);
                        requestContext.setHeaderParam("Accept", "application/json, */*;q=0.8");
                        requestContext.setHttpConfig(config.httpConfig);
                        contentType = ObjectSerializer_1.ObjectSerializer.getPreferredMediaType([
                            "application/json"
        ...
        return __awaiter(this, void 0, void 0, function () {
            ...
            return __generator(this, function (_s) {
                switch (_s.label) {
                    ...
                    case 1:
                        body_1 = _b.apply(_a, [_d.apply(_c, [_s.sent(), contentType]), "UserResponse", ""]);
                    ...
                    case 6:
                        ...
                        return [4 /*yield*/, response.body.text()];
                    case 7:
                        body_4 = _p.apply(_o, [_r.apply(_q, [_s.sent(), contentType]), "UserResponse", ""]);
            ...
            return __generator(this, function (_s) {
                switch (_s.label) {
                    case 0:
                        ...
                        return [4 /*yield*/, response.body.text()];
                    case 1:
                        body_8 = _b.apply(_a, [_d.apply(_c, [_s.sent(), contentType]), "UserInvitationResponse", ""]);
                    ...
                    case 6:
                        ...
                        return [4 /*yield*/, response.body.text()];
                    case 7:
                        body_11 = _p.apply(_o, [_r.apply(_q, [_s.sent(), contentType]), "UserInvitationResponse", ""]);
            ...
            return __generator(this, function (_s) {
                switch (_s.label) {
                    case 0:
                        ...
                        return [4 /*yield*/, response.body.text()];
                    case 1:
                        body_12 = _b.apply(_a, [_d.apply(_c, [_s.sent(), contentType]), "UserResponse", ""]);
                    ...
                    case 6:
                        ...
                        return [4 /*yield*/, response.body.text()];
                    case 7:
                        body_15 = _p.apply(_o, [_r.apply(_q, [_s.sent(), contentType]), "UserResponse", ""]);
            ...
            return __generator(this, function (_s) {
                switch (_s.label) {
                    case 0:
                        ...
                        return [4 /*yield*/, response.body.text()];
                    case 1:
                        body_16 = _b.apply(_a, [_d.apply(_c, [_s.sent(), contentType]), "UserResponse", ""]);
                    ...
                    case 6:
                        ...
                        return [4 /*yield*/, response.body.text()];
                    case 7:
                        body_19 = _p.apply(_o, [_r.apply(_q, [_s.sent(), contentType]), "UserResponse", ""]);
            ...
            return __generator(this, function (_s) {
                switch (_s.label) {
                    case 0:
                        ...
                        return [4 /*yield*/, response.body.text()];
                    case 1:
                        body_20 = _b.apply(_a, [_d.apply(_c, [_s.sent(), contentType]), "PermissionsResponse", ""]);
                    ...
                    case 6:
                        ...
                        return [4 /*yield*/, response.body.text()];
                    case 7:
                        body_23 = _p.apply(_o, [_r.apply(_q, [_s.sent(), contentType]), "PermissionsResponse", ""]);
            ...
            return __generator(this, function (_s) {
                switch (_s.label) {
                    case 0:
                        ...
                        return [4 /*yield*/, response.body.text()];
                    case 1:
                        body_24 = _b.apply(_a, [_d.apply(_c, [_s.sent(), contentType]), "UsersResponse", ""]);
                    ...
                    case 6:
                        ...
                        return [4 /*yield*/, response.body.text()];
                    case 7:
                        body_27 = _p.apply(_o, [_r.apply(_q, [_s.sent(), contentType]), "UsersResponse", ""]);
            ...
            return __generator(this, function (_s) {
                switch (_s.label) {
                    case 0:
                        ...
                        return [4 /*yield*/, response.body.text()];
                    case 1:
                        body_28 = _b.apply(_a, [_d.apply(_c, [_s.sent(), contentType]), "UserInvitationsResponse", ""]);
                    ...
                    case 6:
                        ...
                        return [4 /*yield*/, response.body.text()];
                    case 7:
                        body_31 = _p.apply(_o, [_r.apply(_q, [_s.sent(), contentType]), "UserInvitationsResponse", ""]);
            ...
            return __generator(this, function (_0) {
                switch (_0.label) {
                    case 0:
                        ...
                        return [4 /*yield*/, response.body.text()];
                    case 1:
                        body_32 = _b.apply(_a, [_d.apply(_c, [_0.sent(), contentType]), "UserResponse", ""]);
                    ...
                    case 2:
                        ...
                        return [4 /*yield*/, response.body.text()];
                    case 3:
                        body_33 = _f.apply(_e, [_h.apply(_g, [_0.sent(), contentType]), "APIErrorResponse", ""]);
                    ...
                    case 4:
                        ...
                        return [4 /*yield*/, response.body.text()];
                    case 5:
                        body_34 = _k.apply(_j, [_m.apply(_l, [_0.sent(), contentType]), "APIErrorResponse", ""]);
                    ...
                    case 6:
                        ...
                        return [4 /*yield*/, response.body.text()];
                    case 7:
                        body_35 = _p.apply(_o, [_r.apply(_q, [_0.sent(), contentType]), "APIErrorResponse", ""]);
                    ...
                    case 8:
                        ...
                        return [4 /*yield*/, response.body.text()];
                    case 9:
                        body_36 = _t.apply(_s, [_v.apply(_u, [_0.sent(), contentType]), "APIErrorResponse", ""]);
                    ...
                    case 10:
                        ...
                        return [4 /*yield*/, response.body.text()];
                    case 11:
                        body_37 = _x.apply(_w, [_z.apply(_y, [_0.sent(), contentType]), "UserResponse", ""]);
