...
export class SecurityMonitoringApiRequestFactory extends BaseAPIRequestFactory {
  ...
  public async activateContentPack(contentPackId: string,_options?: Configuration): Promise<RequestContext> {
    ...
    // Path Params
    const localVarPath = '/api/v2/security_monitoring/content_packs/{content_pack_id}/activate'
      .replace('{content_pack_id}', encodeURIComponent(String(contentPackId)));

    // Make Request Context
    const requestContext = _config.getServer('v2.SecurityMonitoringApi.activateContentPack').makeRequestContext(localVarPath, HttpMethod.PUT);
  ...
  public async activateIntegration(integrationType: string,body?: SecurityMonitoringIntegrationActivateRequest,_options?: Configuration): Promise<RequestContext> {
    const _config = _options || this.configuration;

    logger.warn("Using unstable operation 'activateIntegration'");
    ...
    // Path Params
    const localVarPath = '/api/v2/security_monitoring/configuration/integration_config/{integration_type}/activate'
      .replace('{integration_type}', encodeURIComponent(String(integrationType)));

    // Make Request Context
    const requestContext = _config.getServer('v2.SecurityMonitoringApi.activateIntegration').makeRequestContext(localVarPath, HttpMethod.POST);
    ...
    const serializedBody = ObjectSerializer.stringify(
      ObjectSerializer.serialize(body, "SecurityMonitoringIntegrationActivateRequest", ""),
      contentType
    );
  ...
  public async attachCase(caseId: string,body: AttachCaseRequest,_options?: Configuration): Promise<RequestContext> {
    const _config = _options || this.configuration;
    ...
    // Path Params
    const localVarPath = '/api/v2/security/findings/cases/{case_id}'
      .replace('{case_id}', encodeURIComponent(String(caseId)));

    // Make Request Context
    const requestContext = _config.getServer('v2.SecurityMonitoringApi.attachCase').makeRequestContext(localVarPath, HttpMethod.PATCH);
    requestContext.setHeaderParam("Accept", "application/json");
    requestContext.setHttpConfig(_config.httpConfig);
  ...
  public async attachJiraIssue(body: AttachJiraIssueRequest,_options?: Configuration): Promise<RequestContext> {
    const _config = _options || this.configuration;
    ...
    // Make Request Context
    const requestContext = _config.getServer('v2.SecurityMonitoringApi.attachJiraIssue').makeRequestContext(localVarPath, HttpMethod.PATCH);
    requestContext.setHeaderParam("Accept", "application/json");
    requestContext.setHttpConfig(_config.httpConfig);
  ...
  public async attachLinearIssue(body: AttachLinearIssueRequest,_options?: Configuration): Promise<RequestContext> {
    const _config = _options || this.configuration;
    ...
    // Make Request Context
    const requestContext = _config.getServer('v2.SecurityMonitoringApi.attachLinearIssue').makeRequestContext(localVarPath, HttpMethod.PATCH);
    requestContext.setHeaderParam("Accept", "application/json");
    requestContext.setHttpConfig(_config.httpConfig);
  ...
  public async attachServiceNowTicket(body: AttachServiceNowTicketRequest,_options?: Configuration): Promise<RequestContext> {
    const _config = _options || this.configuration;
    ...
    // Make Request Context
    const requestContext = _config.getServer('v2.SecurityMonitoringApi.attachServiceNowTicket').makeRequestContext(localVarPath, HttpMethod.PATCH);
    requestContext.setHeaderParam("Accept", "application/json");
    requestContext.setHttpConfig(_config.httpConfig);
    ...
    requestContext.setHeaderParam("Content-Type", contentType);
    const serializedBody = ObjectSerializer.stringify(
      ObjectSerializer.serialize(body, "AttachServiceNowTicketRequest", ""),
      contentType
    );
    requestContext.setBody(serializedBody);
  ...
  public async batchGetSecurityMonitoringDatasetDependencies(body: SecurityMonitoringDatasetDependenciesRequest,_options?: Configuration): Promise<RequestContext> {
    const _config = _options || this.configuration;

    logger.warn("Using unstable operation 'batchGetSecurityMonitoringDatasetDependencies'");
    ...
    // Make Request Context
    const requestContext = _config.getServer('v2.SecurityMonitoringApi.batchGetSecurityMonitoringDatasetDependencies').makeRequestContext(localVarPath, HttpMethod.POST);
    requestContext.setHeaderParam("Accept", "application/json");
    requestContext.setHttpConfig(_config.httpConfig);
    ...
    requestContext.setHeaderParam("Content-Type", contentType);
    const serializedBody = ObjectSerializer.stringify(
      ObjectSerializer.serialize(body, "SecurityMonitoringDatasetDependenciesRequest", ""),
      contentType
    );
    requestContext.setBody(serializedBody);
  ...
  public async bulkConvertExistingSecurityMonitoringRules(body: SecurityMonitoringRuleConvertBulkPayload,_options?: Configuration): Promise<RequestContext> {
    const _config = _options || this.configuration;
    ...
    // Make Request Context
    const requestContext = _config.getServer('v2.SecurityMonitoringApi.bulkConvertExistingSecurityMonitoringRules').makeRequestContext(localVarPath, HttpMethod.POST);
    ...
    requestContext.setHeaderParam("Content-Type", contentType);
    const serializedBody = ObjectSerializer.stringify(
      ObjectSerializer.serialize(body, "SecurityMonitoringRuleConvertBulkPayload", ""),
      contentType
    );
    requestContext.setBody(serializedBody);
  ...
  public async bulkCreateSampleLogGenerationSubscriptions(body: SampleLogGenerationBulkSubscriptionRequest,_options?: Configuration): Promise<RequestContext> {
    const _config = _options || this.configuration;

    logger.warn("Using unstable operation 'bulkCreateSampleLogGenerationSubscriptions'");
    ...
    // Make Request Context
    const requestContext = _config.getServer('v2.SecurityMonitoringApi.bulkCreateSampleLogGenerationSubscriptions').makeRequestContext(localVarPath, HttpMethod.POST);
    requestContext.setHeaderParam("Accept", "application/json");
    requestContext.setHttpConfig(_config.httpConfig);
    ...
    requestContext.setHeaderParam("Content-Type", contentType);
    const serializedBody = ObjectSerializer.stringify(
      ObjectSerializer.serialize(body, "SampleLogGenerationBulkSubscriptionRequest", ""),
      contentType
    );
    requestContext.setBody(serializedBody);
  ...
  public async bulkDeleteSecurityMonitoringRules(body: SecurityMonitoringRuleBulkDeletePayload,_options?: Configuration): Promise<RequestContext> {
    const _config = _options || this.configuration;
    ...
    // Make Request Context
    const requestContext = _config.getServer('v2.SecurityMonitoringApi.bulkDeleteSecurityMonitoringRules').makeRequestContext(localVarPath, HttpMethod.DELETE);
    requestContext.setHeaderParam("Accept", "application/json");
    requestContext.setHttpConfig(_config.httpConfig);
    ...
    requestContext.setHeaderParam("Content-Type", contentType);
    const serializedBody = ObjectSerializer.stringify(
      ObjectSerializer.serialize(body, "SecurityMonitoringRuleBulkDeletePayload", ""),
      contentType
    );
    requestContext.setBody(serializedBody);
  ...
  public async bulkEditSecurityMonitoringSignals(body: SecurityMonitoringSignalsBulkUpdateRequest,_options?: Configuration): Promise<RequestContext> {
    const _config = _options || this.configuration;
    ...
    // Make Request Context
    const requestContext = _config.getServer('v2.SecurityMonitoringApi.bulkEditSecurityMonitoringSignals').makeRequestContext(localVarPath, HttpMethod.PATCH);
    requestContext.setHeaderParam("Accept", "application/json");
    requestContext.setHttpConfig(_config.httpConfig);
    ...
    requestContext.setHeaderParam("Content-Type", contentType);
    const serializedBody = ObjectSerializer.stringify(
      ObjectSerializer.serialize(body, "SecurityMonitoringSignalsBulkUpdateRequest", ""),
      contentType
    );
    requestContext.setBody(serializedBody);
  ...
  public async bulkEditSecurityMonitoringSignalsAssignee(body: SecurityMonitoringSignalsBulkAssigneeUpdateRequest,_options?: Configuration): Promise<RequestContext> {
    const _config = _options || this.configuration;
    ...
    // Make Request Context
    const requestContext = _config.getServer('v2.SecurityMonitoringApi.bulkEditSecurityMonitoringSignalsAssignee').makeRequestContext(localVarPath, HttpMethod.PATCH);
    requestContext.setHeaderParam("Accept", "application/json");
    requestContext.setHttpConfig(_config.httpConfig);
    ...
    requestContext.setHeaderParam("Content-Type", contentType);
    const serializedBody = ObjectSerializer.stringify(
      ObjectSerializer.serialize(body, "SecurityMonitoringSignalsBulkAssigneeUpdateRequest", ""),
      contentType
    );
    requestContext.setBody(serializedBody);
  ...
  public async bulkEditSecurityMonitoringSignalsState(body: SecurityMonitoringSignalsBulkStateUpdateRequest,_options?: Configuration): Promise<RequestContext> {
    const _config = _options || this.configuration;
    ...
    // Make Request Context
    const requestContext = _config.getServer('v2.SecurityMonitoringApi.bulkEditSecurityMonitoringSignalsState').makeRequestContext(localVarPath, HttpMethod.PATCH);
    requestContext.setHeaderParam("Accept", "application/json");
    requestContext.setHttpConfig(_config.httpConfig);
    ...
    requestContext.setHeaderParam("Content-Type", contentType);
    const serializedBody = ObjectSerializer.stringify(
      ObjectSerializer.serialize(body, "SecurityMonitoringSignalsBulkStateUpdateRequest", ""),
      contentType
    );
    requestContext.setBody(serializedBody);
  ...
  public async bulkExportSecurityMonitoringRules(body: SecurityMonitoringRuleBulkExportPayload,_options?: Configuration): Promise<RequestContext> {
    const _config = _options || this.configuration;
    ...
    // Make Request Context
    const requestContext = _config.getServer('v2.SecurityMonitoringApi.bulkExportSecurityMonitoringRules').makeRequestContext(localVarPath, HttpMethod.POST);
    requestContext.setHeaderParam("Accept", "application/zip, application/json");
    requestContext.setHttpConfig(_config.httpConfig);
    ...
    requestContext.setHeaderParam("Content-Type", contentType);
    const serializedBody = ObjectSerializer.stringify(
      ObjectSerializer.serialize(body, "SecurityMonitoringRuleBulkExportPayload", ""),
      contentType
    );
    requestContext.setBody(serializedBody);
  ...
  public async bulkExportSecurityMonitoringTerraformResources(resourceType: SecurityMonitoringTerraformResourceType,body: SecurityMonitoringTerraformBulkExportRequest,_options?: Configuration): Promise<RequestContext> {
    const _config = _options || this.configuration;

    logger.warn("Using unstable operation 'bulkExportSecurityMonitoringTerraformResources'");
    ...
    // Path Params
    const localVarPath = '/api/v2/security_monitoring/terraform/{resource_type}/bulk'
      .replace('{resource_type}', encodeURIComponent(String(resourceType)));

    // Make Request Context
    const requestContext = _config.getServer('v2.SecurityMonitoringApi.bulkExportSecurityMonitoringTerraformResources').makeRequestContext(localVarPath, HttpMethod.POST);
    requestContext.setHeaderParam("Accept", "application/zip, application/json");
    requestContext.setHttpConfig(_config.httpConfig);
    ...
    requestContext.setHeaderParam("Content-Type", contentType);
    const serializedBody = ObjectSerializer.stringify(
      ObjectSerializer.serialize(body, "SecurityMonitoringTerraformBulkExportRequest", ""),
      contentType
    );
    requestContext.setBody(serializedBody);
  ...
  public async cancelHistoricalJob(jobId: string,_options?: Configuration): Promise<RequestContext> {
    const _config = _options || this.configuration;
    ...
    // Path Params
    const localVarPath = '/api/v2/siem-historical-detections/jobs/{job_id}/cancel'
      .replace('{job_id}', encodeURIComponent(String(jobId)));

    // Make Request Context
    const requestContext = _config.getServer('v2.SecurityMonitoringApi.cancelHistoricalJob').makeRequestContext(localVarPath, HttpMethod.PATCH);
    requestContext.setHeaderParam("Accept", "*/*");
    requestContext.setHttpConfig(_config.httpConfig);
  ...
  public async convertExistingSecurityMonitoringRule(ruleId: string,_options?: Configuration): Promise<RequestContext> {
    const _config = _options || this.configuration;
    ...
    // Path Params
    const localVarPath = '/api/v2/security_monitoring/rules/{rule_id}/convert'
      .replace('{rule_id}', encodeURIComponent(String(ruleId)));

    // Make Request Context
    const requestContext = _config.getServer('v2.SecurityMonitoringApi.convertExistingSecurityMonitoringRule').makeRequestContext(localVarPath, HttpMethod.GET);
    requestContext.setHeaderParam("Accept", "application/json");
    requestContext.setHttpConfig(_config.httpConfig);
  ...
  public async convertJobResultToSignal(body: ConvertJobResultsToSignalsRequest,_options?: Configuration): Promise<RequestContext> {
    const _config = _options || this.configuration;
    ...
    // Make Request Context
    const requestContext = _config.getServer('v2.SecurityMonitoringApi.convertJobResultToSignal').makeRequestContext(localVarPath, HttpMethod.POST);
    requestContext.setHeaderParam("Accept", "*/*");
    requestContext.setHttpConfig(_config.httpConfig);
  ...
  public async convertSecurityMonitoringRuleFromJSONToTerraform(body: SecurityMonitoringRuleConvertPayload,_options?: Configuration): Promise<RequestContext> {
    const _config = _options || this.configuration;
    ...
    // Make Request Context
    const requestContext = _config.getServer('v2.SecurityMonitoringApi.convertSecurityMonitoringRuleFromJSONToTerraform').makeRequestContext(localVarPath, HttpMethod.POST);
    requestContext.setHeaderParam("Accept", "application/json");
    requestContext.setHttpConfig(_config.httpConfig);
  ...
  public async convertSecurityMonitoringTerraformResource(resourceType: SecurityMonitoringTerraformResourceType,body: SecurityMonitoringTerraformConvertRequest,_options?: Configuration): Promise<RequestContext> {
    const _config = _options || this.configuration;

    logger.warn("Using unstable operation 'convertSecurityMonitoringTerraformResource'");
    ...
    // Path Params
    const localVarPath = '/api/v2/security_monitoring/terraform/{resource_type}/convert'
      .replace('{resource_type}', encodeURIComponent(String(resourceType)));

    // Make Request Context
    const requestContext = _config.getServer('v2.SecurityMonitoringApi.convertSecurityMonitoringTerraformResource').makeRequestContext(localVarPath, HttpMethod.POST);
    requestContext.setHeaderParam("Accept", "application/json");
    requestContext.setHttpConfig(_config.httpConfig);
    ...
    requestContext.setHeaderParam("Content-Type", contentType);
    const serializedBody = ObjectSerializer.stringify(
      ObjectSerializer.serialize(body, "SecurityMonitoringTerraformConvertRequest", ""),
      contentType
    );
    requestContext.setBody(serializedBody);
  ...
  public async createCases(body: CreateCaseRequestArray,_options?: Configuration): Promise<RequestContext> {
    const _config = _options || this.configuration;
    ...
    // Make Request Context
    const requestContext = _config.getServer('v2.SecurityMonitoringApi.createCases').makeRequestContext(localVarPath, HttpMethod.POST);
    requestContext.setHeaderParam("Accept", "application/json");
    requestContext.setHttpConfig(_config.httpConfig);
  ...
  public async createCustomFramework(body: CreateCustomFrameworkRequest,_options?: Configuration): Promise<RequestContext> {
    const _config = _options || this.configuration;
    ...
    // Make Request Context
    const requestContext = _config.getServer('v2.SecurityMonitoringApi.createCustomFramework').makeRequestContext(localVarPath, HttpMethod.POST);
    requestContext.setHeaderParam("Accept", "application/json");
    requestContext.setHttpConfig(_config.httpConfig);
  ...
  public async createIoCTriageState(body: IoCTriageWriteRequest,_options?: Configuration): Promise<RequestContext> {
    const _config = _options || this.configuration;
    ...
    // Make Request Context
    const requestContext = _config.getServer('v2.SecurityMonitoringApi.createIoCTriageState').makeRequestContext(localVarPath, HttpMethod.POST);
    requestContext.setHeaderParam("Accept", "application/json");
    requestContext.setHttpConfig(_config.httpConfig);
  ...
  public async createJiraIssues(body: CreateJiraIssueRequestArray,_options?: Configuration): Promise<RequestContext> {
    const _config = _options || this.configuration;
    ...
    // Make Request Context
    const requestContext = _config.getServer('v2.SecurityMonitoringApi.createJiraIssues').makeRequestContext(localVarPath, HttpMethod.POST);
    requestContext.setHeaderParam("Accept", "application/json");
    requestContext.setHttpConfig(_config.httpConfig);
  ...
  public async createLinearIssues(body: CreateLinearIssueRequestArray,_options?: Configuration): Promise<RequestContext> {
    const _config = _options || this.configuration;
    ...
    // Make Request Context
    const requestContext = _config.getServer('v2.SecurityMonitoringApi.createLinearIssues').makeRequestContext(localVarPath, HttpMethod.POST);
    requestContext.setHeaderParam("Accept", "application/json");
    requestContext.setHttpConfig(_config.httpConfig);
  ...
  public async createSampleLogGenerationSubscription(body: SampleLogGenerationSubscriptionCreateRequest,_options?: Configuration): Promise<RequestContext> {
    const _config = _options || this.configuration;

    logger.warn("Using unstable operation 'createSampleLogGenerationSubscription'");
    ...
    // Make Request Context
    const requestContext = _config.getServer('v2.SecurityMonitoringApi.createSampleLogGenerationSubscription').makeRequestContext(localVarPath, HttpMethod.POST);
    requestContext.setHeaderParam("Accept", "application/json");
    requestContext.setHttpConfig(_config.httpConfig);
    ...
    requestContext.setHeaderParam("Content-Type", contentType);
    const serializedBody = ObjectSerializer.stringify(
      ObjectSerializer.serialize(body, "SampleLogGenerationSubscriptionCreateRequest", ""),
      contentType
    );
    requestContext.setBody(serializedBody);
  ...
  public async createSecurityFilter(body: SecurityFilterCreateRequest,_options?: Configuration): Promise<RequestContext> {
    const _config = _options || this.configuration;
    ...
    // Make Request Context
    const requestContext = _config.getServer('v2.SecurityMonitoringApi.createSecurityFilter').makeRequestContext(localVarPath, HttpMethod.POST);
    requestContext.setHeaderParam("Accept", "application/json");
    requestContext.setHttpConfig(_config.httpConfig);
  ...
  public async createSecurityFindingsAutomationDueDateRule(body: DueDateRuleCreateRequest,_options?: Configuration): Promise<RequestContext> {
    const _config = _options || this.configuration;

    logger.warn("Using unstable operation 'createSecurityFindingsAutomationDueDateRule'");
    ...
    // Make Request Context
    const requestContext = _config.getServer('v2.SecurityMonitoringApi.createSecurityFindingsAutomationDueDateRule').makeRequestContext(localVarPath, HttpMethod.POST);
    requestContext.setHeaderParam("Accept", "application/json");
    requestContext.setHttpConfig(_config.httpConfig);
    ...
    requestContext.setHeaderParam("Content-Type", contentType);
    const serializedBody = ObjectSerializer.stringify(
      ObjectSerializer.serialize(body, "DueDateRuleCreateRequest", ""),
      contentType
    );
    requestContext.setBody(serializedBody);
  ...
  public async createSecurityFindingsAutomationMuteRule(body: MuteRuleCreateRequest,_options?: Configuration): Promise<RequestContext> {
    const _config = _options || this.configuration;

    logger.warn("Using unstable operation 'createSecurityFindingsAutomationMuteRule'");
    ...
    // Make Request Context
    const requestContext = _config.getServer('v2.SecurityMonitoringApi.createSecurityFindingsAutomationMuteRule').makeRequestContext(localVarPath, HttpMethod.POST);
    requestContext.setHeaderParam("Accept", "application/json");
    requestContext.setHttpConfig(_config.httpConfig);
    ...
    requestContext.setHeaderParam("Content-Type", contentType);
    const serializedBody = ObjectSerializer.stringify(
      ObjectSerializer.serialize(body, "MuteRuleCreateRequest", ""),
      contentType
    );
    requestContext.setBody(serializedBody);
  ...
  public async createSecurityFindingsAutomationTicketCreationRule(body: TicketCreationRuleCreateRequest,_options?: Configuration): Promise<RequestContext> {
    const _config = _options || this.configuration;

    logger.warn("Using unstable operation 'createSecurityFindingsAutomationTicketCreationRule'");
    ...
    // Make Request Context
    const requestContext = _config.getServer('v2.SecurityMonitoringApi.createSecurityFindingsAutomationTicketCreationRule').makeRequestContext(localVarPath, HttpMethod.POST);
    requestContext.setHeaderParam("Accept", "application/json");
    requestContext.setHttpConfig(_config.httpConfig);
    ...
    requestContext.setHeaderParam("Content-Type", contentType);
    const serializedBody = ObjectSerializer.stringify(
      ObjectSerializer.serialize(body, "TicketCreationRuleCreateRequest", ""),
      contentType
    );
    requestContext.setBody(serializedBody);
  ...
  public async createSecurityMonitoringCriticalAsset(body: SecurityMonitoringCriticalAssetCreateRequest,_options?: Configuration): Promise<RequestContext> {
    const _config = _options || this.configuration;
    ...
    // Make Request Context
    const requestContext = _config.getServer('v2.SecurityMonitoringApi.createSecurityMonitoringCriticalAsset').makeRequestContext(localVarPath, HttpMethod.POST);
    requestContext.setHeaderParam("Accept", "application/json");
    requestContext.setHttpConfig(_config.httpConfig);
    ...
    requestContext.setHeaderParam("Content-Type", contentType);
    const serializedBody = ObjectSerializer.stringify(
      ObjectSerializer.serialize(body, "SecurityMonitoringCriticalAssetCreateRequest", ""),
      contentType
    );
    requestContext.setBody(serializedBody);
  ...
  public async createSecurityMonitoringDataset(body: SecurityMonitoringDatasetCreateRequest,_options?: Configuration): Promise<RequestContext> {
    const _config = _options || this.configuration;
    ...
    // Make Request Context
    const requestContext = _config.getServer('v2.SecurityMonitoringApi.createSecurityMonitoringDataset').makeRequestContext(localVarPath, HttpMethod.POST);
    requestContext.setHeaderParam("Accept", "application/json");
    requestContext.setHttpConfig(_config.httpConfig);
    ...
    requestContext.setHeaderParam("Content-Type", contentType);
    const serializedBody = ObjectSerializer.stringify(
      ObjectSerializer.serialize(body, "SecurityMonitoringDatasetCreateRequest", ""),
      contentType
    );
    requestContext.setBody(serializedBody);
  ...
  public async createSecurityMonitoringIntegrationConfig(body: SecurityMonitoringIntegrationConfigCreateRequest,_options?: Configuration): Promise<RequestContext> {
    const _config = _options || this.configuration;

    logger.warn("Using unstable operation 'createSecurityMonitoringIntegrationConfig'");
    ...
    // Make Request Context
    const requestContext = _config.getServer('v2.SecurityMonitoringApi.createSecurityMonitoringIntegrationConfig').makeRequestContext(localVarPath, HttpMethod.POST);
    requestContext.setHeaderParam("Accept", "application/json");
    requestContext.setHttpConfig(_config.httpConfig);
    ...
    requestContext.setHeaderParam("Content-Type", contentType);
    const serializedBody = ObjectSerializer.stringify(
      ObjectSerializer.serialize(body, "SecurityMonitoringIntegrationConfigCreateRequest", ""),
      contentType
    );
    requestContext.setBody(serializedBody);
  ...
  public async createSecurityMonitoringRule(body: SecurityMonitoringRuleCreatePayload,_options?: Configuration): Promise<RequestContext> {
    const _config = _options || this.configuration;
    ...
    // Make Request Context
    const requestContext = _config.getServer('v2.SecurityMonitoringApi.createSecurityMonitoringRule').makeRequestContext(localVarPath, HttpMethod.POST);
    requestContext.setHeaderParam("Accept", "application/json");
    requestContext.setHttpConfig(_config.httpConfig);
  ...
  public async createSecurityMonitoringSuppression(body: SecurityMonitoringSuppressionCreateRequest,_options?: Configuration): Promise<RequestContext> {
    const _config = _options || this.configuration;
    ...
    // Make Request Context
    const requestContext = _config.getServer('v2.SecurityMonitoringApi.createSecurityMonitoringSuppression').makeRequestContext(localVarPath, HttpMethod.POST);
    requestContext.setHeaderParam("Accept", "application/json");
    requestContext.setHttpConfig(_config.httpConfig);
  ...
  public async createServiceNowTickets(body: CreateServiceNowTicketRequestArray,_options?: Configuration): Promise<RequestContext> {
    const _config = _options || this.configuration;
    ...
    // Make Request Context
    const requestContext = _config.getServer('v2.SecurityMonitoringApi.createServiceNowTickets').makeRequestContext(localVarPath, HttpMethod.POST);
    requestContext.setHeaderParam("Accept", "application/json");
    requestContext.setHttpConfig(_config.httpConfig);
    ...
    requestContext.setHeaderParam("Content-Type", contentType);
    const serializedBody = ObjectSerializer.stringify(
      ObjectSerializer.serialize(body, "CreateServiceNowTicketRequestArray", ""),
      contentType
    );
    requestContext.setBody(serializedBody);
  ...
  public async createSignalNotificationRule(body: CreateNotificationRuleParameters,_options?: Configuration): Promise<RequestContext> {
    const _config = _options || this.configuration;
    ...
    // Make Request Context
    const requestContext = _config.getServer('v2.SecurityMonitoringApi.createSignalNotificationRule').makeRequestContext(localVarPath, HttpMethod.POST);
    requestContext.setHeaderParam("Accept", "application/json");
    requestContext.setHttpConfig(_config.httpConfig);
  ...
  public async createStaticAnalysisAst(body: GetAstRequest,_options?: Configuration): Promise<RequestContext> {
    const _config = _options || this.configuration;
    ...
    // Make Request Context
    const requestContext = _config.getServer('v2.SecurityMonitoringApi.createStaticAnalysisAst').makeRequestContext(localVarPath, HttpMethod.POST);
    requestContext.setHeaderParam("Accept", "application/json");
    requestContext.setHttpConfig(_config.httpConfig);
  ...
  public async createStaticAnalysisServerAnalysis(body: AnalysisRequest,_options?: Configuration): Promise<RequestContext> {
    const _config = _options || this.configuration;

    logger.warn("Using unstable operation 'createStaticAnalysisServerAnalysis'");
    ...
    // Make Request Context
    const requestContext = _config.getServer('v2.SecurityMonitoringApi.createStaticAnalysisServerAnalysis').makeRequestContext(localVarPath, HttpMethod.POST);
    requestContext.setHeaderParam("Accept", "application/json");
    requestContext.setHttpConfig(_config.httpConfig);
  ...
  public async createVulnerabilityNotificationRule(body: CreateNotificationRuleParameters,_options?: Configuration): Promise<RequestContext> {
    const _config = _options || this.configuration;
    ...
    // Make Request Context
    const requestContext = _config.getServer('v2.SecurityMonitoringApi.createVulnerabilityNotificationRule').makeRequestContext(localVarPath, HttpMethod.POST);
    requestContext.setHeaderParam("Accept", "application/json");
    requestContext.setHttpConfig(_config.httpConfig);
  ...
  public async deactivateContentPack(contentPackId: string,_options?: Configuration): Promise<RequestContext> {
    const _config = _options || this.configuration;
    ...
    // Path Params
    const localVarPath = '/api/v2/security_monitoring/content_packs/{content_pack_id}/deactivate'
      .replace('{content_pack_id}', encodeURIComponent(String(contentPackId)));

    // Make Request Context
    const requestContext = _config.getServer('v2.SecurityMonitoringApi.deactivateContentPack').makeRequestContext(localVarPath, HttpMethod.PUT);
    requestContext.setHeaderParam("Accept", "*/*");
    requestContext.setHttpConfig(_config.httpConfig);
  ...
  public async deactivateIntegration(integrationType: string,_options?: Configuration): Promise<RequestContext> {
    const _config = _options || this.configuration;

    logger.warn("Using unstable operation 'deactivateIntegration'");
    ...
    // Path Params
    const localVarPath = '/api/v2/security_monitoring/configuration/integration_config/{integration_type}/deactivate'
      .replace('{integration_type}', encodeURIComponent(String(integrationType)));

    // Make Request Context
    const requestContext = _config.getServer('v2.SecurityMonitoringApi.deactivateIntegration').makeRequestContext(localVarPath, HttpMethod.POST);
    requestContext.setHeaderParam("Accept", "application/json");
    requestContext.setHttpConfig(_config.httpConfig);
  ...
  public async deleteCustomFramework(handle: string,version: string,_options?: Configuration): Promise<RequestContext> {
    const _config = _options || this.configuration;
    ...
    // Make Request Context
    const requestContext = _config.getServer('v2.SecurityMonitoringApi.deleteCustomFramework').makeRequestContext(localVarPath, HttpMethod.DELETE);
    requestContext.setHeaderParam("Accept", "application/json");
    requestContext.setHttpConfig(_config.httpConfig);
  ...
  public async deleteHistoricalJob(jobId: string,_options?: Configuration): Promise<RequestContext> {
    const _config = _options || this.configuration;
    ...
    // Path Params
    const localVarPath = '/api/v2/siem-historical-detections/jobs/{job_id}'
      .replace('{job_id}', encodeURIComponent(String(jobId)));

    // Make Request Context
    const requestContext = _config.getServer('v2.SecurityMonitoringApi.deleteHistoricalJob').makeRequestContext(localVarPath, HttpMethod.DELETE);
    requestContext.setHeaderParam("Accept", "*/*");
    requestContext.setHttpConfig(_config.httpConfig);
  ...
  public async deleteSampleLogGenerationSubscription(contentPackId: string,_options?: Configuration): Promise<RequestContext> {
    const _config = _options || this.configuration;

    logger.warn("Using unstable operation 'deleteSampleLogGenerationSubscription'");
    ...
    // Path Params
    const localVarPath = '/api/v2/security_monitoring/sample_log_generation/subscriptions/{content_pack_id}'
      .replace('{content_pack_id}', encodeURIComponent(String(contentPackId)));

    // Make Request Context
    const requestContext = _config.getServer('v2.SecurityMonitoringApi.deleteSampleLogGenerationSubscription').makeRequestContext(localVarPath, HttpMethod.DELETE);
    requestContext.setHeaderParam("Accept", "application/json");
    requestContext.setHttpConfig(_config.httpConfig);
  ...
  public async deleteSecurityFilter(securityFilterId: string,_options?: Configuration): Promise<RequestContext> {
    const _config = _options || this.configuration;
    ...
    // Path Params
    const localVarPath = '/api/v2/security_monitoring/configuration/security_filters/{security_filter_id}'
      .replace('{security_filter_id}', encodeURIComponent(String(securityFilterId)));

    // Make Request Context
    const requestContext = _config.getServer('v2.SecurityMonitoringApi.deleteSecurityFilter').makeRequestContext(localVarPath, HttpMethod.DELETE);
    requestContext.setHeaderParam("Accept", "*/*");
    requestContext.setHttpConfig(_config.httpConfig);
  ...
  public async deleteSecurityFindingsAutomationDueDateRule(ruleId: string,_options?: Configuration): Promise<RequestContext> {
    const _config = _options || this.configuration;

    logger.warn("Using unstable operation 'deleteSecurityFindingsAutomationDueDateRule'");
    ...
    // Path Params
    const localVarPath = '/api/v2/security/findings/automation/due_date_rules/{rule_id}'
      .replace('{rule_id}', encodeURIComponent(String(ruleId)));

    // Make Request Context
    const requestContext = _config.getServer('v2.SecurityMonitoringApi.deleteSecurityFindingsAutomationDueDateRule').makeRequestContext(localVarPath, HttpMethod.DELETE);
    requestContext.setHeaderParam("Accept", "*/*");
    requestContext.setHttpConfig(_config.httpConfig);
  ...
  public async deleteSecurityFindingsAutomationMuteRule(ruleId: string,_options?: Configuration): Promise<RequestContext> {
    const _config = _options || this.configuration;

    logger.warn("Using unstable operation 'deleteSecurityFindingsAutomationMuteRule'");
    ...
    // Path Params
    const localVarPath = '/api/v2/security/findings/automation/mute_rules/{rule_id}'
      .replace('{rule_id}', encodeURIComponent(String(ruleId)));

    // Make Request Context
    const requestContext = _config.getServer('v2.SecurityMonitoringApi.deleteSecurityFindingsAutomationMuteRule').makeRequestContext(localVarPath, HttpMethod.DELETE);
    requestContext.setHeaderParam("Accept", "*/*");
    requestContext.setHttpConfig(_config.httpConfig);
  ...
  public async deleteSecurityFindingsAutomationTicketCreationRule(ruleId: string,_options?: Configuration): Promise<RequestContext> {
    const _config = _options || this.configuration;

    logger.warn("Using unstable operation 'deleteSecurityFindingsAutomationTicketCreationRule'");
    ...
    // Path Params
    const localVarPath = '/api/v2/security/findings/automation/ticket_creation_rules/{rule_id}'
      .replace('{rule_id}', encodeURIComponent(String(ruleId)));

    // Make Request Context
    const requestContext = _config.getServer('v2.SecurityMonitoringApi.deleteSecurityFindingsAutomationTicketCreationRule').makeRequestContext(localVarPath, HttpMethod.DELETE);
    requestContext.setHeaderParam("Accept", "*/*");
    requestContext.setHttpConfig(_config.httpConfig);
  ...
  public async deleteSecurityMonitoringCriticalAsset(criticalAssetId: string,_options?: Configuration): Promise<RequestContext> {
    const _config = _options || this.configuration;
    ...
    // Path Params
    const localVarPath = '/api/v2/security_monitoring/configuration/critical_assets/{critical_asset_id}'
      .replace('{critical_asset_id}', encodeURIComponent(String(criticalAssetId)));

    // Make Request Context
    const requestContext = _config.getServer('v2.SecurityMonitoringApi.deleteSecurityMonitoringCriticalAsset').makeRequestContext(localVarPath, HttpMethod.DELETE);
    requestContext.setHeaderParam("Accept", "*/*");
    requestContext.setHttpConfig(_config.httpConfig);
  ...
  public async deleteSecurityMonitoringDataset(datasetId: string,_options?: Configuration): Promise<RequestContext> {
    const _config = _options || this.configuration;
    ...
    // Path Params
    const localVarPath = '/api/v2/security_monitoring/datasets/{dataset_id}'
      .replace('{dataset_id}', encodeURIComponent(String(datasetId)));

    // Make Request Context
    const requestContext = _config.getServer('v2.SecurityMonitoringApi.deleteSecurityMonitoringDataset').makeRequestContext(localVarPath, HttpMethod.DELETE);
    requestContext.setHeaderParam("Accept", "*/*");
    requestContext.setHttpConfig(_config.httpConfig);
  ...
  public async deleteSecurityMonitoringIntegrationConfig(integrationConfigId: string,_options?: Configuration): Promise<RequestContext> {
    const _config = _options || this.configuration;

    logger.warn("Using unstable operation 'deleteSecurityMonitoringIntegrationConfig'");
    ...
    // Path Params
    const localVarPath = '/api/v2/security_monitoring/configuration/integration_config/{integration_config_id}'
      .replace('{integration_config_id}', encodeURIComponent(String(integrationConfigId)));

    // Make Request Context
    const requestContext = _config.getServer('v2.SecurityMonitoringApi.deleteSecurityMonitoringIntegrationConfig').makeRequestContext(localVarPath, HttpMethod.DELETE);
    requestContext.setHeaderParam("Accept", "*/*");
    requestContext.setHttpConfig(_config.httpConfig);
  ...
  public async deleteSecurityMonitoringRule(ruleId: string,_options?: Configuration): Promise<RequestContext> {
    const _config = _options || this.configuration;
    ...
    // Make Request Context
    const requestContext = _config.getServer('v2.SecurityMonitoringApi.deleteSecurityMonitoringRule').makeRequestContext(localVarPath, HttpMethod.DELETE);
    requestContext.setHeaderParam("Accept", "*/*");
    requestContext.setHttpConfig(_config.httpConfig);
  ...
  public async deleteSecurityMonitoringSuppression(suppressionId: string,_options?: Configuration): Promise<RequestContext> {
    const _config = _options || this.configuration;
    ...
    // Path Params
    const localVarPath = '/api/v2/security_monitoring/configuration/suppressions/{suppression_id}'
      .replace('{suppression_id}', encodeURIComponent(String(suppressionId)));

    // Make Request Context
    const requestContext = _config.getServer('v2.SecurityMonitoringApi.deleteSecurityMonitoringSuppression').makeRequestContext(localVarPath, HttpMethod.DELETE);
    requestContext.setHeaderParam("Accept", "*/*");
    requestContext.setHttpConfig(_config.httpConfig);
  ...
  public async deleteSignalNotificationRule(id: string,_options?: Configuration): Promise<RequestContext> {
    const _config = _options || this.configuration;
    ...
    // Path Params
    const localVarPath = '/api/v2/security/signals/notification_rules/{id}'
      .replace('{id}', encodeURIComponent(String(id)));

    // Make Request Context
    const requestContext = _config.getServer('v2.SecurityMonitoringApi.deleteSignalNotificationRule').makeRequestContext(localVarPath, HttpMethod.DELETE);
    requestContext.setHeaderParam("Accept", "*/*");
    requestContext.setHttpConfig(_config.httpConfig);
  ...
  public async deleteVulnerabilityNotificationRule(id: string,_options?: Configuration): Promise<RequestContext> {
    const _config = _options || this.configuration;
    ...
    // Path Params
    const localVarPath = '/api/v2/security/vulnerabilities/notification_rules/{id}'
      .replace('{id}', encodeURIComponent(String(id)));

    // Make Request Context
    const requestContext = _config.getServer('v2.SecurityMonitoringApi.deleteVulnerabilityNotificationRule').makeRequestContext(localVarPath, HttpMethod.DELETE);
    requestContext.setHeaderParam("Accept", "*/*");
    requestContext.setHttpConfig(_config.httpConfig);
  ...
  public async detachCase(body: DetachCaseRequest,_options?: Configuration): Promise<RequestContext> {
    const _config = _options || this.configuration;
    ...
    // Make Request Context
    const requestContext = _config.getServer('v2.SecurityMonitoringApi.detachCase').makeRequestContext(localVarPath, HttpMethod.DELETE);
    requestContext.setHeaderParam("Accept", "*/*");
    requestContext.setHttpConfig(_config.httpConfig);
  ...
  public async editSecurityMonitoringSignal(signalId: string,body: SecurityMonitoringSignalUpdateRequest,_options?: Configuration): Promise<RequestContext> {
    const _config = _options || this.configuration;
    ...
    // Path Params
    const localVarPath = '/api/v2/security_monitoring/signals/{signal_id}/update'
      .replace('{signal_id}', encodeURIComponent(String(signalId)));

    // Make Request Context
    const requestContext = _config.getServer('v2.SecurityMonitoringApi.editSecurityMonitoringSignal').makeRequestContext(localVarPath, HttpMethod.PATCH);
    requestContext.setHeaderParam("Accept", "application/json");
    requestContext.setHttpConfig(_config.httpConfig);
    ...
    requestContext.setHeaderParam("Content-Type", contentType);
    const serializedBody = ObjectSerializer.stringify(
      ObjectSerializer.serialize(body, "SecurityMonitoringSignalUpdateRequest", ""),
      contentType
    );
    requestContext.setBody(serializedBody);
  ...
  public async editSecurityMonitoringSignalAssignee(signalId: string,body: SecurityMonitoringSignalAssigneeUpdateRequest,_options?: Configuration): Promise<RequestContext> {
    const _config = _options || this.configuration;
    ...
    // Path Params
    const localVarPath = '/api/v2/security_monitoring/signals/{signal_id}/assignee'
      .replace('{signal_id}', encodeURIComponent(String(signalId)));

    // Make Request Context
    const requestContext = _config.getServer('v2.SecurityMonitoringApi.editSecurityMonitoringSignalAssignee').makeRequestContext(localVarPath, HttpMethod.PATCH);
    requestContext.setHeaderParam("Accept", "application/json");
    requestContext.setHttpConfig(_config.httpConfig);
  ...
  public async editSecurityMonitoringSignalIncidents(signalId: string,body: SecurityMonitoringSignalIncidentsUpdateRequest,_options?: Configuration): Promise<RequestContext> {
    const _config = _options || this.configuration;
    ...
    // Path Params
    const localVarPath = '/api/v2/security_monitoring/signals/{signal_id}/incidents'
      .replace('{signal_id}', encodeURIComponent(String(signalId)));

    // Make Request Context
    const requestContext = _config.getServer('v2.SecurityMonitoringApi.editSecurityMonitoringSignalIncidents').makeRequestContext(localVarPath, HttpMethod.PATCH);
    requestContext.setHeaderParam("Accept", "application/json");
    requestContext.setHttpConfig(_config.httpConfig);
  ...
  public async editSecurityMonitoringSignalState(signalId: string,body: SecurityMonitoringSignalStateUpdateRequest,_options?: Configuration): Promise<RequestContext> {
    const _config = _options || this.configuration;
    ...
    // Path Params
    const localVarPath = '/api/v2/security_monitoring/signals/{signal_id}/state'
      .replace('{signal_id}', encodeURIComponent(String(signalId)));

    // Make Request Context
    const requestContext = _config.getServer('v2.SecurityMonitoringApi.editSecurityMonitoringSignalState').makeRequestContext(localVarPath, HttpMethod.PATCH);
    requestContext.setHeaderParam("Accept", "application/json");
    requestContext.setHttpConfig(_config.httpConfig);
  ...
  public async exportSecurityMonitoringTerraformResource(resourceType: SecurityMonitoringTerraformResourceType,resourceId: string,_options?: Configuration): Promise<RequestContext> {
    const _config = _options || this.configuration;

    logger.warn("Using unstable operation 'exportSecurityMonitoringTerraformResource'");
    ...
    // Make Request Context
    const requestContext = _config.getServer('v2.SecurityMonitoringApi.exportSecurityMonitoringTerraformResource').makeRequestContext(localVarPath, HttpMethod.GET);
    requestContext.setHeaderParam("Accept", "application/json");
    requestContext.setHttpConfig(_config.httpConfig);
  ...
  public async getContentPacksStates(_options?: Configuration): Promise<RequestContext> {
    const _config = _options || this.configuration;
    ...
    // Make Request Context
    const requestContext = _config.getServer('v2.SecurityMonitoringApi.getContentPacksStates').makeRequestContext(localVarPath, HttpMethod.GET);
    requestContext.setHeaderParam("Accept", "application/json");
    requestContext.setHttpConfig(_config.httpConfig);
  ...
  public async getCriticalAssetsAffectingRule(ruleId: string,_options?: Configuration): Promise<RequestContext> {
    const _config = _options || this.configuration;
    ...
    // Path Params
    const localVarPath = '/api/v2/security_monitoring/configuration/critical_assets/rules/{rule_id}'
      .replace('{rule_id}', encodeURIComponent(String(ruleId)));

    // Make Request Context
    const requestContext = _config.getServer('v2.SecurityMonitoringApi.getCriticalAssetsAffectingRule').makeRequestContext(localVarPath, HttpMethod.GET);
    requestContext.setHeaderParam("Accept", "application/json");
    requestContext.setHttpConfig(_config.httpConfig);
  ...
  public async getCustomFramework(handle: string,version: string,_options?: Configuration): Promise<RequestContext> {
    const _config = _options || this.configuration;
    ...
    // Make Request Context
    const requestContext = _config.getServer('v2.SecurityMonitoringApi.getCustomFramework').makeRequestContext(localVarPath, HttpMethod.GET);
    requestContext.setHeaderParam("Accept", "application/json");
    requestContext.setHttpConfig(_config.httpConfig);
  ...
  public async getEntityContext(query?: string,from?: string,to?: string,asOf?: string,limit?: number,pageToken?: string,_options?: Configuration): Promise<RequestContext> {
    const _config = _options || this.configuration;
    ...
    // Make Request Context
    const requestContext = _config.getServer('v2.SecurityMonitoringApi.getEntityContext').makeRequestContext(localVarPath, HttpMethod.GET);
    requestContext.setHeaderParam("Accept", "application/json");
    requestContext.setHttpConfig(_config.httpConfig);
  ...
  if (asOf !== undefined) {
      requestContext.setQueryParam("as_of", ObjectSerializer.serialize(asOf, "string", ""
), "");
    }
  if (limit !== undefined) {
  ...
  public async getEntraIdAzureAppRegistrations(_options?: Configuration): Promise<RequestContext> {
    const _config = _options || this.configuration;

    logger.warn("Using unstable operation 'getEntraIdAzureAppRegistrations'");
    ...
    // Make Request Context
    const requestContext = _config.getServer('v2.SecurityMonitoringApi.getEntraIdAzureAppRegistrations').makeRequestContext(localVarPath, HttpMethod.GET);
    requestContext.setHeaderParam("Accept", "application/json");
    requestContext.setHttpConfig(_config.httpConfig);
  ...
  public async getFinding(findingId: string,snapshotTimestamp?: number,_options?: Configuration): Promise<RequestContext> {
    const _config = _options || this.configuration;
    ...
    // Path Params
    const localVarPath = '/api/v2/posture_management/findings/{finding_id}'
      .replace('{finding_id}', encodeURIComponent(String(findingId)));

    // Make Request Context
    const requestContext = _config.getServer('v2.SecurityMonitoringApi.getFinding').makeRequestContext(localVarPath, HttpMethod.GET);
    requestContext.setHeaderParam("Accept", "application/json");
    requestContext.setHttpConfig(_config.httpConfig);

    // Query Params
  if (snapshotTimestamp !== undefined) {
      requestContext.setQueryParam("snapshot_timestamp", ObjectSerializer.serialize(snapshotTimestamp, "number", "int64"
), "");
    }
  ...
  public async getHistoricalJob(jobId: string,_options?: Configuration): Promise<RequestContext> {
    const _config = _options || this.configuration;
    ...
    // Make Request Context
    const requestContext = _config.getServer('v2.SecurityMonitoringApi.getHistoricalJob').makeRequestContext(localVarPath, HttpMethod.GET);
    requestContext.setHeaderParam("Accept", "application/json");
    requestContext.setHttpConfig(_config.httpConfig);
  ...
  public async getIndicatorOfCompromise(indicator: string,ocsf?: boolean,includeTriageHistory?: boolean,triageHistoryLimit?: number,triageHistoryOffset?: number,_options?: Configuration): Promise<RequestContext> {
    const _config = _options || this.configuration;
    ...
    // Make Request Context
    const requestContext = _config.getServer('v2.SecurityMonitoringApi.getIndicatorOfCompromise').makeRequestContext(localVarPath, HttpMethod.GET);
    requestContext.setHeaderParam("Accept", "application/json");
    requestContext.setHttpConfig(_config.httpConfig);

    // Query Params
  if (indicator !== undefined) {
      requestContext.setQueryParam("indicator", ObjectSerializer.serialize(indicator, "string", ""
), "");
    }
  if (ocsf !== undefined) {
      requestContext.setQueryParam("ocsf", ObjectSerializer.serialize(ocsf, "boolean", ""
), "");
    }
  if (includeTriageHistory !== undefined) {
      requestContext.setQueryParam("include_triage_history", ObjectSerializer.serialize(includeTriageHistory, "boolean", ""
), "");
    }
  if (triageHistoryLimit !== undefined) {
      requestContext.setQueryParam("triage_history_limit", ObjectSerializer.serialize(triageHistoryLimit, "number", "int32"
), "");
    }
  if (triageHistoryOffset !== undefined) {
      requestContext.setQueryParam("triage_history_offset", ObjectSerializer.serialize(triageHistoryOffset, "number", "int32"
), "");
    }
  ...
  public async getInvestigationLogQueriesMatchingSignal(signalId: string,_options?: Configuration): Promise<RequestContext> {
    const _config = _options || this.configuration;
    ...
    // Path Params
    const localVarPath = '/api/v2/security_monitoring/signals/{signal_id}/investigation_queries'
      .replace('{signal_id}', encodeURIComponent(String(signalId)));

    // Make Request Context
    const requestContext = _config.getServer('v2.SecurityMonitoringApi.getInvestigationLogQueriesMatchingSignal').makeRequestContext(localVarPath, HttpMethod.GET);
    requestContext.setHeaderParam("Accept", "application/json");
    requestContext.setHttpConfig(_config.httpConfig);
  ...
  public async getResourceEvaluationFilters(cloudProvider?: string,accountId?: string,skipCache?: boolean,_options?: Configuration): Promise<RequestContext> {
    const _config = _options || this.configuration;
    ...
    // Make Request Context
    const requestContext = _config.getServer('v2.SecurityMonitoringApi.getResourceEvaluationFilters').makeRequestContext(localVarPath, HttpMethod.GET);
    requestContext.setHeaderParam("Accept", "application/json");
    requestContext.setHttpConfig(_config.httpConfig);

    // Query Params
  if (cloudProvider !== undefined) {
      requestContext.setQueryParam("cloud_provider", ObjectSerializer.serialize(cloudProvider, "string", ""
), "");
    }
  ...
  if (skipCache !== undefined) {
      requestContext.setQueryParam("skip_cache", ObjectSerializer.serialize(skipCache, "boolean", ""
), "");
    }
  ...
  public async getRuleVersionHistory(ruleId: string,pageSize?: number,pageNumber?: number,_options?: Configuration): Promise<RequestContext> {
    const _config = _options || this.configuration;
    ...
    // Path Params
    const localVarPath = '/api/v2/security_monitoring/rules/{rule_id}/version_history'
      .replace('{rule_id}', encodeURIComponent(String(ruleId)));

    // Make Request Context
    const requestContext = _config.getServer('v2.SecurityMonitoringApi.getRuleVersionHistory').makeRequestContext(localVarPath, HttpMethod.GET);
    requestContext.setHeaderParam("Accept", "application/json");
    requestContext.setHttpConfig(_config.httpConfig);
  ...
  public async getSBOM(assetType: AssetType,filterAssetName: string,filterRepoDigest?: string,extFormat?: SBOMFormat,_options?: Configuration): Promise<RequestContext> {
    const _config = _options || this.configuration;
    ...
    // Path Params
    const localVarPath = '/api/v2/security/sboms/{asset_type}'
      .replace('{asset_type}', encodeURIComponent(String(assetType)));

    // Make Request Context
    const requestContext = _config.getServer('v2.SecurityMonitoringApi.getSBOM').makeRequestContext(localVarPath, HttpMethod.GET);
    requestContext.setHeaderParam("Accept", "application/json");
    requestContext.setHttpConfig(_config.httpConfig);

    // Query Params
  if (filterAssetName !== undefined) {
      requestContext.setQueryParam("filter[asset_name]", ObjectSerializer.serialize(filterAssetName, "string", ""
), "");
    }
  if (filterRepoDigest !== undefined) {
      requestContext.setQueryParam("filter[repo_digest]", ObjectSerializer.serialize(filterRepoDigest, "string", ""
), "");
    }
  if (extFormat !== undefined) {
      requestContext.setQueryParam("ext:format", ObjectSerializer.serialize(extFormat, "SBOMFormat", ""
), "");
    }
  ...
  public async getSecretsRules(_options?: Configuration): Promise<RequestContext> {
    const _config = _options || this.configuration;
    ...
    // Make Request Context
    const requestContext = _config.getServer('v2.SecurityMonitoringApi.getSecretsRules').makeRequestContext(localVarPath, HttpMethod.GET);
    requestContext.setHeaderParam("Accept", "application/json");
    requestContext.setHttpConfig(_config.httpConfig);
  ...
  public async getSecurityFilter(securityFilterId: string,_options?: Configuration): Promise<RequestContext> {
    const _config = _options || this.configuration;
    ...
    // Make Request Context
    const requestContext = _config.getServer('v2.SecurityMonitoringApi.getSecurityFilter').makeRequestContext(localVarPath, HttpMethod.GET);
    requestContext.setHeaderParam("Accept", "application/json");
    requestContext.setHttpConfig(_config.httpConfig);
  ...
  public async getSecurityFindingsAutomationDueDateRule(ruleId: string,_options?: Configuration): Promise<RequestContext> {
    const _config = _options || this.configuration;

    logger.warn("Using unstable operation 'getSecurityFindingsAutomationDueDateRule'");
    ...
    // Make Request Context
    const requestContext = _config.getServer('v2.SecurityMonitoringApi.getSecurityFindingsAutomationDueDateRule').makeRequestContext(localVarPath, HttpMethod.GET);
    requestContext.setHeaderParam("Accept", "application/json");
    requestContext.setHttpConfig(_config.httpConfig);
  ...
  public async getSecurityFindingsAutomationMuteRule(ruleId: string,_options?: Configuration): Promise<RequestContext> {
    const _config = _options || this.configuration;

    logger.warn("Using unstable operation 'getSecurityFindingsAutomationMuteRule'");
    ...
    // Make Request Context
    const requestContext = _config.getServer('v2.SecurityMonitoringApi.getSecurityFindingsAutomationMuteRule').makeRequestContext(localVarPath, HttpMethod.GET);
    requestContext.setHeaderParam("Accept", "application/json");
    requestContext.setHttpConfig(_config.httpConfig);
  ...
  public async getSecurityFindingsAutomationTicketCreationRule(ruleId: string,_options?: Configuration): Promise<RequestContext> {
    const _config = _options || this.configuration;

    logger.warn("Using unstable operation 'getSecurityFindingsAutomationTicketCreationRule'");
    ...
    // Make Request Context
    const requestContext = _config.getServer('v2.SecurityMonitoringApi.getSecurityFindingsAutomationTicketCreationRule').makeRequestContext(localVarPath, HttpMethod.GET);
    requestContext.setHeaderParam("Accept", "application/json");
    requestContext.setHttpConfig(_config.httpConfig);
  ...
  public async getSecurityMonitoringCriticalAsset(criticalAssetId: string,_options?: Configuration): Promise<RequestContext> {
    const _config = _options || this.configuration;
    ...
    // Make Request Context
    const requestContext = _config.getServer('v2.SecurityMonitoringApi.getSecurityMonitoringCriticalAsset').makeRequestContext(localVarPath, HttpMethod.GET);
    requestContext.setHeaderParam("Accept", "application/json");
    requestContext.setHttpConfig(_config.httpConfig);
  ...
  public async getSecurityMonitoringDataset(datasetId: string,_options?: Configuration): Promise<RequestContext> {
    const _config = _options || this.configuration;
    ...
    // Make Request Context
    const requestContext = _config.getServer('v2.SecurityMonitoringApi.getSecurityMonitoringDataset').makeRequestContext(localVarPath, HttpMethod.GET);
    requestContext.setHeaderParam("Accept", "application/json");
    requestContext.setHttpConfig(_config.httpConfig);
  ...
  public async getSecurityMonitoringDatasetByVersion(datasetId: string,version: number,_options?: Configuration): Promise<RequestContext> {
    const _config = _options || this.configuration;

    logger.warn("Using unstable operation 'getSecurityMonitoringDatasetByVersion'");
    ...
    // Make Request Context
    const requestContext = _config.getServer('v2.SecurityMonitoringApi.getSecurityMonitoringDatasetByVersion').makeRequestContext(localVarPath, HttpMethod.GET);
    requestContext.setHeaderParam("Accept", "application/json");
    requestContext.setHttpConfig(_config.httpConfig);
  ...
  public async getSecurityMonitoringDatasetVersionHistory(datasetId: string,pageSize?: number,pageNumber?: number,_options?: Configuration): Promise<RequestContext> {
    const _config = _options || this.configuration;

    logger.warn("Using unstable operation 'getSecurityMonitoringDatasetVersionHistory'");
    ...
    // Path Params
    const localVarPath = '/api/v2/security_monitoring/datasets/{dataset_id}/version_history'
      .replace('{dataset_id}', encodeURIComponent(String(datasetId)));

    // Make Request Context
    const requestContext = _config.getServer('v2.SecurityMonitoringApi.getSecurityMonitoringDatasetVersionHistory').makeRequestContext(localVarPath, HttpMethod.GET);
    requestContext.setHeaderParam("Accept", "application/json");
    requestContext.setHttpConfig(_config.httpConfig);
  ...
  public async getSecurityMonitoringHistsignal(histsignalId: string,_options?: Configuration): Promise<RequestContext> {
    const _config = _options || this.configuration;
    ...
    // Path Params
    const localVarPath = '/api/v2/siem-historical-detections/histsignals/{histsignal_id}'
      .replace('{histsignal_id}', encodeURIComponent(String(histsignalId)));

    // Make Request Context
    const requestContext = _config.getServer('v2.SecurityMonitoringApi.getSecurityMonitoringHistsignal').makeRequestContext(localVarPath, HttpMethod.GET);
    requestContext.setHeaderParam("Accept", "application/json");
    requestContext.setHttpConfig(_config.httpConfig);
  ...
  public async getSecurityMonitoringHistsignalsByJobId(jobId: string,filterQuery?: string,filterFrom?: Date,filterTo?: Date,sort?: SecurityMonitoringSignalsSort,pageCursor?: string,pageLimit?: number,_options?: Configuration): Promise<RequestContext> {
    const _config = _options || this.configuration;

    logger.warn("Using unstable operation 'getSecurityMonitoringHistsignalsByJobId'");
    ...
    // Path Params
    const localVarPath = '/api/v2/siem-historical-detections/jobs/{job_id}/histsignals'
      .replace('{job_id}', encodeURIComponent(String(jobId)));

    // Make Request Context
    const requestContext = _config.getServer('v2.SecurityMonitoringApi.getSecurityMonitoringHistsignalsByJobId').makeRequestContext(localVarPath, HttpMethod.GET);
    requestContext.setHeaderParam("Accept", "application/json");
    requestContext.setHttpConfig(_config.httpConfig);
  ...
  public async getSecurityMonitoringIntegrationConfig(integrationConfigId: string,_options?: Configuration): Promise<RequestContext> {
    const _config = _options || this.configuration;

    logger.warn("Using unstable operation 'getSecurityMonitoringIntegrationConfig'");
    ...
    // Make Request Context
    const requestContext = _config.getServer('v2.SecurityMonitoringApi.getSecurityMonitoringIntegrationConfig').makeRequestContext(localVarPath, HttpMethod.GET);
    requestContext.setHeaderParam("Accept", "application/json");
    requestContext.setHttpConfig(_config.httpConfig);
  ...
  public async getSecurityMonitoringRule(ruleId: string,_options?: Configuration): Promise<RequestContext> {
    const _config = _options || this.configuration;
    ...
    // Make Request Context
    const requestContext = _config.getServer('v2.SecurityMonitoringApi.getSecurityMonitoringRule').makeRequestContext(localVarPath, HttpMethod.GET);
    requestContext.setHeaderParam("Accept", "application/json");
    requestContext.setHttpConfig(_config.httpConfig);
  ...
  public async getSecurityMonitoringSignal(signalId: string,_options?: Configuration): Promise<RequestContext> {
    const _config = _options || this.configuration;
    ...
    // Path Params
    const localVarPath = '/api/v2/security_monitoring/signals/{signal_id}'
      .replace('{signal_id}', encodeURIComponent(String(signalId)));

    // Make Request Context
    const requestContext = _config.getServer('v2.SecurityMonitoringApi.getSecurityMonitoringSignal').makeRequestContext(localVarPath, HttpMethod.GET);
    requestContext.setHeaderParam("Accept", "application/json");
    requestContext.setHttpConfig(_config.httpConfig);
  ...
  public async getSecurityMonitoringSuppression(suppressionId: string,_options?: Configuration): Promise<RequestContext> {
    const _config = _options || this.configuration;
    ...
    // Make Request Context
    const requestContext = _config.getServer('v2.SecurityMonitoringApi.getSecurityMonitoringSuppression').makeRequestContext(localVarPath, HttpMethod.GET);
    requestContext.setHeaderParam("Accept", "application/json");
    requestContext.setHttpConfig(_config.httpConfig);
  ...
  public async getSignalEntities(signalId: string,limit?: number,_options?: Configuration): Promise<RequestContext> {
    const _config = _options || this.configuration;
    ...
    // Path Params
    const localVarPath = '/api/v2/security_monitoring/signals/{signal_id}/entities'
      .replace('{signal_id}', encodeURIComponent(String(signalId)));

    // Make Request Context
    const requestContext = _config.getServer('v2.SecurityMonitoringApi.getSignalEntities').makeRequestContext(localVarPath, HttpMethod.GET);
    requestContext.setHeaderParam("Accept", "application/json");
    requestContext.setHttpConfig(_config.httpConfig);
  ...
  public async getSignalNotificationRule(id: string,_options?: Configuration): Promise<RequestContext> {
    const _config = _options || this.configuration;
    ...
    // Make Request Context
    const requestContext = _config.getServer('v2.SecurityMonitoringApi.getSignalNotificationRule').makeRequestContext(localVarPath, HttpMethod.GET);
    requestContext.setHeaderParam("Accept", "application/json");
    requestContext.setHttpConfig(_config.httpConfig);
  ...
  public async getSignalNotificationRules(_options?: Configuration): Promise<RequestContext> {
    const _config = _options || this.configuration;
    ...
    // Make Request Context
    const requestContext = _config.getServer('v2.SecurityMonitoringApi.getSignalNotificationRules').makeRequestContext(localVarPath, HttpMethod.GET);
    requestContext.setHeaderParam("Accept", "application/json");
    requestContext.setHttpConfig(_config.httpConfig);
  ...
  public async getSingleEntityContext(id: string,from?: string,to?: string,asOf?: string,_options?: Configuration): Promise<RequestContext> {
    const _config = _options || this.configuration;

    logger.warn("Using unstable operation 'getSingleEntityContext'");
    ...
    // Path Params
    const localVarPath = '/api/v2/security_monitoring/entity_context/{id}'
      .replace('{id}', encodeURIComponent(String(id)));

    // Make Request Context
    const requestContext = _config.getServer('v2.SecurityMonitoringApi.getSingleEntityContext').makeRequestContext(localVarPath, HttpMethod.GET);
    requestContext.setHeaderParam("Accept", "application/json");
    requestContext.setHttpConfig(_config.httpConfig);
  ...
  public async getStaticAnalysisDefaultRulesets(language: string,_options?: Configuration): Promise<RequestContext> {
    const _config = _options || this.configuration;
    ...
    // Path Params
    const localVarPath = '/api/v2/static-analysis/default-rulesets/{language}'
      .replace('{language}', encodeURIComponent(String(language)));

    // Make Request Context
    const requestContext = _config.getServer('v2.SecurityMonitoringApi.getStaticAnalysisDefaultRulesets').makeRequestContext(localVarPath, HttpMethod.GET);
    requestContext.setHeaderParam("Accept", "application/json");
    requestContext.setHttpConfig(_config.httpConfig);
  ...
  public async getStaticAnalysisNodeTypes(language: string,_options?: Configuration): Promise<RequestContext> {
    const _config = _options || this.configuration;
    ...
    // Path Params
    const localVarPath = '/api/v2/static-analysis/static-analysis-server/node-types/{language}'
      .replace('{language}', encodeURIComponent(String(language)));

    // Make Request Context
    const requestContext = _config.getServer('v2.SecurityMonitoringApi.getStaticAnalysisNodeTypes').makeRequestContext(localVarPath, HttpMethod.GET);
    requestContext.setHeaderParam("Accept", "application/json");
    requestContext.setHttpConfig(_config.httpConfig);
  ...
  public async getStaticAnalysisRuleset(rulesetName: string,includeTests?: boolean,includeTestingRules?: boolean,_options?: Configuration): Promise<RequestContext> {
    const _config = _options || this.configuration;
    ...
    // Path Params
    const localVarPath = '/api/v2/static-analysis/rulesets/{ruleset_name}'
      .replace('{ruleset_name}', encodeURIComponent(String(rulesetName)));

    // Make Request Context
    const requestContext = _config.getServer('v2.SecurityMonitoringApi.getStaticAnalysisRuleset').makeRequestContext(localVarPath, HttpMethod.GET);
    requestContext.setHeaderParam("Accept", "application/json");
    requestContext.setHttpConfig(_config.httpConfig);

    // Query Params
  if (includeTests !== undefined) {
      requestContext.setQueryParam("include_tests", ObjectSerializer.serialize(includeTests, "boolean", ""
), "");
    }
  if (includeTestingRules !== undefined) {
      requestContext.setQueryParam("include_testing_rules", ObjectSerializer.serialize(includeTestingRules, "boolean", ""
), "");
    }
  ...
  public async getStaticAnalysisTreeSitterWasm(file: string,_options?: Configuration): Promise<RequestContext> {
    const _config = _options || this.configuration;
    ...
    // Path Params
    const localVarPath = '/api/v2/static-analysis/static-analysis-server/tree-sitter-wasm/{file}'
      .replace('{file}', encodeURIComponent(String(file)));

    // Make Request Context
    const requestContext = _config.getServer('v2.SecurityMonitoringApi.getStaticAnalysisTreeSitterWasm').makeRequestContext(localVarPath, HttpMethod.GET);
  ...
  public async getSuggestedActionsMatchingSignal(signalId: string,_options?: Configuration): Promise<RequestContext> {
    const _config = _options || this.configuration;
    ...
    // Path Params
    const localVarPath = '/api/v2/security_monitoring/signals/{signal_id}/suggested_actions'
      .replace('{signal_id}', encodeURIComponent(String(signalId)));

    // Make Request Context
    const requestContext = _config.getServer('v2.SecurityMonitoringApi.getSuggestedActionsMatchingSignal').makeRequestContext(localVarPath, HttpMethod.GET);
    requestContext.setHeaderParam("Accept", "application/json");
    requestContext.setHttpConfig(_config.httpConfig);
  ...
  public async getSuppressionsAffectingFutureRule(body: SecurityMonitoringRuleCreatePayload,_options?: Configuration): Promise<RequestContext> {
    const _config = _options || this.configuration;
    ...
    // Make Request Context
    const requestContext = _config.getServer('v2.SecurityMonitoringApi.getSuppressionsAffectingFutureRule').makeRequestContext(localVarPath, HttpMethod.POST);
    requestContext.setHeaderParam("Accept", "application/json");
    requestContext.setHttpConfig(_config.httpConfig);
  ...
  public async getSuppressionsAffectingRule(ruleId: string,_options?: Configuration): Promise<RequestContext> {
    const _config = _options || this.configuration;
    ...
    // Path Params
    const localVarPath = '/api/v2/security_monitoring/configuration/suppressions/rules/{rule_id}'
      .replace('{rule_id}', encodeURIComponent(String(ruleId)));

    // Make Request Context
    const requestContext = _config.getServer('v2.SecurityMonitoringApi.getSuppressionsAffectingRule').makeRequestContext(localVarPath, HttpMethod.GET);
    requestContext.setHeaderParam("Accept", "application/json");
    requestContext.setHttpConfig(_config.httpConfig);
  ...
  public async getSuppressionVersionHistory(suppressionId: string,pageSize?: number,pageNumber?: number,_options?: Configuration): Promise<RequestContext> {
    const _config = _options || this.configuration;
    ...
    // Path Params
    const localVarPath = '/api/v2/security_monitoring/configuration/suppressions/{suppression_id}/version_history'
      .replace('{suppression_id}', encodeURIComponent(String(suppressionId)));

    // Make Request Context
    const requestContext = _config.getServer('v2.SecurityMonitoringApi.getSuppressionVersionHistory').makeRequestContext(localVarPath, HttpMethod.GET);
    requestContext.setHeaderParam("Accept", "application/json");
    requestContext.setHttpConfig(_config.httpConfig);
  ...
  public async getVulnerabilityNotificationRule(id: string,_options?: Configuration): Promise<RequestContext> {
    const _config = _options || this.configuration;
    ...
    // Make Request Context
    const requestContext = _config.getServer('v2.SecurityMonitoringApi.getVulnerabilityNotificationRule').makeRequestContext(localVarPath, HttpMethod.GET);
    requestContext.setHeaderParam("Accept", "application/json");
    requestContext.setHttpConfig(_config.httpConfig);
  ...
  public async getVulnerabilityNotificationRules(_options?: Configuration): Promise<RequestContext> {
    const _config = _options || this.configuration;
    ...
    // Make Request Context
    const requestContext = _config.getServer('v2.SecurityMonitoringApi.getVulnerabilityNotificationRules').makeRequestContext(localVarPath, HttpMethod.GET);
    requestContext.setHeaderParam("Accept", "application/json");
    requestContext.setHttpConfig(_config.httpConfig);
  ...
  public async importSecurityVulnerabilities(body: CycloneDXBom,_options?: Configuration): Promise<RequestContext> {
    const _config = _options || this.configuration;
    ...
    // Make Request Context
    const requestContext = _config.getServer('v2.SecurityMonitoringApi.importSecurityVulnerabilities').makeRequestContext(localVarPath, HttpMethod.POST);
    requestContext.setHeaderParam("Accept", "*/*");
    requestContext.setHttpConfig(_config.httpConfig);
  ...
  public async listAssetsSBOMs(pageToken?: string,pageNumber?: number,filterAssetType?: AssetType,filterAssetName?: string,filterPackageName?: string,filterPackageVersion?: string,filterLicenseName?: string,filterLicenseType?: SBOMComponentLicenseType,_options?: Configuration): Promise<RequestContext> {
    const _config = _options || this.configuration;
    ...
    // Make Request Context
    const requestContext = _config.getServer('v2.SecurityMonitoringApi.listAssetsSBOMs').makeRequestContext(localVarPath, HttpMethod.GET);
    requestContext.setHeaderParam("Accept", "application/json");
    requestContext.setHttpConfig(_config.httpConfig);
  ...
  if (filterAssetType !== undefined) {
      requestContext.setQueryParam("filter[asset_type]", ObjectSerializer.serialize(filterAssetType, "AssetType", ""
), "");
    }
  if (filterAssetName !== undefined) {
      requestContext.setQueryParam("filter[asset_name]", ObjectSerializer.serialize(filterAssetName, "string", ""
  ...
  if (filterPackageName !== undefined) {
      requestContext.setQueryParam("filter[package_name]", ObjectSerializer.serialize(filterPackageName, "string", ""
), "");
    }
  if (filterPackageVersion !== undefined) {
      requestContext.setQueryParam("filter[package_version]", ObjectSerializer.serialize(filterPackageVersion, "string", ""
), "");
    }
  if (filterLicenseName !== undefined) {
      requestContext.setQueryParam("filter[license_name]", ObjectSerializer.serialize(filterLicenseName, "string", ""
), "");
    }
  if (filterLicenseType !== undefined) {
      requestContext.setQueryParam("filter[license_type]", ObjectSerializer.serialize(filterLicenseType, "SBOMComponentLicenseType", ""
), "");
    }
  ...
  public async listFindings(pageLimit?: number,snapshotTimestamp?: number,pageCursor?: string,filterTags?: string,filterEvaluationChangedAt?: string,filterMuted?: boolean,filterRuleId?: string,filterRuleName?: string,filterResourceType?: string,filterResourceId?: string,filterDiscoveryTimestamp?: string,filterEvaluation?: FindingEvaluation,filterStatus?: FindingStatus,filterVulnerabilityType?: Array<FindingVulnerabilityType>,detailedFindings?: boolean,_options?: Configuration): Promise<RequestContext> {
    ...
    // Make Request Context
    const requestContext = _config.getServer('v2.SecurityMonitoringApi.listFindings').makeRequestContext(localVarPath, HttpMethod.GET);
    requestContext.setHeaderParam("Accept", "application/json");
    requestContext.setHttpConfig(_config.httpConfig);
  ...
  if (filterEvaluationChangedAt !== undefined) {
      requestContext.setQueryParam("filter[evaluation_changed_at]", ObjectSerializer.serialize(filterEvaluationChangedAt, "string", ""
), "");
    }
  ...
  if (filterRuleName !== undefined) {
      requestContext.setQueryParam("filter[rule_name]", ObjectSerializer.serialize(filterRuleName, "string", ""
), "");
    }
  if (filterResourceType !== undefined) {
      requestContext.setQueryParam("filter[resource_type]", ObjectSerializer.serialize(filterResourceType, "string", ""
), "");
    }
  ...
  if (filterDiscoveryTimestamp !== undefined) {
      requestContext.setQueryParam("filter[discovery_timestamp]", ObjectSerializer.serialize(filterDiscoveryTimestamp, "string", ""
), "");
    }
  ...
  if (filterStatus !== undefined) {
      requestContext.setQueryParam("filter[status]", ObjectSerializer.serialize(filterStatus, "FindingStatus", ""
), "");
    }
  if (filterVulnerabilityType !== undefined) {
      requestContext.setQueryParam("filter[vulnerability_type]", ObjectSerializer.serialize(filterVulnerabilityType, "Array<FindingVulnerabilityType>", ""
), "multi");
    }
  if (detailedFindings !== undefined) {
      requestContext.setQueryParam("detailed_findings", ObjectSerializer.serialize(detailedFindings, "boolean", ""
), "");
    }
  ...
  public async listHistoricalJobs(pageSize?: number,pageNumber?: number,sort?: string,filterQuery?: string,_options?: Configuration): Promise<RequestContext> {
    const _config = _options || this.configuration;
    ...
    // Make Request Context
    const requestContext = _config.getServer('v2.SecurityMonitoringApi.listHistoricalJobs').makeRequestContext(localVarPath, HttpMethod.GET);
    requestContext.setHeaderParam("Accept", "application/json");
    requestContext.setHttpConfig(_config.httpConfig);
  ...
  public async listIndicatorsOfCompromise(limit?: number,offset?: number,query?: string,sortColumn?: string,sortOrder?: string,ocsf?: boolean,workedBy?: string,triageState?: IoCTriageState,_options?: Configuration): Promise<RequestContext> {
    const _config = _options || this.configuration;
    ...
    // Make Request Context
    const requestContext = _config.getServer('v2.SecurityMonitoringApi.listIndicatorsOfCompromise').makeRequestContext(localVarPath, HttpMethod.GET);
    requestContext.setHeaderParam("Accept", "application/json");
    requestContext.setHttpConfig(_config.httpConfig);
  ...
  if (sortColumn !== undefined) {
      requestContext.setQueryParam("sort[column]", ObjectSerializer.serialize(sortColumn, "string", ""
), "");
    }
  ...
  if (workedBy !== undefined) {
      requestContext.setQueryParam("worked_by", ObjectSerializer.serialize(workedBy, "string", ""
), "");
    }
  if (triageState !== undefined) {
      requestContext.setQueryParam("triage_state", ObjectSerializer.serialize(triageState, "IoCTriageState", ""
), "");
    }
  ...
  public async listMultipleRulesets(body: GetMultipleRulesetsRequest,_options?: Configuration): Promise<RequestContext> {
    const _config = _options || this.configuration;
    ...
    // Make Request Context
    const requestContext = _config.getServer('v2.SecurityMonitoringApi.listMultipleRulesets').makeRequestContext(localVarPath, HttpMethod.POST);
    requestContext.setHeaderParam("Accept", "application/json");
    requestContext.setHttpConfig(_config.httpConfig);
  ...
  public async listSampleLogGenerationSubscriptions(status?: SampleLogGenerationSubscriptionsStatusFilter,startTimestamp?: Date,endTimestamp?: Date,_options?: Configuration): Promise<RequestContext> {
    const _config = _options || this.configuration;

    logger.warn("Using unstable operation 'listSampleLogGenerationSubscriptions'");
    ...
    // Make Request Context
    const requestContext = _config.getServer('v2.SecurityMonitoringApi.listSampleLogGenerationSubscriptions').makeRequestContext(localVarPath, HttpMethod.GET);
    requestContext.setHeaderParam("Accept", "application/json");
    requestContext.setHttpConfig(_config.httpConfig);

    // Query Params
  if (status !== undefined) {
      requestContext.setQueryParam("status", ObjectSerializer.serialize(status, "SampleLogGenerationSubscriptionsStatusFilter", ""
), "");
    }
  if (startTimestamp !== undefined) {
      requestContext.setQueryParam("start_timestamp", ObjectSerializer.serialize(startTimestamp, "Date", "date-time"
), "");
    }
  if (endTimestamp !== undefined) {
      requestContext.setQueryParam("end_timestamp", ObjectSerializer.serialize(endTimestamp, "Date", "date-time"
), "");
    }
  ...
  public async listScannedAssetsMetadata(pageToken?: string,pageNumber?: number,filterAssetType?: CloudAssetType,filterAssetName?: string,filterLastSuccessOrigin?: string,filterLastSuccessEnv?: string,_options?: Configuration): Promise<RequestContext> {
    const _config = _options || this.configuration;
    ...
    // Make Request Context
    const requestContext = _config.getServer('v2.SecurityMonitoringApi.listScannedAssetsMetadata').makeRequestContext(localVarPath, HttpMethod.GET);
    requestContext.setHeaderParam("Accept", "application/json");
    requestContext.setHttpConfig(_config.httpConfig);
  ...
  if (filterAssetType !== undefined) {
      requestContext.setQueryParam("filter[asset.type]", ObjectSerializer.serialize(filterAssetType, "CloudAssetType", ""
), "");
    }
  if (filterAssetName !== undefined) {
      requestContext.setQueryParam("filter[asset.name]", ObjectSerializer.serialize(filterAssetName, "string", ""
), "");
    }
  if (filterLastSuccessOrigin !== undefined) {
      requestContext.setQueryParam("filter[last_success.origin]", ObjectSerializer.serialize(filterLastSuccessOrigin, "string", ""
), "");
    }
  if (filterLastSuccessEnv !== undefined) {
      requestContext.setQueryParam("filter[last_success.env]", ObjectSerializer.serialize(filterLastSuccessEnv, "string", ""
), "");
    }
  ...
  public async listSecurityFilters(_options?: Configuration): Promise<RequestContext> {
    const _config = _options || this.configuration;
    ...
    // Make Request Context
    const requestContext = _config.getServer('v2.SecurityMonitoringApi.listSecurityFilters').makeRequestContext(localVarPath, HttpMethod.GET);
    requestContext.setHeaderParam("Accept", "application/json");
    requestContext.setHttpConfig(_config.httpConfig);
  ...
  public async listSecurityFilterVersions(_options?: Configuration): Promise<RequestContext> {
    const _config = _options || this.configuration;
    ...
    // Make Request Context
    const requestContext = _config.getServer('v2.SecurityMonitoringApi.listSecurityFilterVersions').makeRequestContext(localVarPath, HttpMethod.GET);
    requestContext.setHeaderParam("Accept", "application/json");
    requestContext.setHttpConfig(_config.httpConfig);
  ...
  public async listSecurityFindings(filterQuery?: string,pageCursor?: string,pageLimit?: number,sort?: SecurityFindingsSort,_options?: Configuration): Promise<RequestContext> {
    const _config = _options || this.configuration;
    ...
    // Make Request Context
    const requestContext = _config.getServer('v2.SecurityMonitoringApi.listSecurityFindings').makeRequestContext(localVarPath, HttpMethod.GET);
    requestContext.setHeaderParam("Accept", "application/json");
    requestContext.setHttpConfig(_config.httpConfig);
  ...
  if (sort !== undefined) {
      requestContext.setQueryParam("sort", ObjectSerializer.serialize(sort, "SecurityFindingsSort", ""
), "");
    }
  ...
  public async listSecurityFindingsAutomationDueDateRules(pageSize?: number,pageNumber?: number,_options?: Configuration): Promise<RequestContext> {
    const _config = _options || this.configuration;

    logger.warn("Using unstable operation 'listSecurityFindingsAutomationDueDateRules'");
    ...
    // Make Request Context
    const requestContext = _config.getServer('v2.SecurityMonitoringApi.listSecurityFindingsAutomationDueDateRules').makeRequestContext(localVarPath, HttpMethod.GET);
    requestContext.setHeaderParam("Accept", "application/json");
    requestContext.setHttpConfig(_config.httpConfig);
  ...
  public async listSecurityFindingsAutomationMuteRules(pageSize?: number,pageNumber?: number,_options?: Configuration): Promise<RequestContext> {
    const _config = _options || this.configuration;

    logger.warn("Using unstable operation 'listSecurityFindingsAutomationMuteRules'");
    ...
    // Make Request Context
    const requestContext = _config.getServer('v2.SecurityMonitoringApi.listSecurityFindingsAutomationMuteRules').makeRequestContext(localVarPath, HttpMethod.GET);
    requestContext.setHeaderParam("Accept", "application/json");
    requestContext.setHttpConfig(_config.httpConfig);
  ...
  public async listSecurityFindingsAutomationTicketCreationRules(pageSize?: number,pageNumber?: number,_options?: Configuration): Promise<RequestContext> {
    const _config = _options || this.configuration;

    logger.warn("Using unstable operation 'listSecurityFindingsAutomationTicketCreationRules'");
    ...
    // Make Request Context
    const requestContext = _config.getServer('v2.SecurityMonitoringApi.listSecurityFindingsAutomationTicketCreationRules').makeRequestContext(localVarPath, HttpMethod.GET);
    requestContext.setHeaderParam("Accept", "application/json");
    requestContext.setHttpConfig(_config.httpConfig);
  ...
  public async listSecurityMonitoringCriticalAssets(_options?: Configuration): Promise<RequestContext> {
    const _config = _options || this.configuration;
    ...
    // Make Request Context
    const requestContext = _config.getServer('v2.SecurityMonitoringApi.listSecurityMonitoringCriticalAssets').makeRequestContext(localVarPath, HttpMethod.GET);
    requestContext.setHeaderParam("Accept", "application/json");
    requestContext.setHttpConfig(_config.httpConfig);
  ...
  public async listSecurityMonitoringDatasets(pageSize?: number,pageNumber?: number,sort?: string,filterQuery?: string,_options?: Configuration): Promise<RequestContext> {
    const _config = _options || this.configuration;
    ...
    // Make Request Context
    const requestContext = _config.getServer('v2.SecurityMonitoringApi.listSecurityMonitoringDatasets').makeRequestContext(localVarPath, HttpMethod.GET);
    requestContext.setHeaderParam("Accept", "application/json");
    requestContext.setHttpConfig(_config.httpConfig);
  ...
  public async listSecurityMonitoringHistsignals(filterQuery?: string,filterFrom?: Date,filterTo?: Date,sort?: SecurityMonitoringSignalsSort,pageCursor?: string,pageLimit?: number,_options?: Configuration): Promise<RequestContext> {
    const _config = _options || this.configuration;
    ...
    // Make Request Context
    const requestContext = _config.getServer('v2.SecurityMonitoringApi.listSecurityMonitoringHistsignals').makeRequestContext(localVarPath, HttpMethod.GET);
    requestContext.setHeaderParam("Accept", "application/json");
    requestContext.setHttpConfig(_config.httpConfig);
  ...
  public async listSecurityMonitoringIntegrationConfigs(filterIntegrationType?: SecurityMonitoringIntegrationType,_options?: Configuration): Promise<RequestContext> {
    const _config = _options || this.configuration;

    logger.warn("Using unstable operation 'listSecurityMonitoringIntegrationConfigs'");
    ...
    // Make Request Context
    const requestContext = _config.getServer('v2.SecurityMonitoringApi.listSecurityMonitoringIntegrationConfigs').makeRequestContext(localVarPath, HttpMethod.GET);
    requestContext.setHeaderParam("Accept", "application/json");
    requestContext.setHttpConfig(_config.httpConfig);

    // Query Params
  if (filterIntegrationType !== undefined) {
      requestContext.setQueryParam("filter[integration_type]", ObjectSerializer.serialize(filterIntegrationType, "SecurityMonitoringIntegrationType", ""
), "");
    }
  ...
  public async listSecurityMonitoringRules(pageSize?: number,pageNumber?: number,query?: string,sort?: SecurityMonitoringRuleSort,_options?: Configuration): Promise<RequestContext> {
    const _config = _options || this.configuration;
    ...
    // Make Request Context
    const requestContext = _config.getServer('v2.SecurityMonitoringApi.listSecurityMonitoringRules').makeRequestContext(localVarPath, HttpMethod.GET);
    requestContext.setHeaderParam("Accept", "application/json");
    requestContext.setHttpConfig(_config.httpConfig);
  ...
  if (sort !== undefined) {
      requestContext.setQueryParam("sort", ObjectSerializer.serialize(sort, "SecurityMonitoringRuleSort", ""
), "");
    }
  ...
  public async listSecurityMonitoringSignals(filterQuery?: string,filterFrom?: Date,filterTo?: Date,sort?: SecurityMonitoringSignalsSort,pageCursor?: string,pageLimit?: number,_options?: Configuration): Promise<RequestContext> {
    const _config = _options || this.configuration;
    ...
    // Make Request Context
    const requestContext = _config.getServer('v2.SecurityMonitoringApi.listSecurityMonitoringSignals').makeRequestContext(localVarPath, HttpMethod.GET);
    requestContext.setHeaderParam("Accept", "application/json");
    requestContext.setHttpConfig(_config.httpConfig);
  ...
  public async listSecurityMonitoringSuppressions(query?: string,sort?: SecurityMonitoringSuppressionSort,pageSize?: number,pageNumber?: number,_options?: Configuration): Promise<RequestContext> {
    const _config = _options || this.configuration;
    ...
    // Make Request Context
    const requestContext = _config.getServer('v2.SecurityMonitoringApi.listSecurityMonitoringSuppressions').makeRequestContext(localVarPath, HttpMethod.GET);
    requestContext.setHeaderParam("Accept", "application/json");
    requestContext.setHttpConfig(_config.httpConfig);
  ...
  if (sort !== undefined) {
      requestContext.setQueryParam("sort", ObjectSerializer.serialize(sort, "SecurityMonitoringSuppressionSort", ""
), "");
    }
  if (pageSize !== undefined) {
      requestContext.setQueryParam("page[size]", ObjectSerializer.serialize(pageSize, "number", "int64"
  ...
  public async listStaticAnalysisCodegenRulesets(_options?: Configuration): Promise<RequestContext> {
    const _config = _options || this.configuration;
    ...
    // Make Request Context
    const requestContext = _config.getServer('v2.SecurityMonitoringApi.listStaticAnalysisCodegenRulesets').makeRequestContext(localVarPath, HttpMethod.GET);
    requestContext.setHeaderParam("Accept", "application/json");
    requestContext.setHttpConfig(_config.httpConfig);
  ...
  public async listVulnerabilities(pageToken?: string,pageNumber?: number,filterType?: VulnerabilityType,filterCvssBaseScoreOp?: number,filterCvssBaseSeverity?: VulnerabilitySeverity,filterCvssBaseVector?: string,filterCvssDatadogScoreOp?: number,filterCvssDatadogSeverity?: VulnerabilitySeverity,filterCvssDatadogVector?: string,filterStatus?: VulnerabilityStatus,filterTool?: VulnerabilityTool,filterLibraryName?: string,filterLibraryVersion?: string,filterAdvisoryId?: string,filterRisksExploitationProbability?: boolean,filterRisksPocExploitAvailable?: boolean,filterRisksExploitAvailable?: boolean,filterRisksEpssScoreOp?: number,filterRisksEpssSeverity?: VulnerabilitySeverity,filterLanguage?: string,filterEcosystem?: VulnerabilityEcosystem,filterCodeLocationLocation?: string,filterCodeLocationFilePath?: string,filterCodeLocationMethod?: string,filterFixAvailable?: boolean,filterRepoDigests?: string,filterOrigin?: string,filterRunningKernel?: boolean,filterAssetName?: string,filterAssetType?: AssetType,filterAssetVersionFirst?: string,filterAssetVersionLast?: string,filterAssetRepositoryUrl?: string,filterAssetRisksInProduction?: boolean,filterAssetRisksUnderAttack?: boolean,filterAssetRisksIsPubliclyAccessible?: boolean,filterAssetRisksHasPrivilegedAccess?: boolean,filterAssetRisksHasAccessToSensitiveData?: boolean,filterAssetEnvironments?: string,filterAssetTeams?: string,filterAssetArch?: string,filterAssetOperatingSystemName?: string,filterAssetOperatingSystemVersion?: string,_options?: Configuration): Promise<RequestContext> {
    ...
    // Make Request Context
    const requestContext = _config.getServer('v2.SecurityMonitoringApi.listVulnerabilities').makeRequestContext(localVarPath, HttpMethod.GET);
    requestContext.setHeaderParam("Accept", "application/json");
    requestContext.setHttpConfig(_config.httpConfig);
  ...
  if (filterCvssBaseScoreOp !== undefined) {
      requestContext.setQueryParam("filter[cvss.base.score][`$op`]", ObjectSerializer.serialize(filterCvssBaseScoreOp, "number", "double"
), "");
    }
  if (filterCvssBaseSeverity !== undefined) {
      requestContext.setQueryParam("filter[cvss.base.severity]", ObjectSerializer.serialize(filterCvssBaseSeverity, "VulnerabilitySeverity", ""
), "");
    }
  if (filterCvssBaseVector !== undefined) {
      requestContext.setQueryParam("filter[cvss.base.vector]", ObjectSerializer.serialize(filterCvssBaseVector, "string", ""
), "");
    }
  if (filterCvssDatadogScoreOp !== undefined) {
      requestContext.setQueryParam("filter[cvss.datadog.score][`$op`]", ObjectSerializer.serialize(filterCvssDatadogScoreOp, "number", "double"
), "");
    }
  if (filterCvssDatadogSeverity !== undefined) {
      requestContext.setQueryParam("filter[cvss.datadog.severity]", ObjectSerializer.serialize(filterCvssDatadogSeverity, "VulnerabilitySeverity", ""
), "");
    }
  if (filterCvssDatadogVector !== undefined) {
      requestContext.setQueryParam("filter[cvss.datadog.vector]", ObjectSerializer.serialize(filterCvssDatadogVector, "string", ""
), "");
    }
  if (filterStatus !== undefined) {
      requestContext.setQueryParam("filter[status]", ObjectSerializer.serialize(filterStatus, "VulnerabilityStatus", ""
), "");
    }
  if (filterTool !== undefined) {
      requestContext.setQueryParam("filter[tool]", ObjectSerializer.serialize(filterTool, "VulnerabilityTool", ""
), "");
    }
  if (filterLibraryName !== undefined) {
      requestContext.setQueryParam("filter[library.name]", ObjectSerializer.serialize(filterLibraryName, "string", ""
), "");
    }
  if (filterLibraryVersion !== undefined) {
      requestContext.setQueryParam("filter[library.version]", ObjectSerializer.serialize(filterLibraryVersion, "string", ""
), "");
    }
  if (filterAdvisoryId !== undefined) {
      requestContext.setQueryParam("filter[advisory.id]", ObjectSerializer.serialize(filterAdvisoryId, "string", ""
), "");
    }
  if (filterRisksExploitationProbability !== undefined) {
      requestContext.setQueryParam("filter[risks.exploitation_probability]", ObjectSerializer.serialize(filterRisksExploitationProbability, "boolean", ""
), "");
    }
  if (filterRisksPocExploitAvailable !== undefined) {
      requestContext.setQueryParam("filter[risks.poc_exploit_available]", ObjectSerializer.serialize(filterRisksPocExploitAvailable, "boolean", ""
), "");
    }
  if (filterRisksExploitAvailable !== undefined) {
      requestContext.setQueryParam("filter[risks.exploit_available]", ObjectSerializer.serialize(filterRisksExploitAvailable, "boolean", ""
), "");
    }
  if (filterRisksEpssScoreOp !== undefined) {
      requestContext.setQueryParam("filter[risks.epss.score][`$op`]", ObjectSerializer.serialize(filterRisksEpssScoreOp, "number", "double"
), "");
    }
  if (filterRisksEpssSeverity !== undefined) {
      requestContext.setQueryParam("filter[risks.epss.severity]", ObjectSerializer.serialize(filterRisksEpssSeverity, "VulnerabilitySeverity", ""
), "");
    }
  if (filterLanguage !== undefined) {
      requestContext.setQueryParam("filter[language]", ObjectSerializer.serialize(filterLanguage, "string", ""
), "");
    }
  if (filterEcosystem !== undefined) {
      requestContext.setQueryParam("filter[ecosystem]", ObjectSerializer.serialize(filterEcosystem, "VulnerabilityEcosystem", ""
), "");
    }
  if (filterCodeLocationLocation !== undefined) {
      requestContext.setQueryParam("filter[code_location.location]", ObjectSerializer.serialize(filterCodeLocationLocation, "string", ""
), "");
    }
  if (filterCodeLocationFilePath !== undefined) {
      requestContext.setQueryParam("filter[code_location.file_path]", ObjectSerializer.serialize(filterCodeLocationFilePath, "string", ""
), "");
    }
  if (filterCodeLocationMethod !== undefined) {
      requestContext.setQueryParam("filter[code_location.method]", ObjectSerializer.serialize(filterCodeLocationMethod, "string", ""
), "");
    }
  if (filterFixAvailable !== undefined) {
      requestContext.setQueryParam("filter[fix_available]", ObjectSerializer.serialize(filterFixAvailable, "boolean", ""
), "");
    }
  if (filterRepoDigests !== undefined) {
      requestContext.setQueryParam("filter[repo_digests]", ObjectSerializer.serialize(filterRepoDigests, "string", ""
), "");
    }
  if (filterOrigin !== undefined) {
      requestContext.setQueryParam("filter[origin]", ObjectSerializer.serialize(filterOrigin, "string", ""
), "");
    }
  if (filterRunningKernel !== undefined) {
      requestContext.setQueryParam("filter[running_kernel]", ObjectSerializer.serialize(filterRunningKernel, "boolean", ""
), "");
    }
  if (filterAssetName !== undefined) {
      requestContext.setQueryParam("filter[asset.name]", ObjectSerializer.serialize(filterAssetName, "string", ""
  ...
  if (filterAssetType !== undefined) {
      requestContext.setQueryParam("filter[asset.type]", ObjectSerializer.serialize(filterAssetType, "AssetType", ""
), "");
    }
  if (filterAssetVersionFirst !== undefined) {
      requestContext.setQueryParam("filter[asset.version.first]", ObjectSerializer.serialize(filterAssetVersionFirst, "string", ""
), "");
    }
  if (filterAssetVersionLast !== undefined) {
      requestContext.setQueryParam("filter[asset.version.last]", ObjectSerializer.serialize(filterAssetVersionLast, "string", ""
), "");
    }
  if (filterAssetRepositoryUrl !== undefined) {
      requestContext.setQueryParam("filter[asset.repository_url]", ObjectSerializer.serialize(filterAssetRepositoryUrl, "string", ""
), "");
    }
  if (filterAssetRisksInProduction !== undefined) {
      requestContext.setQueryParam("filter[asset.risks.in_production]", ObjectSerializer.serialize(filterAssetRisksInProduction, "boolean", ""
), "");
    }
  if (filterAssetRisksUnderAttack !== undefined) {
      requestContext.setQueryParam("filter[asset.risks.under_attack]", ObjectSerializer.serialize(filterAssetRisksUnderAttack, "boolean", ""
), "");
    }
  if (filterAssetRisksIsPubliclyAccessible !== undefined) {
      requestContext.setQueryParam("filter[asset.risks.is_publicly_accessible]", ObjectSerializer.serialize(filterAssetRisksIsPubliclyAccessible, "boolean", ""
), "");
    }
  if (filterAssetRisksHasPrivilegedAccess !== undefined) {
      requestContext.setQueryParam("filter[asset.risks.has_privileged_access]", ObjectSerializer.serialize(filterAssetRisksHasPrivilegedAccess, "boolean", ""
), "");
    }
  if (filterAssetRisksHasAccessToSensitiveData !== undefined) {
      requestContext.setQueryParam("filter[asset.risks.has_access_to_sensitive_data]", ObjectSerializer.serialize(filterAssetRisksHasAccessToSensitiveData, "boolean", ""
), "");
    }
  if (filterAssetEnvironments !== undefined) {
      requestContext.setQueryParam("filter[asset.environments]", ObjectSerializer.serialize(filterAssetEnvironments, "string", ""
), "");
    }
  if (filterAssetTeams !== undefined) {
      requestContext.setQueryParam("filter[asset.teams]", ObjectSerializer.serialize(filterAssetTeams, "string", ""
), "");
    }
  if (filterAssetArch !== undefined) {
      requestContext.setQueryParam("filter[asset.arch]", ObjectSerializer.serialize(filterAssetArch, "string", ""
), "");
    }
  if (filterAssetOperatingSystemName !== undefined) {
      requestContext.setQueryParam("filter[asset.operating_system.name]", ObjectSerializer.serialize(filterAssetOperatingSystemName, "string", ""
), "");
    }
  if (filterAssetOperatingSystemVersion !== undefined) {
      requestContext.setQueryParam("filter[asset.operating_system.version]", ObjectSerializer.serialize(filterAssetOperatingSystemVersion, "string", ""
), "");
    }
  ...
  public async listVulnerableAssets(pageToken?: string,pageNumber?: number,filterName?: string,filterType?: AssetType,filterVersionFirst?: string,filterVersionLast?: string,filterRepositoryUrl?: string,filterRisksInProduction?: boolean,filterRisksUnderAttack?: boolean,filterRisksIsPubliclyAccessible?: boolean,filterRisksHasPrivilegedAccess?: boolean,filterRisksHasAccessToSensitiveData?: boolean,filterEnvironments?: string,filterTeams?: string,filterArch?: string,filterOperatingSystemName?: string,filterOperatingSystemVersion?: string,_options?: Configuration): Promise<RequestContext> {
    ...
    // Make Request Context
    const requestContext = _config.getServer('v2.SecurityMonitoringApi.listVulnerableAssets').makeRequestContext(localVarPath, HttpMethod.GET);
    requestContext.setHeaderParam("Accept", "application/json");
    requestContext.setHttpConfig(_config.httpConfig);
  ...
  if (filterType !== undefined) {
      requestContext.setQueryParam("filter[type]", ObjectSerializer.serialize(filterType, "AssetType", ""
), "");
    }
  if (filterVersionFirst !== undefined) {
      requestContext.setQueryParam("filter[version.first]", ObjectSerializer.serialize(filterVersionFirst, "string", ""
), "");
    }
  ...
  if (filterRepositoryUrl !== undefined) {
      requestContext.setQueryParam("filter[repository_url]", ObjectSerializer.serialize(filterRepositoryUrl, "string", ""
), "");
    }
  if (filterRisksInProduction !== undefined) {
      requestContext.setQueryParam("filter[risks.in_production]", ObjectSerializer.serialize(filterRisksInProduction, "boolean", ""
), "");
    }
  if (filterRisksUnderAttack !== undefined) {
      requestContext.setQueryParam("filter[risks.under_attack]", ObjectSerializer.serialize(filterRisksUnderAttack, "boolean", ""
), "");
    }
  if (filterRisksIsPubliclyAccessible !== undefined) {
      requestContext.setQueryParam("filter[risks.is_publicly_accessible]", ObjectSerializer.serialize(filterRisksIsPubliclyAccessible, "boolean", ""
), "");
    }
  if (filterRisksHasPrivilegedAccess !== undefined) {
      requestContext.setQueryParam("filter[risks.has_privileged_access]", ObjectSerializer.serialize(filterRisksHasPrivilegedAccess, "boolean", ""
), "");
    }
  if (filterRisksHasAccessToSensitiveData !== undefined) {
      requestContext.setQueryParam("filter[risks.has_access_to_sensitive_data]", ObjectSerializer.serialize(filterRisksHasAccessToSensitiveData, "boolean", ""
), "");
    }
  if (filterEnvironments !== undefined) {
      requestContext.setQueryParam("filter[environments]", ObjectSerializer.serialize(filterEnvironments, "string", ""
), "");
    }
  if (filterTeams !== undefined) {
      requestContext.setQueryParam("filter[teams]", ObjectSerializer.serialize(filterTeams, "string", ""
), "");
    }
  if (filterArch !== undefined) {
      requestContext.setQueryParam("filter[arch]", ObjectSerializer.serialize(filterArch, "string", ""
), "");
    }
  if (filterOperatingSystemName !== undefined) {
      requestContext.setQueryParam("filter[operating_system.name]", ObjectSerializer.serialize(filterOperatingSystemName, "string", ""
), "");
    }
  if (filterOperatingSystemVersion !== undefined) {
      requestContext.setQueryParam("filter[operating_system.version]", ObjectSerializer.serialize(filterOperatingSystemVersion, "string", ""
), "");
    }
  ...
  public async muteSecurityFindings(body: MuteFindingsRequest,_options?: Configuration): Promise<RequestContext> {
    const _config = _options || this.configuration;
    ...
    // Make Request Context
    const requestContext = _config.getServer('v2.SecurityMonitoringApi.muteSecurityFindings').makeRequestContext(localVarPath, HttpMethod.PATCH);
    requestContext.setHeaderParam("Accept", "application/json");
    requestContext.setHttpConfig(_config.httpConfig);
  ...
  public async patchSignalNotificationRule(id: string,body: PatchNotificationRuleParameters,_options?: Configuration): Promise<RequestContext> {
    const _config = _options || this.configuration;
    ...
    // Make Request Context
    const requestContext = _config.getServer('v2.SecurityMonitoringApi.patchSignalNotificationRule').makeRequestContext(localVarPath, HttpMethod.PATCH);
    requestContext.setHeaderParam("Accept", "application/json");
    requestContext.setHttpConfig(_config.httpConfig);
  ...
  public async patchVulnerabilityNotificationRule(id: string,body: PatchNotificationRuleParameters,_options?: Configuration): Promise<RequestContext> {
    const _config = _options || this.configuration;
    ...
    // Make Request Context
    const requestContext = _config.getServer('v2.SecurityMonitoringApi.patchVulnerabilityNotificationRule').makeRequestContext(localVarPath, HttpMethod.PATCH);
    requestContext.setHeaderParam("Accept", "application/json");
    requestContext.setHttpConfig(_config.httpConfig);
  ...
  public async reorderSecurityFindingsAutomationDueDateRules(body: DueDateRuleReorderRequest,_options?: Configuration): Promise<RequestContext> {
    const _config = _options || this.configuration;

    logger.warn("Using unstable operation 'reorderSecurityFindingsAutomationDueDateRules'");
    ...
    // Make Request Context
    const requestContext = _config.getServer('v2.SecurityMonitoringApi.reorderSecurityFindingsAutomationDueDateRules').makeRequestContext(localVarPath, HttpMethod.POST);
    requestContext.setHeaderParam("Accept", "application/json");
    requestContext.setHttpConfig(_config.httpConfig);
    ...
    requestContext.setHeaderParam("Content-Type", contentType);
    const serializedBody = ObjectSerializer.stringify(
      ObjectSerializer.serialize(body, "DueDateRuleReorderRequest", ""),
      contentType
    );
    requestContext.setBody(serializedBody);
  ...
  public async reorderSecurityFindingsAutomationMuteRules(body: MuteRuleReorderRequest,_options?: Configuration): Promise<RequestContext> {
    const _config = _options || this.configuration;

    logger.warn("Using unstable operation 'reorderSecurityFindingsAutomationMuteRules'");
    ...
    // Make Request Context
    const requestContext = _config.getServer('v2.SecurityMonitoringApi.reorderSecurityFindingsAutomationMuteRules').makeRequestContext(localVarPath, HttpMethod.POST);
    requestContext.setHeaderParam("Accept", "application/json");
    requestContext.setHttpConfig(_config.httpConfig);
    ...
    requestContext.setHeaderParam("Content-Type", contentType);
    const serializedBody = ObjectSerializer.stringify(
      ObjectSerializer.serialize(body, "MuteRuleReorderRequest", ""),
      contentType
    );
    requestContext.setBody(serializedBody);
  ...
  public async reorderSecurityFindingsAutomationTicketCreationRules(body: TicketCreationRuleReorderRequest,_options?: Configuration): Promise<RequestContext> {
    const _config = _options || this.configuration;

    logger.warn("Using unstable operation 'reorderSecurityFindingsAutomationTicketCreationRules'");
    ...
    // Make Request Context
    const requestContext = _config.getServer('v2.SecurityMonitoringApi.reorderSecurityFindingsAutomationTicketCreationRules').makeRequestContext(localVarPath, HttpMethod.POST);
    requestContext.setHeaderParam("Accept", "application/json");
    requestContext.setHttpConfig(_config.httpConfig);
    ...
    requestContext.setHeaderParam("Content-Type", contentType);
    const serializedBody = ObjectSerializer.stringify(
      ObjectSerializer.serialize(body, "TicketCreationRuleReorderRequest", ""),
      contentType
    );
    requestContext.setBody(serializedBody);
  ...
  public async restoreSecurityMonitoringRule(ruleId: string,version: number,_options?: Configuration): Promise<RequestContext> {
    const _config = _options || this.configuration;

    logger.warn("Using unstable operation 'restoreSecurityMonitoringRule'");
    ...
    // Make Request Context
    const requestContext = _config.getServer('v2.SecurityMonitoringApi.restoreSecurityMonitoringRule').makeRequestContext(localVarPath, HttpMethod.POST);
    requestContext.setHeaderParam("Accept", "application/json");
    requestContext.setHttpConfig(_config.httpConfig);
  ...
  public async runHistoricalJob(body: RunHistoricalJobRequest,_options?: Configuration): Promise<RequestContext> {
    const _config = _options || this.configuration;
    ...
    // Make Request Context
    const requestContext = _config.getServer('v2.SecurityMonitoringApi.runHistoricalJob').makeRequestContext(localVarPath, HttpMethod.POST);
    requestContext.setHeaderParam("Accept", "application/json");
    requestContext.setHttpConfig(_config.httpConfig);
  ...
  public async searchSecurityFindings(body: SecurityFindingsSearchRequest,_options?: Configuration): Promise<RequestContext> {
    const _config = _options || this.configuration;
    ...
    // Make Request Context
    const requestContext = _config.getServer('v2.SecurityMonitoringApi.searchSecurityFindings').makeRequestContext(localVarPath, HttpMethod.POST);
    requestContext.setHeaderParam("Accept", "application/json");
    requestContext.setHttpConfig(_config.httpConfig);
  ...
  public async searchSecurityMonitoringHistsignals(body?: SecurityMonitoringSignalListRequest,_options?: Configuration): Promise<RequestContext> {
    const _config = _options || this.configuration;

    logger.warn("Using unstable operation 'searchSecurityMonitoringHistsignals'");
    ...
    // Make Request Context
    const requestContext = _config.getServer('v2.SecurityMonitoringApi.searchSecurityMonitoringHistsignals').makeRequestContext(localVarPath, HttpMethod.POST);
    requestContext.setHeaderParam("Accept", "application/json");
    requestContext.setHttpConfig(_config.httpConfig);
  ...
  public async searchSecurityMonitoringSignals(body?: SecurityMonitoringSignalListRequest,_options?: Configuration): Promise<RequestContext> {
    const _config = _options || this.configuration;
    ...
    // Make Request Context
    const requestContext = _config.getServer('v2.SecurityMonitoringApi.searchSecurityMonitoringSignals').makeRequestContext(localVarPath, HttpMethod.POST);
    requestContext.setHeaderParam("Accept", "application/json");
    requestContext.setHttpConfig(_config.httpConfig);
  ...
  public async sendSecurityMonitoringNotificationPreview(body: CreateNotificationRuleParameters,_options?: Configuration): Promise<RequestContext> {
    const _config = _options || this.configuration;
    ...
    // Make Request Context
    const requestContext = _config.getServer('v2.SecurityMonitoringApi.sendSecurityMonitoringNotificationPreview').makeRequestContext(localVarPath, HttpMethod.POST);
    requestContext.setHeaderParam("Accept", "application/json");
    requestContext.setHttpConfig(_config.httpConfig);
  ...
  public async testExistingSecurityMonitoringRule(ruleId: string,body: SecurityMonitoringRuleTestRequest,_options?: Configuration): Promise<RequestContext> {
    const _config = _options || this.configuration;
    ...
    // Path Params
    const localVarPath = '/api/v2/security_monitoring/rules/{rule_id}/test'
      .replace('{rule_id}', encodeURIComponent(String(ruleId)));

    // Make Request Context
    const requestContext = _config.getServer('v2.SecurityMonitoringApi.testExistingSecurityMonitoringRule').makeRequestContext(localVarPath, HttpMethod.POST);
    requestContext.setHeaderParam("Accept", "application/json");
    requestContext.setHttpConfig(_config.httpConfig);
  ...
  public async testSecurityMonitoringRule(body: SecurityMonitoringRuleTestRequest,_options?: Configuration): Promise<RequestContext> {
    const _config = _options || this.configuration;
    ...
    // Make Request Context
    const requestContext = _config.getServer('v2.SecurityMonitoringApi.testSecurityMonitoringRule').makeRequestContext(localVarPath, HttpMethod.POST);
    requestContext.setHeaderParam("Accept", "application/json");
    requestContext.setHttpConfig(_config.httpConfig);
  ...
  public async updateCustomFramework(handle: string,version: string,body: UpdateCustomFrameworkRequest,_options?: Configuration): Promise<RequestContext> {
    const _config = _options || this.configuration;
    ...
    // Make Request Context
    const requestContext = _config.getServer('v2.SecurityMonitoringApi.updateCustomFramework').makeRequestContext(localVarPath, HttpMethod.PUT);
    requestContext.setHeaderParam("Accept", "application/json");
    requestContext.setHttpConfig(_config.httpConfig);
  ...
  public async updateFindingsAssignee(body: AssigneeRequest,_options?: Configuration): Promise<RequestContext> {
    const _config = _options || this.configuration;

    logger.warn("Using unstable operation 'updateFindingsAssignee'");
    ...
    // Make Request Context
    const requestContext = _config.getServer('v2.SecurityMonitoringApi.updateFindingsAssignee').makeRequestContext(localVarPath, HttpMethod.PATCH);
    requestContext.setHeaderParam("Accept", "application/json");
    requestContext.setHttpConfig(_config.httpConfig);
    ...
    requestContext.setHeaderParam("Content-Type", contentType);
    const serializedBody = ObjectSerializer.stringify(
      ObjectSerializer.serialize(body, "AssigneeRequest", ""),
      contentType
    );
    requestContext.setBody(serializedBody);
  ...
  public async updateResourceEvaluationFilters(body: UpdateResourceEvaluationFiltersRequest,_options?: Configuration): Promise<RequestContext> {
    const _config = _options || this.configuration;
    ...
    // Make Request Context
    const requestContext = _config.getServer('v2.SecurityMonitoringApi.updateResourceEvaluationFilters').makeRequestContext(localVarPath, HttpMethod.PUT);
    requestContext.setHeaderParam("Accept", "application/json");
    requestContext.setHttpConfig(_config.httpConfig);
    ...
    requestContext.setHeaderParam("Content-Type", contentType);
    const serializedBody = ObjectSerializer.stringify(
      ObjectSerializer.serialize(body, "UpdateResourceEvaluationFiltersRequest", ""),
      contentType
    );
    requestContext.setBody(serializedBody);
  ...
  public async updateSecurityFilter(securityFilterId: string,body: SecurityFilterUpdateRequest,_options?: Configuration): Promise<RequestContext> {
    const _config = _options || this.configuration;
    ...
    // Make Request Context
    const requestContext = _config.getServer('v2.SecurityMonitoringApi.updateSecurityFilter').makeRequestContext(localVarPath, HttpMethod.PATCH);
    requestContext.setHeaderParam("Accept", "application/json");
    requestContext.setHttpConfig(_config.httpConfig);
  ...
  public async updateSecurityFindingsAutomationDueDateRule(ruleId: string,body: DueDateRuleUpdateRequest,_options?: Configuration): Promise<RequestContext> {
    const _config = _options || this.configuration;

    logger.warn("Using unstable operation 'updateSecurityFindingsAutomationDueDateRule'");
    ...
    // Make Request Context
    const requestContext = _config.getServer('v2.SecurityMonitoringApi.updateSecurityFindingsAutomationDueDateRule').makeRequestContext(localVarPath, HttpMethod.PUT);
    requestContext.setHeaderParam("Accept", "application/json");
    requestContext.setHttpConfig(_config.httpConfig);
    ...
    requestContext.setHeaderParam("Content-Type", contentType);
    const serializedBody = ObjectSerializer.stringify(
      ObjectSerializer.serialize(body, "DueDateRuleUpdateRequest", ""),
      contentType
    );
    requestContext.setBody(serializedBody);
  ...
  public async updateSecurityFindingsAutomationMuteRule(ruleId: string,body: MuteRuleUpdateRequest,_options?: Configuration): Promise<RequestContext> {
    const _config = _options || this.configuration;

    logger.warn("Using unstable operation 'updateSecurityFindingsAutomationMuteRule'");
    ...
    // Make Request Context
    const requestContext = _config.getServer('v2.SecurityMonitoringApi.updateSecurityFindingsAutomationMuteRule').makeRequestContext(localVarPath, HttpMethod.PUT);
    requestContext.setHeaderParam("Accept", "application/json");
    requestContext.setHttpConfig(_config.httpConfig);
    ...
    requestContext.setHeaderParam("Content-Type", contentType);
    const serializedBody = ObjectSerializer.stringify(
      ObjectSerializer.serialize(body, "MuteRuleUpdateRequest", ""),
      contentType
    );
    requestContext.setBody(serializedBody);
  ...
  public async updateSecurityFindingsAutomationTicketCreationRule(ruleId: string,body: TicketCreationRuleUpdateRequest,_options?: Configuration): Promise<RequestContext> {
    const _config = _options || this.configuration;

    logger.warn("Using unstable operation 'updateSecurityFindingsAutomationTicketCreationRule'");
    ...
    // Make Request Context
    const requestContext = _config.getServer('v2.SecurityMonitoringApi.updateSecurityFindingsAutomationTicketCreationRule').makeRequestContext(localVarPath, HttpMethod.PUT);
    requestContext.setHeaderParam("Accept", "application/json");
    requestContext.setHttpConfig(_config.httpConfig);
    ...
    requestContext.setHeaderParam("Content-Type", contentType);
    const serializedBody = ObjectSerializer.stringify(
      ObjectSerializer.serialize(body, "TicketCreationRuleUpdateRequest", ""),
      contentType
    );
    requestContext.setBody(serializedBody);
  ...
  public async updateSecurityMonitoringCriticalAsset(criticalAssetId: string,body: SecurityMonitoringCriticalAssetUpdateRequest,_options?: Configuration): Promise<RequestContext> {
    const _config = _options || this.configuration;
    ...
    // Make Request Context
    const requestContext = _config.getServer('v2.SecurityMonitoringApi.updateSecurityMonitoringCriticalAsset').makeRequestContext(localVarPath, HttpMethod.PATCH);
    requestContext.setHeaderParam("Accept", "application/json");
    requestContext.setHttpConfig(_config.httpConfig);
    ...
    requestContext.setHeaderParam("Content-Type", contentType);
    const serializedBody = ObjectSerializer.stringify(
      ObjectSerializer.serialize(body, "SecurityMonitoringCriticalAssetUpdateRequest", ""),
      contentType
    );
    requestContext.setBody(serializedBody);
  ...
  public async updateSecurityMonitoringDataset(datasetId: string,body: SecurityMonitoringDatasetUpdateRequest,_options?: Configuration): Promise<RequestContext> {
    const _config = _options || this.configuration;
    ...
    // Make Request Context
    const requestContext = _config.getServer('v2.SecurityMonitoringApi.updateSecurityMonitoringDataset').makeRequestContext(localVarPath, HttpMethod.PATCH);
    requestContext.setHeaderParam("Accept", "*/*");
    requestContext.setHttpConfig(_config.httpConfig);
    ...
    requestContext.setHeaderParam("Content-Type", contentType);
    const serializedBody = ObjectSerializer.stringify(
      ObjectSerializer.serialize(body, "SecurityMonitoringDatasetUpdateRequest", ""),
      contentType
    );
    requestContext.setBody(serializedBody);
  ...
  public async updateSecurityMonitoringIntegrationConfig(integrationConfigId: string,body: SecurityMonitoringIntegrationConfigUpdateRequest,_options?: Configuration): Promise<RequestContext> {
    const _config = _options || this.configuration;

    logger.warn("Using unstable operation 'updateSecurityMonitoringIntegrationConfig'");
    ...
    // Make Request Context
    const requestContext = _config.getServer('v2.SecurityMonitoringApi.updateSecurityMonitoringIntegrationConfig').makeRequestContext(localVarPath, HttpMethod.PATCH);
    requestContext.setHeaderParam("Accept", "application/json");
    requestContext.setHttpConfig(_config.httpConfig);
    ...
    requestContext.setHeaderParam("Content-Type", contentType);
    const serializedBody = ObjectSerializer.stringify(
      ObjectSerializer.serialize(body, "SecurityMonitoringIntegrationConfigUpdateRequest", ""),
      contentType
    );
    requestContext.setBody(serializedBody);
  ...
  public async updateSecurityMonitoringRule(ruleId: string,body: SecurityMonitoringRuleUpdatePayload,_options?: Configuration): Promise<RequestContext> {
    const _config = _options || this.configuration;
    ...
    // Make Request Context
    const requestContext = _config.getServer('v2.SecurityMonitoringApi.updateSecurityMonitoringRule').makeRequestContext(localVarPath, HttpMethod.PUT);
    requestContext.setHeaderParam("Accept", "application/json");
    requestContext.setHttpConfig(_config.httpConfig);
  ...
  public async updateSecurityMonitoringSuppression(suppressionId: string,body: SecurityMonitoringSuppressionUpdateRequest,_options?: Configuration): Promise<RequestContext> {
    const _config = _options || this.configuration;
    ...
    // Make Request Context
    const requestContext = _config.getServer('v2.SecurityMonitoringApi.updateSecurityMonitoringSuppression').makeRequestContext(localVarPath, HttpMethod.PATCH);
    requestContext.setHeaderParam("Accept", "application/json");
    requestContext.setHttpConfig(_config.httpConfig);
  ...
  public async validateSecurityMonitoringIntegrationConfig(integrationConfigId: string,_options?: Configuration): Promise<RequestContext> {
    const _config = _options || this.configuration;

    logger.warn("Using unstable operation 'validateSecurityMonitoringIntegrationConfig'");
    ...
    // Path Params
    const localVarPath = '/api/v2/security_monitoring/configuration/integration_config/{integration_config_id}/validate'
      .replace('{integration_config_id}', encodeURIComponent(String(integrationConfigId)));

    // Make Request Context
    const requestContext = _config.getServer('v2.SecurityMonitoringApi.validateSecurityMonitoringIntegrationConfig').makeRequestContext(localVarPath, HttpMethod.POST);
    requestContext.setHeaderParam("Accept", "*/*");
    requestContext.setHttpConfig(_config.httpConfig);
  ...
  public async validateSecurityMonitoringIntegrationCredentials(body: SecurityMonitoringIntegrationCredentialsValidateRequest,_options?: Configuration): Promise<RequestContext> {
    const _config = _options || this.configuration;

    logger.warn("Using unstable operation 'validateSecurityMonitoringIntegrationCredentials'");
    ...
    // Make Request Context
    const requestContext = _config.getServer('v2.SecurityMonitoringApi.validateSecurityMonitoringIntegrationCredentials').makeRequestContext(localVarPath, HttpMethod.POST);
    requestContext.setHeaderParam("Accept", "*/*");
    requestContext.setHttpConfig(_config.httpConfig);
    ...
    requestContext.setHeaderParam("Content-Type", contentType);
    const serializedBody = ObjectSerializer.stringify(
      ObjectSerializer.serialize(body, "SecurityMonitoringIntegrationCredentialsValidateRequest", ""),
      contentType
    );
    requestContext.setBody(serializedBody);
  ...
  public async validateSecurityMonitoringRule(body: SecurityMonitoringRuleValidatePayload,_options?: Configuration): Promise<RequestContext> {
    const _config = _options || this.configuration;
    ...
    // Make Request Context
    const requestContext = _config.getServer('v2.SecurityMonitoringApi.validateSecurityMonitoringRule').makeRequestContext(localVarPath, HttpMethod.POST);
    requestContext.setHeaderParam("Accept", "*/*");
    requestContext.setHttpConfig(_config.httpConfig);
  ...
  public async validateSecurityMonitoringSuppression(body: SecurityMonitoringSuppressionCreateRequest,_options?: Configuration): Promise<RequestContext> {
    const _config = _options || this.configuration;
    ...
    // Make Request Context
    const requestContext = _config.getServer('v2.SecurityMonitoringApi.validateSecurityMonitoringSuppression').makeRequestContext(localVarPath, HttpMethod.POST);
    requestContext.setHeaderParam("Accept", "*/*");
    requestContext.setHttpConfig(_config.httpConfig);
...
export class SecurityMonitoringApiResponseProcessor {
   ...
   * @throws ApiException if the response code was not in [200, 299]
   */
   public async activateIntegration(response: ResponseContext): Promise<SecurityMonitoringIntegrationConfigResponse> {
    const contentType = ObjectSerializer.normalizeMediaType(response.headers["content-type"]);
    if (response.httpStatusCode === 200) {
      const body: SecurityMonitoringIntegrationConfigResponse = ObjectSerializer.deserialize(
   ...
   * @throws ApiException if the response code was not in [200, 299]
   */
   public async attachCase(response: ResponseContext): Promise<FindingCaseResponse> {
    const contentType = ObjectSerializer.normalizeMediaType(response.headers["content-type"]);
    if (response.httpStatusCode === 200) {
   ...
   * @throws ApiException if the response code was not in [200, 299]
   */
   public async attachJiraIssue(response: ResponseContext): Promise<FindingCaseResponse> {
    const contentType = ObjectSerializer.normalizeMediaType(response.headers["content-type"]);
    if (response.httpStatusCode === 200) {
      const body: FindingCaseResponse = ObjectSerializer.deserialize(
        ObjectSerializer.parse(await response.body.text(), contentType),
   ...
   * @throws ApiException if the response code was not in [200, 299]
   */
   public async attachLinearIssue(response: ResponseContext): Promise<FindingCaseResponse> {
    const contentType = ObjectSerializer.normalizeMediaType(response.headers["content-type"]);
    if (response.httpStatusCode === 200) {
      const body: FindingCaseResponse = ObjectSerializer.deserialize(
        ObjectSerializer.parse(await response.body.text(), contentType),
   ...
   * @throws ApiException if the response code was not in [200, 299]
   */
   public async attachServiceNowTicket(response: ResponseContext): Promise<FindingCaseResponse> {
    const contentType = ObjectSerializer.normalizeMediaType(response.headers["content-type"]);
    if (response.httpStatusCode === 200) {
      const body: FindingCaseResponse = ObjectSerializer.deserialize(
        ObjectSerializer.parse(await response.body.text(), contentType),
   ...
   * @throws ApiException if the response code was not in [200, 299]
   */
   public async batchGetSecurityMonitoringDatasetDependencies(response: ResponseContext): Promise<SecurityMonitoringDatasetDependenciesResponse> {
    const contentType = ObjectSerializer.normalizeMediaType(response.headers["content-type"]);
    if (response.httpStatusCode === 200) {
      const body: SecurityMonitoringDatasetDependenciesResponse = ObjectSerializer.deserialize(
        ObjectSerializer.parse(await response.body.text(), contentType),
   ...
   * @throws ApiException if the response code was not in [200, 299]
   */
   public async bulkConvertExistingSecurityMonitoringRules(response: ResponseContext): Promise<HttpFile> {
    const contentType = ObjectSerializer.normalizeMediaType(response.headers["content-type"]);
    if (response.httpStatusCode === 200) {
   ...
   * @throws ApiException if the response code was not in [200, 299]
   */
   public async bulkCreateSampleLogGenerationSubscriptions(response: ResponseContext): Promise<SampleLogGenerationBulkSubscriptionResponse> {
    const contentType = ObjectSerializer.normalizeMediaType(response.headers["content-type"]);
    if (response.httpStatusCode === 200) {
      const body: SampleLogGenerationBulkSubscriptionResponse = ObjectSerializer.deserialize(
        ObjectSerializer.parse(await response.body.text(), contentType),
   ...
   * @throws ApiException if the response code was not in [200, 299]
   */
   public async bulkDeleteSecurityMonitoringRules(response: ResponseContext): Promise<SecurityMonitoringRuleBulkDeleteResponse> {
    const contentType = ObjectSerializer.normalizeMediaType(response.headers["content-type"]);
    if (response.httpStatusCode === 200) {
      const body: SecurityMonitoringRuleBulkDeleteResponse = ObjectSerializer.deserialize(
        ObjectSerializer.parse(await response.body.text(), contentType),
   ...
   * @throws ApiException if the response code was not in [200, 299]
   */
   public async bulkEditSecurityMonitoringSignals(response: ResponseContext): Promise<SecurityMonitoringSignalsBulkTriageUpdateResponse> {
    const contentType = ObjectSerializer.normalizeMediaType(response.headers["content-type"]);
    if (response.httpStatusCode === 200) {
      const body: SecurityMonitoringSignalsBulkTriageUpdateResponse = ObjectSerializer.deserialize(
        ObjectSerializer.parse(await response.body.text(), contentType),
   ...
   * @throws ApiException if the response code was not in [200, 299]
   */
   public async bulkEditSecurityMonitoringSignalsAssignee(response: ResponseContext): Promise<SecurityMonitoringSignalsBulkTriageUpdateResponse> {
    const contentType = ObjectSerializer.normalizeMediaType(response.headers["content-type"]);
    if (response.httpStatusCode === 200) {
      const body: SecurityMonitoringSignalsBulkTriageUpdateResponse = ObjectSerializer.deserialize(
        ObjectSerializer.parse(await response.body.text(), contentType),
   ...
   * @throws ApiException if the response code was not in [200, 299]
   */
   public async bulkEditSecurityMonitoringSignalsState(response: ResponseContext): Promise<SecurityMonitoringSignalsBulkTriageUpdateResponse> {
    const contentType = ObjectSerializer.normalizeMediaType(response.headers["content-type"]);
    if (response.httpStatusCode === 200) {
      const body: SecurityMonitoringSignalsBulkTriageUpdateResponse = ObjectSerializer.deserialize(
        ObjectSerializer.parse(await response.body.text(), contentType),
   ...
   * @throws ApiException if the response code was not in [200, 299]
   */
   public async bulkExportSecurityMonitoringRules(response: ResponseContext): Promise<HttpFile> {
    const contentType = ObjectSerializer.normalizeMediaType(response.headers["content-type"]);
    if (response.httpStatusCode === 200) {
      const body: HttpFile = await response.getBodyAsFile() as HttpFile;
      return body;
   ...
   * @throws ApiException if the response code was not in [200, 299]
   */
   public async bulkExportSecurityMonitoringTerraformResources(response: ResponseContext): Promise<HttpFile> {
    const contentType = ObjectSerializer.normalizeMediaType(response.headers["content-type"]);
    if (response.httpStatusCode === 200) {
      const body: HttpFile = await response.getBodyAsFile() as HttpFile;
      return body;
   ...
   */
   public async cancelHistoricalJob(response: ResponseContext): Promise<void> {
    ...
    if (response.httpStatusCode === 400||response.httpStatusCode === 401||response.httpStatusCode === 403||response.httpStatusCode === 404||response.httpStatusCode === 409||response.httpStatusCode === 429) {
      const bodyText = ObjectSerializer.parse(await response.body.text(), contentType);
      let body: APIErrorResponse;
      try {
        body = ObjectSerializer.deserialize(
   ...
   * @throws ApiException if the response code was not in [200, 299]
   */
   public async convertExistingSecurityMonitoringRule(response: ResponseContext): Promise<SecurityMonitoringRuleConvertResponse> {
    const contentType = ObjectSerializer.normalizeMediaType(response.headers["content-type"]);
    if (response.httpStatusCode === 200) {
   ...
   * @throws ApiException if the response code was not in [200, 299]
   */
   public async convertJobResultToSignal(response: ResponseContext): Promise<void> {
    const contentType = ObjectSerializer.normalizeMediaType(response.headers["content-type"]);
    if (response.httpStatusCode === 204) {
      return;
    }
   ...
   * @throws ApiException if the response code was not in [200, 299]
   */
   public async convertSecurityMonitoringRuleFromJSONToTerraform(response: ResponseContext): Promise<SecurityMonitoringRuleConvertResponse> {
    const contentType = ObjectSerializer.normalizeMediaType(response.headers["content-type"]);
    if (response.httpStatusCode === 200) {
      const body: SecurityMonitoringRuleConvertResponse = ObjectSerializer.deserialize(
        ObjectSerializer.parse(await response.body.text(), contentType),
   ...
   * @throws ApiException if the response code was not in [200, 299]
   */
   public async convertSecurityMonitoringTerraformResource(response: ResponseContext): Promise<SecurityMonitoringTerraformExportResponse> {
    const contentType = ObjectSerializer.normalizeMediaType(response.headers["content-type"]);
    if (response.httpStatusCode === 200) {
      const body: SecurityMonitoringTerraformExportResponse = ObjectSerializer.deserialize(
        ObjectSerializer.parse(await response.body.text(), contentType),
   ...
   * @throws ApiException if the response code was not in [200, 299]
   */
   public async createCases(response: ResponseContext): Promise<FindingCaseResponseArray> {
    const contentType = ObjectSerializer.normalizeMediaType(response.headers["content-type"]);
   ...
   * @throws ApiException if the response code was not in [200, 299]
   */
   public async createCustomFramework(response: ResponseContext): Promise<CreateCustomFrameworkResponse> {
    const contentType = ObjectSerializer.normalizeMediaType(response.headers["content-type"]);
    if (response.httpStatusCode === 200) {
    ...
    if (response.httpStatusCode === 400||response.httpStatusCode === 409||response.httpStatusCode === 429||response.httpStatusCode === 500) {
      const bodyText = ObjectSerializer.parse(await response.body.text(), contentType);
      let body: APIErrorResponse;
      try {
        body = ObjectSerializer.deserialize(
   ...
   * @throws ApiException if the response code was not in [200, 299]
   */
   public async createIoCTriageState(response: ResponseContext): Promise<IoCTriageWriteResponse> {
    const contentType = ObjectSerializer.normalizeMediaType(response.headers["content-type"]);
    if (response.httpStatusCode === 201) {
   ...
   * @throws ApiException if the response code was not in [200, 299]
   */
   public async createJiraIssues(response: ResponseContext): Promise<FindingCaseResponseArray> {
    const contentType = ObjectSerializer.normalizeMediaType(response.headers["content-type"]);
    if (response.httpStatusCode === 201) {
      const body: FindingCaseResponseArray = ObjectSerializer.deserialize(
        ObjectSerializer.parse(await response.body.text(), contentType),
   ...
   * @throws ApiException if the response code was not in [200, 299]
   */
   public async createLinearIssues(response: ResponseContext): Promise<FindingCaseResponseArray> {
    const contentType = ObjectSerializer.normalizeMediaType(response.headers["content-type"]);
    if (response.httpStatusCode === 201) {
      const body: FindingCaseResponseArray = ObjectSerializer.deserialize(
        ObjectSerializer.parse(await response.body.text(), contentType),
   ...
   * @throws ApiException if the response code was not in [200, 299]
   */
   public async createSampleLogGenerationSubscription(response: ResponseContext): Promise<SampleLogGenerationSubscriptionResponse> {
    const contentType = ObjectSerializer.normalizeMediaType(response.headers["content-type"]);
    if (response.httpStatusCode === 200) {
      const body: SampleLogGenerationSubscriptionResponse = ObjectSerializer.deserialize(
        ObjectSerializer.parse(await response.body.text(), contentType),
   ...
   * @throws ApiException if the response code was not in [200, 299]
   */
   public async createSecurityFilter(response: ResponseContext): Promise<SecurityFilterResponse> {
    const contentType = ObjectSerializer.normalizeMediaType(response.headers["content-type"]);
    if (response.httpStatusCode === 200) {
   ...
   * @throws ApiException if the response code was not in [200, 299]
   */
   public async createSecurityFindingsAutomationDueDateRule(response: ResponseContext): Promise<DueDateRuleResponse> {
    const contentType = ObjectSerializer.normalizeMediaType(response.headers["content-type"]);
    if (response.httpStatusCode === 201) {
   ...
   * @throws ApiException if the response code was not in [200, 299]
   */
   public async createSecurityFindingsAutomationMuteRule(response: ResponseContext): Promise<MuteRuleResponse> {
    const contentType = ObjectSerializer.normalizeMediaType(response.headers["content-type"]);
    if (response.httpStatusCode === 201) {
   ...
   * @throws ApiException if the response code was not in [200, 299]
   */
   public async createSecurityFindingsAutomationTicketCreationRule(response: ResponseContext): Promise<TicketCreationRuleResponse> {
    const contentType = ObjectSerializer.normalizeMediaType(response.headers["content-type"]);
    if (response.httpStatusCode === 201) {
      const body: TicketCreationRuleResponse = ObjectSerializer.deserialize(
        ObjectSerializer.parse(await response.body.text(), contentType),
   ...
   * @throws ApiException if the response code was not in [200, 299]
   */
   public async createSecurityMonitoringCriticalAsset(response: ResponseContext): Promise<SecurityMonitoringCriticalAssetResponse> {
    const contentType = ObjectSerializer.normalizeMediaType(response.headers["content-type"]);
    if (response.httpStatusCode === 200) {
      const body: SecurityMonitoringCriticalAssetResponse = ObjectSerializer.deserialize(
        ObjectSerializer.parse(await response.body.text(), contentType),
   ...
   * @throws ApiException if the response code was not in [200, 299]
   */
   public async createSecurityMonitoringDataset(response: ResponseContext): Promise<SecurityMonitoringDatasetCreateResponse> {
    const contentType = ObjectSerializer.normalizeMediaType(response.headers["content-type"]);
    if (response.httpStatusCode === 201) {
      const body: SecurityMonitoringDatasetCreateResponse = ObjectSerializer.deserialize(
        ObjectSerializer.parse(await response.body.text(), contentType),
        "SecurityMonitoringDatasetCreateResponse"
      ) as SecurityMonitoringDatasetCreateResponse;
      return body;
    }
    if (response.httpStatusCode === 400||response.httpStatusCode === 403||response.httpStatusCode === 409) {
      const bodyText = ObjectSerializer.parse(await response.body.text(), contentType);
      let body: JSONAPIErrorResponse;
      try {
        body = ObjectSerializer.deserialize(
   ...
   * @throws ApiException if the response code was not in [200, 299]
   */
   public async createSecurityMonitoringIntegrationConfig(response: ResponseContext): Promise<SecurityMonitoringIntegrationConfigResponse> {
    const contentType = ObjectSerializer.normalizeMediaType(response.headers["content-type"]);
    if (response.httpStatusCode === 200) {
      const body: SecurityMonitoringIntegrationConfigResponse = ObjectSerializer.deserialize(
        ObjectSerializer.parse(await response.body.text(), contentType),
   ...
   * @throws ApiException if the response code was not in [200, 299]
   */
   public async createSecurityMonitoringSuppression(response: ResponseContext): Promise<SecurityMonitoringSuppressionResponse> {
    const contentType = ObjectSerializer.normalizeMediaType(response.headers["content-type"]);
    if (response.httpStatusCode === 200) {
   ...
   * @throws ApiException if the response code was not in [200, 299]
   */
   public async createServiceNowTickets(response: ResponseContext): Promise<FindingCaseResponseArray> {
    const contentType = ObjectSerializer.normalizeMediaType(response.headers["content-type"]);
    if (response.httpStatusCode === 201) {
      const body: FindingCaseResponseArray = ObjectSerializer.deserialize(
        ObjectSerializer.parse(await response.body.text(), contentType),
   ...
   * @throws ApiException if the response code was not in [200, 299]
   */
   public async createSignalNotificationRule(response: ResponseContext): Promise<NotificationRuleResponse> {
    const contentType = ObjectSerializer.normalizeMediaType(response.headers["content-type"]);
    if (response.httpStatusCode === 201) {
   ...
   * @throws ApiException if the response code was not in [200, 299]
   */
   public async createStaticAnalysisAst(response: ResponseContext): Promise<GetAstResponse> {
    const contentType = ObjectSerializer.normalizeMediaType(response.headers["content-type"]);
    if (response.httpStatusCode === 200) {
   ...
   * @throws ApiException if the response code was not in [200, 299]
   */
   public async createStaticAnalysisServerAnalysis(response: ResponseContext): Promise<AnalysisResponse> {
    const contentType = ObjectSerializer.normalizeMediaType(response.headers["content-type"]);
    if (response.httpStatusCode === 200) {
   ...
   * @throws ApiException if the response code was not in [200, 299]
   */
   public async createVulnerabilityNotificationRule(response: ResponseContext): Promise<NotificationRuleResponse> {
    const contentType = ObjectSerializer.normalizeMediaType(response.headers["content-type"]);
    if (response.httpStatusCode === 201) {
      const body: NotificationRuleResponse = ObjectSerializer.deserialize(
        ObjectSerializer.parse(await response.body.text(), contentType),
   ...
   * @throws ApiException if the response code was not in [200, 299]
   */
   public async deactivateIntegration(response: ResponseContext): Promise<SecurityMonitoringIntegrationConfigResponse> {
    const contentType = ObjectSerializer.normalizeMediaType(response.headers["content-type"]);
    if (response.httpStatusCode === 200) {
      const body: SecurityMonitoringIntegrationConfigResponse = ObjectSerializer.deserialize(
        ObjectSerializer.parse(await response.body.text(), contentType),
   ...
   * @throws ApiException if the response code was not in [200, 299]
   */
   public async deleteCustomFramework(response: ResponseContext): Promise<DeleteCustomFrameworkResponse> {
    const contentType = ObjectSerializer.normalizeMediaType(response.headers["content-type"]);
    if (response.httpStatusCode === 200) {
    ...
    if (response.httpStatusCode === 400||response.httpStatusCode === 429||response.httpStatusCode === 500) {
      const bodyText = ObjectSerializer.parse(await response.body.text(), contentType);
      let body: APIErrorResponse;
      try {
        body = ObjectSerializer.deserialize(
   ...
   * @throws ApiException if the response code was not in [200, 299]
   */
   public async deleteSampleLogGenerationSubscription(response: ResponseContext): Promise<SampleLogGenerationSubscriptionResponse> {
    const contentType = ObjectSerializer.normalizeMediaType(response.headers["content-type"]);
    if (response.httpStatusCode === 200) {
      const body: SampleLogGenerationSubscriptionResponse = ObjectSerializer.deserialize(
        ObjectSerializer.parse(await response.body.text(), contentType),
   ...
   * @throws ApiException if the response code was not in [200, 299]
   */
   public async deleteSecurityFindingsAutomationDueDateRule(response: ResponseContext): Promise<void> {
    const contentType = ObjectSerializer.normalizeMediaType(response.headers["content-type"]);
    if (response.httpStatusCode === 204) {
      return;
    }
   ...
   * @throws ApiException if the response code was not in [200, 299]
   */
   public async deleteSecurityFindingsAutomationMuteRule(response: ResponseContext): Promise<void> {
    const contentType = ObjectSerializer.normalizeMediaType(response.headers["content-type"]);
    if (response.httpStatusCode === 204) {
      return;
    }
   ...
   * @throws ApiException if the response code was not in [200, 299]
   */
   public async deleteSecurityFindingsAutomationTicketCreationRule(response: ResponseContext): Promise<void> {
    const contentType = ObjectSerializer.normalizeMediaType(response.headers["content-type"]);
    if (response.httpStatusCode === 204) {
      return;
    }
   ...
   * @throws ApiException if the response code was not in [200, 299]
   */
   public async deleteSecurityMonitoringCriticalAsset(response: ResponseContext): Promise<void> {
    const contentType = ObjectSerializer.normalizeMediaType(response.headers["content-type"]);
    if (response.httpStatusCode === 204) {
      return;
    }
   ...
   * @throws ApiException if the response code was not in [200, 299]
   */
   public async deleteSecurityMonitoringDataset(response: ResponseContext): Promise<void> {
    const contentType = ObjectSerializer.normalizeMediaType(response.headers["content-type"]);
    if (response.httpStatusCode === 204) {
      return;
    }
   ...
   * @throws ApiException if the response code was not in [200, 299]
   */
   public async deleteSecurityMonitoringIntegrationConfig(response: ResponseContext): Promise<void> {
    const contentType = ObjectSerializer.normalizeMediaType(response.headers["content-type"]);
    if (response.httpStatusCode === 204) {
      return;
    }
   ...
   * @throws ApiException if the response code was not in [200, 299]
   */
   public async deleteSecurityMonitoringSuppression(response: ResponseContext): Promise<void> {
    const contentType = ObjectSerializer.normalizeMediaType(response.headers["content-type"]);
    if (response.httpStatusCode === 204) {
      return;
    }
   ...
   * @throws ApiException if the response code was not in [200, 299]
   */
   public async deleteSignalNotificationRule(response: ResponseContext): Promise<void> {
    const contentType = ObjectSerializer.normalizeMediaType(response.headers["content-type"]);
    if (response.httpStatusCode === 204) {
      return;
    }
   ...
   * @throws ApiException if the response code was not in [200, 299]
   */
   public async deleteVulnerabilityNotificationRule(response: ResponseContext): Promise<void> {
    const contentType = ObjectSerializer.normalizeMediaType(response.headers["content-type"]);
    if (response.httpStatusCode === 204) {
      return;
    }
   ...
   * @throws ApiException if the response code was not in [200, 299]
   */
   public async editSecurityMonitoringSignal(response: ResponseContext): Promise<SecurityMonitoringSignalTriageUpdateResponse> {
    const contentType = ObjectSerializer.normalizeMediaType(response.headers["content-type"]);
    if (response.httpStatusCode === 200) {
   ...
   * @throws ApiException if the response code was not in [200, 299]
   */
   public async editSecurityMonitoringSignalAssignee(response: ResponseContext): Promise<SecurityMonitoringSignalTriageUpdateResponse> {
    const contentType = ObjectSerializer.normalizeMediaType(response.headers["content-type"]);
    if (response.httpStatusCode === 200) {
      const body: SecurityMonitoringSignalTriageUpdateResponse = ObjectSerializer.deserialize(
        ObjectSerializer.parse(await response.body.text(), contentType),
   ...
   * @throws ApiException if the response code was not in [200, 299]
   */
   public async editSecurityMonitoringSignalIncidents(response: ResponseContext): Promise<SecurityMonitoringSignalTriageUpdateResponse> {
    const contentType = ObjectSerializer.normalizeMediaType(response.headers["content-type"]);
    if (response.httpStatusCode === 200) {
      const body: SecurityMonitoringSignalTriageUpdateResponse = ObjectSerializer.deserialize(
        ObjectSerializer.parse(await response.body.text(), contentType),
   ...
   * @throws ApiException if the response code was not in [200, 299]
   */
   public async editSecurityMonitoringSignalState(response: ResponseContext): Promise<SecurityMonitoringSignalTriageUpdateResponse> {
    const contentType = ObjectSerializer.normalizeMediaType(response.headers["content-type"]);
    if (response.httpStatusCode === 200) {
      const body: SecurityMonitoringSignalTriageUpdateResponse = ObjectSerializer.deserialize(
        ObjectSerializer.parse(await response.body.text(), contentType),
   ...
   * @throws ApiException if the response code was not in [200, 299]
   */
   public async exportSecurityMonitoringTerraformResource(response: ResponseContext): Promise<SecurityMonitoringTerraformExportResponse> {
    const contentType = ObjectSerializer.normalizeMediaType(response.headers["content-type"]);
    if (response.httpStatusCode === 200) {
      const body: SecurityMonitoringTerraformExportResponse = ObjectSerializer.deserialize(
        ObjectSerializer.parse(await response.body.text(), contentType),
   ...
   * @throws ApiException if the response code was not in [200, 299]
   */
   public async getContentPacksStates(response: ResponseContext): Promise<SecurityMonitoringContentPackStatesResponse> {
    const contentType = ObjectSerializer.normalizeMediaType(response.headers["content-type"]);
    if (response.httpStatusCode === 200) {
      const body: SecurityMonitoringContentPackStatesResponse = ObjectSerializer.deserialize(
        ObjectSerializer.parse(await response.body.text(), contentType),
   ...
   * @throws ApiException if the response code was not in [200, 299]
   */
   public async getCriticalAssetsAffectingRule(response: ResponseContext): Promise<SecurityMonitoringCriticalAssetsResponse> {
    const contentType = ObjectSerializer.normalizeMediaType(response.headers["content-type"]);
    if (response.httpStatusCode === 200) {
      const body: SecurityMonitoringCriticalAssetsResponse = ObjectSerializer.deserialize(
        ObjectSerializer.parse(await response.body.text(), contentType),
   ...
   * @throws ApiException if the response code was not in [200, 299]
   */
   public async getCustomFramework(response: ResponseContext): Promise<GetCustomFrameworkResponse> {
    const contentType = ObjectSerializer.normalizeMediaType(response.headers["content-type"]);
    if (response.httpStatusCode === 200) {
   ...
   * @throws ApiException if the response code was not in [200, 299]
   */
   public async getEntityContext(response: ResponseContext): Promise<EntityContextResponse> {
    const contentType = ObjectSerializer.normalizeMediaType(response.headers["content-type"]);
    if (response.httpStatusCode === 200) {
   ...
   * @throws ApiException if the response code was not in [200, 299]
   */
   public async getEntraIdAzureAppRegistrations(response: ResponseContext): Promise<SecurityMonitoringEntraIdAzureAppRegistrationsResponse> {
    const contentType = ObjectSerializer.normalizeMediaType(response.headers["content-type"]);
    if (response.httpStatusCode === 200) {
      const body: SecurityMonitoringEntraIdAzureAppRegistrationsResponse = ObjectSerializer.deserialize(
        ObjectSerializer.parse(await response.body.text(), contentType),
   ...
   * @throws ApiException if the response code was not in [200, 299]
   */
   public async getFinding(response: ResponseContext): Promise<GetFindingResponse> {
    const contentType = ObjectSerializer.normalizeMediaType(response.headers["content-type"]);
    if (response.httpStatusCode === 200) {
   ...
   * @throws ApiException if the response code was not in [200, 299]
   */
   public async getHistoricalJob(response: ResponseContext): Promise<HistoricalJobResponse> {
    const contentType = ObjectSerializer.normalizeMediaType(response.headers["content-type"]);
    if (response.httpStatusCode === 200) {
   ...
   * @throws ApiException if the response code was not in [200, 299]
   */
   public async getIndicatorOfCompromise(response: ResponseContext): Promise<GetIoCIndicatorResponse> {
    const contentType = ObjectSerializer.normalizeMediaType(response.headers["content-type"]);
    if (response.httpStatusCode === 200) {
   ...
   * @throws ApiException if the response code was not in [200, 299]
   */
   public async getInvestigationLogQueriesMatchingSignal(response: ResponseContext): Promise<SecurityMonitoringSignalSuggestedActionsResponse> {
    const contentType = ObjectSerializer.normalizeMediaType(response.headers["content-type"]);
    if (response.httpStatusCode === 200) {
      const body: SecurityMonitoringSignalSuggestedActionsResponse = ObjectSerializer.deserialize(
        ObjectSerializer.parse(await response.body.text(), contentType),
   ...
   * @throws ApiException if the response code was not in [200, 299]
   */
   public async getResourceEvaluationFilters(response: ResponseContext): Promise<GetResourceEvaluationFiltersResponse> {
    const contentType = ObjectSerializer.normalizeMediaType(response.headers["content-type"]);
    if (response.httpStatusCode === 200) {
      const body: GetResourceEvaluationFiltersResponse = ObjectSerializer.deserialize(
        ObjectSerializer.parse(await response.body.text(), contentType),
   ...
   * @throws ApiException if the response code was not in [200, 299]
   */
   public async getRuleVersionHistory(response: ResponseContext): Promise<GetRuleVersionHistoryResponse> {
    const contentType = ObjectSerializer.normalizeMediaType(response.headers["content-type"]);
    if (response.httpStatusCode === 200) {
   ...
   * @throws ApiException if the response code was not in [200, 299]
   */
   public async getSecretsRules(response: ResponseContext): Promise<SecretRuleArray> {
    const contentType = ObjectSerializer.normalizeMediaType(response.headers["content-type"]);
    if (response.httpStatusCode === 200) {
   ...
   * @throws ApiException if the response code was not in [200, 299]
   */
   public async getSecurityFilter(response: ResponseContext): Promise<SecurityFilterResponse> {
    const contentType = ObjectSerializer.normalizeMediaType(response.headers["content-type"]);
    if (response.httpStatusCode === 200) {
      const body: SecurityFilterResponse = ObjectSerializer.deserialize(
        ObjectSerializer.parse(await response.body.text(), contentType),
   ...
   * @throws ApiException if the response code was not in [200, 299]
   */
   public async getSecurityFindingsAutomationDueDateRule(response: ResponseContext): Promise<DueDateRuleResponse> {
    const contentType = ObjectSerializer.normalizeMediaType(response.headers["content-type"]);
    if (response.httpStatusCode === 200) {
      const body: DueDateRuleResponse = ObjectSerializer.deserialize(
        ObjectSerializer.parse(await response.body.text(), contentType),
   ...
   * @throws ApiException if the response code was not in [200, 299]
   */
   public async getSecurityFindingsAutomationMuteRule(response: ResponseContext): Promise<MuteRuleResponse> {
    const contentType = ObjectSerializer.normalizeMediaType(response.headers["content-type"]);
    if (response.httpStatusCode === 200) {
      const body: MuteRuleResponse = ObjectSerializer.deserialize(
        ObjectSerializer.parse(await response.body.text(), contentType),
   ...
   * @throws ApiException if the response code was not in [200, 299]
   */
   public async getSecurityFindingsAutomationTicketCreationRule(response: ResponseContext): Promise<TicketCreationRuleResponse> {
    const contentType = ObjectSerializer.normalizeMediaType(response.headers["content-type"]);
    if (response.httpStatusCode === 200) {
      const body: TicketCreationRuleResponse = ObjectSerializer.deserialize(
        ObjectSerializer.parse(await response.body.text(), contentType),
   ...
   * @throws ApiException if the response code was not in [200, 299]
   */
   public async getSecurityMonitoringCriticalAsset(response: ResponseContext): Promise<SecurityMonitoringCriticalAssetResponse> {
    const contentType = ObjectSerializer.normalizeMediaType(response.headers["content-type"]);
    if (response.httpStatusCode === 200) {
      const body: SecurityMonitoringCriticalAssetResponse = ObjectSerializer.deserialize(
        ObjectSerializer.parse(await response.body.text(), contentType),
   ...
   * @throws ApiException if the response code was not in [200, 299]
   */
   public async getSecurityMonitoringDataset(response: ResponseContext): Promise<SecurityMonitoringDatasetResponse> {
    const contentType = ObjectSerializer.normalizeMediaType(response.headers["content-type"]);
    if (response.httpStatusCode === 200) {
      const body: SecurityMonitoringDatasetResponse = ObjectSerializer.deserialize(
        ObjectSerializer.parse(await response.body.text(), contentType),
   ...
   * @throws ApiException if the response code was not in [200, 299]
   */
   public async getSecurityMonitoringDatasetByVersion(response: ResponseContext): Promise<SecurityMonitoringDatasetResponse> {
    const contentType = ObjectSerializer.normalizeMediaType(response.headers["content-type"]);
    if (response.httpStatusCode === 200) {
      const body: SecurityMonitoringDatasetResponse = ObjectSerializer.deserialize(
        ObjectSerializer.parse(await response.body.text(), contentType),
   ...
   * @throws ApiException if the response code was not in [200, 299]
   */
   public async getSecurityMonitoringDatasetVersionHistory(response: ResponseContext): Promise<SecurityMonitoringDatasetVersionHistoryResponse> {
    const contentType = ObjectSerializer.normalizeMediaType(response.headers["content-type"]);
    if (response.httpStatusCode === 200) {
      const body: SecurityMonitoringDatasetVersionHistoryResponse = ObjectSerializer.deserialize(
        ObjectSerializer.parse(await response.body.text(), contentType),
   ...
   * @throws ApiException if the response code was not in [200, 299]
   */
   public async getSecurityMonitoringHistsignal(response: ResponseContext): Promise<SecurityMonitoringSignalResponse> {
    const contentType = ObjectSerializer.normalizeMediaType(response.headers["content-type"]);
    if (response.httpStatusCode === 200) {
   ...
   * @throws ApiException if the response code was not in [200, 299]
   */
   public async getSecurityMonitoringHistsignalsByJobId(response: ResponseContext): Promise<SecurityMonitoringSignalsListResponse> {
    const contentType = ObjectSerializer.normalizeMediaType(response.headers["content-type"]);
    if (response.httpStatusCode === 200) {
   ...
   * @throws ApiException if the response code was not in [200, 299]
   */
   public async getSecurityMonitoringIntegrationConfig(response: ResponseContext): Promise<SecurityMonitoringIntegrationConfigResponse> {
    const contentType = ObjectSerializer.normalizeMediaType(response.headers["content-type"]);
    if (response.httpStatusCode === 200) {
      const body: SecurityMonitoringIntegrationConfigResponse = ObjectSerializer.deserialize(
        ObjectSerializer.parse(await response.body.text(), contentType),
   ...
   * @throws ApiException if the response code was not in [200, 299]
   */
   public async getSecurityMonitoringSignal(response: ResponseContext): Promise<SecurityMonitoringSignalResponse> {
    const contentType = ObjectSerializer.normalizeMediaType(response.headers["content-type"]);
    if (response.httpStatusCode === 200) {
      const body: SecurityMonitoringSignalResponse = ObjectSerializer.deserialize(
        ObjectSerializer.parse(await response.body.text(), contentType),
   ...
   * @throws ApiException if the response code was not in [200, 299]
   */
   public async getSecurityMonitoringSuppression(response: ResponseContext): Promise<SecurityMonitoringSuppressionResponse> {
    const contentType = ObjectSerializer.normalizeMediaType(response.headers["content-type"]);
    if (response.httpStatusCode === 200) {
      const body: SecurityMonitoringSuppressionResponse = ObjectSerializer.deserialize(
        ObjectSerializer.parse(await response.body.text(), contentType),
   ...
   * @throws ApiException if the response code was not in [200, 299]
   */
   public async getSignalEntities(response: ResponseContext): Promise<SignalEntitiesResponse> {
    const contentType = ObjectSerializer.normalizeMediaType(response.headers["content-type"]);
    if (response.httpStatusCode === 200) {
   ...
   * @throws ApiException if the response code was not in [200, 299]
   */
   public async getSignalNotificationRule(response: ResponseContext): Promise<NotificationRuleResponse> {
    const contentType = ObjectSerializer.normalizeMediaType(response.headers["content-type"]);
    if (response.httpStatusCode === 200) {
      const body: NotificationRuleResponse = ObjectSerializer.deserialize(
        ObjectSerializer.parse(await response.body.text(), contentType),
   ...
   * @throws ApiException if the response code was not in [200, 299]
   */
   public async getSignalNotificationRules(response: ResponseContext): Promise<NotificationRulesListResponse> {
    const contentType = ObjectSerializer.normalizeMediaType(response.headers["content-type"]);
    if (response.httpStatusCode === 200) {
      const body: NotificationRulesListResponse = ObjectSerializer.deserialize(
        ObjectSerializer.parse(await response.body.text(), contentType),
   ...
   * @throws ApiException if the response code was not in [200, 299]
   */
   public async getSingleEntityContext(response: ResponseContext): Promise<SingleEntityContextResponse> {
    const contentType = ObjectSerializer.normalizeMediaType(response.headers["content-type"]);
    if (response.httpStatusCode === 200) {
      const body: SingleEntityContextResponse = ObjectSerializer.deserialize(
        ObjectSerializer.parse(await response.body.text(), contentType),
   ...
   * @throws ApiException if the response code was not in [200, 299]
   */
   public async getStaticAnalysisDefaultRulesets(response: ResponseContext): Promise<DefaultRulesetsPerLanguageResponse> {
    const contentType = ObjectSerializer.normalizeMediaType(response.headers["content-type"]);
    if (response.httpStatusCode === 200) {
      const body: DefaultRulesetsPerLanguageResponse = ObjectSerializer.deserialize(
        ObjectSerializer.parse(await response.body.text(), contentType),
   ...
   * @throws ApiException if the response code was not in [200, 299]
   */
   public async getStaticAnalysisNodeTypes(response: ResponseContext): Promise<NodeTypesResponse> {
    const contentType = ObjectSerializer.normalizeMediaType(response.headers["content-type"]);
    if (response.httpStatusCode === 200) {
   ...
   * @throws ApiException if the response code was not in [200, 299]
   */
   public async getStaticAnalysisRuleset(response: ResponseContext): Promise<SastRulesetResponse> {
    const contentType = ObjectSerializer.normalizeMediaType(response.headers["content-type"]);
    if (response.httpStatusCode === 200) {
   ...
   * @throws ApiException if the response code was not in [200, 299]
   */
   public async getStaticAnalysisTreeSitterWasm(response: ResponseContext): Promise<HttpFile> {
    const contentType = ObjectSerializer.normalizeMediaType(response.headers["content-type"]);
    if (response.httpStatusCode === 200) {
      const body: HttpFile = await response.getBodyAsFile() as HttpFile;
      return body;
   ...
   * @throws ApiException if the response code was not in [200, 299]
   */
   public async getSuggestedActionsMatchingSignal(response: ResponseContext): Promise<SecurityMonitoringSignalSuggestedActionsResponse> {
    const contentType = ObjectSerializer.normalizeMediaType(response.headers["content-type"]);
    if (response.httpStatusCode === 200) {
      const body: SecurityMonitoringSignalSuggestedActionsResponse = ObjectSerializer.deserialize(
        ObjectSerializer.parse(await response.body.text(), contentType),
   ...
   * @throws ApiException if the response code was not in [200, 299]
   */
   public async getSuppressionsAffectingFutureRule(response: ResponseContext): Promise<SecurityMonitoringSuppressionsResponse> {
    const contentType = ObjectSerializer.normalizeMediaType(response.headers["content-type"]);
    if (response.httpStatusCode === 200) {
   ...
   * @throws ApiException if the response code was not in [200, 299]
   */
   public async getSuppressionsAffectingRule(response: ResponseContext): Promise<SecurityMonitoringSuppressionsResponse> {
    const contentType = ObjectSerializer.normalizeMediaType(response.headers["content-type"]);
    if (response.httpStatusCode === 200) {
      const body: SecurityMonitoringSuppressionsResponse = ObjectSerializer.deserialize(
        ObjectSerializer.parse(await response.body.text(), contentType),
   ...
   * @throws ApiException if the response code was not in [200, 299]
   */
   public async getSuppressionVersionHistory(response: ResponseContext): Promise<GetSuppressionVersionHistoryResponse> {
    const contentType = ObjectSerializer.normalizeMediaType(response.headers["content-type"]);
    if (response.httpStatusCode === 200) {
      const body: GetSuppressionVersionHistoryResponse = ObjectSerializer.deserialize(
        ObjectSerializer.parse(await response.body.text(), contentType),
   ...
   * @throws ApiException if the response code was not in [200, 299]
   */
   public async getVulnerabilityNotificationRule(response: ResponseContext): Promise<NotificationRuleResponse> {
    const contentType = ObjectSerializer.normalizeMediaType(response.headers["content-type"]);
    if (response.httpStatusCode === 200) {
      const body: NotificationRuleResponse = ObjectSerializer.deserialize(
        ObjectSerializer.parse(await response.body.text(), contentType),
   ...
   * @throws ApiException if the response code was not in [200, 299]
   */
   public async getVulnerabilityNotificationRules(response: ResponseContext): Promise<NotificationRulesListResponse> {
    const contentType = ObjectSerializer.normalizeMediaType(response.headers["content-type"]);
    if (response.httpStatusCode === 200) {
      const body: NotificationRulesListResponse = ObjectSerializer.deserialize(
        ObjectSerializer.parse(await response.body.text(), contentType),
   ...
   * @throws ApiException if the response code was not in [200, 299]
   */
   public async importSecurityVulnerabilities(response: ResponseContext): Promise<void> {
    const contentType = ObjectSerializer.normalizeMediaType(response.headers["content-type"]);
    if (response.httpStatusCode === 200) {
      return;
    }
   ...
   * @throws ApiException if the response code was not in [200, 299]
   */
   public async listAssetsSBOMs(response: ResponseContext): Promise<ListAssetsSBOMsResponse> {
    const contentType = ObjectSerializer.normalizeMediaType(response.headers["content-type"]);
    if (response.httpStatusCode === 200) {
   ...
   * @throws ApiException if the response code was not in [200, 299]
   */
   public async listFindings(response: ResponseContext): Promise<ListFindingsResponse> {
    const contentType = ObjectSerializer.normalizeMediaType(response.headers["content-type"]);
    if (response.httpStatusCode === 200) {
   ...
   * @throws ApiException if the response code was not in [200, 299]
   */
   public async listHistoricalJobs(response: ResponseContext): Promise<ListHistoricalJobsResponse> {
    const contentType = ObjectSerializer.normalizeMediaType(response.headers["content-type"]);
    if (response.httpStatusCode === 200) {
   ...
   * @throws ApiException if the response code was not in [200, 299]
   */
   public async listIndicatorsOfCompromise(response: ResponseContext): Promise<IoCExplorerListResponse> {
    const contentType = ObjectSerializer.normalizeMediaType(response.headers["content-type"]);
    if (response.httpStatusCode === 200) {
   ...
   * @throws ApiException if the response code was not in [200, 299]
   */
   public async listMultipleRulesets(response: ResponseContext): Promise<GetMultipleRulesetsResponse> {
    const contentType = ObjectSerializer.normalizeMediaType(response.headers["content-type"]);
    if (response.httpStatusCode === 200) {
   ...
   * @throws ApiException if the response code was not in [200, 299]
   */
   public async listSampleLogGenerationSubscriptions(response: ResponseContext): Promise<SampleLogGenerationSubscriptionsResponse> {
    const contentType = ObjectSerializer.normalizeMediaType(response.headers["content-type"]);
    if (response.httpStatusCode === 200) {
      const body: SampleLogGenerationSubscriptionsResponse = ObjectSerializer.deserialize(
        ObjectSerializer.parse(await response.body.text(), contentType),
   ...
   * @throws ApiException if the response code was not in [200, 299]
   */
   public async listScannedAssetsMetadata(response: ResponseContext): Promise<ScannedAssetsMetadata> {
    const contentType = ObjectSerializer.normalizeMediaType(response.headers["content-type"]);
    if (response.httpStatusCode === 200) {
   ...
   * @throws ApiException if the response code was not in [200, 299]
   */
   public async listSecurityFilters(response: ResponseContext): Promise<SecurityFiltersResponse> {
    const contentType = ObjectSerializer.normalizeMediaType(response.headers["content-type"]);
    if (response.httpStatusCode === 200) {
   ...
   * @throws ApiException if the response code was not in [200, 299]
   */
   public async listSecurityFilterVersions(response: ResponseContext): Promise<SecurityFilterVersionsResponse> {
    const contentType = ObjectSerializer.normalizeMediaType(response.headers["content-type"]);
    if (response.httpStatusCode === 200) {
   ...
   * @throws ApiException if the response code was not in [200, 299]
   */
   public async listSecurityFindings(response: ResponseContext): Promise<ListSecurityFindingsResponse> {
    const contentType = ObjectSerializer.normalizeMediaType(response.headers["content-type"]);
    if (response.httpStatusCode === 200) {
   ...
   * @throws ApiException if the response code was not in [200, 299]
   */
   public async listSecurityFindingsAutomationDueDateRules(response: ResponseContext): Promise<DueDateRulesResponse> {
    const contentType = ObjectSerializer.normalizeMediaType(response.headers["content-type"]);
    if (response.httpStatusCode === 200) {
      const body: DueDateRulesResponse = ObjectSerializer.deserialize(
        ObjectSerializer.parse(await response.body.text(), contentType),
   ...
   * @throws ApiException if the response code was not in [200, 299]
   */
   public async listSecurityFindingsAutomationMuteRules(response: ResponseContext): Promise<MuteRulesResponse> {
    const contentType = ObjectSerializer.normalizeMediaType(response.headers["content-type"]);
    if (response.httpStatusCode === 200) {
      const body: MuteRulesResponse = ObjectSerializer.deserialize(
        ObjectSerializer.parse(await response.body.text(), contentType),
        "MuteRulesResponse"
   ...
   * @throws ApiException if the response code was not in [200, 299]
   */
   public async listSecurityFindingsAutomationTicketCreationRules(response: ResponseContext): Promise<TicketCreationRulesResponse> {
    const contentType = ObjectSerializer.normalizeMediaType(response.headers["content-type"]);
    if (response.httpStatusCode === 200) {
      const body: TicketCreationRulesResponse = ObjectSerializer.deserialize(
        ObjectSerializer.parse(await response.body.text(), contentType),
   ...
   * @throws ApiException if the response code was not in [200, 299]
   */
   public async listSecurityMonitoringCriticalAssets(response: ResponseContext): Promise<SecurityMonitoringCriticalAssetsResponse> {
    const contentType = ObjectSerializer.normalizeMediaType(response.headers["content-type"]);
    if (response.httpStatusCode === 200) {
      const body: SecurityMonitoringCriticalAssetsResponse = ObjectSerializer.deserialize(
        ObjectSerializer.parse(await response.body.text(), contentType),
   ...
   * @throws ApiException if the response code was not in [200, 299]
   */
   public async listSecurityMonitoringDatasets(response: ResponseContext): Promise<SecurityMonitoringDatasetsListResponse> {
    const contentType = ObjectSerializer.normalizeMediaType(response.headers["content-type"]);
    if (response.httpStatusCode === 200) {
      const body: SecurityMonitoringDatasetsListResponse = ObjectSerializer.deserialize(
        ObjectSerializer.parse(await response.body.text(), contentType),
   ...
   * @throws ApiException if the response code was not in [200, 299]
   */
   public async listSecurityMonitoringHistsignals(response: ResponseContext): Promise<SecurityMonitoringSignalsListResponse> {
    const contentType = ObjectSerializer.normalizeMediaType(response.headers["content-type"]);
    if (response.httpStatusCode === 200) {
      const body: SecurityMonitoringSignalsListResponse = ObjectSerializer.deserialize(
        ObjectSerializer.parse(await response.body.text(), contentType),
   ...
   * @throws ApiException if the response code was not in [200, 299]
   */
   public async listSecurityMonitoringIntegrationConfigs(response: ResponseContext): Promise<SecurityMonitoringIntegrationConfigsResponse> {
    const contentType = ObjectSerializer.normalizeMediaType(response.headers["content-type"]);
    if (response.httpStatusCode === 200) {
      const body: SecurityMonitoringIntegrationConfigsResponse = ObjectSerializer.deserialize(
        ObjectSerializer.parse(await response.body.text(), contentType),
   ...
   * @throws ApiException if the response code was not in [200, 299]
   */
   public async listSecurityMonitoringSuppressions(response: ResponseContext): Promise<SecurityMonitoringPaginatedSuppressionsResponse> {
    const contentType = ObjectSerializer.normalizeMediaType(response.headers["content-type"]);
    if (response.httpStatusCode === 200) {
      const body: SecurityMonitoringPaginatedSuppressionsResponse = ObjectSerializer.deserialize(
        ObjectSerializer.parse(await response.body.text(), contentType),
   ...
   * @throws ApiException if the response code was not in [200, 299]
   */
   public async listStaticAnalysisCodegenRulesets(response: ResponseContext): Promise<SastRulesetsResponse> {
    const contentType = ObjectSerializer.normalizeMediaType(response.headers["content-type"]);
    if (response.httpStatusCode === 200) {
   ...
   * @throws ApiException if the response code was not in [200, 299]
   */
   public async listVulnerabilities(response: ResponseContext): Promise<ListVulnerabilitiesResponse> {
    const contentType = ObjectSerializer.normalizeMediaType(response.headers["content-type"]);
    if (response.httpStatusCode === 200) {
   ...
   * @throws ApiException if the response code was not in [200, 299]
   */
   public async listVulnerableAssets(response: ResponseContext): Promise<ListVulnerableAssetsResponse> {
    const contentType = ObjectSerializer.normalizeMediaType(response.headers["content-type"]);
    if (response.httpStatusCode === 200) {
   ...
   * @throws ApiException if the response code was not in [200, 299]
   */
   public async muteSecurityFindings(response: ResponseContext): Promise<MuteFindingsResponse> {
    const contentType = ObjectSerializer.normalizeMediaType(response.headers["content-type"]);
    if (response.httpStatusCode === 202) {
   ...
   * @throws ApiException if the response code was not in [200, 299]
   */
   public async patchSignalNotificationRule(response: ResponseContext): Promise<NotificationRuleResponse> {
    const contentType = ObjectSerializer.normalizeMediaType(response.headers["content-type"]);
    if (response.httpStatusCode === 200) {
      const body: NotificationRuleResponse = ObjectSerializer.deserialize(
        ObjectSerializer.parse(await response.body.text(), contentType),
   ...
   * @throws ApiException if the response code was not in [200, 299]
   */
   public async patchVulnerabilityNotificationRule(response: ResponseContext): Promise<NotificationRuleResponse> {
    const contentType = ObjectSerializer.normalizeMediaType(response.headers["content-type"]);
    if (response.httpStatusCode === 200) {
      const body: NotificationRuleResponse = ObjectSerializer.deserialize(
        ObjectSerializer.parse(await response.body.text(), contentType),
   ...
   * @throws ApiException if the response code was not in [200, 299]
   */
   public async reorderSecurityFindingsAutomationDueDateRules(response: ResponseContext): Promise<DueDateRuleReorderRequest> {
    const contentType = ObjectSerializer.normalizeMediaType(response.headers["content-type"]);
    if (response.httpStatusCode === 200) {
   ...
   * @throws ApiException if the response code was not in [200, 299]
   */
   public async reorderSecurityFindingsAutomationMuteRules(response: ResponseContext): Promise<MuteRuleReorderRequest> {
    const contentType = ObjectSerializer.normalizeMediaType(response.headers["content-type"]);
    if (response.httpStatusCode === 200) {
   ...
   * @throws ApiException if the response code was not in [200, 299]
   */
   public async reorderSecurityFindingsAutomationTicketCreationRules(response: ResponseContext): Promise<TicketCreationRuleReorderRequest> {
    const contentType = ObjectSerializer.normalizeMediaType(response.headers["content-type"]);
    if (response.httpStatusCode === 200) {
      const body: TicketCreationRuleReorderRequest = ObjectSerializer.deserialize(
        ObjectSerializer.parse(await response.body.text(), contentType),
   ...
   * @throws ApiException if the response code was not in [200, 299]
   */
   public async restoreSecurityMonitoringRule(response: ResponseContext): Promise<SecurityMonitoringRuleResponse> {
    const contentType = ObjectSerializer.normalizeMediaType(response.headers["content-type"]);
    if (response.httpStatusCode === 200) {
      const body: SecurityMonitoringRuleResponse = ObjectSerializer.deserialize(
        ObjectSerializer.parse(await response.body.text(), contentType),
   ...
   * @throws ApiException if the response code was not in [200, 299]
   */
   public async runHistoricalJob(response: ResponseContext): Promise<JobCreateResponse> {
    const contentType = ObjectSerializer.normalizeMediaType(response.headers["content-type"]);
    if (response.httpStatusCode === 201) {
   ...
   * @throws ApiException if the response code was not in [200, 299]
   */
   public async searchSecurityFindings(response: ResponseContext): Promise<ListSecurityFindingsResponse> {
    const contentType = ObjectSerializer.normalizeMediaType(response.headers["content-type"]);
    if (response.httpStatusCode === 200) {
      const body: ListSecurityFindingsResponse = ObjectSerializer.deserialize(
        ObjectSerializer.parse(await response.body.text(), contentType),
   ...
   * @throws ApiException if the response code was not in [200, 299]
   */
   public async searchSecurityMonitoringHistsignals(response: ResponseContext): Promise<SecurityMonitoringSignalsListResponse> {
    const contentType = ObjectSerializer.normalizeMediaType(response.headers["content-type"]);
    if (response.httpStatusCode === 200) {
      const body: SecurityMonitoringSignalsListResponse = ObjectSerializer.deserialize(
        ObjectSerializer.parse(await response.body.text(), contentType),
   ...
   * @throws ApiException if the response code was not in [200, 299]
   */
   public async sendSecurityMonitoringNotificationPreview(response: ResponseContext): Promise<NotificationRulePreviewResponse> {
    const contentType = ObjectSerializer.normalizeMediaType(response.headers["content-type"]);
    if (response.httpStatusCode === 200) {
      const body: NotificationRulePreviewResponse = ObjectSerializer.deserialize(
        ObjectSerializer.parse(await response.body.text(), contentType),
   ...
   * @throws ApiException if the response code was not in [200, 299]
   */
   public async testExistingSecurityMonitoringRule(response: ResponseContext): Promise<SecurityMonitoringRuleTestResponse> {
    const contentType = ObjectSerializer.normalizeMediaType(response.headers["content-type"]);
    if (response.httpStatusCode === 200) {
   ...
   * @throws ApiException if the response code was not in [200, 299]
   */
   public async testSecurityMonitoringRule(response: ResponseContext): Promise<SecurityMonitoringRuleTestResponse> {
    const contentType = ObjectSerializer.normalizeMediaType(response.headers["content-type"]);
    if (response.httpStatusCode === 200) {
      const body: SecurityMonitoringRuleTestResponse = ObjectSerializer.deserialize(
        ObjectSerializer.parse(await response.body.text(), contentType),
   ...
   * @throws ApiException if the response code was not in [200, 299]
   */
   public async updateCustomFramework(response: ResponseContext): Promise<UpdateCustomFrameworkResponse> {
    const contentType = ObjectSerializer.normalizeMediaType(response.headers["content-type"]);
    if (response.httpStatusCode === 200) {
   ...
   * @throws ApiException if the response code was not in [200, 299]
   */
   public async updateFindingsAssignee(response: ResponseContext): Promise<AssigneeResponse> {
    const contentType = ObjectSerializer.normalizeMediaType(response.headers["content-type"]);
    if (response.httpStatusCode === 202) {
      const body: AssigneeResponse = ObjectSerializer.deserialize(
        ObjectSerializer.parse(await response.body.text(), contentType),
        "AssigneeResponse"
      ) as AssigneeResponse;
      return body;
   ...
   * @throws ApiException if the response code was not in [200, 299]
   */
   public async updateResourceEvaluationFilters(response: ResponseContext): Promise<UpdateResourceEvaluationFiltersResponse> {
    const contentType = ObjectSerializer.normalizeMediaType(response.headers["content-type"]);
    if (response.httpStatusCode === 201) {
      const body: UpdateResourceEvaluationFiltersResponse = ObjectSerializer.deserialize(
        ObjectSerializer.parse(await response.body.text(), contentType),
   ...
   * @throws ApiException if the response code was not in [200, 299]
   */
   public async updateSecurityFilter(response: ResponseContext): Promise<SecurityFilterResponse> {
    const contentType = ObjectSerializer.normalizeMediaType(response.headers["content-type"]);
    if (response.httpStatusCode === 200) {
      const body: SecurityFilterResponse = ObjectSerializer.deserialize(
        ObjectSerializer.parse(await response.body.text(), contentType),
   ...
   * @throws ApiException if the response code was not in [200, 299]
   */
   public async updateSecurityFindingsAutomationDueDateRule(response: ResponseContext): Promise<DueDateRuleResponse> {
    const contentType = ObjectSerializer.normalizeMediaType(response.headers["content-type"]);
    if (response.httpStatusCode === 200) {
      const body: DueDateRuleResponse = ObjectSerializer.deserialize(
        ObjectSerializer.parse(await response.body.text(), contentType),
   ...
   * @throws ApiException if the response code was not in [200, 299]
   */
   public async updateSecurityFindingsAutomationMuteRule(response: ResponseContext): Promise<MuteRuleResponse> {
    const contentType = ObjectSerializer.normalizeMediaType(response.headers["content-type"]);
    if (response.httpStatusCode === 200) {
      const body: MuteRuleResponse = ObjectSerializer.deserialize(
        ObjectSerializer.parse(await response.body.text(), contentType),
   ...
   * @throws ApiException if the response code was not in [200, 299]
   */
   public async updateSecurityFindingsAutomationTicketCreationRule(response: ResponseContext): Promise<TicketCreationRuleResponse> {
    const contentType = ObjectSerializer.normalizeMediaType(response.headers["content-type"]);
    if (response.httpStatusCode === 200) {
      const body: TicketCreationRuleResponse = ObjectSerializer.deserialize(
        ObjectSerializer.parse(await response.body.text(), contentType),
   ...
   * @throws ApiException if the response code was not in [200, 299]
   */
   public async updateSecurityMonitoringCriticalAsset(response: ResponseContext): Promise<SecurityMonitoringCriticalAssetResponse> {
    const contentType = ObjectSerializer.normalizeMediaType(response.headers["content-type"]);
    if (response.httpStatusCode === 200) {
      const body: SecurityMonitoringCriticalAssetResponse = ObjectSerializer.deserialize(
        ObjectSerializer.parse(await response.body.text(), contentType),
   ...
   * @throws ApiException if the response code was not in [200, 299]
   */
   public async updateSecurityMonitoringDataset(response: ResponseContext): Promise<void> {
    const contentType = ObjectSerializer.normalizeMediaType(response.headers["content-type"]);
    if (response.httpStatusCode === 204) {
      return;
    }
    if (response.httpStatusCode === 400||response.httpStatusCode === 403||response.httpStatusCode === 404||response.httpStatusCode === 409) {
      const bodyText = ObjectSerializer.parse(await response.body.text(), contentType);
      let body: JSONAPIErrorResponse;
      try {
        body = ObjectSerializer.deserialize(
   ...
   * @throws ApiException if the response code was not in [200, 299]
   */
   public async updateSecurityMonitoringIntegrationConfig(response: ResponseContext): Promise<SecurityMonitoringIntegrationConfigResponse> {
    const contentType = ObjectSerializer.normalizeMediaType(response.headers["content-type"]);
    if (response.httpStatusCode === 200) {
      const body: SecurityMonitoringIntegrationConfigResponse = ObjectSerializer.deserialize(
        ObjectSerializer.parse(await response.body.text(), contentType),
   ...
   * @throws ApiException if the response code was not in [200, 299]
   */
   public async updateSecurityMonitoringSuppression(response: ResponseContext): Promise<SecurityMonitoringSuppressionResponse> {
    const contentType = ObjectSerializer.normalizeMediaType(response.headers["content-type"]);
    if (response.httpStatusCode === 200) {
      const body: SecurityMonitoringSuppressionResponse = ObjectSerializer.deserialize(
        ObjectSerializer.parse(await response.body.text(), contentType),
   ...
   * @throws ApiException if the response code was not in [200, 299]
   */
   public async validateSecurityMonitoringIntegrationConfig(response: ResponseContext): Promise<void> {
    const contentType = ObjectSerializer.normalizeMediaType(response.headers["content-type"]);
    if (response.httpStatusCode === 200) {
      return;
    }
   ...
   * @throws ApiException if the response code was not in [200, 299]
   */
   public async validateSecurityMonitoringIntegrationCredentials(response: ResponseContext): Promise<void> {
    const contentType = ObjectSerializer.normalizeMediaType(response.headers["content-type"]);
    if (response.httpStatusCode === 200) {
      return;
    }
   ...
   * @throws ApiException if the response code was not in [200, 299]
   */
   public async validateSecurityMonitoringRule(response: ResponseContext): Promise<void> {
    const contentType = ObjectSerializer.normalizeMediaType(response.headers["content-type"]);
    if (response.httpStatusCode === 204) {
      return;
    }
   ...
   * @throws ApiException if the response code was not in [200, 299]
   */
   public async validateSecurityMonitoringSuppression(response: ResponseContext): Promise<void> {
    const contentType = ObjectSerializer.normalizeMediaType(response.headers["content-type"]);
    if (response.httpStatusCode === 204) {
      return;
    }
...
export class SecurityMonitoringApi {
   ...
   */
  public activateContentPack(param: SecurityMonitoringApiActivateContentPackRequest, options?: Configuration): Promise<void> {
   ...
   * @param param The request object
   */
  public activateIntegration(param: SecurityMonitoringApiActivateIntegrationRequest, options?: Configuration): Promise<SecurityMonitoringIntegrationConfigResponse> {
   ...
   * @param param The request object
   */
  public attachCase(param: SecurityMonitoringApiAttachCaseRequest, options?: Configuration): Promise<FindingCaseResponse> {
   ...
   * @param param The request object
   */
  public attachJiraIssue(param: SecurityMonitoringApiAttachJiraIssueRequest, options?: Configuration): Promise<FindingCaseResponse> {
   ...
   * @param param The request object
   */
  public attachLinearIssue(param: SecurityMonitoringApiAttachLinearIssueRequest, options?: Configuration): Promise<FindingCaseResponse> {
   ...
   * @param param The request object
   */
  public attachServiceNowTicket(param: SecurityMonitoringApiAttachServiceNowTicketRequest, options?: Configuration): Promise<FindingCaseResponse> {
   ...
   * @param param The request object
   */
  public batchGetSecurityMonitoringDatasetDependencies(param: SecurityMonitoringApiBatchGetSecurityMonitoringDatasetDependenciesRequest, options?: Configuration): Promise<SecurityMonitoringDatasetDependenciesResponse> {
   ...
   * @param param The request object
   */
  public bulkConvertExistingSecurityMonitoringRules(param: SecurityMonitoringApiBulkConvertExistingSecurityMonitoringRulesRequest, options?: Configuration): Promise<HttpFile> {
   ...
   * @param param The request object
   */
  public bulkCreateSampleLogGenerationSubscriptions(param: SecurityMonitoringApiBulkCreateSampleLogGenerationSubscriptionsRequest, options?: Configuration): Promise<SampleLogGenerationBulkSubscriptionResponse> {
   ...
   * @param param The request object
   */
  public bulkDeleteSecurityMonitoringRules(param: SecurityMonitoringApiBulkDeleteSecurityMonitoringRulesRequest, options?: Configuration): Promise<SecurityMonitoringRuleBulkDeleteResponse> {
   ...
   * @param param The request object
   */
  public bulkEditSecurityMonitoringSignals(param: SecurityMonitoringApiBulkEditSecurityMonitoringSignalsRequest, options?: Configuration): Promise<SecurityMonitoringSignalsBulkTriageUpdateResponse> {
   ...
   * @param param The request object
   */
  public bulkEditSecurityMonitoringSignalsAssignee(param: SecurityMonitoringApiBulkEditSecurityMonitoringSignalsAssigneeRequest, options?: Configuration): Promise<SecurityMonitoringSignalsBulkTriageUpdateResponse> {
   ...
   * @param param The request object
   */
  public bulkEditSecurityMonitoringSignalsState(param: SecurityMonitoringApiBulkEditSecurityMonitoringSignalsStateRequest, options?: Configuration): Promise<SecurityMonitoringSignalsBulkTriageUpdateResponse> {
   ...
   * @param param The request object
   */
  public bulkExportSecurityMonitoringRules(param: SecurityMonitoringApiBulkExportSecurityMonitoringRulesRequest, options?: Configuration): Promise<HttpFile> {
   ...
   * @param param The request object
   */
  public bulkExportSecurityMonitoringTerraformResources(param: SecurityMonitoringApiBulkExportSecurityMonitoringTerraformResourcesRequest, options?: Configuration): Promise<HttpFile> {
   ...
   * @param param The request object
   */
  public cancelHistoricalJob(param: SecurityMonitoringApiCancelHistoricalJobRequest, options?: Configuration): Promise<void> {
   ...
   * @param param The request object
   */
  public convertExistingSecurityMonitoringRule(param: SecurityMonitoringApiConvertExistingSecurityMonitoringRuleRequest, options?: Configuration): Promise<SecurityMonitoringRuleConvertResponse> {
   ...
   * @param param The request object
   */
  public convertJobResultToSignal(param: SecurityMonitoringApiConvertJobResultToSignalRequest, options?: Configuration): Promise<void> {
   ...
   * @param param The request object
   */
  public convertSecurityMonitoringRuleFromJSONToTerraform(param: SecurityMonitoringApiConvertSecurityMonitoringRuleFromJSONToTerraformRequest, options?: Configuration): Promise<SecurityMonitoringRuleConvertResponse> {
   ...
   * @param param The request object
   */
  public convertSecurityMonitoringTerraformResource(param: SecurityMonitoringApiConvertSecurityMonitoringTerraformResourceRequest, options?: Configuration): Promise<SecurityMonitoringTerraformExportResponse> {
   ...
   * @param param The request object
   */
  public createCases(param: SecurityMonitoringApiCreateCasesRequest, options?: Configuration): Promise<FindingCaseResponseArray> {
   ...
   * @param param The request object
   */
  public createCustomFramework(param: SecurityMonitoringApiCreateCustomFrameworkRequest, options?: Configuration): Promise<CreateCustomFrameworkResponse> {
   ...
   * @param param The request object
   */
  public createIoCTriageState(param: SecurityMonitoringApiCreateIoCTriageStateRequest, options?: Configuration): Promise<IoCTriageWriteResponse> {
   ...
   * @param param The request object
   */
  public createJiraIssues(param: SecurityMonitoringApiCreateJiraIssuesRequest, options?: Configuration): Promise<FindingCaseResponseArray> {
   ...
   * @param param The request object
   */
  public createLinearIssues(param: SecurityMonitoringApiCreateLinearIssuesRequest, options?: Configuration): Promise<FindingCaseResponseArray> {
   ...
   * @param param The request object
   */
  public createSampleLogGenerationSubscription(param: SecurityMonitoringApiCreateSampleLogGenerationSubscriptionRequest, options?: Configuration): Promise<SampleLogGenerationSubscriptionResponse> {
   ...
   * @param param The request object
   */
  public createSecurityFindingsAutomationDueDateRule(param: SecurityMonitoringApiCreateSecurityFindingsAutomationDueDateRuleRequest, options?: Configuration): Promise<DueDateRuleResponse> {
   ...
   * @param param The request object
   */
  public createSecurityFindingsAutomationMuteRule(param: SecurityMonitoringApiCreateSecurityFindingsAutomationMuteRuleRequest, options?: Configuration): Promise<MuteRuleResponse> {
   ...
   * @param param The request object
   */
  public createSecurityFindingsAutomationTicketCreationRule(param: SecurityMonitoringApiCreateSecurityFindingsAutomationTicketCreationRuleRequest, options?: Configuration): Promise<TicketCreationRuleResponse> {
   ...
   * @param param The request object
   */
  public createSecurityMonitoringCriticalAsset(param: SecurityMonitoringApiCreateSecurityMonitoringCriticalAssetRequest, options?: Configuration): Promise<SecurityMonitoringCriticalAssetResponse> {
   ...
   * @param param The request object
   */
  public createSecurityMonitoringDataset(param: SecurityMonitoringApiCreateSecurityMonitoringDatasetRequest, options?: Configuration): Promise<SecurityMonitoringDatasetCreateResponse> {
   ...
   * @param param The request object
   */
  public createSecurityMonitoringIntegrationConfig(param: SecurityMonitoringApiCreateSecurityMonitoringIntegrationConfigRequest, options?: Configuration): Promise<SecurityMonitoringIntegrationConfigResponse> {
   ...
   * @param param The request object
   */
  public createSecurityMonitoringSuppression(param: SecurityMonitoringApiCreateSecurityMonitoringSuppressionRequest, options?: Configuration): Promise<SecurityMonitoringSuppressionResponse> {
   ...
   * @param param The request object
   */
  public createServiceNowTickets(param: SecurityMonitoringApiCreateServiceNowTicketsRequest, options?: Configuration): Promise<FindingCaseResponseArray> {
   ...
   * @param param The request object
   */
  public createSignalNotificationRule(param: SecurityMonitoringApiCreateSignalNotificationRuleRequest, options?: Configuration): Promise<NotificationRuleResponse> {
   ...
   * @param param The request object
   */
  public createStaticAnalysisAst(param: SecurityMonitoringApiCreateStaticAnalysisAstRequest, options?: Configuration): Promise<GetAstResponse> {
   ...
   * @param param The request object
   */
  public createStaticAnalysisServerAnalysis(param: SecurityMonitoringApiCreateStaticAnalysisServerAnalysisRequest, options?: Configuration): Promise<AnalysisResponse> {
   ...
   * @param param The request object
   */
  public createVulnerabilityNotificationRule(param: SecurityMonitoringApiCreateVulnerabilityNotificationRuleRequest, options?: Configuration): Promise<NotificationRuleResponse> {
   ...
   * @param param The request object
   */
  public deactivateContentPack(param: SecurityMonitoringApiDeactivateContentPackRequest, options?: Configuration): Promise<void> {
   ...
   * @param param The request object
   */
  public deactivateIntegration(param: SecurityMonitoringApiDeactivateIntegrationRequest, options?: Configuration): Promise<SecurityMonitoringIntegrationConfigResponse> {
   ...
   * @param param The request object
   */
  public deleteCustomFramework(param: SecurityMonitoringApiDeleteCustomFrameworkRequest, options?: Configuration): Promise<DeleteCustomFrameworkResponse> {
   ...
   * @param param The request object
   */
  public deleteHistoricalJob(param: SecurityMonitoringApiDeleteHistoricalJobRequest, options?: Configuration): Promise<void> {
   ...
   * @param param The request object
   */
  public deleteSampleLogGenerationSubscription(param: SecurityMonitoringApiDeleteSampleLogGenerationSubscriptionRequest, options?: Configuration): Promise<SampleLogGenerationSubscriptionResponse> {
   ...
   * @param param The request object
   */
  public deleteSecurityFindingsAutomationDueDateRule(param: SecurityMonitoringApiDeleteSecurityFindingsAutomationDueDateRuleRequest, options?: Configuration): Promise<void> {
   ...
   * @param param The request object
   */
  public deleteSecurityFindingsAutomationMuteRule(param: SecurityMonitoringApiDeleteSecurityFindingsAutomationMuteRuleRequest, options?: Configuration): Promise<void> {
   ...
   * @param param The request object
   */
  public deleteSecurityFindingsAutomationTicketCreationRule(param: SecurityMonitoringApiDeleteSecurityFindingsAutomationTicketCreationRuleRequest, options?: Configuration): Promise<void> {
   ...
   * @param param The request object
   */
  public deleteSecurityMonitoringCriticalAsset(param: SecurityMonitoringApiDeleteSecurityMonitoringCriticalAssetRequest, options?: Configuration): Promise<void> {
   ...
   * @param param The request object
   */
  public deleteSecurityMonitoringDataset(param: SecurityMonitoringApiDeleteSecurityMonitoringDatasetRequest, options?: Configuration): Promise<void> {
   ...
   * @param param The request object
   */
  public deleteSecurityMonitoringIntegrationConfig(param: SecurityMonitoringApiDeleteSecurityMonitoringIntegrationConfigRequest, options?: Configuration): Promise<void> {
   ...
   * @param param The request object
   */
  public deleteSecurityMonitoringSuppression(param: SecurityMonitoringApiDeleteSecurityMonitoringSuppressionRequest, options?: Configuration): Promise<void> {
   ...
   * @param param The request object
   */
  public deleteSignalNotificationRule(param: SecurityMonitoringApiDeleteSignalNotificationRuleRequest, options?: Configuration): Promise<void> {
   ...
   * @param param The request object
   */
  public deleteVulnerabilityNotificationRule(param: SecurityMonitoringApiDeleteVulnerabilityNotificationRuleRequest, options?: Configuration): Promise<void> {
   ...
   * @param param The request object
   */
  public detachCase(param: SecurityMonitoringApiDetachCaseRequest, options?: Configuration): Promise<void> {
   ...
   * @param param The request object
   */
  public editSecurityMonitoringSignal(param: SecurityMonitoringApiEditSecurityMonitoringSignalRequest, options?: Configuration): Promise<SecurityMonitoringSignalTriageUpdateResponse> {
   ...
   * @param param The request object
   */
  public editSecurityMonitoringSignalAssignee(param: SecurityMonitoringApiEditSecurityMonitoringSignalAssigneeRequest, options?: Configuration): Promise<SecurityMonitoringSignalTriageUpdateResponse> {
   ...
   * @param param The request object
   */
  public editSecurityMonitoringSignalIncidents(param: SecurityMonitoringApiEditSecurityMonitoringSignalIncidentsRequest, options?: Configuration): Promise<SecurityMonitoringSignalTriageUpdateResponse> {
   ...
   * @param param The request object
   */
  public editSecurityMonitoringSignalState(param: SecurityMonitoringApiEditSecurityMonitoringSignalStateRequest, options?: Configuration): Promise<SecurityMonitoringSignalTriageUpdateResponse> {
   ...
   * @param param The request object
   */
  public exportSecurityMonitoringTerraformResource(param: SecurityMonitoringApiExportSecurityMonitoringTerraformResourceRequest, options?: Configuration): Promise<SecurityMonitoringTerraformExportResponse> {
   ...
   * @param param The request object
   */
  public getContentPacksStates( options?: Configuration): Promise<SecurityMonitoringContentPackStatesResponse> {
   ...
   * @param param The request object
   */
  public getCriticalAssetsAffectingRule(param: SecurityMonitoringApiGetCriticalAssetsAffectingRuleRequest, options?: Configuration): Promise<SecurityMonitoringCriticalAssetsResponse> {
   ...
   * @param param The request object
   */
  public getCustomFramework(param: SecurityMonitoringApiGetCustomFrameworkRequest, options?: Configuration): Promise<GetCustomFrameworkResponse> {
   ...
   * @param param The request object
   */
  public getEntityContext(param: SecurityMonitoringApiGetEntityContextRequest = {}, options?: Configuration): Promise<EntityContextResponse> {
   ...
   * @param param The request object
   */
  public getEntraIdAzureAppRegistrations( options?: Configuration): Promise<SecurityMonitoringEntraIdAzureAppRegistrationsResponse> {
   ...
   * @param param The request object
   */
  public getFinding(param: SecurityMonitoringApiGetFindingRequest, options?: Configuration): Promise<GetFindingResponse> {
   ...
   * @param param The request object
   */
  public getHistoricalJob(param: SecurityMonitoringApiGetHistoricalJobRequest, options?: Configuration): Promise<HistoricalJobResponse> {
   ...
   * @param param The request object
   */
  public getIndicatorOfCompromise(param: SecurityMonitoringApiGetIndicatorOfCompromiseRequest, options?: Configuration): Promise<GetIoCIndicatorResponse> {
   ...
   * @param param The request object
   */
  public getInvestigationLogQueriesMatchingSignal(param: SecurityMonitoringApiGetInvestigationLogQueriesMatchingSignalRequest, options?: Configuration): Promise<SecurityMonitoringSignalSuggestedActionsResponse> {
   ...
   * @param param The request object
   */
  public getResourceEvaluationFilters(param: SecurityMonitoringApiGetResourceEvaluationFiltersRequest = {}, options?: Configuration): Promise<GetResourceEvaluationFiltersResponse> {
   ...
   * @param param The request object
   */
  public getRuleVersionHistory(param: SecurityMonitoringApiGetRuleVersionHistoryRequest, options?: Configuration): Promise<GetRuleVersionHistoryResponse> {
   ...
   * @param param The request object
   */
  public getSBOM(param: SecurityMonitoringApiGetSBOMRequest, options?: Configuration): Promise<GetSBOMResponse> {
   ...
   * @param param The request object
   */
  public getSecurityFindingsAutomationDueDateRule(param: SecurityMonitoringApiGetSecurityFindingsAutomationDueDateRuleRequest, options?: Configuration): Promise<DueDateRuleResponse> {
   ...
   * @param param The request object
   */
  public getSecurityFindingsAutomationMuteRule(param: SecurityMonitoringApiGetSecurityFindingsAutomationMuteRuleRequest, options?: Configuration): Promise<MuteRuleResponse> {
   ...
   * @param param The request object
   */
  public getSecurityFindingsAutomationTicketCreationRule(param: SecurityMonitoringApiGetSecurityFindingsAutomationTicketCreationRuleRequest, options?: Configuration): Promise<TicketCreationRuleResponse> {
   ...
   * @param param The request object
   */
  public getSecurityMonitoringCriticalAsset(param: SecurityMonitoringApiGetSecurityMonitoringCriticalAssetRequest, options?: Configuration): Promise<SecurityMonitoringCriticalAssetResponse> {
   ...
   * @param param The request object
   */
  public getSecurityMonitoringDataset(param: SecurityMonitoringApiGetSecurityMonitoringDatasetRequest, options?: Configuration): Promise<SecurityMonitoringDatasetResponse> {
   ...
   * @param param The request object
   */
  public getSecurityMonitoringDatasetByVersion(param: SecurityMonitoringApiGetSecurityMonitoringDatasetByVersionRequest, options?: Configuration): Promise<SecurityMonitoringDatasetResponse> {
   ...
   * @param param The request object
   */
  public getSecurityMonitoringDatasetVersionHistory(param: SecurityMonitoringApiGetSecurityMonitoringDatasetVersionHistoryRequest, options?: Configuration): Promise<SecurityMonitoringDatasetVersionHistoryResponse> {
   ...
   * @param param The request object
   */
  public getSecurityMonitoringHistsignal(param: SecurityMonitoringApiGetSecurityMonitoringHistsignalRequest, options?: Configuration): Promise<SecurityMonitoringSignalResponse> {
   ...
   * @param param The request object
   */
  public getSecurityMonitoringHistsignalsByJobId(param: SecurityMonitoringApiGetSecurityMonitoringHistsignalsByJobIdRequest, options?: Configuration): Promise<SecurityMonitoringSignalsListResponse> {
   ...
   * @param param The request object
   */
  public getSecurityMonitoringIntegrationConfig(param: SecurityMonitoringApiGetSecurityMonitoringIntegrationConfigRequest, options?: Configuration): Promise<SecurityMonitoringIntegrationConfigResponse> {
   ...
   * @param param The request object
   */
  public getSecurityMonitoringSignal(param: SecurityMonitoringApiGetSecurityMonitoringSignalRequest, options?: Configuration): Promise<SecurityMonitoringSignalResponse> {
   ...
   * @param param The request object
   */
  public getSecurityMonitoringSuppression(param: SecurityMonitoringApiGetSecurityMonitoringSuppressionRequest, options?: Configuration): Promise<SecurityMonitoringSuppressionResponse> {
   ...
   * @param param The request object
   */
  public getSignalEntities(param: SecurityMonitoringApiGetSignalEntitiesRequest, options?: Configuration): Promise<SignalEntitiesResponse> {
   ...
   * @param param The request object
   */
  public getSignalNotificationRule(param: SecurityMonitoringApiGetSignalNotificationRuleRequest, options?: Configuration): Promise<NotificationRuleResponse> {
   ...
   * @param param The request object
   */
  public getSignalNotificationRules( options?: Configuration): Promise<NotificationRulesListResponse> {
   ...
   * @param param The request object
   */
  public getSingleEntityContext(param: SecurityMonitoringApiGetSingleEntityContextRequest, options?: Configuration): Promise<SingleEntityContextResponse> {
   ...
   * @param param The request object
   */
  public getStaticAnalysisDefaultRulesets(param: SecurityMonitoringApiGetStaticAnalysisDefaultRulesetsRequest, options?: Configuration): Promise<DefaultRulesetsPerLanguageResponse> {
   ...
   * @param param The request object
   */
  public getStaticAnalysisNodeTypes(param: SecurityMonitoringApiGetStaticAnalysisNodeTypesRequest, options?: Configuration): Promise<NodeTypesResponse> {
   ...
   * @param param The request object
   */
  public getStaticAnalysisRuleset(param: SecurityMonitoringApiGetStaticAnalysisRulesetRequest, options?: Configuration): Promise<SastRulesetResponse> {
   ...
   * @param param The request object
   */
  public getStaticAnalysisTreeSitterWasm(param: SecurityMonitoringApiGetStaticAnalysisTreeSitterWasmRequest, options?: Configuration): Promise<HttpFile> {
   ...
   * @param param The request object
   */
  public getSuggestedActionsMatchingSignal(param: SecurityMonitoringApiGetSuggestedActionsMatchingSignalRequest, options?: Configuration): Promise<SecurityMonitoringSignalSuggestedActionsResponse> {
   ...
   * @param param The request object
   */
  public getSuppressionsAffectingFutureRule(param: SecurityMonitoringApiGetSuppressionsAffectingFutureRuleRequest, options?: Configuration): Promise<SecurityMonitoringSuppressionsResponse> {
   ...
   * @param param The request object
   */
  public getSuppressionsAffectingRule(param: SecurityMonitoringApiGetSuppressionsAffectingRuleRequest, options?: Configuration): Promise<SecurityMonitoringSuppressionsResponse> {
   ...
   * @param param The request object
   */
  public getSuppressionVersionHistory(param: SecurityMonitoringApiGetSuppressionVersionHistoryRequest, options?: Configuration): Promise<GetSuppressionVersionHistoryResponse> {
   ...
   * @param param The request object
   */
  public getVulnerabilityNotificationRule(param: SecurityMonitoringApiGetVulnerabilityNotificationRuleRequest, options?: Configuration): Promise<NotificationRuleResponse> {
   ...
   * @param param The request object
   */
  public getVulnerabilityNotificationRules( options?: Configuration): Promise<NotificationRulesListResponse> {
   ...
   * @param param The request object
   */
  public importSecurityVulnerabilities(param: SecurityMonitoringApiImportSecurityVulnerabilitiesRequest, options?: Configuration): Promise<void> {
   ...
   * @param param The request object
   */
  public listAssetsSBOMs(param: SecurityMonitoringApiListAssetsSBOMsRequest = {}, options?: Configuration): Promise<ListAssetsSBOMsResponse> {
   ...
   * @param param The request object
   */
  public listFindings(param: SecurityMonitoringApiListFindingsRequest = {}, options?: Configuration): Promise<ListFindingsResponse> {
...
/**
   ...
   * @param param The request object
   */
  public listHistoricalJobs(param: SecurityMonitoringApiListHistoricalJobsRequest = {}, options?: Configuration): Promise<ListHistoricalJobsResponse> {
   ...
   * @param param The request object
   */
  public listIndicatorsOfCompromise(param: SecurityMonitoringApiListIndicatorsOfCompromiseRequest = {}, options?: Configuration): Promise<IoCExplorerListResponse> {
   ...
   * @param param The request object
   */
  public listMultipleRulesets(param: SecurityMonitoringApiListMultipleRulesetsRequest, options?: Configuration): Promise<GetMultipleRulesetsResponse> {
   ...
   * @param param The request object
   */
  public listSampleLogGenerationSubscriptions(param: SecurityMonitoringApiListSampleLogGenerationSubscriptionsRequest = {}, options?: Configuration): Promise<SampleLogGenerationSubscriptionsResponse> {
   ...
   * @param param The request object
   */
  public listScannedAssetsMetadata(param: SecurityMonitoringApiListScannedAssetsMetadataRequest = {}, options?: Configuration): Promise<ScannedAssetsMetadata> {
   ...
   * @param param The request object
   */
  public listSecurityFilterVersions( options?: Configuration): Promise<SecurityFilterVersionsResponse> {
   ...
   * @param param The request object
   */
  public listSecurityFindings(param: SecurityMonitoringApiListSecurityFindingsRequest = {}, options?: Configuration): Promise<ListSecurityFindingsResponse> {
...
/**
   ...
   * @param param The request object
   */
  public listSecurityFindingsAutomationDueDateRules(param: SecurityMonitoringApiListSecurityFindingsAutomationDueDateRulesRequest = {}, options?: Configuration): Promise<DueDateRulesResponse> {
   ...
   * @param param The request object
   */
  public listSecurityFindingsAutomationMuteRules(param: SecurityMonitoringApiListSecurityFindingsAutomationMuteRulesRequest = {}, options?: Configuration): Promise<MuteRulesResponse> {
   ...
   * @param param The request object
   */
  public listSecurityFindingsAutomationTicketCreationRules(param: SecurityMonitoringApiListSecurityFindingsAutomationTicketCreationRulesRequest = {}, options?: Configuration): Promise<TicketCreationRulesResponse> {
   ...
   * @param param The request object
   */
  public listSecurityMonitoringCriticalAssets( options?: Configuration): Promise<SecurityMonitoringCriticalAssetsResponse> {
   ...
   * @param param The request object
   */
  public listSecurityMonitoringDatasets(param: SecurityMonitoringApiListSecurityMonitoringDatasetsRequest = {}, options?: Configuration): Promise<SecurityMonitoringDatasetsListResponse> {
   ...
   * @param param The request object
   */
  public listSecurityMonitoringHistsignals(param: SecurityMonitoringApiListSecurityMonitoringHistsignalsRequest = {}, options?: Configuration): Promise<SecurityMonitoringSignalsListResponse> {
   ...
   * @param param The request object
   */
  public listSecurityMonitoringIntegrationConfigs(param: SecurityMonitoringApiListSecurityMonitoringIntegrationConfigsRequest = {}, options?: Configuration): Promise<SecurityMonitoringIntegrationConfigsResponse> {
...
/**
   ...
   * @param param The request object
   */
  public listSecurityMonitoringSuppressions(param: SecurityMonitoringApiListSecurityMonitoringSuppressionsRequest = {}, options?: Configuration): Promise<SecurityMonitoringPaginatedSuppressionsResponse> {
   ...
   * @param param The request object
   */
  public listStaticAnalysisCodegenRulesets( options?: Configuration): Promise<SastRulesetsResponse> {
   ...
   * @param param The request object
   */
  public listVulnerabilities(param: SecurityMonitoringApiListVulnerabilitiesRequest = {}, options?: Configuration): Promise<ListVulnerabilitiesResponse> {
   ...
   * @param param The request object
   */
  public listVulnerableAssets(param: SecurityMonitoringApiListVulnerableAssetsRequest = {}, options?: Configuration): Promise<ListVulnerableAssetsResponse> {
   ...
   * @param param The request object
   */
  public muteSecurityFindings(param: SecurityMonitoringApiMuteSecurityFindingsRequest, options?: Configuration): Promise<MuteFindingsResponse> {
   ...
   * @param param The request object
   */
  public patchSignalNotificationRule(param: SecurityMonitoringApiPatchSignalNotificationRuleRequest, options?: Configuration): Promise<NotificationRuleResponse> {
   ...
   * @param param The request object
   */
  public patchVulnerabilityNotificationRule(param: SecurityMonitoringApiPatchVulnerabilityNotificationRuleRequest, options?: Configuration): Promise<NotificationRuleResponse> {
   ...
   * @param param The request object
   */
  public reorderSecurityFindingsAutomationDueDateRules(param: SecurityMonitoringApiReorderSecurityFindingsAutomationDueDateRulesRequest, options?: Configuration): Promise<DueDateRuleReorderRequest> {
   ...
   * @param param The request object
   */
  public reorderSecurityFindingsAutomationMuteRules(param: SecurityMonitoringApiReorderSecurityFindingsAutomationMuteRulesRequest, options?: Configuration): Promise<MuteRuleReorderRequest> {
   ...
   * @param param The request object
   */
  public reorderSecurityFindingsAutomationTicketCreationRules(param: SecurityMonitoringApiReorderSecurityFindingsAutomationTicketCreationRulesRequest, options?: Configuration): Promise<TicketCreationRuleReorderRequest> {
   ...
   * @param param The request object
   */
  public restoreSecurityMonitoringRule(param: SecurityMonitoringApiRestoreSecurityMonitoringRuleRequest, options?: Configuration): Promise<SecurityMonitoringRuleResponse> {
   ...
   * @param param The request object
   */
  public runHistoricalJob(param: SecurityMonitoringApiRunHistoricalJobRequest, options?: Configuration): Promise<JobCreateResponse> {
   ...
   * @param param The request object
   */
  public searchSecurityFindings(param: SecurityMonitoringApiSearchSecurityFindingsRequest, options?: Configuration): Promise<ListSecurityFindingsResponse> {
...
/**
   ...
   * @param param The request object
   */
  public searchSecurityMonitoringHistsignals(param: SecurityMonitoringApiSearchSecurityMonitoringHistsignalsRequest = {}, options?: Configuration): Promise<SecurityMonitoringSignalsListResponse> {
...
/**
   ...
   * @param param The request object
   */
  public sendSecurityMonitoringNotificationPreview(param: SecurityMonitoringApiSendSecurityMonitoringNotificationPreviewRequest, options?: Configuration): Promise<NotificationRulePreviewResponse> {
   ...
   * @param param The request object
   */
  public testExistingSecurityMonitoringRule(param: SecurityMonitoringApiTestExistingSecurityMonitoringRuleRequest, options?: Configuration): Promise<SecurityMonitoringRuleTestResponse> {
   ...
   * @param param The request object
   */
  public testSecurityMonitoringRule(param: SecurityMonitoringApiTestSecurityMonitoringRuleRequest, options?: Configuration): Promise<SecurityMonitoringRuleTestResponse> {
   ...
   * @param param The request object
   */
  public updateCustomFramework(param: SecurityMonitoringApiUpdateCustomFrameworkRequest, options?: Configuration): Promise<UpdateCustomFrameworkResponse> {
   ...
   * @param param The request object
   */
  public updateFindingsAssignee(param: SecurityMonitoringApiUpdateFindingsAssigneeRequest, options?: Configuration): Promise<AssigneeResponse> {
   ...
   * @param param The request object
   */
  public updateResourceEvaluationFilters(param: SecurityMonitoringApiUpdateResourceEvaluationFiltersRequest, options?: Configuration): Promise<UpdateResourceEvaluationFiltersResponse> {
   ...
   * @param param The request object
   */
  public updateSecurityFindingsAutomationDueDateRule(param: SecurityMonitoringApiUpdateSecurityFindingsAutomationDueDateRuleRequest, options?: Configuration): Promise<DueDateRuleResponse> {
   ...
   * @param param The request object
   */
  public updateSecurityFindingsAutomationMuteRule(param: SecurityMonitoringApiUpdateSecurityFindingsAutomationMuteRuleRequest, options?: Configuration): Promise<MuteRuleResponse> {
   ...
   * @param param The request object
   */
  public updateSecurityFindingsAutomationTicketCreationRule(param: SecurityMonitoringApiUpdateSecurityFindingsAutomationTicketCreationRuleRequest, options?: Configuration): Promise<TicketCreationRuleResponse> {
   ...
   * @param param The request object
   */
  public updateSecurityMonitoringCriticalAsset(param: SecurityMonitoringApiUpdateSecurityMonitoringCriticalAssetRequest, options?: Configuration): Promise<SecurityMonitoringCriticalAssetResponse> {
   ...
   * @param param The request object
   */
  public updateSecurityMonitoringDataset(param: SecurityMonitoringApiUpdateSecurityMonitoringDatasetRequest, options?: Configuration): Promise<void> {
   ...
   * @param param The request object
   */
  public updateSecurityMonitoringIntegrationConfig(param: SecurityMonitoringApiUpdateSecurityMonitoringIntegrationConfigRequest, options?: Configuration): Promise<SecurityMonitoringIntegrationConfigResponse> {
   ...
   * @param param The request object
   */
  public updateSecurityMonitoringSuppression(param: SecurityMonitoringApiUpdateSecurityMonitoringSuppressionRequest, options?: Configuration): Promise<SecurityMonitoringSuppressionResponse> {
   ...
   * @param param The request object
   */
  public validateSecurityMonitoringIntegrationConfig(param: SecurityMonitoringApiValidateSecurityMonitoringIntegrationConfigRequest, options?: Configuration): Promise<void> {
   ...
   * @param param The request object
   */
  public validateSecurityMonitoringIntegrationCredentials(param: SecurityMonitoringApiValidateSecurityMonitoringIntegrationCredentialsRequest, options?: Configuration): Promise<void> {
   ...
   * @param param The request object
   */
  public validateSecurityMonitoringRule(param: SecurityMonitoringApiValidateSecurityMonitoringRuleRequest, options?: Configuration): Promise<void> {
   ...
   * @param param The request object
   */
  public validateSecurityMonitoringSuppression(param: SecurityMonitoringApiValidateSecurityMonitoringSuppressionRequest, options?: Configuration): Promise<void> {
