...
export class SecurityMonitoringApiRequestFactory extends BaseAPIRequestFactory {
  ...
  public async createSecurityMonitoringNotificationRule(
    ...
    // Path Params
    const localVarPath =
      "/api/v2/security_monitoring/configuration/notification_profiles";
  ...
  public async deleteSecurityMonitoringNotificationRule(
    ...
    // verify required parameter 'notificationProfileId' is not null or undefined
    if (notificationProfileId === null || notificationProfileId === undefined) {
      throw new RequiredError(
    ...
    // Path Params
    const localVarPath =
      "/api/v2/security_monitoring/configuration/notification_profiles/{notification_profile_id}".replace(
        "{notification_profile_id}",
        encodeURIComponent(String(notificationProfileId))
      );
