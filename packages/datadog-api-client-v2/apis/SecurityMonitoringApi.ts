...
export class SecurityMonitoringApiRequestFactory extends BaseAPIRequestFactory {
  ...
  public async listVulnerabilities(
    ...
    filterCvssDatadogSeverity?: Severity,
    ...
    filterRisksEpssSeverity?: Severity,
    ...
    if (filterCvssBaseSeverity !== undefined) {
      requestContext.setQueryParam(
        ...
        ObjectSerializer.serialize(filterCvssBaseSeverity, "Severity", ""),
        ""
      );
    }
    ...
    if (filterCvssDatadogSeverity !== undefined) {
      requestContext.setQueryParam(
        ...
        ObjectSerializer.serialize(filterCvssDatadogSeverity, "Severity", ""),
        ""
      );
    }
    ...
    if (filterStatus !== undefined) {
      requestContext.setQueryParam(
        "filter[status]",
        ObjectSerializer.serialize(filterStatus, "Status", ""),
        ""
      );
    }
    if (filterTool !== undefined) {
      requestContext.setQueryParam(
        "filter[tool]",
        ObjectSerializer.serialize(filterTool, "Tool", ""),
        ""
      );
    }
    ...
    if (filterRisksEpssSeverity !== undefined) {
      requestContext.setQueryParam(
        ...
        ObjectSerializer.serialize(filterRisksEpssSeverity, "Severity", ""),
        ""
      );
    }
    ...
    if (filterEcosystem !== undefined) {
      requestContext.setQueryParam(
        "filter[ecosystem]",
        ObjectSerializer.serialize(filterEcosystem, "Ecosystem", ""),
        ""
      );
    }
