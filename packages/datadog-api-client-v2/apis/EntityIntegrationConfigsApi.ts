...
export class EntityIntegrationConfigsApiRequestFactory extends BaseAPIRequestFactory {
  ...
  public async deleteEntityIntegrationConfig(integrationId: string,_options?: Configuration): Promise<RequestContext> {
    ...
    if (!_config.unstableOperations['v2.deleteEntityIntegrationConfig']) {
      throw new Error("Unstable operation 'deleteEntityIntegrationConfig' is disabled");
    }
    ...
    // Path Params
    const localVarPath = '/api/v2/idp/entity_integrations/{integration_id}'
      .replace('{integration_id}', encodeURIComponent(String(integrationId)));

    // Make Request Context
    const requestContext = _config.getServer('v2.EntityIntegrationConfigsApi.deleteEntityIntegrationConfig').makeRequestContext(localVarPath, HttpMethod.DELETE);
  ...
  public async getEntityIntegrationConfig(integrationId: string,_options?: Configuration): Promise<RequestContext> {
    const _config = _options || this.configuration;
    ...
    if (!_config.unstableOperations['v2.getEntityIntegrationConfig']) {
      throw new Error("Unstable operation 'getEntityIntegrationConfig' is disabled");
    }
    ...
    // Make Request Context
    const requestContext = _config.getServer('v2.EntityIntegrationConfigsApi.getEntityIntegrationConfig').makeRequestContext(localVarPath, HttpMethod.GET);
  ...
  public async updateEntityIntegrationConfig(integrationId: string,body: EntityIntegrationConfigRequest,_options?: Configuration): Promise<RequestContext> {
    const _config = _options || this.configuration;
    ...
    if (!_config.unstableOperations['v2.updateEntityIntegrationConfig']) {
      throw new Error("Unstable operation 'updateEntityIntegrationConfig' is disabled");
    }
    ...
    // Make Request Context
    const requestContext = _config.getServer('v2.EntityIntegrationConfigsApi.updateEntityIntegrationConfig').makeRequestContext(localVarPath, HttpMethod.PUT);
    requestContext.setHeaderParam("Accept", "application/json");
    requestContext.setHttpConfig(_config.httpConfig);
...
export class EntityIntegrationConfigsApiResponseProcessor {
   ...
   */
   public async deleteEntityIntegrationConfig(response: ResponseContext): Promise<void> {
   ...
   * @throws ApiException if the response code was not in [200, 299]
   */
   public async getEntityIntegrationConfig(response: ResponseContext): Promise<EntityIntegrationConfigResponse> {
    const contentType = ObjectSerializer.normalizeMediaType(response.headers["content-type"]);
    if (response.httpStatusCode === 200) {
      const body: EntityIntegrationConfigResponse = ObjectSerializer.deserialize(
   ...
   * @throws ApiException if the response code was not in [200, 299]
   */
   public async updateEntityIntegrationConfig(response: ResponseContext): Promise<EntityIntegrationConfigResponse> {
    const contentType = ObjectSerializer.normalizeMediaType(response.headers["content-type"]);
    if (response.httpStatusCode === 200) {
      const body: EntityIntegrationConfigResponse = ObjectSerializer.deserialize(
        ObjectSerializer.parse(await response.body.text(), contentType),
...
export class EntityIntegrationConfigsApi {
  ...
  public constructor(configuration: Configuration, requestFactory?: EntityIntegrationConfigsApiRequestFactory, responseProcessor?: EntityIntegrationConfigsApiResponseProcessor) {
    this.configuration = configuration;
    this.requestFactory = requestFactory || new EntityIntegrationConfigsApiRequestFactory(configuration);
    this.responseProcessor = responseProcessor || new EntityIntegrationConfigsApiResponseProcessor();
  }
   ...
   */
  public deleteEntityIntegrationConfig(param: EntityIntegrationConfigsApiDeleteEntityIntegrationConfigRequest, options?: Configuration): Promise<void> {
    const requestContextPromise = this.requestFactory.deleteEntityIntegrationConfig(param.integrationId,options);
   ...
   * @param param The request object
   */
  public getEntityIntegrationConfig(param: EntityIntegrationConfigsApiGetEntityIntegrationConfigRequest, options?: Configuration): Promise<EntityIntegrationConfigResponse> {
    const requestContextPromise = this.requestFactory.getEntityIntegrationConfig(param.integrationId,options);
    return requestContextPromise.then(requestContext => {
        return this.configuration.httpApi.send(requestContext).then(responseContext => {
   ...
   * @param param The request object
   */
  public updateEntityIntegrationConfig(param: EntityIntegrationConfigsApiUpdateEntityIntegrationConfigRequest, options?: Configuration): Promise<EntityIntegrationConfigResponse> {
    const requestContextPromise = this.requestFactory.updateEntityIntegrationConfig(param.integrationId,param.body,options);
    return requestContextPromise.then(requestContext => {
        return this.configuration.httpApi.send(requestContext).then(responseContext => {
