...
export class GovernanceControlsApiRequestFactory extends BaseAPIRequestFactory {
  ...
  public async getGovernanceControl(detectionType: string,_options?: Configuration): Promise<RequestContext> {
    ...
    // Path Params
    const localVarPath = '/api/v2/governance/control/{detection_type}'
      .replace('{detection_type}', encodeURIComponent(String(detectionType)));

    // Make Request Context
    const requestContext = _config.getServer('v2.GovernanceControlsApi.getGovernanceControl').makeRequestContext(localVarPath, HttpMethod.GET);
  ...
  public async listGovernanceControls(_options?: Configuration): Promise<RequestContext> {
    const _config = _options || this.configuration;

    logger.warn("Using unstable operation 'listGovernanceControls'");
    if (!_config.unstableOperations['v2.listGovernanceControls']) {
      throw new Error("Unstable operation 'listGovernanceControls' is disabled");
    }
    ...
    // Make Request Context
    const requestContext = _config.getServer('v2.GovernanceControlsApi.listGovernanceControls').makeRequestContext(localVarPath, HttpMethod.GET);
    requestContext.setHeaderParam("Accept", "application/json");
    requestContext.setHttpConfig(_config.httpConfig);
  ...
  public async updateGovernanceControl(detectionType: string,body: GovernanceControlUpdateRequest,_options?: Configuration): Promise<RequestContext> {
    const _config = _options || this.configuration;

    logger.warn("Using unstable operation 'updateGovernanceControl'");
    if (!_config.unstableOperations['v2.updateGovernanceControl']) {
      throw new Error("Unstable operation 'updateGovernanceControl' is disabled");
    }
    ...
    // Make Request Context
    const requestContext = _config.getServer('v2.GovernanceControlsApi.updateGovernanceControl').makeRequestContext(localVarPath, HttpMethod.PATCH);
    requestContext.setHeaderParam("Accept", "application/json");
    requestContext.setHttpConfig(_config.httpConfig);
...
export class GovernanceControlsApiResponseProcessor {
   ...
   */
   public async getGovernanceControl(response: ResponseContext): Promise<GovernanceControlResponse> {
   ...
   * @throws ApiException if the response code was not in [200, 299]
   */
   public async listGovernanceControls(response: ResponseContext): Promise<GovernanceControlsResponse> {
    const contentType = ObjectSerializer.normalizeMediaType(response.headers["content-type"]);
    if (response.httpStatusCode === 200) {
   ...
   * @throws ApiException if the response code was not in [200, 299]
   */
   public async updateGovernanceControl(response: ResponseContext): Promise<GovernanceControlResponse> {
    const contentType = ObjectSerializer.normalizeMediaType(response.headers["content-type"]);
    if (response.httpStatusCode === 200) {
      const body: GovernanceControlResponse = ObjectSerializer.deserialize(
        ObjectSerializer.parse(await response.body.text(), contentType),
...
export class GovernanceControlsApi {
  ...
  public constructor(configuration: Configuration, requestFactory?: GovernanceControlsApiRequestFactory, responseProcessor?: GovernanceControlsApiResponseProcessor) {
    this.configuration = configuration;
    this.requestFactory = requestFactory || new GovernanceControlsApiRequestFactory(configuration);
    this.responseProcessor = responseProcessor || new GovernanceControlsApiResponseProcessor();
  }
   ...
   */
  public getGovernanceControl(param: GovernanceControlsApiGetGovernanceControlRequest, options?: Configuration): Promise<GovernanceControlResponse> {
    const requestContextPromise = this.requestFactory.getGovernanceControl(param.detectionType,options);
   ...
   * @param param The request object
   */
  public listGovernanceControls( options?: Configuration): Promise<GovernanceControlsResponse> {
    const requestContextPromise = this.requestFactory.listGovernanceControls(options);
    return requestContextPromise.then(requestContext => {
        return this.configuration.httpApi.send(requestContext).then(responseContext => {
   ...
   * @param param The request object
   */
  public updateGovernanceControl(param: GovernanceControlsApiUpdateGovernanceControlRequest, options?: Configuration): Promise<GovernanceControlResponse> {
    const requestContextPromise = this.requestFactory.updateGovernanceControl(param.detectionType,param.body,options);
    return requestContextPromise.then(requestContext => {
        return this.configuration.httpApi.send(requestContext).then(responseContext => {
