...
export class RUMRetentionFiltersHardcodedApiResponseProcessor {
  ...
  public async getHardcodedRetentionFilter(
    ...
    if (response.httpStatusCode === 200) {
      const body: RumHardcodedRetentionFilterResponse =
  ...
  public async listHardcodedRetentionFilters(
    ...
    if (response.httpStatusCode === 200) {
      const body: RumHardcodedRetentionFiltersResponse =
        ObjectSerializer.deserialize(
          ObjectSerializer.parse(await response.body.text(), contentType),
...
export class RUMRetentionFiltersHardcodedApi {
  ...
  public constructor(
    ...
    this.requestFactory =
      requestFactory ||
      new RUMRetentionFiltersHardcodedApiRequestFactory(configuration);
