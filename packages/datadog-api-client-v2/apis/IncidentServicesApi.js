...
exports.IncidentServicesApiResponseProcessor = exports.IncidentServicesApiRequestFactory = void 0;
...
var IncidentServicesApiRequestFactory = /** @class */ (function (_super) {
     ...
     */
    IncidentServicesApiRequestFactory.prototype.createIncidentService = function (body, options) {
            ...
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0:
                        ...
                        requestContext = configuration_1.getServer(config, 'IncidentServicesApi.createIncidentService').makeRequestContext(localVarPath, http_1.HttpMethod.POST);
     ...
     */
    IncidentServicesApiRequestFactory.prototype.deleteIncidentService = function (serviceId, options) {
        return __awaiter(this, void 0, void 0, function () {
            ...
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0:
                        ...
                        localVarPath = '/api/v2/services/{service_id}'
                            .replace('{' + 'service_id' + '}', encodeURIComponent(String(serviceId)));
                        requestContext = configuration_1.getServer(config, 'IncidentServicesApi.deleteIncidentService').makeRequestContext(localVarPath, http_1.HttpMethod.DELETE);
                        requestContext.setHeaderParam("Accept", "application/json, */*;q=0.8");
                        requestContext.setHttpConfig(config.httpConfig);
                        authMethod = null;
                        // Apply auth methods
     ...
     */
    IncidentServicesApiRequestFactory.prototype.getIncidentService = function (serviceId, include, options) {
        return __awaiter(this, void 0, void 0, function () {
            var config, localVarPath, requestContext, authMethod;
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0:
                        ...
                        localVarPath = '/api/v2/services/{service_id}'
                            .replace('{' + 'service_id' + '}', encodeURIComponent(String(serviceId)));
                        requestContext = configuration_1.getServer(config, 'IncidentServicesApi.getIncidentService').makeRequestContext(localVarPath, http_1.HttpMethod.GET);
                        requestContext.setHeaderParam("Accept", "application/json, */*;q=0.8");
                        requestContext.setHttpConfig(config.httpConfig);
                        // Query Params
     ...
     */
    IncidentServicesApiRequestFactory.prototype.listIncidentServices = function (include, pageSize, pageOffset, filter, options) {
        return __awaiter(this, void 0, void 0, function () {
            var config, localVarPath, requestContext, authMethod;
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0:
                        config = options || this.configuration;
                        localVarPath = '/api/v2/services';
                        requestContext = configuration_1.getServer(config, 'IncidentServicesApi.listIncidentServices').makeRequestContext(localVarPath, http_1.HttpMethod.GET);
                        requestContext.setHeaderParam("Accept", "application/json, */*;q=0.8");
                        requestContext.setHttpConfig(config.httpConfig);
                        // Query Params
                        if (include !== undefined) {
     ...
     * @param body Incident Service Payload.
     */
    IncidentServicesApiRequestFactory.prototype.updateIncidentService = function (serviceId, body, options) {
        return __awaiter(this, void 0, void 0, function () {
            var config, localVarPath, requestContext, contentType, serializedBody, authMethod;
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0:
                        ...
                        localVarPath = '/api/v2/services/{service_id}'
                            .replace('{' + 'service_id' + '}', encodeURIComponent(String(serviceId)));
                        requestContext = configuration_1.getServer(config, 'IncidentServicesApi.updateIncidentService').makeRequestContext(localVarPath, http_1.HttpMethod.PATCH);
                        requestContext.setHeaderParam("Accept", "application/json, */*;q=0.8");
                        requestContext.setHttpConfig(config.httpConfig);
                        contentType = ObjectSerializer_1.ObjectSerializer.getPreferredMediaType([
                            "application/json"
        ...
        return __awaiter(this, void 0, void 0, function () {
            ...
            return __generator(this, function (_0) {
                switch (_0.label) {
                    ...
                    case 1:
                        body_1 = _b.apply(_a, [_d.apply(_c, [_0.sent(), contentType]), "IncidentServiceResponse", ""]);
                    ...
                    case 10:
                        ...
                        return [4 /*yield*/, response.body.text()];
                    case 11:
                        body_6 = _x.apply(_w, [_z.apply(_y, [_0.sent(), contentType]), "IncidentServiceResponse", ""]);
            ...
            return __generator(this, function (_0) {
                switch (_0.label) {
                    case 0:
                        ...
                        return [4 /*yield*/, response.body.text()];
                    case 1:
                        body_12 = _b.apply(_a, [_d.apply(_c, [_0.sent(), contentType]), "IncidentServiceResponse", ""]);
                    ...
                    case 10:
                        ...
                        return [4 /*yield*/, response.body.text()];
                    case 11:
                        body_17 = _x.apply(_w, [_z.apply(_y, [_0.sent(), contentType]), "IncidentServiceResponse", ""]);
            ...
            return __generator(this, function (_0) {
                switch (_0.label) {
                    case 0:
                        ...
                        return [4 /*yield*/, response.body.text()];
                    case 1:
                        body_18 = _b.apply(_a, [_d.apply(_c, [_0.sent(), contentType]), "IncidentServicesResponse", ""]);
                    ...
                    case 10:
                        ...
                        return [4 /*yield*/, response.body.text()];
                    case 11:
                        body_23 = _x.apply(_w, [_z.apply(_y, [_0.sent(), contentType]), "IncidentServicesResponse", ""]);
            ...
            return __generator(this, function (_0) {
                switch (_0.label) {
                    case 0:
                        ...
                        return [4 /*yield*/, response.body.text()];
                    case 1:
                        body_24 = _b.apply(_a, [_d.apply(_c, [_0.sent(), contentType]), "IncidentServiceResponse", ""]);
                    ...
                    case 10:
                        ...
                        return [4 /*yield*/, response.body.text()];
                    case 11:
                        body_29 = _x.apply(_w, [_z.apply(_y, [_0.sent(), contentType]), "IncidentServiceResponse", ""]);
