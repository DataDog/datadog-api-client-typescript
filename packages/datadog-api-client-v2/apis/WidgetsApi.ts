...
export class WidgetsApiRequestFactory extends BaseAPIRequestFactory {
  ...
  public async createWidget(experienceType: WidgetExperienceType,body: CreateOrUpdateWidgetRequest,_options?: Configuration): Promise<RequestContext> {
    ...
    // Path Params
    const localVarPath = '/api/v2/widgets/{experience_type}'
      .replace('{experience_type}', encodeURIComponent(String(experienceType)));

    // Make Request Context
    const requestContext = _config.getServer('v2.WidgetsApi.createWidget').makeRequestContext(localVarPath, HttpMethod.POST);
  ...
  public async deleteWidget(experienceType: WidgetExperienceType,uuid: string,_options?: Configuration): Promise<RequestContext> {
    const _config = _options || this.configuration;
    ...
    // Make Request Context
    const requestContext = _config.getServer('v2.WidgetsApi.deleteWidget').makeRequestContext(localVarPath, HttpMethod.DELETE);
  ...
  public async getWidget(experienceType: WidgetExperienceType,uuid: string,_options?: Configuration): Promise<RequestContext> {
    const _config = _options || this.configuration;
    ...
    // Make Request Context
    const requestContext = _config.getServer('v2.WidgetsApi.getWidget').makeRequestContext(localVarPath, HttpMethod.GET);
    requestContext.setHeaderParam("Accept", "application/json");
    requestContext.setHttpConfig(_config.httpConfig);
  ...
  public async searchWidgets(experienceType: WidgetExperienceType,filterWidgetType?: WidgetType,filterCreatorHandle?: string,filterIsFavorited?: boolean,filterTitle?: string,filterTags?: string,sort?: string,pageNumber?: number,pageSize?: number,_options?: Configuration): Promise<RequestContext> {
    const _config = _options || this.configuration;
    ...
    // Make Request Context
    const requestContext = _config.getServer('v2.WidgetsApi.searchWidgets').makeRequestContext(localVarPath, HttpMethod.GET);
    requestContext.setHeaderParam("Accept", "application/json");
    requestContext.setHttpConfig(_config.httpConfig);

    // Query Params
  if (filterWidgetType !== undefined) {
      requestContext.setQueryParam("filter[widgetType]", ObjectSerializer.serialize(filterWidgetType, "WidgetType", ""
), "");
    }
  if (filterCreatorHandle !== undefined) {
      requestContext.setQueryParam("filter[creatorHandle]", ObjectSerializer.serialize(filterCreatorHandle, "string", ""
), "");
    }
  if (filterIsFavorited !== undefined) {
      requestContext.setQueryParam("filter[isFavorited]", ObjectSerializer.serialize(filterIsFavorited, "boolean", ""
), "");
    }
  ...
  public async updateWidget(experienceType: WidgetExperienceType,uuid: string,body: CreateOrUpdateWidgetRequest,_options?: Configuration): Promise<RequestContext> {
    const _config = _options || this.configuration;
    ...
    // Make Request Context
    const requestContext = _config.getServer('v2.WidgetsApi.updateWidget').makeRequestContext(localVarPath, HttpMethod.PUT);
    requestContext.setHeaderParam("Accept", "application/json");
    requestContext.setHttpConfig(_config.httpConfig);
...
export class WidgetsApiResponseProcessor {
   ...
   */
   public async createWidget(response: ResponseContext): Promise<WidgetResponse> {
   ...
   * @throws ApiException if the response code was not in [200, 299]
   */
   public async searchWidgets(response: ResponseContext): Promise<WidgetListResponse> {
    const contentType = ObjectSerializer.normalizeMediaType(response.headers["content-type"]);
    if (response.httpStatusCode === 200) {
   ...
   * @throws ApiException if the response code was not in [200, 299]
   */
   public async updateWidget(response: ResponseContext): Promise<WidgetResponse> {
    const contentType = ObjectSerializer.normalizeMediaType(response.headers["content-type"]);
    if (response.httpStatusCode === 200) {
      const body: WidgetResponse = ObjectSerializer.deserialize(
        ObjectSerializer.parse(await response.body.text(), contentType),
...
export class WidgetsApi {
  ...
  public constructor(configuration: Configuration, requestFactory?: WidgetsApiRequestFactory, responseProcessor?: WidgetsApiResponseProcessor) {
    this.configuration = configuration;
    this.requestFactory = requestFactory || new WidgetsApiRequestFactory(configuration);
    this.responseProcessor = responseProcessor || new WidgetsApiResponseProcessor();
  }
   ...
   */
  public createWidget(param: WidgetsApiCreateWidgetRequest, options?: Configuration): Promise<WidgetResponse> {
   ...
   * @param param The request object
   */
  public deleteWidget(param: WidgetsApiDeleteWidgetRequest, options?: Configuration): Promise<void> {
   ...
   * @param param The request object
   */
  public getWidget(param: WidgetsApiGetWidgetRequest, options?: Configuration): Promise<WidgetResponse> {
   ...
   * @param param The request object
   */
  public searchWidgets(param: WidgetsApiSearchWidgetsRequest, options?: Configuration): Promise<WidgetListResponse> {
   ...
   * @param param The request object
   */
  public updateWidget(param: WidgetsApiUpdateWidgetRequest, options?: Configuration): Promise<WidgetResponse> {
