...
export class CaseManagementTypeApiRequestFactory extends BaseAPIRequestFactory {
  ...
  public async createCaseType(body: CaseTypeCreateRequest,_options?: Configuration): Promise<RequestContext> {
    ...
    const requestContext = _config.getServer('v2.CaseManagementTypeApi.createCaseType').makeRequestContext(localVarPath, HttpMethod.POST);
  ...
  public async deleteCaseType(caseTypeId: string,_options?: Configuration): Promise<RequestContext> {
    const _config = _options || this.configuration;
    ...
    // Path Params
    const localVarPath = '/api/v2/cases/types/{case_type_id}'
      .replace('{case_type_id}', encodeURIComponent(String(caseTypeId)));

    // Make Request Context
    const requestContext = _config.getServer('v2.CaseManagementTypeApi.deleteCaseType').makeRequestContext(localVarPath, HttpMethod.DELETE);
  ...
  public async getAllCaseTypes(_options?: Configuration): Promise<RequestContext> {
    const _config = _options || this.configuration;
    ...
    // Make Request Context
    const requestContext = _config.getServer('v2.CaseManagementTypeApi.getAllCaseTypes').makeRequestContext(localVarPath, HttpMethod.GET);
    requestContext.setHeaderParam("Accept", "application/json");
    requestContext.setHttpConfig(_config.httpConfig);
  ...
  public async updateCaseType(caseTypeId: string,body: CaseTypeUpdateRequest,_options?: Configuration): Promise<RequestContext> {
    const _config = _options || this.configuration;
    ...
    // Make Request Context
    const requestContext = _config.getServer('v2.CaseManagementTypeApi.updateCaseType').makeRequestContext(localVarPath, HttpMethod.PUT);
    requestContext.setHeaderParam("Accept", "application/json");
    requestContext.setHttpConfig(_config.httpConfig);
...
export class CaseManagementTypeApiResponseProcessor {
   ...
   */
   public async createCaseType(response: ResponseContext): Promise<CaseTypeResponse> {
   ...
   * @throws ApiException if the response code was not in [200, 299]
   */
   public async getAllCaseTypes(response: ResponseContext): Promise<CaseTypesResponse> {
    const contentType = ObjectSerializer.normalizeMediaType(response.headers["content-type"]);
   ...
   * @throws ApiException if the response code was not in [200, 299]
   */
   public async updateCaseType(response: ResponseContext): Promise<CaseTypeResponse> {
    const contentType = ObjectSerializer.normalizeMediaType(response.headers["content-type"]);
    if (response.httpStatusCode === 200) {
      const body: CaseTypeResponse = ObjectSerializer.deserialize(
        ObjectSerializer.parse(await response.body.text(), contentType),
...
export class CaseManagementTypeApi {
  ...
  public constructor(configuration: Configuration, requestFactory?: CaseManagementTypeApiRequestFactory, responseProcessor?: CaseManagementTypeApiResponseProcessor) {
    this.configuration = configuration;
    this.requestFactory = requestFactory || new CaseManagementTypeApiRequestFactory(configuration);
    this.responseProcessor = responseProcessor || new CaseManagementTypeApiResponseProcessor();
  }
   ...
   */
  public createCaseType(param: CaseManagementTypeApiCreateCaseTypeRequest, options?: Configuration): Promise<CaseTypeResponse> {
   ...
   * @param param The request object
   */
  public deleteCaseType(param: CaseManagementTypeApiDeleteCaseTypeRequest, options?: Configuration): Promise<void> {
   ...
   * @param param The request object
   */
  public updateCaseType(param: CaseManagementTypeApiUpdateCaseTypeRequest, options?: Configuration): Promise<CaseTypeResponse> {
