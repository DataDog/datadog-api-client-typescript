...
export class TeamsApiRequestFactory extends BaseAPIRequestFactory {
  ...
  public async addMemberTeam(superTeamId: string,body: AddMemberTeamRequest,_options?: Configuration): Promise<RequestContext> {
    ...
    // Path Params
    const localVarPath = '/api/v2/team/{super_team_id}/member_teams'
      .replace('{super_team_id}', encodeURIComponent(String(superTeamId)));

    // Make Request Context
    const requestContext = _config.getServer('v2.TeamsApi.addMemberTeam').makeRequestContext(localVarPath, HttpMethod.POST);
  ...
  public async addTeamHierarchyLink(body: TeamHierarchyLinkCreateRequest,_options?: Configuration): Promise<RequestContext> {
    const _config = _options || this.configuration;
    ...
    // Make Request Context
    const requestContext = _config.getServer('v2.TeamsApi.addTeamHierarchyLink').makeRequestContext(localVarPath, HttpMethod.POST);
    ...
    requestContext.setHeaderParam("Content-Type", contentType);
    const serializedBody = ObjectSerializer.stringify(
      ObjectSerializer.serialize(body, "TeamHierarchyLinkCreateRequest", ""),
      contentType
    );
    requestContext.setBody(serializedBody);
  ...
  public async createTeamConnections(body: TeamConnectionCreateRequest,_options?: Configuration): Promise<RequestContext> {
    const _config = _options || this.configuration;
    ...
    // Make Request Context
    const requestContext = _config.getServer('v2.TeamsApi.createTeamConnections').makeRequestContext(localVarPath, HttpMethod.POST);
    requestContext.setHeaderParam("Accept", "application/json");
    requestContext.setHttpConfig(_config.httpConfig);
  ...
  public async createTeamNotificationRule(teamId: string,body: TeamNotificationRuleRequest,_options?: Configuration): Promise<RequestContext> {
    const _config = _options || this.configuration;
    ...
    // Path Params
    const localVarPath = '/api/v2/team/{team_id}/notification-rules'
      .replace('{team_id}', encodeURIComponent(String(teamId)));

    // Make Request Context
    const requestContext = _config.getServer('v2.TeamsApi.createTeamNotificationRule').makeRequestContext(localVarPath, HttpMethod.POST);
    requestContext.setHeaderParam("Accept", "application/json");
    requestContext.setHttpConfig(_config.httpConfig);
    ...
    requestContext.setHeaderParam("Content-Type", contentType);
    const serializedBody = ObjectSerializer.stringify(
      ObjectSerializer.serialize(body, "TeamNotificationRuleRequest", ""),
      contentType
    );
    requestContext.setBody(serializedBody);
  ...
  public async deleteTeamConnections(body: TeamConnectionDeleteRequest,_options?: Configuration): Promise<RequestContext> {
    const _config = _options || this.configuration;
    ...
    // Make Request Context
    const requestContext = _config.getServer('v2.TeamsApi.deleteTeamConnections').makeRequestContext(localVarPath, HttpMethod.DELETE);
    requestContext.setHeaderParam("Accept", "*/*");
    requestContext.setHttpConfig(_config.httpConfig);
  ...
  public async deleteTeamNotificationRule(teamId: string,ruleId: string,_options?: Configuration): Promise<RequestContext> {
    const _config = _options || this.configuration;
    ...
    // Make Request Context
    const requestContext = _config.getServer('v2.TeamsApi.deleteTeamNotificationRule').makeRequestContext(localVarPath, HttpMethod.DELETE);
    requestContext.setHeaderParam("Accept", "*/*");
    requestContext.setHttpConfig(_config.httpConfig);
  ...
  public async getTeamHierarchyLink(linkId: string,_options?: Configuration): Promise<RequestContext> {
    const _config = _options || this.configuration;
    ...
    // Path Params
    const localVarPath = '/api/v2/team-hierarchy-links/{link_id}'
      .replace('{link_id}', encodeURIComponent(String(linkId)));

    // Make Request Context
    const requestContext = _config.getServer('v2.TeamsApi.getTeamHierarchyLink').makeRequestContext(localVarPath, HttpMethod.GET);
    requestContext.setHeaderParam("Accept", "application/json");
    requestContext.setHttpConfig(_config.httpConfig);
  ...
  public async getTeamNotificationRule(teamId: string,ruleId: string,_options?: Configuration): Promise<RequestContext> {
    const _config = _options || this.configuration;
    ...
    // Make Request Context
    const requestContext = _config.getServer('v2.TeamsApi.getTeamNotificationRule').makeRequestContext(localVarPath, HttpMethod.GET);
    requestContext.setHeaderParam("Accept", "application/json");
    requestContext.setHttpConfig(_config.httpConfig);
  ...
  public async getTeamNotificationRules(teamId: string,_options?: Configuration): Promise<RequestContext> {
    const _config = _options || this.configuration;
    ...
    // Make Request Context
    const requestContext = _config.getServer('v2.TeamsApi.getTeamNotificationRules').makeRequestContext(localVarPath, HttpMethod.GET);
    requestContext.setHeaderParam("Accept", "application/json");
    requestContext.setHttpConfig(_config.httpConfig);
  ...
  public async getTeamSync(filterSource: TeamSyncAttributesSource,_options?: Configuration): Promise<RequestContext> {
    const _config = _options || this.configuration;
    ...
    // Make Request Context
    const requestContext = _config.getServer('v2.TeamsApi.getTeamSync').makeRequestContext(localVarPath, HttpMethod.GET);
    requestContext.setHeaderParam("Accept", "application/json");
    requestContext.setHttpConfig(_config.httpConfig);

    // Query Params
  if (filterSource !== undefined) {
      requestContext.setQueryParam("filter[source]", ObjectSerializer.serialize(filterSource, "TeamSyncAttributesSource", ""
), "");
    }
  ...
  public async listMemberTeams(superTeamId: string,pageSize?: number,pageNumber?: number,fieldsTeam?: Array<TeamsField>,_options?: Configuration): Promise<RequestContext> {
    const _config = _options || this.configuration;
    ...
    // Make Request Context
    const requestContext = _config.getServer('v2.TeamsApi.listMemberTeams').makeRequestContext(localVarPath, HttpMethod.GET);
    requestContext.setHeaderParam("Accept", "application/json");
    requestContext.setHttpConfig(_config.httpConfig);
  ...
  if (fieldsTeam !== undefined) {
      requestContext.setQueryParam("fields[team]", ObjectSerializer.serialize(fieldsTeam, "Array<TeamsField>", ""
), "csv");
    }
  ...
  public async listTeamConnections(pageSize?: number,pageNumber?: number,filterSources?: Array<string>,filterTeamIds?: Array<string>,filterConnectedTeamIds?: Array<string>,filterConnectionIds?: Array<string>,_options?: Configuration): Promise<RequestContext> {
    const _config = _options || this.configuration;
    ...
    // Make Request Context
    const requestContext = _config.getServer('v2.TeamsApi.listTeamConnections').makeRequestContext(localVarPath, HttpMethod.GET);
    requestContext.setHeaderParam("Accept", "application/json");
    requestContext.setHttpConfig(_config.httpConfig);
  ...
  if (filterSources !== undefined) {
      requestContext.setQueryParam("filter[sources]", ObjectSerializer.serialize(filterSources, "Array<string>", ""
), "csv");
    }
  if (filterTeamIds !== undefined) {
      requestContext.setQueryParam("filter[team_ids]", ObjectSerializer.serialize(filterTeamIds, "Array<string>", ""
), "csv");
    }
  if (filterConnectedTeamIds !== undefined) {
      requestContext.setQueryParam("filter[connected_team_ids]", ObjectSerializer.serialize(filterConnectedTeamIds, "Array<string>", ""
), "csv");
    }
  if (filterConnectionIds !== undefined) {
      requestContext.setQueryParam("filter[connection_ids]", ObjectSerializer.serialize(filterConnectionIds, "Array<string>", ""
), "csv");
    }
  ...
  public async listTeamHierarchyLinks(pageNumber?: number,pageSize?: number,filterParentTeam?: string,filterSubTeam?: string,_options?: Configuration): Promise<RequestContext> {
    const _config = _options || this.configuration;
    ...
    // Make Request Context
    const requestContext = _config.getServer('v2.TeamsApi.listTeamHierarchyLinks').makeRequestContext(localVarPath, HttpMethod.GET);
    requestContext.setHeaderParam("Accept", "application/json");
    requestContext.setHttpConfig(_config.httpConfig);
  ...
  if (filterParentTeam !== undefined) {
      requestContext.setQueryParam("filter[parent_team]", ObjectSerializer.serialize(filterParentTeam, "string", ""
), "");
    }
  if (filterSubTeam !== undefined) {
      requestContext.setQueryParam("filter[sub_team]", ObjectSerializer.serialize(filterSubTeam, "string", ""
), "");
    }
  ...
  if (include !== undefined) {
      requestContext.setQueryParam("include", ObjectSerializer.serialize(include, "Array<ListTeamsInclude>", ""
), "multi");
    }
  if (filterKeyword !== undefined) {
      requestContext.setQueryParam("filter[keyword]", ObjectSerializer.serialize(filterKeyword, "string", ""
  ...
  public async removeMemberTeam(superTeamId: string,memberTeamId: string,_options?: Configuration): Promise<RequestContext> {
    const _config = _options || this.configuration;
    ...
    // Make Request Context
    const requestContext = _config.getServer('v2.TeamsApi.removeMemberTeam').makeRequestContext(localVarPath, HttpMethod.DELETE);
    requestContext.setHeaderParam("Accept", "*/*");
    requestContext.setHttpConfig(_config.httpConfig);
  ...
  public async removeTeamHierarchyLink(linkId: string,_options?: Configuration): Promise<RequestContext> {
    const _config = _options || this.configuration;
    ...
    // Make Request Context
    const requestContext = _config.getServer('v2.TeamsApi.removeTeamHierarchyLink').makeRequestContext(localVarPath, HttpMethod.DELETE);
    requestContext.setHeaderParam("Accept", "*/*");
    requestContext.setHttpConfig(_config.httpConfig);
  ...
  public async syncTeams(body: TeamSyncRequest,_options?: Configuration): Promise<RequestContext> {
    const _config = _options || this.configuration;
    ...
    // Make Request Context
    const requestContext = _config.getServer('v2.TeamsApi.syncTeams').makeRequestContext(localVarPath, HttpMethod.POST);
    requestContext.setHeaderParam("Accept", "*/*");
    requestContext.setHttpConfig(_config.httpConfig);
    ...
    requestContext.setHeaderParam("Content-Type", contentType);
    const serializedBody = ObjectSerializer.stringify(
      ObjectSerializer.serialize(body, "TeamSyncRequest", ""),
      contentType
    );
    requestContext.setBody(serializedBody);
  ...
  public async updateTeamNotificationRule(teamId: string,ruleId: string,body: TeamNotificationRuleRequest,_options?: Configuration): Promise<RequestContext> {
    const _config = _options || this.configuration;
    ...
    // Make Request Context
    const requestContext = _config.getServer('v2.TeamsApi.updateTeamNotificationRule').makeRequestContext(localVarPath, HttpMethod.PUT);
    requestContext.setHeaderParam("Accept", "application/json");
    requestContext.setHttpConfig(_config.httpConfig);
...
export class TeamsApiResponseProcessor {
   ...
   * @throws ApiException if the response code was not in [200, 299]
   */
   public async addTeamHierarchyLink(response: ResponseContext): Promise<TeamHierarchyLinkResponse> {
    const contentType = ObjectSerializer.normalizeMediaType(response.headers["content-type"]);
    if (response.httpStatusCode === 200) {
      const body: TeamHierarchyLinkResponse = ObjectSerializer.deserialize(
   ...
   * @throws ApiException if the response code was not in [200, 299]
   */
   public async createTeamConnections(response: ResponseContext): Promise<TeamConnectionsResponse> {
    const contentType = ObjectSerializer.normalizeMediaType(response.headers["content-type"]);
    if (response.httpStatusCode === 201) {
   ...
   * @throws ApiException if the response code was not in [200, 299]
   */
   public async createTeamNotificationRule(response: ResponseContext): Promise<TeamNotificationRuleResponse> {
    const contentType = ObjectSerializer.normalizeMediaType(response.headers["content-type"]);
    if (response.httpStatusCode === 201) {
      const body: TeamNotificationRuleResponse = ObjectSerializer.deserialize(
        ObjectSerializer.parse(await response.body.text(), contentType),
   ...
   * @throws ApiException if the response code was not in [200, 299]
   */
   public async deleteTeamNotificationRule(response: ResponseContext): Promise<void> {
    const contentType = ObjectSerializer.normalizeMediaType(response.headers["content-type"]);
    if (response.httpStatusCode === 204) {
      return;
    }
   ...
   * @throws ApiException if the response code was not in [200, 299]
   */
   public async getTeamHierarchyLink(response: ResponseContext): Promise<TeamHierarchyLinkResponse> {
    const contentType = ObjectSerializer.normalizeMediaType(response.headers["content-type"]);
    if (response.httpStatusCode === 200) {
      const body: TeamHierarchyLinkResponse = ObjectSerializer.deserialize(
        ObjectSerializer.parse(await response.body.text(), contentType),
   ...
   * @throws ApiException if the response code was not in [200, 299]
   */
   public async getTeamNotificationRule(response: ResponseContext): Promise<TeamNotificationRuleResponse> {
    const contentType = ObjectSerializer.normalizeMediaType(response.headers["content-type"]);
    if (response.httpStatusCode === 200) {
      const body: TeamNotificationRuleResponse = ObjectSerializer.deserialize(
        ObjectSerializer.parse(await response.body.text(), contentType),
   ...
   * @throws ApiException if the response code was not in [200, 299]
   */
   public async getTeamNotificationRules(response: ResponseContext): Promise<TeamNotificationRulesResponse> {
    const contentType = ObjectSerializer.normalizeMediaType(response.headers["content-type"]);
    if (response.httpStatusCode === 200) {
   ...
   * @throws ApiException if the response code was not in [200, 299]
   */
   public async getTeamSync(response: ResponseContext): Promise<TeamSyncResponse> {
    const contentType = ObjectSerializer.normalizeMediaType(response.headers["content-type"]);
    if (response.httpStatusCode === 200) {
      const body: TeamSyncResponse = ObjectSerializer.deserialize(
        ObjectSerializer.parse(await response.body.text(), contentType),
        "TeamSyncResponse"
      ) as TeamSyncResponse;
      return body;
   ...
   * @throws ApiException if the response code was not in [200, 299]
   */
   public async listMemberTeams(response: ResponseContext): Promise<TeamsResponse> {
    const contentType = ObjectSerializer.normalizeMediaType(response.headers["content-type"]);
    if (response.httpStatusCode === 200) {
   ...
   * @throws ApiException if the response code was not in [200, 299]
   */
   public async listTeamConnections(response: ResponseContext): Promise<TeamConnectionsResponse> {
    const contentType = ObjectSerializer.normalizeMediaType(response.headers["content-type"]);
    if (response.httpStatusCode === 200) {
      const body: TeamConnectionsResponse = ObjectSerializer.deserialize(
        ObjectSerializer.parse(await response.body.text(), contentType),
   ...
   * @throws ApiException if the response code was not in [200, 299]
   */
   public async listTeamHierarchyLinks(response: ResponseContext): Promise<TeamHierarchyLinksResponse> {
    const contentType = ObjectSerializer.normalizeMediaType(response.headers["content-type"]);
    if (response.httpStatusCode === 200) {
      const body: TeamHierarchyLinksResponse = ObjectSerializer.deserialize(
        ObjectSerializer.parse(await response.body.text(), contentType),
   ...
   * @throws ApiException if the response code was not in [200, 299]
   */
   public async removeTeamHierarchyLink(response: ResponseContext): Promise<void> {
    const contentType = ObjectSerializer.normalizeMediaType(response.headers["content-type"]);
    if (response.httpStatusCode === 204) {
      return;
    }
   ...
   */
   public async syncTeams(response: ResponseContext): Promise<void> {
    ...
    if (response.httpStatusCode === 403||response.httpStatusCode === 429||response.httpStatusCode === 500) {
      const bodyText = ObjectSerializer.parse(await response.body.text(), contentType);
      let body: APIErrorResponse;
      try {
        body = ObjectSerializer.deserialize(
   ...
   * @throws ApiException if the response code was not in [200, 299]
   */
   public async updateTeamNotificationRule(response: ResponseContext): Promise<TeamNotificationRuleResponse> {
    const contentType = ObjectSerializer.normalizeMediaType(response.headers["content-type"]);
    if (response.httpStatusCode === 200) {
      const body: TeamNotificationRuleResponse = ObjectSerializer.deserialize(
        ObjectSerializer.parse(await response.body.text(), contentType),
...
export class TeamsApi {
   ...
   */
  public addMemberTeam(param: TeamsApiAddMemberTeamRequest, options?: Configuration): Promise<void> {
   ...
   * @param param The request object
   */
  public addTeamHierarchyLink(param: TeamsApiAddTeamHierarchyLinkRequest, options?: Configuration): Promise<TeamHierarchyLinkResponse> {
   ...
   * @param param The request object
   */
  public createTeamConnections(param: TeamsApiCreateTeamConnectionsRequest, options?: Configuration): Promise<TeamConnectionsResponse> {
   ...
   * @param param The request object
   */
  public createTeamNotificationRule(param: TeamsApiCreateTeamNotificationRuleRequest, options?: Configuration): Promise<TeamNotificationRuleResponse> {
   ...
   * @param param The request object
   */
  public deleteTeamConnections(param: TeamsApiDeleteTeamConnectionsRequest, options?: Configuration): Promise<void> {
   ...
   * @param param The request object
   */
  public deleteTeamNotificationRule(param: TeamsApiDeleteTeamNotificationRuleRequest, options?: Configuration): Promise<void> {
   ...
   * @param param The request object
   */
  public getTeamHierarchyLink(param: TeamsApiGetTeamHierarchyLinkRequest, options?: Configuration): Promise<TeamHierarchyLinkResponse> {
...
/**
   ...
   * @param param The request object
   */
  public getTeamNotificationRule(param: TeamsApiGetTeamNotificationRuleRequest, options?: Configuration): Promise<TeamNotificationRuleResponse> {
   ...
   * @param param The request object
   */
  public getTeamNotificationRules(param: TeamsApiGetTeamNotificationRulesRequest, options?: Configuration): Promise<TeamNotificationRulesResponse> {
   ...
   * @param param The request object
   */
  public getTeamSync(param: TeamsApiGetTeamSyncRequest, options?: Configuration): Promise<TeamSyncResponse> {
   ...
   * @param param The request object
   */
  public listMemberTeams(param: TeamsApiListMemberTeamsRequest, options?: Configuration): Promise<TeamsResponse> {
...
/**
   ...
   * @param param The request object
   */
  public listTeamConnections(param: TeamsApiListTeamConnectionsRequest = {}, options?: Configuration): Promise<TeamConnectionsResponse> {
...
/**
   ...
   * @param param The request object
   */
  public listTeamHierarchyLinks(param: TeamsApiListTeamHierarchyLinksRequest = {}, options?: Configuration): Promise<TeamHierarchyLinksResponse> {
...
/**
   ...
   * @param param The request object
   */
  public removeMemberTeam(param: TeamsApiRemoveMemberTeamRequest, options?: Configuration): Promise<void> {
   ...
   * @param param The request object
   */
  public removeTeamHierarchyLink(param: TeamsApiRemoveTeamHierarchyLinkRequest, options?: Configuration): Promise<void> {
   ...
   * @param param The request object
   */
  public syncTeams(param: TeamsApiSyncTeamsRequest, options?: Configuration): Promise<void> {
   ...
   * @param param The request object
   */
  public updateTeamNotificationRule(param: TeamsApiUpdateTeamNotificationRuleRequest, options?: Configuration): Promise<TeamNotificationRuleResponse> {
