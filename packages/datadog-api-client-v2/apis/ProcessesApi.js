...
exports.ProcessesApiResponseProcessor = exports.ProcessesApiRequestFactory = void 0;
...
var ProcessesApiRequestFactory = /** @class */ (function (_super) {
     ...
     */
    ProcessesApiRequestFactory.prototype.listProcesses = function (search, tags, from, to, pageLimit, pageCursor, options) {
            ...
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0:
                        ...
                        requestContext = configuration_1.getServer(config, 'ProcessesApi.listProcesses').makeRequestContext(localVarPath, http_1.HttpMethod.GET);
        ...
        return __awaiter(this, void 0, void 0, function () {
            ...
            return __generator(this, function (_s) {
                switch (_s.label) {
                    ...
                    case 1:
                        body_1 = _b.apply(_a, [_d.apply(_c, [_s.sent(), contentType]), "ProcessSummariesResponse", ""]);
                    ...
                    case 6:
                        ...
                        return [4 /*yield*/, response.body.text()];
                    case 7:
                        body_4 = _p.apply(_o, [_r.apply(_q, [_s.sent(), contentType]), "ProcessSummariesResponse", ""]);
