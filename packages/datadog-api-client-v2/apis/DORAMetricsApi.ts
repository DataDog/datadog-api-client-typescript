...
export class DORAMetricsApiRequestFactory extends BaseAPIRequestFactory {
  ...
  public async createDORAFailure(body: DORAFailureRequest,_options?: Configuration): Promise<RequestContext> {
    const _config = _options || this.configuration;
    ...
    // Make Request Context
    const requestContext = _config.getServer('v2.DORAMetricsApi.createDORAFailure').makeRequestContext(localVarPath, HttpMethod.POST);
    requestContext.setHeaderParam("Accept", "application/json");
    requestContext.setHttpConfig(_config.httpConfig);
  ...
  public async createDORAIncident(body: DORAFailureRequest,_options?: Configuration): Promise<RequestContext> {
    const _config = _options || this.configuration;
  ...
  public async deleteDORADeployment(deploymentId: string,_options?: Configuration): Promise<RequestContext> {
    const _config = _options || this.configuration;
    ...
    // Path Params
    const localVarPath = '/api/v2/dora/deployment/{deployment_id}'
      .replace('{deployment_id}', encodeURIComponent(String(deploymentId)));

    // Make Request Context
    const requestContext = _config.getServer('v2.DORAMetricsApi.deleteDORADeployment').makeRequestContext(localVarPath, HttpMethod.DELETE);
  ...
  public async deleteDORAFailure(failureId: string,_options?: Configuration): Promise<RequestContext> {
    const _config = _options || this.configuration;
    ...
    // Path Params
    const localVarPath = '/api/v2/dora/failure/{failure_id}'
      .replace('{failure_id}', encodeURIComponent(String(failureId)));

    // Make Request Context
    const requestContext = _config.getServer('v2.DORAMetricsApi.deleteDORAFailure').makeRequestContext(localVarPath, HttpMethod.DELETE);
    requestContext.setHeaderParam("Accept", "*/*");
    requestContext.setHttpConfig(_config.httpConfig);
  ...
  public async patchDORADeployment(deploymentId: string,body: DORADeploymentPatchRequest,_options?: Configuration): Promise<RequestContext> {
    const _config = _options || this.configuration;
    ...
    // Make Request Context
    const requestContext = _config.getServer('v2.DORAMetricsApi.patchDORADeployment').makeRequestContext(localVarPath, HttpMethod.PATCH);
    requestContext.setHeaderParam("Accept", "*/*");
    requestContext.setHttpConfig(_config.httpConfig);
    ...
    requestContext.setHeaderParam("Content-Type", contentType);
    const serializedBody = ObjectSerializer.stringify(
      ObjectSerializer.serialize(body, "DORADeploymentPatchRequest", ""),
      contentType
    );
    requestContext.setBody(serializedBody);
...
export class DORAMetricsApiResponseProcessor {
   ...
   * @throws ApiException if the response code was not in [200, 299]
   */
   public async createDORAFailure(response: ResponseContext): Promise<DORAFailureResponse> {
    const contentType = ObjectSerializer.normalizeMediaType(response.headers["content-type"]);
    if (response.httpStatusCode === 200||response.httpStatusCode === 202) {
   ...
   * @throws ApiException if the response code was not in [200, 299]
   */
   public async createDORAIncident(response: ResponseContext): Promise<DORAFailureResponse> {
    const contentType = ObjectSerializer.normalizeMediaType(response.headers["content-type"]);
    if (response.httpStatusCode === 200||response.httpStatusCode === 202) {
      const body: DORAFailureResponse = ObjectSerializer.deserialize(
        ObjectSerializer.parse(await response.body.text(), contentType),
   ...
   * @throws ApiException if the response code was not in [200, 299]
   */
   public async getDORADeployment(response: ResponseContext): Promise<DORADeploymentFetchResponse> {
    const contentType = ObjectSerializer.normalizeMediaType(response.headers["content-type"]);
    if (response.httpStatusCode === 200) {
      const body: DORADeploymentFetchResponse = ObjectSerializer.deserialize(
        ObjectSerializer.parse(await response.body.text(), contentType),
   ...
   * @throws ApiException if the response code was not in [200, 299]
   */
   public async getDORAFailure(response: ResponseContext): Promise<DORAFailureFetchResponse> {
    const contentType = ObjectSerializer.normalizeMediaType(response.headers["content-type"]);
    if (response.httpStatusCode === 200) {
      const body: DORAFailureFetchResponse = ObjectSerializer.deserialize(
        ObjectSerializer.parse(await response.body.text(), contentType),
   ...
   * @throws ApiException if the response code was not in [200, 299]
   */
   public async listDORADeployments(response: ResponseContext): Promise<DORADeploymentsListResponse> {
    const contentType = ObjectSerializer.normalizeMediaType(response.headers["content-type"]);
    if (response.httpStatusCode === 200) {
      const body: DORADeploymentsListResponse = ObjectSerializer.deserialize(
        ObjectSerializer.parse(await response.body.text(), contentType),
   ...
   * @throws ApiException if the response code was not in [200, 299]
   */
   public async listDORAFailures(response: ResponseContext): Promise<DORAFailuresListResponse> {
    const contentType = ObjectSerializer.normalizeMediaType(response.headers["content-type"]);
    if (response.httpStatusCode === 200) {
      const body: DORAFailuresListResponse = ObjectSerializer.deserialize(
        ObjectSerializer.parse(await response.body.text(), contentType),
...
export class DORAMetricsApi {
   ...
   * @param param The request object
   */
  public createDORAFailure(param: DORAMetricsApiCreateDORAFailureRequest, options?: Configuration): Promise<DORAFailureResponse> {
   ...
   * @param param The request object
   */
  public createDORAIncident(param: DORAMetricsApiCreateDORAIncidentRequest, options?: Configuration): Promise<DORAFailureResponse> {
   ...
   * @param param The request object
   */
  public deleteDORADeployment(param: DORAMetricsApiDeleteDORADeploymentRequest, options?: Configuration): Promise<void> {
   ...
   * @param param The request object
   */
  public deleteDORAFailure(param: DORAMetricsApiDeleteDORAFailureRequest, options?: Configuration): Promise<void> {
   ...
   * @param param The request object
   */
  public getDORADeployment(param: DORAMetricsApiGetDORADeploymentRequest, options?: Configuration): Promise<DORADeploymentFetchResponse> {
   ...
   * @param param The request object
   */
  public getDORAFailure(param: DORAMetricsApiGetDORAFailureRequest, options?: Configuration): Promise<DORAFailureFetchResponse> {
   ...
   * @param param The request object
   */
  public listDORADeployments(param: DORAMetricsApiListDORADeploymentsRequest, options?: Configuration): Promise<DORADeploymentsListResponse> {
   ...
   * @param param The request object
   */
  public listDORAFailures(param: DORAMetricsApiListDORAFailuresRequest, options?: Configuration): Promise<DORAFailuresListResponse> {
   ...
   * @param param The request object
   */
  public patchDORADeployment(param: DORAMetricsApiPatchDORADeploymentRequest, options?: Configuration): Promise<void> {
