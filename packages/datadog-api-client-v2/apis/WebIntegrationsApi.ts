...
export class WebIntegrationsApiRequestFactory extends BaseAPIRequestFactory {
  ...
  public async createWebIntegrationAccount(integrationName: string,body: WebIntegrationAccountCreateRequest,_options?: Configuration): Promise<RequestContext> {
    ...
    if (!_config.unstableOperations['v2.createWebIntegrationAccount']) {
      throw new Error("Unstable operation 'createWebIntegrationAccount' is disabled");
    }
    ...
    // Path Params
    const localVarPath = '/api/v2/web-integrations/{integration_name}/accounts'
      .replace('{integration_name}', encodeURIComponent(String(integrationName)));

    // Make Request Context
    const requestContext = _config.getServer('v2.WebIntegrationsApi.createWebIntegrationAccount').makeRequestContext(localVarPath, HttpMethod.POST);
    ...
    const serializedBody = ObjectSerializer.stringify(
      ObjectSerializer.serialize(body, "WebIntegrationAccountCreateRequest", ""),
      contentType
    );
  ...
  public async deleteWebIntegrationAccount(integrationName: string,accountId: string,_options?: Configuration): Promise<RequestContext> {
    const _config = _options || this.configuration;
    ...
    if (!_config.unstableOperations['v2.deleteWebIntegrationAccount']) {
      throw new Error("Unstable operation 'deleteWebIntegrationAccount' is disabled");
    }
    ...
    // Path Params
    const localVarPath = '/api/v2/web-integrations/{integration_name}/accounts/{account_id}'
      .replace('{integration_name}', encodeURIComponent(String(integrationName)))
      .replace('{account_id}', encodeURIComponent(String(accountId)));

    // Make Request Context
    const requestContext = _config.getServer('v2.WebIntegrationsApi.deleteWebIntegrationAccount').makeRequestContext(localVarPath, HttpMethod.DELETE);
  ...
  public async getWebIntegrationAccount(integrationName: string,accountId: string,_options?: Configuration): Promise<RequestContext> {
    const _config = _options || this.configuration;

    logger.warn("Using unstable operation 'getWebIntegrationAccount'");
    if (!_config.unstableOperations['v2.getWebIntegrationAccount']) {
      throw new Error("Unstable operation 'getWebIntegrationAccount' is disabled");
    }
    ...
    // Make Request Context
    const requestContext = _config.getServer('v2.WebIntegrationsApi.getWebIntegrationAccount').makeRequestContext(localVarPath, HttpMethod.GET);
    requestContext.setHeaderParam("Accept", "application/json");
    requestContext.setHttpConfig(_config.httpConfig);
  ...
  public async listWebIntegrationAccounts(integrationName: string,_options?: Configuration): Promise<RequestContext> {
    const _config = _options || this.configuration;
    ...
    if (!_config.unstableOperations['v2.listWebIntegrationAccounts']) {
      throw new Error("Unstable operation 'listWebIntegrationAccounts' is disabled");
    }
    ...
    // Make Request Context
    const requestContext = _config.getServer('v2.WebIntegrationsApi.listWebIntegrationAccounts').makeRequestContext(localVarPath, HttpMethod.GET);
    requestContext.setHeaderParam("Accept", "application/json");
    requestContext.setHttpConfig(_config.httpConfig);
  ...
  public async updateWebIntegrationAccount(integrationName: string,accountId: string,body: WebIntegrationAccountUpdateRequest,_options?: Configuration): Promise<RequestContext> {
    const _config = _options || this.configuration;
    ...
    if (!_config.unstableOperations['v2.updateWebIntegrationAccount']) {
      throw new Error("Unstable operation 'updateWebIntegrationAccount' is disabled");
    }
    ...
    // Make Request Context
    const requestContext = _config.getServer('v2.WebIntegrationsApi.updateWebIntegrationAccount').makeRequestContext(localVarPath, HttpMethod.PATCH);
    requestContext.setHeaderParam("Accept", "application/json");
    requestContext.setHttpConfig(_config.httpConfig);
    ...
    requestContext.setHeaderParam("Content-Type", contentType);
    const serializedBody = ObjectSerializer.stringify(
      ObjectSerializer.serialize(body, "WebIntegrationAccountUpdateRequest", ""),
      contentType
    );
    requestContext.setBody(serializedBody);
...
export class WebIntegrationsApiResponseProcessor {
   ...
   */
   public async createWebIntegrationAccount(response: ResponseContext): Promise<WebIntegrationAccountResponse> {
   ...
   * @throws ApiException if the response code was not in [200, 299]
   */
   public async deleteWebIntegrationAccount(response: ResponseContext): Promise<void> {
    const contentType = ObjectSerializer.normalizeMediaType(response.headers["content-type"]);
   ...
   * @throws ApiException if the response code was not in [200, 299]
   */
   public async getWebIntegrationAccount(response: ResponseContext): Promise<WebIntegrationAccountResponse> {
    const contentType = ObjectSerializer.normalizeMediaType(response.headers["content-type"]);
   ...
   * @throws ApiException if the response code was not in [200, 299]
   */
   public async listWebIntegrationAccounts(response: ResponseContext): Promise<WebIntegrationAccountsResponse> {
    const contentType = ObjectSerializer.normalizeMediaType(response.headers["content-type"]);
    if (response.httpStatusCode === 200) {
   ...
   * @throws ApiException if the response code was not in [200, 299]
   */
   public async updateWebIntegrationAccount(response: ResponseContext): Promise<WebIntegrationAccountResponse> {
    const contentType = ObjectSerializer.normalizeMediaType(response.headers["content-type"]);
    if (response.httpStatusCode === 200) {
      const body: WebIntegrationAccountResponse = ObjectSerializer.deserialize(
        ObjectSerializer.parse(await response.body.text(), contentType),
...
export class WebIntegrationsApi {
  ...
  public constructor(configuration: Configuration, requestFactory?: WebIntegrationsApiRequestFactory, responseProcessor?: WebIntegrationsApiResponseProcessor) {
    this.configuration = configuration;
    this.requestFactory = requestFactory || new WebIntegrationsApiRequestFactory(configuration);
    this.responseProcessor = responseProcessor || new WebIntegrationsApiResponseProcessor();
  }
   ...
   */
  public createWebIntegrationAccount(param: WebIntegrationsApiCreateWebIntegrationAccountRequest, options?: Configuration): Promise<WebIntegrationAccountResponse> {
    const requestContextPromise = this.requestFactory.createWebIntegrationAccount(param.integrationName,param.body,options);
   ...
   * @param param The request object
   */
  public deleteWebIntegrationAccount(param: WebIntegrationsApiDeleteWebIntegrationAccountRequest, options?: Configuration): Promise<void> {
    const requestContextPromise = this.requestFactory.deleteWebIntegrationAccount(param.integrationName,param.accountId,options);
    return requestContextPromise.then(requestContext => {
        return this.configuration.httpApi.send(requestContext).then(responseContext => {
   ...
   * @param param The request object
   */
  public getWebIntegrationAccount(param: WebIntegrationsApiGetWebIntegrationAccountRequest, options?: Configuration): Promise<WebIntegrationAccountResponse> {
    const requestContextPromise = this.requestFactory.getWebIntegrationAccount(param.integrationName,param.accountId,options);
    return requestContextPromise.then(requestContext => {
        return this.configuration.httpApi.send(requestContext).then(responseContext => {
   ...
   * @param param The request object
   */
  public listWebIntegrationAccounts(param: WebIntegrationsApiListWebIntegrationAccountsRequest, options?: Configuration): Promise<WebIntegrationAccountsResponse> {
    const requestContextPromise = this.requestFactory.listWebIntegrationAccounts(param.integrationName,options);
    return requestContextPromise.then(requestContext => {
        return this.configuration.httpApi.send(requestContext).then(responseContext => {
   ...
   * @param param The request object
   */
  public updateWebIntegrationAccount(param: WebIntegrationsApiUpdateWebIntegrationAccountRequest, options?: Configuration): Promise<WebIntegrationAccountResponse> {
    const requestContextPromise = this.requestFactory.updateWebIntegrationAccount(param.integrationName,param.accountId,param.body,options);
    return requestContextPromise.then(requestContext => {
        return this.configuration.httpApi.send(requestContext).then(responseContext => {
