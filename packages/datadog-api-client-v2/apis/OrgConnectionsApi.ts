...
export class OrgConnectionsApiRequestFactory extends BaseAPIRequestFactory {
  ...
  public async createOrgConnections(body: OrgConnectionCreateRequest,_options?: Configuration): Promise<RequestContext> {
    ...
    const requestContext = _config.getServer('v2.OrgConnectionsApi.createOrgConnections').makeRequestContext(localVarPath, HttpMethod.POST);
  ...
  public async deleteOrgConnections(connectionId: string,_options?: Configuration): Promise<RequestContext> {
    const _config = _options || this.configuration;
    ...
    // Path Params
    const localVarPath = '/api/v2/org_connections/{connection_id}'
      .replace('{connection_id}', encodeURIComponent(String(connectionId)));

    // Make Request Context
    const requestContext = _config.getServer('v2.OrgConnectionsApi.deleteOrgConnections').makeRequestContext(localVarPath, HttpMethod.DELETE);
  ...
  public async listOrgConnections(sinkOrgId?: string,sourceOrgId?: string,limit?: number,offset?: number,_options?: Configuration): Promise<RequestContext> {
    const _config = _options || this.configuration;
    ...
    // Make Request Context
    const requestContext = _config.getServer('v2.OrgConnectionsApi.listOrgConnections').makeRequestContext(localVarPath, HttpMethod.GET);
    requestContext.setHeaderParam("Accept", "application/json");
    requestContext.setHttpConfig(_config.httpConfig);

    // Query Params
  if (sinkOrgId !== undefined) {
      requestContext.setQueryParam("sink_org_id", ObjectSerializer.serialize(sinkOrgId, "string", ""
), "");
    }
  if (sourceOrgId !== undefined) {
      requestContext.setQueryParam("source_org_id", ObjectSerializer.serialize(sourceOrgId, "string", ""
), "");
    }
  if (limit !== undefined) {
  ...
  public async updateOrgConnections(connectionId: string,body: OrgConnectionUpdateRequest,_options?: Configuration): Promise<RequestContext> {
    const _config = _options || this.configuration;
    ...
    // Make Request Context
    const requestContext = _config.getServer('v2.OrgConnectionsApi.updateOrgConnections').makeRequestContext(localVarPath, HttpMethod.PATCH);
    requestContext.setHeaderParam("Accept", "application/json");
    requestContext.setHttpConfig(_config.httpConfig);
...
export class OrgConnectionsApiResponseProcessor {
   ...
   */
   public async createOrgConnections(response: ResponseContext): Promise<OrgConnectionResponse> {
   ...
   * @throws ApiException if the response code was not in [200, 299]
   */
   public async listOrgConnections(response: ResponseContext): Promise<OrgConnectionListResponse> {
    const contentType = ObjectSerializer.normalizeMediaType(response.headers["content-type"]);
    if (response.httpStatusCode === 200) {
   ...
   * @throws ApiException if the response code was not in [200, 299]
   */
   public async updateOrgConnections(response: ResponseContext): Promise<OrgConnectionResponse> {
    const contentType = ObjectSerializer.normalizeMediaType(response.headers["content-type"]);
    if (response.httpStatusCode === 200) {
      const body: OrgConnectionResponse = ObjectSerializer.deserialize(
        ObjectSerializer.parse(await response.body.text(), contentType),
...
export class OrgConnectionsApi {
  ...
  public constructor(configuration: Configuration, requestFactory?: OrgConnectionsApiRequestFactory, responseProcessor?: OrgConnectionsApiResponseProcessor) {
    this.configuration = configuration;
    this.requestFactory = requestFactory || new OrgConnectionsApiRequestFactory(configuration);
    this.responseProcessor = responseProcessor || new OrgConnectionsApiResponseProcessor();
  }
   ...
   */
  public createOrgConnections(param: OrgConnectionsApiCreateOrgConnectionsRequest, options?: Configuration): Promise<OrgConnectionResponse> {
   ...
   * @param param The request object
   */
  public deleteOrgConnections(param: OrgConnectionsApiDeleteOrgConnectionsRequest, options?: Configuration): Promise<void> {
   ...
   * @param param The request object
   */
  public listOrgConnections(param: OrgConnectionsApiListOrgConnectionsRequest = {}, options?: Configuration): Promise<OrgConnectionListResponse> {
   ...
   * @param param The request object
   */
  public updateOrgConnections(param: OrgConnectionsApiUpdateOrgConnectionsRequest, options?: Configuration): Promise<OrgConnectionResponse> {
