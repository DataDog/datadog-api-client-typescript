...
export class IntegrationAccountsApiRequestFactory extends BaseAPIRequestFactory {
  public async createIntegrationAccount(
    ...
    logger.warn("Using unstable operation 'createIntegrationAccount'");
    if (!_config.unstableOperations["v2.createIntegrationAccount"]) {
      throw new Error(
        "Unstable operation 'createIntegrationAccount' is disabled"
      );
    }
    ...
    const requestContext = _config
      .getServer("v2.IntegrationAccountsApi.createIntegrationAccount")
    ...
    const serializedBody = ObjectSerializer.stringify(
      ObjectSerializer.serialize(body, "IntegrationAccountRequest", ""),
      contentType
    );
  ...
  public async deleteIntegrationAccount(
    ...
    logger.warn("Using unstable operation 'deleteIntegrationAccount'");
    if (!_config.unstableOperations["v2.deleteIntegrationAccount"]) {
      throw new Error(
        "Unstable operation 'deleteIntegrationAccount' is disabled"
      );
    }
    ...
    // Make Request Context
    const requestContext = _config
      .getServer("v2.IntegrationAccountsApi.deleteIntegrationAccount")
  ...
  public async getIntegrationAccount(
    ...
    logger.warn("Using unstable operation 'getIntegrationAccount'");
    if (!_config.unstableOperations["v2.getIntegrationAccount"]) {
      throw new Error("Unstable operation 'getIntegrationAccount' is disabled");
    }
    ...
    // Make Request Context
    const requestContext = _config
      .getServer("v2.IntegrationAccountsApi.getIntegrationAccount")
  ...
  public async listIntegrationAccounts(
    ...
    logger.warn("Using unstable operation 'listIntegrationAccounts'");
    if (!_config.unstableOperations["v2.listIntegrationAccounts"]) {
      throw new Error(
        "Unstable operation 'listIntegrationAccounts' is disabled"
      );
    }
    ...
    // Make Request Context
    const requestContext = _config
      .getServer("v2.IntegrationAccountsApi.listIntegrationAccounts")
      .makeRequestContext(localVarPath, HttpMethod.GET);
    requestContext.setHeaderParam("Accept", "application/json");
    requestContext.setHttpConfig(_config.httpConfig);
  ...
  public async updateIntegrationAccount(
    ...
    logger.warn("Using unstable operation 'updateIntegrationAccount'");
    if (!_config.unstableOperations["v2.updateIntegrationAccount"]) {
      throw new Error(
        "Unstable operation 'updateIntegrationAccount' is disabled"
      );
    }
    ...
    // Make Request Context
    const requestContext = _config
      .getServer("v2.IntegrationAccountsApi.updateIntegrationAccount")
    ...
    requestContext.setHeaderParam("Content-Type", contentType);
    const serializedBody = ObjectSerializer.stringify(
      ObjectSerializer.serialize(body, "IntegrationAccountUpdateRequest", ""),
      contentType
    );
    requestContext.setBody(serializedBody);
...
export class IntegrationAccountsApiResponseProcessor {
  ...
  public async createIntegrationAccount(
    ...
    if (response.httpStatusCode === 201) {
      const body: IntegrationAccountResponse = ObjectSerializer.deserialize(
  ...
  public async listIntegrationAccounts(
    ...
    if (response.httpStatusCode === 200) {
      const body: IntegrationAccountsResponse = ObjectSerializer.deserialize(
        ObjectSerializer.parse(await response.body.text(), contentType),
