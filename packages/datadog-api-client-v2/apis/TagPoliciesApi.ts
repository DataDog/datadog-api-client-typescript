...
export class TagPoliciesApiRequestFactory extends BaseAPIRequestFactory {
  ...
  public async createTagPolicy(body: TagPolicyCreateRequest,_options?: Configuration): Promise<RequestContext> {
    ...
    const requestContext = _config.getServer('v2.TagPoliciesApi.createTagPolicy').makeRequestContext(localVarPath, HttpMethod.POST);
  ...
  public async deleteTagPolicy(policyId: string,hardDelete?: boolean,_options?: Configuration): Promise<RequestContext> {
    const _config = _options || this.configuration;
    ...
    // Path Params
    const localVarPath = '/api/v2/tag-policies/{policy_id}'
      .replace('{policy_id}', encodeURIComponent(String(policyId)));

    // Make Request Context
    const requestContext = _config.getServer('v2.TagPoliciesApi.deleteTagPolicy').makeRequestContext(localVarPath, HttpMethod.DELETE);
  ...
  public async getTagPolicy(policyId: string,include?: TagPolicyInclude,tsStart?: number,tsEnd?: number,_options?: Configuration): Promise<RequestContext> {
    const _config = _options || this.configuration;
    ...
    // Make Request Context
    const requestContext = _config.getServer('v2.TagPoliciesApi.getTagPolicy').makeRequestContext(localVarPath, HttpMethod.GET);
    requestContext.setHeaderParam("Accept", "application/json");
    requestContext.setHttpConfig(_config.httpConfig);

    // Query Params
  if (include !== undefined) {
      requestContext.setQueryParam("include", ObjectSerializer.serialize(include, "TagPolicyInclude", ""
), "");
    }
  if (tsStart !== undefined) {
      requestContext.setQueryParam("ts_start", ObjectSerializer.serialize(tsStart, "number", "int64"
), "");
    }
  if (tsEnd !== undefined) {
      requestContext.setQueryParam("ts_end", ObjectSerializer.serialize(tsEnd, "number", "int64"
), "");
    }
  ...
  public async getTagPolicyScore(policyId: string,tsStart?: number,tsEnd?: number,_options?: Configuration): Promise<RequestContext> {
    const _config = _options || this.configuration;
    ...
    // Path Params
    const localVarPath = '/api/v2/tag-policies/{policy_id}/score'
      .replace('{policy_id}', encodeURIComponent(String(policyId)));

    // Make Request Context
    const requestContext = _config.getServer('v2.TagPoliciesApi.getTagPolicyScore').makeRequestContext(localVarPath, HttpMethod.GET);
    requestContext.setHeaderParam("Accept", "application/json");
    requestContext.setHttpConfig(_config.httpConfig);
  ...
  public async listTagPolicies(includeDisabled?: boolean,includeDeleted?: boolean,include?: TagPolicyInclude,filterSource?: TagPolicySource,tsStart?: number,tsEnd?: number,_options?: Configuration): Promise<RequestContext> {
    const _config = _options || this.configuration;
    ...
    // Make Request Context
    const requestContext = _config.getServer('v2.TagPoliciesApi.listTagPolicies').makeRequestContext(localVarPath, HttpMethod.GET);
    requestContext.setHeaderParam("Accept", "application/json");
    requestContext.setHttpConfig(_config.httpConfig);

    // Query Params
  if (includeDisabled !== undefined) {
      requestContext.setQueryParam("include_disabled", ObjectSerializer.serialize(includeDisabled, "boolean", ""
), "");
    }
  ...
  if (filterSource !== undefined) {
      requestContext.setQueryParam("filter[source]", ObjectSerializer.serialize(filterSource, "TagPolicySource", ""
), "");
    }
  if (tsStart !== undefined) {
      requestContext.setQueryParam("ts_start", ObjectSerializer.serialize(tsStart, "number", "int64"
  ...
  public async updateTagPolicy(policyId: string,body: TagPolicyUpdateRequest,_options?: Configuration): Promise<RequestContext> {
    const _config = _options || this.configuration;
    ...
    // Make Request Context
    const requestContext = _config.getServer('v2.TagPoliciesApi.updateTagPolicy').makeRequestContext(localVarPath, HttpMethod.PATCH);
    requestContext.setHeaderParam("Accept", "application/json");
    requestContext.setHttpConfig(_config.httpConfig);
...
export class TagPoliciesApiResponseProcessor {
   ...
   */
   public async createTagPolicy(response: ResponseContext): Promise<TagPolicyResponse> {
   ...
   * @throws ApiException if the response code was not in [200, 299]
   */
   public async getTagPolicy(response: ResponseContext): Promise<TagPolicyResponse> {
    const contentType = ObjectSerializer.normalizeMediaType(response.headers["content-type"]);
   ...
   * @throws ApiException if the response code was not in [200, 299]
   */
   public async getTagPolicyScore(response: ResponseContext): Promise<TagPolicyScoreResponse> {
    const contentType = ObjectSerializer.normalizeMediaType(response.headers["content-type"]);
    if (response.httpStatusCode === 200) {
   ...
   * @throws ApiException if the response code was not in [200, 299]
   */
   public async listTagPolicies(response: ResponseContext): Promise<TagPoliciesListResponse> {
    const contentType = ObjectSerializer.normalizeMediaType(response.headers["content-type"]);
    if (response.httpStatusCode === 200) {
   ...
   * @throws ApiException if the response code was not in [200, 299]
   */
   public async updateTagPolicy(response: ResponseContext): Promise<TagPolicyResponse> {
    const contentType = ObjectSerializer.normalizeMediaType(response.headers["content-type"]);
    if (response.httpStatusCode === 200) {
      const body: TagPolicyResponse = ObjectSerializer.deserialize(
        ObjectSerializer.parse(await response.body.text(), contentType),
...
export class TagPoliciesApi {
  ...
  public constructor(configuration: Configuration, requestFactory?: TagPoliciesApiRequestFactory, responseProcessor?: TagPoliciesApiResponseProcessor) {
    this.configuration = configuration;
    this.requestFactory = requestFactory || new TagPoliciesApiRequestFactory(configuration);
    this.responseProcessor = responseProcessor || new TagPoliciesApiResponseProcessor();
  }
   ...
   */
  public createTagPolicy(param: TagPoliciesApiCreateTagPolicyRequest, options?: Configuration): Promise<TagPolicyResponse> {
   ...
   * @param param The request object
   */
  public deleteTagPolicy(param: TagPoliciesApiDeleteTagPolicyRequest, options?: Configuration): Promise<void> {
   ...
   * @param param The request object
   */
  public getTagPolicy(param: TagPoliciesApiGetTagPolicyRequest, options?: Configuration): Promise<TagPolicyResponse> {
   ...
   * @param param The request object
   */
  public getTagPolicyScore(param: TagPoliciesApiGetTagPolicyScoreRequest, options?: Configuration): Promise<TagPolicyScoreResponse> {
   ...
   * @param param The request object
   */
  public listTagPolicies(param: TagPoliciesApiListTagPoliciesRequest = {}, options?: Configuration): Promise<TagPoliciesListResponse> {
   ...
   * @param param The request object
   */
  public updateTagPolicy(param: TagPoliciesApiUpdateTagPolicyRequest, options?: Configuration): Promise<TagPolicyResponse> {
