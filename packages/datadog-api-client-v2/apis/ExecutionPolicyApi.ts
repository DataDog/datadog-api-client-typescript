...
export class ExecutionPolicyApiRequestFactory extends BaseAPIRequestFactory {
  public async createExecutionPolicy(
    ...
    logger.warn("Using unstable operation 'createExecutionPolicy'");
    if (!_config.unstableOperations["v2.createExecutionPolicy"]) {
      throw new Error("Unstable operation 'createExecutionPolicy' is disabled");
    }
    ...
    const requestContext = _config
      .getServer("v2.ExecutionPolicyApi.createExecutionPolicy")
    ...
    const serializedBody = ObjectSerializer.stringify(
      ObjectSerializer.serialize(body, "ExecutionPolicyCreateRequest", ""),
      contentType
    );
  ...
  public async deleteExecutionPolicy(
    ...
    logger.warn("Using unstable operation 'deleteExecutionPolicy'");
    if (!_config.unstableOperations["v2.deleteExecutionPolicy"]) {
      throw new Error("Unstable operation 'deleteExecutionPolicy' is disabled");
    }
    ...
    // Make Request Context
    const requestContext = _config
      .getServer("v2.ExecutionPolicyApi.deleteExecutionPolicy")
  ...
  public async getExecutionPolicy(
    ...
    logger.warn("Using unstable operation 'getExecutionPolicy'");
    if (!_config.unstableOperations["v2.getExecutionPolicy"]) {
      throw new Error("Unstable operation 'getExecutionPolicy' is disabled");
    }
    ...
    // Make Request Context
    const requestContext = _config
      .getServer("v2.ExecutionPolicyApi.getExecutionPolicy")
  ...
  public async listExecutionPolicies(
    ...
    logger.warn("Using unstable operation 'listExecutionPolicies'");
    if (!_config.unstableOperations["v2.listExecutionPolicies"]) {
      throw new Error("Unstable operation 'listExecutionPolicies' is disabled");
    }
    ...
    // Make Request Context
    const requestContext = _config
      .getServer("v2.ExecutionPolicyApi.listExecutionPolicies")
      .makeRequestContext(localVarPath, HttpMethod.GET);
    requestContext.setHeaderParam("Accept", "application/json");
    requestContext.setHttpConfig(_config.httpConfig);
    ...
    if (pageNumber !== undefined) {
      requestContext.setQueryParam(
        "page[number]",
        ObjectSerializer.serialize(pageNumber, "number", "int32"),
        ""
      );
    }
    ...
    if (filterIds !== undefined) {
      requestContext.setQueryParam(
        "filter[ids]",
        ObjectSerializer.serialize(filterIds, "Array<string>", ""),
        "multi"
      );
    }
  ...
  public async updateExecutionPolicy(
    ...
    logger.warn("Using unstable operation 'updateExecutionPolicy'");
    if (!_config.unstableOperations["v2.updateExecutionPolicy"]) {
      throw new Error("Unstable operation 'updateExecutionPolicy' is disabled");
    }
    ...
    // Make Request Context
    const requestContext = _config
      .getServer("v2.ExecutionPolicyApi.updateExecutionPolicy")
    ...
    requestContext.setHeaderParam("Content-Type", contentType);
    const serializedBody = ObjectSerializer.stringify(
      ObjectSerializer.serialize(body, "ExecutionPolicyUpdateRequest", ""),
      contentType
    );
    requestContext.setBody(serializedBody);
...
export class ExecutionPolicyApiResponseProcessor {
  ...
  public async createExecutionPolicy(
    ...
    if (response.httpStatusCode === 201) {
      const body: ExecutionPolicyResponse = ObjectSerializer.deserialize(
  ...
  public async listExecutionPolicies(
    ...
    if (response.httpStatusCode === 200) {
      const body: ExecutionPolicyListResponse = ObjectSerializer.deserialize(
        ObjectSerializer.parse(await response.body.text(), contentType),
...
export class ExecutionPolicyApi {
  ...
  public constructor(
    ...
    this.requestFactory =
      requestFactory || new ExecutionPolicyApiRequestFactory(configuration);
