...
export class ScorecardsApiRequestFactory extends BaseAPIRequestFactory {
  ...
  public async createScorecardCampaign(body: CreateCampaignRequest,_options?: Configuration): Promise<RequestContext> {
    ...
    const requestContext = _config.getServer('v2.ScorecardsApi.createScorecardCampaign').makeRequestContext(localVarPath, HttpMethod.POST);
  ...
  public async createScorecardOutcomesBatch(body: OutcomesBatchRequest,_options?: Configuration): Promise<RequestContext> {
    ...
    // Make Request Context
    const requestContext = _config.getServer('v2.ScorecardsApi.createScorecardOutcomesBatch').makeRequestContext(localVarPath, HttpMethod.POST);
    requestContext.setHeaderParam("Accept", "application/json");
    requestContext.setHttpConfig(_config.httpConfig);
  ...
  public async createScorecardRule(body: CreateRuleRequest,_options?: Configuration): Promise<RequestContext> {
    ...
    // Make Request Context
    const requestContext = _config.getServer('v2.ScorecardsApi.createScorecardRule').makeRequestContext(localVarPath, HttpMethod.POST);
    requestContext.setHeaderParam("Accept", "application/json");
    requestContext.setHttpConfig(_config.httpConfig);
  ...
  public async deleteScorecardCampaign(campaignId: string,_options?: Configuration): Promise<RequestContext> {
    const _config = _options || this.configuration;
    ...
    // Path Params
    const localVarPath = '/api/v2/scorecard/campaigns/{campaign_id}'
      .replace('{campaign_id}', encodeURIComponent(String(campaignId)));

    // Make Request Context
    const requestContext = _config.getServer('v2.ScorecardsApi.deleteScorecardCampaign').makeRequestContext(localVarPath, HttpMethod.DELETE);
  ...
  public async deleteScorecardRule(ruleId: string,_options?: Configuration): Promise<RequestContext> {
    ...
    // Make Request Context
    const requestContext = _config.getServer('v2.ScorecardsApi.deleteScorecardRule').makeRequestContext(localVarPath, HttpMethod.DELETE);
    requestContext.setHeaderParam("Accept", "*/*");
    requestContext.setHttpConfig(_config.httpConfig);
  ...
  public async getScorecardCampaign(campaignId: string,include?: string,includeMeta?: boolean,_options?: Configuration): Promise<RequestContext> {
    const _config = _options || this.configuration;
    ...
    // Make Request Context
    const requestContext = _config.getServer('v2.ScorecardsApi.getScorecardCampaign').makeRequestContext(localVarPath, HttpMethod.GET);
    requestContext.setHeaderParam("Accept", "application/json");
    requestContext.setHttpConfig(_config.httpConfig);
  ...
  if (includeMeta !== undefined) {
      requestContext.setQueryParam("include_meta", ObjectSerializer.serialize(includeMeta, "boolean", ""
), "");
    }
  ...
  public async listScorecardCampaigns(pageLimit?: number,pageOffset?: number,filterCampaignName?: string,filterCampaignStatus?: string,filterCampaignOwner?: string,_options?: Configuration): Promise<RequestContext> {
    const _config = _options || this.configuration;
    ...
    // Make Request Context
    const requestContext = _config.getServer('v2.ScorecardsApi.listScorecardCampaigns').makeRequestContext(localVarPath, HttpMethod.GET);
    requestContext.setHeaderParam("Accept", "application/json");
    requestContext.setHttpConfig(_config.httpConfig);
  ...
  if (filterCampaignName !== undefined) {
      requestContext.setQueryParam("filter[campaign][name]", ObjectSerializer.serialize(filterCampaignName, "string", ""
), "");
    }
  if (filterCampaignStatus !== undefined) {
      requestContext.setQueryParam("filter[campaign][status]", ObjectSerializer.serialize(filterCampaignStatus, "string", ""
), "");
    }
  if (filterCampaignOwner !== undefined) {
      requestContext.setQueryParam("filter[campaign][owner]", ObjectSerializer.serialize(filterCampaignOwner, "string", ""
), "");
    }
  ...
  public async listScorecardOutcomes(pageSize?: number,pageOffset?: number,include?: string,fieldsOutcome?: string,fieldsRule?: string,filterOutcomeServiceName?: string,filterOutcomeState?: string,filterRuleEnabled?: boolean,filterRuleId?: string,filterRuleName?: string,_options?: Configuration): Promise<RequestContext> {
    ...
    // Make Request Context
    const requestContext = _config.getServer('v2.ScorecardsApi.listScorecardOutcomes').makeRequestContext(localVarPath, HttpMethod.GET);
    requestContext.setHeaderParam("Accept", "application/json");
    requestContext.setHttpConfig(_config.httpConfig);
  ...
  public async listScorecardRules(pageSize?: number,pageOffset?: number,include?: string,filterRuleId?: string,filterRuleEnabled?: boolean,filterRuleCustom?: boolean,filterRuleName?: string,filterRuleDescription?: string,fieldsRule?: string,fieldsScorecard?: string,_options?: Configuration): Promise<RequestContext> {
    ...
    // Make Request Context
    const requestContext = _config.getServer('v2.ScorecardsApi.listScorecardRules').makeRequestContext(localVarPath, HttpMethod.GET);
    requestContext.setHeaderParam("Accept", "application/json");
    requestContext.setHttpConfig(_config.httpConfig);
  ...
  public async listScorecards(pageOffset?: number,pageSize?: number,filterScorecardId?: string,filterScorecardName?: string,filterScorecardDescription?: string,_options?: Configuration): Promise<RequestContext> {
    const _config = _options || this.configuration;
    ...
    // Make Request Context
    const requestContext = _config.getServer('v2.ScorecardsApi.listScorecards').makeRequestContext(localVarPath, HttpMethod.GET);
    requestContext.setHeaderParam("Accept", "application/json");
    requestContext.setHttpConfig(_config.httpConfig);
  ...
  if (filterScorecardId !== undefined) {
      requestContext.setQueryParam("filter[scorecard][id]", ObjectSerializer.serialize(filterScorecardId, "string", ""
), "");
    }
  if (filterScorecardName !== undefined) {
      requestContext.setQueryParam("filter[scorecard][name]", ObjectSerializer.serialize(filterScorecardName, "string", ""
), "");
    }
  if (filterScorecardDescription !== undefined) {
      requestContext.setQueryParam("filter[scorecard][description]", ObjectSerializer.serialize(filterScorecardDescription, "string", ""
), "");
    }
  ...
  public async listScorecardScores(aggregation: ScorecardScoresAggregation,filterRuleId?: string,filterRuleName?: string,filterRuleLevel?: string,filterRuleScorecardId?: string,filterRuleIsCustom?: boolean,filterRuleIsEnabled?: boolean,sort?: string,pageOffset?: number,pageLimit?: number,_options?: Configuration): Promise<RequestContext> {
    const _config = _options || this.configuration;
    ...
    // Path Params
    const localVarPath = '/api/v2/scorecard/scores/{aggregation}'
      .replace('{aggregation}', encodeURIComponent(String(aggregation)));

    // Make Request Context
    const requestContext = _config.getServer('v2.ScorecardsApi.listScorecardScores').makeRequestContext(localVarPath, HttpMethod.GET);
    requestContext.setHeaderParam("Accept", "application/json");
    requestContext.setHttpConfig(_config.httpConfig);
  ...
  if (filterRuleLevel !== undefined) {
      requestContext.setQueryParam("filter[rule][level]", ObjectSerializer.serialize(filterRuleLevel, "string", ""
), "");
    }
  if (filterRuleScorecardId !== undefined) {
      requestContext.setQueryParam("filter[rule][scorecard_id]", ObjectSerializer.serialize(filterRuleScorecardId, "string", ""
), "");
    }
  if (filterRuleIsCustom !== undefined) {
      requestContext.setQueryParam("filter[rule][is_custom]", ObjectSerializer.serialize(filterRuleIsCustom, "boolean", ""
), "");
    }
  if (filterRuleIsEnabled !== undefined) {
      requestContext.setQueryParam("filter[rule][is_enabled]", ObjectSerializer.serialize(filterRuleIsEnabled, "boolean", ""
), "");
    }
  if (sort !== undefined) {
  ...
  public async updateScorecardCampaign(campaignId: string,body: UpdateCampaignRequest,_options?: Configuration): Promise<RequestContext> {
    const _config = _options || this.configuration;
    ...
    // Make Request Context
    const requestContext = _config.getServer('v2.ScorecardsApi.updateScorecardCampaign').makeRequestContext(localVarPath, HttpMethod.PUT);
    requestContext.setHeaderParam("Accept", "application/json");
    requestContext.setHttpConfig(_config.httpConfig);
  ...
  public async updateScorecardOutcomes(body: UpdateOutcomesAsyncRequest,_options?: Configuration): Promise<RequestContext> {
    const _config = _options || this.configuration;
    ...
    // Make Request Context
    const requestContext = _config.getServer('v2.ScorecardsApi.updateScorecardOutcomes').makeRequestContext(localVarPath, HttpMethod.POST);
    requestContext.setHeaderParam("Accept", "*/*");
    requestContext.setHttpConfig(_config.httpConfig);
  ...
  public async updateScorecardRule(ruleId: string,body: UpdateRuleRequest,_options?: Configuration): Promise<RequestContext> {
    ...
    // Make Request Context
    const requestContext = _config.getServer('v2.ScorecardsApi.updateScorecardRule').makeRequestContext(localVarPath, HttpMethod.PUT);
    requestContext.setHeaderParam("Accept", "application/json");
    requestContext.setHttpConfig(_config.httpConfig);
...
export class ScorecardsApiResponseProcessor {
   ...
   */
   public async createScorecardCampaign(response: ResponseContext): Promise<CampaignResponse> {
   ...
   * @throws ApiException if the response code was not in [200, 299]
   */
   public async deleteScorecardCampaign(response: ResponseContext): Promise<void> {
    const contentType = ObjectSerializer.normalizeMediaType(response.headers["content-type"]);
   ...
   * @throws ApiException if the response code was not in [200, 299]
   */
   public async getScorecardCampaign(response: ResponseContext): Promise<CampaignResponse> {
    const contentType = ObjectSerializer.normalizeMediaType(response.headers["content-type"]);
    if (response.httpStatusCode === 200) {
      const body: CampaignResponse = ObjectSerializer.deserialize(
        ObjectSerializer.parse(await response.body.text(), contentType),
   ...
   * @throws ApiException if the response code was not in [200, 299]
   */
   public async listScorecardCampaigns(response: ResponseContext): Promise<ListCampaignsResponse> {
    const contentType = ObjectSerializer.normalizeMediaType(response.headers["content-type"]);
    if (response.httpStatusCode === 200) {
   ...
   * @throws ApiException if the response code was not in [200, 299]
   */
   public async listScorecards(response: ResponseContext): Promise<ListScorecardsResponse> {
    const contentType = ObjectSerializer.normalizeMediaType(response.headers["content-type"]);
    if (response.httpStatusCode === 200) {
   ...
   * @throws ApiException if the response code was not in [200, 299]
   */
   public async listScorecardScores(response: ResponseContext): Promise<ListScorecardScoresResponse> {
    const contentType = ObjectSerializer.normalizeMediaType(response.headers["content-type"]);
    if (response.httpStatusCode === 200) {
   ...
   * @throws ApiException if the response code was not in [200, 299]
   */
   public async updateScorecardCampaign(response: ResponseContext): Promise<CampaignResponse> {
    const contentType = ObjectSerializer.normalizeMediaType(response.headers["content-type"]);
    if (response.httpStatusCode === 200) {
      const body: CampaignResponse = ObjectSerializer.deserialize(
        ObjectSerializer.parse(await response.body.text(), contentType),
   ...
   * @throws ApiException if the response code was not in [200, 299]
   */
   public async updateScorecardOutcomes(response: ResponseContext): Promise<void> {
    const contentType = ObjectSerializer.normalizeMediaType(response.headers["content-type"]);
...
export class ScorecardsApi {
  ...
  public constructor(configuration: Configuration, requestFactory?: ScorecardsApiRequestFactory, responseProcessor?: ScorecardsApiResponseProcessor) {
    this.configuration = configuration;
    this.requestFactory = requestFactory || new ScorecardsApiRequestFactory(configuration);
    this.responseProcessor = responseProcessor || new ScorecardsApiResponseProcessor();
  }
   ...
   */
  public createScorecardCampaign(param: ScorecardsApiCreateScorecardCampaignRequest, options?: Configuration): Promise<CampaignResponse> {
   ...
   * @param param The request object
   */
  public createScorecardOutcomesBatch(param: ScorecardsApiCreateScorecardOutcomesBatchRequest, options?: Configuration): Promise<OutcomesBatchResponse> {
   ...
   * @param param The request object
   */
  public createScorecardRule(param: ScorecardsApiCreateScorecardRuleRequest, options?: Configuration): Promise<CreateRuleResponse> {
   ...
   * @param param The request object
   */
  public deleteScorecardCampaign(param: ScorecardsApiDeleteScorecardCampaignRequest, options?: Configuration): Promise<void> {
   ...
   * @param param The request object
   */
  public deleteScorecardRule(param: ScorecardsApiDeleteScorecardRuleRequest, options?: Configuration): Promise<void> {
   ...
   * @param param The request object
   */
  public getScorecardCampaign(param: ScorecardsApiGetScorecardCampaignRequest, options?: Configuration): Promise<CampaignResponse> {
   ...
   * @param param The request object
   */
  public listScorecardCampaigns(param: ScorecardsApiListScorecardCampaignsRequest = {}, options?: Configuration): Promise<ListCampaignsResponse> {
   ...
   * @param param The request object
   */
  public listScorecardOutcomes(param: ScorecardsApiListScorecardOutcomesRequest = {}, options?: Configuration): Promise<OutcomesResponse> {
...
/**
   ...
   * @param param The request object
   */
  public listScorecardRules(param: ScorecardsApiListScorecardRulesRequest = {}, options?: Configuration): Promise<ListRulesResponse> {
...
/**
   ...
   * @param param The request object
   */
  public listScorecards(param: ScorecardsApiListScorecardsRequest = {}, options?: Configuration): Promise<ListScorecardsResponse> {
   ...
   * @param param The request object
   */
  public listScorecardScores(param: ScorecardsApiListScorecardScoresRequest, options?: Configuration): Promise<ListScorecardScoresResponse> {
   ...
   * @param param The request object
   */
  public updateScorecardCampaign(param: ScorecardsApiUpdateScorecardCampaignRequest, options?: Configuration): Promise<CampaignResponse> {
   ...
   * @param param The request object
   */
  public updateScorecardOutcomes(param: ScorecardsApiUpdateScorecardOutcomesRequest, options?: Configuration): Promise<void> {
   ...
   * @param param The request object
   */
  public updateScorecardRule(param: ScorecardsApiUpdateScorecardRuleRequest, options?: Configuration): Promise<UpdateRuleResponse> {
