...
export class RumReplayViewershipApiRequestFactory extends BaseAPIRequestFactory {
  ...
  public async createRumReplaySessionWatch(sessionId: string,body: Watch,_options?: Configuration): Promise<RequestContext> {
    ...
    // Path Params
    const localVarPath = '/api/v2/rum/replay/sessions/{session_id}/watches'
      .replace('{session_id}', encodeURIComponent(String(sessionId)));

    // Make Request Context
    const requestContext = _config.getServer('v2.RumReplayViewershipApi.createRumReplaySessionWatch').makeRequestContext(localVarPath, HttpMethod.POST);
  ...
  public async deleteRumReplaySessionWatch(sessionId: string,_options?: Configuration): Promise<RequestContext> {
    const _config = _options || this.configuration;
    ...
    // Make Request Context
    const requestContext = _config.getServer('v2.RumReplayViewershipApi.deleteRumReplaySessionWatch').makeRequestContext(localVarPath, HttpMethod.DELETE);
  ...
  public async listRumReplaySessionWatchers(sessionId: string,pageSize?: number,pageNumber?: number,_options?: Configuration): Promise<RequestContext> {
    const _config = _options || this.configuration;
    ...
    // Path Params
    const localVarPath = '/api/v2/rum/replay/sessions/{session_id}/watchers'
      .replace('{session_id}', encodeURIComponent(String(sessionId)));

    // Make Request Context
    const requestContext = _config.getServer('v2.RumReplayViewershipApi.listRumReplaySessionWatchers').makeRequestContext(localVarPath, HttpMethod.GET);
    requestContext.setHeaderParam("Accept", "application/json");
    requestContext.setHttpConfig(_config.httpConfig);
  ...
  public async listRumReplayViewershipHistorySessions(filterWatchedAtStart?: number,pageNumber?: number,filterCreatedBy?: string,filterWatchedAtEnd?: number,filterSessionIds?: string,pageSize?: number,filterApplicationId?: string,_options?: Configuration): Promise<RequestContext> {
    const _config = _options || this.configuration;
    ...
    // Make Request Context
    const requestContext = _config.getServer('v2.RumReplayViewershipApi.listRumReplayViewershipHistorySessions').makeRequestContext(localVarPath, HttpMethod.GET);
    requestContext.setHeaderParam("Accept", "application/json");
    requestContext.setHttpConfig(_config.httpConfig);

    // Query Params
  if (filterWatchedAtStart !== undefined) {
      requestContext.setQueryParam("filter[watched_at][start]", ObjectSerializer.serialize(filterWatchedAtStart, "number", "int64"
), "");
    }
  if (pageNumber !== undefined) {
      requestContext.setQueryParam("page[number]", ObjectSerializer.serialize(pageNumber, "number", "int64"
  ...
  if (filterCreatedBy !== undefined) {
      requestContext.setQueryParam("filter[created_by]", ObjectSerializer.serialize(filterCreatedBy, "string", ""
), "");
    }
  if (filterWatchedAtEnd !== undefined) {
      requestContext.setQueryParam("filter[watched_at][end]", ObjectSerializer.serialize(filterWatchedAtEnd, "number", "int64"
), "");
    }
  if (filterSessionIds !== undefined) {
      requestContext.setQueryParam("filter[session_ids]", ObjectSerializer.serialize(filterSessionIds, "string", ""
), "");
    }
  if (pageSize !== undefined) {
      requestContext.setQueryParam("page[size]", ObjectSerializer.serialize(pageSize, "number", "int64"
...
export class RumReplayViewershipApiResponseProcessor {
   ...
   */
   public async createRumReplaySessionWatch(response: ResponseContext): Promise<Watch> {
   ...
   * @throws ApiException if the response code was not in [200, 299]
   */
   public async deleteRumReplaySessionWatch(response: ResponseContext): Promise<void> {
    const contentType = ObjectSerializer.normalizeMediaType(response.headers["content-type"]);
   ...
   * @throws ApiException if the response code was not in [200, 299]
   */
   public async listRumReplaySessionWatchers(response: ResponseContext): Promise<WatcherArray> {
    const contentType = ObjectSerializer.normalizeMediaType(response.headers["content-type"]);
   ...
   * @throws ApiException if the response code was not in [200, 299]
   */
   public async listRumReplayViewershipHistorySessions(response: ResponseContext): Promise<ViewershipHistorySessionArray> {
    const contentType = ObjectSerializer.normalizeMediaType(response.headers["content-type"]);
    if (response.httpStatusCode === 200) {
...
export class RumReplayViewershipApi {
  ...
  public constructor(configuration: Configuration, requestFactory?: RumReplayViewershipApiRequestFactory, responseProcessor?: RumReplayViewershipApiResponseProcessor) {
    this.configuration = configuration;
    this.requestFactory = requestFactory || new RumReplayViewershipApiRequestFactory(configuration);
    this.responseProcessor = responseProcessor || new RumReplayViewershipApiResponseProcessor();
  }
   ...
   */
  public createRumReplaySessionWatch(param: RumReplayViewershipApiCreateRumReplaySessionWatchRequest, options?: Configuration): Promise<Watch> {
   ...
   * @param param The request object
   */
  public deleteRumReplaySessionWatch(param: RumReplayViewershipApiDeleteRumReplaySessionWatchRequest, options?: Configuration): Promise<void> {
   ...
   * @param param The request object
   */
  public listRumReplaySessionWatchers(param: RumReplayViewershipApiListRumReplaySessionWatchersRequest, options?: Configuration): Promise<WatcherArray> {
   ...
   * @param param The request object
   */
  public listRumReplayViewershipHistorySessions(param: RumReplayViewershipApiListRumReplayViewershipHistorySessionsRequest = {}, options?: Configuration): Promise<ViewershipHistorySessionArray> {
