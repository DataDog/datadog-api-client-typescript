...
export class LogsApiRequestFactory extends BaseAPIRequestFactory {
  ...
  public async aggregateLogs(body: LogsAggregateRequest,_options?: Configuration): Promise<RequestContext> {
    ...
    const requestContext = _config.getServer('v2.LogsApi.aggregateLogs').makeRequestContext(localVarPath, HttpMethod.POST);
  ...
  public async listLogs(body?: LogsListRequest,_options?: Configuration): Promise<RequestContext> {
    ...
    // Make Request Context
    const requestContext = _config.getServer('v2.LogsApi.listLogs').makeRequestContext(localVarPath, HttpMethod.POST);
    requestContext.setHeaderParam("Accept", "application/json");
    requestContext.setHttpConfig(_config.httpConfig);
  ...
  public async listLogsGet(filterQuery?: string,filterIndexes?: Array<string>,filterFrom?: Date,filterTo?: Date,filterStorageTier?: LogsStorageTier,sort?: LogsSort,pageCursor?: string,pageLimit?: number,_options?: Configuration): Promise<RequestContext> {
    const _config = _options || this.configuration;
    ...
    // Make Request Context
    const requestContext = _config.getServer('v2.LogsApi.listLogsGet').makeRequestContext(localVarPath, HttpMethod.GET);
    requestContext.setHeaderParam("Accept", "application/json");
    requestContext.setHttpConfig(_config.httpConfig);
    ...
    if (filterIndexes !== undefined) {
      requestContext.setQueryParam("filter[indexes]", ObjectSerializer.serialize(filterIndexes, "Array<string>", ""), "csv");
    }
    ...
    if (filterStorageTier !== undefined) {
      requestContext.setQueryParam("filter[storage_tier]", ObjectSerializer.serialize(filterStorageTier, "LogsStorageTier", ""), "");
    }
    if (sort !== undefined) {
  ...
  public async submitLog(body: Array<HTTPLogItem>,contentEncoding?: ContentEncoding,ddtags?: string,_options?: Configuration): Promise<RequestContext> {
    ...
    // Make Request Context
    const requestContext = _config.getServer('v2.LogsApi.submitLog').makeRequestContext(localVarPath, HttpMethod.POST);
    requestContext.setHeaderParam("Accept", "application/json");
    requestContext.setHttpConfig(_config.httpConfig);
   ...
   public async submitLog(response: ResponseContext): Promise<any> {
    ...
    if (response.httpStatusCode === 400||response.httpStatusCode === 401||response.httpStatusCode === 403||response.httpStatusCode === 408||response.httpStatusCode === 413||response.httpStatusCode === 429||response.httpStatusCode === 500||response.httpStatusCode === 503) {
      ...
      try {
        ...
        logger.debug(`Got error deserializing error: ${error}`);
        throw new ApiException<HTTPLogErrors>(response.httpStatusCode, bodyText);
      } 
...
export class LogsApi {
   ...
   */
  public async *listLogsWithPagination(param: LogsApiListLogsRequest = {}, options?: Configuration): AsyncGenerator<Log> {
   ...
   */
  public async *listLogsGetWithPagination(param: LogsApiListLogsGetRequest = {}, options?: Configuration): AsyncGenerator<Log> {
