...
export class ThreatIntelligenceApiRequestFactory extends BaseAPIRequestFactory {
  public async addSTIXThreatIntel(
    ...
    logger.warn("Using unstable operation 'addSTIXThreatIntel'");
    if (!_config.unstableOperations["v2.addSTIXThreatIntel"]) {
      throw new Error("Unstable operation 'addSTIXThreatIntel' is disabled");
    }
    ...
    const requestContext = _config
      .getServer("v2.ThreatIntelligenceApi.addSTIXThreatIntel")
