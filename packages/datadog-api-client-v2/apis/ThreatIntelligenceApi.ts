...
export class ThreatIntelligenceApiRequestFactory extends BaseAPIRequestFactory {
  public async submitStixThreatIntel(
    ...
    logger.warn("Using unstable operation 'submitStixThreatIntel'");
    if (!_config.unstableOperations["v2.submitStixThreatIntel"]) {
      throw new Error("Unstable operation 'submitStixThreatIntel' is disabled");
    }
    ...
    const requestContext = _config
      .getServer("v2.ThreatIntelligenceApi.submitStixThreatIntel")
