...
export class ReportSchedulesApiRequestFactory extends BaseAPIRequestFactory {
  ...
  public async createReportSchedule(body: ReportScheduleCreateRequest,_options?: Configuration): Promise<RequestContext> {
    ...
    const requestContext = _config.getServer('v2.ReportSchedulesApi.createReportSchedule').makeRequestContext(localVarPath, HttpMethod.POST);
  ...
  public async deleteReportSchedule(scheduleUuid: string,_options?: Configuration): Promise<RequestContext> {
    const _config = _options || this.configuration;
    ...
    // Path Params
    const localVarPath = '/api/v2/reporting/schedule/{schedule_uuid}'
      .replace('{schedule_uuid}', encodeURIComponent(String(scheduleUuid)));

    // Make Request Context
    const requestContext = _config.getServer('v2.ReportSchedulesApi.deleteReportSchedule').makeRequestContext(localVarPath, HttpMethod.DELETE);
    requestContext.setHeaderParam("Accept", "application/json");
    requestContext.setHttpConfig(_config.httpConfig);
  ...
  public async getReportSchedule(scheduleUuid: string,_options?: Configuration): Promise<RequestContext> {
    const _config = _options || this.configuration;
    ...
    // Make Request Context
    const requestContext = _config.getServer('v2.ReportSchedulesApi.getReportSchedule').makeRequestContext(localVarPath, HttpMethod.GET);
    requestContext.setHeaderParam("Accept", "application/json");
    requestContext.setHttpConfig(_config.httpConfig);
  ...
  public async getReportSchedulesForResource(resourceType: ReportScheduleResourceType,resourceId: string,_options?: Configuration): Promise<RequestContext> {
    const _config = _options || this.configuration;
    ...
    // Make Request Context
    const requestContext = _config.getServer('v2.ReportSchedulesApi.getReportSchedulesForResource').makeRequestContext(localVarPath, HttpMethod.GET);
    requestContext.setHeaderParam("Accept", "application/json");
    requestContext.setHttpConfig(_config.httpConfig);
  ...
  public async listDatasetReportSchedules(datasetId: string,_options?: Configuration): Promise<RequestContext> {
    const _config = _options || this.configuration;
    ...
    // Path Params
    const localVarPath = '/api/v2/reporting/dataset/{dataset_id}/schedules'
      .replace('{dataset_id}', encodeURIComponent(String(datasetId)));

    // Make Request Context
    const requestContext = _config.getServer('v2.ReportSchedulesApi.listDatasetReportSchedules').makeRequestContext(localVarPath, HttpMethod.GET);
    requestContext.setHeaderParam("Accept", "application/json");
    requestContext.setHttpConfig(_config.httpConfig);
  ...
  public async listReportSchedules(pageLimit?: number,pageOffset?: number,filterTitle?: string,filterAuthorUuid?: string,filterRecipients?: string,_options?: Configuration): Promise<RequestContext> {
    const _config = _options || this.configuration;
    ...
    // Make Request Context
    const requestContext = _config.getServer('v2.ReportSchedulesApi.listReportSchedules').makeRequestContext(localVarPath, HttpMethod.GET);
    requestContext.setHeaderParam("Accept", "application/json");
    requestContext.setHttpConfig(_config.httpConfig);
  ...
  if (filterTitle !== undefined) {
      requestContext.setQueryParam("filter[title]", ObjectSerializer.serialize(filterTitle, "string", ""
), "");
    }
  if (filterAuthorUuid !== undefined) {
      requestContext.setQueryParam("filter[author_uuid]", ObjectSerializer.serialize(filterAuthorUuid, "string", "uuid"
), "");
    }
  if (filterRecipients !== undefined) {
      requestContext.setQueryParam("filter[recipients]", ObjectSerializer.serialize(filterRecipients, "string", ""
), "");
    }
  ...
  public async patchReportSchedule(scheduleUuid: string,body: ReportSchedulePatchRequest,_options?: Configuration): Promise<RequestContext> {
    const _config = _options || this.configuration;
    ...
    // Make Request Context
    const requestContext = _config.getServer('v2.ReportSchedulesApi.patchReportSchedule').makeRequestContext(localVarPath, HttpMethod.PATCH);
    requestContext.setHeaderParam("Accept", "application/json");
    requestContext.setHttpConfig(_config.httpConfig);
  ...
  public async printReport(body: PrintReportRequest,_options?: Configuration): Promise<RequestContext> {
    const _config = _options || this.configuration;
    ...
    // Make Request Context
    const requestContext = _config.getServer('v2.ReportSchedulesApi.printReport').makeRequestContext(localVarPath, HttpMethod.POST);
    requestContext.setHeaderParam("Accept", "application/json");
    requestContext.setHttpConfig(_config.httpConfig);
  ...
  public async toggleReportSchedule(scheduleUuid: string,body: ReportScheduleToggleRequest,_options?: Configuration): Promise<RequestContext> {
    const _config = _options || this.configuration;
    ...
    // Path Params
    const localVarPath = '/api/v2/reporting/schedule/{schedule_uuid}/toggle'
      .replace('{schedule_uuid}', encodeURIComponent(String(scheduleUuid)));

    // Make Request Context
    const requestContext = _config.getServer('v2.ReportSchedulesApi.toggleReportSchedule').makeRequestContext(localVarPath, HttpMethod.PATCH);
    requestContext.setHeaderParam("Accept", "application/json");
    requestContext.setHttpConfig(_config.httpConfig);
...
export class ReportSchedulesApiResponseProcessor {
   ...
   */
   public async createReportSchedule(response: ResponseContext): Promise<ReportScheduleResponse> {
   ...
   * @throws ApiException if the response code was not in [200, 299]
   */
   public async deleteReportSchedule(response: ResponseContext): Promise<ReportScheduleResponse> {
    const contentType = ObjectSerializer.normalizeMediaType(response.headers["content-type"]);
   ...
   * @throws ApiException if the response code was not in [200, 299]
   */
   public async getReportSchedule(response: ResponseContext): Promise<ReportScheduleResponse> {
    const contentType = ObjectSerializer.normalizeMediaType(response.headers["content-type"]);
    if (response.httpStatusCode === 200) {
      const body: ReportScheduleResponse = ObjectSerializer.deserialize(
        ObjectSerializer.parse(await response.body.text(), contentType),
   ...
   * @throws ApiException if the response code was not in [200, 299]
   */
   public async getReportSchedulesForResource(response: ResponseContext): Promise<ReportScheduleListResponse> {
    const contentType = ObjectSerializer.normalizeMediaType(response.headers["content-type"]);
    if (response.httpStatusCode === 200) {
   ...
   * @throws ApiException if the response code was not in [200, 299]
   */
   public async listDatasetReportSchedules(response: ResponseContext): Promise<DatasetReportScheduleListResponse> {
    const contentType = ObjectSerializer.normalizeMediaType(response.headers["content-type"]);
    if (response.httpStatusCode === 200) {
      const body: DatasetReportScheduleListResponse = ObjectSerializer.deserialize(
        ObjectSerializer.parse(await response.body.text(), contentType),
   ...
   * @throws ApiException if the response code was not in [200, 299]
   */
   public async listReportSchedules(response: ResponseContext): Promise<ReportScheduleListResponse> {
    const contentType = ObjectSerializer.normalizeMediaType(response.headers["content-type"]);
    if (response.httpStatusCode === 200) {
      const body: ReportScheduleListResponse = ObjectSerializer.deserialize(
        ObjectSerializer.parse(await response.body.text(), contentType),
   ...
   * @throws ApiException if the response code was not in [200, 299]
   */
   public async patchReportSchedule(response: ResponseContext): Promise<ReportScheduleResponse> {
    const contentType = ObjectSerializer.normalizeMediaType(response.headers["content-type"]);
    if (response.httpStatusCode === 200) {
      const body: ReportScheduleResponse = ObjectSerializer.deserialize(
        ObjectSerializer.parse(await response.body.text(), contentType),
   ...
   * @throws ApiException if the response code was not in [200, 299]
   */
   public async printReport(response: ResponseContext): Promise<PrintReportResponse> {
    const contentType = ObjectSerializer.normalizeMediaType(response.headers["content-type"]);
    if (response.httpStatusCode === 200) {
   ...
   * @throws ApiException if the response code was not in [200, 299]
   */
   public async toggleReportSchedule(response: ResponseContext): Promise<ReportScheduleResponse> {
    const contentType = ObjectSerializer.normalizeMediaType(response.headers["content-type"]);
    if (response.httpStatusCode === 200) {
      const body: ReportScheduleResponse = ObjectSerializer.deserialize(
        ObjectSerializer.parse(await response.body.text(), contentType),
...
export class ReportSchedulesApi {
  ...
  public constructor(configuration: Configuration, requestFactory?: ReportSchedulesApiRequestFactory, responseProcessor?: ReportSchedulesApiResponseProcessor) {
    this.configuration = configuration;
    this.requestFactory = requestFactory || new ReportSchedulesApiRequestFactory(configuration);
    this.responseProcessor = responseProcessor || new ReportSchedulesApiResponseProcessor();
  }
   ...
   */
  public createReportSchedule(param: ReportSchedulesApiCreateReportScheduleRequest, options?: Configuration): Promise<ReportScheduleResponse> {
   ...
   * @param param The request object
   */
  public deleteReportSchedule(param: ReportSchedulesApiDeleteReportScheduleRequest, options?: Configuration): Promise<ReportScheduleResponse> {
   ...
   * @param param The request object
   */
  public getReportSchedule(param: ReportSchedulesApiGetReportScheduleRequest, options?: Configuration): Promise<ReportScheduleResponse> {
   ...
   * @param param The request object
   */
  public getReportSchedulesForResource(param: ReportSchedulesApiGetReportSchedulesForResourceRequest, options?: Configuration): Promise<ReportScheduleListResponse> {
   ...
   * @param param The request object
   */
  public listDatasetReportSchedules(param: ReportSchedulesApiListDatasetReportSchedulesRequest, options?: Configuration): Promise<DatasetReportScheduleListResponse> {
   ...
   * @param param The request object
   */
  public listReportSchedules(param: ReportSchedulesApiListReportSchedulesRequest = {}, options?: Configuration): Promise<ReportScheduleListResponse> {
   ...
   * @param param The request object
   */
  public patchReportSchedule(param: ReportSchedulesApiPatchReportScheduleRequest, options?: Configuration): Promise<ReportScheduleResponse> {
   ...
   * @param param The request object
   */
  public printReport(param: ReportSchedulesApiPrintReportRequest, options?: Configuration): Promise<PrintReportResponse> {
   ...
   * @param param The request object
   */
  public toggleReportSchedule(param: ReportSchedulesApiToggleReportScheduleRequest, options?: Configuration): Promise<ReportScheduleResponse> {
