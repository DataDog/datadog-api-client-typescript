...
export class DashboardSecureEmbedApiRequestFactory extends BaseAPIRequestFactory {
  ...
  public async createDashboardSecureEmbed(dashboardId: string,body: SecureEmbedCreateRequest,_options?: Configuration): Promise<RequestContext> {
    ...
    // Path Params
    const localVarPath = '/api/v2/dashboard/{dashboard_id}/shared/secure-embed'
      .replace('{dashboard_id}', encodeURIComponent(String(dashboardId)));

    // Make Request Context
    const requestContext = _config.getServer('v2.DashboardSecureEmbedApi.createDashboardSecureEmbed').makeRequestContext(localVarPath, HttpMethod.POST);
  ...
  public async deleteDashboardSecureEmbed(dashboardId: string,token: string,_options?: Configuration): Promise<RequestContext> {
    const _config = _options || this.configuration;
    ...
    // Make Request Context
    const requestContext = _config.getServer('v2.DashboardSecureEmbedApi.deleteDashboardSecureEmbed').makeRequestContext(localVarPath, HttpMethod.DELETE);
  ...
  public async getDashboardSecureEmbed(dashboardId: string,token: string,_options?: Configuration): Promise<RequestContext> {
    const _config = _options || this.configuration;
    ...
    // Make Request Context
    const requestContext = _config.getServer('v2.DashboardSecureEmbedApi.getDashboardSecureEmbed').makeRequestContext(localVarPath, HttpMethod.GET);
    requestContext.setHeaderParam("Accept", "application/json");
    requestContext.setHttpConfig(_config.httpConfig);
  ...
  public async updateDashboardSecureEmbed(dashboardId: string,token: string,body: SecureEmbedUpdateRequest,_options?: Configuration): Promise<RequestContext> {
    const _config = _options || this.configuration;
    ...
    // Make Request Context
    const requestContext = _config.getServer('v2.DashboardSecureEmbedApi.updateDashboardSecureEmbed').makeRequestContext(localVarPath, HttpMethod.PATCH);
    requestContext.setHeaderParam("Accept", "application/json");
    requestContext.setHttpConfig(_config.httpConfig);
...
export class DashboardSecureEmbedApiResponseProcessor {
   ...
   */
   public async createDashboardSecureEmbed(response: ResponseContext): Promise<SecureEmbedCreateResponse> {
    ...
    if (response.httpStatusCode === 403||response.httpStatusCode === 404||response.httpStatusCode === 409) {
   ...
   * @throws ApiException if the response code was not in [200, 299]
   */
   public async deleteDashboardSecureEmbed(response: ResponseContext): Promise<void> {
    const contentType = ObjectSerializer.normalizeMediaType(response.headers["content-type"]);
   ...
   * @throws ApiException if the response code was not in [200, 299]
   */
   public async getDashboardSecureEmbed(response: ResponseContext): Promise<SecureEmbedGetResponse> {
    const contentType = ObjectSerializer.normalizeMediaType(response.headers["content-type"]);
    if (response.httpStatusCode === 200) {
   ...
   * @throws ApiException if the response code was not in [200, 299]
   */
   public async updateDashboardSecureEmbed(response: ResponseContext): Promise<SecureEmbedUpdateResponse> {
    const contentType = ObjectSerializer.normalizeMediaType(response.headers["content-type"]);
    if (response.httpStatusCode === 200) {
...
export class DashboardSecureEmbedApi {
  ...
  public constructor(configuration: Configuration, requestFactory?: DashboardSecureEmbedApiRequestFactory, responseProcessor?: DashboardSecureEmbedApiResponseProcessor) {
    this.configuration = configuration;
    this.requestFactory = requestFactory || new DashboardSecureEmbedApiRequestFactory(configuration);
    this.responseProcessor = responseProcessor || new DashboardSecureEmbedApiResponseProcessor();
  }
   ...
   */
  public createDashboardSecureEmbed(param: DashboardSecureEmbedApiCreateDashboardSecureEmbedRequest, options?: Configuration): Promise<SecureEmbedCreateResponse> {
   ...
   * @param param The request object
   */
  public deleteDashboardSecureEmbed(param: DashboardSecureEmbedApiDeleteDashboardSecureEmbedRequest, options?: Configuration): Promise<void> {
   ...
   * @param param The request object
   */
  public getDashboardSecureEmbed(param: DashboardSecureEmbedApiGetDashboardSecureEmbedRequest, options?: Configuration): Promise<SecureEmbedGetResponse> {
   ...
   * @param param The request object
   */
  public updateDashboardSecureEmbed(param: DashboardSecureEmbedApiUpdateDashboardSecureEmbedRequest, options?: Configuration): Promise<SecureEmbedUpdateResponse> {
