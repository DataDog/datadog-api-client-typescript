...
export class UsageMeteringApiRequestFactory extends BaseAPIRequestFactory {
  ...
  public async getActiveBillingDimensions(_options?: Configuration): Promise<RequestContext> {
    ...
    const requestContext = _config.getServer('v2.UsageMeteringApi.getActiveBillingDimensions').makeRequestContext(localVarPath, HttpMethod.GET);
  ...
  public async getBillingDimensionMapping(filterMonth?: Date,filterView?: string,_options?: Configuration): Promise<RequestContext> {
    const _config = _options || this.configuration;
    ...
    // Make Request Context
    const requestContext = _config.getServer('v2.UsageMeteringApi.getBillingDimensionMapping').makeRequestContext(localVarPath, HttpMethod.GET);
    requestContext.setHeaderParam("Accept", "application/json;datetime-format=rfc3339");
    requestContext.setHttpConfig(_config.httpConfig);

    // Query Params
  if (filterMonth !== undefined) {
      requestContext.setQueryParam("filter[month]", ObjectSerializer.serialize(filterMonth, "Date", "date-time"
), "");
    }
  if (filterView !== undefined) {
      requestContext.setQueryParam("filter[view]", ObjectSerializer.serialize(filterView, "string", ""
), "");
    }
  ...
  public async getCostByOrg(startMonth: Date,endMonth?: Date,_options?: Configuration): Promise<RequestContext> {
    ...
    // Make Request Context
    const requestContext = _config.getServer('v2.UsageMeteringApi.getCostByOrg').makeRequestContext(localVarPath, HttpMethod.GET);
    requestContext.setHeaderParam("Accept", "application/json;datetime-format=rfc3339");
    requestContext.setHttpConfig(_config.httpConfig);
  ...
  public async getEstimatedCostByOrg(view?: string,startMonth?: Date,endMonth?: Date,startDate?: Date,endDate?: Date,costAggregation?: CostAggregationType,includeConnectedAccounts?: boolean,_options?: Configuration): Promise<RequestContext> {
    const _config = _options || this.configuration;
    ...
    // Make Request Context
    const requestContext = _config.getServer('v2.UsageMeteringApi.getEstimatedCostByOrg').makeRequestContext(localVarPath, HttpMethod.GET);
    requestContext.setHeaderParam("Accept", "application/json;datetime-format=rfc3339");
    requestContext.setHttpConfig(_config.httpConfig);

    // Query Params
  if (view !== undefined) {
      requestContext.setQueryParam("view", ObjectSerializer.serialize(view, "string", ""
), "");
    }
  if (startMonth !== undefined) {
      requestContext.setQueryParam("start_month", ObjectSerializer.serialize(startMonth, "Date", "date-time"
  ...
  if (costAggregation !== undefined) {
      requestContext.setQueryParam("cost_aggregation", ObjectSerializer.serialize(costAggregation, "CostAggregationType", ""
), "");
    }
  ...
  public async getHistoricalCostByOrg(startMonth: Date,view?: string,endMonth?: Date,includeConnectedAccounts?: boolean,_options?: Configuration): Promise<RequestContext> {
    const _config = _options || this.configuration;
    ...
    // Make Request Context
    const requestContext = _config.getServer('v2.UsageMeteringApi.getHistoricalCostByOrg').makeRequestContext(localVarPath, HttpMethod.GET);
    requestContext.setHeaderParam("Accept", "application/json;datetime-format=rfc3339");
    requestContext.setHttpConfig(_config.httpConfig);
  ...
  public async getHourlyUsage(filterTimestampStart: Date,filterProductFamilies: string,filterTimestampEnd?: Date,filterIncludeDescendants?: boolean,filterIncludeConnectedAccounts?: boolean,filterIncludeBreakdown?: boolean,filterVersions?: string,pageLimit?: number,pageNextRecordId?: string,_options?: Configuration): Promise<RequestContext> {
    ...
    // Make Request Context
    const requestContext = _config.getServer('v2.UsageMeteringApi.getHourlyUsage').makeRequestContext(localVarPath, HttpMethod.GET);
    requestContext.setHeaderParam("Accept", "application/json;datetime-format=rfc3339");
    requestContext.setHttpConfig(_config.httpConfig);

    // Query Params
  if (filterTimestampStart !== undefined) {
      requestContext.setQueryParam("filter[timestamp][start]", ObjectSerializer.serialize(filterTimestampStart, "Date", "date-time"
), "");
    }
  if (filterTimestampEnd !== undefined) {
      requestContext.setQueryParam("filter[timestamp][end]", ObjectSerializer.serialize(filterTimestampEnd, "Date", "date-time"
), "");
    }
  if (filterProductFamilies !== undefined) {
      requestContext.setQueryParam("filter[product_families]", ObjectSerializer.serialize(filterProductFamilies, "string", ""
), "");
    }
  if (filterIncludeDescendants !== undefined) {
      requestContext.setQueryParam("filter[include_descendants]", ObjectSerializer.serialize(filterIncludeDescendants, "boolean", ""
), "");
    }
  if (filterIncludeConnectedAccounts !== undefined) {
      requestContext.setQueryParam("filter[include_connected_accounts]", ObjectSerializer.serialize(filterIncludeConnectedAccounts, "boolean", ""
), "");
    }
  if (filterIncludeBreakdown !== undefined) {
      requestContext.setQueryParam("filter[include_breakdown]", ObjectSerializer.serialize(filterIncludeBreakdown, "boolean", ""
), "");
    }
  if (filterVersions !== undefined) {
      requestContext.setQueryParam("filter[versions]", ObjectSerializer.serialize(filterVersions, "string", ""
), "");
    }
  ...
  if (pageNextRecordId !== undefined) {
      requestContext.setQueryParam("page[next_record_id]", ObjectSerializer.serialize(pageNextRecordId, "string", ""
), "");
    }
  ...
  public async getMonthlyCostAttribution(startMonth: Date,fields: string,endMonth?: Date,sortDirection?: SortDirection,sortName?: string,tagBreakdownKeys?: string,nextRecordId?: string,includeDescendants?: boolean,_options?: Configuration): Promise<RequestContext> {
    const _config = _options || this.configuration;
    ...
    // Make Request Context
    const requestContext = _config.getServer('v2.UsageMeteringApi.getMonthlyCostAttribution').makeRequestContext(localVarPath, HttpMethod.GET);
    requestContext.setHeaderParam("Accept", "application/json;datetime-format=rfc3339");
    requestContext.setHttpConfig(_config.httpConfig);
  ...
  if (sortName !== undefined) {
      requestContext.setQueryParam("sort_name", ObjectSerializer.serialize(sortName, "string", ""
), "");
    }
  ...
  public async getProjectedCost(view?: string,includeConnectedAccounts?: boolean,_options?: Configuration): Promise<RequestContext> {
    const _config = _options || this.configuration;
    ...
    // Make Request Context
    const requestContext = _config.getServer('v2.UsageMeteringApi.getProjectedCost').makeRequestContext(localVarPath, HttpMethod.GET);
    requestContext.setHeaderParam("Accept", "application/json;datetime-format=rfc3339");
    requestContext.setHttpConfig(_config.httpConfig);
  ...
  public async getUsageApplicationSecurityMonitoring(startHr: Date,endHr?: Date,_options?: Configuration): Promise<RequestContext> {
    ...
    // Make Request Context
    const requestContext = _config.getServer('v2.UsageMeteringApi.getUsageApplicationSecurityMonitoring').makeRequestContext(localVarPath, HttpMethod.GET);
    requestContext.setHeaderParam("Accept", "application/json;datetime-format=rfc3339");
    requestContext.setHttpConfig(_config.httpConfig);
  ...
  public async getUsageAttributionTypes(_options?: Configuration): Promise<RequestContext> {
    const _config = _options || this.configuration;
    ...
    // Make Request Context
    const requestContext = _config.getServer('v2.UsageMeteringApi.getUsageAttributionTypes').makeRequestContext(localVarPath, HttpMethod.GET);
    requestContext.setHeaderParam("Accept", "application/json;datetime-format=rfc3339");
    requestContext.setHttpConfig(_config.httpConfig);
  ...
  public async getUsageLambdaTracedInvocations(startHr: Date,endHr?: Date,_options?: Configuration): Promise<RequestContext> {
    const _config = _options || this.configuration;
    ...
    // Make Request Context
    const requestContext = _config.getServer('v2.UsageMeteringApi.getUsageLambdaTracedInvocations').makeRequestContext(localVarPath, HttpMethod.GET);
    requestContext.setHeaderParam("Accept", "application/json;datetime-format=rfc3339");
    requestContext.setHttpConfig(_config.httpConfig);
  ...
  public async getUsageObservabilityPipelines(startHr: Date,endHr?: Date,_options?: Configuration): Promise<RequestContext> {
    ...
    // Make Request Context
    const requestContext = _config.getServer('v2.UsageMeteringApi.getUsageObservabilityPipelines').makeRequestContext(localVarPath, HttpMethod.GET);
    requestContext.setHeaderParam("Accept", "application/json;datetime-format=rfc3339");
    requestContext.setHttpConfig(_config.httpConfig);
  ...
  public async getUsageSummaryAvailableFields(_options?: Configuration): Promise<RequestContext> {
    const _config = _options || this.configuration;
    ...
    // Make Request Context
    const requestContext = _config.getServer('v2.UsageMeteringApi.getUsageSummaryAvailableFields').makeRequestContext(localVarPath, HttpMethod.GET);
    requestContext.setHeaderParam("Accept", "application/json;datetime-format=rfc3339");
    requestContext.setHttpConfig(_config.httpConfig);
...
export class UsageMeteringApiResponseProcessor {
   ...
   */
   public async getActiveBillingDimensions(response: ResponseContext): Promise<ActiveBillingDimensionsResponse> {
   ...
   * @throws ApiException if the response code was not in [200, 299]
   */
   public async getBillingDimensionMapping(response: ResponseContext): Promise<BillingDimensionsMappingResponse> {
    const contentType = ObjectSerializer.normalizeMediaType(response.headers["content-type"]);
    if (response.httpStatusCode === 200) {
   ...
   * @throws ApiException if the response code was not in [200, 299]
   */
   public async getEstimatedCostByOrg(response: ResponseContext): Promise<CostByOrgResponse> {
    const contentType = ObjectSerializer.normalizeMediaType(response.headers["content-type"]);
    if (response.httpStatusCode === 200) {
      const body: CostByOrgResponse = ObjectSerializer.deserialize(
        ObjectSerializer.parse(await response.body.text(), contentType),
   ...
   * @throws ApiException if the response code was not in [200, 299]
   */
   public async getHistoricalCostByOrg(response: ResponseContext): Promise<CostByOrgResponse> {
    const contentType = ObjectSerializer.normalizeMediaType(response.headers["content-type"]);
    if (response.httpStatusCode === 200) {
      const body: CostByOrgResponse = ObjectSerializer.deserialize(
        ObjectSerializer.parse(await response.body.text(), contentType),
   ...
   * @throws ApiException if the response code was not in [200, 299]
   */
   public async getHourlyUsage(response: ResponseContext): Promise<HourlyUsageResponse> {
    const contentType = ObjectSerializer.normalizeMediaType(response.headers["content-type"]);
    if (response.httpStatusCode === 200) {
   ...
   * @throws ApiException if the response code was not in [200, 299]
   */
   public async getMonthlyCostAttribution(response: ResponseContext): Promise<MonthlyCostAttributionResponse> {
    const contentType = ObjectSerializer.normalizeMediaType(response.headers["content-type"]);
    if (response.httpStatusCode === 200) {
   ...
   * @throws ApiException if the response code was not in [200, 299]
   */
   public async getProjectedCost(response: ResponseContext): Promise<ProjectedCostResponse> {
    const contentType = ObjectSerializer.normalizeMediaType(response.headers["content-type"]);
    if (response.httpStatusCode === 200) {
   ...
   * @throws ApiException if the response code was not in [200, 299]
   */
   public async getUsageAttributionTypes(response: ResponseContext): Promise<UsageAttributionTypesResponse> {
    const contentType = ObjectSerializer.normalizeMediaType(response.headers["content-type"]);
    if (response.httpStatusCode === 200) {
      const body: UsageAttributionTypesResponse = ObjectSerializer.deserialize(
        ObjectSerializer.parse(await response.body.text(), contentType),
   ...
   * @throws ApiException if the response code was not in [200, 299]
   */
   public async getUsageLambdaTracedInvocations(response: ResponseContext): Promise<UsageLambdaTracedInvocationsResponse> {
    const contentType = ObjectSerializer.normalizeMediaType(response.headers["content-type"]);
    if (response.httpStatusCode === 200) {
   ...
   * @throws ApiException if the response code was not in [200, 299]
   */
   public async getUsageSummaryAvailableFields(response: ResponseContext): Promise<UsageSummaryAvailableFieldsResponse> {
    const contentType = ObjectSerializer.normalizeMediaType(response.headers["content-type"]);
    if (response.httpStatusCode === 200) {
      const body: UsageSummaryAvailableFieldsResponse = ObjectSerializer.deserialize(
        ObjectSerializer.parse(await response.body.text(), contentType),
...
export class UsageMeteringApi {
   ...
   */
  public getActiveBillingDimensions( options?: Configuration): Promise<ActiveBillingDimensionsResponse> {
   ...
   * @param param The request object
   */
  public getBillingDimensionMapping(param: UsageMeteringApiGetBillingDimensionMappingRequest = {}, options?: Configuration): Promise<BillingDimensionsMappingResponse> {
   ...
   * @param param The request object
   */
  public getEstimatedCostByOrg(param: UsageMeteringApiGetEstimatedCostByOrgRequest = {}, options?: Configuration): Promise<CostByOrgResponse> {
    const requestContextPromise = this.requestFactory.getEstimatedCostByOrg(param.view,param.startMonth,param.endMonth,param.startDate,param.endDate,param.costAggregation,param.includeConnectedAccounts,options);
    return requestContextPromise.then(requestContext => {
        return this.configuration.httpApi.send(requestContext).then(responseContext => {
   ...
   * @param param The request object
   */
  public getHistoricalCostByOrg(param: UsageMeteringApiGetHistoricalCostByOrgRequest, options?: Configuration): Promise<CostByOrgResponse> {
   ...
   * @param param The request object
   */
  public getHourlyUsage(param: UsageMeteringApiGetHourlyUsageRequest, options?: Configuration): Promise<HourlyUsageResponse> {
   ...
   * @param param The request object
   */
  public getMonthlyCostAttribution(param: UsageMeteringApiGetMonthlyCostAttributionRequest, options?: Configuration): Promise<MonthlyCostAttributionResponse> {
   ...
   * @param param The request object
   */
  public getProjectedCost(param: UsageMeteringApiGetProjectedCostRequest = {}, options?: Configuration): Promise<ProjectedCostResponse> {
   ...
   * @param param The request object
   */
  public getUsageAttributionTypes( options?: Configuration): Promise<UsageAttributionTypesResponse> {
    const requestContextPromise = this.requestFactory.getUsageAttributionTypes(options);
    return requestContextPromise.then(requestContext => {
        return this.configuration.httpApi.send(requestContext).then(responseContext => {
            return this.responseProcessor.getUsageAttributionTypes(responseContext);
        });
    });
  }
   ...
   * @param param The request object
   */
  public getUsageLambdaTracedInvocations(param: UsageMeteringApiGetUsageLambdaTracedInvocationsRequest, options?: Configuration): Promise<UsageLambdaTracedInvocationsResponse> {
   ...
   * @param param The request object
   */
  public getUsageSummaryAvailableFields( options?: Configuration): Promise<UsageSummaryAvailableFieldsResponse> {
    const requestContextPromise = this.requestFactory.getUsageSummaryAvailableFields(options);
    return requestContextPromise.then(requestContext => {
        return this.configuration.httpApi.send(requestContext).then(responseContext => {
            return this.responseProcessor.getUsageSummaryAvailableFields(responseContext);
        });
    });
  }
}