...
export class RumRateLimitApiRequestFactory extends BaseAPIRequestFactory {
  public async deleteRumRateLimitConfig(
    ...
    if (!_config.unstableOperations["v2.deleteRumRateLimitConfig"]) {
      throw new Error(
        "Unstable operation 'deleteRumRateLimitConfig' is disabled"
      );
    }
    ...
    const requestContext = _config
      .getServer("v2.RumRateLimitApi.deleteRumRateLimitConfig")
  ...
  public async getRumRateLimitConfig(
    ...
    // Make Request Context
    const requestContext = _config
      .getServer("v2.RumRateLimitApi.getRumRateLimitConfig")
  ...
  public async updateRumRateLimitConfig(
    ...
    if (!_config.unstableOperations["v2.updateRumRateLimitConfig"]) {
      throw new Error(
        "Unstable operation 'updateRumRateLimitConfig' is disabled"
      );
    }
    ...
    // Make Request Context
    const requestContext = _config
      .getServer("v2.RumRateLimitApi.updateRumRateLimitConfig")
...
export class RumRateLimitApi {
  ...
  public constructor(
    ...
    this.requestFactory =
      requestFactory || new RumRateLimitApiRequestFactory(configuration);
