...
export class OAuth2ClientPublicApiRequestFactory extends BaseAPIRequestFactory {
  ...
  public async deleteScopesRestriction(clientUuid: string,_options?: Configuration): Promise<RequestContext> {
    ...
    if (!_config.unstableOperations['v2.deleteScopesRestriction']) {
      throw new Error("Unstable operation 'deleteScopesRestriction' is disabled");
    }
    ...
    // Path Params
    const localVarPath = '/api/v2/oauth2/clients/{client_uuid}/scopes_restriction'
      .replace('{client_uuid}', encodeURIComponent(String(clientUuid)));

    // Make Request Context
    const requestContext = _config.getServer('v2.OAuth2ClientPublicApi.deleteScopesRestriction').makeRequestContext(localVarPath, HttpMethod.DELETE);
  ...
  public async getOAuth2WellKnownSites(_options?: Configuration): Promise<RequestContext> {
    const _config = _options || this.configuration;

    logger.warn("Using unstable operation 'getOAuth2WellKnownSites'");
    if (!_config.unstableOperations['v2.getOAuth2WellKnownSites']) {
      throw new Error("Unstable operation 'getOAuth2WellKnownSites' is disabled");
    }
    ...
    // Make Request Context
    const requestContext = _config.getServer('v2.OAuth2ClientPublicApi.getOAuth2WellKnownSites').makeRequestContext(localVarPath, HttpMethod.GET);
  ...
  public async getScopesRestriction(clientUuid: string,_options?: Configuration): Promise<RequestContext> {
    const _config = _options || this.configuration;
    ...
    // Make Request Context
    const requestContext = _config.getServer('v2.OAuth2ClientPublicApi.getScopesRestriction').makeRequestContext(localVarPath, HttpMethod.GET);
    requestContext.setHeaderParam("Accept", "application/json");
    requestContext.setHttpConfig(_config.httpConfig);
  ...
  public async registerOAuthClient(body: OAuthClientRegistrationRequest,_options?: Configuration): Promise<RequestContext> {
    const _config = _options || this.configuration;
    ...
    // Make Request Context
    const requestContext = _config.getServer('v2.OAuth2ClientPublicApi.registerOAuthClient').makeRequestContext(localVarPath, HttpMethod.POST);
    requestContext.setHeaderParam("Accept", "application/json");
    requestContext.setHttpConfig(_config.httpConfig);
  ...
  public async upsertScopesRestriction(clientUuid: string,body: UpsertOAuthScopesRestrictionRequest,_options?: Configuration): Promise<RequestContext> {
    const _config = _options || this.configuration;

    logger.warn("Using unstable operation 'upsertScopesRestriction'");
    if (!_config.unstableOperations['v2.upsertScopesRestriction']) {
      throw new Error("Unstable operation 'upsertScopesRestriction' is disabled");
    }
    ...
    // Make Request Context
    const requestContext = _config.getServer('v2.OAuth2ClientPublicApi.upsertScopesRestriction').makeRequestContext(localVarPath, HttpMethod.POST);
    requestContext.setHeaderParam("Accept", "application/json");
    requestContext.setHttpConfig(_config.httpConfig);
    ...
    requestContext.setHeaderParam("Content-Type", contentType);
    const serializedBody = ObjectSerializer.stringify(
      ObjectSerializer.serialize(body, "UpsertOAuthScopesRestrictionRequest", ""),
      contentType
    );
    requestContext.setBody(serializedBody);
...
export class OAuth2ClientPublicApiResponseProcessor {
   ...
   */
   public async deleteScopesRestriction(response: ResponseContext): Promise<void> {
   ...
   * @throws ApiException if the response code was not in [200, 299]
   */
   public async getOAuth2WellKnownSites(response: ResponseContext): Promise<OAuth2WellKnownSitesResponse> {
    const contentType = ObjectSerializer.normalizeMediaType(response.headers["content-type"]);
   ...
   * @throws ApiException if the response code was not in [200, 299]
   */
   public async getScopesRestriction(response: ResponseContext): Promise<OAuthScopesRestrictionResponse> {
    const contentType = ObjectSerializer.normalizeMediaType(response.headers["content-type"]);
    if (response.httpStatusCode === 200) {
   ...
   * @throws ApiException if the response code was not in [200, 299]
   */
   public async registerOAuthClient(response: ResponseContext): Promise<OAuthClientRegistrationResponse> {
    const contentType = ObjectSerializer.normalizeMediaType(response.headers["content-type"]);
    if (response.httpStatusCode === 201) {
      const body: OAuthClientRegistrationResponse = ObjectSerializer.deserialize(
        ObjectSerializer.parse(await response.body.text(), contentType),
    ...
    if (response.httpStatusCode === 400) {
      ...
      try {
        ...
        logger.debug(`Got error deserializing error: ${error}`);
        throw new ApiException<OAuthClientRegistrationError>(response.httpStatusCode, bodyText);
      } 
      throw new ApiException<OAuthClientRegistrationError>(response.httpStatusCode, body);
    }
    if (response.httpStatusCode === 429) {
      const bodyText = ObjectSerializer.parse(await response.body.text(), contentType);
      let body: APIErrorResponse;
   ...
   * @throws ApiException if the response code was not in [200, 299]
   */
   public async upsertScopesRestriction(response: ResponseContext): Promise<OAuthScopesRestrictionResponse> {
    const contentType = ObjectSerializer.normalizeMediaType(response.headers["content-type"]);
    if (response.httpStatusCode === 200) {
      const body: OAuthScopesRestrictionResponse = ObjectSerializer.deserialize(
        ObjectSerializer.parse(await response.body.text(), contentType),
...
export class OAuth2ClientPublicApi {
  ...
  public constructor(configuration: Configuration, requestFactory?: OAuth2ClientPublicApiRequestFactory, responseProcessor?: OAuth2ClientPublicApiResponseProcessor) {
    this.configuration = configuration;
    this.requestFactory = requestFactory || new OAuth2ClientPublicApiRequestFactory(configuration);
    this.responseProcessor = responseProcessor || new OAuth2ClientPublicApiResponseProcessor();
  }
   ...
   */
  public deleteScopesRestriction(param: OAuth2ClientPublicApiDeleteScopesRestrictionRequest, options?: Configuration): Promise<void> {
    const requestContextPromise = this.requestFactory.deleteScopesRestriction(param.clientUuid,options);
   ...
   * @param param The request object
   */
  public getOAuth2WellKnownSites( options?: Configuration): Promise<OAuth2WellKnownSitesResponse> {
    const requestContextPromise = this.requestFactory.getOAuth2WellKnownSites(options);
    return requestContextPromise.then(requestContext => {
        return this.configuration.httpApi.send(requestContext).then(responseContext => {
   ...
   * @param param The request object
   */
  public getScopesRestriction(param: OAuth2ClientPublicApiGetScopesRestrictionRequest, options?: Configuration): Promise<OAuthScopesRestrictionResponse> {
    const requestContextPromise = this.requestFactory.getScopesRestriction(param.clientUuid,options);
    return requestContextPromise.then(requestContext => {
        return this.configuration.httpApi.send(requestContext).then(responseContext => {
   ...
   * @param param The request object
   */
  public registerOAuthClient(param: OAuth2ClientPublicApiRegisterOAuthClientRequest, options?: Configuration): Promise<OAuthClientRegistrationResponse> {
    const requestContextPromise = this.requestFactory.registerOAuthClient(param.body,options);
    return requestContextPromise.then(requestContext => {
        return this.configuration.httpApi.send(requestContext).then(responseContext => {
   ...
   * @param param The request object
   */
  public upsertScopesRestriction(param: OAuth2ClientPublicApiUpsertScopesRestrictionRequest, options?: Configuration): Promise<OAuthScopesRestrictionResponse> {
    const requestContextPromise = this.requestFactory.upsertScopesRestriction(param.clientUuid,param.body,options);
    return requestContextPromise.then(requestContext => {
        return this.configuration.httpApi.send(requestContext).then(responseContext => {
