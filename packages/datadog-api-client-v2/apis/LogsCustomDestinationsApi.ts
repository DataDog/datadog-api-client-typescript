...
import { CustomDestinationCreatePayload } from "../models/CustomDestinationCreatePayload";
...
import { CustomDestinationUpdatePayload } from "../models/CustomDestinationUpdatePayload";
...
export class LogsCustomDestinationsApiRequestFactory extends BaseAPIRequestFactory {
  public async createLogsCustomDestination(
    ...
    const serializedBody = ObjectSerializer.stringify(
      ObjectSerializer.serialize(body, "CustomDestinationCreatePayload", ""),
      contentType
    );
  ...
  public async updateLogsCustomDestination(
    ...
    requestContext.setHeaderParam("Content-Type", contentType);
    const serializedBody = ObjectSerializer.stringify(
      ObjectSerializer.serialize(body, "CustomDestinationUpdatePayload", ""),
      contentType
    );
    requestContext.setBody(serializedBody);
