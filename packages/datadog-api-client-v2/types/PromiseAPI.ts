...
export class PromiseDashboardListsApi {
     ...
     */
    public createDashboardListItems(dashboardListId: number, body: DashboardListAddItemsRequest, _options?: Configuration): Promise<DashboardListAddItemsResponse> {
        const result = this.api.createDashboardListItems(dashboardListId, body, _options);
     ...
     */
    public deleteDashboardListItems(dashboardListId: number, body: DashboardListDeleteItemsRequest, _options?: Configuration): Promise<DashboardListDeleteItemsResponse> {
        const result = this.api.deleteDashboardListItems(dashboardListId, body, _options);
        return result.toPromise();
    }
     ...
     */
    public getDashboardListItems(dashboardListId: number, _options?: Configuration): Promise<DashboardListItems> {
     ...
     */
    public updateDashboardListItems(dashboardListId: number, body: DashboardListUpdateItemsRequest, _options?: Configuration): Promise<DashboardListUpdateItemsResponse> {
        const result = this.api.updateDashboardListItems(dashboardListId, body, _options);
        return result.toPromise();
    }
...
export class PromiseIncidentServicesApi {
     ...
     */
    public createIncidentService(body: IncidentServiceCreateRequest, _options?: Configuration): Promise<IncidentServiceResponse> {
     ...
     */
    public deleteIncidentService(serviceId: string, _options?: Configuration): Promise<void> {
     ...
     */
    public getIncidentService(serviceId: string, include?: IncidentRelatedObject, _options?: Configuration): Promise<IncidentServiceResponse> {
     ...
     */
    public listIncidentServices(include?: IncidentRelatedObject, pageSize?: number, pageOffset?: number, filter?: string, _options?: Configuration): Promise<IncidentServicesResponse> {
        const result = this.api.listIncidentServices(include, pageSize, pageOffset, filter, _options);
        return result.toPromise();
    }
     ...
     * @param body Incident Service Payload.
     */
    public updateIncidentService(serviceId: string, body: IncidentServiceUpdateRequest, _options?: Configuration): Promise<IncidentServiceResponse> {
...
export class PromiseIncidentTeamsApi {
     ...
     */
    public createIncidentTeam(body: IncidentTeamCreateRequest, _options?: Configuration): Promise<IncidentTeamResponse> {
     ...
     */
    public deleteIncidentTeam(teamId: string, _options?: Configuration): Promise<void> {
     ...
     * @param include Specifies which types of related objects should be included in the response.
     */
    public getIncidentTeam(teamId: string, include?: IncidentRelatedObject, _options?: Configuration): Promise<IncidentTeamResponse> {
     ...
     */
    public listIncidentTeams(include?: IncidentRelatedObject, pageSize?: number, pageOffset?: number, filter?: string, _options?: Configuration): Promise<IncidentTeamsResponse> {
        const result = this.api.listIncidentTeams(include, pageSize, pageOffset, filter, _options);
        return result.toPromise();
    }
     ...
     * @param body Incident Team Payload.
     */
    public updateIncidentTeam(teamId: string, body: IncidentTeamUpdateRequest, _options?: Configuration): Promise<IncidentTeamResponse> {
...
export class PromiseIncidentsApi {
     ...
     */
    public createIncident(body: IncidentCreateRequest, _options?: Configuration): Promise<IncidentResponse> {
     ...
     */
    public deleteIncident(incidentId: string, _options?: Configuration): Promise<void> {
     ...
     * @param include Specifies which types of related objects should be included in the response.
     */
    public getIncident(incidentId: string, include?: Array<IncidentRelatedObject>, _options?: Configuration): Promise<IncidentResponse> {
     ...
     * @param pageOffset Specific offset to use as the beginning of the returned page.
     */
    public listIncidents(include?: Array<IncidentRelatedObject>, pageSize?: number, pageOffset?: number, _options?: Configuration): Promise<IncidentsResponse> {
        const result = this.api.listIncidents(include, pageSize, pageOffset, _options);
        return result.toPromise();
    }
     ...
     * @param body Incident Payload.
     */
    public updateIncident(incidentId: string, body: IncidentUpdateRequest, _options?: Configuration): Promise<IncidentResponse> {
...
export class PromiseKeyManagementApi {
     ...
     * @param body 
     */
    public createAPIKey(body: APIKeyCreateRequest, _options?: Configuration): Promise<APIKeyResponse> {
     ...
     * @param body 
     */
    public createCurrentUserApplicationKey(body: ApplicationKeyCreateRequest, _options?: Configuration): Promise<ApplicationKeyResponse> {
     ...
     */
    public deleteAPIKey(apiKeyId: string, _options?: Configuration): Promise<void> {
     ...
     */
    public deleteApplicationKey(appKeyId: string, _options?: Configuration): Promise<void> {
     ...
     * @param appKeyId The ID of the application key.
     */
    public deleteCurrentUserApplicationKey(appKeyId: string, _options?: Configuration): Promise<void> {
     ...
     */
    public getAPIKey(apiKeyId: string, include?: string, _options?: Configuration): Promise<APIKeyResponse> {
     ...
     */
    public getApplicationKey(appKeyId: string, include?: string, _options?: Configuration): Promise<ApplicationKeyResponse> {
     ...
     * @param appKeyId The ID of the application key.
     */
    public getCurrentUserApplicationKey(appKeyId: string, _options?: Configuration): Promise<ApplicationKeyResponse> {
     ...
     * @param include Comma separated list of resource paths for related resources to include in the response. Supported resource paths are &#x60;created_by&#x60; and &#x60;modified_by&#x60;.
     */
    public listAPIKeys(pageSize?: number, pageNumber?: number, sort?: APIKeysSort, filter?: string, filterCreatedAtStart?: string, filterCreatedAtEnd?: string, filterModifiedAtStart?: string, filterModifiedAtEnd?: string, include?: string, _options?: Configuration): Promise<APIKeysResponse> {
        const result = this.api.listAPIKeys(pageSize, pageNumber, sort, filter, filterCreatedAtStart, filterCreatedAtEnd, filterModifiedAtStart, filterModifiedAtEnd, include, _options);
        return result.toPromise();
    }
     ...
     */
    public listApplicationKeys(pageSize?: number, pageNumber?: number, sort?: ApplicationKeysSort, filter?: string, filterCreatedAtStart?: string, filterCreatedAtEnd?: string, _options?: Configuration): Promise<ListApplicationKeysResponse> {
        const result = this.api.listApplicationKeys(pageSize, pageNumber, sort, filter, filterCreatedAtStart, filterCreatedAtEnd, _options);
        return result.toPromise();
    }
     ...
     * @param filterCreatedAtEnd Only include application keys created on or before the specified date.
     */
    public listCurrentUserApplicationKeys(pageSize?: number, pageNumber?: number, sort?: ApplicationKeysSort, filter?: string, filterCreatedAtStart?: string, filterCreatedAtEnd?: string, _options?: Configuration): Promise<ListApplicationKeysResponse> {
        const result = this.api.listCurrentUserApplicationKeys(pageSize, pageNumber, sort, filter, filterCreatedAtStart, filterCreatedAtEnd, _options);
        return result.toPromise();
    }
     ...
     * @param body 
     */
    public updateAPIKey(apiKeyId: string, body: APIKeyUpdateRequest, _options?: Configuration): Promise<APIKeyResponse> {
     ...
     * @param body 
     */
    public updateApplicationKey(appKeyId: string, body: ApplicationKeyUpdateRequest, _options?: Configuration): Promise<ApplicationKeyResponse> {
     ...
     * @param body 
     */
    public updateCurrentUserApplicationKey(appKeyId: string, body: ApplicationKeyUpdateRequest, _options?: Configuration): Promise<ApplicationKeyResponse> {
        const result = this.api.updateCurrentUserApplicationKey(appKeyId, body, _options);
        return result.toPromise();
    }
...
export class PromiseLogsApi {
     ...
     * @param body 
     */
    public aggregateLogs(body: LogsAggregateRequest, _options?: Configuration): Promise<LogsAggregateResponse> {
     ...
     * @param body 
     */
    public listLogs(body?: LogsListRequest, _options?: Configuration): Promise<LogsListResponse> {
     ...
     */
    public listLogsGet(filterQuery?: string, filterIndex?: string, filterFrom?: Date, filterTo?: Date, sort?: LogsSort, pageCursor?: string, pageLimit?: number, _options?: Configuration): Promise<LogsListResponse> {
        const result = this.api.listLogsGet(filterQuery, filterIndex, filterFrom, filterTo, sort, pageCursor, pageLimit, _options);
        return result.toPromise();
    }
     ...
     */
    public submitLog(body: Array<HTTPLogItem>, contentEncoding?: ContentEncoding, ddtags?: string, _options?: Configuration): Promise<any> {
...
export class PromiseLogsArchivesApi {
     ...
     * @param body 
     */
    public addReadRoleToArchive(archiveId: string, body: RelationshipToRole, _options?: Configuration): Promise<void> {
     ...
     */
    public createLogsArchive(body: LogsArchiveCreateRequest, _options?: Configuration): Promise<LogsArchive> {
     ...
     * @param archiveId The ID of the archive.
     */
    public deleteLogsArchive(archiveId: string, _options?: Configuration): Promise<void> {
     ...
     * @param archiveId The ID of the archive.
     */
    public getLogsArchive(archiveId: string, _options?: Configuration): Promise<LogsArchive> {
     ...
     * Get archive order
     */
    public getLogsArchiveOrder(_options?: Configuration): Promise<LogsArchiveOrder> {
     ...
     * @param archiveId The ID of the archive.
     */
    public listArchiveReadRoles(archiveId: string, _options?: Configuration): Promise<RolesResponse> {
     ...
     * @param body 
     */
    public removeRoleFromArchive(archiveId: string, body: RelationshipToRole, _options?: Configuration): Promise<void> {
     ...
     */
    public updateLogsArchive(archiveId: string, body: LogsArchiveCreateRequest, _options?: Configuration): Promise<LogsArchive> {
     ...
     */
    public updateLogsArchiveOrder(body: LogsArchiveOrder, _options?: Configuration): Promise<LogsArchiveOrder> {
...
export class PromiseLogsMetricsApi {
     ...
     */
    public createLogsMetric(body: LogsMetricCreateRequest, _options?: Configuration): Promise<LogsMetricResponse> {
     ...
     */
    public deleteLogsMetric(metricId: string, _options?: Configuration): Promise<void> {
     ...
     * @param metricId The name of the log-based metric.
     */
    public getLogsMetric(metricId: string, _options?: Configuration): Promise<LogsMetricResponse> {
     ...
     */
    public listLogsMetrics(_options?: Configuration): Promise<LogsMetricsResponse> {
     ...
     */
    public updateLogsMetric(metricId: string, body: LogsMetricUpdateRequest, _options?: Configuration): Promise<LogsMetricResponse> {
...
export class PromiseMetricsApi {
     ...
     * @param body 
     */
    public createTagConfiguration(metricName: string, body: MetricTagConfigurationCreateRequest, _options?: Configuration): Promise<MetricTagConfigurationResponse> {
     ...
     * @param metricName The name of the metric.
     */
    public deleteTagConfiguration(metricName: string, _options?: Configuration): Promise<void> {
     ...
     * @param metricName The name of the metric.
     */
    public listTagConfigurationByName(metricName: string, _options?: Configuration): Promise<MetricTagConfigurationResponse> {
     ...
     */
    public listTagConfigurations(filterConfigured?: boolean, filterTagsConfigured?: string, filterMetricType?: MetricTagConfigurationMetricTypes, filterIncludePercentiles?: boolean, filterTags?: string, windowSeconds?: number, _options?: Configuration): Promise<MetricsAndMetricTagConfigurationsResponse> {
        const result = this.api.listTagConfigurations(filterConfigured, filterTagsConfigured, filterMetricType, filterIncludePercentiles, filterTags, windowSeconds, _options);
        return result.toPromise();
    }
     ...
     * @param metricName The name of the metric.
     */
    public listTagsByMetricName(metricName: string, _options?: Configuration): Promise<MetricAllTagsResponse> {
     ...
     * @param metricName The name of the metric.
     */
    public listVolumesByMetricName(metricName: string, _options?: Configuration): Promise<MetricVolumesResponse> {
     ...
     * @param body 
     */
    public updateTagConfiguration(metricName: string, body: MetricTagConfigurationUpdateRequest, _options?: Configuration): Promise<MetricTagConfigurationResponse> {
...
export class PromiseProcessesApi {
     ...
     */
    public listProcesses(search?: string, tags?: string, from?: number, to?: number, pageLimit?: number, pageCursor?: string, _options?: Configuration): Promise<ProcessSummariesResponse> {
        const result = this.api.listProcesses(search, tags, from, to, pageLimit, pageCursor, _options);
        return result.toPromise();
    }
...
export class PromiseRolesApi {
     ...
     * @param body 
     */
    public addPermissionToRole(roleId: string, body: RelationshipToPermission, _options?: Configuration): Promise<PermissionsResponse> {
     ...
     * @param body 
     */
    public addUserToRole(roleId: string, body: RelationshipToUser, _options?: Configuration): Promise<UsersResponse> {
     ...
     * @param body 
     */
    public cloneRole(roleId: string, body: RoleCloneRequest, _options?: Configuration): Promise<RoleResponse> {
     ...
     * @param body 
     */
    public createRole(body: RoleCreateRequest, _options?: Configuration): Promise<RoleCreateResponse> {
     ...
     * @param roleId The ID of the role.
     */
    public getRole(roleId: string, _options?: Configuration): Promise<RoleResponse> {
     ...
     * List permissions
     */
    public listPermissions(_options?: Configuration): Promise<PermissionsResponse> {
     ...
     * @param roleId The ID of the role.
     */
    public listRolePermissions(roleId: string, _options?: Configuration): Promise<PermissionsResponse> {
     ...
     */
    public listRoleUsers(roleId: string, pageSize?: number, pageNumber?: number, sort?: string, filter?: string, _options?: Configuration): Promise<UsersResponse> {
        const result = this.api.listRoleUsers(roleId, pageSize, pageNumber, sort, filter, _options);
        return result.toPromise();
    }
     ...
     */
    public listRoles(pageSize?: number, pageNumber?: number, sort?: RolesSort, filter?: string, _options?: Configuration): Promise<RolesResponse> {
        const result = this.api.listRoles(pageSize, pageNumber, sort, filter, _options);
        return result.toPromise();
    }
     ...
     * @param body 
     */
    public removePermissionFromRole(roleId: string, body: RelationshipToPermission, _options?: Configuration): Promise<PermissionsResponse> {
     ...
     * @param body 
     */
    public removeUserFromRole(roleId: string, body: RelationshipToUser, _options?: Configuration): Promise<UsersResponse> {
     ...
     * @param body 
     */
    public updateRole(roleId: string, body: RoleUpdateRequest, _options?: Configuration): Promise<RoleUpdateResponse> {
...
export class PromiseSecurityMonitoringApi {
     ...
     */
    public createSecurityFilter(body: SecurityFilterCreateRequest, _options?: Configuration): Promise<SecurityFilterResponse> {
     ...
     * @param body 
     */
    public createSecurityMonitoringRule(body: SecurityMonitoringRuleCreatePayload, _options?: Configuration): Promise<SecurityMonitoringRuleResponse> {
     ...
     */
    public deleteSecurityFilter(securityFilterId: string, _options?: Configuration): Promise<void> {
     ...
     */
    public deleteSecurityMonitoringRule(ruleId: string, _options?: Configuration): Promise<void> {
     ...
     * @param securityFilterId The ID of the security filter.
     */
    public getSecurityFilter(securityFilterId: string, _options?: Configuration): Promise<SecurityFilterResponse> {
     ...
     * @param ruleId The ID of the rule.
     */
    public getSecurityMonitoringRule(ruleId: string, _options?: Configuration): Promise<SecurityMonitoringRuleResponse> {
     ...
     */
    public listSecurityFilters(_options?: Configuration): Promise<SecurityFiltersResponse> {
     ...
     * @param pageNumber Specific page number to return.
     */
    public listSecurityMonitoringRules(pageSize?: number, pageNumber?: number, _options?: Configuration): Promise<SecurityMonitoringListRulesResponse> {
        const result = this.api.listSecurityMonitoringRules(pageSize, pageNumber, _options);
        return result.toPromise();
    }
     ...
     */
    public listSecurityMonitoringSignals(filterQuery?: string, filterFrom?: Date, filterTo?: Date, sort?: SecurityMonitoringSignalsSort, pageCursor?: string, pageLimit?: number, _options?: Configuration): Promise<SecurityMonitoringSignalsListResponse> {
        const result = this.api.listSecurityMonitoringSignals(filterQuery, filterFrom, filterTo, sort, pageCursor, pageLimit, _options);
        return result.toPromise();
    }
     ...
     * @param body 
     */
    public searchSecurityMonitoringSignals(body?: SecurityMonitoringSignalListRequest, _options?: Configuration): Promise<SecurityMonitoringSignalsListResponse> {
     ...
     */
    public updateSecurityFilter(securityFilterId: string, body: SecurityFilterUpdateRequest, _options?: Configuration): Promise<SecurityFilterResponse> {
        const result = this.api.updateSecurityFilter(securityFilterId, body, _options);
        return result.toPromise();
    }
     ...
     * @param body 
     */
    public updateSecurityMonitoringRule(ruleId: string, body: SecurityMonitoringRuleUpdatePayload, _options?: Configuration): Promise<SecurityMonitoringRuleResponse> {
        const result = this.api.updateSecurityMonitoringRule(ruleId, body, _options);
        return result.toPromise();
    }
...
export class PromiseServiceAccountsApi {
    ...
    public constructor(
        ...
        this.api = new ObservableServiceAccountsApi(configuration, requestFactory, responseProcessor);
    }
     ...
     * @param body 
     */
    public createServiceAccountApplicationKey(serviceAccountId: string, body: ApplicationKeyCreateRequest, _options?: Configuration): Promise<ApplicationKeyResponse> {
        const result = this.api.createServiceAccountApplicationKey(serviceAccountId, body, _options);
        return result.toPromise();
    }
     ...
     * @param appKeyId The ID of the application key.
     */
    public deleteServiceAccountApplicationKey(serviceAccountId: string, appKeyId: string, _options?: Configuration): Promise<void> {
        const result = this.api.deleteServiceAccountApplicationKey(serviceAccountId, appKeyId, _options);
        return result.toPromise();
    }
     ...
     * @param appKeyId The ID of the application key.
     */
    public getServiceAccountApplicationKey(serviceAccountId: string, appKeyId: string, _options?: Configuration): Promise<PartialApplicationKeyResponse> {
        const result = this.api.getServiceAccountApplicationKey(serviceAccountId, appKeyId, _options);
        return result.toPromise();
    }
     ...
     * @param filterCreatedAtEnd Only include application keys created on or before the specified date.
     */
    public listServiceAccountApplicationKeys(serviceAccountId: string, pageSize?: number, pageNumber?: number, sort?: ApplicationKeysSort, filter?: string, filterCreatedAtStart?: string, filterCreatedAtEnd?: string, _options?: Configuration): Promise<ListApplicationKeysResponse> {
        const result = this.api.listServiceAccountApplicationKeys(serviceAccountId, pageSize, pageNumber, sort, filter, filterCreatedAtStart, filterCreatedAtEnd, _options);
        return result.toPromise();
    }
     ...
     * @param body 
     */
    public updateServiceAccountApplicationKey(serviceAccountId: string, appKeyId: string, body: ApplicationKeyUpdateRequest, _options?: Configuration): Promise<PartialApplicationKeyResponse> {
        const result = this.api.updateServiceAccountApplicationKey(serviceAccountId, appKeyId, body, _options);
        return result.toPromise();
    }
...
export class PromiseUsersApi {
     ...
     * @param body 
     */
    public createServiceAccount(body: ServiceAccountCreateRequest, _options?: Configuration): Promise<UserResponse> {
     ...
     * @param body 
     */
    public createUser(body: UserCreateRequest, _options?: Configuration): Promise<UserResponse> {
     ...
     */
    public getInvitation(userInvitationUuid: string, _options?: Configuration): Promise<UserInvitationResponse> {
     ...
     * @param userId The ID of the user.
     */
    public getUser(userId: string, _options?: Configuration): Promise<UserResponse> {
     ...
     * @param userId The ID of the user.
     */
    public listUserOrganizations(userId: string, _options?: Configuration): Promise<UserResponse> {
     ...
     * @param userId The ID of the user.
     */
    public listUserPermissions(userId: string, _options?: Configuration): Promise<PermissionsResponse> {
     ...
     */
    public listUsers(pageSize?: number, pageNumber?: number, sort?: string, sortDir?: QuerySortOrder, filter?: string, filterStatus?: string, _options?: Configuration): Promise<UsersResponse> {
        const result = this.api.listUsers(pageSize, pageNumber, sort, sortDir, filter, filterStatus, _options);
        return result.toPromise();
    }
     ...
     * @param body 
     */
    public sendInvitations(body: UserInvitationsRequest, _options?: Configuration): Promise<UserInvitationsResponse> {
     ...
     * @param body 
     */
    public updateUser(userId: string, body: UserUpdateRequest, _options?: Configuration): Promise<UserResponse> {
