...
export class ObjectKeyManagementApi {
    ...
    public getApplicationKey(param: KeyManagementApiGetApplicationKeyRequest, options?: Configuration): Promise<ApplicationKeyResponse> {
        return this.api.getApplicationKey(param.appKeyId, param.include,  options).toPromise();
    }
...
export class ObjectServiceAccountsApi {
    ...
    public createServiceAccountApplicationKey(param: ServiceAccountsApiCreateServiceAccountApplicationKeyRequest, options?: Configuration): Promise<ApplicationKeyResponse> {
        return this.api.createServiceAccountApplicationKey(param.serviceAccountId, param.body,  options).toPromise();
    }
    ...
    public deleteServiceAccountApplicationKey(param: ServiceAccountsApiDeleteServiceAccountApplicationKeyRequest, options?: Configuration): Promise<void> {
        return this.api.deleteServiceAccountApplicationKey(param.serviceAccountId, param.appKeyId,  options).toPromise();
    }
    ...
    public getServiceAccountApplicationKey(param: ServiceAccountsApiGetServiceAccountApplicationKeyRequest, options?: Configuration): Promise<PartialApplicationKeyResponse> {
        return this.api.getServiceAccountApplicationKey(param.serviceAccountId, param.appKeyId,  options).toPromise();
    }
    ...
    public listServiceAccountApplicationKeys(param: ServiceAccountsApiListServiceAccountApplicationKeysRequest, options?: Configuration): Promise<ListApplicationKeysResponse> {
        return this.api.listServiceAccountApplicationKeys(param.serviceAccountId, param.pageSize, param.pageNumber, param.sort, param.filter, param.filterCreatedAtStart, param.filterCreatedAtEnd,  options).toPromise();
    }
    ...
    public updateServiceAccountApplicationKey(param: ServiceAccountsApiUpdateServiceAccountApplicationKeyRequest, options?: Configuration): Promise<PartialApplicationKeyResponse> {
        return this.api.updateServiceAccountApplicationKey(param.serviceAccountId, param.appKeyId, param.body,  options).toPromise();
    }
