...
export { RumMetricResponseComputeAggregationType } from "./models/RumMetricResponseComputeAggregationType";
...
export { RumMetricResponseUniquenessWhen } from "./models/RumMetricResponseUniquenessWhen";
