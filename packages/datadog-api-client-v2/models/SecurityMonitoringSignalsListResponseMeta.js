...
var SecurityMonitoringSignalsListResponseMeta = /** @class */ (function () {
    ...
    SecurityMonitoringSignalsListResponseMeta.deserialize = function (data) {
        var res = new SecurityMonitoringSignalsListResponseMeta();
        res.page = ObjectSerializer_1.ObjectSerializer.deserialize(data.page, "SecurityMonitoringSignalsListResponseMetaPage", "");
        return res;
    };
    SecurityMonitoringSignalsListResponseMeta.serialize = function (data) {
        var attributeTypes = SecurityMonitoringSignalsListResponseMeta.getAttributeTypeMap();
        var res = {};
        ...
        res.page = ObjectSerializer_1.ObjectSerializer.serialize(data.page, "SecurityMonitoringSignalsListResponseMetaPage", "");
        return res;
    };
    SecurityMonitoringSignalsListResponseMeta.discriminator = undefined;
