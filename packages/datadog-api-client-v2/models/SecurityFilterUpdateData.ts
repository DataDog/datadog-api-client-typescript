...
export class SecurityFilterUpdateData {
    ...
    static deserialize(data: {[key: string]: any}): SecurityFilterUpdateData {
      let res = new SecurityFilterUpdateData();

      if (data.attributes === undefined) {
          throw new TypeError("missing required attribute 'attributes' on 'SecurityFilterUpdateData' object");
      }
      res.attributes = ObjectSerializer.deserialize(data.attributes, "SecurityFilterUpdateAttributes", "")
    ...
    static serialize(data: SecurityFilterUpdateData): {[key: string]: any} {
        let attributeTypes = SecurityFilterUpdateData.getAttributeTypeMap();
        ...
        res.attributes = ObjectSerializer.serialize(data.attributes, "SecurityFilterUpdateAttributes", "")
