...
var APIKeyCreateAttributes = /** @class */ (function () {
    ...
    APIKeyCreateAttributes.deserialize = function (data) {
        var res = new APIKeyCreateAttributes();
    ...
    APIKeyCreateAttributes.serialize = function (data) {
        var attributeTypes = APIKeyCreateAttributes.getAttributeTypeMap();
        var res = {};
    ...
    APIKeyCreateAttributes.discriminator = undefined;
