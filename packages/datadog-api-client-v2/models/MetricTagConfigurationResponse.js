...
var MetricTagConfigurationResponse = /** @class */ (function () {
    ...
    MetricTagConfigurationResponse.deserialize = function (data) {
        var res = new MetricTagConfigurationResponse();
        res.data = ObjectSerializer_1.ObjectSerializer.deserialize(data.data, "MetricTagConfiguration", "");
        return res;
    };
    MetricTagConfigurationResponse.serialize = function (data) {
        var attributeTypes = MetricTagConfigurationResponse.getAttributeTypeMap();
        var res = {};
        ...
        res.data = ObjectSerializer_1.ObjectSerializer.serialize(data.data, "MetricTagConfiguration", "");
        return res;
    };
    MetricTagConfigurationResponse.discriminator = undefined;
