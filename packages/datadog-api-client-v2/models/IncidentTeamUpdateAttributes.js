...
var IncidentTeamUpdateAttributes = /** @class */ (function () {
    ...
    IncidentTeamUpdateAttributes.deserialize = function (data) {
        var res = new IncidentTeamUpdateAttributes();
    ...
    IncidentTeamUpdateAttributes.serialize = function (data) {
        var attributeTypes = IncidentTeamUpdateAttributes.getAttributeTypeMap();
        var res = {};
    ...
    IncidentTeamUpdateAttributes.discriminator = undefined;
