...
var Log = /** @class */ (function () {
    ...
    Log.deserialize = function (data) {
        var res = new Log();
        res.attributes = ObjectSerializer_1.ObjectSerializer.deserialize(data.attributes, "LogAttributes", "");
    ...
    Log.serialize = function (data) {
        ...
        res.attributes = ObjectSerializer_1.ObjectSerializer.serialize(data.attributes, "LogAttributes", "");
