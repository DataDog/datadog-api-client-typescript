...
export class SecurityFilterAttributes {
    ...
    */
    ...
    static deserialize(data: {[key: string]: any}): SecurityFilterAttributes {
      let res = new SecurityFilterAttributes();

      res.exclusionFilters = ObjectSerializer.deserialize(data.exclusion_filters, "Array<SecurityFilterExclusionFilterResponse>", "")
      ...
      res.isBuiltin = ObjectSerializer.deserialize(data.is_builtin, "boolean", "")
    ...
    static serialize(data: SecurityFilterAttributes): {[key: string]: any} {
        let attributeTypes = SecurityFilterAttributes.getAttributeTypeMap();
        ...
        res.exclusion_filters = ObjectSerializer.serialize(data.exclusionFilters, "Array<SecurityFilterExclusionFilterResponse>", "")
