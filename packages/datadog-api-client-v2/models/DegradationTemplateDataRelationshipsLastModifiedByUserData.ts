 ...
 */
export class DegradationTemplateDataRelationshipsLastModifiedByUserData {
  /**
  ...
  static getAttributeTypeMap(): AttributeTypeMap {
    return DegradationTemplateDataRelationshipsLastModifiedByUserData.attributeTypeMap;
  }
