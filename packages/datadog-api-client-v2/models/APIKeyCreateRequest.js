...
var APIKeyCreateRequest = /** @class */ (function () {
    ...
    APIKeyCreateRequest.deserialize = function (data) {
        var res = new APIKeyCreateRequest();
        if (data.data === undefined) {
            throw new TypeError("missing required attribute 'data' on 'APIKeyCreateRequest' object");
        }
        res.data = ObjectSerializer_1.ObjectSerializer.deserialize(data.data, "APIKeyCreateData", "");
        return res;
    };
    APIKeyCreateRequest.serialize = function (data) {
        var attributeTypes = APIKeyCreateRequest.getAttributeTypeMap();
        var res = {};
        ...
        res.data = ObjectSerializer_1.ObjectSerializer.serialize(data.data, "APIKeyCreateData", "");
        return res;
    };
