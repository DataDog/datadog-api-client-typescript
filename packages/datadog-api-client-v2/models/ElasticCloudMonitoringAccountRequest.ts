 ...
 */
export class ElasticCloudMonitoringAccountRequest {
  /**
  ...
  static readonly attributeTypeMap: AttributeTypeMap = {
    data: {
      baseName: "data",
      type: "ElasticCloudMonitoringAccountCreateData",
      required: true,
    },
  ...
  static getAttributeTypeMap(): AttributeTypeMap {
    return ElasticCloudMonitoringAccountRequest.attributeTypeMap;
  }
