...
const enumsMap: {[key: string]: any[]} = {
  ...
  "AlertEventCustomAttributesLinksItemsCategory": ['runbook', 'documentation', 'dashboard'],
  ...
  "ApplicationSecurityWafCustomRuleConditionInputAddress": ['server.db.statement', 'server.io.fs.file', 'server.io.net.url', 'server.sys.shell.cmd', 'server.request.method', 'server.request.uri.raw', 'server.request.path_params', 'server.request.query', 'server.request.headers.no_cookies', 'server.request.cookies', 'server.request.trailers', 'server.request.body', 'server.response.status', 'server.response.headers.no_cookies', 'server.response.trailers', 'grpc.server.request.metadata', 'grpc.server.request.message', 'grpc.server.method', 'graphql.server.all_resolvers', 'usr.id', 'http.client_ip'],
  "ApplicationSecurityWafCustomRuleConditionOperator": ['match_regex', '!match_regex', 'phrase_match', '!phrase_match', 'is_xss', 'is_sqli', 'exact_match', '!exact_match', 'ip_match', '!ip_match', 'capture_data'],
  ...
  "ObservabilityPipelinePipelineKafkaSourceSaslMechanism": ['PLAIN', 'SCRAM-SHA-256', 'SCRAM-SHA-512'],
  ...
  "SecurityMonitoringRuleDetectionMethod": ['threshold', 'new_value', 'anomaly_detection', 'impossible_travel', 'hardcoded', 'third_party', 'anomaly_threshold'],
  ...
  "SecurityMonitoringRuleTypeCreate": ['api_security', 'application_security', 'log_detection', 'workload_security'],
  "SecurityMonitoringRuleTypeRead": ['log_detection', 'infrastructure_configuration', 'workload_security', 'cloud_configuration', 'application_security', 'api_security'],
  "SecurityMonitoringRuleTypeTest": ['log_detection'],
  "SecurityMonitoringSignalArchiveReason": ['none', 'false_positive', 'testing_or_maintenance', 'investigated_case_opened', 'other'],
  ...
  "SecurityMonitoringStandardDataSource": ['logs', 'audit', 'app_sec_spans', 'spans', 'security_runtime', 'network', 'events'],
  ...
  "VulnerabilityEcosystem": ['PyPI', 'Maven', 'NuGet', 'Npm', 'RubyGems', 'Go', 'Packagist', 'Ddeb', 'Rpm', 'Apk', 'Windows'],
...
const typeMap: {[index: string]: any} = {
  ...
  "ObservabilityPipelineKafkaSourceLibrdkafkaOption": ObservabilityPipelineKafkaSourceLibrdkafkaOption,
...
const oneOfMap: {[index: string]: string[]} = {
  ...
  "EscalationPolicyIncluded": ["TeamReference", "EscalationPolicyStep", "EscalationPolicyUser", "ScheduleData"],
  ...
  "Trigger": ["APITriggerWrapper", "AppTriggerWrapper", "CaseTriggerWrapper", "ChangeEventTriggerWrapper", "DatabaseMonitoringTriggerWrapper", "DashboardTriggerWrapper", "GithubWebhookTriggerWrapper", "IncidentTriggerWrapper", "MonitorTriggerWrapper", "NotebookTriggerWrapper", "ScheduleTriggerWrapper", "SecurityTriggerWrapper", "SelfServiceTriggerWrapper", "SlackTriggerWrapper", "SoftwareCatalogTriggerWrapper", "WorkflowTriggerWrapper"],
