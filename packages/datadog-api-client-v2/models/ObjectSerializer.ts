...
const enumsMap: {[key: string]: any[]} = {
    ...
    AlertEventAttributesLinksItemCategory: ["runbook", "documentation", "dashboard"],
    AlertEventAttributesPriority: ["1", "2", "3", "4", "5"],
    AlertEventAttributesStatus: ["warn", "error", "ok"],
    AlertEventCustomAttributesLinksItemsCategory: ["runbook", "documentation", "dashboard", "resource"],
    ...
    ApmDependencyStatName: ["avg_duration", "avg_root_duration", "avg_spans_per_trace", "error_rate", "pct_exec_time", "pct_of_traces", "total_traces_count"],
    ...
    ApmMetricsStat: ["error_rate", "errors", "errors_per_second", "hits", "hits_per_second", "apdex", "latency_avg", "latency_max", "latency_p50", "latency_p75", "latency_p90", "latency_p95", "latency_p99", "latency_p999", "latency_distribution", "total_time"],
    ApmResourceStatName: ["error_rate", "errors", "hits", "latency_avg", "latency_max", "latency_p50", "latency_p75", "latency_p90", "latency_p95", "latency_p99", "latency_distribution", "total_time"],
    ApmResourceStatsDataSource: ["apm_resource_stats"],
    ApmRetentionFilterType: ["apm_retention_filter"],
    AppBuilderEventName: ["pageChange", "tableRowClick", "_tableRowButtonClick", "change", "submit", "click", "toggleOpen", "close", "open", "executionFinished"],
    AppBuilderEventType: ["custom", "setComponentState", "triggerQuery", "openModal", "closeModal", "openUrl", "downloadFile", "setStateVariableValue"],
    ...
    AppsSortField: ["name", "created_at", "updated_at", "user_name", "-name", "-created_at", "-updated_at", "-user_name"],
    ...
    AutomationRuleTriggerType: ["case_created", "status_transitioned", "attribute_value_changed", "event_correlation_signal_correlated", "case_review_approved", "comment_added"],
    ...
    CaseBulkActionType: ["priority", "status", "assign", "unassign", "archive", "unarchive", "jira", "servicenow", "linear", "update_project"],
    CaseBulkResourceType: ["bulk"],
    CaseDataType: ["cases"],
    CaseInsightType: ["SECURITY_SIGNAL", "MONITOR", "EVENT_CORRELATION", "ERROR_TRACKING", "CLOUD_COST_RECOMMENDATION", "INCIDENT", "SENSITIVE_DATA_SCANNER_ISSUE", "EVENT", "WATCHDOG_STORY", "WIDGET", "SECURITY_FINDING", "INSIGHT_SCORECARD_CAMPAIGN", "RESOURCE_POLICY", "APM_RECOMMENDATION", "SCM_URL", "PROFILING_DOWNSIZING_EXPERIMENT"],
    ...
    ChangeEventCustomAttributesAuthorType: ["user", "system", "api", "automation"],
    ...
    ComponentType: ["table", "textInput", "textArea", "button", "text", "select", "modal", "schemaForm", "checkbox", "tabs", "vegaChart", "radioButtons", "numberInput", "fileInput", "jsonInput", "gridCell", "dateRangePicker", "search", "container", "calloutValue"],
    ConditionOperator: ["LT", "LTE", "GT", "GTE", "MATCHES", "NOT_MATCHES", "ONE_OF", "NOT_ONE_OF", "IS_NULL", "EQUALS"],
    ...
    EventType: ["event"],
    EventsAggregation: ["count", "cardinality", "pc75", "pc90", "pc95", "pc98", "pc99", "sum", "min", "max", "avg"],
    EventsDataSource: ["logs", "spans", "network", "rum", "security_signals", "profiles", "audit", "events", "ci_tests", "ci_pipelines", "incident_analytics", "product_analytics", "on_call_events", "dora"],
    ...
    FormType: ["forms"],
    FormUiDefinitionUiThemePrimaryColor: ["gray", "red", "orange", "yellow", "green", "light-blue", "dark-blue", "magenta", "indigo"],
    ...
    GetTeamMembershipsSort: ["manager_name", "-manager_name", "name", "-name", "handle", "-handle", "email", "-email"],
    ...
    IssueLanguage: ["BRIGHTSCRIPT", "C", "C_PLUS_PLUS", "C_SHARP", "CLOJURE", "DOT_NET", "ELIXIR", "ERLANG", "GO", "GROOVY", "HASKELL", "HCL", "JAVA", "JAVASCRIPT", "JVM", "KOTLIN", "OBJECTIVE_C", "PERL", "PHP", "PYTHON", "RUBY", "RUST", "SCALA", "SWIFT", "TERRAFORM", "TYPESCRIPT", "UNKNOWN"],
    IssuePlatform: ["ANDROID", "BACKEND", "BROWSER", "FLUTTER", "IOS", "REACT_NATIVE", "ROKU", "UNKNOWN"],
    ...
    IssueUserType: ["user"],
    IssuesSearchRequestDataAttributesOrderBy: ["TOTAL_COUNT", "FIRST_SEEN", "IMPACTED_SESSIONS", "PRIORITY"],
    IssuesSearchRequestDataAttributesPersona: ["ALL", "BROWSER", "MOBILE", "BACKEND"],
    ...
    LogsAggregationFunction: ["count", "cardinality", "pc75", "pc90", "pc95", "pc98", "pc99", "sum", "min", "max", "avg", "median"],
    ...
    MetricSLOType: ["slos"],
    MetricTagConfigurationMetricTypeCategory: ["non_distribution", "distribution"],
    MetricTagConfigurationMetricTypes: ["gauge", "count", "rate", "distribution"],
    MetricTagConfigurationType: ["manage_tags"],
    MetricType: ["metrics"],
    MetricsAggregator: ["avg", "min", "max", "sum", "last", "percentile", "mean", "l2norm", "area"],
    ...
    ModelLabRunStatus: ["pending", "running", "completed", "failed", "killed", "unresponsive", "paused"],
    ...
    OrgGroupPolicyEnforcementTier: ["OVERRIDE_ALLOWED", "GROUP_MANAGED", "DELEGATE"],
    ...
    OwnershipInferenceStatus: ["suggested", "persisted", "overridden", "failed", "unknown"],
    ...
    ScorecardScoresAggregation: ["by-entity", "by-rule", "by-scorecard", "by-team", "by-kind"],
    ScorecardType: ["scorecard"],
    SearchIssuesIncludeQueryParameterItem: ["issue", "issue.assignee", "issue.case", "issue.team_owners"],
    ...
    ServiceDefinitionV1ResourceType: ["doc", "wiki", "runbook", "url", "repo", "dashboard", "oncall", "code", "link"],
    ServiceDefinitionV1Version: ["v1"],
    ServiceDefinitionV2Dot1EmailType: ["email"],
    ServiceDefinitionV2Dot1LinkType: ["doc", "repo", "runbook", "dashboard", "other"],
    ...
    ServiceDefinitionV2LinkType: ["doc", "wiki", "runbook", "url", "repo", "dashboard", "oncall", "code", "link"],
    ...
    SlosMeasure: ["good_events", "bad_events", "slo_status", "error_budget_remaining", "error_budget_remaining_history", "error_budget_burndown", "burn_rate", "slo_status_history", "good_minutes", "bad_minutes"],
    ...
    SpansAggregationFunction: ["count", "cardinality", "pc75", "pc90", "pc95", "pc98", "pc99", "sum", "min", "max", "avg", "median"],
    ...
    SyntheticsFastTestSubType: ["dns", "grpc", "http", "icmp", "mcp", "multi", "ssl", "tcp", "udp", "websocket"],
    SyntheticsFastTestType: ["fast-api", "fast-browser"],
    SyntheticsGlobalVariableParseTestOptionsType: ["http_body", "http_header", "http_status_code", "local_variable"],
    ...
    SyntheticsNetworkAssertionOperator: ["is", "isNot", "lessThan", "lessThanOrEqual", "moreThan", "moreThanOrEqual"],
    SyntheticsNetworkAssertionPacketLossPercentageType: ["packetLossPercentage"],
    ...
    SyntheticsTestFileMultipartPresignedUrlsRequestBucketKeyPrefix: ["api-upload-file", "browser-upload-file-step"],
    SyntheticsTestOptionsMonitorOptionsNotificationPresetName: ["show_all", "hide_all", "hide_query", "hide_handles", "hide_query_and_handles", "show_only_snapshot", "hide_handles_and_footer"],
    ...
    SyntheticsTestSubType: ["dns", "grpc", "http", "icmp", "mcp", "multi", "ssl", "tcp", "udp", "websocket"],
    ...
    TeamPermissionSettingValue: ["admins", "members", "organization", "user_access_manage", "teams_manage"],
    ...
    TeamType: ["team"],
    TeamsField: ["id", "name", "handle", "summary", "description", "avatar", "banner", "visible_modules", "hidden_modules", "created_at", "modified_at", "user_count", "link_count", "team_links", "user_team_permissions"],
...
const typeMap: {[index: string]: any} = {
    ...
    AWSEventBridgeCreateResponseAttributes: AWSEventBridgeCreateResponseAttributes,
    ...
    AWSEventBridgeDeleteResponseAttributes: AWSEventBridgeDeleteResponseAttributes,
    ...
    AWSIntegrationIamPermissionsResponseAttributes: AWSIntegrationIamPermissionsResponseAttributes,
    AWSIntegrationIamPermissionsResponseData: AWSIntegrationIamPermissionsResponseData,
    ...
    AWSMetricNameFilterPreviewRequestAttributes: AWSMetricNameFilterPreviewRequestAttributes,
    ...
    AWSMetricNameFilterPreviewResponseAttributes: AWSMetricNameFilterPreviewResponseAttributes,
    ...
    CreatePublishRequestRequestDataAttributes: CreatePublishRequestRequestDataAttributes,
    ...
    GlobalVariableJsonPatchRequestDataAttributes: GlobalVariableJsonPatchRequestDataAttributes,
    ...
    IntegrationJiraSyncPropertiesCustomFieldsAdditionalProperties: IntegrationJiraSyncPropertiesCustomFieldsAdditionalProperties,
    IntegrationLinks: IntegrationLinks,
    IntegrationMonitor: IntegrationMonitor,
    IntegrationOnCall: IntegrationOnCall,
    IntegrationOnCallEscalationQueriesItems: IntegrationOnCallEscalationQueriesItems,
    ...
    ListAppsResponseDataItemsRelationships: ListAppsResponseDataItemsRelationships,
    ...
    OrgGroupPolicyOverrideCreateAttributes: OrgGroupPolicyOverrideCreateAttributes,
    OrgGroupPolicyOverrideCreateData: OrgGroupPolicyOverrideCreateData,
    OrgGroupPolicyOverrideCreateRelationships: OrgGroupPolicyOverrideCreateRelationships,
    ...
    SyntheticsApiMultistepSubtestAttributes: SyntheticsApiMultistepSubtestAttributes,
    SyntheticsApiMultistepSubtestData: SyntheticsApiMultistepSubtestData,
    SyntheticsApiMultistepSubtestsResponse: SyntheticsApiMultistepSubtestsResponse,
    ...
    SyntheticsTestFileCompleteMultipartUploadRequest: SyntheticsTestFileCompleteMultipartUploadRequest,
    ...
    SyntheticsTestFileMultipartPresignedUrlsRequest: SyntheticsTestFileMultipartPresignedUrlsRequest,
    SyntheticsTestFileMultipartPresignedUrlsResponse: SyntheticsTestFileMultipartPresignedUrlsResponse,
    ...
    SyntheticsTestResultCertificateValidity: SyntheticsTestResultCertificateValidity,
    ...
    SyntheticsTestResultNetpathDestination: SyntheticsTestResultNetpathDestination,
    ...
    SyntheticsTestResultRelationshipTestData: SyntheticsTestResultRelationshipTestData,
    ...
    TagIndexingRuleExemptionCreateAttributes: TagIndexingRuleExemptionCreateAttributes,
    ...
    TeamNotificationRuleAttributesPagerduty: TeamNotificationRuleAttributesPagerduty,
    ...
    UpdateAppFavoriteRequestDataAttributes: UpdateAppFavoriteRequestDataAttributes,
    ...
    UpdateAppSelfServiceRequestDataAttributes: UpdateAppSelfServiceRequestDataAttributes,
    ...
    UpdateAppVersionNameRequestDataAttributes: UpdateAppVersionNameRequestDataAttributes,
    ...
    UpsertAndPublishFormVersionUpsertParams: UpsertAndPublishFormVersionUpsertParams,
...
const oneOfMap: {[index: string]: string[]} = {
  ...
  "AnyValue": ["string", "number", "{ [key: string]: any; }", "Array<AnyValueItem>", "boolean"],
  ...
  "AuthNMappingCreateRelationships": ["AuthNMappingRelationshipToRole", "AuthNMappingRelationshipToTeam"],
  "AuthNMappingIncluded": ["SAMLAssertionAttribute", "Role", "AuthNMappingTeam"],
  "AuthNMappingUpdateRelationships": ["AuthNMappingRelationshipToRole", "AuthNMappingRelationshipToTeam"],
  ...
  "CIAppAggregateBucketValue": ["string", "number", "Array<CIAppAggregateBucketValueTimeseriesPoint>"],
  "CIAppCreatePipelineEventRequestAttributesResource": ["CIAppPipelineEventPipeline", "CIAppPipelineEventStage", "CIAppPipelineEventJob", "CIAppPipelineEventStep"],
  "CIAppCreatePipelineEventRequestDataSingleOrArray": ["CIAppCreatePipelineEventRequestData", "Array<CIAppCreatePipelineEventRequestData>"],
  "CIAppGroupByMissing": ["string", "number"],
  "CIAppGroupByTotal": ["boolean", "string", "number"],
  "CIAppPipelineEventJob": ["CIAppPipelineEventFinishedJob", "CIAppPipelineEventInProgressJob"],
  "CIAppPipelineEventPipeline": ["CIAppPipelineEventFinishedPipeline", "CIAppPipelineEventInProgressPipeline"],
  "ChangeRequestIncludedItem": ["ChangeRequestIncludedUser", "ChangeRequestIncludedDecision"],
  ...
  "CloudflareCredentialsUpdate": ["CloudflareAPITokenUpdate", "CloudflareGlobalAPITokenUpdate"],
  "CommitmentsListItem": ["CommitmentsAwsEC2RICommitment", "CommitmentsAwsRDSRICommitment", "CommitmentsAwsElasticacheRICommitment", "CommitmentsAwsSPCommitment", "CommitmentsAzureVMRICommitment", "CommitmentsAzureComputeSPCommitment"],
  ...
  "CreateNotificationChannelConfig": ["CreatePhoneNotificationChannelConfig", "CreateEmailNotificationChannelConfig"],
  "CreateTableRequestDataAttributesFileMetadata": ["CreateTableRequestDataAttributesFileMetadataCloudStorage", "CreateTableRequestDataAttributesFileMetadataLocalFile"],
  "CustomAttributeValuesUnion": ["string", "Array<string>", "number", "Array<number>"],
  "CustomDestinationForwardDestination": ["CustomDestinationForwardDestinationHttp", "CustomDestinationForwardDestinationSplunk", "CustomDestinationForwardDestinationElasticsearch", "CustomDestinationForwardDestinationMicrosoftSentinel"],
  "CustomDestinationHttpDestinationAuth": ["CustomDestinationHttpDestinationAuthBasic", "CustomDestinationHttpDestinationAuthCustomHeader"],
  "CustomDestinationResponseForwardDestination": ["CustomDestinationResponseForwardDestinationHttp", "CustomDestinationResponseForwardDestinationSplunk", "CustomDestinationResponseForwardDestinationElasticsearch", "CustomDestinationResponseForwardDestinationMicrosoftSentinel"],
  "CustomDestinationResponseHttpDestinationAuth": ["CustomDestinationResponseHttpDestinationAuthBasic", "CustomDestinationResponseHttpDestinationAuthCustomHeader"],
  ...
  "DegradationUpdateIncluded": ["StatusPagesUser", "Degradation", "StatusPageAsIncluded"],
  "DeploymentGatesEvaluationRule": ["DeploymentGatesMonitorRule", "DeploymentGatesFDDRule"],
  ...
  "DowntimeScheduleCreateRequest": ["DowntimeScheduleRecurrencesCreateRequest", "DowntimeScheduleOneTimeCreateUpdateRequest"],
  "DowntimeScheduleResponse": ["DowntimeScheduleRecurrencesResponse", "DowntimeScheduleOneTimeResponse"],
  "DowntimeScheduleUpdateRequest": ["DowntimeScheduleRecurrencesUpdateRequest", "DowntimeScheduleOneTimeCreateUpdateRequest"],
  "EntityV3": ["EntityV3Service", "EntityV3Datastore", "EntityV3Queue", "EntityV3System", "EntityV3API", "EntityV3Repository"],
  "EntityV3APISpecInterface": ["EntityV3APISpecInterfaceFileRef", "EntityV3APISpecInterfaceDefinition"],
  "EscalationPolicyIncluded": ["EscalationPolicyStep", "EscalationPolicyUser", "ScheduleData", "ConfiguredSchedule", "TeamReference"],
  "EscalationTarget": ["TeamTarget", "UserTarget", "ScheduleTarget", "ConfiguredScheduleTarget"],
  "EventPayloadAttributes": ["ChangeEventCustomAttributes", "AlertEventCustomAttributes"],
  ...
  "IncidentIntegrationMetadataMetadata": ["SlackIntegrationMetadata", "JiraIntegrationMetadata", "MSTeamsIntegrationMetadata"],
  ...
  "LLMObsAnnotatedInteractionItem": ["LLMObsTraceAnnotatedInteractionItem", "LLMObsDisplayBlockAnnotatedInteractionItem"],
  "LLMObsAnnotationLabelValueValue": ["number", "string", "Array<string>", "boolean"],
  "LLMObsAnnotationQueueInteractionItem": ["LLMObsTraceInteractionItem", "LLMObsDisplayBlockInteractionItem"],
  "LLMObsAnnotationQueueInteractionResponseItem": ["LLMObsTraceInteractionResponseItem", "LLMObsDisplayBlockInteractionResponseItem"],
  ...
  "ListEntityCatalogResponseIncludedItem": ["EntityResponseIncludedSchema", "EntityResponseIncludedRawSchema", "EntityResponseIncludedRelatedEntity", "EntityResponseIncludedOncall", "EntityResponseIncludedIncident"],
  "LogsAggregateBucketValue": ["string", "number", "Array<LogsAggregateBucketValueTimeseriesPoint>"],
  ...
  "LogsArchiveIntegrationS3": ["LogsArchiveIntegrationS3AccessKey", "LogsArchiveIntegrationS3Role"],
  "LogsGroupByMissing": ["string", "number"],
  "LogsGroupByTotal": ["boolean", "string", "number"],
  "MetricAssetResponseIncluded": ["MetricDashboardAsset", "MetricMonitorAsset", "MetricNotebookAsset", "MetricSLOAsset"],
  ...
  "MonitorNotificationRuleFilter": ["MonitorNotificationRuleFilterTags", "MonitorNotificationRuleFilterScope"],
  "MonitorNotificationRuleResponseIncludedItem": ["User"],
  "NotificationChannelConfig": ["NotificationChannelPhoneConfig", "NotificationChannelEmailConfig", "NotificationChannelPushConfig"],
  "NotionCredentials": ["NotionAPIKey"],
  "NotionCredentialsUpdate": ["NotionAPIKeyUpdate"],
  "ObservabilityPipelineAmazonS3GenericCompression": ["ObservabilityPipelineAmazonS3GenericCompressionZstd", "ObservabilityPipelineAmazonS3GenericCompressionGzip", "ObservabilityPipelineAmazonS3GenericCompressionSnappy"],
  "ObservabilityPipelineAmazonS3GenericEncoding": ["ObservabilityPipelineAmazonS3GenericEncodingJson", "ObservabilityPipelineAmazonS3GenericEncodingParquet"],
  "ObservabilityPipelineBufferOptions": ["ObservabilityPipelineDiskBufferOptions", "ObservabilityPipelineMemoryBufferOptions", "ObservabilityPipelineMemoryBufferSizeOptions"],
  "ObservabilityPipelineClickhouseDestinationCompression": ["ObservabilityPipelineClickhouseDestinationCompressionAlgorithm", "ObservabilityPipelineClickhouseDestinationCompressionObject"],
  "ObservabilityPipelineConfigDestinationItem": ["ObservabilityPipelineElasticsearchDestination", "ObservabilityPipelineHttpClientDestination", "ObservabilityPipelineAmazonOpenSearchDestination", "ObservabilityPipelineAmazonS3Destination", "ObservabilityPipelineAmazonS3GenericDestination", "ObservabilityPipelineAmazonSecurityLakeDestination", "AzureStorageDestination", "ObservabilityPipelineClickhouseDestination", "ObservabilityPipelineCloudPremDestination", "ObservabilityPipelineCrowdStrikeNextGenSiemDestination", "ObservabilityPipelineDatadogLogsDestination", "ObservabilityPipelineGoogleChronicleDestination", "ObservabilityPipelineGoogleCloudStorageDestination", "ObservabilityPipelineGooglePubSubDestination", "ObservabilityPipelineKafkaDestination", "MicrosoftSentinelDestination", "ObservabilityPipelineNewRelicDestination", "ObservabilityPipelineOpenSearchDestination", "ObservabilityPipelineRsyslogDestination", "ObservabilityPipelineSentinelOneDestination", "ObservabilityPipelineSocketDestination", "ObservabilityPipelineSplunkHecDestination", "ObservabilityPipelineSumoLogicDestination", "ObservabilityPipelineSyslogNgDestination", "ObservabilityPipelineDatabricksZerobusDestination", "ObservabilityPipelineDatadogMetricsDestination", "ObservabilityPipelineSplunkHecMetricsDestination"],
  "ObservabilityPipelineConfigProcessorItem": ["ObservabilityPipelineFilterProcessor", "ObservabilityPipelineAddEnvVarsProcessor", "ObservabilityPipelineAddFieldsProcessor", "ObservabilityPipelineAddHostnameProcessor", "ObservabilityPipelineCustomProcessor", "ObservabilityPipelineDatadogTagsProcessor", "ObservabilityPipelineDedupeProcessor", "ObservabilityPipelineEnrichmentTableProcessor", "ObservabilityPipelineGenerateMetricsProcessor", "ObservabilityPipelineGenerateMetricsV2Processor", "ObservabilityPipelineOcsfMapperProcessor", "ObservabilityPipelineParseGrokProcessor", "ObservabilityPipelineParseJSONProcessor", "ObservabilityPipelineParseXMLProcessor", "ObservabilityPipelineQuotaProcessor", "ObservabilityPipelineReduceProcessor", "ObservabilityPipelineRemoveFieldsProcessor", "ObservabilityPipelineRenameFieldsProcessor", "ObservabilityPipelineSampleProcessor", "ObservabilityPipelineSensitiveDataScannerProcessor", "ObservabilityPipelineSplitArrayProcessor", "ObservabilityPipelineThrottleProcessor", "ObservabilityPipelineAddMetricTagsProcessor", "ObservabilityPipelineAggregateProcessor", "ObservabilityPipelineMetricTagsProcessor", "ObservabilityPipelineRenameMetricTagsProcessor", "ObservabilityPipelineTagCardinalityLimitProcessor"],
  "ObservabilityPipelineConfigSourceItem": ["ObservabilityPipelineDatadogAgentSource", "ObservabilityPipelineAmazonDataFirehoseSource", "ObservabilityPipelineAmazonS3Source", "ObservabilityPipelineFluentBitSource", "ObservabilityPipelineFluentdSource", "ObservabilityPipelineGooglePubSubSource", "ObservabilityPipelineHttpClientSource", "ObservabilityPipelineHttpServerSource", "ObservabilityPipelineKafkaSource", "ObservabilityPipelineLogstashSource", "ObservabilityPipelineRsyslogSource", "ObservabilityPipelineSocketSource", "ObservabilityPipelineSplunkHecSource", "ObservabilityPipelineSplunkTcpSource", "ObservabilityPipelineSumoLogicSource", "ObservabilityPipelineSyslogNgSource", "ObservabilityPipelineWebsocketSource", "ObservabilityPipelineOpentelemetrySource"],
  "ObservabilityPipelineEnrichmentTableFileKeyItemField": ["string", "ObservabilityPipelineEnrichmentTableFieldEventLookup", "ObservabilityPipelineEnrichmentTableFieldVrlLookup", "ObservabilityPipelineEnrichmentTableFieldSecretLookup"],
  "ObservabilityPipelineHttpServerSourceValidTokenPathToToken": ["ObservabilityPipelineHttpServerSourceValidTokenPathToTokenLocation", "ObservabilityPipelineHttpServerSourceValidTokenPathToTokenHeader"],
  "ObservabilityPipelineMetricValue": ["ObservabilityPipelineGeneratedMetricIncrementByOne", "ObservabilityPipelineGeneratedMetricIncrementByField"],
  "ObservabilityPipelineOcsfMapperProcessorMappingMapping": ["ObservabilityPipelineOcsfMappingLibrary", "ObservabilityPipelineOcsfMappingCustom"],
  "ObservabilityPipelineParseGrokProcessorRuleItem": ["ObservabilityPipelineParseGrokProcessorRule", "ObservabilityPipelineParseGrokProcessorIncludeRule"],
  "ObservabilityPipelineSensitiveDataScannerProcessorAction": ["ObservabilityPipelineSensitiveDataScannerProcessorActionRedact", "ObservabilityPipelineSensitiveDataScannerProcessorActionHash", "ObservabilityPipelineSensitiveDataScannerProcessorActionPartialRedact"],
  "ObservabilityPipelineSensitiveDataScannerProcessorPattern": ["ObservabilityPipelineSensitiveDataScannerProcessorCustomPattern", "ObservabilityPipelineSensitiveDataScannerProcessorLibraryPattern"],
  "ObservabilityPipelineSensitiveDataScannerProcessorScope": ["ObservabilityPipelineSensitiveDataScannerProcessorScopeInclude", "ObservabilityPipelineSensitiveDataScannerProcessorScopeExclude", "ObservabilityPipelineSensitiveDataScannerProcessorScopeAll"],
  "ObservabilityPipelineSocketDestinationFraming": ["ObservabilityPipelineSocketDestinationFramingNewlineDelimited", "ObservabilityPipelineSocketDestinationFramingBytes", "ObservabilityPipelineSocketDestinationFramingCharacterDelimited"],
  ...
  "ObservabilityPipelineWebsocketSourceTls": ["ObservabilityPipelineWebsocketSourceTlsEnabled", "ObservabilityPipelineWebsocketSourceTlsWithClientCert"],
  ...
  "PatchTableRequestDataAttributesFileMetadata": ["PatchTableRequestDataAttributesFileMetadataCloudStorage", "PatchTableRequestDataAttributesFileMetadataLocalFile"],
  "ProductAnalyticsBaseQuery": ["ProductAnalyticsEventQuery", "ProductAnalyticsOccurrenceQuery"],
  "Query": ["ActionQuery", "DataTransform", "StateVariable"],
  "RUMAggregateBucketValue": ["string", "number", "Array<RUMAggregateBucketValueTimeseriesPoint>"],
  "RUMGroupByMissing": ["string", "number"],
  "RUMGroupByTotal": ["boolean", "string", "number"],
  "ReportScheduleIncludedResource": ["ReportScheduleAuthor", "ReportScheduleResource"],
  "RestrictionQueryResponseIncludedItem": ["RestrictionQueryRole"],
  "RoutingRuleAction": ["SendSlackMessageAction", "SendTeamsMessageAction", "TriggerWorkflowAutomationAction", "RoutingRuleEscalationPolicyAction"],
  "ScalarColumn": ["GroupScalarColumn", "DataScalarColumn"],
  "ScalarQuery": ["MetricsScalarQuery", "EventsScalarQuery", "ApmResourceStatsQuery", "ApmMetricsQuery", "ApmDependencyStatsQuery", "SloQuery", "ProcessScalarQuery", "ContainerScalarQuery"],
  "ScanResultResponse": ["{ [key: string]: any; }"],
  "ScheduleDataIncludedItem": ["TeamReference", "Layer", "ScheduleMember", "ScheduleUser"],
  "ScheduleOnCallRespondersIncluded": ["ScheduleOnCallResponderData", "ShiftData", "ScheduleData", "User"],
  "SecurityMonitoringIntegrationConfigCreateAttributes": ["SecurityMonitoringGoogleWorkspaceIntegrationConfigCreateAttributes", "SecurityMonitoringOktaIntegrationConfigCreateAttributes", "SecurityMonitoringEntraIdIntegrationConfigCreateAttributes", "SecurityMonitoringCrowdStrikeIntegrationConfigCreateAttributes", "SecurityMonitoringSentinelOneIntegrationConfigCreateAttributes"],
  "SecurityMonitoringIntegrationConfigUpdateAttributes": ["SecurityMonitoringGoogleWorkspaceIntegrationConfigUpdateAttributes", "SecurityMonitoringOktaIntegrationConfigUpdateAttributes", "SecurityMonitoringEntraIdIntegrationConfigUpdateAttributes", "SecurityMonitoringCrowdStrikeIntegrationConfigUpdateAttributes", "SecurityMonitoringSentinelOneIntegrationConfigUpdateAttributes"],
  "SecurityMonitoringIntegrationCredentialsValidateAttributes": ["SecurityMonitoringGoogleWorkspaceIntegrationCredentialsValidateAttributes", "SecurityMonitoringOktaIntegrationCredentialsValidateAttributes", "SecurityMonitoringEntraIdIntegrationCredentialsValidateAttributes", "SecurityMonitoringCrowdStrikeIntegrationCredentialsValidateAttributes", "SecurityMonitoringSentinelOneIntegrationCredentialsValidateAttributes"],
  "SecurityMonitoringRuleConvertPayload": ["SecurityMonitoringStandardRulePayload", "SecurityMonitoringSignalRulePayload"],
  "SecurityMonitoringRuleCreatePayload": ["SecurityMonitoringStandardRuleCreatePayload", "SecurityMonitoringSignalRuleCreatePayload", "CloudConfigurationRuleCreatePayload"],
  "SecurityMonitoringRuleQuery": ["SecurityMonitoringStandardRuleQuery", "SecurityMonitoringSignalRuleQuery"],
  "SecurityMonitoringRuleResponse": ["SecurityMonitoringStandardRuleResponse", "SecurityMonitoringSignalRuleResponse"],
  "SecurityMonitoringRuleTestPayload": ["SecurityMonitoringStandardRuleTestPayload"],
  "SecurityMonitoringRuleValidatePayload": ["SecurityMonitoringStandardRulePayload", "SecurityMonitoringSignalRulePayload", "CloudConfigurationRulePayload"],
  "SensitiveDataScannerGetConfigIncludedItem": ["SensitiveDataScannerRuleIncludedItem", "SensitiveDataScannerGroupIncludedItem"],
  "ServiceDefinitionSchema": ["ServiceDefinitionV1", "ServiceDefinitionV2", "ServiceDefinitionV2Dot1", "ServiceDefinitionV2Dot2"],
  "ServiceDefinitionV2Contact": ["ServiceDefinitionV2Email", "ServiceDefinitionV2Slack", "ServiceDefinitionV2MSTeams"],
  "ServiceDefinitionV2Dot1Contact": ["ServiceDefinitionV2Dot1Email", "ServiceDefinitionV2Dot1Slack", "ServiceDefinitionV2Dot1MSTeams"],
  "ServiceDefinitionsCreateRequest": ["ServiceDefinitionV2Dot2", "ServiceDefinitionV2Dot1", "ServiceDefinitionV2", "string"],
  "ServiceNowCredentials": ["ServiceNowBasicAuth"],
  "ServiceNowCredentialsUpdate": ["ServiceNowBasicAuthUpdate"],
  "SharedDashboardIncluded": ["SharedDashboardIncludedDashboard", "SharedDashboardIncludedUser"],
  "ShiftIncluded": ["ScheduleUser"],
  "SourcemapItem": ["JSSourcemapData", "ReactNativeSourcemapData", "IOSSourcemapData", "JVMSourcemapData", "FlutterSourcemapData", "ELFSourcemapData", "NDKSourcemapData", "IL2CPPSourcemapData"],
  "SpansAggregateBucketValue": ["string", "number", "Array<SpansAggregateBucketValueTimeseriesPoint>"],
  ...
  "SyntheticsNetworkAssertion": ["SyntheticsNetworkAssertionLatency", "SyntheticsNetworkAssertionMultiNetworkHop", "SyntheticsNetworkAssertionPacketLossPercentage", "SyntheticsNetworkAssertionJitter"],
  ...
  "TimeseriesQuery": ["MetricsTimeseriesQuery", "EventsTimeseriesQuery", "ApmResourceStatsQuery", "ApmMetricsQuery", "ApmDependencyStatsQuery", "SloQuery", "ProcessTimeseriesQuery", "ContainerTimeseriesQuery"],
  "Trigger": ["APITriggerWrapper", "AppTriggerWrapper", "CaseTriggerWrapper", "ChangeEventTriggerWrapper", "DatabaseMonitoringTriggerWrapper", "DatastoreTriggerWrapper", "DashboardTriggerWrapper", "FormTriggerWrapper", "GithubWebhookTriggerWrapper", "IncidentTriggerWrapper", "MonitorTriggerWrapper", "NotebookTriggerWrapper", "OnCallTriggerWrapper", "ScheduleTriggerWrapper", "SecurityTriggerWrapper", "SelfServiceTriggerWrapper", "SlackTriggerWrapper", "SoftwareCatalogTriggerWrapper", "WorkflowTriggerWrapper"],
  ...
  "V2EventAttributesAttributes": ["ChangeEventAttributes", "AlertEventAttributes"],
