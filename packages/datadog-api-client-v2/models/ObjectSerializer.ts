...
const enumsMap: { [key: string]: any[] } = {
  ...
  PostmortemTemplateType: ["postmortem_templates", "postmortem_template"],
...
const typeMap: { [index: string]: any } = {
  ...
  ElasticCloudIntegrationAccountRequest: ElasticCloudIntegrationAccountRequest,
  ...
  FleetDeploymentPackageUpgradeV2Attributes:
    FleetDeploymentPackageUpgradeV2Attributes,
  FleetDeploymentPackageUpgradeV2Create: FleetDeploymentPackageUpgradeV2Create,
