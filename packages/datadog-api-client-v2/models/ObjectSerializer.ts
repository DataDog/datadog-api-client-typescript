...
const enumsMap: {[key: string]: any[]} = {
  ...
  "RuleType": ['rule'],
  "RuleTypesItems": ['application_security', 'log_detection', 'workload_security', 'signal_correlation', 'cloud_configuration', 'infrastructure_configuration', 'application_code_vulnerability', 'application_library_vulnerability', 'attack_path', 'container_image_vulnerability', 'identity_risk', 'misconfiguration', 'api_security'],
  ...
  "SecurityMonitoringRuleCaseActionType": ['block_ip', 'block_user', 'user_behavior'],
  ...
  "SecurityMonitoringRuleTypeCreate": ['application_security', 'log_detection', 'workload_security'],
  "SecurityMonitoringRuleTypeRead": ['log_detection', 'infrastructure_configuration', 'workload_security', 'cloud_configuration', 'application_security'],
...
const oneOfMap: {[index: string]: string[]} = {
  ...
  "ActionConnectionIntegrationUpdate": ["AWSIntegrationUpdate", "HTTPIntegrationUpdate"],
  ...
  "CustomDestinationForwardDestination": ["CustomDestinationForwardDestinationHttp", "CustomDestinationForwardDestinationSplunk", "CustomDestinationForwardDestinationElasticsearch"],
  ...
  "CustomDestinationResponseForwardDestination": ["CustomDestinationResponseForwardDestinationHttp", "CustomDestinationResponseForwardDestinationSplunk", "CustomDestinationResponseForwardDestinationElasticsearch"],
