...
var MetricTagConfigurationCreateData = /** @class */ (function () {
    ...
    MetricTagConfigurationCreateData.deserialize = function (data) {
        var res = new MetricTagConfigurationCreateData();
        res.attributes = ObjectSerializer_1.ObjectSerializer.deserialize(data.attributes, "MetricTagConfigurationCreateAttributes", "");
    ...
    MetricTagConfigurationCreateData.serialize = function (data) {
        var attributeTypes = MetricTagConfigurationCreateData.getAttributeTypeMap();
        var res = {};
        ...
        res.attributes = ObjectSerializer_1.ObjectSerializer.serialize(data.attributes, "MetricTagConfigurationCreateAttributes", "");
        if (data.id === undefined) {
            throw new TypeError("missing required attribute 'id' on 'MetricTagConfigurationCreateData' object");
        }
    ...
    MetricTagConfigurationCreateData.discriminator = undefined;
