...
var MetricsAndMetricTagConfigurationsResponse = /** @class */ (function () {
    ...
    MetricsAndMetricTagConfigurationsResponse.deserialize = function (data) {
        var res = new MetricsAndMetricTagConfigurationsResponse();
        res.data = ObjectSerializer_1.ObjectSerializer.deserialize(data.data, "Array<MetricsAndMetricTagConfigurations>", "");
        return res;
    };
    MetricsAndMetricTagConfigurationsResponse.serialize = function (data) {
        var attributeTypes = MetricsAndMetricTagConfigurationsResponse.getAttributeTypeMap();
        var res = {};
        ...
        res.data = ObjectSerializer_1.ObjectSerializer.serialize(data.data, "Array<MetricsAndMetricTagConfigurations>", "");
        return res;
    };
    MetricsAndMetricTagConfigurationsResponse.discriminator = undefined;
