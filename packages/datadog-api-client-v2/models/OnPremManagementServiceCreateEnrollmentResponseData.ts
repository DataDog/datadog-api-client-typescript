...
import { OnPremManagementServiceCreateEnrollmentResponseType } from "./OnPremManagementServiceCreateEnrollmentResponseType";
 ...
 */
export class OnPremManagementServiceCreateEnrollmentResponseData {
  /**
  ...
  static readonly attributeTypeMap: AttributeTypeMap = {
    attributes: {
      baseName: "attributes",
      type: "OnPremManagementServiceCreateEnrollmentResponseAttributes",
      required: true,
    },
    id: {
      baseName: "id",
  ...
  static getAttributeTypeMap(): AttributeTypeMap {
    return OnPremManagementServiceCreateEnrollmentResponseData.attributeTypeMap;
  }
