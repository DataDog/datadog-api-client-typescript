...
import { PipelineQuotaProcessorType } from "./PipelineQuotaProcessorType";
 ...
 */
export class PipelineQuotaProcessor {
  /**
  ...
  static readonly attributeTypeMap: AttributeTypeMap = {
    ...
    overrides: {
      baseName: "overrides",
      type: "Array<PipelineQuotaProcessorOverride>",
    },
    partitionFields: {
  ...
  static getAttributeTypeMap(): AttributeTypeMap {
    return PipelineQuotaProcessor.attributeTypeMap;
  }
