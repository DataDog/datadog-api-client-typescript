 ...
 */
export class InputSchemaDataAttributesParametersItemsData {
  /**
  ...
  static readonly attributeTypeMap: AttributeTypeMap = {
    attributes: {
      baseName: "attributes",
      type: "InputSchemaDataAttributesParametersItemsDataAttributes",
    },
  ...
  static getAttributeTypeMap(): AttributeTypeMap {
    return InputSchemaDataAttributesParametersItemsData.attributeTypeMap;
  }
