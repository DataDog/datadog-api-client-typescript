...
var DashboardListAddItemsRequest = /** @class */ (function () {
    ...
    DashboardListAddItemsRequest.deserialize = function (data) {
        var res = new DashboardListAddItemsRequest();
        res.dashboards = ObjectSerializer_1.ObjectSerializer.deserialize(data.dashboards, "Array<DashboardListItemRequest>", "");
        return res;
    };
    DashboardListAddItemsRequest.serialize = function (data) {
        var attributeTypes = DashboardListAddItemsRequest.getAttributeTypeMap();
        var res = {};
    ...
    DashboardListAddItemsRequest.discriminator = undefined;
