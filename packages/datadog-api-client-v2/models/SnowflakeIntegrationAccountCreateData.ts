 ...
 */
export class SnowflakeIntegrationAccountCreateData {
  /**
  ...
  static readonly attributeTypeMap: AttributeTypeMap = {
    attributes: {
      baseName: "attributes",
      type: "SnowflakeIntegrationAccountCreateAttributes",
      required: true,
    },
    type: {
      baseName: "type",
  ...
  static getAttributeTypeMap(): AttributeTypeMap {
    return SnowflakeIntegrationAccountCreateData.attributeTypeMap;
  }
