...
var LogAttributes = /** @class */ (function () {
    ...
    LogAttributes.deserialize = function (data) {
        var res = new LogAttributes();
    ...
    LogAttributes.serialize = function (data) {
        var attributeTypes = LogAttributes.getAttributeTypeMap();
        var res = {};
    ...
    LogAttributes.discriminator = undefined;
