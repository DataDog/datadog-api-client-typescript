...
var RoleUpdateAttributes = /** @class */ (function () {
    ...
    RoleUpdateAttributes.deserialize = function (data) {
        var res = new RoleUpdateAttributes();
    ...
    RoleUpdateAttributes.serialize = function (data) {
        var attributeTypes = RoleUpdateAttributes.getAttributeTypeMap();
        var res = {};
    ...
    RoleUpdateAttributes.discriminator = undefined;
