 ...
 */
import { PipelineFilterProcessorType } from "./PipelineFilterProcessorType";
 ...
 */
export class PipelineFilterProcessor {
  /**
  ...
  static getAttributeTypeMap(): AttributeTypeMap {
    return PipelineFilterProcessor.attributeTypeMap;
  }
