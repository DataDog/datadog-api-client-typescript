...
var IncidentServiceUpdateRequest = /** @class */ (function () {
    ...
    IncidentServiceUpdateRequest.deserialize = function (data) {
        var res = new IncidentServiceUpdateRequest();
        if (data.data === undefined) {
            throw new TypeError("missing required attribute 'data' on 'IncidentServiceUpdateRequest' object");
        }
        res.data = ObjectSerializer_1.ObjectSerializer.deserialize(data.data, "IncidentServiceUpdateData", "");
        return res;
    };
    IncidentServiceUpdateRequest.serialize = function (data) {
        var attributeTypes = IncidentServiceUpdateRequest.getAttributeTypeMap();
        var res = {};
        ...
        res.data = ObjectSerializer_1.ObjectSerializer.serialize(data.data, "IncidentServiceUpdateData", "");
        return res;
    };
    IncidentServiceUpdateRequest.discriminator = undefined;
