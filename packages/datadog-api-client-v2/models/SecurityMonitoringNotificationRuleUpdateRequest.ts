 ...
 */
export class SecurityMonitoringNotificationRuleUpdateRequest {
  /**
  ...
  static readonly attributeTypeMap: AttributeTypeMap = {
    data: {
      baseName: "data",
      type: "SecurityMonitoringNotificationRuleUpdateData",
      required: true,
    },
  ...
  static getAttributeTypeMap(): AttributeTypeMap {
    return SecurityMonitoringNotificationRuleUpdateRequest.attributeTypeMap;
  }
