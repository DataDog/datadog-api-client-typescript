...
export class Query {
  ...
  "id": string;
  /**
   * The name of the query. The name should be unique within the app, and will be visible in the app editor.
   */
  "name": string;
  /**
   * The properties of the query. The properties will vary depending on the query type.
   */
  "properties"?: any;
  /**
   * The query type.
