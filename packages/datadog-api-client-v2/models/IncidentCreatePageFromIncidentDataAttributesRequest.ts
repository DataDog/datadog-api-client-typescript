 ...
 */
export class IncidentCreatePageFromIncidentDataAttributesRequest {
  /**
  ...
  static getAttributeTypeMap(): AttributeTypeMap {
    return IncidentCreatePageFromIncidentDataAttributesRequest.attributeTypeMap;
  }
