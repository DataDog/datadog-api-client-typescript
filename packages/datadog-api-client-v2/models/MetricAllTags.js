...
var MetricAllTags = /** @class */ (function () {
    ...
    MetricAllTags.deserialize = function (data) {
        var res = new MetricAllTags();
        res.attributes = ObjectSerializer_1.ObjectSerializer.deserialize(data.attributes, "MetricAllTagsAttributes", "");
    ...
    MetricAllTags.serialize = function (data) {
        var attributeTypes = MetricAllTags.getAttributeTypeMap();
        var res = {};
        ...
        res.attributes = ObjectSerializer_1.ObjectSerializer.serialize(data.attributes, "MetricAllTagsAttributes", "");
    ...
    MetricAllTags.discriminator = undefined;
