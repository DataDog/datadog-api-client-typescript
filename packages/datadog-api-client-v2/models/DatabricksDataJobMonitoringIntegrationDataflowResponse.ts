 ...
 */
export class DatabricksDataJobMonitoringIntegrationDataflowResponse {
  /**
  ...
  static readonly attributeTypeMap: AttributeTypeMap = {
    ...
    settings: {
      baseName: "settings",
      type: "DatabricksDataJobMonitoringIntegrationDataflowSettingsResponse",
    },
  ...
  static getAttributeTypeMap(): AttributeTypeMap {
    return DatabricksDataJobMonitoringIntegrationDataflowResponse.attributeTypeMap;
  }
