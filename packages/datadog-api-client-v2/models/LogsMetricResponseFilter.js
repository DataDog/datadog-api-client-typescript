...
var LogsMetricResponseFilter = /** @class */ (function () {
    ...
    LogsMetricResponseFilter.deserialize = function (data) {
        var res = new LogsMetricResponseFilter();
        res.query = ObjectSerializer_1.ObjectSerializer.deserialize(data.query, "string", "");
        return res;
    };
    LogsMetricResponseFilter.serialize = function (data) {
        var attributeTypes = LogsMetricResponseFilter.getAttributeTypeMap();
        var res = {};
    ...
    LogsMetricResponseFilter.discriminator = undefined;
