...
var RoleResponse = /** @class */ (function () {
    ...
    RoleResponse.deserialize = function (data) {
        var res = new RoleResponse();
        res.data = ObjectSerializer_1.ObjectSerializer.deserialize(data.data, "Role", "");
        return res;
    };
    RoleResponse.serialize = function (data) {
        var attributeTypes = RoleResponse.getAttributeTypeMap();
        var res = {};
        ...
        res.data = ObjectSerializer_1.ObjectSerializer.serialize(data.data, "Role", "");
        return res;
    };
