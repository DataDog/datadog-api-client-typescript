...
var IncidentResponseRelationships = /** @class */ (function () {
    ...
    IncidentResponseRelationships.deserialize = function (data) {
        var res = new IncidentResponseRelationships();
    ...
    IncidentResponseRelationships.serialize = function (data) {
        var attributeTypes = IncidentResponseRelationships.getAttributeTypeMap();
        var res = {};
    ...
    IncidentResponseRelationships.discriminator = undefined;
