 ...
 */
export class SnowflakeIntegrationAccountResponseData {
  /**
  ...
  static readonly attributeTypeMap: AttributeTypeMap = {
    attributes: {
      baseName: "attributes",
      type: "SnowflakeIntegrationAccountResponseAttributes",
      required: true,
    },
    id: {
      baseName: "id",
  ...
  static getAttributeTypeMap(): AttributeTypeMap {
    return SnowflakeIntegrationAccountResponseData.attributeTypeMap;
  }
