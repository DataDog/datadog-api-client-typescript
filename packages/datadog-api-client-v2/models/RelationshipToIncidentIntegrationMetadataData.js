...
var RelationshipToIncidentIntegrationMetadataData = /** @class */ (function () {
    ...
    RelationshipToIncidentIntegrationMetadataData.deserialize = function (data) {
        var res = new RelationshipToIncidentIntegrationMetadataData();
    ...
    RelationshipToIncidentIntegrationMetadataData.serialize = function (data) {
        var attributeTypes = RelationshipToIncidentIntegrationMetadataData.getAttributeTypeMap();
        var res = {};
    ...
    RelationshipToIncidentIntegrationMetadataData.discriminator = undefined;
