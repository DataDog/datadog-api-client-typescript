...
import { PipelineRenameFieldsProcessorType } from "./PipelineRenameFieldsProcessorType";
 ...
 */
export class PipelineRenameFieldsProcessor {
  /**
  ...
  static readonly attributeTypeMap: AttributeTypeMap = {
    fields: {
      baseName: "fields",
      type: "Array<PipelineRenameFieldsProcessorField>",
      required: true,
    },
    id: {
      baseName: "id",
  ...
  static getAttributeTypeMap(): AttributeTypeMap {
    return PipelineRenameFieldsProcessor.attributeTypeMap;
  }
