 ...
 */
export class CloudWorkloadSecurityAgentPolicyBatchUpdateRequest {
  /**
  ...
  static readonly attributeTypeMap: AttributeTypeMap = {
    data: {
      baseName: "data",
      type: "CloudWorkloadSecurityAgentPolicyBatchUpdateData",
      required: true,
    },
  ...
  static getAttributeTypeMap(): AttributeTypeMap {
    return CloudWorkloadSecurityAgentPolicyBatchUpdateRequest.attributeTypeMap;
  }
