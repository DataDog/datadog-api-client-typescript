...
export class LogsMetricResponse {
    ...
    static deserialize(data: {[key: string]: any}): LogsMetricResponse {
      let res = new LogsMetricResponse();

      res.data = ObjectSerializer.deserialize(data.data, "LogsMetricResponseData", "")
    ...
    static serialize(data: LogsMetricResponse): {[key: string]: any} {
        let attributeTypes = LogsMetricResponse.getAttributeTypeMap();
        ...
        res.data = ObjectSerializer.serialize(data.data, "LogsMetricResponseData", "")
