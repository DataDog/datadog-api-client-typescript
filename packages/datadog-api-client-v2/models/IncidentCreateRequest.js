...
var IncidentCreateRequest = /** @class */ (function () {
    ...
    IncidentCreateRequest.deserialize = function (data) {
        var res = new IncidentCreateRequest();
        if (data.data === undefined) {
            throw new TypeError("missing required attribute 'data' on 'IncidentCreateRequest' object");
        }
        res.data = ObjectSerializer_1.ObjectSerializer.deserialize(data.data, "IncidentCreateData", "");
        return res;
    };
    IncidentCreateRequest.serialize = function (data) {
        var attributeTypes = IncidentCreateRequest.getAttributeTypeMap();
        var res = {};
        ...
        res.data = ObjectSerializer_1.ObjectSerializer.serialize(data.data, "IncidentCreateData", "");
        return res;
    };
    IncidentCreateRequest.discriminator = undefined;
