...
var IncidentTeamCreateRequest = /** @class */ (function () {
    ...
    IncidentTeamCreateRequest.deserialize = function (data) {
        var res = new IncidentTeamCreateRequest();
        if (data.data === undefined) {
            throw new TypeError("missing required attribute 'data' on 'IncidentTeamCreateRequest' object");
        }
        res.data = ObjectSerializer_1.ObjectSerializer.deserialize(data.data, "IncidentTeamCreateData", "");
        return res;
    };
    IncidentTeamCreateRequest.serialize = function (data) {
        var attributeTypes = IncidentTeamCreateRequest.getAttributeTypeMap();
        var res = {};
        ...
        res.data = ObjectSerializer_1.ObjectSerializer.serialize(data.data, "IncidentTeamCreateData", "");
        return res;
    };
    IncidentTeamCreateRequest.discriminator = undefined;
