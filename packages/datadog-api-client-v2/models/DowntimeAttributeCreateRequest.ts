...
import { DowntimeAttributeScheduleCreateRequest } from "./DowntimeAttributeScheduleCreateRequest";
 ...
 * Downtime details.
 */
export class DowntimeAttributeCreateRequest {
  /**
  ...
  static readonly attributeTypeMap: AttributeTypeMap = {
    ...
    schedule: {
      baseName: "schedule",
      type: "DowntimeAttributeScheduleCreateRequest",
    },
    scope: {
      baseName: "scope",
      type: "string",
  ...
  static getAttributeTypeMap(): AttributeTypeMap {
    return DowntimeAttributeCreateRequest.attributeTypeMap;
  }
