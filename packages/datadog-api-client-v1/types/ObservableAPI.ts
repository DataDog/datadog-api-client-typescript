...
export class ObservableServiceLevelObjectivesApi {
     ...
     */
    public getSLOHistory(sloId: string, fromTs: number, toTs: number, target?: number, options?: Configuration): Observable<SLOHistoryResponse> {
        const requestContextPromise = this.requestFactory.getSLOHistory(sloId, fromTs, toTs, target, options);
     ...
     */
    public listSLOs(ids?: string, query?: string, tagsQuery?: string, metricsQuery?: string, limit?: number, offset?: number, options?: Configuration): Observable<SLOListResponse> {
        const requestContextPromise = this.requestFactory.listSLOs(ids, query, tagsQuery, metricsQuery, limit, offset, options);
...
export class ObservableUsageMeteringApi {
     ...
     * @param endHr Datetime in ISO-8601 format, UTC, precise to hour: &#x60;[YYYY-MM-DDThh]&#x60; for usage ending **before** this hour.
     */
    public getUsageCWS(startHr: Date, endHr?: Date, options?: Configuration): Observable<UsageCWSResponse> {
        const requestContextPromise = this.requestFactory.getUsageCWS(startHr, endHr, options);
