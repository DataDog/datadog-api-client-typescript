...
import { DashboardBulkActionData } from '../models/DashboardBulkActionData';
...
import { DashboardResourceType } from '../models/DashboardResourceType';
...
import { FormulaAndFunctionApmDependencyStatName } from '../models/FormulaAndFunctionApmDependencyStatName';
import { FormulaAndFunctionApmDependencyStatsDataSource } from '../models/FormulaAndFunctionApmDependencyStatsDataSource';
import { FormulaAndFunctionApmDependencyStatsQueryDefinition } from '../models/FormulaAndFunctionApmDependencyStatsQueryDefinition';
import { FormulaAndFunctionApmResourceStatName } from '../models/FormulaAndFunctionApmResourceStatName';
import { FormulaAndFunctionApmResourceStatsDataSource } from '../models/FormulaAndFunctionApmResourceStatsDataSource';
import { FormulaAndFunctionApmResourceStatsQueryDefinition } from '../models/FormulaAndFunctionApmResourceStatsQueryDefinition';
...
import { FunnelQuery } from '../models/FunnelQuery';
import { FunnelRequestType } from '../models/FunnelRequestType';
import { FunnelSource } from '../models/FunnelSource';
import { FunnelWidgetDefinition } from '../models/FunnelWidgetDefinition';
import { FunnelWidgetDefinitionType } from '../models/FunnelWidgetDefinitionType';
import { FunnelWidgetRequest } from '../models/FunnelWidgetRequest';
...
import { HourlyUsageAttributionBody } from '../models/HourlyUsageAttributionBody';
import { HourlyUsageAttributionMetadata } from '../models/HourlyUsageAttributionMetadata';
import { HourlyUsageAttributionPagination } from '../models/HourlyUsageAttributionPagination';
...
import { ListStreamColumn } from '../models/ListStreamColumn';
import { ListStreamColumnWidth } from '../models/ListStreamColumnWidth';
import { ListStreamQuery } from '../models/ListStreamQuery';
import { ListStreamResponseFormat } from '../models/ListStreamResponseFormat';
import { ListStreamSource } from '../models/ListStreamSource';
import { ListStreamWidgetDefinition } from '../models/ListStreamWidgetDefinition';
import { ListStreamWidgetDefinitionType } from '../models/ListStreamWidgetDefinitionType';
import { ListStreamWidgetRequest } from '../models/ListStreamWidgetRequest';
...
import { MonitorRenotifyStatusType } from '../models/MonitorRenotifyStatusType';
...
import { NotebookMetadataType } from '../models/NotebookMetadataType';
...
import { SLOCorrectionResponseAttributesModifier } from '../models/SLOCorrectionResponseAttributesModifier';
...
import { SLOHistoryMonitor } from '../models/SLOHistoryMonitor';
...
import { SLOHistoryResponseErrorWithType } from '../models/SLOHistoryResponseErrorWithType';
...
import { ScatterplotDimension } from '../models/ScatterplotDimension';
import { ScatterplotTableRequest } from '../models/ScatterplotTableRequest';
import { ScatterplotWidgetAggregator } from '../models/ScatterplotWidgetAggregator';
import { ScatterplotWidgetFormula } from '../models/ScatterplotWidgetFormula';
...
import { SunburstWidgetDefinition } from '../models/SunburstWidgetDefinition';
import { SunburstWidgetDefinitionType } from '../models/SunburstWidgetDefinitionType';
import { SunburstWidgetLegend } from '../models/SunburstWidgetLegend';
import { SunburstWidgetLegendInlineAutomatic } from '../models/SunburstWidgetLegendInlineAutomatic';
import { SunburstWidgetLegendInlineAutomaticType } from '../models/SunburstWidgetLegendInlineAutomaticType';
import { SunburstWidgetLegendTable } from '../models/SunburstWidgetLegendTable';
import { SunburstWidgetLegendTableType } from '../models/SunburstWidgetLegendTableType';
import { SunburstWidgetRequest } from '../models/SunburstWidgetRequest';
...
import { SyntheticsBatchDetailsData } from '../models/SyntheticsBatchDetailsData';
import { SyntheticsBatchResult } from '../models/SyntheticsBatchResult';
...
import { SyntheticsCIBatchMetadata } from '../models/SyntheticsCIBatchMetadata';
import { SyntheticsCIBatchMetadataCI } from '../models/SyntheticsCIBatchMetadataCI';
import { SyntheticsCIBatchMetadataGit } from '../models/SyntheticsCIBatchMetadataGit';
import { SyntheticsCIBatchMetadataPipeline } from '../models/SyntheticsCIBatchMetadataPipeline';
import { SyntheticsCIBatchMetadataProvider } from '../models/SyntheticsCIBatchMetadataProvider';
...
import { SyntheticsGlobalVariableAttributes } from '../models/SyntheticsGlobalVariableAttributes';
...
import { SyntheticsStatus } from '../models/SyntheticsStatus';
...
import { SyntheticsTestExecutionRule } from '../models/SyntheticsTestExecutionRule';
...
import { SyntheticsTriggerTest } from '../models/SyntheticsTriggerTest';
...
import { TreeMapColorBy } from '../models/TreeMapColorBy';
import { TreeMapGroupBy } from '../models/TreeMapGroupBy';
import { TreeMapSizeBy } from '../models/TreeMapSizeBy';
import { TreeMapWidgetDefinition } from '../models/TreeMapWidgetDefinition';
import { TreeMapWidgetDefinitionType } from '../models/TreeMapWidgetDefinitionType';
import { TreeMapWidgetRequest } from '../models/TreeMapWidgetRequest';
...
import { UsageDBMHour } from '../models/UsageDBMHour';
...
import { UsageRumUnitsHour } from '../models/UsageRumUnitsHour';
import { UsageRumUnitsResponse } from '../models/UsageRumUnitsResponse';
import { UsageSDSHour } from '../models/UsageSDSHour';
...
import { WebhooksIntegrationEncoding } from '../models/WebhooksIntegrationEncoding';
...
import { WidgetHorizontalAlign } from '../models/WidgetHorizontalAlign';
...
import { WidgetVerticalAlign } from '../models/WidgetVerticalAlign';
...
export class ObservableAWSIntegrationApi {
     ...
     */
    public createAWSAccount(body: AWSAccount, _options?: Configuration): Observable<AWSAccountCreateResponse> {
        const requestContextPromise = this.requestFactory.createAWSAccount(body, _options);
     ...
     */
    public createAWSTagFilter(body: AWSTagFilterCreateRequest, _options?: Configuration): Observable<any> {
        const requestContextPromise = this.requestFactory.createAWSTagFilter(body, _options);
     ...
     */
    public createNewAWSExternalID(body: AWSAccount, _options?: Configuration): Observable<AWSAccountCreateResponse> {
        const requestContextPromise = this.requestFactory.createNewAWSExternalID(body, _options);
     ...
     * @param body AWS request object
     */
    public deleteAWSAccount(body: AWSAccountDeleteRequest, _options?: Configuration): Observable<any> {
        const requestContextPromise = this.requestFactory.deleteAWSAccount(body, _options);
     ...
     */
    public deleteAWSTagFilter(body: AWSTagFilterDeleteRequest, _options?: Configuration): Observable<any> {
        const requestContextPromise = this.requestFactory.deleteAWSTagFilter(body, _options);
     ...
     */
    public listAWSAccounts(accountId?: string, roleName?: string, accessKeyId?: string, _options?: Configuration): Observable<AWSAccountListResponse> {
        const requestContextPromise = this.requestFactory.listAWSAccounts(accountId, roleName, accessKeyId, _options);
     ...
     */
    public listAWSTagFilters(accountId: string, _options?: Configuration): Observable<AWSTagFilterListResponse> {
        const requestContextPromise = this.requestFactory.listAWSTagFilters(accountId, _options);
     ...
     */
    public listAvailableAWSNamespaces(_options?: Configuration): Observable<Array<string>> {
        const requestContextPromise = this.requestFactory.listAvailableAWSNamespaces(_options);
     ...
     */
    public updateAWSAccount(body: AWSAccount, accountId?: string, roleName?: string, accessKeyId?: string, _options?: Configuration): Observable<any> {
        const requestContextPromise = this.requestFactory.updateAWSAccount(body, accountId, roleName, accessKeyId, _options);
...
export class ObservableAWSLogsIntegrationApi {
     ...
     */
    public checkAWSLogsLambdaAsync(body: AWSAccountAndLambdaRequest, _options?: Configuration): Observable<AWSLogsAsyncResponse> {
        const requestContextPromise = this.requestFactory.checkAWSLogsLambdaAsync(body, _options);
     ...
     */
    public checkAWSLogsServicesAsync(body: AWSLogsServicesRequest, _options?: Configuration): Observable<AWSLogsAsyncResponse> {
        const requestContextPromise = this.requestFactory.checkAWSLogsServicesAsync(body, _options);
     ...
     */
    public createAWSLambdaARN(body: AWSAccountAndLambdaRequest, _options?: Configuration): Observable<any> {
        const requestContextPromise = this.requestFactory.createAWSLambdaARN(body, _options);
     ...
     */
    public deleteAWSLambdaARN(body: AWSAccountAndLambdaRequest, _options?: Configuration): Observable<any> {
        const requestContextPromise = this.requestFactory.deleteAWSLambdaARN(body, _options);
     ...
     */
    public enableAWSLogServices(body: AWSLogsServicesRequest, _options?: Configuration): Observable<any> {
        const requestContextPromise = this.requestFactory.enableAWSLogServices(body, _options);
     ...
     */
    public listAWSLogsIntegrations(_options?: Configuration): Observable<Array<AWSLogsListResponse>> {
        const requestContextPromise = this.requestFactory.listAWSLogsIntegrations(_options);
     ...
     */
    public listAWSLogsServices(_options?: Configuration): Observable<Array<AWSLogsListServicesResponse>> {
        const requestContextPromise = this.requestFactory.listAWSLogsServices(_options);
...
export class ObservableAuthenticationApi {
     ...
     * Validate API key
     */
    public validate(_options?: Configuration): Observable<AuthenticationValidationResponse> {
...
export class ObservableAzureIntegrationApi {
     ...
     */
    public createAzureIntegration(body: AzureAccount, _options?: Configuration): Observable<any> {
        const requestContextPromise = this.requestFactory.createAzureIntegration(body, _options);
     ...
     */
    public deleteAzureIntegration(body: AzureAccount, _options?: Configuration): Observable<any> {
        const requestContextPromise = this.requestFactory.deleteAzureIntegration(body, _options);
     ...
     */
    public listAzureIntegration(_options?: Configuration): Observable<Array<AzureAccount>> {
        const requestContextPromise = this.requestFactory.listAzureIntegration(_options);
     ...
     */
    public updateAzureHostFilters(body: AzureAccount, _options?: Configuration): Observable<any> {
        const requestContextPromise = this.requestFactory.updateAzureHostFilters(body, _options);
     ...
     */
    public updateAzureIntegration(body: AzureAccount, _options?: Configuration): Observable<any> {
        const requestContextPromise = this.requestFactory.updateAzureIntegration(body, _options);
...
export class ObservableDashboardListsApi {
     ...
     */
    public createDashboardList(body: DashboardList, _options?: Configuration): Observable<DashboardList> {
        const requestContextPromise = this.requestFactory.createDashboardList(body, _options);
     ...
     */
    public deleteDashboardList(listId: number, _options?: Configuration): Observable<DashboardListDeleteResponse> {
        const requestContextPromise = this.requestFactory.deleteDashboardList(listId, _options);
     ...
     */
    public getDashboardList(listId: number, _options?: Configuration): Observable<DashboardList> {
        const requestContextPromise = this.requestFactory.getDashboardList(listId, _options);
     ...
     */
    public listDashboardLists(_options?: Configuration): Observable<DashboardListListResponse> {
        const requestContextPromise = this.requestFactory.listDashboardLists(_options);
     ...
     */
    public updateDashboardList(listId: number, body: DashboardList, _options?: Configuration): Observable<DashboardList> {
        const requestContextPromise = this.requestFactory.updateDashboardList(listId, body, _options);
...
export class ObservableDashboardsApi {
     ...
     */
    public createDashboard(body: Dashboard, _options?: Configuration): Observable<Dashboard> {
        const requestContextPromise = this.requestFactory.createDashboard(body, _options);
     ...
     */
    public deleteDashboard(dashboardId: string, _options?: Configuration): Observable<DashboardDeleteResponse> {
        const requestContextPromise = this.requestFactory.deleteDashboard(dashboardId, _options);
     ...
     */
    public deleteDashboards(body: DashboardBulkDeleteRequest, _options?: Configuration): Observable<void> {
        const requestContextPromise = this.requestFactory.deleteDashboards(body, _options);
        ...
        return middlewarePreObservable.pipe(mergeMap((ctx: RequestContext) => this.configuration.httpApi.send(ctx))).
            pipe(mergeMap((response: ResponseContext) => {
                ...
                return middlewarePostObservable.pipe(map((rsp: ResponseContext) => this.responseProcessor.deleteDashboards(rsp)));
            }));
    }
    /**
     ...
     * @param dashboardId The ID of the dashboard.
     */
    public getDashboard(dashboardId: string, _options?: Configuration): Observable<Dashboard> {
        const requestContextPromise = this.requestFactory.getDashboard(dashboardId, _options);
     ...
     */
    public listDashboards(filterShared?: boolean, _options?: Configuration): Observable<DashboardSummary> {
        const requestContextPromise = this.requestFactory.listDashboards(filterShared, _options);
     ...
     */
    public restoreDashboards(body: DashboardRestoreRequest, _options?: Configuration): Observable<void> {
        const requestContextPromise = this.requestFactory.restoreDashboards(body, _options);
        ...
        return middlewarePreObservable.pipe(mergeMap((ctx: RequestContext) => this.configuration.httpApi.send(ctx))).
            pipe(mergeMap((response: ResponseContext) => {
                ...
                return middlewarePostObservable.pipe(map((rsp: ResponseContext) => this.responseProcessor.restoreDashboards(rsp)));
            }));
    }
    /**
     ...
     */
    public updateDashboard(dashboardId: string, body: Dashboard, _options?: Configuration): Observable<Dashboard> {
        const requestContextPromise = this.requestFactory.updateDashboard(dashboardId, body, _options);
...
export class ObservableDowntimesApi {
     ...
     */
    public cancelDowntime(downtimeId: number, _options?: Configuration): Observable<void> {
        const requestContextPromise = this.requestFactory.cancelDowntime(downtimeId, _options);
     ...
     */
    public cancelDowntimesByScope(body: CancelDowntimesByScopeRequest, _options?: Configuration): Observable<CanceledDowntimesIds> {
        const requestContextPromise = this.requestFactory.cancelDowntimesByScope(body, _options);
     ...
     */
    public createDowntime(body: Downtime, _options?: Configuration): Observable<Downtime> {
        const requestContextPromise = this.requestFactory.createDowntime(body, _options);
     ...
     */
    public getDowntime(downtimeId: number, _options?: Configuration): Observable<Downtime> {
        const requestContextPromise = this.requestFactory.getDowntime(downtimeId, _options);
     ...
     */
    public listDowntimes(currentOnly?: boolean, _options?: Configuration): Observable<Array<Downtime>> {
        const requestContextPromise = this.requestFactory.listDowntimes(currentOnly, _options);
     ...
     */
    public listMonitorDowntimes(monitorId: number, _options?: Configuration): Observable<Array<Downtime>> {
        const requestContextPromise = this.requestFactory.listMonitorDowntimes(monitorId, _options);
     ...
     */
    public updateDowntime(downtimeId: number, body: Downtime, _options?: Configuration): Observable<Downtime> {
        const requestContextPromise = this.requestFactory.updateDowntime(downtimeId, body, _options);
...
export class ObservableEventsApi {
     ...
     */
    public createEvent(body: EventCreateRequest, _options?: Configuration): Observable<EventCreateResponse> {
        const requestContextPromise = this.requestFactory.createEvent(body, _options);
     ...
     */
    public getEvent(eventId: number, _options?: Configuration): Observable<EventResponse> {
        const requestContextPromise = this.requestFactory.getEvent(eventId, _options);
     ...
     */
    public listEvents(start: number, end: number, priority?: EventPriority, sources?: string, tags?: string, unaggregated?: boolean, excludeAggregate?: boolean, page?: number, _options?: Configuration): Observable<EventListResponse> {
        const requestContextPromise = this.requestFactory.listEvents(start, end, priority, sources, tags, unaggregated, excludeAggregate, page, _options);
...
export class ObservableGCPIntegrationApi {
     ...
     */
    public createGCPIntegration(body: GCPAccount, _options?: Configuration): Observable<any> {
        const requestContextPromise = this.requestFactory.createGCPIntegration(body, _options);
     ...
     */
    public deleteGCPIntegration(body: GCPAccount, _options?: Configuration): Observable<any> {
        const requestContextPromise = this.requestFactory.deleteGCPIntegration(body, _options);
     ...
     */
    public listGCPIntegration(_options?: Configuration): Observable<Array<GCPAccount>> {
        const requestContextPromise = this.requestFactory.listGCPIntegration(_options);
     ...
     */
    public updateGCPIntegration(body: GCPAccount, _options?: Configuration): Observable<any> {
        const requestContextPromise = this.requestFactory.updateGCPIntegration(body, _options);
...
export class ObservableHostsApi {
     ...
     */
    public getHostTotals(from?: number, _options?: Configuration): Observable<HostTotals> {
        const requestContextPromise = this.requestFactory.getHostTotals(from, _options);
     ...
     */
    public listHosts(filter?: string, sortField?: string, sortDir?: string, start?: number, count?: number, from?: number, includeMutedHostsData?: boolean, includeHostsMetadata?: boolean, _options?: Configuration): Observable<HostListResponse> {
        const requestContextPromise = this.requestFactory.listHosts(filter, sortField, sortDir, start, count, from, includeMutedHostsData, includeHostsMetadata, _options);
     ...
     */
    public muteHost(hostName: string, body: HostMuteSettings, _options?: Configuration): Observable<HostMuteResponse> {
        const requestContextPromise = this.requestFactory.muteHost(hostName, body, _options);
     ...
     */
    public unmuteHost(hostName: string, _options?: Configuration): Observable<HostMuteResponse> {
        const requestContextPromise = this.requestFactory.unmuteHost(hostName, _options);
...
export class ObservableKeyManagementApi {
     ...
     * @param body 
     */
    public createAPIKey(body: ApiKey, _options?: Configuration): Observable<ApiKeyResponse> {
     ...
     * @param body 
     */
    public createApplicationKey(body: ApplicationKey, _options?: Configuration): Observable<ApplicationKeyResponse> {
        const requestContextPromise = this.requestFactory.createApplicationKey(body, _options);
     ...
     */
    public deleteAPIKey(key: string, _options?: Configuration): Observable<ApiKeyResponse> {
        const requestContextPromise = this.requestFactory.deleteAPIKey(key, _options);
     ...
     */
    public deleteApplicationKey(key: string, _options?: Configuration): Observable<ApplicationKeyResponse> {
        const requestContextPromise = this.requestFactory.deleteApplicationKey(key, _options);
     ...
     * @param key The specific API key you are working with.
     */
    public getAPIKey(key: string, _options?: Configuration): Observable<ApiKeyResponse> {
     ...
     * @param key The specific APP key you are working with.
     */
    public getApplicationKey(key: string, _options?: Configuration): Observable<ApplicationKeyResponse> {
        const requestContextPromise = this.requestFactory.getApplicationKey(key, _options);
     ...
     */
    public listApplicationKeys(_options?: Configuration): Observable<ApplicationKeyListResponse> {
        const requestContextPromise = this.requestFactory.listApplicationKeys(_options);
     ...
     * @param body 
     */
    public updateAPIKey(key: string, body: ApiKey, _options?: Configuration): Observable<ApiKeyResponse> {
        const requestContextPromise = this.requestFactory.updateAPIKey(key, body, _options);
     ...
     * @param body 
     */
    public updateApplicationKey(key: string, body: ApplicationKey, _options?: Configuration): Observable<ApplicationKeyResponse> {
        const requestContextPromise = this.requestFactory.updateApplicationKey(key, body, _options);
...
export class ObservableLogsIndexesApi {
     ...
     */
    public createLogsIndex(body: LogsIndex, _options?: Configuration): Observable<LogsIndex> {
        const requestContextPromise = this.requestFactory.createLogsIndex(body, _options);
     ...
     */
    public getLogsIndex(name: string, _options?: Configuration): Observable<LogsIndex> {
        const requestContextPromise = this.requestFactory.getLogsIndex(name, _options);
     ...
     * Get indexes order
     */
    public getLogsIndexOrder(_options?: Configuration): Observable<LogsIndexesOrder> {
        const requestContextPromise = this.requestFactory.getLogsIndexOrder(_options);
     ...
     * Get all indexes
     */
    public listLogIndexes(_options?: Configuration): Observable<LogsIndexListResponse> {
     ...
     */
    public updateLogsIndex(name: string, body: LogsIndexUpdateRequest, _options?: Configuration): Observable<LogsIndex> {
        const requestContextPromise = this.requestFactory.updateLogsIndex(name, body, _options);
     ...
     */
    public updateLogsIndexOrder(body: LogsIndexesOrder, _options?: Configuration): Observable<LogsIndexesOrder> {
        const requestContextPromise = this.requestFactory.updateLogsIndexOrder(body, _options);
...
export class ObservableLogsPipelinesApi {
     ...
     */
    public createLogsPipeline(body: LogsPipeline, _options?: Configuration): Observable<LogsPipeline> {
        const requestContextPromise = this.requestFactory.createLogsPipeline(body, _options);
     ...
     */
    public deleteLogsPipeline(pipelineId: string, _options?: Configuration): Observable<void> {
        const requestContextPromise = this.requestFactory.deleteLogsPipeline(pipelineId, _options);
     ...
     */
    public getLogsPipeline(pipelineId: string, _options?: Configuration): Observable<LogsPipeline> {
        const requestContextPromise = this.requestFactory.getLogsPipeline(pipelineId, _options);
     ...
     * Get pipeline order
     */
    public getLogsPipelineOrder(_options?: Configuration): Observable<LogsPipelinesOrder> {
        const requestContextPromise = this.requestFactory.getLogsPipelineOrder(_options);
     ...
     * Get all pipelines
     */
    public listLogsPipelines(_options?: Configuration): Observable<Array<LogsPipeline>> {
        const requestContextPromise = this.requestFactory.listLogsPipelines(_options);
     ...
     */
    public updateLogsPipeline(pipelineId: string, body: LogsPipeline, _options?: Configuration): Observable<LogsPipeline> {
        const requestContextPromise = this.requestFactory.updateLogsPipeline(pipelineId, body, _options);
     ...
     */
    public updateLogsPipelineOrder(body: LogsPipelinesOrder, _options?: Configuration): Observable<LogsPipelinesOrder> {
        const requestContextPromise = this.requestFactory.updateLogsPipelineOrder(body, _options);
...
export class ObservableMetricsApi {
     ...
     */
    public getMetricMetadata(metricName: string, _options?: Configuration): Observable<MetricMetadata> {
        const requestContextPromise = this.requestFactory.getMetricMetadata(metricName, _options);
     ...
     */
    public listActiveMetrics(from: number, host?: string, tagFilter?: string, _options?: Configuration): Observable<MetricsListResponse> {
        const requestContextPromise = this.requestFactory.listActiveMetrics(from, host, tagFilter, _options);
     ...
     */
    public listMetrics(q: string, _options?: Configuration): Observable<MetricSearchResponse> {
     ...
     */
    public queryMetrics(from: number, to: number, query: string, _options?: Configuration): Observable<MetricsQueryResponse> {
        const requestContextPromise = this.requestFactory.queryMetrics(from, to, query, _options);
     ...
     * @param contentEncoding HTTP header used to compress the media-type.
     */
    public submitMetrics(body: MetricsPayload, contentEncoding?: MetricContentEncoding, _options?: Configuration): Observable<IntakePayloadAccepted> {
        const requestContextPromise = this.requestFactory.submitMetrics(body, contentEncoding, _options);
     ...
     */
    public updateMetricMetadata(metricName: string, body: MetricMetadata, _options?: Configuration): Observable<MetricMetadata> {
        const requestContextPromise = this.requestFactory.updateMetricMetadata(metricName, body, _options);
...
export class ObservableMonitorsApi {
     ...
     */
    public checkCanDeleteMonitor(monitorIds: Array<number>, _options?: Configuration): Observable<CheckCanDeleteMonitorResponse> {
        const requestContextPromise = this.requestFactory.checkCanDeleteMonitor(monitorIds, _options);
     ...
     */
    public createMonitor(body: Monitor, _options?: Configuration): Observable<Monitor> {
        const requestContextPromise = this.requestFactory.createMonitor(body, _options);
     ...
     */
    public deleteMonitor(monitorId: number, force?: string, _options?: Configuration): Observable<DeletedMonitor> {
        const requestContextPromise = this.requestFactory.deleteMonitor(monitorId, force, _options);
     ...
     */
    public getMonitor(monitorId: number, groupStates?: string, _options?: Configuration): Observable<Monitor> {
        const requestContextPromise = this.requestFactory.getMonitor(monitorId, groupStates, _options);
     ...
     */
    public listMonitors(groupStates?: string, name?: string, tags?: string, monitorTags?: string, withDowntimes?: boolean, idOffset?: number, page?: number, pageSize?: number, _options?: Configuration): Observable<Array<Monitor>> {
        const requestContextPromise = this.requestFactory.listMonitors(groupStates, name, tags, monitorTags, withDowntimes, idOffset, page, pageSize, _options);
     ...
     */
    public searchMonitorGroups(query?: string, page?: number, perPage?: number, sort?: string, _options?: Configuration): Observable<MonitorGroupSearchResponse> {
        const requestContextPromise = this.requestFactory.searchMonitorGroups(query, page, perPage, sort, _options);
     ...
     * @param sort String for sort order, composed of field and sort order separate by a comma, for example &#x60;name,asc&#x60;. Supported sort directions: &#x60;asc&#x60;, &#x60;desc&#x60;. Supported fields:  * &#x60;name&#x60; * &#x60;status&#x60; * &#x60;tags&#x60;
     */
    public searchMonitors(query?: string, page?: number, perPage?: number, sort?: string, _options?: Configuration): Observable<MonitorSearchResponse> {
        const requestContextPromise = this.requestFactory.searchMonitors(query, page, perPage, sort, _options);
     ...
     */
    public updateMonitor(monitorId: number, body: MonitorUpdateRequest, _options?: Configuration): Observable<Monitor> {
        const requestContextPromise = this.requestFactory.updateMonitor(monitorId, body, _options);
     ...
     */
    public validateMonitor(body: Monitor, _options?: Configuration): Observable<any> {
        const requestContextPromise = this.requestFactory.validateMonitor(body, _options);
...
export class ObservableNotebooksApi {
     ...
     */
    public createNotebook(body: NotebookCreateRequest, _options?: Configuration): Observable<NotebookResponse> {
        const requestContextPromise = this.requestFactory.createNotebook(body, _options);
     ...
     */
    public deleteNotebook(notebookId: number, _options?: Configuration): Observable<void> {
        const requestContextPromise = this.requestFactory.deleteNotebook(notebookId, _options);
     ...
     * @param notebookId Unique ID, assigned when you create the notebook.
     */
    public getNotebook(notebookId: number, _options?: Configuration): Observable<NotebookResponse> {
        const requestContextPromise = this.requestFactory.getNotebook(notebookId, _options);
     ...
     */
    public listNotebooks(authorHandle?: string, excludeAuthorHandle?: string, start?: number, count?: number, sortField?: string, sortDir?: string, query?: string, includeCells?: boolean, isTemplate?: boolean, type?: string, _options?: Configuration): Observable<NotebooksResponse> {
        const requestContextPromise = this.requestFactory.listNotebooks(authorHandle, excludeAuthorHandle, start, count, sortField, sortDir, query, includeCells, isTemplate, type, _options);
     ...
     */
    public updateNotebook(notebookId: number, body: NotebookUpdateRequest, _options?: Configuration): Observable<NotebookResponse> {
        const requestContextPromise = this.requestFactory.updateNotebook(notebookId, body, _options);
...
export class ObservableOrganizationsApi {
     ...
     */
    public createChildOrg(body: OrganizationCreateBody, _options?: Configuration): Observable<OrganizationCreateResponse> {
        const requestContextPromise = this.requestFactory.createChildOrg(body, _options);
     ...
     */
    public getOrg(publicId: string, _options?: Configuration): Observable<OrganizationResponse> {
        const requestContextPromise = this.requestFactory.getOrg(publicId, _options);
     ...
     * List your managed organizations
     */
    public listOrgs(_options?: Configuration): Observable<OrganizationListResponse> {
     ...
     * @param body 
     */
    public updateOrg(publicId: string, body: Organization, _options?: Configuration): Observable<OrganizationResponse> {
        const requestContextPromise = this.requestFactory.updateOrg(publicId, body, _options);
     ...
     */
    public uploadIdPForOrg(publicId: string, idpFile: HttpFile, _options?: Configuration): Observable<IdpResponse> {
        const requestContextPromise = this.requestFactory.uploadIdPForOrg(publicId, idpFile, _options);
...
export class ObservablePagerDutyIntegrationApi {
     ...
     */
    public createPagerDutyIntegrationService(body: PagerDutyService, _options?: Configuration): Observable<PagerDutyServiceName> {
        const requestContextPromise = this.requestFactory.createPagerDutyIntegrationService(body, _options);
     ...
     */
    public deletePagerDutyIntegrationService(serviceName: string, _options?: Configuration): Observable<void> {
        const requestContextPromise = this.requestFactory.deletePagerDutyIntegrationService(serviceName, _options);
     ...
     * @param serviceName The service name.
     */
    public getPagerDutyIntegrationService(serviceName: string, _options?: Configuration): Observable<PagerDutyServiceName> {
        const requestContextPromise = this.requestFactory.getPagerDutyIntegrationService(serviceName, _options);
     ...
     */
    public updatePagerDutyIntegrationService(serviceName: string, body: PagerDutyServiceKey, _options?: Configuration): Observable<void> {
        const requestContextPromise = this.requestFactory.updatePagerDutyIntegrationService(serviceName, body, _options);
...
export class ObservableServiceChecksApi {
     ...
     */
    public submitServiceCheck(body: Array<ServiceCheck>, _options?: Configuration): Observable<IntakePayloadAccepted> {
        const requestContextPromise = this.requestFactory.submitServiceCheck(body, _options);
...
export class ObservableServiceLevelObjectiveCorrectionsApi {
     ...
     */
    public createSLOCorrection(body: SLOCorrectionCreateRequest, _options?: Configuration): Observable<SLOCorrectionResponse> {
        const requestContextPromise = this.requestFactory.createSLOCorrection(body, _options);
     ...
     */
    public deleteSLOCorrection(sloCorrectionId: string, _options?: Configuration): Observable<void> {
        const requestContextPromise = this.requestFactory.deleteSLOCorrection(sloCorrectionId, _options);
     ...
     * @param sloCorrectionId The ID of the SLO correction object.
     */
    public getSLOCorrection(sloCorrectionId: string, _options?: Configuration): Observable<SLOCorrectionResponse> {
        const requestContextPromise = this.requestFactory.getSLOCorrection(sloCorrectionId, _options);
     ...
     */
    public listSLOCorrection(_options?: Configuration): Observable<SLOCorrectionListResponse> {
        const requestContextPromise = this.requestFactory.listSLOCorrection(_options);
     ...
     */
    public updateSLOCorrection(sloCorrectionId: string, body: SLOCorrectionUpdateRequest, _options?: Configuration): Observable<SLOCorrectionResponse> {
        const requestContextPromise = this.requestFactory.updateSLOCorrection(sloCorrectionId, body, _options);
...
export class ObservableServiceLevelObjectivesApi {
     ...
     */
    public checkCanDeleteSLO(ids: string, _options?: Configuration): Observable<CheckCanDeleteSLOResponse> {
        const requestContextPromise = this.requestFactory.checkCanDeleteSLO(ids, _options);
     ...
     */
    public createSLO(body: ServiceLevelObjectiveRequest, _options?: Configuration): Observable<SLOListResponse> {
     ...
     * @param force Delete the monitor even if it&#39;s referenced by other resources (for example SLO, composite monitor).
     */
    public deleteSLO(sloId: string, force?: string, _options?: Configuration): Observable<SLODeleteResponse> {
        const requestContextPromise = this.requestFactory.deleteSLO(sloId, force, _options);
     ...
     */
    public deleteSLOTimeframeInBulk(body: { [key: string]: Array<SLOTimeframe>; }, _options?: Configuration): Observable<SLOBulkDeleteResponse> {
        const requestContextPromise = this.requestFactory.deleteSLOTimeframeInBulk(body, _options);
     ...
     */
    public getSLO(sloId: string, withConfiguredAlertIds?: boolean, _options?: Configuration): Observable<SLOResponse> {
        const requestContextPromise = this.requestFactory.getSLO(sloId, withConfiguredAlertIds, _options);
     ...
     * @param sloId The ID of the service level objective object.
     */
    public getSLOCorrections(sloId: string, _options?: Configuration): Observable<SLOCorrectionListResponse> {
        const requestContextPromise = this.requestFactory.getSLOCorrections(sloId, _options);
        ...
        return middlewarePreObservable.pipe(mergeMap((ctx: RequestContext) => this.configuration.httpApi.send(ctx))).
            pipe(mergeMap((response: ResponseContext) => {
                ...
                return middlewarePostObservable.pipe(map((rsp: ResponseContext) => this.responseProcessor.getSLOCorrections(rsp)));
            }));
    }
    /**
     ...
     */
    public getSLOHistory(sloId: string, fromTs: number, toTs: number, target?: number, applyCorrection?: boolean, _options?: Configuration): Observable<SLOHistoryResponse> {
        const requestContextPromise = this.requestFactory.getSLOHistory(sloId, fromTs, toTs, target, applyCorrection, _options);
     ...
     */
    public listSLOs(ids?: string, query?: string, tagsQuery?: string, metricsQuery?: string, limit?: number, offset?: number, _options?: Configuration): Observable<SLOListResponse> {
        const requestContextPromise = this.requestFactory.listSLOs(ids, query, tagsQuery, metricsQuery, limit, offset, _options);
     ...
     */
    public updateSLO(sloId: string, body: ServiceLevelObjective, _options?: Configuration): Observable<SLOListResponse> {
        const requestContextPromise = this.requestFactory.updateSLO(sloId, body, _options);
...
export class ObservableSlackIntegrationApi {
     ...
     */
    public createSlackIntegrationChannel(accountName: string, body: SlackIntegrationChannel, _options?: Configuration): Observable<SlackIntegrationChannel> {
        const requestContextPromise = this.requestFactory.createSlackIntegrationChannel(accountName, body, _options);
     ...
     */
    public getSlackIntegrationChannel(accountName: string, channelName: string, _options?: Configuration): Observable<SlackIntegrationChannel> {
        const requestContextPromise = this.requestFactory.getSlackIntegrationChannel(accountName, channelName, _options);
     ...
     * @param accountName Your Slack account name.
     */
    public getSlackIntegrationChannels(accountName: string, _options?: Configuration): Observable<Array<SlackIntegrationChannel>> {
        const requestContextPromise = this.requestFactory.getSlackIntegrationChannels(accountName, _options);
     ...
     * @param channelName The name of the Slack channel being operated on.
     */
    public removeSlackIntegrationChannel(accountName: string, channelName: string, _options?: Configuration): Observable<void> {
        const requestContextPromise = this.requestFactory.removeSlackIntegrationChannel(accountName, channelName, _options);
     ...
     */
    public updateSlackIntegrationChannel(accountName: string, channelName: string, body: SlackIntegrationChannel, _options?: Configuration): Observable<SlackIntegrationChannel> {
        const requestContextPromise = this.requestFactory.updateSlackIntegrationChannel(accountName, channelName, body, _options);
...
export class ObservableSnapshotsApi {
     ...
     */
    public getGraphSnapshot(start: number, end: number, metricQuery?: string, eventQuery?: string, graphDef?: string, title?: string, _options?: Configuration): Observable<GraphSnapshot> {
        const requestContextPromise = this.requestFactory.getGraphSnapshot(start, end, metricQuery, eventQuery, graphDef, title, _options);
...
export class ObservableSyntheticsApi {
     ...
     */
    public createGlobalVariable(body: SyntheticsGlobalVariable, _options?: Configuration): Observable<SyntheticsGlobalVariable> {
        const requestContextPromise = this.requestFactory.createGlobalVariable(body, _options);
     ...
     */
    public createPrivateLocation(body: SyntheticsPrivateLocation, _options?: Configuration): Observable<SyntheticsPrivateLocationCreationResponse> {
        const requestContextPromise = this.requestFactory.createPrivateLocation(body, _options);
     ...
     */
    public createSyntheticsAPITest(body: SyntheticsAPITest, _options?: Configuration): Observable<SyntheticsAPITest> {
        const requestContextPromise = this.requestFactory.createSyntheticsAPITest(body, _options);
     ...
     * @param body Details of the test to create.
     */
    public createSyntheticsBrowserTest(body: SyntheticsBrowserTest, _options?: Configuration): Observable<SyntheticsBrowserTest> {
        const requestContextPromise = this.requestFactory.createSyntheticsBrowserTest(body, _options);
     ...
     */
    public deleteGlobalVariable(variableId: string, _options?: Configuration): Observable<void> {
        const requestContextPromise = this.requestFactory.deleteGlobalVariable(variableId, _options);
     ...
     */
    public deletePrivateLocation(locationId: string, _options?: Configuration): Observable<void> {
        const requestContextPromise = this.requestFactory.deletePrivateLocation(locationId, _options);
     ...
     */
    public deleteTests(body: SyntheticsDeleteTestsPayload, _options?: Configuration): Observable<SyntheticsDeleteTestsResponse> {
        const requestContextPromise = this.requestFactory.deleteTests(body, _options);
     ...
     */
    public editGlobalVariable(variableId: string, body: SyntheticsGlobalVariable, _options?: Configuration): Observable<SyntheticsGlobalVariable> {
        const requestContextPromise = this.requestFactory.editGlobalVariable(variableId, body, _options);
     ...
     */
    public getAPITest(publicId: string, _options?: Configuration): Observable<SyntheticsAPITest> {
        const requestContextPromise = this.requestFactory.getAPITest(publicId, _options);
     ...
     */
    public getAPITestLatestResults(publicId: string, fromTs?: number, toTs?: number, probeDc?: Array<string>, _options?: Configuration): Observable<SyntheticsGetAPITestLatestResultsResponse> {
        const requestContextPromise = this.requestFactory.getAPITestLatestResults(publicId, fromTs, toTs, probeDc, _options);
     ...
     */
    public getAPITestResult(publicId: string, resultId: string, _options?: Configuration): Observable<SyntheticsAPITestResultFull> {
        const requestContextPromise = this.requestFactory.getAPITestResult(publicId, resultId, _options);
     ...
     * @param publicId The public ID of the test to get details from.
     */
    public getBrowserTest(publicId: string, _options?: Configuration): Observable<SyntheticsBrowserTest> {
        const requestContextPromise = this.requestFactory.getBrowserTest(publicId, _options);
     ...
     * @param probeDc Locations for which to query results.
     */
    public getBrowserTestLatestResults(publicId: string, fromTs?: number, toTs?: number, probeDc?: Array<string>, _options?: Configuration): Observable<SyntheticsGetBrowserTestLatestResultsResponse> {
        const requestContextPromise = this.requestFactory.getBrowserTestLatestResults(publicId, fromTs, toTs, probeDc, _options);
     ...
     * @param resultId The ID of the result to get.
     */
    public getBrowserTestResult(publicId: string, resultId: string, _options?: Configuration): Observable<SyntheticsBrowserTestResultFull> {
        const requestContextPromise = this.requestFactory.getBrowserTestResult(publicId, resultId, _options);
     ...
     * @param variableId The ID of the global variable.
     */
    public getGlobalVariable(variableId: string, _options?: Configuration): Observable<SyntheticsGlobalVariable> {
        const requestContextPromise = this.requestFactory.getGlobalVariable(variableId, _options);
     ...
     * @param locationId The ID of the private location.
     */
    public getPrivateLocation(locationId: string, _options?: Configuration): Observable<SyntheticsPrivateLocation> {
        const requestContextPromise = this.requestFactory.getPrivateLocation(locationId, _options);
     ...
     */
    public getSyntheticsCIBatch(batchId: string, _options?: Configuration): Observable<SyntheticsBatchDetails> {
        const requestContextPromise = this.requestFactory.getSyntheticsCIBatch(batchId, _options);
        ...
        return middlewarePreObservable.pipe(mergeMap((ctx: RequestContext) => this.configuration.httpApi.send(ctx))).
            pipe(mergeMap((response: ResponseContext) => {
                ...
                return middlewarePostObservable.pipe(map((rsp: ResponseContext) => this.responseProcessor.getSyntheticsCIBatch(rsp)));
            }));
    }
    /**
     ...
     * @param publicId The public ID of the test to get details from.
     */
    public getTest(publicId: string, _options?: Configuration): Observable<SyntheticsTestDetails> {
        const requestContextPromise = this.requestFactory.getTest(publicId, _options);
     ...
     */
    public listGlobalVariables(_options?: Configuration): Observable<SyntheticsListGlobalVariablesResponse> {
        const requestContextPromise = this.requestFactory.listGlobalVariables(_options);
     ...
     */
    public listLocations(_options?: Configuration): Observable<SyntheticsLocations> {
     ...
     */
    public listTests(_options?: Configuration): Observable<SyntheticsListTestsResponse> {
     ...
     */
    public triggerCITests(body: SyntheticsCITestBody, _options?: Configuration): Observable<SyntheticsTriggerCITestsResponse> {
        const requestContextPromise = this.requestFactory.triggerCITests(body, _options);
     ...
     */
    public triggerTests(body: SyntheticsTriggerBody, _options?: Configuration): Observable<SyntheticsTriggerCITestsResponse> {
        const requestContextPromise = this.requestFactory.triggerTests(body, _options);
        ...
        return middlewarePreObservable.pipe(mergeMap((ctx: RequestContext) => this.configuration.httpApi.send(ctx))).
            pipe(mergeMap((response: ResponseContext) => {
                ...
                return middlewarePostObservable.pipe(map((rsp: ResponseContext) => this.responseProcessor.triggerTests(rsp)));
            }));
    }
    /**
     ...
     */
    public updateAPITest(publicId: string, body: SyntheticsAPITest, _options?: Configuration): Observable<SyntheticsAPITest> {
        const requestContextPromise = this.requestFactory.updateAPITest(publicId, body, _options);
     ...
     * @param body New test details to be saved.
     */
    public updateBrowserTest(publicId: string, body: SyntheticsBrowserTest, _options?: Configuration): Observable<SyntheticsBrowserTest> {
        const requestContextPromise = this.requestFactory.updateBrowserTest(publicId, body, _options);
     ...
     */
    public updatePrivateLocation(locationId: string, body: SyntheticsPrivateLocation, _options?: Configuration): Observable<SyntheticsPrivateLocation> {
        const requestContextPromise = this.requestFactory.updatePrivateLocation(locationId, body, _options);
     ...
     */
    public updateTestPauseStatus(publicId: string, body: SyntheticsUpdateTestPauseStatusPayload, _options?: Configuration): Observable<boolean> {
        const requestContextPromise = this.requestFactory.updateTestPauseStatus(publicId, body, _options);
...
export class ObservableTagsApi {
     ...
     */
    public createHostTags(hostName: string, body: HostTags, source?: string, _options?: Configuration): Observable<HostTags> {
        const requestContextPromise = this.requestFactory.createHostTags(hostName, body, source, _options);
     ...
     */
    public deleteHostTags(hostName: string, source?: string, _options?: Configuration): Observable<void> {
        const requestContextPromise = this.requestFactory.deleteHostTags(hostName, source, _options);
     ...
     */
    public getHostTags(hostName: string, source?: string, _options?: Configuration): Observable<HostTags> {
        const requestContextPromise = this.requestFactory.getHostTags(hostName, source, _options);
     ...
     */
    public listHostTags(source?: string, _options?: Configuration): Observable<TagToHosts> {
        const requestContextPromise = this.requestFactory.listHostTags(source, _options);
     ...
     * @param source The source of the tags (for example chef, puppet). [Complete list of source attribute values](https://docs.datadoghq.com/integrations/faq/list-of-api-source-attribute-value)
     */
    public updateHostTags(hostName: string, body: HostTags, source?: string, _options?: Configuration): Observable<HostTags> {
        const requestContextPromise = this.requestFactory.updateHostTags(hostName, body, source, _options);
...
export class ObservableUsageMeteringApi {
     ...
     */
    public getDailyCustomReports(pageSize?: number, pageNumber?: number, sortDir?: UsageSortDirection, sort?: UsageSort, _options?: Configuration): Observable<UsageCustomReportsResponse> {
        const requestContextPromise = this.requestFactory.getDailyCustomReports(pageSize, pageNumber, sortDir, sort, _options);
     ...
     */
    public getHourlyUsageAttribution(startHr: Date, usageType: HourlyUsageAttributionUsageType, endHr?: Date, nextRecordId?: string, tagBreakdownKeys?: string, _options?: Configuration): Observable<HourlyUsageAttributionResponse> {
        const requestContextPromise = this.requestFactory.getHourlyUsageAttribution(startHr, usageType, endHr, nextRecordId, tagBreakdownKeys, _options);
        ...
        return middlewarePreObservable.pipe(mergeMap((ctx: RequestContext) => this.configuration.httpApi.send(ctx))).
            pipe(mergeMap((response: ResponseContext) => {
                ...
                return middlewarePostObservable.pipe(map((rsp: ResponseContext) => this.responseProcessor.getHourlyUsageAttribution(rsp)));
            }));
    }
    /**
     ...
     * @param endHr Datetime in ISO-8601 format, UTC, precise to hour: &#x60;[YYYY-MM-DDThh]&#x60; for usage ending **before** this hour.
     */
    public getIncidentManagement(startHr: Date, endHr?: Date, _options?: Configuration): Observable<UsageIncidentManagementResponse> {
        const requestContextPromise = this.requestFactory.getIncidentManagement(startHr, endHr, _options);
     ...
     * @param endHr Datetime in ISO-8601 format, UTC, precise to hour: &#x60;[YYYY-MM-DDThh]&#x60; for usage ending **before** this hour.
     */
    public getIngestedSpans(startHr: Date, endHr?: Date, _options?: Configuration): Observable<UsageIngestedSpansResponse> {
        const requestContextPromise = this.requestFactory.getIngestedSpans(startHr, endHr, _options);
     ...
     * @param sort The field to sort by: &#x60;[computed_on, size, start_date, end_date]&#x60;.
     */
    public getMonthlyCustomReports(pageSize?: number, pageNumber?: number, sortDir?: UsageSortDirection, sort?: UsageSort, _options?: Configuration): Observable<UsageCustomReportsResponse> {
        const requestContextPromise = this.requestFactory.getMonthlyCustomReports(pageSize, pageNumber, sortDir, sort, _options);
     ...
     */
    public getSpecifiedDailyCustomReports(reportId: string, _options?: Configuration): Observable<UsageSpecifiedCustomReportsResponse> {
        const requestContextPromise = this.requestFactory.getSpecifiedDailyCustomReports(reportId, _options);
     ...
     * @param reportId Date of the report in the format &#x60;YYYY-MM-DD&#x60;.
     */
    public getSpecifiedMonthlyCustomReports(reportId: string, _options?: Configuration): Observable<UsageSpecifiedCustomReportsResponse> {
        const requestContextPromise = this.requestFactory.getSpecifiedMonthlyCustomReports(reportId, _options);
     ...
     * @param endHr Datetime in ISO-8601 format, UTC, precise to hour: &#x60;[YYYY-MM-DDThh]&#x60; for usage ending **before** this hour.
     */
    public getUsageAnalyzedLogs(startHr: Date, endHr?: Date, _options?: Configuration): Observable<UsageAnalyzedLogsResponse> {
        const requestContextPromise = this.requestFactory.getUsageAnalyzedLogs(startHr, endHr, _options);
     ...
     */
    public getUsageAttribution(startMonth: Date, fields: UsageAttributionSupportedMetrics, endMonth?: Date, sortDirection?: UsageSortDirection, sortName?: UsageAttributionSort, includeDescendants?: boolean, _options?: Configuration): Observable<UsageAttributionResponse> {
        const requestContextPromise = this.requestFactory.getUsageAttribution(startMonth, fields, endMonth, sortDirection, sortName, includeDescendants, _options);
     ...
     * @param endHr Datetime in ISO-8601 format, UTC, precise to hour: &#x60;[YYYY-MM-DDThh]&#x60; for usage ending **before** this hour.
     */
    public getUsageAuditLogs(startHr: Date, endHr?: Date, _options?: Configuration): Observable<UsageAuditLogsResponse> {
        const requestContextPromise = this.requestFactory.getUsageAuditLogs(startHr, endHr, _options);
     ...
     */
    public getUsageBillableSummary(month?: Date, _options?: Configuration): Observable<UsageBillableSummaryResponse> {
        const requestContextPromise = this.requestFactory.getUsageBillableSummary(month, _options);
     ...
     * @param endHr Datetime in ISO-8601 format, UTC, precise to hour: &#x60;[YYYY-MM-DDThh]&#x60; for usage ending **before** this hour.
     */
    public getUsageCWS(startHr: Date, endHr?: Date, _options?: Configuration): Observable<UsageCWSResponse> {
        const requestContextPromise = this.requestFactory.getUsageCWS(startHr, endHr, _options);
        ...
        return middlewarePreObservable.pipe(mergeMap((ctx: RequestContext) => this.configuration.httpApi.send(ctx))).
            pipe(mergeMap((response: ResponseContext) => {
                ...
                return middlewarePostObservable.pipe(map((rsp: ResponseContext) => this.responseProcessor.getUsageCWS(rsp)));
            }));
    }
    /**
     ...
     * @param endHr Datetime in ISO-8601 format, UTC, precise to hour: &#x60;[YYYY-MM-DDThh]&#x60; for usage ending **before** this hour.
     */
    public getUsageCloudSecurityPostureManagement(startHr: Date, endHr?: Date, _options?: Configuration): Observable<UsageCloudSecurityPostureManagementResponse> {
        const requestContextPromise = this.requestFactory.getUsageCloudSecurityPostureManagement(startHr, endHr, _options);
     ...
     * @param endHr Datetime in ISO-8601 format, UTC, precise to hour: &#x60;[YYYY-MM-DDThh]&#x60; for usage ending **before** this hour.
     */
    public getUsageDBM(startHr: Date, endHr?: Date, _options?: Configuration): Observable<UsageDBMResponse> {
        const requestContextPromise = this.requestFactory.getUsageDBM(startHr, endHr, _options);
        ...
        return middlewarePreObservable.pipe(mergeMap((ctx: RequestContext) => this.configuration.httpApi.send(ctx))).
            pipe(mergeMap((response: ResponseContext) => {
                ...
                return middlewarePostObservable.pipe(map((rsp: ResponseContext) => this.responseProcessor.getUsageDBM(rsp)));
            }));
    }
    /**
     ...
     * @param endHr Datetime in ISO-8601 format, UTC, precise to hour: [YYYY-MM-DDThh] for usage ending **before** this hour.
     */
    public getUsageFargate(startHr: Date, endHr?: Date, _options?: Configuration): Observable<UsageFargateResponse> {
        const requestContextPromise = this.requestFactory.getUsageFargate(startHr, endHr, _options);
     ...
     * @param endHr Datetime in ISO-8601 format, UTC, precise to hour: [YYYY-MM-DDThh] for usage ending **before** this hour.
     */
    public getUsageHosts(startHr: Date, endHr?: Date, _options?: Configuration): Observable<UsageHostsResponse> {
        const requestContextPromise = this.requestFactory.getUsageHosts(startHr, endHr, _options);
     ...
     * @param endHr Datetime in ISO-8601 format, UTC, precise to hour: &#x60;[YYYY-MM-DDThh]&#x60; for usage ending **before** this hour.
     */
    public getUsageIndexedSpans(startHr: Date, endHr?: Date, _options?: Configuration): Observable<UsageIndexedSpansResponse> {
        const requestContextPromise = this.requestFactory.getUsageIndexedSpans(startHr, endHr, _options);
     ...
     * @param endHr Datetime in ISO-8601 format, UTC, precise to hour: &#x60;[YYYY-MM-DDThh]&#x60; for usage ending **before** this hour.
     */
    public getUsageInternetOfThings(startHr: Date, endHr?: Date, _options?: Configuration): Observable<UsageIoTResponse> {
        const requestContextPromise = this.requestFactory.getUsageInternetOfThings(startHr, endHr, _options);
     ...
     * @param endHr Datetime in ISO-8601 format, UTC, precise to hour: [YYYY-MM-DDThh] for usage ending **before** this hour.
     */
    public getUsageLambda(startHr: Date, endHr?: Date, _options?: Configuration): Observable<UsageLambdaResponse> {
        const requestContextPromise = this.requestFactory.getUsageLambda(startHr, endHr, _options);
     ...
     * @param endHr Datetime in ISO-8601 format, UTC, precise to hour: [YYYY-MM-DDThh] for usage ending **before** this hour.
     */
    public getUsageLogs(startHr: Date, endHr?: Date, _options?: Configuration): Observable<UsageLogsResponse> {
        const requestContextPromise = this.requestFactory.getUsageLogs(startHr, endHr, _options);
     ...
     */
    public getUsageLogsByIndex(startHr: Date, endHr?: Date, indexName?: Array<string>, _options?: Configuration): Observable<UsageLogsByIndexResponse> {
        const requestContextPromise = this.requestFactory.getUsageLogsByIndex(startHr, endHr, indexName, _options);
     ...
     * @param endHr Datetime in ISO-8601 format, UTC, precise to hour: &#x60;[YYYY-MM-DDThh]&#x60; for usage ending **before** this hour.
     */
    public getUsageLogsByRetention(startHr: Date, endHr?: Date, _options?: Configuration): Observable<UsageLogsByRetentionResponse> {
        const requestContextPromise = this.requestFactory.getUsageLogsByRetention(startHr, endHr, _options);
     ...
     * @param endHr Datetime in ISO-8601 format, UTC, precise to hour: &#x60;[YYYY-MM-DDThh]&#x60; for usage ending **before** this hour.
     */
    public getUsageNetworkFlows(startHr: Date, endHr?: Date, _options?: Configuration): Observable<UsageNetworkFlowsResponse> {
        const requestContextPromise = this.requestFactory.getUsageNetworkFlows(startHr, endHr, _options);
     ...
     * @param endHr Datetime in ISO-8601 format, UTC, precise to hour: [YYYY-MM-DDThh] for usage ending **before** this hour.
     */
    public getUsageNetworkHosts(startHr: Date, endHr?: Date, _options?: Configuration): Observable<UsageNetworkHostsResponse> {
        const requestContextPromise = this.requestFactory.getUsageNetworkHosts(startHr, endHr, _options);
     ...
     * @param endHr Datetime in ISO-8601 format, UTC, precise to hour: &#x60;[YYYY-MM-DDThh]&#x60; for usage ending **before** this hour.
     */
    public getUsageProfiling(startHr: Date, endHr?: Date, _options?: Configuration): Observable<UsageProfilingResponse> {
        const requestContextPromise = this.requestFactory.getUsageProfiling(startHr, endHr, _options);
     ...
     */
    public getUsageRumSessions(startHr: Date, endHr?: Date, type?: string, _options?: Configuration): Observable<UsageRumSessionsResponse> {
        const requestContextPromise = this.requestFactory.getUsageRumSessions(startHr, endHr, type, _options);
     ...
     * @param endHr Datetime in ISO-8601 format, UTC, precise to hour: [YYYY-MM-DDThh] for usage ending **before** this hour.
     */
    public getUsageRumUnits(startHr: Date, endHr?: Date, _options?: Configuration): Observable<UsageRumUnitsResponse> {
        const requestContextPromise = this.requestFactory.getUsageRumUnits(startHr, endHr, _options);
        ...
        return middlewarePreObservable.pipe(mergeMap((ctx: RequestContext) => this.configuration.httpApi.send(ctx))).
            pipe(mergeMap((response: ResponseContext) => {
                ...
                return middlewarePostObservable.pipe(map((rsp: ResponseContext) => this.responseProcessor.getUsageRumUnits(rsp)));
            }));
    }
    /**
     ...
     * @param endHr Datetime in ISO-8601 format, UTC, precise to hour: &#x60;[YYYY-MM-DDThh]&#x60; for usage ending **before** this hour.
     */
    public getUsageSDS(startHr: Date, endHr?: Date, _options?: Configuration): Observable<UsageSDSResponse> {
        const requestContextPromise = this.requestFactory.getUsageSDS(startHr, endHr, _options);
        ...
        return middlewarePreObservable.pipe(mergeMap((ctx: RequestContext) => this.configuration.httpApi.send(ctx))).
            pipe(mergeMap((response: ResponseContext) => {
                ...
                return middlewarePostObservable.pipe(map((rsp: ResponseContext) => this.responseProcessor.getUsageSDS(rsp)));
            }));
    }
    /**
     ...
     * @param endHr Datetime in ISO-8601 format, UTC, precise to hour: &#x60;[YYYY-MM-DDThh]&#x60; for usage ending **before** this hour.
     */
    public getUsageSNMP(startHr: Date, endHr?: Date, _options?: Configuration): Observable<UsageSNMPResponse> {
        const requestContextPromise = this.requestFactory.getUsageSNMP(startHr, endHr, _options);
     ...
     */
    public getUsageSummary(startMonth: Date, endMonth?: Date, includeOrgDetails?: boolean, _options?: Configuration): Observable<UsageSummaryResponse> {
        const requestContextPromise = this.requestFactory.getUsageSummary(startMonth, endMonth, includeOrgDetails, _options);
     ...
     * @param endHr Datetime in ISO-8601 format, UTC, precise to hour: [YYYY-MM-DDThh] for usage ending **before** this hour.
     */
    public getUsageSynthetics(startHr: Date, endHr?: Date, _options?: Configuration): Observable<UsageSyntheticsResponse> {
        const requestContextPromise = this.requestFactory.getUsageSynthetics(startHr, endHr, _options);
     ...
     * @param endHr Datetime in ISO-8601 format, UTC, precise to hour: [YYYY-MM-DDThh] for usage ending **before** this hour.
     */
    public getUsageSyntheticsAPI(startHr: Date, endHr?: Date, _options?: Configuration): Observable<UsageSyntheticsAPIResponse> {
        const requestContextPromise = this.requestFactory.getUsageSyntheticsAPI(startHr, endHr, _options);
     ...
     * @param endHr Datetime in ISO-8601 format, UTC, precise to hour: [YYYY-MM-DDThh] for usage ending **before** this hour.
     */
    public getUsageSyntheticsBrowser(startHr: Date, endHr?: Date, _options?: Configuration): Observable<UsageSyntheticsBrowserResponse> {
        const requestContextPromise = this.requestFactory.getUsageSyntheticsBrowser(startHr, endHr, _options);
     ...
     * @param endHr Datetime in ISO-8601 format, UTC, precise to hour: [YYYY-MM-DDThh] for usage ending **before** this hour.
     */
    public getUsageTimeseries(startHr: Date, endHr?: Date, _options?: Configuration): Observable<UsageTimeseriesResponse> {
        const requestContextPromise = this.requestFactory.getUsageTimeseries(startHr, endHr, _options);
     ...
     * @param nextRecordId List following results with a next_record_id provided in the previous query.
     */
    public getUsageTopAvgMetrics(month?: Date, day?: Date, names?: Array<string>, limit?: number, nextRecordId?: string, _options?: Configuration): Observable<UsageTopAvgMetricsResponse> {
        const requestContextPromise = this.requestFactory.getUsageTopAvgMetrics(month, day, names, limit, nextRecordId, _options);
...
export class ObservableUsersApi {
     ...
     */
    public createUser(body: User, _options?: Configuration): Observable<UserResponse> {
     ...
     */
    public disableUser(userHandle: string, _options?: Configuration): Observable<UserDisableResponse> {
        const requestContextPromise = this.requestFactory.disableUser(userHandle, _options);
     ...
     */
    public getUser(userHandle: string, _options?: Configuration): Observable<UserResponse> {
        const requestContextPromise = this.requestFactory.getUser(userHandle, _options);
     ...
     */
    public updateUser(userHandle: string, body: User, _options?: Configuration): Observable<UserResponse> {
        const requestContextPromise = this.requestFactory.updateUser(userHandle, body, _options);
...
import { WebhooksIntegrationApiRequestFactory, WebhooksIntegrationApiResponseProcessor} from "../apis/WebhooksIntegrationApi";
export class ObservableWebhooksIntegrationApi {
     ...
     */
    public createWebhooksIntegration(body: WebhooksIntegration, _options?: Configuration): Observable<WebhooksIntegration> {
        const requestContextPromise = this.requestFactory.createWebhooksIntegration(body, _options);
        ...
        return middlewarePreObservable.pipe(mergeMap((ctx: RequestContext) => this.configuration.httpApi.send(ctx))).
            pipe(mergeMap((response: ResponseContext) => {
                ...
                return middlewarePostObservable.pipe(map((rsp: ResponseContext) => this.responseProcessor.createWebhooksIntegration(rsp)));
            }));
    }
    /**
     ...
     */
    public createWebhooksIntegrationCustomVariable(body: WebhooksIntegrationCustomVariable, _options?: Configuration): Observable<WebhooksIntegrationCustomVariableResponse> {
        const requestContextPromise = this.requestFactory.createWebhooksIntegrationCustomVariable(body, _options);
        ...
        return middlewarePreObservable.pipe(mergeMap((ctx: RequestContext) => this.configuration.httpApi.send(ctx))).
            pipe(mergeMap((response: ResponseContext) => {
                ...
                return middlewarePostObservable.pipe(map((rsp: ResponseContext) => this.responseProcessor.createWebhooksIntegrationCustomVariable(rsp)));
            }));
    }
    /**
     ...
     */
    public deleteWebhooksIntegration(webhookName: string, _options?: Configuration): Observable<void> {
        const requestContextPromise = this.requestFactory.deleteWebhooksIntegration(webhookName, _options);
        ...
        return middlewarePreObservable.pipe(mergeMap((ctx: RequestContext) => this.configuration.httpApi.send(ctx))).
            pipe(mergeMap((response: ResponseContext) => {
                ...
                return middlewarePostObservable.pipe(map((rsp: ResponseContext) => this.responseProcessor.deleteWebhooksIntegration(rsp)));
            }));
    }
    /**
     ...
     */
    public deleteWebhooksIntegrationCustomVariable(customVariableName: string, _options?: Configuration): Observable<void> {
        const requestContextPromise = this.requestFactory.deleteWebhooksIntegrationCustomVariable(customVariableName, _options);
        ...
        return middlewarePreObservable.pipe(mergeMap((ctx: RequestContext) => this.configuration.httpApi.send(ctx))).
            pipe(mergeMap((response: ResponseContext) => {
                ...
                return middlewarePostObservable.pipe(map((rsp: ResponseContext) => this.responseProcessor.deleteWebhooksIntegrationCustomVariable(rsp)));
            }));
    }
    /**
     ...
     * @param webhookName The name of the webhook.
     */
    public getWebhooksIntegration(webhookName: string, _options?: Configuration): Observable<WebhooksIntegration> {
        const requestContextPromise = this.requestFactory.getWebhooksIntegration(webhookName, _options);
        ...
        return middlewarePreObservable.pipe(mergeMap((ctx: RequestContext) => this.configuration.httpApi.send(ctx))).
            pipe(mergeMap((response: ResponseContext) => {
                ...
                return middlewarePostObservable.pipe(map((rsp: ResponseContext) => this.responseProcessor.getWebhooksIntegration(rsp)));
            }));
    }
    /**
     ...
     * @param customVariableName The name of the custom variable.
     */
    public getWebhooksIntegrationCustomVariable(customVariableName: string, _options?: Configuration): Observable<WebhooksIntegrationCustomVariableResponse> {
        const requestContextPromise = this.requestFactory.getWebhooksIntegrationCustomVariable(customVariableName, _options);
        ...
        return middlewarePreObservable.pipe(mergeMap((ctx: RequestContext) => this.configuration.httpApi.send(ctx))).
            pipe(mergeMap((response: ResponseContext) => {
                ...
                return middlewarePostObservable.pipe(map((rsp: ResponseContext) => this.responseProcessor.getWebhooksIntegrationCustomVariable(rsp)));
            }));
    }
    /**
     ...
     */
    public updateWebhooksIntegration(webhookName: string, body: WebhooksIntegrationUpdateRequest, _options?: Configuration): Observable<WebhooksIntegration> {
        const requestContextPromise = this.requestFactory.updateWebhooksIntegration(webhookName, body, _options);
        ...
        return middlewarePreObservable.pipe(mergeMap((ctx: RequestContext) => this.configuration.httpApi.send(ctx))).
            pipe(mergeMap((response: ResponseContext) => {
                ...
                return middlewarePostObservable.pipe(map((rsp: ResponseContext) => this.responseProcessor.updateWebhooksIntegration(rsp)));
            }));
    }
    /**
     ...
     */
    public updateWebhooksIntegrationCustomVariable(customVariableName: string, body: WebhooksIntegrationCustomVariableUpdateRequest, _options?: Configuration): Observable<WebhooksIntegrationCustomVariableResponse> {
        const requestContextPromise = this.requestFactory.updateWebhooksIntegrationCustomVariable(customVariableName, body, _options);
        ...
        return middlewarePreObservable.pipe(mergeMap((ctx: RequestContext) => this.configuration.httpApi.send(ctx))).
            pipe(mergeMap((response: ResponseContext) => {
                ...
                return middlewarePostObservable.pipe(map((rsp: ResponseContext) => this.responseProcessor.updateWebhooksIntegrationCustomVariable(rsp)));
            }));
    }
}
