...
export class GCPIntegrationApiRequestFactory extends BaseAPIRequestFactory {
    ...
    public async createGCPIntegration(body: GCPAccount, _options?: Configuration): Promise<RequestContext> {
        ...
        const requestContext = getServer(_config, 'GCPIntegrationApi.createGCPIntegration').makeRequestContext(localVarPath, HttpMethod.POST);
    ...
    public async deleteGCPIntegration(body: GCPAccount, _options?: Configuration): Promise<RequestContext> {
        ...
        // Make Request Context
        const requestContext = getServer(_config, 'GCPIntegrationApi.deleteGCPIntegration').makeRequestContext(localVarPath, HttpMethod.DELETE);
        requestContext.setHeaderParam("Accept", "application/json, */*;q=0.8")
        requestContext.setHttpConfig(_config.httpConfig);
    ...
    public async listGCPIntegration(_options?: Configuration): Promise<RequestContext> {
        ...
        // Make Request Context
        const requestContext = getServer(_config, 'GCPIntegrationApi.listGCPIntegration').makeRequestContext(localVarPath, HttpMethod.GET);
        requestContext.setHeaderParam("Accept", "application/json, */*;q=0.8")
        requestContext.setHttpConfig(_config.httpConfig);
    ...
    public async updateGCPIntegration(body: GCPAccount, _options?: Configuration): Promise<RequestContext> {
        ...
        // Make Request Context
        const requestContext = getServer(_config, 'GCPIntegrationApi.updateGCPIntegration').makeRequestContext(localVarPath, HttpMethod.PUT);
        requestContext.setHeaderParam("Accept", "application/json, */*;q=0.8")
        requestContext.setHttpConfig(_config.httpConfig);
