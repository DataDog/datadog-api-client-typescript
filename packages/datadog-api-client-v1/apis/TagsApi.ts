...
export class TagsApiRequestFactory extends BaseAPIRequestFactory {
    ...
    public async createHostTags(hostName: string, body: HostTags, source?: string, _options?: Configuration): Promise<RequestContext> {
        ...
        const requestContext = getServer(_config, 'TagsApi.createHostTags').makeRequestContext(localVarPath, HttpMethod.POST);
    ...
    public async deleteHostTags(hostName: string, source?: string, _options?: Configuration): Promise<RequestContext> {
        ...
        // Make Request Context
        const requestContext = getServer(_config, 'TagsApi.deleteHostTags').makeRequestContext(localVarPath, HttpMethod.DELETE);
        requestContext.setHeaderParam("Accept", "application/json, */*;q=0.8")
        requestContext.setHttpConfig(_config.httpConfig);
    ...
    public async getHostTags(hostName: string, source?: string, _options?: Configuration): Promise<RequestContext> {
        ...
        // Make Request Context
        const requestContext = getServer(_config, 'TagsApi.getHostTags').makeRequestContext(localVarPath, HttpMethod.GET);
        requestContext.setHeaderParam("Accept", "application/json, */*;q=0.8")
        requestContext.setHttpConfig(_config.httpConfig);
    ...
    public async listHostTags(source?: string, _options?: Configuration): Promise<RequestContext> {
        ...
        // Make Request Context
        const requestContext = getServer(_config, 'TagsApi.listHostTags').makeRequestContext(localVarPath, HttpMethod.GET);
        requestContext.setHeaderParam("Accept", "application/json, */*;q=0.8")
        requestContext.setHttpConfig(_config.httpConfig);
    ...
    public async updateHostTags(hostName: string, body: HostTags, source?: string, _options?: Configuration): Promise<RequestContext> {
        ...
        // Make Request Context
        const requestContext = getServer(_config, 'TagsApi.updateHostTags').makeRequestContext(localVarPath, HttpMethod.PUT);
        requestContext.setHeaderParam("Accept", "application/json, */*;q=0.8")
        requestContext.setHttpConfig(_config.httpConfig);
