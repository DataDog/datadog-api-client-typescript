...
exports.DowntimesApiResponseProcessor = exports.DowntimesApiRequestFactory = void 0;
...
var DowntimesApiRequestFactory = /** @class */ (function (_super) {
     ...
     */
    DowntimesApiRequestFactory.prototype.cancelDowntime = function (downtimeId, options) {
            ...
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0:
                        ...
                        localVarPath = '/api/v1/downtime/{downtime_id}'
                            .replace('{' + 'downtime_id' + '}', encodeURIComponent(String(downtimeId)));
                        requestContext = configuration_1.getServer(config, 'DowntimesApi.cancelDowntime').makeRequestContext(localVarPath, http_1.HttpMethod.DELETE);
     ...
     */
    DowntimesApiRequestFactory.prototype.cancelDowntimesByScope = function (body, options) {
        return __awaiter(this, void 0, void 0, function () {
            ...
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0:
                        ...
                        requestContext = configuration_1.getServer(config, 'DowntimesApi.cancelDowntimesByScope').makeRequestContext(localVarPath, http_1.HttpMethod.POST);
                        requestContext.setHeaderParam("Accept", "application/json, */*;q=0.8");
                        requestContext.setHttpConfig(config.httpConfig);
     ...
     */
    DowntimesApiRequestFactory.prototype.createDowntime = function (body, options) {
        return __awaiter(this, void 0, void 0, function () {
            var config, localVarPath, requestContext, contentType, serializedBody, authMethod;
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0:
                        ...
                        requestContext = configuration_1.getServer(config, 'DowntimesApi.createDowntime').makeRequestContext(localVarPath, http_1.HttpMethod.POST);
                        requestContext.setHeaderParam("Accept", "application/json, */*;q=0.8");
                        requestContext.setHttpConfig(config.httpConfig);
                        contentType = ObjectSerializer_1.ObjectSerializer.getPreferredMediaType([
                            "application/json"
     ...
     */
    DowntimesApiRequestFactory.prototype.getDowntime = function (downtimeId, options) {
        return __awaiter(this, void 0, void 0, function () {
            var config, localVarPath, requestContext, authMethod;
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0:
                        ...
                        localVarPath = '/api/v1/downtime/{downtime_id}'
                            .replace('{' + 'downtime_id' + '}', encodeURIComponent(String(downtimeId)));
                        requestContext = configuration_1.getServer(config, 'DowntimesApi.getDowntime').makeRequestContext(localVarPath, http_1.HttpMethod.GET);
                        requestContext.setHeaderParam("Accept", "application/json, */*;q=0.8");
                        requestContext.setHttpConfig(config.httpConfig);
                        authMethod = null;
                        // Apply auth methods
     ...
     */
    DowntimesApiRequestFactory.prototype.listDowntimes = function (currentOnly, options) {
        return __awaiter(this, void 0, void 0, function () {
            var config, localVarPath, requestContext, authMethod;
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0:
                        config = options || this.configuration;
                        localVarPath = '/api/v1/downtime';
                        requestContext = configuration_1.getServer(config, 'DowntimesApi.listDowntimes').makeRequestContext(localVarPath, http_1.HttpMethod.GET);
                        requestContext.setHeaderParam("Accept", "application/json, */*;q=0.8");
                        requestContext.setHttpConfig(config.httpConfig);
                        // Query Params
     ...
     */
    DowntimesApiRequestFactory.prototype.listMonitorDowntimes = function (monitorId, options) {
        return __awaiter(this, void 0, void 0, function () {
            var config, localVarPath, requestContext, authMethod;
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0:
                        ...
                        localVarPath = '/api/v1/monitor/{monitor_id}/downtimes'
                            .replace('{' + 'monitor_id' + '}', encodeURIComponent(String(monitorId)));
                        requestContext = configuration_1.getServer(config, 'DowntimesApi.listMonitorDowntimes').makeRequestContext(localVarPath, http_1.HttpMethod.GET);
                        requestContext.setHeaderParam("Accept", "application/json, */*;q=0.8");
                        requestContext.setHttpConfig(config.httpConfig);
                        authMethod = null;
                        // Apply auth methods
     ...
     */
    DowntimesApiRequestFactory.prototype.updateDowntime = function (downtimeId, body, options) {
        return __awaiter(this, void 0, void 0, function () {
            var config, localVarPath, requestContext, contentType, serializedBody, authMethod;
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0:
                        ...
                        localVarPath = '/api/v1/downtime/{downtime_id}'
                            .replace('{' + 'downtime_id' + '}', encodeURIComponent(String(downtimeId)));
                        requestContext = configuration_1.getServer(config, 'DowntimesApi.updateDowntime').makeRequestContext(localVarPath, http_1.HttpMethod.PUT);
                        requestContext.setHeaderParam("Accept", "application/json, */*;q=0.8");
                        requestContext.setHttpConfig(config.httpConfig);
                        contentType = ObjectSerializer_1.ObjectSerializer.getPreferredMediaType([
                            "application/json"
...
var DowntimesApiResponseProcessor = /** @class */ (function () {
        ...
        return __awaiter(this, void 0, void 0, function () {
            ...
            return __generator(this, function (_o) {
                switch (_o.label) {
                    ...
                    case 1:
                        body_1 = _b.apply(_a, [_d.apply(_c, [_o.sent(), contentType]), "APIErrorResponse", ""]);
                    ...
                    case 4:
                        ...
                        return [4 /*yield*/, response.body.text()];
                    case 5:
                        body_3 = _k.apply(_j, [_m.apply(_l, [_o.sent(), contentType]), "void", ""]);
    ...
    DowntimesApiResponseProcessor.prototype.cancelDowntimesByScope = function (response) {
        return __awaiter(this, void 0, void 0, function () {
            var contentType, body_4, _a, _b, _c, _d, body_5, _e, _f, _g, _h, body_6, _j, _k, _l, _m, body_7, _o, _p, _q, _r, body_8, _s, _t, _u, _v, body;
            return __generator(this, function (_w) {
                switch (_w.label) {
                    case 0:
                        ...
                        return [4 /*yield*/, response.body.text()];
                    case 1:
                        body_4 = _b.apply(_a, [_d.apply(_c, [_w.sent(), contentType]), "CanceledDowntimesIds", ""]);
                    ...
                    case 2:
                        ...
                        return [4 /*yield*/, response.body.text()];
                    case 3:
                        body_5 = _f.apply(_e, [_h.apply(_g, [_w.sent(), contentType]), "APIErrorResponse", ""]);
                    ...
                    case 4:
                        ...
                        return [4 /*yield*/, response.body.text()];
                    case 5:
                        body_6 = _k.apply(_j, [_m.apply(_l, [_w.sent(), contentType]), "APIErrorResponse", ""]);
                    ...
                    case 6:
                        ...
                        return [4 /*yield*/, response.body.text()];
                    case 7:
                        body_7 = _p.apply(_o, [_r.apply(_q, [_w.sent(), contentType]), "APIErrorResponse", ""]);
                    ...
                    case 8:
                        ...
                        return [4 /*yield*/, response.body.text()];
                    case 9:
                        body_8 = _t.apply(_s, [_v.apply(_u, [_w.sent(), contentType]), "CanceledDowntimesIds", ""]);
            ...
            return __generator(this, function (_s) {
                switch (_s.label) {
                    case 0:
                        ...
                        return [4 /*yield*/, response.body.text()];
                    case 1:
                        body_9 = _b.apply(_a, [_d.apply(_c, [_s.sent(), contentType]), "Downtime", ""]);
                    ...
                    case 6:
                        ...
                        return [4 /*yield*/, response.body.text()];
                    case 7:
                        body_12 = _p.apply(_o, [_r.apply(_q, [_s.sent(), contentType]), "Downtime", ""]);
            ...
            return __generator(this, function (_s) {
                switch (_s.label) {
                    case 0:
                        ...
                        return [4 /*yield*/, response.body.text()];
                    case 1:
                        body_13 = _b.apply(_a, [_d.apply(_c, [_s.sent(), contentType]), "Downtime", ""]);
                    ...
                    case 6:
                        ...
                        return [4 /*yield*/, response.body.text()];
                    case 7:
                        body_16 = _p.apply(_o, [_r.apply(_q, [_s.sent(), contentType]), "Downtime", ""]);
    ...
    DowntimesApiResponseProcessor.prototype.listDowntimes = function (response) {
        return __awaiter(this, void 0, void 0, function () {
            var contentType, body_17, _a, _b, _c, _d, body_18, _e, _f, _g, _h, body_19, _j, _k, _l, _m, body;
            return __generator(this, function (_o) {
                switch (_o.label) {
                    case 0:
                        contentType = ObjectSerializer_1.ObjectSerializer.normalizeMediaType(response.headers["content-type"]);
                        ...
                        return [4 /*yield*/, response.body.text()];
                    case 1:
                        body_17 = _b.apply(_a, [_d.apply(_c, [_o.sent(), contentType]), "Array<Downtime>", ""]);
                    ...
                    case 2:
                        ...
                        return [4 /*yield*/, response.body.text()];
                    case 3:
                        body_18 = _f.apply(_e, [_h.apply(_g, [_o.sent(), contentType]), "APIErrorResponse", ""]);
                    ...
                    case 4:
                        ...
                        return [4 /*yield*/, response.body.text()];
                    case 5:
                        body_19 = _k.apply(_j, [_m.apply(_l, [_o.sent(), contentType]), "Array<Downtime>", ""]);
            ...
            return __generator(this, function (_s) {
                switch (_s.label) {
                    case 0:
                        ...
                        return [4 /*yield*/, response.body.text()];
                    case 1:
                        body_20 = _b.apply(_a, [_d.apply(_c, [_s.sent(), contentType]), "Array<Downtime>", ""]);
                    ...
                    case 2:
                        ...
                        return [4 /*yield*/, response.body.text()];
                    case 3:
                        body_21 = _f.apply(_e, [_h.apply(_g, [_s.sent(), contentType]), "APIErrorResponse", ""]);
                    ...
                    case 6:
                        ...
                        return [4 /*yield*/, response.body.text()];
                    case 7:
                        body_23 = _p.apply(_o, [_r.apply(_q, [_s.sent(), contentType]), "Array<Downtime>", ""]);
            ...
            return __generator(this, function (_w) {
                switch (_w.label) {
                    case 0:
                        ...
                        return [4 /*yield*/, response.body.text()];
                    case 1:
                        body_24 = _b.apply(_a, [_d.apply(_c, [_w.sent(), contentType]), "Downtime", ""]);
                    ...
                    case 2:
                        ...
                        return [4 /*yield*/, response.body.text()];
                    case 3:
                        body_25 = _f.apply(_e, [_h.apply(_g, [_w.sent(), contentType]), "APIErrorResponse", ""]);
                    ...
                    case 4:
                        ...
                        return [4 /*yield*/, response.body.text()];
                    case 5:
                        body_26 = _k.apply(_j, [_m.apply(_l, [_w.sent(), contentType]), "APIErrorResponse", ""]);
                    ...
                    case 6:
                        ...
                        return [4 /*yield*/, response.body.text()];
                    case 7:
                        body_27 = _p.apply(_o, [_r.apply(_q, [_w.sent(), contentType]), "APIErrorResponse", ""]);
                    ...
                    case 8:
                        ...
                        return [4 /*yield*/, response.body.text()];
                    case 9:
                        body_28 = _t.apply(_s, [_v.apply(_u, [_w.sent(), contentType]), "Downtime", ""]);
