...
var LogsApiRequestFactory = /** @class */ (function (_super) {
     ...
     */
    LogsApiRequestFactory.prototype.submitLog = function (body, contentEncoding, ddtags, options) {
        return __awaiter(this, void 0, void 0, function () {
            var config, localVarPath, requestContext, contentType, serializedBody, authMethod;
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0:
                        ...
                        requestContext = configuration_1.getServer(config, 'LogsApi.submitLog').makeRequestContext(localVarPath, http_1.HttpMethod.POST);
                        requestContext.setHeaderParam("Accept", "application/json, */*;q=0.8");
                        requestContext.setHttpConfig(config.httpConfig);
                        // Query Params
                        if (ddtags !== undefined) {
                        ...
                        requestContext.setHeaderParam("Content-Type", contentType);
                        serializedBody = ObjectSerializer_1.ObjectSerializer.stringify(ObjectSerializer_1.ObjectSerializer.serialize(body, "Array<HTTPLogItem>", ""), contentType);
                        requestContext.setBody(serializedBody);
                        authMethod = null;
                        // Apply auth methods
                        authMethod = config.authMethods["apiKeyAuth"];
        ...
        return __awaiter(this, void 0, void 0, function () {
            ...
            return __generator(this, function (_s) {
                switch (_s.label) {
                    ...
                    case 1:
                        body_1 = _b.apply(_a, [_d.apply(_c, [_s.sent(), contentType]), "LogsListResponse", ""]);
                    ...
                    case 6:
                        ...
                        return [4 /*yield*/, response.body.text()];
                    case 7:
                        body_4 = _p.apply(_o, [_r.apply(_q, [_s.sent(), contentType]), "LogsListResponse", ""]);
            ...
            return __generator(this, function (_o) {
                switch (_o.label) {
                    case 0:
                        ...
                        return [4 /*yield*/, response.body.text()];
                    case 1:
                        body_5 = _b.apply(_a, [_d.apply(_c, [_o.sent(), contentType]), "any", ""]);
                    ...
                    case 2:
                        ...
                        return [4 /*yield*/, response.body.text()];
                    case 3:
                        body_6 = _f.apply(_e, [_h.apply(_g, [_o.sent(), contentType]), "HTTPLogError", ""]);
                    ...
                    case 4:
                        ...
                        return [4 /*yield*/, response.body.text()];
                    case 5:
                        body_7 = _k.apply(_j, [_m.apply(_l, [_o.sent(), contentType]), "any", ""]);
