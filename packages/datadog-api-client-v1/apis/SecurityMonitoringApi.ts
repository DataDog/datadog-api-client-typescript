...
export class SecurityMonitoringApiRequestFactory extends BaseAPIRequestFactory {
  ...
  public async addSecurityMonitoringSignalToIncident(signalId: string,body: AddSignalToIncidentRequest,_options?: Configuration): Promise<RequestContext> {
    ...
    // Path Params
    const localVarPath = '/api/v1/security_analytics/signals/{signal_id}/add_to_incident'
      .replace('{signal_id}', encodeURIComponent(String(signalId)));

    // Make Request Context
    const requestContext = _config.getServer('v1.SecurityMonitoringApi.addSecurityMonitoringSignalToIncident').makeRequestContext(localVarPath, HttpMethod.PATCH);
  ...
  public async editSecurityMonitoringSignalAssignee(signalId: string,body: SignalAssigneeUpdateRequest,_options?: Configuration): Promise<RequestContext> {
    const _config = _options || this.configuration;
    ...
    // Path Params
    const localVarPath = '/api/v1/security_analytics/signals/{signal_id}/assignee'
      .replace('{signal_id}', encodeURIComponent(String(signalId)));

    // Make Request Context
    const requestContext = _config.getServer('v1.SecurityMonitoringApi.editSecurityMonitoringSignalAssignee').makeRequestContext(localVarPath, HttpMethod.PATCH);
    requestContext.setHeaderParam("Accept", "application/json");
    requestContext.setHttpConfig(_config.httpConfig);
  ...
  public async editSecurityMonitoringSignalState(signalId: string,body: SignalStateUpdateRequest,_options?: Configuration): Promise<RequestContext> {
    const _config = _options || this.configuration;
    ...
    // Path Params
    const localVarPath = '/api/v1/security_analytics/signals/{signal_id}/state'
      .replace('{signal_id}', encodeURIComponent(String(signalId)));

    // Make Request Context
    const requestContext = _config.getServer('v1.SecurityMonitoringApi.editSecurityMonitoringSignalState').makeRequestContext(localVarPath, HttpMethod.PATCH);
    requestContext.setHeaderParam("Accept", "application/json");
    requestContext.setHttpConfig(_config.httpConfig);
...
export class SecurityMonitoringApiResponseProcessor {
   ...
   */
   public async addSecurityMonitoringSignalToIncident(response: ResponseContext): Promise<SuccessfulSignalUpdateResponse> {
   ...
   * @throws ApiException if the response code was not in [200, 299]
   */
   public async editSecurityMonitoringSignalAssignee(response: ResponseContext): Promise<SuccessfulSignalUpdateResponse> {
    const contentType = ObjectSerializer.normalizeMediaType(response.headers["content-type"]);
    if (response.httpStatusCode === 200) {
      const body: SuccessfulSignalUpdateResponse = ObjectSerializer.deserialize(
        ObjectSerializer.parse(await response.body.text(), contentType),
   ...
   * @throws ApiException if the response code was not in [200, 299]
   */
   public async editSecurityMonitoringSignalState(response: ResponseContext): Promise<SuccessfulSignalUpdateResponse> {
    const contentType = ObjectSerializer.normalizeMediaType(response.headers["content-type"]);
    if (response.httpStatusCode === 200) {
      const body: SuccessfulSignalUpdateResponse = ObjectSerializer.deserialize(
        ObjectSerializer.parse(await response.body.text(), contentType),
...
export class SecurityMonitoringApi {
   ...
   */
  public addSecurityMonitoringSignalToIncident(param: SecurityMonitoringApiAddSecurityMonitoringSignalToIncidentRequest, options?: Configuration): Promise<SuccessfulSignalUpdateResponse> {
   ...
   * @param param The request object
   */
  public editSecurityMonitoringSignalAssignee(param: SecurityMonitoringApiEditSecurityMonitoringSignalAssigneeRequest, options?: Configuration): Promise<SuccessfulSignalUpdateResponse> {
   ...
   * @param param The request object
   */
  public editSecurityMonitoringSignalState(param: SecurityMonitoringApiEditSecurityMonitoringSignalStateRequest, options?: Configuration): Promise<SuccessfulSignalUpdateResponse> {
