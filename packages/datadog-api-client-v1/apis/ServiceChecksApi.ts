...
import { ServiceChecks } from "../models/ServiceChecks";

export class ServiceChecksApiRequestFactory extends BaseAPIRequestFactory {

  public async submitServiceCheck(body: Array<ServiceCheck>,_options?: Configuration): Promise<RequestContext> {
    ...
    const requestContext = _config.getServer('v1.ServiceChecksApi.submitServiceCheck').makeRequestContext(localVarPath, HttpMethod.POST);
