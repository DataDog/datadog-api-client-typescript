...
var OrganizationsApiRequestFactory = /** @class */ (function (_super) {
     ...
     */
    OrganizationsApiRequestFactory.prototype.createChildOrg = function (body, options) {
            ...
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0:
                        ...
                        requestContext = configuration_1.getServer(config, 'OrganizationsApi.createChildOrg').makeRequestContext(localVarPath, http_1.HttpMethod.POST);
     ...
     */
    OrganizationsApiRequestFactory.prototype.getOrg = function (publicId, options) {
        return __awaiter(this, void 0, void 0, function () {
            ...
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0:
                        ...
                        localVarPath = '/api/v1/org/{public_id}'
                            .replace('{' + 'public_id' + '}', encodeURIComponent(String(publicId)));
                        requestContext = configuration_1.getServer(config, 'OrganizationsApi.getOrg').makeRequestContext(localVarPath, http_1.HttpMethod.GET);
                        requestContext.setHeaderParam("Accept", "application/json, */*;q=0.8");
                        requestContext.setHttpConfig(config.httpConfig);
                        authMethod = null;
                        // Apply auth methods
     ...
     * List your managed organizations
     */
    OrganizationsApiRequestFactory.prototype.listOrgs = function (options) {
        return __awaiter(this, void 0, void 0, function () {
            var config, localVarPath, requestContext, authMethod;
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0:
                        config = options || this.configuration;
                        localVarPath = '/api/v1/org';
                        requestContext = configuration_1.getServer(config, 'OrganizationsApi.listOrgs').makeRequestContext(localVarPath, http_1.HttpMethod.GET);
                        requestContext.setHeaderParam("Accept", "application/json, */*;q=0.8");
                        requestContext.setHttpConfig(config.httpConfig);
                        authMethod = null;
                        // Apply auth methods
     ...
     * @param body
     */
    OrganizationsApiRequestFactory.prototype.updateOrg = function (publicId, body, options) {
        return __awaiter(this, void 0, void 0, function () {
            var config, localVarPath, requestContext, contentType, serializedBody, authMethod;
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0:
                        ...
                        localVarPath = '/api/v1/org/{public_id}'
                            .replace('{' + 'public_id' + '}', encodeURIComponent(String(publicId)));
                        requestContext = configuration_1.getServer(config, 'OrganizationsApi.updateOrg').makeRequestContext(localVarPath, http_1.HttpMethod.PUT);
                        requestContext.setHeaderParam("Accept", "application/json, */*;q=0.8");
                        requestContext.setHttpConfig(config.httpConfig);
                        contentType = ObjectSerializer_1.ObjectSerializer.getPreferredMediaType([
                            "application/json"
     ...
     */
    OrganizationsApiRequestFactory.prototype.uploadIdPForOrg = function (publicId, idpFile, options) {
        return __awaiter(this, void 0, void 0, function () {
            var config, localVarPath, requestContext, localVarFormParams, authMethod;
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0:
                        config = options || this.configuration;
                        ...
                        localVarPath = '/api/v1/org/{public_id}/idp_metadata'
                            .replace('{' + 'public_id' + '}', encodeURIComponent(String(publicId)));
                        requestContext = configuration_1.getServer(config, 'OrganizationsApi.uploadIdPForOrg').makeRequestContext(localVarPath, http_1.HttpMethod.POST);
                        requestContext.setHeaderParam("Accept", "application/json, */*;q=0.8");
                        requestContext.setHttpConfig(config.httpConfig);
        ...
        return __awaiter(this, void 0, void 0, function () {
            ...
            return __generator(this, function (_s) {
                switch (_s.label) {
                    ...
                    case 1:
                        body_1 = _b.apply(_a, [_d.apply(_c, [_s.sent(), contentType]), "OrganizationCreateResponse", ""]);
                    ...
                    case 6:
                        ...
                        return [4 /*yield*/, response.body.text()];
                    case 7:
                        body_4 = _p.apply(_o, [_r.apply(_q, [_s.sent(), contentType]), "OrganizationCreateResponse", ""]);
            ...
            return __generator(this, function (_s) {
                switch (_s.label) {
                    case 0:
                        ...
                        return [4 /*yield*/, response.body.text()];
                    case 1:
                        body_5 = _b.apply(_a, [_d.apply(_c, [_s.sent(), contentType]), "OrganizationResponse", ""]);
                    ...
                    case 6:
                        ...
                        return [4 /*yield*/, response.body.text()];
                    case 7:
                        body_8 = _p.apply(_o, [_r.apply(_q, [_s.sent(), contentType]), "OrganizationResponse", ""]);
            ...
            return __generator(this, function (_o) {
                switch (_o.label) {
                    case 0:
                        ...
                        return [4 /*yield*/, response.body.text()];
                    case 1:
                        body_9 = _b.apply(_a, [_d.apply(_c, [_o.sent(), contentType]), "OrganizationListResponse", ""]);
                    ...
                    case 4:
                        ...
                        return [4 /*yield*/, response.body.text()];
                    case 5:
                        body_11 = _k.apply(_j, [_m.apply(_l, [_o.sent(), contentType]), "OrganizationListResponse", ""]);
            ...
            return __generator(this, function (_s) {
                switch (_s.label) {
                    case 0:
                        ...
                        return [4 /*yield*/, response.body.text()];
                    case 1:
                        body_12 = _b.apply(_a, [_d.apply(_c, [_s.sent(), contentType]), "OrganizationResponse", ""]);
                    ...
                    case 6:
                        ...
                        return [4 /*yield*/, response.body.text()];
                    case 7:
                        body_15 = _p.apply(_o, [_r.apply(_q, [_s.sent(), contentType]), "OrganizationResponse", ""]);
            ...
            return __generator(this, function (_w) {
                switch (_w.label) {
                    case 0:
                        ...
                        return [4 /*yield*/, response.body.text()];
                    case 1:
                        body_16 = _b.apply(_a, [_d.apply(_c, [_w.sent(), contentType]), "IdpResponse", ""]);
                    ...
                    case 6:
                        if (!util_1.isCodeInRange("415", response.httpStatusCode)) return [3 /*break*/, 8];
                        _p = (_o = ObjectSerializer_1.ObjectSerializer).deserialize;
                        _r = (_q = ObjectSerializer_1.ObjectSerializer).parse;
                        return [4 /*yield*/, response.body.text()];
                    case 7:
                        body_19 = _p.apply(_o, [_r.apply(_q, [_w.sent(), contentType]), "APIErrorResponse", ""]);
                        throw new exception_1.ApiException(415, body_19);
                    case 8:
                        ...
                        return [4 /*yield*/, response.body.text()];
                    case 9:
                        body_20 = _t.apply(_s, [_v.apply(_u, [_w.sent(), contentType]), "IdpResponse", ""]);
