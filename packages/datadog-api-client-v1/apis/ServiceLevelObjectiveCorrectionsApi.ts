...
export class ServiceLevelObjectiveCorrectionsApiRequestFactory extends BaseAPIRequestFactory {
  ...
  public async createSLOCorrection(body: SLOCorrectionCreateRequest,_options?: Configuration): Promise<RequestContext> {
    ...
    const requestContext = _config.getServer('v1.ServiceLevelObjectiveCorrectionsApi.createSLOCorrection').makeRequestContext(localVarPath, HttpMethod.POST);
  ...
  public async deleteSLOCorrection(sloCorrectionId: string,_options?: Configuration): Promise<RequestContext> {
    ...
    // Make Request Context
    const requestContext = _config.getServer('v1.ServiceLevelObjectiveCorrectionsApi.deleteSLOCorrection').makeRequestContext(localVarPath, HttpMethod.DELETE);
  ...
  public async getSLOCorrection(sloCorrectionId: string,_options?: Configuration): Promise<RequestContext> {
    ...
    // Make Request Context
    const requestContext = _config.getServer('v1.ServiceLevelObjectiveCorrectionsApi.getSLOCorrection').makeRequestContext(localVarPath, HttpMethod.GET);
    requestContext.setHeaderParam("Accept", "application/json");
    requestContext.setHttpConfig(_config.httpConfig);
  ...
  public async listSLOCorrection(offset?: number,limit?: number,_options?: Configuration): Promise<RequestContext> {
    const _config = _options || this.configuration;
    ...
    // Make Request Context
    const requestContext = _config.getServer('v1.ServiceLevelObjectiveCorrectionsApi.listSLOCorrection').makeRequestContext(localVarPath, HttpMethod.GET);
    requestContext.setHeaderParam("Accept", "application/json");
    requestContext.setHttpConfig(_config.httpConfig);
  ...
  public async updateSLOCorrection(sloCorrectionId: string,body: SLOCorrectionUpdateRequest,_options?: Configuration): Promise<RequestContext> {
    ...
    // Make Request Context
    const requestContext = _config.getServer('v1.ServiceLevelObjectiveCorrectionsApi.updateSLOCorrection').makeRequestContext(localVarPath, HttpMethod.PATCH);
    requestContext.setHeaderParam("Accept", "application/json");
    requestContext.setHttpConfig(_config.httpConfig);
...
export class ServiceLevelObjectiveCorrectionsApi {
   ...
   */
  public async *listSLOCorrectionWithPagination(param: ServiceLevelObjectiveCorrectionsApiListSLOCorrectionRequest = {}, options?: Configuration): AsyncGenerator<SLOCorrection> {
