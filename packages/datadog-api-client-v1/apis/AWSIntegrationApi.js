...
exports.AWSIntegrationApiResponseProcessor = exports.AWSIntegrationApiRequestFactory = void 0;
...
var AWSIntegrationApiRequestFactory = /** @class */ (function (_super) {
     ...
     */
    AWSIntegrationApiRequestFactory.prototype.createAWSAccount = function (body, options) {
            ...
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0:
                        ...
                        requestContext = configuration_1.getServer(config, 'AWSIntegrationApi.createAWSAccount').makeRequestContext(localVarPath, http_1.HttpMethod.POST);
     ...
     */
    AWSIntegrationApiRequestFactory.prototype.createAWSTagFilter = function (body, options) {
        return __awaiter(this, void 0, void 0, function () {
            var config, localVarPath, requestContext, contentType, serializedBody, authMethod;
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0:
                        ...
                        requestContext = configuration_1.getServer(config, 'AWSIntegrationApi.createAWSTagFilter').makeRequestContext(localVarPath, http_1.HttpMethod.POST);
                        requestContext.setHeaderParam("Accept", "application/json, */*;q=0.8");
                        requestContext.setHttpConfig(config.httpConfig);
                        contentType = ObjectSerializer_1.ObjectSerializer.getPreferredMediaType([
                            "application/json"
     ...
     */
    AWSIntegrationApiRequestFactory.prototype.createNewAWSExternalID = function (body, options) {
        return __awaiter(this, void 0, void 0, function () {
            var config, localVarPath, requestContext, contentType, serializedBody, authMethod;
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0:
                        ...
                        requestContext = configuration_1.getServer(config, 'AWSIntegrationApi.createNewAWSExternalID').makeRequestContext(localVarPath, http_1.HttpMethod.PUT);
                        requestContext.setHeaderParam("Accept", "application/json, */*;q=0.8");
                        requestContext.setHttpConfig(config.httpConfig);
                        contentType = ObjectSerializer_1.ObjectSerializer.getPreferredMediaType([
                            "application/json"
     ...
     * @param body AWS request object
     */
    AWSIntegrationApiRequestFactory.prototype.deleteAWSAccount = function (body, options) {
        return __awaiter(this, void 0, void 0, function () {
            var config, localVarPath, requestContext, contentType, serializedBody, authMethod;
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0:
                        ...
                        localVarPath = '/api/v1/integration/aws';
                        requestContext = configuration_1.getServer(config, 'AWSIntegrationApi.deleteAWSAccount').makeRequestContext(localVarPath, http_1.HttpMethod.DELETE);
                        requestContext.setHeaderParam("Accept", "application/json, */*;q=0.8");
                        requestContext.setHttpConfig(config.httpConfig);
                        contentType = ObjectSerializer_1.ObjectSerializer.getPreferredMediaType([
                            "application/json"
     ...
     */
    AWSIntegrationApiRequestFactory.prototype.deleteAWSTagFilter = function (body, options) {
        return __awaiter(this, void 0, void 0, function () {
            var config, localVarPath, requestContext, contentType, serializedBody, authMethod;
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0:
                        ...
                        localVarPath = '/api/v1/integration/aws/filtering';
                        requestContext = configuration_1.getServer(config, 'AWSIntegrationApi.deleteAWSTagFilter').makeRequestContext(localVarPath, http_1.HttpMethod.DELETE);
                        requestContext.setHeaderParam("Accept", "application/json, */*;q=0.8");
                        requestContext.setHttpConfig(config.httpConfig);
                        contentType = ObjectSerializer_1.ObjectSerializer.getPreferredMediaType([
                            "application/json"
     ...
     */
    AWSIntegrationApiRequestFactory.prototype.listAWSAccounts = function (accountId, roleName, accessKeyId, options) {
        return __awaiter(this, void 0, void 0, function () {
            ...
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0:
                        config = options || this.configuration;
                        localVarPath = '/api/v1/integration/aws';
                        requestContext = configuration_1.getServer(config, 'AWSIntegrationApi.listAWSAccounts').makeRequestContext(localVarPath, http_1.HttpMethod.GET);
                        requestContext.setHeaderParam("Accept", "application/json, */*;q=0.8");
                        requestContext.setHttpConfig(config.httpConfig);
                        // Query Params
     ...
     */
    AWSIntegrationApiRequestFactory.prototype.listAWSTagFilters = function (accountId, options) {
        return __awaiter(this, void 0, void 0, function () {
            var config, localVarPath, requestContext, authMethod;
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0:
                        ...
                        localVarPath = '/api/v1/integration/aws/filtering';
                        requestContext = configuration_1.getServer(config, 'AWSIntegrationApi.listAWSTagFilters').makeRequestContext(localVarPath, http_1.HttpMethod.GET);
                        requestContext.setHeaderParam("Accept", "application/json, */*;q=0.8");
                        requestContext.setHttpConfig(config.httpConfig);
                        // Query Params
                        if (accountId !== undefined) {
     ...
     */
    AWSIntegrationApiRequestFactory.prototype.listAvailableAWSNamespaces = function (options) {
        return __awaiter(this, void 0, void 0, function () {
            var config, localVarPath, requestContext, authMethod;
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0:
                        ...
                        requestContext = configuration_1.getServer(config, 'AWSIntegrationApi.listAvailableAWSNamespaces').makeRequestContext(localVarPath, http_1.HttpMethod.GET);
                        requestContext.setHeaderParam("Accept", "application/json, */*;q=0.8");
                        requestContext.setHttpConfig(config.httpConfig);
                        authMethod = null;
                        // Apply auth methods
     ...
     */
    AWSIntegrationApiRequestFactory.prototype.updateAWSAccount = function (body, accountId, roleName, accessKeyId, options) {
        return __awaiter(this, void 0, void 0, function () {
            var config, localVarPath, requestContext, contentType, serializedBody, authMethod;
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0:
                        ...
                        localVarPath = '/api/v1/integration/aws';
                        requestContext = configuration_1.getServer(config, 'AWSIntegrationApi.updateAWSAccount').makeRequestContext(localVarPath, http_1.HttpMethod.PUT);
                        requestContext.setHeaderParam("Accept", "application/json, */*;q=0.8");
                        requestContext.setHttpConfig(config.httpConfig);
                        // Query Params
                        if (accountId !== undefined) {
        ...
        return __awaiter(this, void 0, void 0, function () {
            ...
            return __generator(this, function (_w) {
                switch (_w.label) {
                    ...
                    case 1:
                        body_1 = _b.apply(_a, [_d.apply(_c, [_w.sent(), contentType]), "AWSAccountCreateResponse", ""]);
                    ...
                    case 8:
                        ...
                        return [4 /*yield*/, response.body.text()];
                    case 9:
                        body_5 = _t.apply(_s, [_v.apply(_u, [_w.sent(), contentType]), "AWSAccountCreateResponse", ""]);
            ...
            return __generator(this, function (_s) {
                switch (_s.label) {
                    case 0:
                        ...
                        return [4 /*yield*/, response.body.text()];
                    case 1:
                        body_6 = _b.apply(_a, [_d.apply(_c, [_s.sent(), contentType]), "any", ""]);
                    ...
                    case 6:
                        ...
                        return [4 /*yield*/, response.body.text()];
                    case 7:
                        body_9 = _p.apply(_o, [_r.apply(_q, [_s.sent(), contentType]), "any", ""]);
            ...
            return __generator(this, function (_s) {
                switch (_s.label) {
                    case 0:
                        ...
                        return [4 /*yield*/, response.body.text()];
                    case 1:
                        body_10 = _b.apply(_a, [_d.apply(_c, [_s.sent(), contentType]), "AWSAccountCreateResponse", ""]);
                    ...
                    case 2:
                        ...
                        return [4 /*yield*/, response.body.text()];
                    case 3:
                        body_11 = _f.apply(_e, [_h.apply(_g, [_s.sent(), contentType]), "APIErrorResponse", ""]);
                    ...
                    case 4:
                        ...
                        return [4 /*yield*/, response.body.text()];
                    case 5:
                        body_12 = _k.apply(_j, [_m.apply(_l, [_s.sent(), contentType]), "APIErrorResponse", ""]);
                    ...
                    case 6:
                        ...
                        return [4 /*yield*/, response.body.text()];
                    case 7:
                        body_13 = _p.apply(_o, [_r.apply(_q, [_s.sent(), contentType]), "AWSAccountCreateResponse", ""]);
            ...
            return __generator(this, function (_w) {
                switch (_w.label) {
                    case 0:
                        ...
                        return [4 /*yield*/, response.body.text()];
                    case 1:
                        body_14 = _b.apply(_a, [_d.apply(_c, [_w.sent(), contentType]), "any", ""]);
                    ...
                    case 8:
                        ...
                        return [4 /*yield*/, response.body.text()];
                    case 9:
                        body_18 = _t.apply(_s, [_v.apply(_u, [_w.sent(), contentType]), "any", ""]);
            ...
            return __generator(this, function (_s) {
                switch (_s.label) {
                    case 0:
                        ...
                        return [4 /*yield*/, response.body.text()];
                    case 1:
                        body_19 = _b.apply(_a, [_d.apply(_c, [_s.sent(), contentType]), "any", ""]);
                    ...
                    case 6:
                        ...
                        return [4 /*yield*/, response.body.text()];
                    case 7:
                        body_22 = _p.apply(_o, [_r.apply(_q, [_s.sent(), contentType]), "any", ""]);
            ...
            return __generator(this, function (_s) {
                switch (_s.label) {
                    case 0:
                        ...
                        return [4 /*yield*/, response.body.text()];
                    case 1:
                        body_23 = _b.apply(_a, [_d.apply(_c, [_s.sent(), contentType]), "AWSAccountListResponse", ""]);
                    ...
                    case 6:
                        ...
                        return [4 /*yield*/, response.body.text()];
                    case 7:
                        body_26 = _p.apply(_o, [_r.apply(_q, [_s.sent(), contentType]), "AWSAccountListResponse", ""]);
            ...
            return __generator(this, function (_s) {
                switch (_s.label) {
                    case 0:
                        ...
                        return [4 /*yield*/, response.body.text()];
                    case 1:
                        body_27 = _b.apply(_a, [_d.apply(_c, [_s.sent(), contentType]), "AWSTagFilterListResponse", ""]);
                    ...
                    case 6:
                        ...
                        return [4 /*yield*/, response.body.text()];
                    case 7:
                        body_30 = _p.apply(_o, [_r.apply(_q, [_s.sent(), contentType]), "AWSTagFilterListResponse", ""]);
            ...
            return __generator(this, function (_o) {
                switch (_o.label) {
                    case 0:
                        ...
                        return [4 /*yield*/, response.body.text()];
                    case 1:
                        body_31 = _b.apply(_a, [_d.apply(_c, [_o.sent(), contentType]), "Array<string>", ""]);
                    ...
                    case 4:
                        ...
                        return [4 /*yield*/, response.body.text()];
                    case 5:
                        body_33 = _k.apply(_j, [_m.apply(_l, [_o.sent(), contentType]), "Array<string>", ""]);
            ...
            return __generator(this, function (_w) {
                switch (_w.label) {
                    case 0:
                        ...
                        return [4 /*yield*/, response.body.text()];
                    case 1:
                        body_34 = _b.apply(_a, [_d.apply(_c, [_w.sent(), contentType]), "any", ""]);
                    ...
                    case 2:
                        ...
                        return [4 /*yield*/, response.body.text()];
                    case 3:
                        body_35 = _f.apply(_e, [_h.apply(_g, [_w.sent(), contentType]), "APIErrorResponse", ""]);
                    ...
                    case 4:
                        ...
                        return [4 /*yield*/, response.body.text()];
                    case 5:
                        body_36 = _k.apply(_j, [_m.apply(_l, [_w.sent(), contentType]), "APIErrorResponse", ""]);
                    ...
                    case 6:
                        ...
                        return [4 /*yield*/, response.body.text()];
                    case 7:
                        body_37 = _p.apply(_o, [_r.apply(_q, [_w.sent(), contentType]), "APIErrorResponse", ""]);
                        throw new exception_1.ApiException(409, body_37);
                    case 8:
                        if (!(response.httpStatusCode >= 200 && response.httpStatusCode <= 299)) return [3 /*break*/, 10];
                        _t = (_s = ObjectSerializer_1.ObjectSerializer).deserialize;
                        _v = (_u = ObjectSerializer_1.ObjectSerializer).parse;
                        return [4 /*yield*/, response.body.text()];
                    case 9:
                        body_38 = _t.apply(_s, [_v.apply(_u, [_w.sent(), contentType]), "any", ""]);
