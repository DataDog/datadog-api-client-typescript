...
export class MonitorsApiRequestFactory extends BaseAPIRequestFactory {
  ...
  public async checkCanDeleteMonitor(monitorIds: Array<number>,_options?: Configuration): Promise<RequestContext> {
    ...
    const requestContext = getServer(_config, 'MonitorsApi.checkCanDeleteMonitor').makeRequestContext(localVarPath, HttpMethod.GET);
  ...
  public async createMonitor(body: Monitor,_options?: Configuration): Promise<RequestContext> {
    ...
    // Make Request Context
    const requestContext = getServer(_config, 'MonitorsApi.createMonitor').makeRequestContext(localVarPath, HttpMethod.POST);
    requestContext.setHeaderParam("Accept", "application/json");
    requestContext.setHttpConfig(_config.httpConfig);
  ...
  public async deleteMonitor(monitorId: number,force?: string,_options?: Configuration): Promise<RequestContext> {
    ...
    // Make Request Context
    const requestContext = getServer(_config, 'MonitorsApi.deleteMonitor').makeRequestContext(localVarPath, HttpMethod.DELETE);
    requestContext.setHeaderParam("Accept", "application/json");
    requestContext.setHttpConfig(_config.httpConfig);
  ...
  public async getMonitor(monitorId: number,groupStates?: string,_options?: Configuration): Promise<RequestContext> {
    const _config = _options || this.configuration;
    ...
    // Make Request Context
    const requestContext = getServer(_config, 'MonitorsApi.getMonitor').makeRequestContext(localVarPath, HttpMethod.GET);
    requestContext.setHeaderParam("Accept", "application/json");
    requestContext.setHttpConfig(_config.httpConfig);
  ...
  public async listMonitors(groupStates?: string,name?: string,tags?: string,monitorTags?: string,withDowntimes?: boolean,idOffset?: number,page?: number,pageSize?: number,_options?: Configuration): Promise<RequestContext> {
    ...
    // Make Request Context
    const requestContext = getServer(_config, 'MonitorsApi.listMonitors').makeRequestContext(localVarPath, HttpMethod.GET);
    requestContext.setHeaderParam("Accept", "application/json");
    requestContext.setHttpConfig(_config.httpConfig);
  ...
  public async searchMonitorGroups(query?: string,page?: number,perPage?: number,sort?: string,_options?: Configuration): Promise<RequestContext> {
    ...
    // Make Request Context
    const requestContext = getServer(_config, 'MonitorsApi.searchMonitorGroups').makeRequestContext(localVarPath, HttpMethod.GET);
    requestContext.setHeaderParam("Accept", "application/json");
    requestContext.setHttpConfig(_config.httpConfig);
  ...
  public async searchMonitors(query?: string,page?: number,perPage?: number,sort?: string,_options?: Configuration): Promise<RequestContext> {
    ...
    // Make Request Context
    const requestContext = getServer(_config, 'MonitorsApi.searchMonitors').makeRequestContext(localVarPath, HttpMethod.GET);
    requestContext.setHeaderParam("Accept", "application/json");
    requestContext.setHttpConfig(_config.httpConfig);
  ...
  public async updateMonitor(monitorId: number,body: MonitorUpdateRequest,_options?: Configuration): Promise<RequestContext> {
    ...
    // Make Request Context
    const requestContext = getServer(_config, 'MonitorsApi.updateMonitor').makeRequestContext(localVarPath, HttpMethod.PUT);
    requestContext.setHeaderParam("Accept", "application/json");
    requestContext.setHttpConfig(_config.httpConfig);
  ...
  public async validateExistingMonitor(monitorId: number,body: Monitor,_options?: Configuration): Promise<RequestContext> {
    ...
    // verify required parameter 'monitorId' is not null or undefined
    if (monitorId === null || monitorId === undefined) {
      throw new RequiredError('Required parameter monitorId was null or undefined when calling validateExistingMonitor.');
    }

    // verify required parameter 'body' is not null or undefined
    if (body === null || body === undefined) {
      throw new RequiredError('Required parameter body was null or undefined when calling validateExistingMonitor.');
    }
    ...
    // Make Request Context
    const requestContext = getServer(_config, 'MonitorsApi.validateExistingMonitor').makeRequestContext(localVarPath, HttpMethod.POST);
    requestContext.setHeaderParam("Accept", "application/json");
    requestContext.setHttpConfig(_config.httpConfig);
  ...
  public async validateMonitor(body: Monitor,_options?: Configuration): Promise<RequestContext> {
    ...
    // Make Request Context
    const requestContext = getServer(_config, 'MonitorsApi.validateMonitor').makeRequestContext(localVarPath, HttpMethod.POST);
    requestContext.setHeaderParam("Accept", "application/json");
    requestContext.setHttpConfig(_config.httpConfig);
