...
exports.HostsApiResponseProcessor = exports.HostsApiRequestFactory = void 0;
...
var HostsApiRequestFactory = /** @class */ (function (_super) {
     ...
     */
    HostsApiRequestFactory.prototype.getHostTotals = function (from, options) {
            ...
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0:
                        ...
                        requestContext = configuration_1.getServer(config, 'HostsApi.getHostTotals').makeRequestContext(localVarPath, http_1.HttpMethod.GET);
     ...
     */
    HostsApiRequestFactory.prototype.listHosts = function (filter, sortField, sortDir, start, count, from, includeMutedHostsData, includeHostsMetadata, options) {
        return __awaiter(this, void 0, void 0, function () {
            var config, localVarPath, requestContext, authMethod;
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0:
                        ...
                        requestContext = configuration_1.getServer(config, 'HostsApi.listHosts').makeRequestContext(localVarPath, http_1.HttpMethod.GET);
                        requestContext.setHeaderParam("Accept", "application/json, */*;q=0.8");
                        requestContext.setHttpConfig(config.httpConfig);
                        // Query Params
                        if (filter !== undefined) {
     ...
     */
    HostsApiRequestFactory.prototype.muteHost = function (hostName, body, options) {
        return __awaiter(this, void 0, void 0, function () {
            ...
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0:
                        ...
                        localVarPath = '/api/v1/host/{host_name}/mute'
                            .replace('{' + 'host_name' + '}', encodeURIComponent(String(hostName)));
                        requestContext = configuration_1.getServer(config, 'HostsApi.muteHost').makeRequestContext(localVarPath, http_1.HttpMethod.POST);
                        requestContext.setHeaderParam("Accept", "application/json, */*;q=0.8");
                        requestContext.setHttpConfig(config.httpConfig);
     ...
     */
    HostsApiRequestFactory.prototype.unmuteHost = function (hostName, options) {
        return __awaiter(this, void 0, void 0, function () {
            var config, localVarPath, requestContext, authMethod;
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0:
                        ...
                        localVarPath = '/api/v1/host/{host_name}/unmute'
                            .replace('{' + 'host_name' + '}', encodeURIComponent(String(hostName)));
                        requestContext = configuration_1.getServer(config, 'HostsApi.unmuteHost').makeRequestContext(localVarPath, http_1.HttpMethod.POST);
                        requestContext.setHeaderParam("Accept", "application/json, */*;q=0.8");
                        requestContext.setHttpConfig(config.httpConfig);
                        authMethod = null;
                        // Apply auth methods
        ...
        return __awaiter(this, void 0, void 0, function () {
            ...
            return __generator(this, function (_s) {
                switch (_s.label) {
                    ...
                    case 1:
                        body_1 = _b.apply(_a, [_d.apply(_c, [_s.sent(), contentType]), "HostTotals", ""]);
                    ...
                    case 6:
                        ...
                        return [4 /*yield*/, response.body.text()];
                    case 7:
                        body_4 = _p.apply(_o, [_r.apply(_q, [_s.sent(), contentType]), "HostTotals", ""]);
            ...
            return __generator(this, function (_s) {
                switch (_s.label) {
                    case 0:
                        ...
                        return [4 /*yield*/, response.body.text()];
                    case 1:
                        body_5 = _b.apply(_a, [_d.apply(_c, [_s.sent(), contentType]), "HostListResponse", ""]);
                    ...
                    case 6:
                        ...
                        return [4 /*yield*/, response.body.text()];
                    case 7:
                        body_8 = _p.apply(_o, [_r.apply(_q, [_s.sent(), contentType]), "HostListResponse", ""]);
            ...
            return __generator(this, function (_s) {
                switch (_s.label) {
                    case 0:
                        ...
                        return [4 /*yield*/, response.body.text()];
                    case 1:
                        body_9 = _b.apply(_a, [_d.apply(_c, [_s.sent(), contentType]), "HostMuteResponse", ""]);
                    ...
                    case 6:
                        ...
                        return [4 /*yield*/, response.body.text()];
                    case 7:
                        body_12 = _p.apply(_o, [_r.apply(_q, [_s.sent(), contentType]), "HostMuteResponse", ""]);
            ...
            return __generator(this, function (_s) {
                switch (_s.label) {
                    case 0:
                        ...
                        return [4 /*yield*/, response.body.text()];
                    case 1:
                        body_13 = _b.apply(_a, [_d.apply(_c, [_s.sent(), contentType]), "HostMuteResponse", ""]);
                    ...
                    case 6:
                        ...
                        return [4 /*yield*/, response.body.text()];
                    case 7:
                        body_16 = _p.apply(_o, [_r.apply(_q, [_s.sent(), contentType]), "HostMuteResponse", ""]);
