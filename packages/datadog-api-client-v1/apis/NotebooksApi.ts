...
export class NotebooksApiRequestFactory extends BaseAPIRequestFactory {
     ...
     */
    public async createNotebook(body: NotebookCreateRequest, options?: Configuration): Promise<RequestContext> {
        let config = options || this.configuration;

        // verify required parameter 'body' is not null or undefined
        if (body === null || body === undefined) {
            throw new RequiredError('Required parameter body was null or undefined when calling createNotebook.');
        }
        ...
        const requestContext = getServer(config, 'NotebooksApi.createNotebook').makeRequestContext(localVarPath, HttpMethod.POST);
     ...
     */
    public async deleteNotebook(notebookId: number, options?: Configuration): Promise<RequestContext> {
        let config = options || this.configuration;

        // verify required parameter 'notebookId' is not null or undefined
        if (notebookId === null || notebookId === undefined) {
            throw new RequiredError('Required parameter notebookId was null or undefined when calling deleteNotebook.');
        }
        ...
        // Make Request Context
        const requestContext = getServer(config, 'NotebooksApi.deleteNotebook').makeRequestContext(localVarPath, HttpMethod.DELETE);
        requestContext.setHeaderParam("Accept", "application/json, */*;q=0.8")
        requestContext.setHttpConfig(config.httpConfig);
     ...
     * @param notebookId Unique ID, assigned when you create the notebook.
     */
    public async getNotebook(notebookId: number, options?: Configuration): Promise<RequestContext> {
        let config = options || this.configuration;

        // verify required parameter 'notebookId' is not null or undefined
        if (notebookId === null || notebookId === undefined) {
            throw new RequiredError('Required parameter notebookId was null or undefined when calling getNotebook.');
        }
        ...
        // Make Request Context
        const requestContext = getServer(config, 'NotebooksApi.getNotebook').makeRequestContext(localVarPath, HttpMethod.GET);
        requestContext.setHeaderParam("Accept", "application/json, */*;q=0.8")
        requestContext.setHttpConfig(config.httpConfig);
     ...
     */
    public async listNotebooks(authorHandle?: string, excludeAuthorHandle?: string, start?: number, count?: number, sortField?: string, sortDir?: string, query?: string, includeCells?: boolean, options?: Configuration): Promise<RequestContext> {
        let config = options || this.configuration;
        ...
        // Make Request Context
        const requestContext = getServer(config, 'NotebooksApi.listNotebooks').makeRequestContext(localVarPath, HttpMethod.GET);
        requestContext.setHeaderParam("Accept", "application/json, */*;q=0.8")
        requestContext.setHttpConfig(config.httpConfig);
     ...
     */
    public async updateNotebook(notebookId: number, body: NotebookUpdateRequest, options?: Configuration): Promise<RequestContext> {
        let config = options || this.configuration;

        // verify required parameter 'notebookId' is not null or undefined
        if (notebookId === null || notebookId === undefined) {
            throw new RequiredError('Required parameter notebookId was null or undefined when calling updateNotebook.');
        }


        // verify required parameter 'body' is not null or undefined
        if (body === null || body === undefined) {
            throw new RequiredError('Required parameter body was null or undefined when calling updateNotebook.');
        }
        ...
        // Make Request Context
        const requestContext = getServer(config, 'NotebooksApi.updateNotebook').makeRequestContext(localVarPath, HttpMethod.PUT);
        requestContext.setHeaderParam("Accept", "application/json, */*;q=0.8")
        requestContext.setHttpConfig(config.httpConfig);
