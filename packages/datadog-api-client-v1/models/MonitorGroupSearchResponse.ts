...
export class MonitorGroupSearchResponse {
    ...
    */
    ...
    static deserialize(data: {[key: string]: any}): MonitorGroupSearchResponse {
      let res = new MonitorGroupSearchResponse();

      res.counts = ObjectSerializer.deserialize(data.counts, "MonitorGroupSearchResponseCounts", "")

      res.groups = ObjectSerializer.deserialize(data.groups, "Array<MonitorGroupSearchResult>", "")
    ...
    static serialize(data: MonitorGroupSearchResponse): {[key: string]: any} {
        let attributeTypes = MonitorGroupSearchResponse.getAttributeTypeMap();
        ...
        res.counts = ObjectSerializer.serialize(data.counts, "MonitorGroupSearchResponseCounts", "")

        res.groups = ObjectSerializer.serialize(data.groups, "Array<MonitorGroupSearchResult>", "")
