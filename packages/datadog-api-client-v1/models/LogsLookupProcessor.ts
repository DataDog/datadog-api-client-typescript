...
export class LogsLookupProcessor {
    ...
    */
    ...
    static deserialize(data: {[key: string]: any}): LogsLookupProcessor {
      let res = new LogsLookupProcessor();

      res.defaultLookup = ObjectSerializer.deserialize(data.default_lookup, "string", "")
      ...
      res.lookupTable = ObjectSerializer.deserialize(data.lookup_table, "Array<string>", "")
    ...
    static serialize(data: LogsLookupProcessor): {[key: string]: any} {
        let attributeTypes = LogsLookupProcessor.getAttributeTypeMap();
        ...
        res.default_lookup = ObjectSerializer.serialize(data.defaultLookup, "string", "")
        ...
        res.lookup_table = ObjectSerializer.serialize(data.lookupTable, "Array<string>", "")
