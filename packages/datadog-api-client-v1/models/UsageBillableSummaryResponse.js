...
var UsageBillableSummaryResponse = /** @class */ (function () {
    ...
    UsageBillableSummaryResponse.deserialize = function (data) {
        var res = new UsageBillableSummaryResponse();
        res.usage = ObjectSerializer_1.ObjectSerializer.deserialize(data.usage, "Array<UsageBillableSummaryHour>", "");
        return res;
    };
    UsageBillableSummaryResponse.serialize = function (data) {
        var attributeTypes = UsageBillableSummaryResponse.getAttributeTypeMap();
        var res = {};
        ...
        res.usage = ObjectSerializer_1.ObjectSerializer.serialize(data.usage, "Array<UsageBillableSummaryHour>", "");
        return res;
    };
    UsageBillableSummaryResponse.discriminator = undefined;
