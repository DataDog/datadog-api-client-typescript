...
export type SyntheticsApiTestFailureCode =
  ...
  | typeof DENIED
  | typeof TOO_MANY_REDIRECTS
  | typeof AUTHENTICATION_ERROR
  | typeof DECRYPTION
  | typeof INVALID_CHAR_IN_HEADER
  | typeof HEADER_TOO_LARGE
  | typeof HEADERS_INCOMPATIBLE_CONTENT_LENGTH
  | typeof INVALID_REQUEST
  | typeof REQUIRES_UPDATE
  | typeof UNESCAPED_CHARACTERS_IN_REQUEST_PATH
...
export const HEADERS_INCOMPATIBLE_CONTENT_LENGTH =
  "HEADERS_INCOMPATIBLE_CONTENT_LENGTH";
export const INVALID_REQUEST = "INVALID_REQUEST";
export const REQUIRES_UPDATE = "REQUIRES_UPDATE";
export const UNESCAPED_CHARACTERS_IN_REQUEST_PATH =
