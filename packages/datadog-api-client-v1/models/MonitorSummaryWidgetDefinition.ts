...
export class MonitorSummaryWidgetDefinition {
    ...
    */
    ...
    static deserialize(data: {[key: string]: any}): MonitorSummaryWidgetDefinition {
      let res = new MonitorSummaryWidgetDefinition();
      ...
      res.hideZeroCounts = ObjectSerializer.deserialize(data.hide_zero_counts, "boolean", "")
      ...
      res.showLastTriggered = ObjectSerializer.deserialize(data.show_last_triggered, "boolean", "")
    ...
    static serialize(data: MonitorSummaryWidgetDefinition): {[key: string]: any} {
        let attributeTypes = MonitorSummaryWidgetDefinition.getAttributeTypeMap();
        ...
        res.hide_zero_counts = ObjectSerializer.serialize(data.hideZeroCounts, "boolean", "")
        ...
        res.show_last_triggered = ObjectSerializer.serialize(data.showLastTriggered, "boolean", "")
