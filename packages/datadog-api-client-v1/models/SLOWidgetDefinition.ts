...
export class SLOWidgetDefinition {
    ...
    */
    ...
    static deserialize(data: {[key: string]: any}): SLOWidgetDefinition {
      let res = new SLOWidgetDefinition();

      res.globalTimeTarget = ObjectSerializer.deserialize(data.global_time_target, "string", "")

      res.showErrorBudget = ObjectSerializer.deserialize(data.show_error_budget, "boolean", "")

      res.sloId = ObjectSerializer.deserialize(data.slo_id, "string", "")

      res.timeWindows = ObjectSerializer.deserialize(data.time_windows, "Array<WidgetTimeWindows>", "")
    ...
    static serialize(data: SLOWidgetDefinition): {[key: string]: any} {
        let attributeTypes = SLOWidgetDefinition.getAttributeTypeMap();
        ...
        res.global_time_target = ObjectSerializer.serialize(data.globalTimeTarget, "string", "")

        res.show_error_budget = ObjectSerializer.serialize(data.showErrorBudget, "boolean", "")

        res.slo_id = ObjectSerializer.serialize(data.sloId, "string", "")

        res.time_windows = ObjectSerializer.serialize(data.timeWindows, "Array<WidgetTimeWindows>", "")
