...
export class MonitorGroupSearchResult {
    ...
    */
    ...
    static deserialize(data: {[key: string]: any}): MonitorGroupSearchResult {
      let res = new MonitorGroupSearchResult();

      res.group = ObjectSerializer.deserialize(data.group, "string", "")

      res.groupTags = ObjectSerializer.deserialize(data.group_tags, "Array<string>", "")
    ...
    static serialize(data: MonitorGroupSearchResult): {[key: string]: any} {
        let attributeTypes = MonitorGroupSearchResult.getAttributeTypeMap();
        ...
        res.group_tags = ObjectSerializer.serialize(data.groupTags, "Array<string>", "")
