...
var UsageSNMPResponse = /** @class */ (function () {
    ...
    UsageSNMPResponse.deserialize = function (data) {
        var res = new UsageSNMPResponse();
        res.usage = ObjectSerializer_1.ObjectSerializer.deserialize(data.usage, "Array<UsageSNMPHour>", "");
        return res;
    };
    UsageSNMPResponse.serialize = function (data) {
        var attributeTypes = UsageSNMPResponse.getAttributeTypeMap();
        var res = {};
        ...
        res.usage = ObjectSerializer_1.ObjectSerializer.serialize(data.usage, "Array<UsageSNMPHour>", "");
        return res;
    };
    UsageSNMPResponse.discriminator = undefined;
