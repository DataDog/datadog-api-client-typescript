...
var IPPrefixesWebhooks = /** @class */ (function () {
    ...
    IPPrefixesWebhooks.deserialize = function (data) {
        var res = new IPPrefixesWebhooks();
    ...
    IPPrefixesWebhooks.serialize = function (data) {
        var attributeTypes = IPPrefixesWebhooks.getAttributeTypeMap();
        var res = {};
    ...
    IPPrefixesWebhooks.discriminator = undefined;
