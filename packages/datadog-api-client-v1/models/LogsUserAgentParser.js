...
var LogsUserAgentParser = /** @class */ (function () {
    ...
    LogsUserAgentParser.deserialize = function (data) {
        var res = new LogsUserAgentParser();
        res.isEnabled = ObjectSerializer_1.ObjectSerializer.deserialize(data.is_enabled, "boolean", "");
        res.isEncoded = ObjectSerializer_1.ObjectSerializer.deserialize(data.is_encoded, "boolean", "");
    ...
    LogsUserAgentParser.serialize = function (data) {
        var attributeTypes = LogsUserAgentParser.getAttributeTypeMap();
        var res = {};
        ...
        res.is_encoded = ObjectSerializer_1.ObjectSerializer.serialize(data.isEncoded, "boolean", "");
    ...
    LogsUserAgentParser.discriminator = undefined;
