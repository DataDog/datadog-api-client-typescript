...
export class UsageCWSResponse {
    ...
    */
    ...
    static deserialize(data: {[key: string]: any}): UsageCWSResponse {
      let res = new UsageCWSResponse();

      res.usage = ObjectSerializer.deserialize(data.usage, "Array<UsageCWSHour>", "")
    ...
    static serialize(data: UsageCWSResponse): {[key: string]: any} {
        let attributeTypes = UsageCWSResponse.getAttributeTypeMap();
        ...
        res.usage = ObjectSerializer.serialize(data.usage, "Array<UsageCWSHour>", "")
