...
export class SLOHistoryMetrics {
    ...
    */
    ...
    static deserialize(data: {[key: string]: any}): SLOHistoryMetrics {
      ...
      res.numerator = ObjectSerializer.deserialize(data.numerator, "SLOHistoryMetricsSeries", "")
      ...
      res.respVersion = ObjectSerializer.deserialize(data.resp_version, "number", "int64")

      if (data.times === undefined) {
          throw new TypeError("missing required attribute 'times' on 'SLOHistoryMetrics' object");
      }
      res.times = ObjectSerializer.deserialize(data.times, "Array<number>", "double")
    ...
    static serialize(data: SLOHistoryMetrics): {[key: string]: any} {
        let attributeTypes = SLOHistoryMetrics.getAttributeTypeMap();
        ...
        res.denominator = ObjectSerializer.serialize(data.denominator, "SLOHistoryMetricsSeries", "")
        ...
        res.numerator = ObjectSerializer.serialize(data.numerator, "SLOHistoryMetricsSeries", "")
        ...
        res.resp_version = ObjectSerializer.serialize(data.respVersion, "number", "int64")

        if (data.times === undefined) {
            throw new TypeError("missing required attribute 'times' on 'SLOHistoryMetrics' object");
        }
        res.times = ObjectSerializer.serialize(data.times, "Array<number>", "double")
