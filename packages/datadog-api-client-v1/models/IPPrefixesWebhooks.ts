...
export class IPPrefixesWebhooks {
  ...
  static deserialize(data: { [key: string]: any }): IPPrefixesWebhooks {
    const res = new IPPrefixesWebhooks();
  ...
  static serialize(data: IPPrefixesWebhooks): { [key: string]: any } {
    const attributeTypes = IPPrefixesWebhooks.getAttributeTypeMap();
