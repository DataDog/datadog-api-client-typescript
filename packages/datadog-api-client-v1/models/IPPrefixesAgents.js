...
var IPPrefixesAgents = /** @class */ (function () {
    ...
    IPPrefixesAgents.deserialize = function (data) {
        var res = new IPPrefixesAgents();
    ...
    IPPrefixesAgents.serialize = function (data) {
        var attributeTypes = IPPrefixesAgents.getAttributeTypeMap();
        var res = {};
    ...
    IPPrefixesAgents.discriminator = undefined;
