...
export class OrganizationSettings {
    ...
    */
    ...
    static deserialize(data: {[key: string]: any}): OrganizationSettings {
      let res = new OrganizationSettings();

      res.privateWidgetShare = ObjectSerializer.deserialize(data.private_widget_share, "boolean", "")

      res.saml = ObjectSerializer.deserialize(data.saml, "OrganizationSettingsSaml", "")
      ...
      res.samlAutocreateUsersDomains = ObjectSerializer.deserialize(data.saml_autocreate_users_domains, "OrganizationSettingsSamlAutocreateUsersDomains", "")

      res.samlCanBeEnabled = ObjectSerializer.deserialize(data.saml_can_be_enabled, "boolean", "")

      res.samlIdpEndpoint = ObjectSerializer.deserialize(data.saml_idp_endpoint, "string", "")

      res.samlIdpInitiatedLogin = ObjectSerializer.deserialize(data.saml_idp_initiated_login, "OrganizationSettingsSamlIdpInitiatedLogin", "")

      res.samlIdpMetadataUploaded = ObjectSerializer.deserialize(data.saml_idp_metadata_uploaded, "boolean", "")

      res.samlLoginUrl = ObjectSerializer.deserialize(data.saml_login_url, "string", "")

      res.samlStrictMode = ObjectSerializer.deserialize(data.saml_strict_mode, "OrganizationSettingsSamlStrictMode", "")
    ...
    static serialize(data: OrganizationSettings): {[key: string]: any} {
        let attributeTypes = OrganizationSettings.getAttributeTypeMap();
        ...
        res.private_widget_share = ObjectSerializer.serialize(data.privateWidgetShare, "boolean", "")

        res.saml = ObjectSerializer.serialize(data.saml, "OrganizationSettingsSaml", "")
        ...
        res.saml_autocreate_users_domains = ObjectSerializer.serialize(data.samlAutocreateUsersDomains, "OrganizationSettingsSamlAutocreateUsersDomains", "")

        res.saml_can_be_enabled = ObjectSerializer.serialize(data.samlCanBeEnabled, "boolean", "")

        res.saml_idp_endpoint = ObjectSerializer.serialize(data.samlIdpEndpoint, "string", "")

        res.saml_idp_initiated_login = ObjectSerializer.serialize(data.samlIdpInitiatedLogin, "OrganizationSettingsSamlIdpInitiatedLogin", "")

        res.saml_idp_metadata_uploaded = ObjectSerializer.serialize(data.samlIdpMetadataUploaded, "boolean", "")

        res.saml_login_url = ObjectSerializer.serialize(data.samlLoginUrl, "string", "")

        res.saml_strict_mode = ObjectSerializer.serialize(data.samlStrictMode, "OrganizationSettingsSamlStrictMode", "")
