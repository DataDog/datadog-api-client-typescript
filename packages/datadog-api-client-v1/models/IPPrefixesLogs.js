...
var IPPrefixesLogs = /** @class */ (function () {
    ...
    IPPrefixesLogs.deserialize = function (data) {
        var res = new IPPrefixesLogs();
    ...
    IPPrefixesLogs.serialize = function (data) {
        var attributeTypes = IPPrefixesLogs.getAttributeTypeMap();
        var res = {};
    ...
    IPPrefixesLogs.discriminator = undefined;
