...
export class LogStreamWidgetDefinition {
    ...
    */
    ...
    static deserialize(data: {[key: string]: any}): LogStreamWidgetDefinition {
      let res = new LogStreamWidgetDefinition();

      res.columns = ObjectSerializer.deserialize(data.columns, "Array<string>", "")
      ...
      res.showDateColumn = ObjectSerializer.deserialize(data.show_date_column, "boolean", "")

      res.showMessageColumn = ObjectSerializer.deserialize(data.show_message_column, "boolean", "")
    ...
    static serialize(data: LogStreamWidgetDefinition): {[key: string]: any} {
        let attributeTypes = LogStreamWidgetDefinition.getAttributeTypeMap();
        ...
        res.show_date_column = ObjectSerializer.serialize(data.showDateColumn, "boolean", "")

        res.show_message_column = ObjectSerializer.serialize(data.showMessageColumn, "boolean", "")
