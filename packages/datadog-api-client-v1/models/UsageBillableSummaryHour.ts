...
export class UsageBillableSummaryHour {
    ...
    */
    ...
    static deserialize(data: {[key: string]: any}): UsageBillableSummaryHour {
      let res = new UsageBillableSummaryHour();

      res.billingPlan = ObjectSerializer.deserialize(data.billing_plan, "string", "")

      res.endDate = ObjectSerializer.deserialize(data.end_date, "Date", "date-time")

      res.numOrgs = ObjectSerializer.deserialize(data.num_orgs, "number", "int64")
      ...
      res.ratioInMonth = ObjectSerializer.deserialize(data.ratio_in_month, "number", "int64")

      res.startDate = ObjectSerializer.deserialize(data.start_date, "Date", "date-time")

      res.usage = ObjectSerializer.deserialize(data.usage, "UsageBillableSummaryKeys", "")
    ...
    static serialize(data: UsageBillableSummaryHour): {[key: string]: any} {
        let attributeTypes = UsageBillableSummaryHour.getAttributeTypeMap();
        ...
        res.billing_plan = ObjectSerializer.serialize(data.billingPlan, "string", "")
        ...
        res.ratio_in_month = ObjectSerializer.serialize(data.ratioInMonth, "number", "int64")

        res.start_date = ObjectSerializer.serialize(data.startDate, "Date", "date-time")

        res.usage = ObjectSerializer.serialize(data.usage, "UsageBillableSummaryKeys", "")
