...
var UsageCustomReportsData = /** @class */ (function () {
    ...
    UsageCustomReportsData.deserialize = function (data) {
        var res = new UsageCustomReportsData();
        res.attributes = ObjectSerializer_1.ObjectSerializer.deserialize(data.attributes, "UsageCustomReportsAttributes", "");
    ...
    UsageCustomReportsData.serialize = function (data) {
        var attributeTypes = UsageCustomReportsData.getAttributeTypeMap();
        var res = {};
        ...
        res.attributes = ObjectSerializer_1.ObjectSerializer.serialize(data.attributes, "UsageCustomReportsAttributes", "");
    ...
    UsageCustomReportsData.discriminator = undefined;
