...
var MonitorUpdateRequest = /** @class */ (function () {
    ...
    MonitorUpdateRequest.deserialize = function (data) {
        var res = new MonitorUpdateRequest();
    ...
    MonitorUpdateRequest.serialize = function (data) {
        var attributeTypes = MonitorUpdateRequest.getAttributeTypeMap();
        var res = {};
    ...
    MonitorUpdateRequest.discriminator = undefined;
