...
var UsageSpecifiedCustomReportsPage = /** @class */ (function () {
    ...
    UsageSpecifiedCustomReportsPage.deserialize = function (data) {
        var res = new UsageSpecifiedCustomReportsPage();
        res.totalCount = ObjectSerializer_1.ObjectSerializer.deserialize(data.total_count, "number", "int64");
        return res;
    };
    UsageSpecifiedCustomReportsPage.serialize = function (data) {
        var attributeTypes = UsageSpecifiedCustomReportsPage.getAttributeTypeMap();
        var res = {};
    ...
    UsageSpecifiedCustomReportsPage.discriminator = undefined;
