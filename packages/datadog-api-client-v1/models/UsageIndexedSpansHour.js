...
var UsageIndexedSpansHour = /** @class */ (function () {
    ...
    UsageIndexedSpansHour.deserialize = function (data) {
        var res = new UsageIndexedSpansHour();
    ...
    UsageIndexedSpansHour.serialize = function (data) {
        var attributeTypes = UsageIndexedSpansHour.getAttributeTypeMap();
        var res = {};
    ...
    UsageIndexedSpansHour.discriminator = undefined;
