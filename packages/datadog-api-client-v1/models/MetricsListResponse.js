...
var MetricsListResponse = /** @class */ (function () {
    ...
    MetricsListResponse.deserialize = function (data) {
        var res = new MetricsListResponse();
    ...
    MetricsListResponse.serialize = function (data) {
        var attributeTypes = MetricsListResponse.getAttributeTypeMap();
        var res = {};
    ...
    MetricsListResponse.discriminator = undefined;
