...
var SyntheticsAPITestResultFull = /** @class */ (function () {
    ...
    SyntheticsAPITestResultFull.deserialize = function (data) {
        var res = new SyntheticsAPITestResultFull();
        res.check = ObjectSerializer_1.ObjectSerializer.deserialize(data.check, "SyntheticsAPITestResultFullCheck", "");
        ...
        res.result = ObjectSerializer_1.ObjectSerializer.deserialize(data.result, "SyntheticsAPITestResultData", "");
    ...
    SyntheticsAPITestResultFull.serialize = function (data) {
        var attributeTypes = SyntheticsAPITestResultFull.getAttributeTypeMap();
        var res = {};
        ...
        res.check = ObjectSerializer_1.ObjectSerializer.serialize(data.check, "SyntheticsAPITestResultFullCheck", "");
        ...
        res.result = ObjectSerializer_1.ObjectSerializer.serialize(data.result, "SyntheticsAPITestResultData", "");
    ...
    SyntheticsAPITestResultFull.discriminator = undefined;
