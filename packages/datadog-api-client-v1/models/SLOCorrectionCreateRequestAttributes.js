...
var SLOCorrectionCreateRequestAttributes = /** @class */ (function () {
    ...
    SLOCorrectionCreateRequestAttributes.deserialize = function (data) {
        var res = new SLOCorrectionCreateRequestAttributes();
        if (data.category === undefined) {
            throw new TypeError("missing required attribute 'category' on 'SLOCorrectionCreateRequestAttributes' object");
        }
        ...
        if (data.end === undefined) {
            throw new TypeError("missing required attribute 'end' on 'SLOCorrectionCreateRequestAttributes' object");
        }
        res.end = ObjectSerializer_1.ObjectSerializer.deserialize(data.end, "number", "int64");
        if (data.slo_id === undefined) {
            throw new TypeError("missing required attribute 'slo_id' on 'SLOCorrectionCreateRequestAttributes' object");
        }
        res.sloId = ObjectSerializer_1.ObjectSerializer.deserialize(data.slo_id, "string", "");
        if (data.start === undefined) {
            throw new TypeError("missing required attribute 'start' on 'SLOCorrectionCreateRequestAttributes' object");
        }
    ...
    SLOCorrectionCreateRequestAttributes.serialize = function (data) {
        var attributeTypes = SLOCorrectionCreateRequestAttributes.getAttributeTypeMap();
        var res = {};
    ...
    SLOCorrectionCreateRequestAttributes.discriminator = undefined;
