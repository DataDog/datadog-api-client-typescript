...
export class Monitor {
  ...
  static deserialize(data: { [key: string]: any }): Monitor {
    const res = new Monitor();
    ...
    if (data.query === undefined) {
      throw new TypeError(
        "missing required attribute 'query' on 'Monitor' object"
      );
    }
    ...
    if (data.type === undefined) {
      throw new TypeError(
        "missing required attribute 'type' on 'Monitor' object"
      );
    }
    if (
      [
  ...
  static serialize(data: Monitor): { [key: string]: any } {
    const attributeTypes = Monitor.getAttributeTypeMap();
