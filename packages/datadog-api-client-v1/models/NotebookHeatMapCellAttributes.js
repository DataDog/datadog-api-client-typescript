...
var NotebookHeatMapCellAttributes = /** @class */ (function () {
    ...
    NotebookHeatMapCellAttributes.deserialize = function (data) {
        var res = new NotebookHeatMapCellAttributes();
        if (data.definition === undefined) {
            throw new TypeError("missing required attribute 'definition' on 'NotebookHeatMapCellAttributes' object");
        }
        res.definition = ObjectSerializer_1.ObjectSerializer.deserialize(data.definition, "HeatMapWidgetDefinition", "");
    ...
    NotebookHeatMapCellAttributes.serialize = function (data) {
        var attributeTypes = NotebookHeatMapCellAttributes.getAttributeTypeMap();
        var res = {};
        ...
        res.definition = ObjectSerializer_1.ObjectSerializer.serialize(data.definition, "HeatMapWidgetDefinition", "");
    ...
    NotebookHeatMapCellAttributes.discriminator = undefined;
