...
export class UsageAuditLogsHour {
    ...
    */
    ...
    static deserialize(data: {[key: string]: any}): UsageAuditLogsHour {
      let res = new UsageAuditLogsHour();

      res.hour = ObjectSerializer.deserialize(data.hour, "Date", "date-time")

      res.linesIndexed = ObjectSerializer.deserialize(data.lines_indexed, "number", "int64")
    ...
    static serialize(data: UsageAuditLogsHour): {[key: string]: any} {
        let attributeTypes = UsageAuditLogsHour.getAttributeTypeMap();
        ...
        res.lines_indexed = ObjectSerializer.serialize(data.linesIndexed, "number", "int64")
