...
var NotebookToplistCellAttributes = /** @class */ (function () {
    ...
    NotebookToplistCellAttributes.deserialize = function (data) {
        var res = new NotebookToplistCellAttributes();
        if (data.definition === undefined) {
            throw new TypeError("missing required attribute 'definition' on 'NotebookToplistCellAttributes' object");
        }
        res.definition = ObjectSerializer_1.ObjectSerializer.deserialize(data.definition, "ToplistWidgetDefinition", "");
    ...
    NotebookToplistCellAttributes.serialize = function (data) {
        var attributeTypes = NotebookToplistCellAttributes.getAttributeTypeMap();
        var res = {};
        ...
        res.definition = ObjectSerializer_1.ObjectSerializer.serialize(data.definition, "ToplistWidgetDefinition", "");
    ...
    NotebookToplistCellAttributes.discriminator = undefined;
