...
export class SLOHistoryMetricsSeries {
    ...
    */
    ...
    static deserialize(data: {[key: string]: any}): SLOHistoryMetricsSeries {
      let res = new SLOHistoryMetricsSeries();
      ...
      res.metadata = ObjectSerializer.deserialize(data.metadata, "SLOHistoryMetricsSeriesMetadata", "")
      ...
      res.values = ObjectSerializer.deserialize(data.values, "Array<number>", "double")
    ...
    static serialize(data: SLOHistoryMetricsSeries): {[key: string]: any} {
        let attributeTypes = SLOHistoryMetricsSeries.getAttributeTypeMap();
        ...
        res.metadata = ObjectSerializer.serialize(data.metadata, "SLOHistoryMetricsSeriesMetadata", "")
        ...
        res.values = ObjectSerializer.serialize(data.values, "Array<number>", "double")
