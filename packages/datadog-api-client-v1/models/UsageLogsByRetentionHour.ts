...
export class UsageLogsByRetentionHour {
    ...
    */
    ...
    static deserialize(data: {[key: string]: any}): UsageLogsByRetentionHour {
      let res = new UsageLogsByRetentionHour();

      res.indexedEventsCount = ObjectSerializer.deserialize(data.indexed_events_count, "number", "int64")

      res.liveIndexedEventsCount = ObjectSerializer.deserialize(data.live_indexed_events_count, "number", "int64")

      res.rehydratedIndexedEventsCount = ObjectSerializer.deserialize(data.rehydrated_indexed_events_count, "number", "int64")
    ...
    static serialize(data: UsageLogsByRetentionHour): {[key: string]: any} {
        let attributeTypes = UsageLogsByRetentionHour.getAttributeTypeMap();
        ...
        res.live_indexed_events_count = ObjectSerializer.serialize(data.liveIndexedEventsCount, "number", "int64")

        res.rehydrated_indexed_events_count = ObjectSerializer.serialize(data.rehydratedIndexedEventsCount, "number", "int64")
