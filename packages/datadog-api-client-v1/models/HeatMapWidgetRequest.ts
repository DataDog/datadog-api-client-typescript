...
export class HeatMapWidgetRequest {
    ...
    */
    ...
    static deserialize(data: {[key: string]: any}): HeatMapWidgetRequest {
      let res = new HeatMapWidgetRequest();

      res.apmQuery = ObjectSerializer.deserialize(data.apm_query, "LogQueryDefinition", "")

      res.eventQuery = ObjectSerializer.deserialize(data.event_query, "EventQueryDefinition", "")
    ...
    static serialize(data: HeatMapWidgetRequest): {[key: string]: any} {
        let attributeTypes = HeatMapWidgetRequest.getAttributeTypeMap();
        ...
        res.event_query = ObjectSerializer.serialize(data.eventQuery, "EventQueryDefinition", "")
