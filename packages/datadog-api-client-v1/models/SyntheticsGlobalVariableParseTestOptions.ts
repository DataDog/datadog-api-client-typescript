...
export class SyntheticsGlobalVariableParseTestOptions {
    ...
    */
    ...
    static deserialize(data: {[key: string]: any}): SyntheticsGlobalVariableParseTestOptions {
      let res = new SyntheticsGlobalVariableParseTestOptions();
    ...
    static serialize(data: SyntheticsGlobalVariableParseTestOptions): {[key: string]: any} {
        let attributeTypes = SyntheticsGlobalVariableParseTestOptions.getAttributeTypeMap();
