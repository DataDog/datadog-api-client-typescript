...
var EventListResponse = /** @class */ (function () {
    ...
    EventListResponse.deserialize = function (data) {
        var res = new EventListResponse();
        res.events = ObjectSerializer_1.ObjectSerializer.deserialize(data.events, "Array<Event>", "");
        res.status = ObjectSerializer_1.ObjectSerializer.deserialize(data.status, "string", "");
        return res;
    };
    EventListResponse.serialize = function (data) {
        var attributeTypes = EventListResponse.getAttributeTypeMap();
        var res = {};
        ...
        res.events = ObjectSerializer_1.ObjectSerializer.serialize(data.events, "Array<Event>", "");
        res.status = ObjectSerializer_1.ObjectSerializer.serialize(data.status, "string", "");
        return res;
    };
    EventListResponse.discriminator = undefined;
