...
var UsageSpecifiedCustomReportsMeta = /** @class */ (function () {
    ...
    UsageSpecifiedCustomReportsMeta.deserialize = function (data) {
        var res = new UsageSpecifiedCustomReportsMeta();
        res.page = ObjectSerializer_1.ObjectSerializer.deserialize(data.page, "UsageSpecifiedCustomReportsPage", "");
        return res;
    };
    UsageSpecifiedCustomReportsMeta.serialize = function (data) {
        var attributeTypes = UsageSpecifiedCustomReportsMeta.getAttributeTypeMap();
        var res = {};
        ...
        res.page = ObjectSerializer_1.ObjectSerializer.serialize(data.page, "UsageSpecifiedCustomReportsPage", "");
        return res;
    };
    UsageSpecifiedCustomReportsMeta.discriminator = undefined;
