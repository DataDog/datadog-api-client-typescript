...
export class ApplicationKeyListResponse {
  ...
  static deserialize(data: { [key: string]: any }): ApplicationKeyListResponse {
    const res = new ApplicationKeyListResponse();

    res.applicationKeys = ObjectSerializer.deserialize(
  ...
  static serialize(data: ApplicationKeyListResponse): { [key: string]: any } {
    const attributeTypes = ApplicationKeyListResponse.getAttributeTypeMap();
    ...
    res.application_keys = ObjectSerializer.serialize(
