...
var EventCreateResponse = /** @class */ (function () {
    ...
    EventCreateResponse.deserialize = function (data) {
        var res = new EventCreateResponse();
    ...
    EventCreateResponse.serialize = function (data) {
        var attributeTypes = EventCreateResponse.getAttributeTypeMap();
        var res = {};
    ...
    EventCreateResponse.discriminator = undefined;
