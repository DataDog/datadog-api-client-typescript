...
var NotebookTimeseriesCellAttributes = /** @class */ (function () {
    ...
    NotebookTimeseriesCellAttributes.deserialize = function (data) {
        var res = new NotebookTimeseriesCellAttributes();
        if (data.definition === undefined) {
            throw new TypeError("missing required attribute 'definition' on 'NotebookTimeseriesCellAttributes' object");
        }
        res.definition = ObjectSerializer_1.ObjectSerializer.deserialize(data.definition, "TimeseriesWidgetDefinition", "");
    ...
    NotebookTimeseriesCellAttributes.serialize = function (data) {
        var attributeTypes = NotebookTimeseriesCellAttributes.getAttributeTypeMap();
        var res = {};
        ...
        res.definition = ObjectSerializer_1.ObjectSerializer.serialize(data.definition, "TimeseriesWidgetDefinition", "");
    ...
    NotebookTimeseriesCellAttributes.discriminator = undefined;
