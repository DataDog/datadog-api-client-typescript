...
export class LogQueryDefinitionGroupBy {
    ...
    */
    ...
    static deserialize(data: {[key: string]: any}): LogQueryDefinitionGroupBy {
      let res = new LogQueryDefinitionGroupBy();
      ...
      res.sort = ObjectSerializer.deserialize(data.sort, "LogQueryDefinitionGroupBySort", "")
    ...
    static serialize(data: LogQueryDefinitionGroupBy): {[key: string]: any} {
        let attributeTypes = LogQueryDefinitionGroupBy.getAttributeTypeMap();
        ...
        res.sort = ObjectSerializer.serialize(data.sort, "LogQueryDefinitionGroupBySort", "")
