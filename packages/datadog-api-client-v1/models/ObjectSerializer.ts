...
const enumsMap: {[key: string]: any[]} = {
  ...
  "SyntheticsAPITestStepSubtype": ['http', 'grpc', 'ssl', 'dns', 'tcp', 'udp', 'icmp', 'websocket'],
  ...
  "SyntheticsStepType": ['assertCurrentUrl', 'assertElementAttribute', 'assertElementContent', 'assertElementPresent', 'assertEmail', 'assertFileDownload', 'assertFromJavascript', 'assertPageContains', 'assertPageLacks', 'assertRequests', 'click', 'extractFromJavascript', 'extractFromEmailBody', 'extractVariable', 'goToEmailLink', 'goToUrl', 'goToUrlAndMeasureTti', 'hover', 'playSubTest', 'pressKey', 'refresh', 'runApiTest', 'scroll', 'selectOption', 'typeText', 'uploadFiles', 'wait'],
...
const oneOfMap: {[index: string]: string[]} = {
  ...
  "DistributionWidgetHistogramRequestQuery": ["FormulaAndFunctionMetricQueryDefinition", "FormulaAndFunctionEventQueryDefinition", "FormulaAndFunctionApmResourceStatsQueryDefinition"],
  ...
  "SplitGraphSourceWidgetDefinition": ["ChangeWidgetDefinition", "GeomapWidgetDefinition", "QueryValueWidgetDefinition", "ScatterPlotWidgetDefinition", "SunburstWidgetDefinition", "TableWidgetDefinition", "TimeseriesWidgetDefinition", "ToplistWidgetDefinition", "TreeMapWidgetDefinition"],
  ...
  "SyntheticsAssertion": ["SyntheticsAssertionTarget", "SyntheticsAssertionBodyHashTarget", "SyntheticsAssertionJSONPathTarget", "SyntheticsAssertionJSONSchemaTarget", "SyntheticsAssertionXPathTarget", "SyntheticsAssertionJavascript"],
  "SyntheticsAssertionTargetValue": ["number", "string"],
  "SyntheticsBasicAuth": ["SyntheticsBasicAuthWeb", "SyntheticsBasicAuthSigv4", "SyntheticsBasicAuthNTLM", "SyntheticsBasicAuthDigest", "SyntheticsBasicAuthOauthClient", "SyntheticsBasicAuthOauthROP"],
