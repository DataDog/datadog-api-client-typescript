...
const enumsMap: {[key: string]: any[]} = {
    ...
    MonitorFormulaAndFunctionDataQualityModelTypeOverride: ["freshness", "percentage", "any"],
    MonitorFormulaAndFunctionEventAggregation: ["count", "cardinality", "median", "pc75", "pc90", "pc95", "pc98", "pc99", "sum", "min", "max", "avg"],
    MonitorFormulaAndFunctionEventsDataSource: ["rum", "ci_pipelines", "ci_tests", "audit", "events", "logs", "spans", "database_queries", "network", "network_path"],
    MonitorFormulaAndFunctionMetricsAggregator: ["avg", "min", "max", "sum", "last", "mean", "area", "l2norm", "percentile", "stddev", "count_unique"],
    MonitorFormulaAndFunctionMetricsDataSource: ["metrics", "cloud_cost", "datadog_usage"],
    MonitorFormulaAndFunctionReferenceTableDataSource: ["reference_table"],
    MonitorOptionsNotificationPresets: ["show_all", "hide_query", "hide_handles", "hide_all", "hide_query_and_handles", "show_only_snapshot", "hide_handles_and_footer"],
...
const typeMap: {[index: string]: any} = {
    ...
    MonitorFormulaAndFunctionAggregateQueryFilter: MonitorFormulaAndFunctionAggregateQueryFilter,
    MonitorFormulaAndFunctionAggregateQueryJoinCondition: MonitorFormulaAndFunctionAggregateQueryJoinCondition,
    ...
    MonitorFormulaAndFunctionDataQualityMonitorOptions: MonitorFormulaAndFunctionDataQualityMonitorOptions,
    ...
    NotebookTemplateVariableAvailableValuesQueryGroupBy: NotebookTemplateVariableAvailableValuesQueryGroupBy,
    ...
    NotebookTemplateVariableAvailableValuesQuerySearch: NotebookTemplateVariableAvailableValuesQuerySearch,
...
const oneOfMap: {[index: string]: string[]} = {
  ...
  "DashboardDefaultTimeframeSetting": ["DashboardLiveTimeframe", "DashboardFixedTimeframe"],
  "DistributionPointItem": ["number", "Array<number>"],
  "DistributionWidgetHistogramRequestQuery": ["FormulaAndFunctionMetricQueryDefinition", "FormulaAndFunctionEventQueryDefinition", "FormulaAndFunctionApmResourceStatsQueryDefinition", "FormulaAndFunctionApmMetricsQueryDefinition"],
  "EventsAggregation": ["EventsAggregationValue", "string"],
  "FormulaAndFunctionEventQueryGroupByConfig": ["Array<FormulaAndFunctionEventQueryGroupBy>", "FormulaAndFunctionEventQueryGroupByFields"],
  "FormulaAndFunctionQueryDefinition": ["FormulaAndFunctionMetricQueryDefinition", "FormulaAndFunctionEventQueryDefinition", "FormulaAndFunctionProcessQueryDefinition", "FormulaAndFunctionApmDependencyStatsQueryDefinition", "FormulaAndFunctionApmResourceStatsQueryDefinition", "FormulaAndFunctionApmMetricsQueryDefinition", "FormulaAndFunctionSLOQueryDefinition", "FormulaAndFunctionCloudCostQueryDefinition", "FormulaAndFunctionProductAnalyticsExtendedQueryDefinition", "FormulaAndFunctionUserJourneyQueryDefinition", "FormulaAndFunctionRetentionQueryDefinition"],
  "LogsArrayMapSubProcessor": ["LogsArrayMapAttributeRemapper", "LogsArrayMapArithmeticSubProcessor", "LogsArrayMapStringBuilderSubProcessor", "LogsArrayMapCategorySubProcessor"],
  "LogsArrayProcessorOperation": ["LogsArrayProcessorOperationAppend", "LogsArrayProcessorOperationLength", "LogsArrayProcessorOperationSelect"],
  ...
  "MonitorFormulaAndFunctionAggregateAugmentQuery": ["MonitorFormulaAndFunctionEventQueryDefinition", "MonitorFormulaAndFunctionReferenceTableQueryDefinition"],
  "MonitorFormulaAndFunctionAggregateBaseQuery": ["MonitorFormulaAndFunctionEventQueryDefinition", "MonitorFormulaAndFunctionMetricsQueryDefinition"],
  "MonitorFormulaAndFunctionAggregateFilterQuery": ["MonitorFormulaAndFunctionEventQueryDefinition", "MonitorFormulaAndFunctionReferenceTableQueryDefinition"],
  ...
  "NotebookCellCreateRequestAttributes": ["NotebookMarkdownCellAttributes", "NotebookTimeseriesCellAttributes", "NotebookToplistCellAttributes", "NotebookHeatMapCellAttributes", "NotebookDistributionCellAttributes", "NotebookLogStreamCellAttributes"],
  "NotebookCellResponseAttributes": ["NotebookMarkdownCellAttributes", "NotebookTimeseriesCellAttributes", "NotebookToplistCellAttributes", "NotebookHeatMapCellAttributes", "NotebookDistributionCellAttributes", "NotebookLogStreamCellAttributes"],
  "NotebookCellTime": ["NotebookRelativeTime", "NotebookAbsoluteTime"],
  "NotebookCellUpdateRequestAttributes": ["NotebookMarkdownCellAttributes", "NotebookTimeseriesCellAttributes", "NotebookToplistCellAttributes", "NotebookHeatMapCellAttributes", "NotebookDistributionCellAttributes", "NotebookLogStreamCellAttributes"],
  "NotebookGlobalTime": ["NotebookRelativeTime", "NotebookAbsoluteTime"],
  "NotebookTemplateVariableAvailableValuesQuery": ["NotebookTemplateVariableAvailableValuesQueryLogRumSpans", "NotebookTemplateVariableAvailableValuesQueryMetrics"],
  ...
  "SharedDashboardInvitesData": ["SharedDashboardInvitesDataObject", "Array<SharedDashboardInvitesDataObject>"],
  "SplitGraphSourceWidgetDefinition": ["BarChartWidgetDefinition", "ChangeWidgetDefinition", "GeomapWidgetDefinition", "QueryValueWidgetDefinition", "ScatterPlotWidgetDefinition", "SunburstWidgetDefinition", "TableWidgetDefinition", "TimeseriesWidgetDefinition", "ToplistWidgetDefinition", "TreeMapWidgetDefinition"],
  "SunburstWidgetLegend": ["SunburstWidgetLegendTable", "SunburstWidgetLegendInlineAutomatic"],
  "SyntheticsAPIStep": ["SyntheticsAPITestStep", "SyntheticsAPIWaitStep", "SyntheticsAPISubtestStep"],
  ...
  "SyntheticsBasicAuth": ["SyntheticsBasicAuthWeb", "SyntheticsBasicAuthSigv4", "SyntheticsBasicAuthNTLM", "SyntheticsBasicAuthDigest", "SyntheticsBasicAuthOauthClient", "SyntheticsBasicAuthOauthROP", "SyntheticsBasicAuthJWT"],
  ...
  "TableWidgetTextFormatReplace": ["TableWidgetTextFormatReplaceAll", "TableWidgetTextFormatReplaceSubstring"],
  ...
  "WildcardWidgetRequest": ["TreeMapWidgetRequest", "TimeseriesWidgetRequest", "ListStreamWidgetRequest", "DistributionWidgetRequest"],
};
