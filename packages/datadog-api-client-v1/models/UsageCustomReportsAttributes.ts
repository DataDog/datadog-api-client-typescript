...
export class UsageCustomReportsAttributes {
    ...
    */
    ...
    static deserialize(data: {[key: string]: any}): UsageCustomReportsAttributes {
      let res = new UsageCustomReportsAttributes();
    ...
    static serialize(data: UsageCustomReportsAttributes): {[key: string]: any} {
        let attributeTypes = UsageCustomReportsAttributes.getAttributeTypeMap();
