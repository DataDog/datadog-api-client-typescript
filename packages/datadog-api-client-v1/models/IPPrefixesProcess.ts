...
export class IPPrefixesProcess {
  ...
  static deserialize(data: { [key: string]: any }): IPPrefixesProcess {
    const res = new IPPrefixesProcess();
  ...
  static serialize(data: IPPrefixesProcess): { [key: string]: any } {
    const attributeTypes = IPPrefixesProcess.getAttributeTypeMap();
