...
var HeatMapWidgetRequest = /** @class */ (function () {
    ...
    HeatMapWidgetRequest.deserialize = function (data) {
        var res = new HeatMapWidgetRequest();
        res.apmQuery = ObjectSerializer_1.ObjectSerializer.deserialize(data.apm_query, "LogQueryDefinition", "");
        res.eventQuery = ObjectSerializer_1.ObjectSerializer.deserialize(data.event_query, "EventQueryDefinition", "");
    ...
    HeatMapWidgetRequest.serialize = function (data) {
        var attributeTypes = HeatMapWidgetRequest.getAttributeTypeMap();
        var res = {};
        ...
        res.event_query = ObjectSerializer_1.ObjectSerializer.serialize(data.eventQuery, "EventQueryDefinition", "");
    ...
    HeatMapWidgetRequest.discriminator = undefined;
