...
export class UsageSyntheticsAPIHour {
  ...
  static deserialize(data: { [key: string]: any }): UsageSyntheticsAPIHour {
    const res = new UsageSyntheticsAPIHour();

    res.checkCallsCount = ObjectSerializer.deserialize(
      data.check_calls_count,
      "number",
      "int64"
    );
  ...
  static serialize(data: UsageSyntheticsAPIHour): { [key: string]: any } {
    const attributeTypes = UsageSyntheticsAPIHour.getAttributeTypeMap();
    ...
    res.check_calls_count = ObjectSerializer.serialize(
      data.checkCallsCount,
      "number",
      "int64"
    );
