...
var UsageProfilingResponse = /** @class */ (function () {
    ...
    UsageProfilingResponse.deserialize = function (data) {
        var res = new UsageProfilingResponse();
        res.usage = ObjectSerializer_1.ObjectSerializer.deserialize(data.usage, "Array<UsageProfilingHour>", "");
        return res;
    };
    UsageProfilingResponse.serialize = function (data) {
        var attributeTypes = UsageProfilingResponse.getAttributeTypeMap();
        var res = {};
        ...
        res.usage = ObjectSerializer_1.ObjectSerializer.serialize(data.usage, "Array<UsageProfilingHour>", "");
        return res;
    };
    UsageProfilingResponse.discriminator = undefined;
