...
export class NotebookUpdateRequest {
    ...
    static deserialize(data: {[key: string]: any}): NotebookUpdateRequest {
      let res = new NotebookUpdateRequest();

      if (data.data === undefined) {
          throw new TypeError("missing required attribute 'data' on 'NotebookUpdateRequest' object");
      }
      res.data = ObjectSerializer.deserialize(data.data, "NotebookUpdateData", "")
    ...
    static serialize(data: NotebookUpdateRequest): {[key: string]: any} {
        let attributeTypes = NotebookUpdateRequest.getAttributeTypeMap();
