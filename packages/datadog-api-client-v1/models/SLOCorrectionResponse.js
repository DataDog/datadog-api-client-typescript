...
var SLOCorrectionResponse = /** @class */ (function () {
    ...
    SLOCorrectionResponse.deserialize = function (data) {
        var res = new SLOCorrectionResponse();
        res.data = ObjectSerializer_1.ObjectSerializer.deserialize(data.data, "SLOCorrection", "");
        return res;
    };
    SLOCorrectionResponse.serialize = function (data) {
        var attributeTypes = SLOCorrectionResponse.getAttributeTypeMap();
        var res = {};
        ...
        res.data = ObjectSerializer_1.ObjectSerializer.serialize(data.data, "SLOCorrection", "");
        return res;
    };
    SLOCorrectionResponse.discriminator = undefined;
