...
var SyntheticsBrowserTestResultShort = /** @class */ (function () {
    ...
    SyntheticsBrowserTestResultShort.deserialize = function (data) {
        var res = new SyntheticsBrowserTestResultShort();
        ...
        res.result = ObjectSerializer_1.ObjectSerializer.deserialize(data.result, "SyntheticsBrowserTestResultShortResult", "");
    ...
    SyntheticsBrowserTestResultShort.serialize = function (data) {
        var attributeTypes = SyntheticsBrowserTestResultShort.getAttributeTypeMap();
        var res = {};
        ...
        res.result = ObjectSerializer_1.ObjectSerializer.serialize(data.result, "SyntheticsBrowserTestResultShortResult", "");
    ...
    SyntheticsBrowserTestResultShort.discriminator = undefined;
