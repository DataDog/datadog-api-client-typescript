...
export class MonitorSearchResult {
    ...
    */
    ...
    static deserialize(data: {[key: string]: any}): MonitorSearchResult {
      let res = new MonitorSearchResult();

      res.classification = ObjectSerializer.deserialize(data.classification, "string", "")
      ...
      res.notifications = ObjectSerializer.deserialize(data.notifications, "Array<MonitorSearchResultNotification>", "")
    ...
    static serialize(data: MonitorSearchResult): {[key: string]: any} {
        let attributeTypes = MonitorSearchResult.getAttributeTypeMap();
        ...
        res.classification = ObjectSerializer.serialize(data.classification, "string", "")
        ...
        res.notifications = ObjectSerializer.serialize(data.notifications, "Array<MonitorSearchResultNotification>", "")
