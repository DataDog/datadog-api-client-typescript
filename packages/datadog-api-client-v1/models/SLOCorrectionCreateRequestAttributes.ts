...
export class SLOCorrectionCreateRequestAttributes {
    ...
    */
    ...
    static deserialize(data: {[key: string]: any}): SLOCorrectionCreateRequestAttributes {
      let res = new SLOCorrectionCreateRequestAttributes();
    ...
    static serialize(data: SLOCorrectionCreateRequestAttributes): {[key: string]: any} {
        let attributeTypes = SLOCorrectionCreateRequestAttributes.getAttributeTypeMap();
