...
export class UsageCWSHour {
    ...
    */
    ...
    static deserialize(data: {[key: string]: any}): UsageCWSHour {
      let res = new UsageCWSHour();

      res.cwsContainerCount = ObjectSerializer.deserialize(data.cws_container_count, "number", "int64")

      res.cwsHostCount = ObjectSerializer.deserialize(data.cws_host_count, "number", "int64")
    ...
    static serialize(data: UsageCWSHour): {[key: string]: any} {
        let attributeTypes = UsageCWSHour.getAttributeTypeMap();
        ...
        res.cws_container_count = ObjectSerializer.serialize(data.cwsContainerCount, "number", "int64")

        res.cws_host_count = ObjectSerializer.serialize(data.cwsHostCount, "number", "int64")
