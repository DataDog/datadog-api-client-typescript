...
from generator.formatter import snake_case, untitle_case, format_parameters, format_data_with_schema, get_response_type
...
TYPESCRIPT_EXAMPLE_J2 = JINJA_ENV.get_template("example.j2")
...
def pytest_bdd_after_scenario(request, feature, scenario):
    ...
    data = TYPESCRIPT_EXAMPLE_J2.render(
        context=context,
        version=version,
        scenario=scenario,
    ...
    output = ROOT_PATH / "examples" / version / group_name / f"{operation_id}{unique_suffix}.ts"
