...
let params: v2.RUMApiListRUMEventsRequest = {
  // string | Search query following RUM syntax. (optional)
  ...
  // RUMSort | Order of events in results. (optional)
  sort: "timestamp",
