...
configuration.unstableOperations["v2.deleteScopesRestriction"] = true;
const apiInstance = new v2.OAuth2ClientPublicApi(configuration);

const params: v2.OAuth2ClientPublicApiDeleteScopesRestrictionRequest = {
  clientUuid: "fafa8e1c-36a5-11f0-a83d-da7ad0900001",
};

apiInstance
  .deleteScopesRestriction(params)
  .then((data: any) => {
    console.log(
