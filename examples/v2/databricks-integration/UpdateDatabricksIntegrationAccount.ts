...
configuration.unstableOperations["v2.updateDatabricksIntegrationAccount"] =
  true;
const apiInstance = new v2.DatabricksIntegrationApi(configuration);

const params: v2.DatabricksIntegrationApiUpdateDatabricksIntegrationAccountRequest =
  {
    body: {
      data: {
        attributes: {
          authentication: {
            authType: "databricks_oauth",
...
apiInstance
  .updateDatabricksIntegrationAccount(params)
