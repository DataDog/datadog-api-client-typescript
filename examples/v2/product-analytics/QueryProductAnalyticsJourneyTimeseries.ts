...
configuration.unstableOperations["v2.queryProductAnalyticsJourneyTimeseries"] =
  true;
const apiInstance = new v2.ProductAnalyticsApi(configuration);

const params: v2.ProductAnalyticsApiQueryProductAnalyticsJourneyTimeseriesRequest =
  {
    body: {
      data: {
        attributes: {
...
apiInstance
  .queryProductAnalyticsJourneyTimeseries(params)
  .then((data: v2.ProductAnalyticsJourneyTimeseriesResponse) => {
    console.log(
