...
configuration.unstableOperations["v2.queryProductAnalyticsJourneyList"] = true;
const apiInstance = new v2.ProductAnalyticsApi(configuration);

const params: v2.ProductAnalyticsApiQueryProductAnalyticsJourneyListRequest = {
  body: {
    data: {
      attributes: {
        from: 1756425600000,
        query: {
          computedColumns: [
            {
              name: "first_conversion_timestamps",
            },
          ],
...
apiInstance
  .queryProductAnalyticsJourneyList(params)
  .then((data: v2.ProductAnalyticsJourneyListResponse) => {
    console.log(
