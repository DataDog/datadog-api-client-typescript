...
configuration.unstableOperations["v2.queryProductAnalyticsJourneyFunnel"] =
  true;
const apiInstance = new v2.ProductAnalyticsApi(configuration);

const params: v2.ProductAnalyticsApiQueryProductAnalyticsJourneyFunnelRequest =
  {
    body: {
      data: {
        attributes: {
...
apiInstance
  .queryProductAnalyticsJourneyFunnel(params)
  .then((data: v2.ProductAnalyticsJourneyFunnelResponse) => {
    console.log(
