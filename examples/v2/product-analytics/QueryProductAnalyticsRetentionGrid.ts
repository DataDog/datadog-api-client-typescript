...
configuration.unstableOperations["v2.queryProductAnalyticsRetentionGrid"] =
  true;
const apiInstance = new v2.ProductAnalyticsApi(configuration);

const params: v2.ProductAnalyticsApiQueryProductAnalyticsRetentionGridRequest =
  {
    body: {
      data: {
        attributes: {
        ...
        type: "retention_grid_request",
      },
    },
  };

apiInstance
  .queryProductAnalyticsRetentionGrid(params)
  .then((data: v2.ProductAnalyticsRetentionGridResponse) => {
    console.log(
