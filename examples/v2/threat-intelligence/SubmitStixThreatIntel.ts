...
configuration.unstableOperations["v2.submitStixThreatIntel"] = true;
const apiInstance = new v2.ThreatIntelligenceApi(configuration);

const params: v2.ThreatIntelligenceApiSubmitStixThreatIntelRequest = {
  body: {
