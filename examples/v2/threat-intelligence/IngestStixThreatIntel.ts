...
configuration.unstableOperations["v2.ingestStixThreatIntel"] = true;
const apiInstance = new v2.ThreatIntelligenceApi(configuration);

const params: v2.ThreatIntelligenceApiIngestStixThreatIntelRequest = {
  body: {
