...
configuration.unstableOperations["v2.getSecurityFindingsAutomationMuteRule"] =
  true;
...
const params: v2.SecurityMonitoringApiGetSecurityFindingsAutomationMuteRuleRequest =
  {
    ruleId: VALID_MUTE_RULE_DATA_ID,
  };

apiInstance
  .getSecurityFindingsAutomationMuteRule(params)
