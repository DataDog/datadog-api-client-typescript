...
const params: v2.SecurityMonitoringApiReorderSecurityFindingsAutomationInboxRulesRequest =
  {
    body: {
      data: [
        {
...
apiInstance
  .reorderSecurityFindingsAutomationInboxRules(params)
  .then((data: v2.InboxRuleReorderResponse) => {
    console.log(
