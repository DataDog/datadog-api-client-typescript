...
configuration.unstableOperations["v2.reorderTagIndexingRules"] = true;
...
const params: v2.MetricsApiReorderTagIndexingRulesRequest = {
  body: {
    data: {
      attributes: {
        ruleIds: [TAG_INDEXING_RULE_DATA_ID],
      },
...
apiInstance
  .reorderTagIndexingRules(params)
  .then((data: any) => {
    console.log(
