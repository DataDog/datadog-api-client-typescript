...
configuration.unstableOperations["v2.updateElasticCloudMonitoringAccount"] =
  true;
const apiInstance = new v2.ElasticCloudIntegrationAccountsApi(configuration);

const params: v2.ElasticCloudIntegrationAccountsApiUpdateElasticCloudMonitoringAccountRequest =
  {
    body: {
      data: {
        attributes: {
...
apiInstance
  .updateElasticCloudMonitoringAccount(params)
