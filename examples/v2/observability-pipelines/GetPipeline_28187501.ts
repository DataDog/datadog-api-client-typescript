...
const PIPELINE_WITH_END_TO_END_ACKNOWLEDGEMENTS_DATA_ID = process.env
  .PIPELINE_WITH_END_TO_END_ACKNOWLEDGEMENTS_DATA_ID as string;

const params: v2.ObservabilityPipelinesApiGetPipelineRequest = {
  pipelineId: PIPELINE_WITH_END_TO_END_ACKNOWLEDGEMENTS_DATA_ID,
};
