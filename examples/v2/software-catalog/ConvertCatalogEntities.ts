...
configuration.unstableOperations["v2.convertCatalogEntities"] = true;
const apiInstance = new v2.SoftwareCatalogApi(configuration);

const params: v2.SoftwareCatalogApiConvertCatalogEntitiesRequest = {
  body: {
    apiVersion: "v3",
    datadog: {
      codeLocations: [
...
apiInstance
  .convertCatalogEntities(params)
  .then((data: v2.ConvertCatalogEntityResponse) => {
    console.log(
