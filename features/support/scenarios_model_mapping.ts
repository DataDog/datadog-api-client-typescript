export const ScenariosModelMappings: {[key: string]: {[key: string]: any}} = {
    ...
    "v2.GetEntraIdAzureAppRegistrations": {
    ...
    "v2.ListElasticCloudCcmAccounts": {
    ...
    "v2.ListElasticCloudMonitoringAccounts": {
