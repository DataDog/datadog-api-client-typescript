...
export class FleetAutomationApiRequestFactory extends BaseAPIRequestFactory {
  ...
  public async listFleetDeploymentsV2(
    ...
    if (ascending !== undefined) {
      requestContext.setQueryParam(
        "ascending",
        serialize(ascending, TypingInfo, "boolean", ""),
        "",
      );
    }
    if (filter !== undefined) {
...
export class FleetAutomationApiResponseProcessor {
  ...
  public async cancelFleetDeploymentV2(
    ...
    if (response.httpStatusCode === 200) {
      const body: FleetDeploymentV2CancelResponse = deserialize(
  ...
  public async createFleetDeploymentConfigureV2(
    ...
    const contentType = normalizeMediaType(response.headers["content-type"]);
    if (response.httpStatusCode === 200) {
      const body: FleetDeploymentConfigureV2DryRunResponse = deserialize(
        parse(await response.body.text(), contentType),
        TypingInfo,
    ...
    if (response.httpStatusCode === 201) {
      const body: FleetDeploymentV2CreateResponse = deserialize(
        parse(await response.body.text(), contentType),
        TypingInfo,
  ...
  public async getFleetAgentDetailV2(
    ...
    const contentType = normalizeMediaType(response.headers["content-type"]);
    if (response.httpStatusCode === 200) {
      const body: FleetAgentDetailV2Response = deserialize(
        parse(await response.body.text(), contentType),
        TypingInfo,
  ...
  public async getFleetDeploymentV2(
    ...
    const contentType = normalizeMediaType(response.headers["content-type"]);
    if (response.httpStatusCode === 200) {
      const body: FleetDeploymentV2DetailResponse = deserialize(
        parse(await response.body.text(), contentType),
        TypingInfo,
  ...
  public async getFleetScheduleV2(
    ...
    const contentType = normalizeMediaType(response.headers["content-type"]);
    if (response.httpStatusCode === 200) {
      const body: FleetScheduleV2Response = deserialize(
        parse(await response.body.text(), contentType),
        TypingInfo,
  ...
  public async listFleetAgentsV2(
    ...
    const contentType = normalizeMediaType(response.headers["content-type"]);
    if (response.httpStatusCode === 200) {
      const body: FleetAgentsV2Response = deserialize(
        parse(await response.body.text(), contentType),
        TypingInfo,
  ...
  public async listFleetAgentVersionsV2(
    ...
    const contentType = normalizeMediaType(response.headers["content-type"]);
    if (response.httpStatusCode === 200) {
      const body: FleetAgentVersionsV2Response = deserialize(
        parse(await response.body.text(), contentType),
        TypingInfo,
  ...
  public async listFleetDeploymentsV2(
    ...
    const contentType = normalizeMediaType(response.headers["content-type"]);
    if (response.httpStatusCode === 200) {
      const body: FleetDeploymentsV2Response = deserialize(
        parse(await response.body.text(), contentType),
        TypingInfo,
  ...
  public async listFleetSchedulesV2(
    ...
    const contentType = normalizeMediaType(response.headers["content-type"]);
    if (response.httpStatusCode === 200) {
      const body: FleetSchedulesV2Response = deserialize(
        parse(await response.body.text(), contentType),
        TypingInfo,
