...
export class LogsIndexesApiRequestFactory extends BaseAPIRequestFactory {
  ...
  public constructor(configuration: Configuration) {
    super(configuration);
    if (!isBrowser) {
      this.userAgent = buildUserAgent("logs-indexes", version);
    }
  }
  public async createLogsIndex(
    ...
    const requestContext = _config
      .getServer("LogsIndexesApi.v1.createLogsIndex")
  ...
  public async deleteLogsIndex(
    ...
    // Make Request Context
    const requestContext = _config
      .getServer("LogsIndexesApi.v1.deleteLogsIndex")
  ...
  public async getLogsIndex(
    ...
    // Make Request Context
    const requestContext = _config
      .getServer("LogsIndexesApi.v1.getLogsIndex")
  ...
  public async getLogsIndexOrder(
    ...
    // Make Request Context
    const requestContext = _config
      .getServer("LogsIndexesApi.v1.getLogsIndexOrder")
      .makeRequestContext(localVarPath, HttpMethod.GET);
    requestContext.setHeaderParam("Accept", "application/json");
    requestContext.setHttpConfig(_config.httpConfig);
  ...
  public async listLogIndexes(
    ...
    // Make Request Context
    const requestContext = _config
      .getServer("LogsIndexesApi.v1.listLogIndexes")
      .makeRequestContext(localVarPath, HttpMethod.GET);
    requestContext.setHeaderParam("Accept", "application/json");
    requestContext.setHttpConfig(_config.httpConfig);
  ...
  public async updateLogsIndex(
    ...
    // Make Request Context
    const requestContext = _config
      .getServer("LogsIndexesApi.v1.updateLogsIndex")
  ...
  public async updateLogsIndexOrder(
    ...
    // Make Request Context
    const requestContext = _config
      .getServer("LogsIndexesApi.v1.updateLogsIndexOrder")
      .makeRequestContext(localVarPath, HttpMethod.PUT);
    requestContext.setHeaderParam("Accept", "application/json");
    requestContext.setHttpConfig(_config.httpConfig);
