...
export class UserAuthorizedClientsApiRequestFactory extends BaseAPIRequestFactory {
  ...
  public constructor(configuration: Configuration) {
    super(configuration);
    if (!isBrowser) {
      this.userAgent = buildUserAgent("user-authorized-clients", version);
    }
  }
  ...
  public async listUserAuthorizedClients(
    ...
    if (filterDisabled !== undefined) {
      requestContext.setQueryParam(
        "filter[disabled]",
        serialize(filterDisabled, TypingInfo, "string", ""),
        "",
      );
    }
...
export class UserAuthorizedClientsApi {
  ...
  public constructor(
    ...
    this.requestFactory =
      requestFactory ||
      new UserAuthorizedClientsApiRequestFactory(this.configuration);
