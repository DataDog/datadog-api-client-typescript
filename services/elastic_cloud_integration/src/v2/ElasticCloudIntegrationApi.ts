...
export class ElasticCloudIntegrationApiRequestFactory extends BaseAPIRequestFactory {
  ...
  public constructor(configuration: Configuration) {
    super(configuration);
    if (!isBrowser) {
      this.userAgent = buildUserAgent("elastic-cloud-integration", version);
    }
  }
  public async createElasticCloudIntegrationAccount(
    ...
    if (
      ...
      throw new Error(
        "Unstable operation 'createElasticCloudIntegrationAccount' is disabled. Enable it by setting `configuration.unstableOperations['ElasticCloudIntegrationApi.v2.createElasticCloudIntegrationAccount'] = true`",
      );
    }
    ...
    const { server, overrides } = _config.getServerAndOverrides(
      "ElasticCloudIntegrationApi.v2.createElasticCloudIntegrationAccount",
      ElasticCloudIntegrationApi.operationServers,
    );
  ...
  public async deleteElasticCloudIntegrationAccount(
    ...
    if (
      ...
      throw new Error(
        "Unstable operation 'deleteElasticCloudIntegrationAccount' is disabled. Enable it by setting `configuration.unstableOperations['ElasticCloudIntegrationApi.v2.deleteElasticCloudIntegrationAccount'] = true`",
      );
    }
  ...
  public async getElasticCloudIntegrationAccount(
    ...
    if (
      ...
      throw new Error(
        "Unstable operation 'getElasticCloudIntegrationAccount' is disabled. Enable it by setting `configuration.unstableOperations['ElasticCloudIntegrationApi.v2.getElasticCloudIntegrationAccount'] = true`",
      );
    }
  ...
  public async listElasticCloudIntegrationAccounts(
    ...
    if (
      ...
      throw new Error(
        "Unstable operation 'listElasticCloudIntegrationAccounts' is disabled. Enable it by setting `configuration.unstableOperations['ElasticCloudIntegrationApi.v2.listElasticCloudIntegrationAccounts'] = true`",
      );
    }
  ...
  public async updateElasticCloudIntegrationAccount(
    ...
    if (
      ...
      throw new Error(
        "Unstable operation 'updateElasticCloudIntegrationAccount' is disabled. Enable it by setting `configuration.unstableOperations['ElasticCloudIntegrationApi.v2.updateElasticCloudIntegrationAccount'] = true`",
      );
    }
...
export class ElasticCloudIntegrationApi {
  ...
  public constructor(
    ...
    this.requestFactory =
      requestFactory ||
      new ElasticCloudIntegrationApiRequestFactory(this.configuration);
