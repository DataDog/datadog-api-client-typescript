...
export type MonthlyUsageAttributionSupportedMetrics =
  ...
  | typeof FLEX_LOGS_STARTER_USAGE
  | typeof FLEX_LOGS_STARTER_PERCENTAGE
...
export const BITS_AI_INVESTIGATIONS_PERCENTAGE = "bits_ai_investigations_percentage";
...
export const CONTAINER_EXCL_AGENT_PERCENTAGE = "container_excl_agent_percentage";
...
export const CUSTOM_INGESTED_TIMESERIES_PERCENTAGE = "custom_ingested_timeseries_percentage";
...
export const DATA_JOBS_MONITORING_PERCENTAGE = "data_jobs_monitoring_percentage";
export const DATA_STREAM_MONITORING_USAGE = "data_stream_monitoring_usage";
export const DATA_STREAM_MONITORING_PERCENTAGE = "data_stream_monitoring_percentage";
...
export const ESTIMATED_INDEXED_SPANS_PERCENTAGE = "estimated_indexed_spans_percentage";
export const ESTIMATED_INGESTED_SPANS_USAGE = "estimated_ingested_spans_usage";
export const ESTIMATED_INGESTED_SPANS_PERCENTAGE = "estimated_ingested_spans_percentage";
export const FARGATE_USAGE = "fargate_usage";
export const FARGATE_PERCENTAGE = "fargate_percentage";
export const FLEX_LOGS_STARTER_USAGE = "flex_logs_starter_usage";
export const FLEX_LOGS_STARTER_PERCENTAGE = "flex_logs_starter_percentage";
...
export const INCIDENT_MANAGEMENT_MONTHLY_ACTIVE_USERS_PERCENTAGE = "incident_management_monthly_active_users_percentage";
...
export const LAMBDA_TRACED_INVOCATIONS_PERCENTAGE = "lambda_traced_invocations_percentage";
...
export const NETWORK_DEVICE_WIRELESS_PERCENTAGE = "network_device_wireless_percentage";
...
export const PRODUCT_ANALYTICS_SESSION_PERCENTAGE = "product_analytics_session_percentage";
...
export const UNIVERSAL_SERVICE_MONITORING_PERCENTAGE = "universal_service_monitoring_percentage";
export const VULN_MANAGEMENT_HOSTS_USAGE = "vuln_management_hosts_usage";
export const VULN_MANAGEMENT_HOSTS_PERCENTAGE = "vuln_management_hosts_percentage";
...
export const CI_TEST_INDEXED_SPANS_PERCENTAGE = "ci_test_indexed_spans_percentage";
...
export const CI_PIPELINE_INDEXED_SPANS_PERCENTAGE = "ci_pipeline_indexed_spans_percentage";
...
export const LOGS_INDEXED_CUSTOM_RETENTION_PERCENTAGE = "logs_indexed_custom_retention_percentage";
...
export const RUM_SESSION_REPLAY_ADD_ON_PERCENTAGE = "rum_session_replay_add_on_percentage";
export const RUM_BROWSER_MOBILE_SESSIONS_USAGE = "rum_browser_mobile_sessions_usage";
export const RUM_BROWSER_MOBILE_SESSIONS_PERCENTAGE = "rum_browser_mobile_sessions_percentage";
export const INGESTED_SPANS_BYTES_USAGE = "ingested_spans_bytes_usage";
export const INGESTED_SPANS_BYTES_PERCENTAGE = "ingested_spans_bytes_percentage";
...
export const SIEM_ANALYZED_LOGS_ADD_ON_PERCENTAGE = "siem_analyzed_logs_add_on_percentage";
