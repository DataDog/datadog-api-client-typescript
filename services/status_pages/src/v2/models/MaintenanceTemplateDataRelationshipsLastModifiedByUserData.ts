 ...
 */
export class MaintenanceTemplateDataRelationshipsLastModifiedByUserData {
  /**
  ...
  static getAttributeTypeMap(): AttributeTypeMap {
    return MaintenanceTemplateDataRelationshipsLastModifiedByUserData.attributeTypeMap;
  }
