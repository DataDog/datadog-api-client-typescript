 ...
 */
export class CreateDegradationTemplateRequestDataAttributesUpdatesItems {
  /**
  ...
  static getAttributeTypeMap(): AttributeTypeMap {
    return CreateDegradationTemplateRequestDataAttributesUpdatesItems.attributeTypeMap;
  }
