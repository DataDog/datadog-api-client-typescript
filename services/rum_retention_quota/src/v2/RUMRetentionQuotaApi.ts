...
export class RUMRetentionQuotaApiRequestFactory extends BaseAPIRequestFactory {
  ...
  public constructor(configuration: Configuration) {
    super(configuration);
    if (!isBrowser) {
      this.userAgent = buildUserAgent("rum-retention-quota", version);
    }
  }
  public async deleteRumQuotaConfig(
    ...
    const { server, overrides } = _config.getServerAndOverrides(
      ...
      RUMRetentionQuotaApi.operationServers,
    );
...
export class RUMRetentionQuotaApi {
  ...
  public constructor(
    ...
    this.requestFactory =
      requestFactory ||
      new RUMRetentionQuotaApiRequestFactory(this.configuration);
