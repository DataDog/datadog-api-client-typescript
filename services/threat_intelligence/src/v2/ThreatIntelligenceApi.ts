...
export class ThreatIntelligenceApiRequestFactory extends BaseAPIRequestFactory {
  ...
  public async ingestStixThreatIntel(
    ...
    if (
      ...
      throw new Error(
        "Unstable operation 'ingestStixThreatIntel' is disabled. Enable it by setting `configuration.unstableOperations['ThreatIntelligenceApi.v2.ingestStixThreatIntel'] = true`",
      );
    }
