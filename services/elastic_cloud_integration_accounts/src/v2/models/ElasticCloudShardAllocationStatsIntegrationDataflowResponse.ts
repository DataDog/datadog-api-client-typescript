 ...
 */
export class ElasticCloudShardAllocationStatsIntegrationDataflowResponse {
  /**
  ...
  static getAttributeTypeMap(): AttributeTypeMap {
    return ElasticCloudShardAllocationStatsIntegrationDataflowResponse.attributeTypeMap;
  }
