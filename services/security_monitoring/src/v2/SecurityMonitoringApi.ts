...
export class SecurityMonitoringApiRequestFactory extends BaseAPIRequestFactory {
  ...
  public async assignIntegrationIssues(
    ...
    if (
      ...
      throw new Error(
        "Unstable operation 'assignIntegrationIssues' is disabled. Enable it by setting `configuration.unstableOperations['SecurityMonitoringApi.v2.assignIntegrationIssues'] = true`",
      );
    }
    ...
    const serializedBody = stringify(
      serialize(body, TypingInfo, "IntegrationAssignmentRequest", ""),
      contentType,
    );
  ...
  public async cancelThreatHuntingJob(
    ...
    if (
      ...
      throw new Error(
        "Unstable operation 'cancelThreatHuntingJob' is disabled. Enable it by setting `configuration.unstableOperations['SecurityMonitoringApi.v2.cancelThreatHuntingJob'] = true`",
      );
    }
  ...
  public async createJiraIssue(
    ...
    if (
      !_config.unstableOperations["SecurityMonitoringApi.v2.createJiraIssue"]
    ) {
      throw new Error(
        "Unstable operation 'createJiraIssue' is disabled. Enable it by setting `configuration.unstableOperations['SecurityMonitoringApi.v2.createJiraIssue'] = true`",
      );
    }
    ...
    requestContext.setHeaderParam("Content-Type", contentType);
    const serializedBody = stringify(
      serialize(body, TypingInfo, "JiraIssueRequest", ""),
      contentType,
    );
    requestContext.setBody(serializedBody);
  ...
  public async deleteThreatHuntingJob(
    ...
    if (
      ...
      throw new Error(
        "Unstable operation 'deleteThreatHuntingJob' is disabled. Enable it by setting `configuration.unstableOperations['SecurityMonitoringApi.v2.deleteThreatHuntingJob'] = true`",
      );
    }
  ...
  public async getJiraIssueMetadata(
    ...
    if (
      ...
      throw new Error(
        "Unstable operation 'getJiraIssueMetadata' is disabled. Enable it by setting `configuration.unstableOperations['SecurityMonitoringApi.v2.getJiraIssueMetadata'] = true`",
      );
    }
    ...
    if (url !== undefined) {
      requestContext.setQueryParam(
        "url",
        serialize(url, TypingInfo, "string", ""),
        "",
      );
    }
  ...
  public async getSBOM(
    ...
    if (extFormat !== undefined) {
      requestContext.setQueryParam(
        "ext:format",
        serialize(extFormat, TypingInfo, "SBOMFormat", ""),
        "",
      );
    }
  ...
  public async getThreatHuntingJob(
    ...
    if (
      ...
      throw new Error(
        "Unstable operation 'getThreatHuntingJob' is disabled. Enable it by setting `configuration.unstableOperations['SecurityMonitoringApi.v2.getThreatHuntingJob'] = true`",
      );
    }
  ...
  public async listScannedAssetsMetadata(
    ...
    if (filterAssetType !== undefined) {
      requestContext.setQueryParam(
        "filter[asset.type]",
        serialize(filterAssetType, TypingInfo, "CloudAssetType", ""),
        "",
      );
    }
    if (filterAssetName !== undefined) {
    ...
    if (filterLastSuccessOrigin !== undefined) {
      requestContext.setQueryParam(
        ...
        serialize(filterLastSuccessOrigin, TypingInfo, "string", ""),
        "",
      );
    }
    if (filterLastSuccessEnv !== undefined) {
      requestContext.setQueryParam(
        ...
        serialize(filterLastSuccessEnv, TypingInfo, "string", ""),
        "",
      );
    }
  ...
  public async listThreatHuntingJobs(
    ...
    if (
      ...
      throw new Error(
        "Unstable operation 'listThreatHuntingJobs' is disabled. Enable it by setting `configuration.unstableOperations['SecurityMonitoringApi.v2.listThreatHuntingJobs'] = true`",
      );
    }
  ...
  public async runThreatHuntingJob(
    ...
    if (
      ...
      throw new Error(
        "Unstable operation 'runThreatHuntingJob' is disabled. Enable it by setting `configuration.unstableOperations['SecurityMonitoringApi.v2.runThreatHuntingJob'] = true`",
      );
    }
...
export class SecurityMonitoringApiResponseProcessor {
  ...
  public async getJiraIssueMetadata(
    ...
    const contentType = normalizeMediaType(response.headers["content-type"]);
    if (response.httpStatusCode === 200) {
      const body: JiraIssuesMetadataResponse = deserialize(
        parse(await response.body.text(), contentType),
        TypingInfo,
  ...
  public async getThreatHuntingJob(
    ...
    const contentType = normalizeMediaType(response.headers["content-type"]);
    if (response.httpStatusCode === 200) {
      const body: ThreatHuntingJobResponse = deserialize(
        parse(await response.body.text(), contentType),
        TypingInfo,
  ...
  public async listThreatHuntingJobs(
    ...
    const contentType = normalizeMediaType(response.headers["content-type"]);
    if (response.httpStatusCode === 200) {
      const body: ListThreatHuntingJobsResponse = deserialize(
        parse(await response.body.text(), contentType),
        TypingInfo,
