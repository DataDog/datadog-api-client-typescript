...
export class SecurityMonitoringApiRequestFactory extends BaseAPIRequestFactory {
  ...
  public async createSignalInvestigation(
    ...
    if (
      ...
      throw new Error(
        "Unstable operation 'createSignalInvestigation' is disabled. Enable it by setting `configuration.unstableOperations['SecurityMonitoringApi.v2.createSignalInvestigation'] = true`",
      );
    }
  ...
  public async getInvestigationFeedback(
    ...
    if (
      ...
      throw new Error(
        "Unstable operation 'getInvestigationFeedback' is disabled. Enable it by setting `configuration.unstableOperations['SecurityMonitoringApi.v2.getInvestigationFeedback'] = true`",
      );
    }
  ...
  public async updateInvestigationFeedback(
    ...
    if (
      ...
      throw new Error(
        "Unstable operation 'updateInvestigationFeedback' is disabled. Enable it by setting `configuration.unstableOperations['SecurityMonitoringApi.v2.updateInvestigationFeedback'] = true`",
      );
    }
...
export class SecurityMonitoringApiResponseProcessor {
  ...
  public async createSignalInvestigation(
    ...
    const contentType = normalizeMediaType(response.headers["content-type"]);
    if (response.httpStatusCode === 200) {
      const body: SecurityMonitoringSignalInvestigationResponse = deserialize(
        parse(await response.body.text(), contentType),
        TypingInfo,
