...
export class GCPIntegrationApiRequestFactory extends BaseAPIRequestFactory {
  ...
  public async createGCPSTSAccount(
    ...
    const requestContext = _config
      .getServer("GCPIntegrationApi.v2.createGCPSTSAccount")
  ...
  public async deleteGCPSTSAccount(
    ...
    // Make Request Context
    const requestContext = _config
      .getServer("GCPIntegrationApi.v2.deleteGCPSTSAccount")
  ...
  public async getGCPSTSDelegate(
    ...
    // Make Request Context
    const requestContext = _config
      .getServer("GCPIntegrationApi.v2.getGCPSTSDelegate")
  ...
  public async listGCPSTSAccounts(
    ...
    // Make Request Context
    const requestContext = _config
      .getServer("GCPIntegrationApi.v2.listGCPSTSAccounts")
      .makeRequestContext(localVarPath, HttpMethod.GET);
    requestContext.setHeaderParam("Accept", "application/json");
    requestContext.setHttpConfig(_config.httpConfig);
  ...
  public async makeGCPSTSDelegate(
    ...
    // Make Request Context
    const requestContext = _config
      .getServer("GCPIntegrationApi.v2.makeGCPSTSDelegate")
      .makeRequestContext(localVarPath, HttpMethod.POST);
    requestContext.setHeaderParam("Accept", "application/json");
    requestContext.setHttpConfig(_config.httpConfig);
  ...
  public async updateGCPSTSAccount(
    ...
    // Make Request Context
    const requestContext = _config
      .getServer("GCPIntegrationApi.v2.updateGCPSTSAccount")
