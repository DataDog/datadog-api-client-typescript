...
export class ElasticCloudCloudCostManagementApiRequestFactory extends BaseAPIRequestFactory {
  ...
  public constructor(configuration: Configuration) {
    ...
    if (!isBrowser) {
      this.userAgent = buildUserAgent(
        "elastic-cloud-cloud-cost-management",
        version,
      );
    }
  }
  public async createElasticCloudCcmAccount(
    ...
    if (
      ...
      throw new Error(
        "Unstable operation 'createElasticCloudCcmAccount' is disabled. Enable it by setting `configuration.unstableOperations['ElasticCloudCloudCostManagementApi.v2.createElasticCloudCcmAccount'] = true`",
      );
    }
    ...
    const { server, overrides } = _config.getServerAndOverrides(
      "ElasticCloudCloudCostManagementApi.v2.createElasticCloudCcmAccount",
      ElasticCloudCloudCostManagementApi.operationServers,
    );
  ...
  public async deleteElasticCloudCcmAccount(
    ...
    if (
      ...
      throw new Error(
        "Unstable operation 'deleteElasticCloudCcmAccount' is disabled. Enable it by setting `configuration.unstableOperations['ElasticCloudCloudCostManagementApi.v2.deleteElasticCloudCcmAccount'] = true`",
      );
    }
  ...
  public async getElasticCloudCcmAccount(
    ...
    if (
      ...
      throw new Error(
        "Unstable operation 'getElasticCloudCcmAccount' is disabled. Enable it by setting `configuration.unstableOperations['ElasticCloudCloudCostManagementApi.v2.getElasticCloudCcmAccount'] = true`",
      );
    }
  ...
  public async listElasticCloudCcmAccounts(
    ...
    if (
      ...
      throw new Error(
        "Unstable operation 'listElasticCloudCcmAccounts' is disabled. Enable it by setting `configuration.unstableOperations['ElasticCloudCloudCostManagementApi.v2.listElasticCloudCcmAccounts'] = true`",
      );
    }
  ...
  public async updateElasticCloudCcmAccount(
    ...
    if (
      ...
      throw new Error(
        "Unstable operation 'updateElasticCloudCcmAccount' is disabled. Enable it by setting `configuration.unstableOperations['ElasticCloudCloudCostManagementApi.v2.updateElasticCloudCcmAccount'] = true`",
      );
    }
...
export class ElasticCloudCloudCostManagementApi {
  ...
  public constructor(
    ...
    this.requestFactory =
      requestFactory ||
      new ElasticCloudCloudCostManagementApiRequestFactory(this.configuration);
