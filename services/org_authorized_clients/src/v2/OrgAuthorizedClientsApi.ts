...
export class OrgAuthorizedClientsApiRequestFactory extends BaseAPIRequestFactory {
  ...
  public constructor(configuration: Configuration) {
    super(configuration);
    if (!isBrowser) {
      this.userAgent = buildUserAgent("org-authorized-clients", version);
    }
  }
  ...
  public async listOrgAuthorizedClients(
    ...
    if (filterOauth2ClientName !== undefined) {
      requestContext.setQueryParam(
        ...
        serialize(filterOauth2ClientName, TypingInfo, "string", ""),
        "",
      );
    }
  ...
  public async listOrgAuthorizedClientUserAuthorizations(
    ...
    if (filterUserEmail !== undefined) {
      requestContext.setQueryParam(
        "filter[user][email]",
        serialize(filterUserEmail, TypingInfo, "string", ""),
        "",
      );
    }
    if (filterUserDisabled !== undefined) {
      requestContext.setQueryParam(
        ...
        serialize(filterUserDisabled, TypingInfo, "string", ""),
        "",
      );
    }
...
export class OrgAuthorizedClientsApi {
  ...
  public constructor(
    ...
    this.requestFactory =
      requestFactory ||
      new OrgAuthorizedClientsApiRequestFactory(this.configuration);
