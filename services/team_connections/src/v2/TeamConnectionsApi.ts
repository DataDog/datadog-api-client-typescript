...
export class TeamConnectionsApiRequestFactory extends BaseAPIRequestFactory {
  ...
  public constructor(configuration: Configuration) {
    super(configuration);
    if (!isBrowser) {
      this.userAgent = buildUserAgent("team-connections", version);
    }
  }
  public async createTeamConnections(
    ...
    if (
      !_config.unstableOperations["TeamConnectionsApi.v2.createTeamConnections"]
    ) {
      throw new Error(
        "Unstable operation 'createTeamConnections' is disabled. Enable it by setting `configuration.unstableOperations['TeamConnectionsApi.v2.createTeamConnections'] = true`",
      );
    }
    ...
    const { server, overrides } = _config.getServerAndOverrides(
      ...
      TeamConnectionsApi.operationServers,
    );
  ...
  public async deleteTeamConnections(
    ...
    if (
      !_config.unstableOperations["TeamConnectionsApi.v2.deleteTeamConnections"]
    ) {
      throw new Error(
        "Unstable operation 'deleteTeamConnections' is disabled. Enable it by setting `configuration.unstableOperations['TeamConnectionsApi.v2.deleteTeamConnections'] = true`",
      );
    }
  ...
  public async listTeamConnections(
    ...
    if (
      !_config.unstableOperations["TeamConnectionsApi.v2.listTeamConnections"]
    ) {
      throw new Error(
        "Unstable operation 'listTeamConnections' is disabled. Enable it by setting `configuration.unstableOperations['TeamConnectionsApi.v2.listTeamConnections'] = true`",
      );
    }
...
export class TeamConnectionsApi {
  ...
  public constructor(
    ...
    this.requestFactory =
      requestFactory ||
      new TeamConnectionsApiRequestFactory(this.configuration);
