 ...
 */
export class DatabricksIntegrationAccountPrivateActionRunnerAuthResponse {
  /**
  ...
  static getAttributeTypeMap(): AttributeTypeMap {
    return DatabricksIntegrationAccountPrivateActionRunnerAuthResponse.attributeTypeMap;
  }
