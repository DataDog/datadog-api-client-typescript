...
export class DatabricksIntegrationApiRequestFactory extends BaseAPIRequestFactory {
  public userAgent: string | undefined;

  public constructor(configuration: Configuration) {
    super(configuration);
    if (!isBrowser) {
      this.userAgent = buildUserAgent("databricks-integration", version);
    }
  }
  public async createDatabricksIntegrationAccount(
    ...
    if (
      ...
      throw new Error(
        "Unstable operation 'createDatabricksIntegrationAccount' is disabled. Enable it by setting `configuration.unstableOperations['DatabricksIntegrationApi.v2.createDatabricksIntegrationAccount'] = true`",
      );
    }
    ...
    const { server, overrides } = _config.getServerAndOverrides(
      "DatabricksIntegrationApi.v2.createDatabricksIntegrationAccount",
      DatabricksIntegrationApi.operationServers,
    );
  ...
  public async deleteDatabricksIntegrationAccount(
    ...
    if (
      ...
      throw new Error(
        "Unstable operation 'deleteDatabricksIntegrationAccount' is disabled. Enable it by setting `configuration.unstableOperations['DatabricksIntegrationApi.v2.deleteDatabricksIntegrationAccount'] = true`",
      );
    }
  ...
  public async getDatabricksIntegrationAccount(
    ...
    if (
      ...
      throw new Error(
        "Unstable operation 'getDatabricksIntegrationAccount' is disabled. Enable it by setting `configuration.unstableOperations['DatabricksIntegrationApi.v2.getDatabricksIntegrationAccount'] = true`",
      );
    }
  ...
  public async listDatabricksIntegrationAccounts(
    ...
    if (
      ...
      throw new Error(
        "Unstable operation 'listDatabricksIntegrationAccounts' is disabled. Enable it by setting `configuration.unstableOperations['DatabricksIntegrationApi.v2.listDatabricksIntegrationAccounts'] = true`",
      );
    }
  ...
  public async updateDatabricksIntegrationAccount(
    ...
    if (
      ...
      throw new Error(
        "Unstable operation 'updateDatabricksIntegrationAccount' is disabled. Enable it by setting `configuration.unstableOperations['DatabricksIntegrationApi.v2.updateDatabricksIntegrationAccount'] = true`",
      );
    }
...
export class DatabricksIntegrationApiResponseProcessor {
  /**
...
export interface DatabricksIntegrationApiCreateDatabricksIntegrationAccountRequest {
  /**
...
export interface DatabricksIntegrationApiDeleteDatabricksIntegrationAccountRequest {
  /**
...
export interface DatabricksIntegrationApiGetDatabricksIntegrationAccountRequest {
  /**
   * Unique identifier of the integration account.
   * @type string
   */
...
export interface DatabricksIntegrationApiUpdateDatabricksIntegrationAccountRequest {
  /**
   * Unique identifier of the integration account.
   * @type string
   */
...
export class DatabricksIntegrationApi {
  private requestFactory: DatabricksIntegrationApiRequestFactory;
  private responseProcessor: DatabricksIntegrationApiResponseProcessor;
  ...
  public constructor(
    ...
    requestFactory?: DatabricksIntegrationApiRequestFactory,
    responseProcessor?: DatabricksIntegrationApiResponseProcessor,
  ) {
    this.configuration = configuration || createConfiguration();
    this.requestFactory =
      requestFactory ||
      new DatabricksIntegrationApiRequestFactory(this.configuration);
    this.responseProcessor =
      responseProcessor || new DatabricksIntegrationApiResponseProcessor();
  }
  ...
  public createDatabricksIntegrationAccount(
    param: DatabricksIntegrationApiCreateDatabricksIntegrationAccountRequest,
  ...
  public deleteDatabricksIntegrationAccount(
    param: DatabricksIntegrationApiDeleteDatabricksIntegrationAccountRequest,
    options?: Configuration,
  ): Promise<void> {
    const requestContextPromise =
  ...
  public getDatabricksIntegrationAccount(
    param: DatabricksIntegrationApiGetDatabricksIntegrationAccountRequest,
    options?: Configuration,
  ): Promise<DatabricksIntegrationAccountResponse> {
    const requestContextPromise =
  ...
  public updateDatabricksIntegrationAccount(
    param: DatabricksIntegrationApiUpdateDatabricksIntegrationAccountRequest,
    options?: Configuration,
  ): Promise<DatabricksIntegrationAccountResponse> {
    const requestContextPromise =
