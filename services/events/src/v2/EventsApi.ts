...
export class EventsApiRequestFactory extends BaseAPIRequestFactory {
  ...
  public async listOnCallEventEmailAddresses(
    ...
    if (
      !_config.unstableOperations["EventsApi.v2.listOnCallEventEmailAddresses"]
    ) {
      throw new Error(
        "Unstable operation 'listOnCallEventEmailAddresses' is disabled. Enable it by setting `configuration.unstableOperations['EventsApi.v2.listOnCallEventEmailAddresses'] = true`",
      );
    }
