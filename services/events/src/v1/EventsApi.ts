...
export class EventsApiRequestFactory extends BaseAPIRequestFactory {
  ...
  public async createEvent(
    ...
    const requestContext = _config
      .getServer("EventsApi.v1.createEvent")
  ...
  public async getEvent(
    ...
    // Make Request Context
    const requestContext = _config
      .getServer("EventsApi.v1.getEvent")
  ...
  public async listEvents(
    ...
    // Make Request Context
    const requestContext = _config
      .getServer("EventsApi.v1.listEvents")
      .makeRequestContext(localVarPath, HttpMethod.GET);
    requestContext.setHeaderParam("Accept", "application/json");
    requestContext.setHttpConfig(_config.httpConfig);
    ...
    if (priority !== undefined) {
      requestContext.setQueryParam(
        "priority",
        serialize(priority, TypingInfo, "EventPriority", ""),
        "",
      );
    }
    if (sources !== undefined) {
      requestContext.setQueryParam(
        "sources",
        serialize(sources, TypingInfo, "string", ""),
        "",
      );
    }
    if (tags !== undefined) {
    ...
    if (unaggregated !== undefined) {
      requestContext.setQueryParam(
        "unaggregated",
        serialize(unaggregated, TypingInfo, "boolean", ""),
        "",
      );
    }
    if (excludeAggregate !== undefined) {
      requestContext.setQueryParam(
        "exclude_aggregate",
        serialize(excludeAggregate, TypingInfo, "boolean", ""),
        "",
      );
    }
    if (page !== undefined) {
