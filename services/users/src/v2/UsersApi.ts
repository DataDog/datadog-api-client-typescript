...
export class UsersApiRequestFactory extends BaseAPIRequestFactory {
  public async createUser(
    ...
    const requestContext = _config
      .getServer("0.0.1.UsersApi.createUser")
  ...
  public async disableUser(
    ...
    // Make Request Context
    const requestContext = _config
      .getServer("0.0.1.UsersApi.disableUser")
  ...
  public async getInvitation(
    ...
    // Make Request Context
    const requestContext = _config
      .getServer("0.0.1.UsersApi.getInvitation")
  ...
  public async getUser(
    ...
    // Make Request Context
    const requestContext = _config
      .getServer("0.0.1.UsersApi.getUser")
      .makeRequestContext(localVarPath, HttpMethod.GET);
    requestContext.setHeaderParam("Accept", "application/json");
    requestContext.setHttpConfig(_config.httpConfig);
  ...
  public async listUserOrganizations(
    ...
    // Make Request Context
    const requestContext = _config
      .getServer("0.0.1.UsersApi.listUserOrganizations")
      .makeRequestContext(localVarPath, HttpMethod.GET);
    requestContext.setHeaderParam("Accept", "application/json");
    requestContext.setHttpConfig(_config.httpConfig);
  ...
  public async listUserPermissions(
    ...
    // Make Request Context
    const requestContext = _config
      .getServer("0.0.1.UsersApi.listUserPermissions")
      .makeRequestContext(localVarPath, HttpMethod.GET);
    requestContext.setHeaderParam("Accept", "application/json");
    requestContext.setHttpConfig(_config.httpConfig);
  ...
  public async listUsers(
    ...
    // Make Request Context
    const requestContext = _config
      .getServer("0.0.1.UsersApi.listUsers")
      .makeRequestContext(localVarPath, HttpMethod.GET);
    requestContext.setHeaderParam("Accept", "application/json");
    requestContext.setHttpConfig(_config.httpConfig);
  ...
  public async sendInvitations(
    ...
    // Make Request Context
    const requestContext = _config
      .getServer("0.0.1.UsersApi.sendInvitations")
      .makeRequestContext(localVarPath, HttpMethod.POST);
    requestContext.setHeaderParam("Accept", "application/json");
    requestContext.setHttpConfig(_config.httpConfig);
  ...
  public async updateUser(
    ...
    // Make Request Context
    const requestContext = _config
      .getServer("0.0.1.UsersApi.updateUser")
