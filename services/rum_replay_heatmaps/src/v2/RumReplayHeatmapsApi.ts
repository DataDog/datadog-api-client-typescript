...
export class RumReplayHeatmapsApiRequestFactory extends BaseAPIRequestFactory {
  ...
  public constructor(configuration: Configuration) {
    super(configuration);
    if (!isBrowser) {
      this.userAgent = buildUserAgent("rum-replay-heatmaps", version);
    }
  }
  ...
  public async listReplayHeatmapSnapshots(
    ...
    if (filterDeviceType !== undefined) {
      requestContext.setQueryParam(
        "filter[device_type]",
        serialize(filterDeviceType, TypingInfo, "string", ""),
        "",
      );
    }
...
export class RumReplayHeatmapsApi {
  ...
  public constructor(
    ...
    this.requestFactory =
      requestFactory ||
      new RumReplayHeatmapsApiRequestFactory(this.configuration);
