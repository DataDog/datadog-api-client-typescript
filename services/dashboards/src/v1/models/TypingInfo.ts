...
export const TypingInfo: ModelTypingInfo = {
  enumsMap: {
    ...
    CalendarIntervalType: ["day", "week", "month", "year", "quarter", "minute", "hour"],
    ChangeWidgetDefinitionType: ["change"],
    CheckStatusWidgetDefinitionType: ["check_status"],
    CohortWidgetDefinitionType: ["cohort"],
    ComparisonDurationType: ["previous_timeframe", "custom_timeframe", "previous_day", "previous_week", "previous_month"],
    ...
    EventsAggregationValue: ["avg", "cardinality", "count", "delta", "earliest", "latest", "max", "median", "min", "most_frequent", "sum"],
    ...
    FormulaAndFunctionApmMetricStatName: ["errors", "error_rate", "errors_per_second", "latency_avg", "latency_max", "latency_p50", "latency_p75", "latency_p90", "latency_p95", "latency_p99", "latency_p999", "latency_distribution", "hits", "hits_per_second", "total_time", "apdex"],
    FormulaAndFunctionApmMetricsDataSource: ["apm_metrics"],
    FormulaAndFunctionApmMetricsSpanKind: ["consumer", "server", "client", "producer", "internal"],
    ...
    FormulaAndFunctionEventsDataSource: ["logs", "spans", "network", "rum", "security_signals", "profiles", "audit", "events", "ci_tests", "ci_pipelines", "incident_analytics", "product_analytics", "on_call_events", "errors", "llm_observability"],
    ...
    FunnelComparisonDurationType: ["previous_timeframe", "custom_timeframe", "previous_day", "previous_week", "previous_month"],
    ...
    HostMapWidgetDefinitionRequestType: ["infrastructure_hostmap", "data_projection"],
    ...
    ListStreamSource: ["logs_stream", "audit_stream", "ci_pipeline_stream", "ci_test_stream", "rum_issue_stream", "apm_issue_stream", "trace_stream", "logs_issue_stream", "logs_pattern_stream", "logs_transaction_stream", "event_stream", "rum_stream", "llm_observability_stream", "issue_stream"],
    ...
    ProductAnalyticsFunnelComputeMetric: ["__dd.conversion", "__dd.conversion_rate"],
    ...
    QueryValueWidgetComparisonDirectionality: ["increase_better", "decrease_better", "neutral"],
    ...
    UserJourneyFormulaComputeMetric: ["__dd.conversion", "__dd.conversion_rate", "__dd.time_to_convert"],
