...
export class WorkflowAutomationApiRequestFactory extends BaseAPIRequestFactory {
  ...
  public async listWorkflows(
    ...
    if (filterTriggerType !== undefined) {
      requestContext.setQueryParam(
        "filter[triggerType]",
        serialize(filterTriggerType, TypingInfo, "Array<string>", ""),
        "multi",
      );
    }
    if (filterIncludeUnpublished !== undefined) {
      requestContext.setQueryParam(
        ...
        serialize(filterIncludeUnpublished, TypingInfo, "boolean", ""),
        "",
      );
    }
    if (filterIncludeSpecs !== undefined) {
      requestContext.setQueryParam(
        "filter[includeSpecs]",
        serialize(filterIncludeSpecs, TypingInfo, "boolean", ""),
        "",
      );
    }
