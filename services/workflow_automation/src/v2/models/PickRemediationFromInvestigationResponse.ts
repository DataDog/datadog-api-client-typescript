...
export class PickRemediationFromInvestigationResponse {
  /**
   * The keywords generated and used for finding actions.
   */
  "keywordsUsed": Array<string>;
  /**
  ...
  static getAttributeTypeMap(): AttributeTypeMap {
    return PickRemediationFromInvestigationResponse.attributeTypeMap;
  }
