...
export class DataAccessControlsApiRequestFactory extends BaseAPIRequestFactory {
  ...
  public async createDataset(
    ...
    if (!_config.unstableOperations["DataAccessControlsApi.v2.createDataset"]) {
      throw new Error(
        "Unstable operation 'createDataset' is disabled. Enable it by setting `configuration.unstableOperations['DataAccessControlsApi.v2.createDataset'] = true`",
      );
    }
  ...
  public async deleteDataset(
    ...
    if (!_config.unstableOperations["DataAccessControlsApi.v2.deleteDataset"]) {
      throw new Error(
        "Unstable operation 'deleteDataset' is disabled. Enable it by setting `configuration.unstableOperations['DataAccessControlsApi.v2.deleteDataset'] = true`",
      );
    }
  ...
  public async getAllDatasets(
    ...
    if (
      !_config.unstableOperations["DataAccessControlsApi.v2.getAllDatasets"]
    ) {
      throw new Error(
        "Unstable operation 'getAllDatasets' is disabled. Enable it by setting `configuration.unstableOperations['DataAccessControlsApi.v2.getAllDatasets'] = true`",
      );
    }
  ...
  public async getDataset(
    ...
    if (!_config.unstableOperations["DataAccessControlsApi.v2.getDataset"]) {
      throw new Error(
        "Unstable operation 'getDataset' is disabled. Enable it by setting `configuration.unstableOperations['DataAccessControlsApi.v2.getDataset'] = true`",
      );
    }
  ...
  public async updateDataset(
    ...
    if (!_config.unstableOperations["DataAccessControlsApi.v2.updateDataset"]) {
      throw new Error(
        "Unstable operation 'updateDataset' is disabled. Enable it by setting `configuration.unstableOperations['DataAccessControlsApi.v2.updateDataset'] = true`",
      );
    }
