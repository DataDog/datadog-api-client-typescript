...
export class CloudCostManagementApiRequestFactory extends BaseAPIRequestFactory {
  ...
  public async getCostAIPreferredTags(
    ...
    if (
      ...
      throw new Error(
        "Unstable operation 'getCostAIPreferredTags' is disabled. Enable it by setting `configuration.unstableOperations['CloudCostManagementApi.v2.getCostAIPreferredTags'] = true`",
      );
    }
  ...
  public async getCostSetting(
    ...
    if (
      !_config.unstableOperations["CloudCostManagementApi.v2.getCostSetting"]
    ) {
      throw new Error(
        "Unstable operation 'getCostSetting' is disabled. Enable it by setting `configuration.unstableOperations['CloudCostManagementApi.v2.getCostSetting'] = true`",
      );
    }
  ...
  public async listCostTagPipelineActiveKeys(
    ...
    if (
      ...
      throw new Error(
        "Unstable operation 'listCostTagPipelineActiveKeys' is disabled. Enable it by setting `configuration.unstableOperations['CloudCostManagementApi.v2.listCostTagPipelineActiveKeys'] = true`",
      );
    }
  ...
  public async listCustomAllocationRulesStatus(
    ...
    if (
      ...
      throw new Error(
        "Unstable operation 'listCustomAllocationRulesStatus' is disabled. Enable it by setting `configuration.unstableOperations['CloudCostManagementApi.v2.listCustomAllocationRulesStatus'] = true`",
      );
    }
  ...
  public async listTagPipelinesRulesetsStatus(
    ...
    if (
      ...
      throw new Error(
        "Unstable operation 'listTagPipelinesRulesetsStatus' is disabled. Enable it by setting `configuration.unstableOperations['CloudCostManagementApi.v2.listTagPipelinesRulesetsStatus'] = true`",
      );
    }
...
export class CloudCostManagementApiResponseProcessor {
  ...
  public async getCostAIPreferredTags(
    ...
    const contentType = normalizeMediaType(response.headers["content-type"]);
    if (response.httpStatusCode === 200) {
      const body: CostAIPreferredTagsResponse = deserialize(
        parse(await response.body.text(), contentType),
        TypingInfo,
  ...
  public async getCostSetting(
    ...
    const contentType = normalizeMediaType(response.headers["content-type"]);
    if (response.httpStatusCode === 200) {
      const body: CostSettingResponse = deserialize(
        parse(await response.body.text(), contentType),
        TypingInfo,
        "CostSettingResponse",
  ...
  public async listCostTagPipelineActiveKeys(
    ...
    const contentType = normalizeMediaType(response.headers["content-type"]);
    if (response.httpStatusCode === 200) {
      const body: CostTagPipelineActiveKeyResponse = deserialize(
        parse(await response.body.text(), contentType),
        TypingInfo,
  ...
  public async listCustomAllocationRulesStatus(
    ...
    const contentType = normalizeMediaType(response.headers["content-type"]);
    if (response.httpStatusCode === 200) {
      const body: CustomAllocationRuleStatusResponse = deserialize(
        parse(await response.body.text(), contentType),
        TypingInfo,
  ...
  public async listTagPipelinesRulesetsStatus(
    ...
    const contentType = normalizeMediaType(response.headers["content-type"]);
    if (response.httpStatusCode === 200) {
      const body: TagPipelinesRulesetStatusResponse = deserialize(
        parse(await response.body.text(), contentType),
        TypingInfo,
