...
export class TwilioIntegrationApiRequestFactory extends BaseAPIRequestFactory {
  ...
  public constructor(configuration: Configuration) {
    super(configuration);
    if (!isBrowser) {
      this.userAgent = buildUserAgent("twilio-integration", version);
    }
  }
  public async createTwilioIntegrationAccount(
    ...
    if (
      ...
      throw new Error(
        "Unstable operation 'createTwilioIntegrationAccount' is disabled. Enable it by setting `configuration.unstableOperations['TwilioIntegrationApi.v2.createTwilioIntegrationAccount'] = true`",
      );
    }
    ...
    const { server, overrides } = _config.getServerAndOverrides(
      "TwilioIntegrationApi.v2.createTwilioIntegrationAccount",
      TwilioIntegrationApi.operationServers,
    );
  ...
  public async deleteTwilioIntegrationAccount(
    ...
    if (
      ...
      throw new Error(
        "Unstable operation 'deleteTwilioIntegrationAccount' is disabled. Enable it by setting `configuration.unstableOperations['TwilioIntegrationApi.v2.deleteTwilioIntegrationAccount'] = true`",
      );
    }
  ...
  public async getTwilioIntegrationAccount(
    ...
    if (
      ...
      throw new Error(
        "Unstable operation 'getTwilioIntegrationAccount' is disabled. Enable it by setting `configuration.unstableOperations['TwilioIntegrationApi.v2.getTwilioIntegrationAccount'] = true`",
      );
    }
  ...
  public async listTwilioIntegrationAccounts(
    ...
    if (
      ...
      throw new Error(
        "Unstable operation 'listTwilioIntegrationAccounts' is disabled. Enable it by setting `configuration.unstableOperations['TwilioIntegrationApi.v2.listTwilioIntegrationAccounts'] = true`",
      );
    }
  ...
  public async updateTwilioIntegrationAccount(
    ...
    if (
      ...
      throw new Error(
        "Unstable operation 'updateTwilioIntegrationAccount' is disabled. Enable it by setting `configuration.unstableOperations['TwilioIntegrationApi.v2.updateTwilioIntegrationAccount'] = true`",
      );
    }
...
export class TwilioIntegrationApi {
  ...
  public constructor(
    ...
    this.requestFactory =
      requestFactory ||
      new TwilioIntegrationApiRequestFactory(this.configuration);
