 ...
 */
export class DeviceDetailsDataAttributes {
  /**
  ...
  static readonly attributeTypeMap: AttributeTypeMap = {
    ...
    batteryChargePct: {
      baseName: "battery_charge_pct",
      type: "number",
      format: "int64",
    },
    batteryChargeRate: {
      baseName: "battery_charge_rate",
      type: "number",
      format: "int64",
    },
    batteryCycleCount: {
      baseName: "battery_cycle_count",
      type: "number",
      format: "int64",
    },
    ...
    packetsInDrop: {
      baseName: "packets_in_drop",
      type: "number",
      format: "double",
    },
    packetsInError: {
      baseName: "packets_in_error",
      type: "number",
      format: "double",
    },
    packetsOutDrop: {
      baseName: "packets_out_drop",
      type: "number",
      format: "double",
    },
    packetsOutError: {
      baseName: "packets_out_error",
      type: "number",
      format: "double",
    },
    resourceId: {
    ...
    tcpOutSegs: {
      baseName: "tcp_out_segs",
      type: "number",
      format: "double",
    },
    tcpRetransSegs: {
      baseName: "tcp_retrans_segs",
      type: "number",
      format: "double",
    },
    type: {
  ...
  static getAttributeTypeMap(): AttributeTypeMap {
    return DeviceDetailsDataAttributes.attributeTypeMap;
  }
