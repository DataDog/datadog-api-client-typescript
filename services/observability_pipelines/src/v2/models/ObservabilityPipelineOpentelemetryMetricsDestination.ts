 ...
 */
export class ObservabilityPipelineOpentelemetryMetricsDestination {
  /**
  ...
  static getAttributeTypeMap(): AttributeTypeMap {
    return ObservabilityPipelineOpentelemetryMetricsDestination.attributeTypeMap;
  }
