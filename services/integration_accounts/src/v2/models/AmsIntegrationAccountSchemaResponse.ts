 ...
 */
export class AmsIntegrationAccountSchemaResponse {
  /**
  ...
  static readonly attributeTypeMap: AttributeTypeMap = {
    ...
    properties: {
      baseName: "properties",
      type: "AmsIntegrationAccountSchemaResponseProperties",
      required: true,
    },
    required: {
      baseName: "required",
  ...
  static getAttributeTypeMap(): AttributeTypeMap {
    return AmsIntegrationAccountSchemaResponse.attributeTypeMap;
  }
