...
export class OrganizationsApiRequestFactory extends BaseAPIRequestFactory {
  ...
  public async createChildOrg(
    ...
    const requestContext = _config
      .getServer("OrganizationsApi.v1.createChildOrg")
  ...
  public async downgradeOrg(
    ...
    // Make Request Context
    const requestContext = _config
      .getServer("OrganizationsApi.v1.downgradeOrg")
      .makeRequestContext(localVarPath, HttpMethod.POST);
    requestContext.setHeaderParam("Accept", "application/json");
    requestContext.setHttpConfig(_config.httpConfig);
  ...
  public async getOrg(
    ...
    // Make Request Context
    const requestContext = _config
      .getServer("OrganizationsApi.v1.getOrg")
  ...
  public async listOrgs(_options?: Configuration): Promise<RequestContext> {
    ...
    // Make Request Context
    const requestContext = _config
      .getServer("OrganizationsApi.v1.listOrgs")
      .makeRequestContext(localVarPath, HttpMethod.GET);
    requestContext.setHeaderParam("Accept", "application/json");
    requestContext.setHttpConfig(_config.httpConfig);
  ...
  public async updateOrg(
    ...
    // Make Request Context
    const requestContext = _config
      .getServer("OrganizationsApi.v1.updateOrg")
  ...
  public async uploadIdPForOrg(
    ...
    // Make Request Context
    const requestContext = _config
      .getServer("OrganizationsApi.v1.uploadIdPForOrg")
      .makeRequestContext(localVarPath, HttpMethod.POST);
    requestContext.setHeaderParam("Accept", "application/json");
    requestContext.setHttpConfig(_config.httpConfig);
