...
export class DashboardListsApiRequestFactory extends BaseAPIRequestFactory {
  ...
  public async createDashboardList(
    ...
    const { server, overrides } = _config.getServerAndOverrides("DashboardListsApi.v1.createDashboardList", DashboardListsApi.operationServers);
  ...
  public async deleteDashboardList(
    ...
    // Make Request Context
    const { server, overrides } = _config.getServerAndOverrides("DashboardListsApi.v1.deleteDashboardList", DashboardListsApi.operationServers);
  ...
  public async getDashboardList(
    ...
    // Make Request Context
    const { server, overrides } = _config.getServerAndOverrides("DashboardListsApi.v1.getDashboardList", DashboardListsApi.operationServers);
  ...
  public async listDashboardLists(
    ...
    // Make Request Context
    const { server, overrides } = _config.getServerAndOverrides("DashboardListsApi.v1.listDashboardLists", DashboardListsApi.operationServers);
    const requestContext = server.makeRequestContext(localVarPath, HttpMethod.GET, overrides);
    requestContext.setHeaderParam("Accept", "application/json");
    requestContext.setHttpConfig(_config.httpConfig);
  ...
  public async updateDashboardList(
    ...
    // Make Request Context
    const { server, overrides } = _config.getServerAndOverrides("DashboardListsApi.v1.updateDashboardList", DashboardListsApi.operationServers);
