...
export class ScorecardsApiRequestFactory extends BaseAPIRequestFactory {
  ...
  public constructor(configuration: Configuration) {
    super(configuration);
    if (!isBrowser) {
      this.userAgent = buildUserAgent("scorecards", version);
    }
  }
  ...
  public async listScorecardScores(
    ...
    if (filterRuleLevel !== undefined) {
      requestContext.setQueryParam(
        "filter[rule][level]",
        serialize(filterRuleLevel, TypingInfo, "string", ""),
        "",
      );
    }
    if (filterRuleScorecardId !== undefined) {
      requestContext.setQueryParam(
        ...
        serialize(filterRuleScorecardId, TypingInfo, "string", ""),
        "",
      );
    }
    if (filterRuleIsCustom !== undefined) {
      requestContext.setQueryParam(
        ...
        serialize(filterRuleIsCustom, TypingInfo, "boolean", ""),
        "",
      );
    }
    if (filterRuleIsEnabled !== undefined) {
      requestContext.setQueryParam(
        ...
        serialize(filterRuleIsEnabled, TypingInfo, "boolean", ""),
        "",
      );
    }
    if (sort !== undefined) {
