...
import { ReportScheduleQueryParameterValue } from "./ReportScheduleQueryParameterValue";
...
export class ReportScheduleListResponseAttributes {
   ...
   */
  "queryParams": { [key: string]: ReportScheduleQueryParameterValue };
  /**
  ...
  static readonly attributeTypeMap: AttributeTypeMap = {
    ...
    queryParams: {
      baseName: "query_params",
      type: "{ [key: string]: ReportScheduleQueryParameterValue; }",
      required: true,
    },
    recipients: {
      baseName: "recipients",
