...
export class DEMApiRequestFactory extends BaseAPIRequestFactory {
  ...
  public constructor(configuration: Configuration) {
    super(configuration);
    if (!isBrowser) {
      this.userAgent = buildUserAgent("dem", version);
    }
  }
  public async batchGetJourneysByTestSuiteIDs(
    ...
    const serializedBody = stringify(
      serialize(body, TypingInfo, "DemBatchGetJourneysRequest", ""),
      contentType,
    );
  ...
  public async createJourney(
    ...
    requestContext.setHeaderParam("Content-Type", contentType);
    const serializedBody = stringify(
      serialize(body, TypingInfo, "DemJourneyCreateRequest", ""),
      contentType,
    );
    requestContext.setBody(serializedBody);
  ...
  public async createJourneyVariant(
    ...
    requestContext.setHeaderParam("Content-Type", contentType);
    const serializedBody = stringify(
      serialize(body, TypingInfo, "DemVariantRequest", ""),
      contentType,
    );
    requestContext.setBody(serializedBody);
  ...
  public async createTestSuiteForJourney(
    ...
    requestContext.setHeaderParam("Content-Type", contentType);
    const serializedBody = stringify(
      serialize(body, TypingInfo, "DemCreateJourneyTestSuiteRequest", ""),
      contentType,
    );
    requestContext.setBody(serializedBody);
  ...
  public async searchInferredJourneys(
    ...
    if (status !== undefined) {
      requestContext.setQueryParam(
        "status",
        serialize(status, TypingInfo, "DemInferredJourneyStatus", ""),
        "",
      );
    }
    if (q !== undefined) {
    ...
    if (appId !== undefined) {
      requestContext.setQueryParam(
        "app_id",
        serialize(appId, TypingInfo, "string", ""),
        "",
      );
    }
...
export class DEMApiResponseProcessor {
  ...
  public async batchGetJourneysByTestSuiteIDs(
    ...
    if (response.httpStatusCode === 200) {
      const body: DemJourneysListResponse = deserialize(
  ...
  public async createJourney(
    ...
    const contentType = normalizeMediaType(response.headers["content-type"]);
    if (response.httpStatusCode === 200) {
      const body: DemJourneyResponse = deserialize(
        parse(await response.body.text(), contentType),
        TypingInfo,
        "DemJourneyResponse",
  ...
  public async createJourneyVariant(
    ...
    const contentType = normalizeMediaType(response.headers["content-type"]);
    if (response.httpStatusCode === 200) {
      const body: DemVariantResponse = deserialize(
        parse(await response.body.text(), contentType),
        TypingInfo,
        "DemVariantResponse",
  ...
  public async createTestSuiteForJourney(
    ...
    if (response.httpStatusCode === 201) {
      const body: DemJourneyTestSuiteResponse = deserialize(
        parse(await response.body.text(), contentType),
        TypingInfo,
  ...
  public async getJourneyRecommendedTests(
    ...
    const contentType = normalizeMediaType(response.headers["content-type"]);
    if (response.httpStatusCode === 200) {
      const body: DemRecommendedTestsResponse = deserialize(
        parse(await response.body.text(), contentType),
        TypingInfo,
  ...
  public async searchInferredJourneys(
    ...
    const contentType = normalizeMediaType(response.headers["content-type"]);
    if (response.httpStatusCode === 200) {
      const body: DemSearchInferredJourneysResponse = deserialize(
        parse(await response.body.text(), contentType),
        TypingInfo,
...
export class DEMApi {
  ...
  public constructor(
    ...
    this.requestFactory =
      requestFactory || new DEMApiRequestFactory(this.configuration);
